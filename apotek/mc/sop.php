		...
		<div align="center">
		  <form name="form1" method="post" action="">
			...
			<div id="listma" style="display:block">
			  <p><span class="jdltable">MASTER DATA SOP</span> 
			  ...
			  ?>
                <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
                  ...
                  <td width="10" class="tdisi"><img src="../icon/lihat.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Melihat Detail SOP" onClick="NewWindow('../master/view_sop.php?id=<?php echo $rows['id']; ?>','name','900','500','yes');return false"></td>
...
function fedit(id){
	...
	Request('../mc/get_sop.php?id='+id , 'tmpContent', '', 'GET',fSetContent,'NoLoad');
	jQuery("#listma").hide(1000);
	jQuery("#input").show(1000);
}

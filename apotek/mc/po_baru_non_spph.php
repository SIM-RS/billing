...
$cmbPemeriksa=mysqli_real_escape_string($konek,$_REQUEST["cmbPemeriksa"]);
if ($cmbPemeriksa==2) $Pemeriksa="Pejabat"; else $Pemeriksa="Panitia";
//$tgl_po=$_REQUEST['tgl_po'];
$tgl_po=mysqli_real_escape_string($konek,$_REQUEST["tgl_po"]);
...
$chk_ppn1=mysqli_real_escape_string($konek,$_REQUEST['chk_ppn']);

/* Baru Cara Bayar PO */
$cmbCaraBayar=mysqli_real_escape_string($konek,$_REQUEST['cmbCaraBayar']);
$cmbCaraBayar = ($cmbCaraBayar > 0) ? $cmbCaraBayar : 2; // Default Kredit [2]

/* Baru Uang Muka */
$uangMuka = mysqli_real_escape_string($konek,$_REQUEST['uangMuka']);
$uangMuka = ($cmbCaraBayar == 3) ? $uangMuka : 0;

$arrCBayar =  array(1 => 'Tunai', 2 => 'Kredit', 3 => 'Uang Muka');
$arrTObat =  array(0 => 'Reguler', 1 => 'BPJS');

if (($chk_ppn1=="") || ($chk_ppn1=="0")) $chk_ppn=0; else $chk_ppn=1;
//====================================================================
...
$sql="SELECT DISTINCT p.PBF_ID,PBF_ALAMAT,PBF_TELP,p.PBF_NAMA FROM a_pbf p WHERE p.PBF_ID='$pbf_id'";
//echo $sql."<br>";
$rs=mysqli_query($konek,$sql);
if ($rows=mysqli_fetch_array($rs)){
	$pbf=$rows['PBF_NAMA'];
...
$sql="SELECT DISTINCT * FROM a_kepemilikan WHERE ID='$kepemilikan_id'";
//echo $sql."<br>";
$rs=mysqli_query($konek,$sql);
if ($rows=mysqli_fetch_array($rs)){
	$kp_id=$rows['ID'];
...
<html>
<head>
<title>Sistem Informasi Apotik RS Bhayangkara Surabaya</title>
...
var tds;
	...
	if ((tbl.rows.length-1)==1){
		...
		document.forms[0].obat_id[(cdata[0]*1)].value=cdata[1];
		document.forms[0].txtObat[(cdata[0]*1)].value=cdata[2];
		document.forms[0].satuan[(cdata[0]*1)].value=cdata[3];
		//document.forms[0].kemasan[(cdata[0]*1)].value=cdata[9];
		//tds = tbl.rows[(cdata[0]*1)+2].getElementsByTagName('td');
		//document.forms[0].txtHarga[(cdata[0]*1)-1].value=cdata[4];
		document.forms[0].qty_kemasan[(cdata[0]*1)].focus();
	}
...
<tr align="center" valign="top">
	...
	<p align="center"><span class="jdltable" ><b>SURAT PEMESANAN</b></span></br>
      <span class="txtcenter"> No : <?php echo $no_po; ?></span></p>
            ...
            <!--table width="100%" border="0" cellpadding="1" cellspacing="0">
                 <tr>
                  <td width="300" height="25" class="txtinput" style="text-align:center"><b>Yang Mengajukan,</b></td>
                  <td>&nbsp;</td>
                  <td width="300" class="txtinput" style="text-align:center"><b>Mengetahui,</b></td>
                 </tr>
                 <tr>
                  <td colspan="3" height="75">&nbsp;</td>
                 </tr>
                 <tr>
                  <td height="25" class="txtinput" style="text-align:center"><b>Unit Layanan Pengadaan</b></td>
                  <td>&nbsp;</td>
                  <td class="txtinput" style="text-align:center"><b>Karumkit RS. Bhayangkara TK II<br>
                   H.S. Samsoeri Mertojoso</b></td>
                 </tr>
              </table-->
    </div>
	<p align="center">Surat Pesanan Dgn No PO : <?php echo $no_po; ?> 
		...
		<div align="center">
		  <form name="form1" method="post" action="">
            ...
            <input name="spph" id="spph" type="hidden" value="<?php echo $spph; ?>">
			...
			<div id="listma" style="display:block">
			  ...
			  <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
                ...
                <tr> 
                  <td>PBF</td>
                  <td>: <select id="pbf_id" name="pbf_id" class="txtinput">
				  <?php
                  ...
                  <td>Kepemilikan</td>
                  <td>: <select id="kepemilikan_id" name="kepemilikan_id" class="txtinput">
				  <?php
                  ...
                  <td colspan="2" style="display:none"><input name="chk_updt" type="checkbox" id="chk_updt" value="">
                ...
                <tr>
                  ...
                  <td>Cara Bayar</td>
                  <td>:
					<select name="cmbCaraBayar" id="cmbCaraBayar" class="txtinput" onChange="SetuangMuka(this.value);">
						<option value="1">Tunai</option>
						<option value="2" selected >Kredit</option>
						<option value="3">Uang Muka</option>
					</select>
				  </td>
                  <td><span id="labelUangMuka" style="display:none;">Uang Muka</span></td>
				  <td>
					<span id="inputUangMuka" style="display:none;">
						: <input type="text" name="uangMuka" id="uangMuka" size="15" class="txtright" value="0"/>
					</span>
				  </td>
                </tr>
				<tr>
					<td colspan="6" align="right"><button type="button" name="tambahRow" id="tambahRow" onClick="addRowToTable(); return false;">&nbsp;+&nbsp;</button></td>
				</tr>
              </table>
			  <table id="tblJual" width="100%" border="0" cellpadding="1" cellspacing="0">
                <tr class="headtable"> 
                  <td width="30" height="25" class="tblheaderkiri">No</td>
                  <td id="OBAT_NAMA" class="tblheader">Nama Obat</td>
				  <td id="OBAT_TYPE" class="tblheader">Jenis Obat</td>
                ...
                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'"> 
                  ...
                  <td class="tdisi" align="left"><input name="spph_id" type="hidden" value="0">
                    <input name="obat_id" type="hidden" value="<?php echo $obat_id; ?>">
                    <input name="txtObat" type="text" id="txtObat" class="txtinput" size="46" value="" onKeyUp="suggest(event,this);" autocomplete="off">
				  </td>
				  <td class="tdisi" align="left">
					<select name="obat_tipe" class="txtinput" id="obat_tipe">
						<option value="0">Reguler</option>
						<option value="1">BPJS</option>
					</select>
				  </td>
                  <td width="40" align="center" class="tdisi"> 
                    <input name="qty_kemasan" type="text" id="qty_kemasan" class="txtcenter" size="4" value="" onKeyUp="AddRow(event,this);" autocomplete="off">                  </td>
                  <td width="60" align="center" class="tdisi"> 
                    <input name="kemasan" id="kemasan" class="txtinput" size="7" value=""></td>
                  <td width="40" align="center" class="tdisi">
<input name="h_kemasan" type="text" class="txtright" id="h_kemasan" onKeyUp="AddRow(event,this);" value="" size="8" autocomplete="off">                  </td>
                  <td width="40" align="center" class="tdisi">
<input name="qty_per_kemasan" type="text" class="txtcenter" id="qty_per_kemasan" onKeyUp="AddRow(event,this);" value="" size="4" autocomplete="off">                  </td>
                  <td width="40" align="center" class="tdisi">
<input name="qty_satuan" type="text" class="txtcenter" id="qty_satuan" onKeyUp="" value="0" size="5" autocomplete="off" readonly="true">                  </td>
                  <td width="60" align="center" class="tdisi"> 
                    <input name="satuan" id="satuan" class="txtinput" value="" type="text" size="7">                  </td>
                  <td width="50" align="center" class="tdisi">
<input name="h_satuan" type="text" class="txtright" id="h_satuan" onKeyUp="" value="0" size="8" autocomplete="off" readonly="true">                  </td>
                  <td width="60" align="center" class="tdisi">
<input name="sub_tot" type="text" class="txtright" id="sub_tot" onKeyUp="" value="0" size="8" readonly="true">                  </td>
                  <td width="30" align="center" class="tdisi"> 
                    <input name="diskon_type" type="hidden" value="0"><input name="diskon" type="text" class="txtcenter" id="diskon" onKeyUp="AddRow(event,this);" value="0" size="3" autocomplete="off"></td>
                  <td width="50" align="center" class="tdisi"> 
                    <input name="diskon_rp" type="text" class="txtright" id="diskon_rp" onKeyUp="AddRow(event,this);" value="0" size="7" autocomplete="off"></td>
                  <td width="50" align="center" class="tdisi"><img src="../icon/del.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Menghapus" onClick="if (confirm('Yakin Ingin Menghapus Data?')){removeRowFromTable(this);}"></td>
                </tr>
              </table>
			</div>
				<p align="center">
...
<script>
function SetuangMuka(tipe = 2){
	document.getElementById('labelUangMuka').style.display = document.getElementById('inputUangMuka').style.display = 'none';
	if(tipe == 3){
		document.getElementById('labelUangMuka').style.display = document.getElementById('inputUangMuka').style.display = 'block';
	}
}
...
var tmp;
	if (document.form1.obat_id.length){
		if (j==1){
			document.forms[0].diskon_type[i].value="0";
			...
			document.forms[0].diskon_type[i].value="1";

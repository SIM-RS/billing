		  ...
		  <div id="listma" style="display:block">
			  ...
			  <table width="98%" border="0" cellpadding="1" cellspacing="0">
				<tr class="headtable"> 
				  ...
				  <td id="HARGA_JUAL_SATUAN" width="80" class="tblheader" onClick="ifPop.CallFr(this);">Harga<br>Jual </td>
			  ...
			  $sql="select ao.OBAT_ID,ao.OBAT_KODE,ao.OBAT_NAMA,ap.PABRIK,ah.*,ak.NAMA from a_obat ao left join a_pabrik ap on ao.PABRIK_ID=ap.PABRIK_ID inner join a_harga ah on ao.OBAT_ID=ah.OBAT_ID inner join a_kepemilikan ak on ah.KEPEMILIKAN_ID=ak.ID where OBAT_ISAKTIF=1".$filter." order by ".$sorting;
			  //echo $sql;
				$rs=mysqli_query($konek,$sql);
			  ...
			  while ($rows=mysqli_fetch_array($rs)){
				$i++;		
				$arfvalue="act*-*edit*|*harga_id*-*".$rows['HARGA_ID']."*|*obat_id*-*".$rows['OBAT_ID']."*|*obat_nama*-*".$rows['OBAT_NAMA']."*|*kepemilikan_id*-*".$rows['KEPEMILIKAN_ID']."*|*harga_netto*-*".$rows['HARGA_BELI_SATUAN']."*|*untung*-*".$rows['PROFIT']."*|*harga_jual*-*".$rows['HARGA_JUAL_SATUAN'];
			  ...
			  ?>
				<tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
				  ...
				  <td class="tdisi" align="right"><?php echo $rows['HARGA_JUAL_SATUAN'];?></td>

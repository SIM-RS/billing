	...
	<link rel="stylesheet" href="../theme/print.css" type="text/css" />
            ...
            <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
              ...
              <tr>
                ...
                <td>Cara Bayar</td>
                <td>: <?php echo $arrCBayar[$cmbCaraBayar]; ?></td>
                <td><?=($cmbCaraBayar == 3) ? 'Uang Muka' : '&nbsp'?></td>
                <td><?=($cmbCaraBayar == 3) ? ': '.number_format($uangMuka,2,",",".") : '&nbsp;'?></td>
              </tr>
            </table>
...
<input name="sub_tot" type="text" class="txtright" id="sub_tot" onKeyUp="" value="0" size="8" readonly="true">
                  ...
                  <td width="30" align="center" class="tdisi"> 
                    <input name="diskon_type" type="hidden" value="0"><input name="diskon" type="text" class="txtcenter" id="diskon" onKeyUp="HitungDiskon(<?php echo ($i-1); ?>,1);" value="0" size="3" autocomplete="off"></td>
                  <td width="50" align="center" class="tdisi"> 

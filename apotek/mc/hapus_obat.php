...
$idunit_url=$_REQUEST['idunit']; if($idunit_url=="") $idunit_url=1; 
		...
		for ($i=0;$i<count($arfdata);$i++)
		{
			...
			while (($rows=mysqli_fetch_array($rs))&&($done=="false"))
			{
				...
				if ($cstok>=$jml)
				{
					...
					$sql="INSERT INTO a_obat_hapus(USER_ID,UNIT_ID,PENERIMAAN_ID,OBAT_ID,KEPEMILIKAN_ID,NO_HAPUS,TGL_HAPUS,TGL_ACT,QTY,ALASAN) 
						VALUES($iduser,$idunit_url,$cid,$arfvalue[0],$arfvalue[3],'$nohapus','$tglhapus','$tglact',$jml,'$arfvalue[2]')";
					//echo $sql."<br>";
					...
					$jml=$jml-$cstok;
					$sql="INSERT INTO a_obat_hapus(USER_ID,UNIT_ID,PENERIMAAN_ID,OBAT_ID,KEPEMILIKAN_ID,NO_HAPUS,TGL_HAPUS,TGL_ACT,QTY,ALASAN) 
						VALUES($iduser,$idunit_url,$cid,$arfvalue[0],$arfvalue[3],'$nohapus','$tglhapus','$tglact',$cstok,'$arfvalue[2]')";
					//echo $sql."<br>";
					$rs1=mysqli_query($konek,$sql);
...
//	alert(isIE);
  ...
  if(!isIE){
	...
	//el.setAttribute('readonly', "false");
  	...
  	el = document.createElement('<input name="txtHapusStok" />');
  }
  el.type = 'text';
...
<div id="idArea" style="display:none;" align="center">
	<link rel="stylesheet" href="../theme/print.css" type="text/css" />
			  ...
			  <table width="910" border="0" cellpadding="1" cellspacing="0" align="center">
                ...
                <?php 
			  $sql="Select a_obat_hapus.QTY, a_obat_hapus.ALASAN, a_obat.OBAT_NAMA, ak.NAMA From a_obat_hapus
			  Inner Join a_obat ON a_obat_hapus.OBAT_ID = a_obat.OBAT_ID inner join a_kepemilikan ak on a_obat_hapus.KEPEMILIKAN_ID=ak.ID 
			  where NO_HAPUS='$nohapusPrint' group by a_obat.OBAT_NAMA, ak.NAMA order by ID_HAPUS";
			  //echo $sql."<br>";
			  $rs=mysqli_query($konek,$sql);
			  $i=0;
...
<input name="nohapus" type="text" id="nohapus" size="25" maxlength="30" value="<?php echo $nohapus;?>" class="txtinput" readonly="true" /></td>
              ...
              <tr>
                <td>Tanggal&nbsp; </td>
                        <td>:
<input name="tglhapus" type="text" id="tglhapus" size="11" maxlength="10" value="<?php echo $tgl;?>" class="txtcenter" /></td>
                </tr>
              <tr>
                <td>Unit</td>
                        <td>:
<select name="idunit" id="idunit" class="txtinput" onChange="location='hapus_obat.php?idunit='+idunit.value">
  ...
  <table id="tblJual" width="95%" border="0" cellpadding="0" cellspacing="0" align="center">
  	...
  	<tr>
		              <td colspan="7" align="center" class="jdltable">PENGHAPUSAN 
                        OBAT</td>
	  ...
	  <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'">
		...
		<td class="tdisi" align="left"><input name="obatid" type="hidden" value=""><input name="kpid" type="hidden" value="">
		  <input type="text" name="txtObat" id="txtObat" class="txtinput" size="65" onKeyUp="suggest(event,this);" autocomplete="off" /></td>
		      ...
		      <td class="tdisi" width="77"><input type="text" name="txtHapusStok" id="txtHapusStok" class="txtcenter" size="5" /></td>
    ...
    <table width="82%" border="0" cellpadding="0" cellspacing="0">
      <tr> 
        <td width="100%" align="center"><p>
			...
			<BUTTON type="button" onClick="if (ValidateForm('tglhapus,nohapus,idunit,txtHapusStok,txtAlasan','ind')){fSubmit();}"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Proses</BUTTON>

            <BUTTON type="reset" onClick="fSetBatalFr();location='hapus_obat.php';"><IMG SRC="../icon/cancel.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Reset&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON> <br>
		...
		&nbsp;<BUTTON type="button" onClick="location='list_hps_obat.php'"><IMG SRC="../icon/back.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Kembali&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
        </p>
		 </td>
      </tr>
    </table>

...
<div align="center">
  <form name="form1" method="post" action="">
    ...
    <div id="listma" style="display:block">
      ...
      <table width="60%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td colspan="6"><span class="txtinput">Bulan : </span> 
            <select name="bulan" id="bulan" class="txtinput" onChange="location='?f=../gudang/list_permintaan.php&bulan='+bulan.value+'&ta='+ta.value">
            ...
            <select name="ta" id="ta" class="txtinput" onChange="location='?f=../gudang/list_permintaan.php&bulan='+bulan.value+'&ta='+ta.value">
	  ...
	  $sql="select distinct date_format(am.tgl,'%d/%m/%Y') as tgl1,am.no_bukti,au.UNIT_ID,au.UNIT_NAME from a_minta_obat am inner join a_unit au on am.unit_id=au.UNIT_ID where month(am.tgl)=$bulan and year(am.tgl)=$ta and am.unit_tujuan=$idunit".$filter." order by ".$sorting;
	  //echo $sql."<br>";
		$rs=mysqli_query($konek,$sql);
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td width="25" class="tdisi"><img src="../icon/published.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Mengirim Permintaan Obat" onClick="<?php if ($qty_kurang==0){?>alert('Obat Yg Diminta Sudah Dikirim Semua !');<?php }else{?>location='?f=../gudang/list_permintaan_detail.php&no_minta=<?php echo $rows['no_bukti']; ?>&tgl_minta=<?php echo $rows['tgl1']; ?>&iunit=<?php echo $iunit; ?>&nunit=<?php echo $rows['UNIT_NAME']; ?>&bulan=<?php echo $bulan; ?>&ta=<?php echo $ta; ?>&page=<?php echo $page; ?>'<?php }?>"></td>
        </tr>
        <?php 
	  }

...
$kpid = $_REQUEST['kpid'];
convert_var($tgl_d,$tgl_s,$idunit);
...
if($kpid=='0'){
	...
	$qry2="select * from a_kepemilikan where ID=".$kpid;
...
if($_REQUEST['kpid']=='0'){
	...
	$fkpid = ' AND a_retur_togudang.KEPEMILIKAN_ID='.$kpid;
}

$funit = ' AND a_retur_togudang.UNIT_ID='.$idunit;

...
$tgl_2="$s[2]-$s[1]-$s[0]";
//===========================================================
$milik=$_REQUEST['milik']; if($milik=="" OR $milik=="0") $kep=""; else $kep=" and a_p.KEPEMILIKAN_ID=$milik ";
	...
	<div id="view" style="display:block">
	  <p align="center"><span class="jdltable">PENERIMAAN GUDANG</span></p>
		<table width="53%" border="0" align="center" cellpadding="1" cellspacing="0" class="txtinput">
		  <tr>
		    ...
		    <td>:
            <select name="jenis" id="jenis" class="txtinput" onChange="location='?f=../gudang/penerimaan_detail_report.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&milik='+milik.value+'&jenis='+jenis.value">
            ...
            <td>: 
			<select name="milik" id="milik" class="txtinput" onChange="location='?f=../gudang/penerimaan_detail_report.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&milik='+milik.value+'&jenis='+jenis.value">
		  ...
		  <tr> 
            ...
            <button type="button" onClick="location='?f=../gudang/penerimaan_detail_report.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&milik='+milik.value">
	  ...
	  <table id="tblpenerimaan" width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td width="45" class="tblheader" id="sd.nama" onClick="ifPop.CallFr(this);">Sumber Dana</td>
          <!-- Selesai-->
...
//	  $arfvalue="";
	  ...
	  ?>
        <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'"> 
          ...
          <td class="tdisi" align="left">&nbsp;<?php echo $rows['sumberdana']; ?></td>
...
//	  $arfvalue="";
	  ...
	  ?>
        <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'"> 
		  ...
		  <td class="tdisi" align="left" style="font-size:12px;">&nbsp;<?php echo $rows['sumberdana']; ?></td>

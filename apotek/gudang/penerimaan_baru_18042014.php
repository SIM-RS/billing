  ...
  <form name="form1" method="post" action="">
	...
	<div id="listma" style="display:block">
	  ...
	  <table width="1150" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        ...
        <tr>
          <td colspan="2"><select name="no_po" id="no_po" class="txtinput" onChange="location='?f=penerimaan_baru.php&no_po='+no_po.value+'&bln_po='+bln_po.value+'&th_po='+th_po.value">

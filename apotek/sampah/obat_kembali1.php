...
if ($isview==""){
	$sql="select NOKIRIM from a_penerimaan where UNIT_ID_KIRIM=$idunit and NOKIRIM like '$kodeunit/PK/$th[2]-$th[1]/%' order by NOKIRIM desc limit 1";
	//echo $sql."<br>";
	$rs=mysqli_query($konek,$sql);
    ...
    <div id="listma" style="display:block">
	  ...
	  <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr> 
          ...
          <td width="875">: 
            <input name="no_kirim" type="text" id="no_kirim" size="25" maxlength="30" class="txtcenter" value="<?php echo $no_kirim2; ?>"></td>
        </tr>
        <tr> 
      ...
      <BUTTON type="button" onClick="if (ValidateForm('no_terima','ind')){fSubmit();}"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;&nbsp;Kirim&nbsp;&nbsp;</BUTTON>

      ...
      <tr>
		...
		<table width="342" height="113" border="0" align="left" cellpadding="0" cellspacing="0" class="txtinput">
         <tr>
          ...
          <tr>
            <td colspan="2" ><table width="342" border="0" cellpadding="0" cellspacing="0" align="left" style="font-size:14px;">
            <?php 
            ...
            <tr>
              ...
              <td colspan="3" align="right" style="font-size:14px"><span class="">Harga Total</span>: <?php echo $showSingle['HARGA_TOTAL']; ?> </span></td>
            </tr>
            <tr>

<?php
	...
	if ($iduser!=1510 && $iduser!=732) $viewdel="false";
	$tgl=$_GET['tgl'];
			...
			<table id="head-table" style="font-size: 12px; float:right;">
				...
				<?php 
					if ($iduser_jual!=""){
						...
						$sqlPrint = "SELECT NO_PENJUALAN, TGL_ACT, NO_KUNJUNGAN, NO_PASIEN, NAMA_PASIEN, JENIS_PASIEN_ID, o.OBAT_NAMA,(ap.PPN/100) * SUM(ap.QTY_JUAL* ap.HARGA_SATUAN) PPN_NILAI,DIJAMIN,
									  o.OBAT_SATUAN_KECIL, SUM(ap.QTY_JUAL*ap.HARGA_SATUAN) total_awal, SUM(ap.QTY_JUAL*ap.HARGA_SATUAN) total_px,
									  SUM(ap.QTY_RETUR*ap.HARGA_SATUAN) total_retur,
				...
				<tr>
					...
					<?php
						...
						$ppn_nilai =floor($ppn_nilai2);  //floor($showPrint['QTY'] * $showPrint['HARGA_SATUAN']);
						$htot+=$jTot;

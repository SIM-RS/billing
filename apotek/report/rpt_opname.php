...
<input name="act" id="act" type="hidden" value="save">
	...
	<div id="idArea" style="display:block">
      ...
      <select name="unit_tujuan" id="unit_tujuan" onchange="location='?f=../report/rpt_opname.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value">
...
<td width="120">Tanggal Periode</td>
      ...
      <button type="button" onclick="location='?f=../report/rpt_opname.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value">
...
(SELECT * FROM a_kartustok WHERE ".$unit_tj." UNIT_ID NOT IN(8,9) AND tipetrans=5 AND TGL_TRANS BETWEEN '$tgl_1' AND '$tgl_2') AS t1

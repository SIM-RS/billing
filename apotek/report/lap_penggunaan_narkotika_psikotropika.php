...
<input name="act" id="act" type="hidden" value="save">
	...
	<div id="idArea" style="display:block">
	  <p><span class="jdltable">LAPORAN KHUSUS PENGGUNAAN NARKOTIKA DAN PSIKOTROPIKA<br/>INSTALASI FARMASI</span></p>
      <table width="48%" align="center" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr>
          <td>Unit</td>
          <td>:<span class="jdltable">
            <select name="unit_tujuan" id="unit_tujuan" onchange="location='?f=../report/lap_penggunaan_narkotika_psikotropika.php&amp;tgl_d='+tgl_d.value+'&amp;tgl_s='+tgl_s.value+'&amp;unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
        ...
        <tr style="display:none">
          ...
          <td>:<span class="jdltable">
          <?php $ckat="ALL";?>
            <select name="kategori" id="kategori" onchange="location='?f=../report/lap_penggunaan_narkotika_psikotropika.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
      ...
      <input type="button" name="Buttontgl_s" value=" V " class="txtcenter" onClick="gfPop.fPopCalendar(this.form.tgl_s,depRange);" />&nbsp;&nbsp;<button type="button" onclick="location='?f=../report/lap_penggunaan_narkotika_psikotropika.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
...
WHERE
	".$unit_tj."
	(ao.OBAT_GOLONGAN = 'N' OR ao.OBAT_GOLONGAN = 'Psi') AND
  ...
  INNER JOIN `rspelindo_billing`.`b_ms_pegawai` d ON c.DOKTER=d.`nama` WHERE a.TGL_TRANS BETWEEN '$tgl_de' AND '$tgl_se' AND b.`OBAT_GOLONGAN` IN ('N','Psi')
  GROUP BY a.`ID`
...
<link rel="stylesheet" href="../theme/print.css" type="text/css" />
	  <table width="98%" align="center" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr> 
          <td colspan="2" align="center" class="jdltable"><p><u>LAPORAN PENGGUNAAN NARKOTIKA DAN PSIKOTROPIKA</u>
              </p></td>
        </tr>
        <tr style="display:none"> 

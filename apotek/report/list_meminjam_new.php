...
function toExcel(){
	var winpopup=window.open("lPmintaGudang.php?tgl_d=<?=$_REQUEST['tgl_d'];?>&tgl_s=<?=$_REQUEST['tgl_s']?>&unit_tujuan=<?=$_REQUEST['unit_tujuan']?>&filter=<?=$_REQUEST["filter"]?>&sorting=<?=$_REQUEST["sorting"]?>");
	/*winpopup.document.write(document.getElementById(cetak).innerHTML);
	winpopup.document.write("<p class='txtinput'  style='padding-right:25px; text-align:right;'>");
	winpopup.document.write("<?php echo '<b>&raquo; Tgl Cetak:</b> '.$tglctk.' <b>- User:</b> '.$username; ?>");
	winpopup.document.write("</p>");
...
<input name="act" id="act" type="hidden" value="save">
	...
	<div id="idArea" style="display:block">
	  <p><span class="jdltable">LAPORAN PENERIMAAN OBAT DARI GUDANG<br>UNIT : <?php echo $namaunit; ?></span></p>
...
<tr>
	<td colspan="4" align="center"><button type="button" onclick="location='?f=../apotik/list_meminjam_new.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value">
			  <img src="../icon/lihat.gif" height="16" width="16" border="0" />&nbsp; Lihat</button></td>
</tr>
<tr style="display:none;">
<td width="120">Unit Pengirim </td>
            <td colspan="2">:
              <select name="unit_tujuan" id="unit_tujuan" onchange="location='?f=../apotik/list_meminjam_new.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value">
			  ...
			  <td width="193">
			  <button type="button" onclick="location='?f=../apotik/list_meminjam_new.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value">
			  <img src="../icon/lihat.gif" height="16" width="16" border="0" />&nbsp; Lihat</button></td>
    </tr>
	</table>
    ...
    <table width="90%" align="center" border="0" cellpadding="1" cellspacing="0">
	 ...
	 <td align="center" colspan="2">&nbsp;
            ...
            <BUTTON type="button" onclick="toExcel()" <?php  if($jmldata==0) echo "disabled='disabled'"; ?>><IMG src="../icon/addcommentButton.jpg" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Convert to Excel</BUTTON>
	 </td>
		</tr>
		</table>
</div>

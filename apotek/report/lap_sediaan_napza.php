...
<input name="act" id="act" type="hidden" value="save">
	...
	<div id="idArea" style="display:block">
	  <p><span class="jdltable">LAPORAN PENGGUNAAN SEDIAAN NARKOTIKA<br/>INSTALASI FARMASI</span></p>
      <table width="48%" align="center" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr>
          <td>Unit</td>
          <td>:<span class="jdltable">
            <select name="unit_tujuan" id="unit_tujuan" onchange="location='?f=../report/lap_sediaan_napza.php&amp;tgl_d='+tgl_d.value+'&amp;tgl_s='+tgl_s.value+'&amp;unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
        ...
        <tr style="display:none">
          ...
          <td>:<span class="jdltable">
          <?php $ckat="ALL";?>
            <select name="kategori" id="kategori" onchange="location='?f=../report/lap_sediaan_napza.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
      ...
      <input type="button" name="Buttontgl_s" value=" V " class="txtcenter" onClick="gfPop.fPopCalendar(this.form.tgl_s,depRange);" />&nbsp;&nbsp;<button type="button" onclick="location='?f=../report/lap_sediaan_napza.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
...
<link rel="stylesheet" href="../theme/print.css" type="text/css" />
	  <table width="40%" align="center" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr> 
          <td colspan="2" align="center" class="jdltable"><p>LAPORAN PENGGUNAAN SEDIAAN NARKOTIKA<br/>INSTALASI FARMASI<br>
              UNIT : 
            <?
	  ...
	  ?>
        <tr class="itemtable" onmouseover="this.className='itemtableMOver'" onmouseout="this.className='itemtable'"> 
          ...
          <td align="center" class="tdisi"><?php if($rows['umur']>=1 && $rows['umur']<=9){ ?>&radic;<?php }?>&nbsp;</td>
          <td align="center" class="tdisi"><?php if($rows['umur']>9){ ?>&radic;<?php }?>&nbsp;</td>
          <td class="tdisi" align="center"><?php echo $rows['namadokter']; ?>&nbsp;</td>
          <td class="tdisi" align="center"><?php echo $rows['spesialis']; ?>&nbsp;</td>
          <td class="tdisi" align="center"><?php echo $rows['ket']; ?>&nbsp;</td>
        </tr>

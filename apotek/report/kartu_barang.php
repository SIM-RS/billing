...
var keywords=par.value;//alert(keywords);
	if(keywords==""){
		...
		if (key==38 || key==40){
			...
			RowIdx=0;
			fKeyEnt=false;
			Request('../transaksi/obatlist.php?aKepemilikan=0&aKeyword='+keywords, 'divobat', '', 'GET' );
...
<div align="center">
  ...
  <div id="listma" style="display:block">
      <p align="center"><span class="jdltable">Kartu Barang Obat/Alkes</span></p>
	  <table>
        <tr> 
          <td>Obat/Alkes</td>
          <td>: <input name="txtObat" id="txtObat" type="text" size="45" class="txtinput" onKeyUp="suggest(event,this);" autocomplete="off"></td>
        </tr>
        <tr> 
          <td width="115">Kepemilikan</td>
          <td>: <select name="kpid" id="kpid">
              <?php 
        ...
        <tr> 
          <td>Tanggal</td>
          <td>: <input name="tgl_d" type="text" id="tgl_d" size="11" maxlength="10" readonly="true" class="txtcenter" value="<?php echo $tgl_d; ?>" /></input> 
...
*/	  ?>
	...
	<p>
        ...
        Kartu Barang</BUTTON-->
	  <BUTTON type="button" onClick="if (obatid.value==''){alert('Pilih Obat/Alkes Terlebih Dahulu !');}else{OpenWnd('../report/kartu_barang_excell.php?obatid='+obatid.value+'&kpid='+kpid.value+'&unitid=<?php echo $idunit; ?>&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&filter=<?php echo $filter; ?>&sorting=<?php echo $sorting; ?>',600,450,'childwnd',true);}"><IMG SRC="../icon/addcommentButton.jpg" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Export ke File Excell</BUTTON>
	</p>
    </div>
	<?php /*?>

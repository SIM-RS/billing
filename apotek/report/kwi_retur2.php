...
$sql="SELECT * FROM a_penjualan WHERE QTY_RETUR>0 AND NO_PENJUALAN='$no_penjualan' AND NO_PASIEN='$no_pasien' AND TGL='$tgl'";
$rs=mysqli_query($konek,$sql);
$ada_retur=mysqli_num_rows($rs);
$retur='';
if ($rows=mysqli_fetch_array($rs)) $retur=$rows['NO_RETUR'];
?>
<html>
<head>
    ...
    <tr> 
      <td colspan="3" ><table width="550" border="0" cellpadding="0" cellspacing="0" align="left">
          ...
          <tr> 
            ...
            <td width="400" class="style1"><?php echo $showPrint['OBAT_NAMA']; ?></td>
            <td colspan="2" align="left" class="style1" <?php if ($i>$k){?>style="border-bottom:1px dashed #999999"<?php }?>><?php echo $showPrint['QTY_JUAL']; ?>&nbsp;&nbsp;-&nbsp;&nbsp;<?php echo $showPrint['QTY_RETUR']; ?>&nbsp;</td>
            <td width="25" class="style1" <?php if ($i>$k){?>style="border-bottom:1px dashed #999999"<?php }?>>= <?php echo $showPrint['QTY']; ?></td>
          </tr>
		  <?php }else{?>
          <tr> 
            <td width="36" align="center" class="style1"><?php echo $i++ ?></td>
            <td width="490" class="style1"><?php echo $showPrint['OBAT_NAMA']; ?></td>
            <td colspan="3" align="left" class="style1" <?php if ($i>$k){?>style="border-bottom:1px dashed #999999"<?php }?>><?php echo $showPrint['QTY_JUAL']; ?></td>
          </tr>
		  <?php }?>
          <? } ?>
          <tr align="right"> 
            <td colspan="4" class="style1" style="padding-right:5px;"><?php if ($ada_retur>0){?>Nilai Awal :<?php }else{?>Nilai Total :<?php }?></td>
            <td class="style1" style="padding-right:10px;"><?php echo number_format($htot,0,",","."); ?></td>
          </tr>
          <tr align="right"> 
            <?php
      function kekata($x) {
      ...
      <?php
	  	if ($ada_retur>0){
			$sql_ret= "SELECT SUM(FLOOR(QTY_RETUR*HARGA_SATUAN*(100-BIAYA_RETUR)/100)) as nretur from a_penjualan where NO_PENJUALAN='$no_penjualan' and UNIT_ID=$idunit and NO_PASIEN='$no_pasien'";
			//echo $sql_ret;
			...
			$stot=$htot-$nretur;		
       ?>
            <td colspan="4" class="style1" style="padding-right:5px;">Nilai Retur :</td>
            <td class="style1" style="padding-right:10px;"><?php echo number_format($nretur,0,",","."); ?></td>
          </tr>
          <tr align="right"> 
            <td colspan="4" class="style1" style="padding-right:5px;">Sub Total :</td>
            <td class="style1" style="padding-right:10px;"><?php echo number_format($stot,0,",","."); ?></td>
          </tr>
          <?php
          ...
          <tr align="left"> 
            <td colspan="5" class="style1" style="padding-right:5px; border-bottom:1px dashed #999999"><?php echo $bilangan2."&nbsp;".$koma2."Rupiah";?></td>
          </tr>
          <tr> 
            <td colspan="5" align="right" class="style1" style="padding-right:5px;text-align:left">Kasir 
              : <?php echo $showSingle['username']; ?></td>
          </tr>
          <tr> 
            <td colspan="5" align="left" style="padding-right:5px;font-size:18px"><div align="left"><span style="font-size:14px; "><em>Bukti 
...
<tr>
	...
	<td width="50%" align="right">
		<BUTTON type="button" style="display:<?php if ($viewdel=="true") echo "block"; else echo "none";?>" onClick="location='../transaksi/hapus_penjualan.php?no_jual=<?php echo $njual; ?>&idunit=<?php echo $idunit; ?>';"><IMG SRC="../icon/hapus.gif" border="0" width="16" height="16" ALIGN="absmiddle">Delete</BUTTON>
	</td>
</tr>
</table>
</div>

...
$kategori=$_REQUEST['kategori']; if ($kategori=="" || $kategori=="0") $kat="ao.OBAT_GOLONGAN IN ('Psi')"; else $kat="ao.OBAT_GOLONGAN IN ('$kategori')";
...
<input name="act" id="act" type="hidden" value="save">
	...
	<div id="idArea" style="display:block">
	  <p><span class="jdltable">LAPORAN PENERIMAAN DAN PENGELUARAN PSIKOTROPIKA</span></p>
      <table width="48%" align="center" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr>
          <td>Unit</td>
          <td>:<span class="jdltable">
            <select name="unit_tujuan" id="unit_tujuan" onchange="location='?f=../report/rpt_napza_new_format.php&amp;tgl_d='+tgl_d.value+'&amp;tgl_s='+tgl_s.value+'&amp;unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
        ...
        <tr>
          ...
          <td>:<span class="jdltable">
          <?php $ckat="ALL";?>
            <select name="kategori" id="kategori" onchange="location='?f=../report/rpt_napza_new_format.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
      ...
      <input type="button" name="Buttontgl_s" value=" V " class="txtcenter" onClick="gfPop.fPopCalendar(this.form.tgl_s,depRange);" />&nbsp;&nbsp;<button type="button" onclick="location='?f=../report/rpt_napza_new_format.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&unit_tujuan='+unit_tujuan.value+'&kategori='+kategori.value">
      ...
      <table width="98%" align="center" cellpadding="1" cellspacing="0" border="0">
        <tr class="headtable"> 
          ...
          <td id="OBAT_NAMA" class="tblheader" onclick="ifPop.CallFr(this);">Nama Sediaan Jadi OKT</td>
          <td align="center" id="NAMA" class="tblheader" onclick="ifPop.CallFr(this);">Satuan</td>
          <td align="center" id="NAMA" width="80" class="tblheader" onclick="ifPop.CallFr(this);">Persediaan Awal</td>
          <td align="center" id="NAMA" width="80" class="tblheader" onclick="ifPop.CallFr(this);">Jumlah Pemasukan</td>
          <td width="40" class="tblheader" id="QTY_SATUAN" onclick="ifPop.CallFr(this);">Jumlah Pengeluaran</td>
          <td id="HARGA_BELI_TOTAL" width="90" class="tblheader" onclick="ifPop.CallFr(this);">Sisa Kahir Tahun</td>
          <td id="HARGA_BELI_TOTAL" class="tblheader" onclick="ifPop.CallFr(this);">Keterangan</td>
        </tr>
        <?php 
	  if ($filter!=""){
...
GROUP BY ao.OBAT_ID,ak.ID,t1.NAMA_PASIEN,t1.ALAMAT ORDER BY ".$sorting;*/
		$sql="SELECT 
  ao.obat_id, ao.OBAT_NAMA, ao.OBAT_SATUAN_KECIL, ak.STOK_BEFOR, SUM(ak.DEBET) AS jml_pemasukan, SUM(ak.KREDIT) AS jml_pengeluaran,
  (SELECT STOK_AFTER FROM a_kartustok WHERE obat_id = ak.OBAT_ID AND unit_id=ak.UNIT_ID AND DATE(TGL_ACT) BETWEEN '$tgl_de' AND '$tgl_se' ORDER BY id DESC LIMIT 1) AS STOK_AFTER
FROM
  a_kartustok ak INNER JOIN a_obat ao ON ak.OBAT_ID = ao.OBAT_ID
WHERE  $unit_tj 
  DATE(TGL_ACT) BETWEEN '$tgl_de' 
  AND '$tgl_se'
  AND ao.OBAT_GOLONGAN IN ('Psi')
...
ORDER BY ".$sorting;
	  ...
	  ?>
        <tr class="itemtable" onmouseover="this.className='itemtableMOver'" onmouseout="this.className='itemtable'"> 
          ...
          <td class="tdisi" align="left"><?php echo $rows['OBAT_SATUAN_KECIL']; ?></td>
          <td class="tdisi" align="left">&nbsp;<?php echo $rows['STOK_BEFOR']; ?></td>
          <td class="tdisi" align="center"><?php echo $rows['jml_pemasukan']; ?></td>
          <td class="tdisi" align="center"><?php echo $rows['jml_pengeluaran']; ?></td>
          <td class="tdisi" align="right"><?php echo $rows['STOK_AFTER']; ?></td>
...
<link rel="stylesheet" href="../theme/print.css" type="text/css" />
	  <table width="98%" align="center" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr> 
          <td colspan="2" align="center" class="jdltable"><p>LAPORAN PENERIMAAN DAN PENGELUARAN PSIKOTROPIKA<br>
              TAHUN : <?=$thn_rpt;?>
            <?
      ...
      <table width="98%" align="center" cellpadding="1" cellspacing="0" border="0">
      <tr>
         <td align="left" style="font-size:12px;">Nama Apotek</td>
         <td align="left" style="font-size:12px;">: <?=$dUnit['UNIT_NAME']."&nbsp;";?>Rumah Sakit Umum Daerah Kota Tangerang</td>
        </tr>
        <tr>
         <td align="left" style="font-size:12px;">SIA</td>
         <td align="left" style="font-size:12px;">: </td>
        </tr>
        <tr>
         <td align="left" style="font-size:12px;">Alamat</td>
         <td align="left" style="font-size:12px;">: JL. Jenderal Sudirman, Kel.Kelapa Indah, Kec.Tangerang<br/>&nbsp;&nbsp;Kota Tangerang</td>
        </tr>
        <tr>
         <td align="left" style="font-size:12px;">Telpon</td>
         <td align="left" style="font-size:12px;">: (021) 29720201-03</td>
        </tr>
      </table>

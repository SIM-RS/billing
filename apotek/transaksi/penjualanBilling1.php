	...
	var i=1;
		...
		if(keywords.length<2){
			...
			if (key==38 || key==40){
				...
				if (key==123){
					RowIdx=0;
					Request('../transaksi/obatlistjual.php?aKepemilikan=0&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas='+kelasObat , 'divobat', '', 'GET' );
					
					linking = '../transaksi/obatlistjual.php?aKepemilikan=0&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas=';
				}else if (key==120){
					alert(RowIdx);
				}else{
					RowIdx=0;
					Request('../transaksi/obatlistjual.php?aKepemilikan='+kpPop+'&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas='+kelasObat , 'divobat', '', 'GET' );
					
					linking = '../transaksi/obatlistjual.php?aKepemilikan='+kpPop+'&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas=';
				}

...
switch ($act){
	case "delete":
		$sql="SELECT ar.*,ap.* FROM a_return_penjualan ar INNER JOIN a_penjualan ap ON ar.idpenjualan=ap.ID INNER JOIN a_penerimaan a 
		...
		if ($jmldata>0){
			...
			$sql="SELECT a.* FROM a_penjualan a INNER JOIN a_penerimaan ap ON a.PENERIMAAN_ID=ap.ID WHERE a.NO_RETUR='$ano_retur' AND a.NO_PENJUALAN='$ano_penjualan' AND ap.OBAT_ID=$aobat_id AND a.UNIT_ID=$idunit";
			$rs1=mysqli_query($konek,$sql);
    ...
    <table width="99%" border="0" cellpadding="1" cellspacing="0">
      <tr class="headtable"> 
        ...
        <td id="NO_PENJUALAN" width="70" class="tblheader" onClick="ifPop.CallFr(this);">No. 
          Penjualan</td>
        <td id="NO_PASIEN" width="70" class="tblheader" onClick="ifPop.CallFr(this);">No. 
          Pasien</td>
        <td id="NAMA_PASIEN" width="170" class="tblheader" onClick="ifPop.CallFr(this);">Nama 
          Pasien </td>
        ...
        <td id="QTY_RETUR" width="40" class="tblheader" onClick="ifPop.CallFr(this);">Qty 
          Return </td>
        <td id="nilai" width="75" class="tblheader" onClick="ifPop.CallFr(this);">Nilai 
          Return </td>

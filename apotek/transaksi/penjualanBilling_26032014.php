              ...
              <tr>
				...
				<tr>
					<td colspan="8" >Tanggal Penjualan &nbsp;
						...
						<input type="button" name="btnTgl" id="btnTglJual" value=" V " class="txtcenter" disabled onClick="gfPop.fPopCalendar(document.getElementById('txtTglJual'),depRange,tidak);" />
						&nbsp;<input type="checkbox" name="manTglJual" id="manTglJual" onclick="setManual(this.checked)"/><label for="manTglJual">&nbsp;set manual</label><br />

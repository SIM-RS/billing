...
<div align="center" id="div_detail" style="display:block">
	<table width="950" border="0" cellspacing="0" cellpadding="0" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
		...
		<tr>
			<td align="center">
            <!--BUTTON type="button" style="float:right" onClick="EditObat();"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Edit</BUTTON><br /><br /-->
...
<script>
	...
	var kpPop,IdResepPop,tObat,tKpid,tHNetto,tHJual,tQty,tQtyStok,tRow;
	function EditObat(p){
	var tmp=p.split("|");
		//alert('edit obat : '+p);
		IdResepPop=tmp[0];

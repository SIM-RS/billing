...
<body>
	...
	<div id="dilayani" style="float:left; width:52%; max-width:52%;">
		...
		<?php
			$sql = "SELECT p.NO_RESEP no_resep, DATE_FORMAT(p.TGL, '%d-%m-%Y') tgl, o.OBAT_ID, o.OBAT_NAMA nama, p.QTY, p.QTY_JUAL, p.QTY_RETUR, (p.QTY_JUAL - p.QTY_RETUR) qty_a, p.RACIKAN, u.UNIT_NAME apotek
					FROM a_penjualan p

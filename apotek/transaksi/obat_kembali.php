...
*/
  ...
  <p align="center">Pengembalian Obat Ke Unit : <?php echo $iunit; ?> Sudah Dikirim</p>
    ...
    Pengembalian&nbsp;&nbsp;</BUTTON>
	</a>&nbsp;<BUTTON type="button" onClick="location='?f=../transaksi/list_kembali.php'"><IMG SRC="../icon/back.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Daftar Pengembalian&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
	</p>
</div>
<?php }else{?>
<script>
    ...
    <div id="listma" style="display:block">
	  ...
	  <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        ...
        <tr>
          <td>Unit Tujuan</td>
          <td>: 
            <select name="unit_tujuan" id="unit_tujuan" onChange="location='?f=../transaksi/obat_kembali&unit_tujuan='+document.forms[0].unit_tujuan.value">
              <?
	  ...
	  while ($rows=mysqli_fetch_array($rs)){
		...
		$sql="select sum(qty_terima-qty_kembali) as qty from a_pinjam_obat where unit_id=$unit_tujuan and unit_tujuan=$idunit and obat_id=$cobat_id and kepemilikan_id=$ckp_id_asal and kepemilikan_id_asal=$ckp_id and (qty_kembali < qty_terima) and status=2 group by obat_id,kepemilikan_id,kepemilikan_id_asal";
		//echo $sql."<br>";
		$rs1=mysqli_query($konek,$sql);
      ...
      <BUTTON type="button" onClick="if (ValidateForm('no_kirim','ind')){fSubmit();}"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;&nbsp;Kirim&nbsp;&nbsp;</BUTTON>
            &nbsp;<BUTTON type="reset" onClick="location='?f=../transaksi/list_kembali.php'"><IMG SRC="../icon/cancel.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Batal&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
          </p>
		<?php }else{?>
	<div id="listma" style="display:block">
	<link rel="stylesheet" href="../theme/print.css" type="text/css" />
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr> 
          <td width="80">No Kirim</td>
          <td width="885">: <?php echo $no_kirim; ?></td>
        </tr>
        <tr> 
          <td width="80">Tgl Kirim</td>
          <td>: <?php echo $tgl_kirim; ?></td>
        </tr>
        <tr>
          <td>Unit Tujuan</td>
      ...
      Pengembalian&nbsp;&nbsp;</BUTTON>
            ...
            &nbsp;<BUTTON type="button" onClick="location='?f=../transaksi/list_kembali.php'"><IMG SRC="../icon/back.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Kembali&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
          </p>
		<?php }?>
</form>
</div>

...
?>
    <table id="tblObat" border="0" cellpadding="1" cellspacing="0">
	  ...
	  //if ($aKepemilikan=="0"){
	  	$sql="select ao.OBAT_ID,ao.OBAT_KODE,ao.OBAT_NAMA,ao.OBAT_SATUAN_KECIL from a_obat ao where ao.OBAT_NAMA like '$aKeyword%' and OBAT_ISAKTIF=1 order by ao.OBAT_NAMA";

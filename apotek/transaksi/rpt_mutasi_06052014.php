...
var kpid1=kpid.options[kpid.options.selectedIndex].label;
	...
	if (p==1){
		OpenWnd('../transaksi/rpt_mutasi_excell.php?tipe='+tipe+'&bulan='+bulan+'&bulann='+bulann+'&tahun='+tahun+'&bulan1='+bulan1+'&bulan1n='+bulan1n+'&tahun1='+tahun1+'&idunit1='+idunit1+'&kpid='+fkpid+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kpid1='+kpid1+'&k1='+k1+'&g1='+g1+'&j1='+j1,600,450,'childwnd',true);
	}else if (p==2){
		OpenWnd('../transaksi/rpt_mutasi_nilai_excell.php?tipe='+tipe+'&bulan='+bulan+'&bulann='+bulann+'&tahun='+tahun+'&bulan1='+bulan1+'&bulan1n='+bulan1n+'&tahun1='+tahun1+'&idunit1='+idunit1+'&kpid='+fkpid+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kpid1='+kpid1+'&k1='+k1+'&g1='+g1+'&j1='+j1,600,450,'childwnd',true);
	}
}
</script>
</html>

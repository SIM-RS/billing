...
/*	function ambilData(key,val){
	...
	var sisipDet;
		...
		url='../transaksi/utils.php?grd=true&act=simpan&idPel='+sisip[4]+'&no_rm='+sisip[3]+'&no_resep='+sisip[2]+'&subtotal='+sTot+'&txtH='+txtH+'&txtT='+txtT+'&txtK='+txtK+'&txtP='+txtP+'&fdata='+tmp+"&idunit=<?php echo $idunit; ?>&iduser=<?php echo $iduser; ?>&shift=<?php echo $shift; ?>&tanggal="+tgl+"&status="+document.getElementById('cmbDilayani').value+"&tgl_act="+tgl_act;
		//alert(url);

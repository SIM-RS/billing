...
/*	function ambilData(key,val){
	...
	r.setColHeader("NO,NO RESEP,NO RM,NAMA PASIEN,TEMPAT LAYANAN,NAMA DOKTER,CARA BAYAR,KEPEMILIKAN,PENJAMIN PASIEN,DETAIL PASIEN,ITER");
	r.setIDColHeader(",no_resep,no_rm,nama_pasien,unit,dokter_nama,cara_bayar,kepemilikan,kso,kso,,");
	r.setColWidth("30,60,70,200,200,150,80,100,200,150,150");
	r.setCellAlign("center,center,center,left,left,center,center,center,center,center,center");
	r.setCellType("txt,txt,txt,txt,txt,txt,txt,txt,txt,txt,txt");
	r.setCellHeight(20);
	r.setImgPath("../icon");

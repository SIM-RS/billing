...
switch ($act){
	case "save":
		...
		for ($i=0;$i<count($arfdata);$i++)
		{
			...
			$sql="select * from a_retur_togudang where OBAT_ID=$arfvalue[0] and KEPEMILIKAN_ID=$arfvalue[3] and NO_RETUR='$noretur'";
			//echo $sql."<br>";
			$rs1=mysqli_query($konek,$sql);
			$idrtr=0;
			if ($rows1=mysqli_fetch_array($rs1)) $idrtr=$rows1['ID_RETUR'];
			$sql="call gd_mutasi($idunit,$id_gudang,$idrtr,'$noretur',$arfvalue[0],$arfvalue[3],$arfvalue[3],$arfvalue[1],7,$iduser,0,'$tglretur','$tglact')";
			//echo $sql."<br>";
			$rs1=mysqli_query($konek,$sql);
    ...
    <table width="82%" border="0" cellpadding="0" cellspacing="0">
      <tr> 
        <td width="100%" align="center"><p>
			<BUTTON type="button" onClick="if (ValidateForm('tglretur,noretur,txtHapusStok,txtAlasan','ind')){fSubmit();}"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Simpan&nbsp;&nbsp;&nbsp;</BUTTON>

...
/*	function ambilData(key,val){
	...
	function CheckedObat(k){
		...
		if (rDet.obj.childNodes[0].childNodes[k-1].childNodes[9].childNodes[0].checked){
			var a = replaceall(rDet.obj.childNodes[0].childNodes[k-1].childNodes[4].innerHTML,'.','');
			var b = replaceall(rDet.obj.childNodes[0].childNodes[k-1].childNodes[6].childNodes[0].innerHTML,'.','');
			//alert(parseFloat(rDet.obj.childNodes[0].childNodes[k-1].childNodes[4].innerHTML));

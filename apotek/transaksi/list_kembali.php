      ...
      <table width="70%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td colspan="6"><span class="txtinput">Bulan : </span> 
            <select name="bulan" id="bulan" class="txtinput" onChange="location='?f=../transaksi/list_kembali.php&bulan='+document.forms[0].bulan.value+'&ta='+document.forms[0].ta.value">
            ...
            <select name="ta" id="ta" class="txtinput" onChange="location='?f=../transaksi/list_kembali.php&bulan='+document.forms[0].bulan.value+'&ta='+document.forms[0].ta.value">
...
//					if ($jmlrec>1) $cstatus="Diterima(-)"; else $cstatus="Diterima";
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td width="30" class="tdisi"><img src="../icon/edit.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Melihat Detail Peminjaman" onClick="location='?f=../transaksi/obat_kembali.php&no_kirim=<?php echo $rows['NOKIRIM']; ?>&isview=true';"></td>
        </tr>
        <?php 
	  }

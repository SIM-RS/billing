...
/*	function ambilData(key,val){
	...
	//----joker----
	var kpPop,IdResepPop,tObat,tKpid,tHNetto,tHJual,tQty,tQtyStok,tRow,tAct;
	function EditObat(p){
	var tmp=p.split("|");
	var tmpId = rDet.getRowId(rDet.getSelRow()).split('|');
		//alert('edit obat : '+p);

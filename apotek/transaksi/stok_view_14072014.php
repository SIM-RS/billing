      ...
      <table>
        <tr> 
          ...
          <td align="center" class="txtinput">: 
            <select name="idunit" id="idunit" class="txtinput" onChange="location='?f=../transaksi/stok_view.php&idunit='+idunit.value+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kategori='+kategori.value+'&stok_S='+stok_S.value">
              <?php
        ...
        <tr> 
          ...
          <td align="center" class="txtinput">: 
            <select name="kelas" id="kelas" class="txtinput" onChange="location='?f=../transaksi/stok_view.php&idunit='+idunit.value+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kategori='+kategori.value+'&stok_S='+stok_S.value">
        ...
        <tr>
          ...
          <td align="center" class="txtinput">:
            <select name="kategori" id="kategori" class="txtinput" onChange="location='?f=../transaksi/stok_view.php&idunit='+idunit.value+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kategori='+kategori.value+'&stok_S='+stok_S.value">
        ...
        <tr> 
          ...
          <td align="center" class="txtinput">: 
            <select name="golongan" id="golongan" class="txtinput" onChange="location='?f=../transaksi/stok_view.php&idunit='+idunit.value+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kategori='+kategori.value+'&stok_S='+stok_S.value">
        ...
        <tr> 
          ...
          <td align="center" class="txtinput">: 
            <select name="jenis" id="jenis" class="txtinput" onChange="location='?f=../transaksi/stok_view.php&idunit='+idunit.value+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kategori='+kategori.value+'&stok_S='+stok_S.value">
		...
		<tr>
			...
			<td align="center" class="txtinput">:
				<select name="stok_S" id="stok_S" onChange="location='?f=../transaksi/stok_view.php&idunit='+idunit.value+'&kelas='+kelas.value+'&golongan='+golongan.value+'&jenis='+jenis.value+'&kategori='+kategori.value+'&stok_S='+stok_S.value">
...
ORDER BY ".$sorting;
	  ...
	  ?>
        <tr> 
          <td colspan="8" class="txtright"><strong>Nilai Total :</strong></td>

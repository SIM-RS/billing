...
<script type="text/javascript" src="../theme/js/ajax2.js"></script>
...
<div id="popPas" style="display:none; width:600px;height:auto;background-color: #80514E;border: 5px solid #CC3366;" class="popup">
<div id="pasiens2" align="left" style="position:absolute; z-index:1; left: 100px; top: 25px; height: 230px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC; layer-background-color: #CCCCCC;"></div>
<table width="600px" height="300" border="0" align="left" cellpadding="0" cellspacing="0" class="style1">
    <tr>
    <td width="100%" colspan="3" align="right"><button style="cursor:pointer" class="popup_closebox" name="batal" id="batal" type="button"><img width="20" align="absmiddle" src="../icon/cancel.gif">&nbsp;&nbsp;Tutup</button></td>
    </tr>
    <tr>
    	<td width="100px">No. KTP</td>
        <td width="10px">:</td>
        <td width="490px"><input type="text" id="ktppatient" readonly="readonly" size="25" />&nbsp;</td>
    </tr>
    <tr>
    	<td width="100px">No. RM</td>
        <td width="10px">:</td>
        <td width="490px"><input type="text" id="nmrrm" readonly="readonly" size="15" />&nbsp;</td>
    </tr>
    <tr>
    	<td width="100px">Nama Pasien</td>
        <td width="10px">:</td>
        <td width="490px"><input type="text" id="namapatient" readonly="readonly" size="30" />&nbsp;</td>
    </tr>
    <tr>
   	  <td width="120px">Jenis Kelamin</td>
        <td width="10px">:</td>
      <td width="470px"><input type="text" id="jenkel" readonly="readonly" size="15" />&nbsp;</td>
    </tr>
    <tr>
   	  <td width="120px">Umur</td>
        <td width="10px">:</td>
      <td width="470px"><input type="text" id="umurpatient" readonly="readonly" size="15" />&nbsp;</td>
    </tr>
    <tr>
   	  <td width="120px">Tanggal/Lahir</td>
        <td width="10px">:</td>
      <td width="470px"><input type="text" id="tglpatient" readonly="readonly" size="15" />&nbsp;</td>
    </tr>
    <tr>
   	  <td width="120px">Alamat</td>
        <td width="10px">:</td>
        <td width="470px"><textarea id="alamatpatient" rows="4" cols="50" readonly="readonly"></textarea>&nbsp;</td>
    </tr>
    <tr>
   	  <td width="120px">No.Telp.</td>
        <td width="10px">:</td>
        <td width="470px"><input type="text" id="telppatient" readonly="readonly" size="15" />&nbsp;</td>
    </tr>
</table>
</div>
<div id="popHTKP" style="display:none; width:300px;height:auto;background-color: #80514E;border: 5px solid #CC3366;" class="popup">
<div id="htkp2" align="left" style="position:absolute; z-index:1; left: 100px; top: 25px; height: 230px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC; layer-background-color: #CCCCCC;"></div>
<table width="300px" height="300" border="0" align="left" cellpadding="0" cellspacing="0" class="style1">
    <tr>
    <td width="100%" colspan="3" align="right"><button style="cursor:pointer" class="popup_closebox" name="batal" id="batal" type="button"><img width="20" align="absmiddle" src="../icon/cancel.gif">&nbsp;&nbsp;Tutup</button></td>
    </tr>
    <tr>
    	<td width="100px">H</td>
        <td width="10px">:</td>
        <td width="490px"><input type="text" id="isiH" readonly="readonly" size="30" />&nbsp;</td>
    </tr>
    <tr>
    	<td width="100px">T</td>
        <td width="10px">:</td>
        <td width="490px"><input type="text" id="isiT" readonly="readonly" size="30" />&nbsp;</td>
    </tr>
    <tr>
    	<td width="100px">K</td>
        <td width="10px">:</td>
        <td width="490px"><input type="text" id="isiK" readonly="readonly" size="30" />&nbsp;</td>
    </tr>
    <tr>
   	  <td width="100px">P</td>
        <td width="10px">:</td>
      <td width="490px"><input type="text" id="isiP" readonly="readonly" size="30" />&nbsp;</td>
    </tr>
</table>
</div>
...
<div id="divobat" align="left" style="position:absolute; z-index:1; left: 100px; top: 25px; height: 230px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC; layer-background-color: #CCCCCC;"></div>
        ...
        <tr id="trObat">
            ...
            <td>:&nbsp;<input type="text" id="newObat" size="55" onKeyUp="suggest(event,this);" autocomplete="off" />
...
<div align="center" id="div_data" >
	<table width="950" border="0" cellpadding="0" cellspacing="0" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
		<!--tr>
			<td height="30"><?php //echo $_SESSION['userNo'] ?>&nbsp;</td>
		</tr-->
		<tr>
			<td height="50">Status Dilayani: 
				...
				<div id="tgll" style="display:inline-block">Tgl Resep&nbsp;
				...
				<div id="rKartu" style="display:inline-block">
					<input type="hidden" name="pelid" id="pelid"/>
					<input type="hidden" name="rmno" id="rmno"/>
					<input type="hidden" name="kunjid" id="kunjid"/>
					<button id="kartuRincian" onclick="kartukendali()" class="txtcenter" >Kartu Kendali</button>
				</div>
				<BUTTON id="cetakResep" style="float:right" type="button" onClick="cetakResep();">&nbsp;COPY RESEP</BUTTON>
				<BUTTON id="btnMutasi" style="float:right" type="button" onClick="KirimUnit();"><IMG SRC="../icon/save.gif" border="0" width="14" height="14" ALIGN="absmiddle">&nbsp;Kirim >> Farmasi Lain</BUTTON>
			</td>
		</tr>
		<tr>
			<td>
				<input type="checkbox" name="setBulan" id="setBulan" onclick="viewBulan(this.checked);" /><label for="setBulan">&nbsp;Filter Bulan</label>
				<div id="showBulan" style="display:none">
					Bulan : <select name="setB" id="setB" class="txtinput">
					...
					&nbsp; Tahun : <select name="setT" id="setT" class="txtinput">
						<?php for ($ii=1;$ii<7;$ii++){?>
							<option value="<?php echo $ta+$ii-5; ?>" class="txtinput"<?php if ($ii==5) echo " selected";?>><?php echo $ta+$ii-5; ?></option>
						<?php }?>
					</select>
					&nbsp;<button onclick="ubahTgl()" >Filter</button>
				</div>
			</td>
		</tr>
		<tr>
			<td style="padding-top:10px;">
				Diagnosa Pasien : <span id="diag"></span>
			</td>
		</tr>
		<tr>
			<td align="center">
			<div id="gridbox" style="width:950px; height:220px; background-color:white; margin-top:10px;"></div>
...
<div align="center" id="div_detail" style="display:block">
	<table width="950" border="0" cellspacing="0" cellpadding="0" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
		...
		<tr>
			<td align="center">
            <IMG SRC="../icon/add.gif" border="0" width="16" height="16" ALIGN="right" id="tambah_obat" title="Klik Untuk Menambah Item Obat" style="padding-right:10px;padding-top:2px;cursor:pointer;" onclick="AddItemObatKlik()">
            ...
            <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center" class="txtinput">
              ...
              <tr>
				...
				<tr>
					<td colspan="8" >Tanggal Penjualan &nbsp;
						: <input name="txtTglJual" type="text" id="txtTglJual" size="11" disabled maxlength="10" readonly="true" class="txtcenter" value="<?php echo $tgl?>" /> 
						<input type="button" name="btnTgl" id="btnTglJual" value=" V " style="cursor:pointer" class="txtcenter" disabled onClick="gfPop.fPopCalendar(document.getElementById('txtTglJual'),depRange,tidak);" />
						&nbsp;<input type="checkbox" name="manTglJual" id="manTglJual" style="cursor:pointer" onclick="setManual(this.checked)"/><label style="cursor:pointer" for="manTglJual">&nbsp;set manual</label><br />
						<span id="pasman" style="display:none;">kata kunci : &nbsp;<input type="password" id="manpas" name="manpas"/></span>
						<br /><br />
						<div id="spanTar1" style="display:none;"></div>
					</td>
				</tr>
                <tr>
                	<td align="center">[H]</td>
                    <td align="center">: &nbsp;<input type="text" id="txtH" class="txtH" /></td>
                    <td align="center">[T]</td>
                    <td align="center">: &nbsp;<input type="text" id="txtT" class="txtT" /></td>
                    <td align="center">[K]</td>
                    <td align="center">: &nbsp;<input type="text" id="txtK" class="txtK" /></td>
                    <td align="center">[P]</td>
                    <td align="center">: &nbsp;<input type="text" id="txtP" class="txtP" /></td>
                </tr>
                </table>
                </td>
              </tr>
...
<script>
	function kartukendali(){
		var a = document.getElementById('pelid').value;
		var b = document.getElementById('rmno').value;
		var url = '../transaksi/kartukendali.php?&idPel='+a+'&norm='+b;
		//alert(url);
		window.open(url);
	}
	function viewBulan(par){
		if(par==true){
			document.getElementById('showBulan').style.display = 'block';
			document.getElementById('tgll').style.display = 'none';
		} else if(par==false){
			document.getElementById('showBulan').style.display = 'none';
			document.getElementById('tgll').style.display = 'inline-block';
		}
		ubahTgl();
	}
	function tidak(){
	...
	function setManual(man){
		//alert(man);
		if(man==true){
			document.getElementById('txtTglJual').disabled = false;
			document.getElementById('btnTglJual').disabled = false;
			document.getElementById('pasman').style.display = 'inline-block';
		} else {
			document.getElementById('manpas').value = '';
			document.getElementById('txtTglJual').disabled = true;
			document.getElementById('btnTglJual').disabled = true;
			document.getElementById('pasman').style.display = 'none';
			document.getElementById('manTglJual').checked = false;
			document.getElementById('txtTglJual').value = '<?php echo $tgl; ?>';
		}
	}
	var RowIdx;
	var fKeyEnt;
	...
	var i=1;
		...
		if(keywords.length<2){
			...
			if (key==38 || key==40){
				...
				if (key==123){
					RowIdx=0;
					Request('../transaksi/obatlistjual.php?aKepemilikan=0&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas='+kelasObat+'&ksoid='+kso_id, 'divobat', '', 'GET' );
					
					linking = '../transaksi/obatlistjual.php?aKepemilikan=0&aHarga='+kpPop+'&ksoid='+kso_id+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas=';
				}else if (key==120){
					alert(RowIdx);
				}else{
					RowIdx=0;
					Request('../transaksi/obatlistjual.php?aKepemilikan='+kpPop+'&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&kelas='+kelasObat+'&ksoid='+kso_id , 'divobat', '', 'GET' );
					
					linking = '../transaksi/obatlistjual.php?aKepemilikan='+kpPop+'&aHarga='+kpPop+'&idunit=<?php echo $idunit; ?>&aKeyword='+keywords+'&no='+i+'&ksoid='+kso_id+'&kelas=';
				}
	...
	function listObat(e,par){
		...
		/* if (key==123){
			...
			OpenWnd('../../apotek/transaksi/list_obat_all.php?idunit=<?php echo $idunit; ?>&kepemilikan='+kpPop+'&actB=pbill',800,500,'msma',true);
		//}
	}
	...
	function ubahTgl(){
		...
		r.setFilter('');
		r.setSorting('');
		//alert(setBulan.checked);
		var bulanSet = document.getElementById('setBulan').checked;
		var url = '';
		if(bulanSet==false){
			url="../transaksi/utils.php?grd=true&tanggal="+document.getElementById('txtTgl').value+"&status="+document.getElementById('cmbDilayani').value+"&idunit=<?php echo $idunit; ?>";
		} else {
			url="../transaksi/utils.php?grd=true&setBulan=1&bulan="+document.getElementById('setB').value+"&tahun="+document.getElementById('setT').value+"&status="+document.getElementById('cmbDilayani').value+"&idunit=<?php echo $idunit; ?>";
		}
		
		if (document.getElementById('cmbDilayani').value=="0"){
		 	document.getElementById('btnMutasi').disabled=false;
		 	document.getElementById('btnSimpan').disabled=false;
		 	document.getElementById('tambah_obat').style.display='inline-block';
		}else{
		 	document.getElementById('btnMutasi').disabled=true;
		 	document.getElementById('btnSimpan').disabled=true;
		 	document.getElementById('tambah_obat').style.display='none';
		}
		//alert(url);
		r.loadURL(url,"","GET");
	...
	var bulanSet = document.getElementById('setBulan').checked;
		...
		if (r.getMaxPage()>0){
			...
			document.getElementById('diag').innerHTML = www[17];
			if(bulanSet == false){
			...
			} else if(bulanSet == true){
				url="../transaksi/utils.php?grdDet=true&no_resep="+no_resep+"&status="+document.getElementById('cmbDilayani').value+"&idunit=<?php echo $idunit; ?>&tanggal="+tgll+"&idpel="+idpel+"&no_penj="+no_penjualan+"&no_rm="+NoRM+"&tgltrans="+tgltrans;
			}
			//document.getElementById('kunji').value = 
			document.getElementById('pelid').value = idpel;
			document.getElementById('rmno').value = NoRM;
			//alert(url);
	...
	//alert(NoRM);
		...
		url="../report/kwi_dosis2.php?no_penjualan="+nPenj+"&idpel="+idpel+"&no_resep="+no_resep+"&sunit=<?php echo $idunit; ?>&no_pasien="+NoRM+"&tgl="+tgl[2]+"-"+tgl[1]+"-"+tgl[0];
		//alert(url);
		window.open(url);
	}
/*	function ambilData(key,val){
	...
	function prosesHTKP(){
	var htkp = rDet.getRowId(rDet.getSelRow()).split('|');
		document.getElementById('txtH').value = htkp[7];
		document.getElementById('txtT').value = htkp[8];
		document.getElementById('txtK').value = htkp[9];
		document.getElementById('txtP').value = htkp[10];	
	}
	...
	function CheckedObat(k){
		...
		var tmpId = rDet.getRowId(k).split('|');
		if (rDet.obj.childNodes[0].childNodes[k-1].childNodes[9].childNodes[0].checked){
			var a = (rDet.obj.childNodes[0].childNodes[k-1].childNodes[4].innerHTML*1); //replaceall (,'.','');
			var b = (rDet.obj.childNodes[0].childNodes[k-1].childNodes[6].childNodes[0].innerHTML*1);
			//alert(a+'||'+b);
			if (tmpId[5]==0 && tmpId[6]==1){
	...
	function detailPasien(idpas1,isi){
		new Popup('popPas',null,{modal:true,position:'center',duration:1});
		/*for(var b=1; b<=isi; b++)
		{
			jQuery("#pasiens").load("../transaksi/detailpasien.php?cek=true&id_patient="+idpas1);
		}*/
		jQuery("#pasiens2").load("../transaksi/detailpasien.php?cek=true&id_patient="+idpas1);
		//url="../transaksi/detailpasien.php?cek=true&id_patient="+idpas1;
		//r.loadURL(url,"","GET");
		document.getElementById('popPas').popup.show();
		
	}
	
	function detailHTKP(htkp1,htkp2,htkp3){
		new Popup('popHTKP',null,{modal:true,position:'center',duration:1});
		/*for(var b=1; b<=isi; b++)
		{
			jQuery("#pasiens").load("../transaksi/detailpasien.php?cek=true&id_patient="+idpas1);
		}*/
		//alert(htkp1,htkp2,htkp3);
		jQuery("#htkp2").load("../transaksi/detailhtkp.php?cek=true&kunj="+htkp1+"&rm="+htkp2+"&res="+htkp3);
		//url="../transaksi/detailpasien.php?cek=true&id_patient="+idpas1;
		//r.loadURL(url,"","GET");
		document.getElementById('popHTKP').popup.show();
...
function prosesData(){
	var tmp,url;
	var tgl=document.getElementById('txtTgl').value;
	var katkun = document.getElementById('manpas').value;
	var tglJual = '';
	if(katkun == 'tarikMANG999'){
		tglJual = document.getElementById('txtTglJual').value;
	}
	//alert(tglJual);
	var sTot=ValidasiText(document.getElementById('tot_harga').value);
	var tgl_act=tgl;
	var sisip=r.getRowId(r.getSelRow()).split('|');
	var txtH=document.getElementById("txtH").value;
	var txtT=document.getElementById("txtT").value;
	var txtK=document.getElementById("txtK").value;
	...
	//Set the two dates
	//alert(tglJual);
	var datecek = tglJual.split('-');
	var nowdate = '<?php echo $tgl2; ?>';
	var nowdates = nowdate.split('-');
	var y2k  = new Date(datecek[2], datecek[1], datecek[0]);
	var today= new Date(nowdates[0], nowdates[1], nowdates[2]);
	
	if (tglJual != ''){
		var diffD = Date.dateDiff('d', y2k, today);
	} else {
		var diffD = 1;
	}
	//alert(diffD);
	...
	var sisipDet;
		...
		if(bulanSet==false){
			url='../transaksi/utils.php?grd=true&act=simpan&idPel='+sisip[4]+'&no_rm='+sisip[3]+'&no_resep='+sisip[2]+'&subtotal='+sTot+'&txtH='+txtH+'&txtT='+txtT+'&txtK='+txtK+'&txtP='+txtP+'&fdata='+tmp+"&idunit=<?php echo $idunit; ?>&iduser=<?php echo $iduser; ?>&shift=<?php echo $shift; ?>&tanggal="+tgl+"&status="+document.getElementById('cmbDilayani').value+"&tgl_act="+tgl_act+"&tglJual="+tglJual;
		} else {
			tgl = sisip[16];
			tgl_act = sisip[16];
			url='../transaksi/utils.php?grd=true&act=simpan&idPel='+sisip[4]+'&no_rm='+sisip[3]+'&no_resep='+sisip[2]+'&subtotal='+sTot+'&txtH='+txtH+'&txtT='+txtT+'&txtK='+txtK+'&txtP='+txtP+'&fdata='+tmp+"&idunit=<?php echo $idunit; ?>&iduser=<?php echo $iduser; ?>&shift=<?php echo $shift; ?>&tanggal="+tgl+"&status="+document.getElementById('cmbDilayani').value+"&tgl_act="+tgl_act+"&tglJual="+tglJual;
	...
	if(diffD >= 0){
		if (confirm('Apakah Data Sudah Benar?')){
			Request('../transaksi/utils.php?act=simpan&idPel='+sisip[4]+'&no_rm='+sisip[3]+'&no_resep='+sisip[2]+'&subtotal='+sTot+'&txtH='+txtH+'&txtT='+txtT+'&txtK='+txtK+'&txtP='+txtP+'&fdata='+tmp+"&idunit=<?php echo $idunit; ?>&iduser=<?php echo $iduser; ?>&shift=<?php echo $shift; ?>&tanggal="+tgl+"&status="+document.getElementById('cmbDilayani').value+"&tgl_act="+tgl_act+"&tglJual="+tglJual, 'spanTar1', '', 'GET',
			function(){
				url="../transaksi/utils.php?grdDet=true&no_resep=&idpel=0&status="+document.getElementById('cmbDilayani').value+"&idunit=<?php echo $idunit; ?>&tanggal=00-00-0000";
				rDet.loadURL(url,"","GET");
				...
				document.getElementById('spanTar1').innerHTML='';
			});
			//r.loadURL(url,"","GET");
			//alert(url);
		...
		alert('Maaf Tanggal BackDate Tidak Boleh Lebh Besar dari Tanggal Sekarang!');
		document.getElementById('btnSimpan').disabled=false;
	}
		clearTimeout(fReload);
		fReload=setTimeout("AutoRefresh()", 120000);
	...
	function EditObat(p){
	var tmp=p.split("|");
	//alert(rDet.getSelRow());
	//rDet.getSelRow();
	var tmpId = rDet.getRowId(tmp[3]).split('|');
		//alert('edit obat : '+p);
		tAct="edit";
		IdResepPop=tmp[0];
		kpPop=tmp[1];
	...
	function SimpanNewObat(){
		...
		if (tAct=="add"){
			if (confirm('Yakin Ingin Menambah Item Obat ?')){
				//alert(tHJual);
				stot=Math.floor((document.getElementById('newQtyObat').value)*tHJual);
				//alert(stot);
				...
				if (tmpNewIdSisip_lstNewObat==""){
					...
					if (confirm('Apakah Data Sudah Betul ?')){
						...
						for (var j=0;j<(ArrtmpNewIdSisip_lstNewObat.length-1);j++){
							...
							cqtyRsp="<span id='qtyRsp-"+(rDet.getMaxRow()+1)+"' style='text-decoration:underline' title='Klik Untuk Mengubah Jumlah Obat Yg Diambil Pasien' onclick='UbahQtyRsp(this,"+ArrtmpNewIdSisip[3]+",1);'>"+ArrtmpNewIdSisip[3]+"</span>";
	...
	function goFilterAndSort(grd){
		...
		//alert(grd);
		if (grd=="gridbox"){
			if(document.getElementById('setBulan').checked == false){
				...
				url="../transaksi/utils.php?grd=true&setBulan=1&bulan="+document.getElementById('setB').value+"&tahun="+document.getElementById('setT').value+"&status="+document.getElementById('cmbDilayani').value+"&idunit=<?php echo $idunit; ?>"+"&filter="+r.getFilter()+"&sorting="+r.getSorting()+"&page="+r.getPage();
			}
			//alert(url);
			r.loadURL(url,"","GET");
	...
	r.setColHeader("NO,NO RESEP,NO RM,NAMA PASIEN,TEMPAT LAYANAN,NAMA DOKTER,CARA BAYAR,KEPEMILIKAN,PENJAMIN PASIEN,DETAIL PASIEN,ITER,HTKP");
	r.setIDColHeader(",no_resep,no_rm,nama_pasien,unit,dokter_nama,cara_bayar,kepemilikan,kso,kso,,,");
	r.setColWidth("30,60,70,200,200,150,80,100,200,150,150,150");
	r.setCellAlign("center,center,center,left,left,center,center,center,center,center,center,center");
	r.setCellType("txt,txt,txt,txt,txt,txt,txt,txt,txt,txt,txt,txt");
	r.setCellHeight(20);
	r.setImgPath("../icon");
	...
	//rDet.attachEvent("onRowClick","prosesHTKP");

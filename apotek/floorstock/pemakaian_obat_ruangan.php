  ...
  <input name="act" id="act" type="hidden" value="save">
    ...
    <div id="listma" style="display:block">
      ...
      <table width="500" align="center">
        ...
        <tr id="trTanggal"> 
          <td colspan="2"> <input name="tgl_d" type="text" id="tgl_d" size="11" maxlength="10" readonly class="txtcenter" value="<?php echo $tgl_d; ?>" /></input> 
            <input type="button" name="Buttontgl_d" value=" V " class="txtcenter" onClick="gfPop.fPopCalendar(this.form.tgl_d,depRange);"/> 
            &nbsp;s/d 
            <input name="tgl_s" type="text" id="tgl_s" size="11" maxlength="10" readonly class="txtcenter" value="<?php echo $tgl_s; ?>" /></input> 

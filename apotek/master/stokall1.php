...
$golongan=$_REQUEST['golongan'];if ($golongan=="") $fgolongan=""; else{ if ($fkelas=="") $fgolongan=" WHERE o.OBAT_GOLONGAN='$golongan'"; else $fgolongan=" AND o.OBAT_GOLONGAN='$golongan'";}
$jenis=$_REQUEST['jenis'];if ($jenis=="") $fjenis=""; else { if (($fkelas=="")&&($fgolongan=="")) $fjenis=" WHERE o.OBAT_KELOMPOK=$jenis"; else $fjenis=" AND o.OBAT_KELOMPOK=$jenis";}
  ...
  <p><span class="jdltable">STOK SELURUH UNIT</span>
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="unit17" width="36" class="tblheader" onClick="ifPop.CallFr(this);">PR</td>
          <td id="unit20" width="36" class="tblheader" onClick="ifPop.CallFr(this);">FS</td>
	...
	$sql="SELECT q.idobat as obat_id,q.OBAT_NAMA obat,q.NAMA kepemilikan,q.KEPEMILIKAN_ID,SUM(q.unit1) AS unit1,SUM(q.unit2) AS unit2,
		SUM(q.unit3) AS unit3,SUM(q.unit4) AS unit4,SUM(q.unit5) AS unit5,SUM(q.unit6) AS unit6,SUM(q.unit7) AS unit7,SUM(q.unit8) AS unit8,SUM(q.unit9) AS unit9,SUM(q.unit11) AS unit11,
		SUM(q.unit12) AS unit12,SUM(q.unit17) AS unit17,SUM(q.unit20) AS unit20,SUM(q.ntotal) AS ntotal,SUM(q.total) AS total
		...
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit7 IS NULL,0,p.unit7) AS unit7,
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit8 IS NULL,0,p.unit8) AS unit8,
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit9 IS NULL,0,p.unit9) AS unit9,
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit11 IS NULL,0,p.unit11) AS unit11,
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit12 IS NULL,0,p.unit12) AS unit12,
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit17 IS NULL,0,p.unit17) AS unit17,
		IF (p.KEPEMILIKAN_ID<>ak.ID OR p.unit20 IS NULL,0,p.unit20) AS unit20,
		...
		FROM (SELECT o.OBAT_ID AS idobat,o.OBAT_NAMA,v.*,unit1+unit2+unit3+unit4+unit5+unit6+unit7+unit8+unit9+unit11+unit12+unit17+unit20 AS total 
		FROM (SELECT * FROM a_obat WHERE OBAT_ISAKTIF=1) AS o LEFT JOIN vstokall AS v ON v.obat_id=o.OBAT_ID  
		LEFT JOIN a_kelas AS kls ON o.KLS_ID=kls.KLS_ID".$fkelas.$fgolongan.$fjenis.$fkategori.") AS p LEFT JOIN a_kepemilikan ak ON 1=1) AS q ".$filter."
	...
	//echo $sql2;
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=1" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit1']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=2" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit2']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=3" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit3']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=4" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit4']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=5" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit5']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=6" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit6']; ?></a></td>
          <td align="right" class="tdisi"><a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=100" onClick="NewWindow(this.href,'name','900','500','yes');return false"><?php echo $rows['unit7']; ?></a></td>
          <td align="right" class="tdisi"><a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=101" onClick="NewWindow(this.href,'name','900','500','yes');return false"><?php echo $rows['unit8']; ?></a></td>
          <td align="right" class="tdisi"><a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=97" onClick="NewWindow(this.href,'name','900','500','yes');return false"><?php echo $rows['unit9']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=11" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit11']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=12" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit12']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=17" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
            <?php echo $rows['unit17']; ?></a></td>
          <td align="right" class="tdisi"> <a href="../master/kartu_stok.php?obat_id=<?php echo $rows['obat_id'];?>&kepemilikan_id=<?php echo $rows['KEPEMILIKAN_ID'];?>&unit_id=20" onClick="NewWindow(this.href,'name','900','500','yes');return false"> 
	  ...
	  ?>
        <tr> 
          ...
          <td colspan="7" align="right"><span class="style1"><strong>Nilai Total 
            :&nbsp;&nbsp;</strong></span></td>
        ...
        <tr> 
          ...
          <td colspan="7" align="left"><div align="left" class="textpaging">Ke 
              Halaman: 
          ...
          <td colspan="9" align="right"> <img src="../icon/next_01.gif" border="0" width="30" height="30" style="cursor:pointer" title="Halaman Pertama" onClick="act.value='paging';page.value='1';document.form1.submit();"> 

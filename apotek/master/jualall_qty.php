  ...
  <div id="listma" style="display:block">
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="AP1" width="36" class="tblheader" onClick="ifPop.CallFr(this);">AP-RS</td>
          <!-- <td id="AP2" width="36" class="tblheader" onClick="ifPop.CallFr(this);">AP-Krakatau</td>
          <td id="AP3" width="36" class="tblheader" onClick="ifPop.CallFr(this);">AP-BICT</td> -->
	  ...
	  $sql="SELECT * FROM 
(SELECT ao.OBAT_NAMA,ak.NAMA,t1.*,t1.AP1+/* t1.AP2+t1.AP3 */+t1.FS  AS QTY_TOTAL FROM a_obat ao INNER JOIN 
      ...
      -- SUM(IF((`a_penjualan`.`UNIT_ID` = 8),(`a_penjualan`.`QTY_JUAL` - `a_penjualan`.`QTY_RETUR`),0)) AS `AP2`,
			...
			SUM(IF((`a_penjualan`.`UNIT_ID` = 14),(`a_penjualan`.`QTY_JUAL` - `a_penjualan`.`QTY_RETUR`),0)) AS `FS`,
	...
	//echo $sql;
	 ...
	 //echo $sql."<br>";
	  ...
	  ?>
        <tr> 
          <td colspan="4"></td>
          <td colspan="2" align="right"><span class="style1">Total :</span></td>
	...
	<link rel="stylesheet" href="../theme/print.css" type="text/css" />
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td class="tblheader" id="OBAT_NAMA" onClick="ifPop.CallFr(this);">Obat</td>
          <td width="90" class="tblheader" id="NAMA" onClick="ifPop.CallFr(this);">Kepemilikan</td>
          <td id="unit2" width="36" class="tblheader" onClick="ifPop.CallFr(this);">AP-RS</td>
          <!-- <td id="unit3" width="36" class="tblheader" onClick="ifPop.CallFr(this);">AP-Krakatau</td>
          <td id="unit4" width="36" class="tblheader" onClick="ifPop.CallFr(this);">AP-BICT</td> -->

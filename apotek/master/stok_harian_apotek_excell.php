...
$workbook->send('Stok_Harian_Apotek'.$tgl.'.xls');
...
$worksheet->write($row, 4, "LAPORAN STOK OBAT HARIAN APOTEK", $sheetTitleFormat);
$row += 1;
...
$worksheet->write($row, $column+2, "Stok Apotek Sebelumnya", $columnTitleFormat);
$worksheet->write($row, $column+3, "Stok Apotek Terkini", $columnTitleFormat);

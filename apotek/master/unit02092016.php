...
switch ($act){
	case "save":
			$sql="insert into a_unit(UNIT_ID,UNIT_NAME,UNIT_TIPE,UNIT_ISAKTIF) values('','$unit_name',$unit_tipe,$unit_isaktif)";
			//echo $sql;
...
<div align="center">
  ...
  <div id="input" style="display:none">
    ...
    <table width="75%" border="0" cellpadding="1" cellspacing="1" class="txtinput">
      ...
      <td>Nama Unit</td>
      	<td>:</td>
        <td ><input name="unit_name" type="text" id="unit_name" class="txtinput" size="25" ></td>
    </tr>
     <tr>
      <td>Tipe Unit</td>
      <td>:</td>
		  <td>
		  <select name="unit_tipe" id="unit_tipe" class="txtinput">
		  <?
	...
	<tr>  
      <td>Status</td>
      <td>:</td>
          <td><select name="unit_isaktif" id="unit_isaktif" class="txtinput">
  ...
  <table width="74%" cellpadding="0" cellspacing="0" border="0">
    ...
    <table border="0" cellspacing="0" cellpadding="1">
	  ...
	  while ($rows=mysqli_fetch_array($rs)){
	  	$i++;		
		$arfvalue="act*-*edit*|*unit_id*-*".$rows['UNIT_ID']."*|*unit_name*-*".$rows['UNIT_NAME']."*|*unit_tipe*-*".$rows['UNIT_TIPE']."*|*unit_isaktif*-*".$rows['UNIT_ISAKTIF'];

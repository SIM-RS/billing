...
<body>
    ...
    <div class="cari">
        <form name="form1" method="post" action="">
            ...
            <button type="button" onclick="location='?f=../master/stok_harian_apotek.php&tgl='+tgl.value">
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="0" style="margin-left: 0; margin-top: 2%">
        <thead>
            <tr class="headtable">
                ...
                <th id="STOK_AFTER" class="tblheader" onClick="ifPop.CallFr(this);">Stok Apotek Sebelumnya</th>
                <th id="qty_stok" class="tblheader" onclick="ifPop.CalLFr(this);">Stok Apotek Terkini</th>
                                    ...
                                    FROM
                                        ...
                                        FROM
                                            ...
                                            FROM
                                                ...
                                                INNER JOIN ( SELECT OBAT_ID, STOK_BEFOR FROM a_kartustok WHERE UNIT_ID = 7 AND TGL_TRANS = '{$tgl}' ORDER BY TGL_ACT ASC ) AS ak ON ak.OBAT_ID = o.OBAT_ID 
                                            ) AS p
                ...
                <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'">
                    ...
                    <td class="tdisi">
                        ...
                        if($stok_terkini['STOK_BEFOR'] == '' or $stok_terkini['STOK_BEFOR'] == null){ ?>
                            <a href="../master/kartu_stok.php?obat_id=<?php echo $val['obat_id']; ?>&kepemilikan_id=1&unit_id=7" onClick="NewWindow(this.href,'name','1200','500','yes');return false">
                                <?= $val['unit1'] ?>
                            </a>
    ...
    <div class="but">
        <BUTTON type="button" onClick="OpenWnd('../master/stok_harian_apotek_print.php?user=<?php echo $username; ?>&filter=<?php echo $jfilter; ?>&sorting=<?php echo $sorting; ?>&tgl=<?= $tglOut ?>',1000,800,'childwnd',true);" <?php if ($jmldata == 0) echo "disabled='disabled'"; ?>><IMG SRC="../icon/printer.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Cetak
            Stok </BUTTON>
        <button type="button" <?php if ($jumlahData == 0) echo "disabled='disabled'"; ?> onClick="OpenWnd('../master/stok_harian_apotek_excell.php?filter=<?php echo $jfilter; ?>&sorting=<?php echo $sorting; ?>&tgl=<?= $tgl ?>',600,450,'childwnd',true);"><IMG SRC="../icon/addcommentButton.jpg" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Export

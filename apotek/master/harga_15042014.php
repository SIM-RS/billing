...
<div align="center">
  ...
  <div id="input" style="display:none">
      ...
      <table width="50%" border="0" cellpadding="1" cellspacing="1" class="txtinput">
        <tr> 
          <td width="120">Nama Obat</td>
          <td width="10">:</td>
          <td ><input name="obatid" id="obat_id" type="hidden" value=""> <input type="text" name="txtObat" id="obat_nama" class="txtinput" size="65" onKeyUp="suggest(event,this);" autocomplete="off" /></td>
        </tr>
        <tr> 
          <td>Kepemilikan</td>
          <td>:</td>
        ...
        <tr> 
          <td>Keuntungan</td>
          <td>:</td>
          <td ><input name="untung" type="text" class="txtright" id="untung" size="4" maxlength="4" onKeyUp="HProsen(1,harga_netto,untung,harga_jual)" autocomplete="off" >
            %</td>
        </tr>
        <tr> 
          <td>Harga Jual</td>
  ...
  <div id="listma" style="display:block">
      ...
      <table width="98%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="HARGA_BELI_SATUAN" width="80" class="tblheader" onClick="ifPop.CallFr(this);">Harga<br>
            Netto </td>
          <td id="PROFIT" width="40" class="tblheader" onClick="ifPop.CallFr(this);">Profit<br>
            (%)</td>
          <td id="harga_j" width="80" class="tblheader" onClick="ifPop.CallFr(this);">Harga<br>
            Jual </td>
        </tr>
        <?php 
	  if ($filter!=""){
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td class="tdisi" align="right"><?php echo number_format($rows['harga_j'],2,",",".");?></td>
        </tr>
        <?php 
	  }
      ...
      <table width="98%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="harga_j" width="80" class="tblheader" onClick="ifPop.CallFr(this);">Harga<br>
            Jual </td>
          <td id="harga_j" width="50" class="tblheader" onClick="ifPop.CallFr(this);">Lock 
            Harga</td>
	  ...
	  <p>
        <BUTTON type="button" onClick="fSubmit();"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Update 
        Lock Harga</BUTTON></p>
    <?php }?>
    </div>
</form>

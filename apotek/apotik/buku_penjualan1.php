...
<iframe height="72" width="130" name="sort"
	...
	<div id="view" style="display:block"> 
      <p><span class="jdltable">BUKU PENJUALAN 
        <select name="idunit" id="idunit" class="txtinput" onchange="location='?f=../apotik/buku_penjualan.php&idunit='+this.value+'&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&jns_pasien='+jns_pasien.value">
	  ...
	  <tr> 
        ...
        <input type="button" name="Buttontgl_d" value=" V " class="txtcenter" onClick="gfPop.fPopCalendar(this.form.tgl_d,depRange);"/>&nbsp;&nbsp;&nbsp;</input>
            ...
            <input name="tgl_s" type="text" id="tgl_s" size="11" maxlength="10" readonly="true" class="txtcenter" onchange="location='?f=../apotik/buku_penjualan.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value" value="<?php if ($_GET['tgl_s']<>'') echo $_GET['tgl_s']; else echo $tgl;?>" ></input> 
        <input type="button" name="Buttontgl_s" value=" V " class="txtcenter" onClick="gfPop.fPopCalendar(this.form.tgl_s,depRange);" /></input>
            ...
            <td colspan="2">: 
			<select name="jns_pasien" id="jns_pasien" class="txtinput" onchange="location='?f=buku_penjualan.php&idunit='+idunit.value+'&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&jns_pasien='+jns_pasien.value">
			  ...
			  <td >
			  <button type="button" onclick="location='?f=../apotik/buku_penjualan.php&idunit='+idunit.value+'&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value+'&jns_pasien='+jns_pasien.value">
      ...
      <table width="98%" align="center" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="u.UNIT_NAME" width="120" class="tblheader" onclick="ifPop.CallFr(this);">Poli<br>
            (Ruangan)</td>
          <td id="DOKTER" width="160" class="tblheader" onclick="ifPop.CallFr(this);">Dokter</td>
...
*/
	  ...
	  $sql="SELECT DATE_FORMAT(a.TGL,'%d/%m/%Y') AS tgl1,a.NO_PENJUALAN,a.NAMA_PASIEN,ao.OBAT_NAMA,SUM(a.QTY_JUAL-a.QTY_RETUR) AS QTY_JUAL,
		...
		WHERE a.TGL BETWEEN '$tgl_1' AND '$tgl_2'".$junit.$jns_p.$filter."
	...
	//echo $sql."<br>";
	 ...
	 //$hartot=$hartot+$rows['HARGA_TOTAL'];
	  ...
	  ?>
        <tr> 
          <td colspan="6"  align="right" class="txtright">Jumlah Total &nbsp; 
          </td>
        ...
        <tr align="center"> 
          <td colspan="10"><a class="navText" href='#' onclick='PrintArea("idArea","#")'>&nbsp; 
            <button type="button" <?php  if($jmldata==0) echo "disabled='disabled'"; ?>><img src="../icon/printer.png" border="0" width="16" height="16" align="absmiddle" onclick="document.getElementById('idArea').style.display='block'" />&nbsp;Cetak 

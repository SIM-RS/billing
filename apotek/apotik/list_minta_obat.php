    ...
    <div id="listma" style="display:block">
      ...
      <table width="70%" border="0" cellpadding="1" cellspacing="0">
		...
		while ($rows=mysqli_fetch_array($rs)){
			...
			/* $sql = "SELECT status, COUNT(CASE WHEN status = 7 THEN 1 END) jml 
					FROM (SELECT DISTINCT status
							FROM a_minta_obat
							WHERE no_bukti = '$c_no_bukti' 
							ORDER BY STATUS DESC) tb"; */
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td width="25" class="tdisi" align="center"><img src="../icon/edit.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Melihat Detail Permintaan" onClick="location='?f=../apotik/minta_obat.php&no_minta=<?php echo $rows['no_bukti']; ?>&unit_tujuan=<?php echo $rows['UNIT_ID']; ?>&tglminta=<?php echo $rows['tgl1']; ?>&isview=true&bulan=<?php echo $bulan; ?>&ta=<?php echo $ta; ?>';"></td>

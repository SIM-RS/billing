...
$row++;
  ...
  if ($sorting=="") $sorting=$defaultsort;
	/*$sql="SELECT date_format(a_penjualan.TGL,'%d/%m/%Y') as tgl1,a_penjualan.TGL, a_penjualan.NO_PENJUALAN,am.NAMA AS KSO, a_penjualan.NO_RESEP, a_penjualan.NO_PASIEN, a_penjualan.NAMA_PASIEN, 
		...
		GROUP BY a_penjualan.NO_PENJUALAN,a_penjualan.JENIS_PASIEN_ID,a_penjualan.NO_PASIEN ORDER BY ".$sorting;*/
	...
	$sql="SELECT DATE_FORMAT(a_penjualan.TGL,'%d/%m/%Y') AS tgl1,a_penjualan.TGL,a_penjualan.UNIT_ID, a_penjualan.NO_PENJUALAN,am.NAMA AS KSO, a_penjualan.NO_RESEP, a_penjualan.NO_PASIEN, a_penjualan.NAMA_PASIEN, a_penjualan.USER_ID, 
		...
		WHERE $tmpunit (a_penjualan.TGL BETWEEN '$tgl_d1' AND '$tgl_s1')".$jns_p.$statusp.$filter." 

...
convert_var($tgl,$tglctk,$tgl_d,$tgl_s);
...
convert_var($tgl_d1,$tgl_s1,$tgl2);
...
convert_var($idunit1,$kpid,$page,$sorting,$filter);
//===============================
  ...
  <input name="act" id="act" type="hidden" value="save">
    ...
    <div id="listma" style="display:block">
        ...
        <tr> 
          ...
          <td align="center" class="txtinput">: 
            <select name="idunit" id="idunit" class="txtinput" onChange="location='?f=../apotik/permintaan_tak_terlayani.php&idunit='+idunit.value+'&kpid='+kepemilikan.value+'&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value">
              ...
              <?
		  $qry="SELECT * FROM a_unit WHERE (UNIT_TIPE=2 OR UNIT_TIPE=5) AND UNIT_ID<>".$idunit." AND UNIT_ISAKTIF=1";
	  ...
	  $sql="SELECT * FROM (SELECT 
		...
		WHERE  (am.qty - am.qty_terima) > 0  AND am.unit_tujuan=".$idunit." $fwaktu $funit $fkpid
		ORDER BY am.tgl,

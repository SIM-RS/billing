...
$page=$_REQUEST["page"];
$defaultsort="t1.tgl desc,t1.peminjaman_id";
    ...
    <div id="listma" style="display:block">
      ...
      <table width="99%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td colspan="6"><span class="txtinput">Bulan : </span> 
            <select name="bulan" id="bulan" class="txtinput" onChange="location='?f=list_pinjam_obat.php&bulan='+document.forms[0].bulan.value+'&ta='+document.forms[0].ta.value">
            ...
            <select name="ta" id="ta" class="txtinput" onChange="location='?f=list_pinjam_obat.php&bulan='+document.forms[0].bulan.value+'&ta='+document.forms[0].ta.value">
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="status" width="60" class="tblheader" onClick="">Status</td>
          <td id="status" width="30" class="tblheader" onClick="">Det</td>
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td class="tdisi" align="center"><?php echo ($rows['qty']-$rows['qty_terima']); ?></td>
          <td class="tdisi" align="center"><?php echo $cstatus; ?></td>
		  <td class="tdisi" align="center"><a href="../report/rpinjam_obat.php?no_bukti=<?php echo $rows['no_bukti'];?>&unit_tujuan=<? echo $rows['UNIT_NAME']; ?>&sunit=<?php echo $idunit;?>&user=<? echo $username; ?>" onClick="NewWindow(this.href,'name','1000','500','yes');return false"><img src="../icon/lihat.gif" border="0" width="16" height="16" align="absmiddle" title="Klik Untuk Melihat Detail"></a></td>

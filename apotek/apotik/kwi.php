...
<div id="idArea" style="display:block;">
	...
	$qrySingle="SELECT a_penjualan.*,a_kepemilikan.NAMA,a_user.username from a_penjualan Inner Join a_kepemilikan ON a_penjualan.JENIS_PASIEN_ID = a_kepemilikan.ID Left Join a_user on a_penjualan.USER_ID=a_user.kode_user WHERE a_penjualan.NO_PENJUALAN=$no_penjualan and UNIT_ID=$idunit limit 1";
	...
	<!--link rel="stylesheet" href="../theme/print.css" type="text/css"/-->
		...
		<table width="413" height="113" border="0" align="left" cellpadding="0" cellspacing="0" class="style1">
         <tr class="style1">
          ...
          <tr>
            <td colspan="2"><? $u="select UNIT_NAME from a_unit where UNIT_ID='$idunit'";
								//echo $u;

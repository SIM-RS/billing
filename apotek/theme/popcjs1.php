...
var gBegin=[tanggal.getFullYear()-4,1,1];	// Valid Range begin from [Year,Month,Date]
...
function fSetDate(y,m,d){
  ...
  fHideCal();
  eval(action);
  parent.document.getElementById('penerimaan1').src='../transaksi/isi_penerimaan.php?tipe=1&par='+fFormatDate(d,m,y);
}

...
<div align="center">
  <p align="center">Pengiriman Obat Dgn No Kirim : <?php echo $no_kirim; ?> Sudah 
    ...
    Pengiriman&nbsp;&nbsp;</BUTTON>
	&nbsp;
    <BUTTON type="button" onClick="location='?f=../gudang/list_permintaan.php'"><IMG SRC="../icon/back.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Daftar 
	...
	<link rel="stylesheet" href="../theme/print.css" type="text/css" />
	  ...
	  ?>
		...
		<p align="center">
            ...
            &nbsp;<BUTTON type="reset" onClick="location='?f=../gudang/list_permintaan.php'"><IMG SRC="../icon/cancel.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Batal&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
          </p>
</form>
</div>
<?php } ?>

...
<iframe height="72" width="130" name="sort"
	...
	<p><span class="jdltable">DAFTAR PEMINJAMAN OBAT </span> 
    ...
    <table width="90%" align="center" border="0" cellpadding="1" cellspacing="0">
      <tr class="headtable">
        <td id="" width="35" height="25" class="tblheaderkiri" onclick="">No</td>
        <td id="TGL_ACT" width="69" class="tblheader" onclick="ifPop.CallFr(this);">Tgl Act</td>
        <td id="NO_PASIEN" width="70" class="tblheader" onclick="ifPop.CallFr(this);">No RM</td>
		<td id="NAMA_PASIEN" width="111" class="tblheader" onclick="ifPop.CallFr(this);">Nama Pasien</td>
        <td id="NO_KUNJUNGAN" width="108" class="tblheader" onclick="ifPop.CallFr(this);">No Kunjungan</td>
		<td id="NAMA" width="108" class="tblheader" onclick="ifPop.CallFr(this);">Jenis Pasien</td>
        <td id="OBAT_NAMA" width="145" class="tblheader" onclick="ifPop.CallFr(this);">Item </td>
        <td width="42" class="tblheader" id="QTY" onclick="ifPop.CallFr(this);">QTY</td>
        <td id="HARGA_SATUAN" width="60" class="tblheader" onclick="ifPop.CallFr(this);">Harga</td>
        <td id="SUM_SUB_TOTAL" width="64" class="tblheader" onclick="ifPop.CallFr(this);">Total </td>
        <td width="120" class="tblheader" id="DOKTER" onclick="ifPop.CallFr(this);">Dokter</td>
        <td id="UNIT_NAME" width="131" class="tblheader" onclick="ifPop.CallFr(this);">Ruangan</td>
	...
	$sql="Select a_penjualan.UNIT_ID,a_penjualan.TGL,a_penjualan.TGL_ACT,a_penjualan.NO_KUNJUNGAN,a_penjualan.NO_PASIEN,a_penjualan.QTY,a_penjualan.HARGA_SATUAN,a_penjualan.SUM_SUB_TOTAL,a_penjualan.DOKTER,a_penjualan.RUANGAN,a_penjualan.NAMA_PASIEN,a_obat.OBAT_NAMA,a_kepemilikan.NAMA,a_unit.UNIT_NAME,a_kepemilikan.NAMA From a_penjualan Left Join a_penerimaan ON a_penjualan.PENERIMAAN_ID = a_penerimaan.ID Left Join a_obat ON a_penerimaan.OBAT_ID = a_obat.OBAT_ID Left Join a_kepemilikan on a_penerimaan.KEPEMILIKAN_ID = a_kepemilikan.ID Left Join a_unit ON a_penjualan.RUANGAN = a_unit.UNIT_ID where a_penjualan.UNIT_ID=$idunit and a_penjualan.TGL between '$tgl_1' and '$tgl_2'" .$jns_p.$filter." order by " .$sorting;
      ...
      <tr class="itemtable" onmouseover="this.className='itemtableMOver'" onmouseout="this.className='itemtable'">
        ...
        <td width="131" class="tdisi">&nbsp;<?php echo $rows['UNIT_NAME']; ?></td>
      </tr>
      <?php 
	  }
	...
	<table width="48%" border="0" align="center" cellpadding="1" cellspacing="0" class="txtinput">
	  <tr> 
          <td width="127">Tanggal Periode</td>
          <td width="177">:<?php echo $_GET['tgl_d'];?> 
		</td>
			<td width="43" align="center">s/d</td>
		    <td colspan="" width="179">: <?php echo $_GET['tgl_s'];?>
		</td>
	  </tr>
			<tr>
			<td width="127">Jenis Pasien </td>
            <td colspan="2">: 
			<select name="pasien" id="pasien" class="txtinput">
    ...
    <table width="80%" align="center" border="0" cellpadding="1" cellspacing="0">
      <tr class="headtable">
		...
		<td id="NAMA_PASIEN" width="73" class="tblheader" onclick="ifPop.CallFr(this);">Nama Pasien</td>
   ...
   <tr>
	...
	<tr>
	 <td align="center" colspan="2"><a class="navText" href='#' onclick='PrintArea("idArea","#")'>&nbsp;
		<BUTTON type="button" <?php  if($jmldata==0) echo "disabled='disabled'"; ?>><IMG SRC="../icon/printer.png" border="0" width="16" height="16" ALIGN="absmiddle" onclick="document.getElementById('idArea').style.display='block'">&nbsp;Cetak Penjualan</BUTTON></a></td>
	  </tr>
	  </table>
  	</form>
  </div>

...
<div align="center">
  <form name="form1" method="post" action="">
    ...
    <div id="listma" style="display:block">
      <p><span class="jdltable">DAFTAR PENGIRIMAN PRODUKSI KE GUDANG</span></p>
      ...
      <table width="60%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="tgl" width="100" class="tblheader" onClick="ifPop.CallFr(this);">Tgl 
            Kirim</td>
	  ...
	  $sql="select distinct date_format(TANGGAL,'%d/%m/%Y') as tgl1,date_format(TGL_TERIMA,'%d/%m/%Y') as tgl2,NOKIRIM,NOTERIMA,STATUS from a_penerimaan where TIPE_TRANS=1 and UNIT_ID_TERIMA=$idunit and UNIT_ID_KIRIM<>0 and month(TANGGAL)=$bulan and year(TANGGAL)=$ta" .$filter." group by NOKIRIM order by ".$sorting;
	  //echo $sql."<br>";
	  ...
	  while ($rows=mysqli_fetch_array($rs)){
		...
		switch ($istatus){
			case 0:
				$cstatus="Dikirim";
				$lnk="?f=list_penerimaan_detail.php&no_kirim=".$rows['NOKIRIM'];
				break;
			case 1:
				$cstatus="Diterima";
				$lnk="?f=list_penerimaan_detail.php&no_kirim=".$rows['NOKIRIM']."&isview=true";
				break;
		}
	  ?>

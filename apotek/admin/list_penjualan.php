...
$kso_id=$_REQUEST['kso_id'];if($kso_id=="" OR $kso_id=="0") $kso=""; else $kso=" and am.IDMITRA=$kso_id";
$status_inap=$_REQUEST['status_inap'];if($status_inap=="" OR $status_inap=="0") $status_i=""; else $status_i=" and a_unit.status_inap=$status_inap";
$ninap='All Pasien';
$nkso='All KSO';

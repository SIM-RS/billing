		...
		if ($rows1=mysqli_fetch_array($rs1)){
			...
			switch ($istatus){
				case 0:
					...
					$cevent2="location='?f=list_dipinjam_detail.php&no_bukti=".$rows['no_bukti']."&iunit=".$rows['UNIT_NAME']."&tgl_pinjam=".$rows['tgl1']."';";
					break;
				case 1:
					if ($jmlrec>1){
						$cstatus="Dikirim(-)";
						$cevent1="location='?f=list_sdh_dipinjam_detail&no_bukti=".$rows['no_bukti']."&iunit=".$rows['UNIT_NAME']."&tgl_pinjam=".$rows['tgl1']."';";
						$cevent2="location='?f=list_dipinjam_detail.php&no_bukti=".$rows['no_bukti']."&iunit=".$rows['UNIT_NAME']."&tgl_pinjam=".$rows['tgl1']."';";
					}else{
						$cstatus="Dikirim";
						$cevent1="location='?f=list_sdh_dipinjam_detail&no_bukti=".$rows['no_bukti']."&iunit=".$rows['UNIT_NAME']."&tgl_pinjam=".$rows['tgl1']."';";
...
*/
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td width="30" class="tdisi"><img src="../icon/lihat.gif" border="0" width="25" height="25" align="absmiddle" class="proses" title="Klik Untuk Melihat Detail Obat Yg Dipinjam" onClick="location='?f=list_dipinjam_detail.php&isview=true&no_bukti=<?php echo $rows['no_bukti']; ?>&iunit=<?php echo $rows['UNIT_NAME']; ?>&tgl_pinjam=<?php echo $rows['tgl1']; ?>';"></td>

  ...
  <form name="form1" method="post" action="">
    ...
    <div id="listma" style="display:block">
	  ...
	  <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
        <tr> 
          <td width="116">No Penerimaan</td>
          <td width="257">: 
            <input name="no_terima" type="text" id="no_terima" size="25" maxlength="30" class="txtcenter" value="<?php echo $no_terima2; ?>"></td>
          <td width="105">No Permintaan</td>
          <td width="193">: <?php echo $no_minta; ?></td>
          <td width="114">No Kirim Gudang</td>
          <td width="167">: <?php echo $no_gdg; ?></td>
        </tr>
        <tr> 
          <td width="116">Tgl Penerimaan</td>
          <td>: 
	 ...
	 <table><tr> 
		...
		<link rel="stylesheet" href="../theme/print.css" type="text/css" />
		  ...
		  <table width="99%" border="0" cellpadding="1" cellspacing="0" class="txtinput">
			...
			<td width="260">: <?php echo $no_terima; ?></td>
			  <td width="105">No Permintaan</td>
			  <td width="194">: <?php echo $no_minta; ?></td>
			  <td width="113">No Kirim Gudang</td>
			  <td width="164">: <?php echo $no_gdg; ?></td>
	...
	*/
		...
		<p align="center">
            ...
            <BUTTON type="button" onClick=""><IMG SRC="../icon/printer.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;&nbsp;Cetak Penerimaan&nbsp;&nbsp;</BUTTON>
			</a>
            &nbsp;<BUTTON type="button" onClick="location='?f=list_penerimaan.php'"><IMG SRC="../icon/back.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Kembali&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
    </p>
		<?php }?>

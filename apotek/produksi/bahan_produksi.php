...
<div align="center" style="display:block">
      <table width="80%" border="0" cellpadding="1" cellspacing="0">
        <tr> ` 
          <td align="center" class=""><span class="jdltable">LAPORAN BAHAN PRODUKSI 
            OBAT</span></td>
        </tr>
        <tr> 
          <td class="txtcenter">Tgl Produksi&nbsp; 
            ...
            &nbsp;&nbsp;<button type="button" onClick="location='?f=../produksi/bahan_produksi.php&tgl_d='+tgl_d.value+'&tgl_s='+tgl_s.value"><img src="../icon/lihat.gif" height="16" width="16" border="0" align="absmiddle" /></button>&nbsp; 
            Lihat</td>
        </tr>
      </table>
      ...
      <table width="98%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td width="80" class="tblheader" id="tgl" onClick="ifPop.CallFr(this);">Tgl 
            Produksi</td>
          <td width="120" class="tblheader" id="no_produksi" onClick="ifPop.CallFr(this);">No 
            Produksi</td>
          <td width="80" class="tblheader" id="OBAT_KODE" onClick="ifPop.CallFr(this);">Kode 
            Obat</td>
          <td id="OBAT_NAMA" class="tblheader" onClick="ifPop.CallFr(this);">Bahan 
            Produksi</td>
          ...
          <td width="40" class="tblheader" id="qty_lama" onClick="ifPop.CallFr(this);">Qty</td>
	...
	?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td class="tdisi"><?php echo $show['no_produksi']; ?></td>
...
<div align="center" id="idArea" style="display:none">
  ...
  <table width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
	...
	?>
      ...
      <td align="center" class="tdisi"><?php echo $show['no_produksi']; ?></td>

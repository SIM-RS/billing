...
$no_terima1=$_REQUEST['no_terima1'];
$tgl_terima1=$_REQUEST['tgl_terima1'];
 	...
 	case "save":
		...
		for ($j=0;$j<count($arfvalue);$j++){
			...
			if ($arfdata[1]==$arfdata[2]){
				$sql="update a_penerimaan set STATUS=1,TGL_PINJAM_TERIMA='$tgl_terima',TGL_PINJAM_TERIMA_ACT='$tgl_act' where NOKIRIM='$no_kirim' and OBAT_ID=$arfdata[0]";
				//echo $sql."<br>";
...
//if ($isview==""){
	$sql="select NOTERIMA from a_penerimaan where UNIT_ID_TERIMA=$idunit and NOTERIMA like '$kodeunit/PT/$th[2]-$th[1]/%' order by NOTERIMA desc limit 1";
	$rs=mysqli_query($konek,$sql);
...
<p align="center"><b>Peminjaman Obat Dari <?php echo strtoupper($iunit); ?> Sudah Diterima Dgn 
  No Penerimaan : <?php echo $no_terima; ?></b></p>
	<!--p align="center">
    ...
    <div id="listma" style="display:block"> 
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="qty" width="40" class="tblheader">Qty<br>
            Minta</td>
          <td id="qty_terima" width="40" class="tblheader">Qty 
            Sdh Terima</td>
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td class="tdisi" align="center"><input name="qty_kirim" type="hidden" size="4" maxlength="4" class="txtcenter" value="<?php echo $rows['OBAT_ID'].'|'.$rows['qty_kirim']; ?>"><input name="qty_terima" type="text" size="4" maxlength="4" class="txtcenter" value="<?php echo $rows['qty_kirim']; ?>"></td>
        </tr>
        <?php 
	  }
    ...
    <table width="99%" border="0" cellpadding="1" cellspacing="0">
      ...
      <tr> 
		...
		<p align="center">
            ...
            &nbsp;<BUTTON type="button" onClick="location='?f=list_pinjam_terima.php'"><IMG SRC="../icon/back.png" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Kembali&nbsp;&nbsp;&nbsp;&nbsp;</BUTTON>
          </p>
	   </div>
	</div>
<?php

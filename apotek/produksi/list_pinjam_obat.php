...
$page=$_REQUEST["page"];
$defaultsort="am.tgl,am.peminjaman_id";
      ...
      <table width="99%" border="0" cellpadding="1" cellspacing="0">
        <tr class="headtable"> 
          ...
          <td id="OBAT_NAMA" class="tblheader" onClick="ifPop.CallFr(this);">Nama 
            Obat</td>
		  <td id="UNIT_NAME" class="tblheader" onClick="ifPop.CallFr(this);">Unit Tujuan</td>
          <td id="OBAT_SATUAN_KECIL" width="80" class="tblheader" onClick="ifPop.CallFr(this);">Satuan Kecil</td>

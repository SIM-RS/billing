...
<div align="center">
  <form name="form1" method="post" action="">
    ...
    <div id="listma" style="display:block">
      <p><span class="jdltable">DAFTAR OBAT YANG SUDAH DIPRODUKSI</span></p>
      <table width="60%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td width="315"><span class="txtinput">Bulan : </span> 
            <select name="bulan" id="bulan" class="txtinput" onChange="location='?f=list_produksi.php&bulan='+document.forms[0].bulan.value+'&ta='+document.forms[0].ta.value">
            ...
            <select name="ta" id="ta" class="txtinput" onChange="location='?f=list_produksi.php&bulan='+document.forms[0].bulan.value+'&ta='+document.forms[0].ta.value">
		  ...
		  <!--BUTTON type="button" onClick="location='?f=produksi_obat.php'"><IMG SRC="../icon/add.gif" border="0" width="16" height="16" ALIGN="absmiddle"> 
	  ...
	  ?>
        <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
          ...
          <td class="tdisi" align="center"><img src="../icon/edit.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Melihat Detail Produksi" onClick="location='?f=produksi_obat.php&no_produksi=<?php echo $rows['no_produksi']; ?>&tgl_produksi=<?php echo $rows['tgl1']; ?>&kp_id=<?php echo $rows['ID']; ?>&fasal=rpt&isview=true';"></td>
        </tr>
        <?php 
	  }

  ...
  <tr class="H">
	...
	<table width="637" border="0" align="center" id="menuatas">
      <tr style="border-right:#FFFFFF">
        <td width="321" align="right"><a class="navText" id="link2" style="cursor:pointer" onMouseOver="MM_showMenu(window.mm_menu_0814123211_8,-150,0,null,'link2');" onMouseOut="MM_startTimeout();">E1. Permintaan Obat &laquo;</a></td>
        <td width="19" rowspan="5" align="center" id style="border-right:1px solid #FFFFFF; border-left:1px solid #FFFFFF">&nbsp;</td>
        <td width="283" align="left"><a class="navText" href="?f=../apotik/list_penerimaan.php">&raquo; E2. Penerimaan dari Gudang </a></td>
      </tr>
      <tr>
        <td align="right"><a class="navText" href="?f=list_produksi_obat.php"> E3. Produksi Obat &laquo;</a></td>
        <td align="left"><a class="navText" href="?f=../transaksi/list_retur_kegudang.php">&raquo; E4. Retur Ke Gudang </a></td>
      </tr>
      <tr>
         <td align="right"><a class="navText" href="?f=../transaksi/stok.php"> E5. Stok Opname &laquo;</a></td>
         <td align="left"><a class="navText" id="link3" style="cursor:pointer" onMouseOver="MM_showMenu(window.mm_menu_0814123211_7,100,0,null,'link3');" onMouseOut="MM_startTimeout();">&raquo; E6. Laporan </a></td>
      </tr>
      <tr>
         <td align="right"><a class="navText" href="?f=../gudang/list_pinjam_obat.php">E7. Pindah Kepemilikan&laquo;</a></td>
         <td align="left"><a class="navText" href="?f=../transaksi/tutupbuku.php">&raquo; E8. Close Month</a></td>
      </tr>
      <tr>
         <td align="right"><a class="navText" href="?f=../master/sop.php">&raquo; E.9 View SOP</a></td>
         <td align="left">&nbsp;</td>
      </tr>
    </table>

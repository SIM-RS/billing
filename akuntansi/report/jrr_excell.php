...
$workbook->send('JRR.xls');

//Creating a worksheet
$worksheet=&$workbook->addWorksheet('JRR');
...
$sql="SELECT a.no_kw, a.uraian,DATE_FORMAT(a.tgl,'%d-%m-%Y') tanggal,a.debit,a.kredit FROM jurnal a 
 ...
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.TIPE_JURNAL='$tipe' AND a.flag='$flag' AND a.`NO_KW` NOT LIKE '%JP%'"; //decyber
$rs=mysql_query($sql);
$i=0;

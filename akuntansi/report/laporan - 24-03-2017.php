            ...
            <tr style="display:none"> 
              ...
              <table width="800" cellspacing="0" cellpadding="0" class="bodyText12" border="1" style="border-collapse:collapse">
                <tr>
                  ...
                  <td align="center">Uraian</td>
                  <td width="160" align="center"><?php if($bulan_lr < 3){ echo '01'."-".$ta_lr; }else{ echo '01'."-".$ta_lr." s/d ".((($bulan_lr-1)<10)?"0".($bulan_lr-1):($bulan_lr-1))."-".$ta_lr ;} ?> </td>
				  <td width="160" align="center"><?php echo (($bulan_lr<10)?"0".$bulan_lr:$bulan_lr)."-".$ta_lr;?></td>
                </tr>
                <?php 

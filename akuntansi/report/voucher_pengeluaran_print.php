...
<?php
            ...
            if($statusPosting == 0 && isset($statusPosting)){
                ...
                if (isset($id_posting)){
                    $sql = "SELECT j.*, s.MA_ID, s.MA_KODE, s.MA_KODE_KP, s.MA_PARENT_KODE, s.MA_PARENT, 
                            ...
                            CONCAT(s.MA_KODE_VIEW, ' ',IFNULL(bj.kode,'')) fullkode
    ...
    <table width="1038" height="258" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr align="center">
            <td colspan="2">
                <p style="background:#ECECEC;"><u>BUKTI PENGELUARAN KAS - BANK</u></p>
            ...
            <td height="40">
                <div class="box" style="border: 1px solid black; padding: 8px;">
                    <table class="table1" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                        ...
                        <tr style="vertical-align:top">
                            <td width="25">1. </td>
                            <td width="350">Pemegang kas harap mengeluarkan uang sebesar</td>
                            <td>:</td>
                        ...
                        <tr style="vertical-align:top">
                            ...
                            <td>:</td>
                            <td><?php echo ucwords(terbilang($total['debit'])." Rupiah."); ?></td>
                        </tr>

                        <tr style="vertical-align:top">
                            <td width="25">3. </td>
                            <td width="350">Kepada</td>
                            <td>:</td>
                        ...
                        if($dataKosong == false){
                            ...
                            foreach($arrData as $DK => $val){
                                foreach($val as $key => $data){
                                    ...
                                    echo "<tr>";
                                    echo "<td width='25' class='tdisikiri'>".$no++.".</td>";
                ...
                <table width="1030" class="table3"
                    ...
                    <tr align="center">
                        ...
                        <td rowspan="6"><br>Belawan, .... .............. <?= date(Y);?><br>
                            <?php echo $namaRS; ?><br>
                            GENERAL MANAGER RUMAH SAKIT<br>
                            <br>
                            <br>
                            <br>
                            <br>
                            ...
                            <br>
                            <br>
                            <b>dr. AUSVIN GENIUSMAN KOMAINI, M. H. Kes.</b></td>
                    </tr>
                    <tr>
                    ...
                    <td colspan="3" style="border-right:none;">b. Tanggal Posting</td>
                        <td style="border-left:none; border-right:none;">:</td>
                        <td style="border-left:none;">-<?php //echo $tgl_Post; ?></td>
                    </tr>
                </table>
                <!-- END TABLE TIGA -->

...
$workbook->send('JKM.xls');

//Creating a worksheet
$worksheet=&$workbook->addWorksheet('JKM');
...
$sql="SELECT a.no_kw, a.uraian,DATE_FORMAT(a.tgl,'%d-%m-%Y') tanggal,a.debit FROM jurnal a 
 ...
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.`D_K`='D' AND a.flag = '$flag' AND b.`MA_KODE` LIKE '1.1.01%' AND a.`TIPE_JURNAL` IN (1,0) ORDER BY no_kw ASC"; //decyber
//echo $sql.";<br>";
$rs=mysql_query($sql);
$i=0;

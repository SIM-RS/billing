...
<?php }elseif ($it=="2"){
	$lnk="'../report/bukubesar_print_pajak.php?idma='+idma.value+'&kode_ma='+kode_ma.value+'&bulan='+bulan.value+'&ta='+ta.value+'&idunit=$iunit&cislast='+islast.value+'&ccrvpbfumum='+ccrvpbfumum.value+'&idccrvpbfumum='+idccrvpbfumum.value+'&cc_islast='+cc_islast.value";

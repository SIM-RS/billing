...
<?php if ($it=="1"){
$lnk="'../report/journal_print.php?&tgl_s='+tgl_s.value+'&tgl_d='+tgl_d.value+'&cuser='+cuser.value";
?>
...
WHERE b.MA_KODE LIKE '101%' AND a.TGL BETWEEN '$tgl_s1' AND '$tgl_d1') AS t1,jurnal j 
...
WHERE LEFT(t3.MA_KODE,3)<>'101' AND ($cstr)) AS t4";
					}else{
...
WHERE LEFT(t3.MA_KODE,3)<>'101' AND ($cstr)) AS t4";
				...
				if ($ckategori==2){
					...
					$sql="SELECT IF (SUM(s.SALDO_AWAL) IS NULL,0,SUM(s.SALDO_AWAL)) AS NILAI FROM (SELECT * FROM saldo WHERE BULAN=$cbln AND TAHUN=$cthn) AS s INNER JOIN ma_sak m ON s.FK_MAID=m.MA_ID WHERE m.MA_KODE LIKE '101%'";
					//echo $sql."<br>";
					$rs1=mysql_query($sql);
					if ($rows1=mysql_fetch_array($rs1)){
						if ($rows1["NILAI"]<0)
        ...
        <tr>
          ...
          <?php if ($ckode=="" or $nilai=="-"){?>
          <td align="left">&nbsp;<?php echo $rows["uraian"]; ?></td>
          <?php }else{?>
          <td align="left">&nbsp;<a href="?f=../report/arus_kas_detail.php&sak_sap=<?php echo $sak_sap; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&kodema=<?php echo $ckode; ?>&kelompok=<?php echo $ckelompok; ?>&type=<?php echo $ctype; ?>&cinduk=<?php echo $cinduk; ?>&ckel=<?php echo $rows["uraian"]; ?>&cdk=<?php echo $cdk; ?>"><?php echo $rows["uraian"]; ?></a></td>
          <?php }?>
	...
	?>
            ...
            <tr>
              ...
              <table width="700" cellspacing="0" cellpadding="0" class="bodyText12" border="1" style="border-collapse:collapse">
                ...
                <tr>
                  ...
                  <?php 
                  if (($rw1["nilai"]>0) && ($rw["MA_ISLAST"]==0)){
                  ?>
                  <td>&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $rw["MA_KODE"]; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail"><?php echo $rw["MA_NAMA"]; ?></a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPO>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kode_MA_BPO; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail"><?php echo $nama_MA_BPO; ?></a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaUmum>0){
                  ?>
                  <td align="left">&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaUmum; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya OTL</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOKaWaka>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaBPOKawaka; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Ka/Waka RSPM</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOUmum>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaBPOUmum; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Dinas Umum</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOKeu>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaBPOKeu; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Dinas Keuangan</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOTeknik>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaBPOTeknik; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Dinas Teknik</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                $sql="SELECT IFNULL(SUM(j.KREDIT-j.DEBIT),0) AS nilai FROM jurnal j INNER JOIN ma_sak ma ON j.FK_SAK=ma.MA_ID WHERE ma.MA_KODE LIKE '$kodePend_Dluar%' AND j.TGL BETWEEN '$tgl_s1' AND '$tgl_d1'";
                $rs1=mysql_query($sql);
                $rw1=mysql_fetch_array($rs1);
		...
		?>
			...
			WHERE LEFT(t3.MA_KODE,3)<>'111' AND ($cstr)) AS t4";*/
									$sql="SELECT IFNULL(SUM(j.KREDIT-j.DEBIT),0) AS NILAI FROM jurnal j INNER JOIN ma_sak ma ON j.FK_SAK=ma.MA_ID WHERE ($cstr) AND j.TGL BETWEEN '$tgl_s1' AND '$tgl_d1'";
								}else{
									/*$sql="SELECT IFNULL(SUM(t4.KREDIT),'-') AS NILAI FROM 
			(SELECT DISTINCT t3.* FROM (SELECT t2.*,c.MA_KODE FROM 
			(SELECT j.NO_TRANS,j.FK_SAK,j.DEBIT,j.KREDIT,j.FK_LAST_TRANS,j.CC_RV_KSO_PBF_UMUM_ID FROM (SELECT a.NO_TRANS,a.TGL,a.FK_LAST_TRANS FROM jurnal a INNER JOIN ma_sak b ON a.FK_SAK=b.MA_ID 
			...
			WHERE t1.NO_TRANS=j.NO_TRANS AND t1.TGL=j.TGL AND t1.FK_LAST_TRANS=j.FK_LAST_TRANS) AS t2 INNER JOIN ma_sak c ON t2.FK_SAK=c.MA_ID) AS t3 
			WHERE LEFT(t3.MA_KODE,3)<>'111' AND ($cstr)) AS t4";*/
									$sql="SELECT IFNULL(SUM(j.KREDIT),'-') AS NILAI FROM jurnal j INNER JOIN ma_sak ma ON j.FK_SAK=ma.MA_ID WHERE ($cstr) AND j.TGL BETWEEN '$tgl_s1' AND '$tgl_d1'";
								}
							}else{
								if ($ctype==0){
									/*$sql="SELECT IFNULL(SUM(t4.DEBIT-t4.KREDIT),'-') AS NILAI FROM 
			...
			WHERE t1.NO_TRANS=j.NO_TRANS AND t1.TGL=j.TGL AND t1.FK_LAST_TRANS=j.FK_LAST_TRANS) AS t2 INNER JOIN ma_sak c ON t2.FK_SAK=c.MA_ID) AS t3 
			WHERE LEFT(t3.MA_KODE,3)<>'111' AND ($cstr)) AS t4";*/
									$sql="SELECT IFNULL(SUM(j.DEBIT-j.KREDIT),0) AS NILAI FROM jurnal j INNER JOIN ma_sak ma ON j.FK_SAK=ma.MA_ID WHERE ($cstr) AND j.TGL BETWEEN '$tgl_s1' AND '$tgl_d1'";
								}else{
									/*$sql="SELECT IFNULL(SUM(t4.DEBIT),'-') AS NILAI FROM 
			(SELECT DISTINCT t3.* FROM (SELECT t2.*,c.MA_KODE FROM 
			(SELECT j.NO_TRANS,j.FK_SAK,j.DEBIT,j.KREDIT,j.FK_LAST_TRANS,j.CC_RV_KSO_PBF_UMUM_ID FROM (SELECT a.NO_TRANS,a.TGL,a.FK_LAST_TRANS FROM jurnal a INNER JOIN ma_sak b ON a.FK_SAK=b.MA_ID 
			...
			WHERE t1.NO_TRANS=j.NO_TRANS AND t1.TGL=j.TGL AND t1.FK_LAST_TRANS=j.FK_LAST_TRANS) AS t2 INNER JOIN ma_sak c ON t2.FK_SAK=c.MA_ID) AS t3 
			WHERE LEFT(t3.MA_KODE,3)<>'111' AND ($cstr)) AS t4";*/
									$sql="SELECT IFNULL(SUM(j.DEBIT),'-') AS NILAI FROM jurnal j INNER JOIN ma_sak ma ON j.FK_SAK=ma.MA_ID WHERE ($cstr) AND j.TGL BETWEEN '$tgl_s1' AND '$tgl_d1'";
								}
							}
							//echo $sql."<br>";
							/*if ($ckode=='411'){
							...
							if ($ckategori==2){
								...
								$sql="SELECT IF (SUM(s.SALDO_AWAL) IS NULL,0,SUM(s.SALDO_AWAL)) AS NILAI FROM (SELECT * FROM saldo WHERE BULAN=$cbln AND TAHUN=$cthn) AS s INNER JOIN ma_sak m ON s.FK_MAID=m.MA_ID WHERE m.MA_KODE LIKE '111%'";
								//echo $sql."<br>";
								$rs1=mysql_query($sql);
								if ($rows1=mysql_fetch_array($rs1)){
									if ($rows1["NILAI"]<0)
...
?>
 ...
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.`D_K`='D' AND  b.`MA_KODE` LIKE '101%';";
...
?>
 ...
 INNER JOIN `ma_sak` b ON a.`FK_SAK`=b.`MA_ID`
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.`D_K`='K' AND  b.`MA_KODE` LIKE '101%';";
   $sql1=mysql_query($sql);

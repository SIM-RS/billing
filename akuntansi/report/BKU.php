...
<br />
<table width="989" border="1" align="center" cellpadding="2" cellspacing="0" style="border:1px solid #000000; border-collapse:collapse; font:12px tahoma;">
  <tr class="headtable">
    <td width="50" height="30" class="tblheaderkiri" >No.<br />
    Urut</td>
    <td width="111" class="tblheader" >Tanggal</td>
    <td width="176" class="tblheader" >Kode Rekening </td>
    <td width="525" class="tblheader" >Uraian</td>
    <td width="150" class="tblheader" >Penerimaan<br />
    (Rp.)</td>
    <td width="150" class="tblheader" >Pengeluaran<br />
    (Rp.)</td>
  </tr>
...
while($d = mysql_fetch_array($q))
{
  ...
  <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'">
    ...
    <td class="tdisi" align="center"><?=$d['tgl2'];?></td>
    <td class="tdisi"><?=$d['ma_kode'];?></td>
    <td class="tdisi" align="left"><?=$namaTrans;?></td>
    <td class="tdisi" align="right"><?=number_format($d['pen'],0,",",".");?></td>
    <td class="tdisi" align="right"><?=number_format($d['peng'],0,",",".");?></td>
  </tr>
<?
$i++;
}

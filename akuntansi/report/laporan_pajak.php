...
<?php }elseif ($it=="2"){
	$lnk="'../report/bukubesar_print_pajak.php?idma=&kode_ma=&ta='+ta.value+'&idunit=$iunit&cislast='+islast.value+'&ccrvpbfumum='+ccrvpbfumum.value+'&idccrvpbfumum='+idccrvpbfumum.value+'&cc_islast='+cc_islast.value";
	//$lnk="'../report/bukubesar_print_pajaks.php?idma='+idma.value+'&kode_ma='+kode_ma.value+'&ta='+ta.value+'&idunit=$iunit&cislast='+islast.value+'&ccrvpbfumum='+ccrvpbfumum.value+'&idccrvpbfumum='+idccrvpbfumum.value+'&cc_islast='+cc_islast.value";
	$qstr_ma="par=idma*kode_ma*ma*islast*ccrvpbfumum*idccrvpbfumum*cc_islast";
	$_SESSION["PATH_MS_MA"]="?".$qstr_ma;
?>
	  <p class="jdltable">LAPORAN PAJAK</p>
	  ...
	  <table width="502" border="0" cellspacing="0" cellpadding="0" class="txtinput">
            ...
            <tr>
              ...
              <td align="left"><select name="bulan_lr" id="bulan_lr">
                ...
                <option value="4|AAPRIL"<?php if ($bulan_lr=="4") echo " selected";?>>April</option>
...
?>
 ...
 INNER JOIN `ma_sak` b ON a.`FK_SAK`=b.`MA_ID`
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.TIPE_JURNAL=3";
...
?>
   ...
   <?php 
    $sql="SELECT a.no_kw, a.uraian,DATE_FORMAT(a.tgl,'%d-%m-%Y') tanggal,a.debit,a.kredit FROM jurnal a 
 INNER JOIN `ma_sak` b ON a.`FK_SAK`=b.`MA_ID`
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.TIPE_JURNAL=4";
   $sql1=mysql_query($sql);
...
?>
   ...
   <?php 
     $sql="SELECT a.no_kw, a.uraian,DATE_FORMAT(a.tgl,'%d-%m-%Y') tanggal,a.debit,a.kredit FROM jurnal a 
 INNER JOIN `ma_sak` b ON a.`FK_SAK`=b.`MA_ID`
 WHERE a.`TGL` BETWEEN '$tgl_s1' AND '$tgl_d1' AND a.TIPE_JURNAL=5";
   $sql1=mysql_query($sql);

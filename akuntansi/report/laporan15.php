            ...
            <tr>
              ...
              <table width="700" cellspacing="0" cellpadding="0" class="bodyText12" border="1" style="border-collapse:collapse">
                ...
                <tr>
                  ...
                  if ($biayaBPOKaWaka>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaUmum; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Ka/Waka RSPM</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOUmum>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaUmum; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Dinas Umum</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOKeu>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaUmum; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Dinas Keuangan</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  if ($biayaBPOTeknik>0){
                  ?>
                  <td align="left">&nbsp;&nbsp;&nbsp;<a href="?f=../report/laporan.php&it=5&sak_sap=<?php echo $sak_sap; ?>&ma_kode=<?php echo $kodeMaUmum; ?>&tgl_d=<?php echo $tgl_d; ?>&tgl_s=<?php echo $tgl_s; ?>&tipe=detail">Biaya Dinas Teknik</a></td>
                  <?php 
                  }else{
                  ?>
                ...
                <tr>
                  ...
                  <td align="right"><?php echo number_format($LB_Op,2,",","."); ?></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td align="right"><?php echo number_format($LR_SblmPajak,2,",","."); ?></td>
                </tr>
              </table>
              </div>
		<?php

        ...
        <div align="center">
            <table width="980" border="0" cellpadding="0" cellspacing="0" class="txtinput">
                ...
                <tr>
                    ...
                    <td height="30" align="right" style="padding-right:5px;"><BUTTON id="btnPost" type="button" onClick="Verifikasi()"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Verifikasi</BUTTON></td>
                </tr>
                <tr>
...
<script>
 	function kirim(){
	var url;
		url="../unit/utils.php?grd=pengeluaranLain&tipe=<?php echo $tipe ?>&cmbSupplier="+document.getElementById('cmbSupplier').value+"&tglAwal="+document.getElementById('tglAwal').value+"&tglAkhir="+document.getElementById('tglAkhir').value+"&posting="+document.getElementById('cmbPost').value;
		//alert(url);
	...
	var tmp='',cid='';
	var url;
		url="../unit/utils.php?grd=pengeluaranLain&tipe=<?php echo $tipe ?>&cmbSupplier="+document.getElementById('cmbSupplier').value+"&tglAwal="+document.getElementById('tglAwal').value+"&tglAkhir="+document.getElementById('tglAkhir').value+"&posting="+document.getElementById('cmbPost').value+"&idUser=<?php echo $iduser; ?>";
	...
	var url;
		//alert(grd);
		if (grd=="gridbox"){
			url="../unit/utils.php?grd=pengeluaranLain&tipe=<?php echo $tipe ?>&cmbSupplier="+document.getElementById('cmbSupplier').value+"&tglAwal="+document.getElementById('tglAwal').value+"&tglAkhir="+document.getElementById('tglAkhir').value+"&posting="+document.getElementById('cmbPost').value+"&filter="+aGrid.getFilter()+"&sorting="+aGrid.getSorting()+"&page="+aGrid.getPage();
			//alert(url);
			aGrid.loadURL(url,"","GET");
		}
	}
	...
	aGrid.baseURL("../unit/utils.php?grd=pengeluaranLain&tipe=<?php echo $tipe ?>&cmbSupplier="+document.getElementById('cmbSupplier').value+"&posting="+document.getElementById('cmbPost').value+"&tglAwal="+document.getElementById('tglAwal').value+"&tglAkhir="+document.getElementById('tglAkhir').value);
	aGrid.Init();

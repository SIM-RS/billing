...
<?php	
  ...
  while ($rows=mysql_fetch_array($rs)){
		 ...
		 if ($cc_rv_kso_pbf_umum>0){
			...
			$tree[$cnt][2]= "javascript:window.opener.location='main.php?f=bukubesar&idma=".$rows['MA_ID']."&ccrvpbfumum=".$rows['CC_RV_KSO_PBF_UMUM']."&idccrvpbfumum=0&cc_islast=0&kode_ma=".$rows['MA_KODE']."&bulan=".$_GET["bulan"]."&ta=".$_GET["ta"]."&islast=".$c_islast."';window.close();";
			$tree[$cnt][3]= "";
			$tree[$cnt][4]= 0;
			$tree[$cnt][6]= "";
			...
			switch ($cc_rv_kso_pbf_umum){
				case 1:
					...
					while ($rw1=mysql_fetch_array($rs1)){
						...
						$tree[$cnt][2]= "javascript:window.opener.location='main.php?f=bukubesar&idma=".$rows['MA_ID']."&ccrvpbfumum=".$cc_rv_kso_pbf_umum."&idccrvpbfumum=".$rw1["id"]."&cc_islast=".$ak_islast."&kode_ma=".$mpkode."&bulan=".$_GET["bulan"]."&ta=".$_GET["ta"]."&islast=".$c_islast."';window.close();";
						$tree[$cnt][3]= "";
						$tree[$cnt][4]= 0;
						$tree[$cnt][6]= "";
						if ($tree[$cnt][0] > $maxlevel) 
				...
				case 3:
					...
					while ($rw1=mysql_fetch_array($rs1)){
						...
						$tree[$cnt][2]= "javascript:window.opener.location='main.php?f=bukubesar&idma=".$rows['MA_ID']."&ccrvpbfumum=".$cc_rv_kso_pbf_umum."&idccrvpbfumum=".$rw1["PBF_ID"]."&cc_islast=".$ak_islast."&kode_ma=".$mpkode."&bulan=".$_GET["bulan"]."&ta=".$_GET["ta"]."&islast=".$c_islast."';window.close();";
						$tree[$cnt][3]= "";
						$tree[$cnt][4]= 0;
						$tree[$cnt][6]= "";
						if ($tree[$cnt][0] > $maxlevel) 
				...
				case 4:
					...
					while ($rw1=mysql_fetch_array($rs1)){
						...
						$tree[$cnt][2]= "javascript:window.opener.location='main.php?f=bukubesar&idma=".$rows['MA_ID']."&ccrvpbfumum=".$cc_rv_kso_pbf_umum."&idccrvpbfumum=".$rw1["idrekanan"]."&cc_islast=".$ak_islast."&kode_ma=".$mpkode."&bulan=".$_GET["bulan"]."&ta=".$_GET["ta"]."&islast=".$c_islast."';window.close();";
						$tree[$cnt][3]= "";
						$tree[$cnt][4]= 0;
						$tree[$cnt][6]= "";
						if ($tree[$cnt][0] > $maxlevel) 

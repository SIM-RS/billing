...
<script>
	...
	a1.baseURL("../unit/utils.php?grd=HapusObat&bulan="+document.getElementById('bulan').value+"&tahun="+document.getElementById('ta').value);
	//alert("../unit/utils.php?grd=HapusObat&bulan="+document.getElementById('bulan').value+"&tahun="+document.getElementById('ta').value);
	a1.Init();
	...
	var url;
		//alert(grd);
		if (grd=="gridbox"){		
			url="../unit/utils.php?grd=HapusObat&bulan="+document.getElementById('bulan').value+"&tahun="+document.getElementById('ta').value+"&posting="+document.getElementById('cmbPost').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			//alert(url);
			a1.loadURL(url,"","GET");
		}
	}
	...
	function kirim(){
	var url;
		url="../unit/utils.php?grd=HapusObat&bulan="+document.getElementById('bulan').value+"&tahun="+document.getElementById('ta').value+"&posting="+document.getElementById('cmbPost').value;
		a1.loadURL(url,"","GET");
	}
	...
	var tmp='';
	var url;
		url="../unit/utils.php?grd=HapusObat&bulan="+document.getElementById('bulan').value+"&tahun="+document.getElementById('ta').value+"&posting="+document.getElementById('cmbPost').value+"&idUser=<?php echo $iduser; ?>";
		
		for (var i=0;i<a1.getMaxRow();i++){
			if (a1.obj.childNodes[0].childNodes[i].childNodes[8].childNodes[0].checked){
				//alert(a1.cellsGetValue(i+1,2));
				tmp+=a1.getRowId(i+1)+String.fromCharCode(5)+ValidasiText(a1.cellsGetValue(i+1,3))+String.fromCharCode(5)+ValidasiText(a1.cellsGetValue(i+1,4))+String.fromCharCode(5)+ValidasiText(a1.cellsGetValue(i+1,5))+String.fromCharCode(5)+ValidasiText(a1.cellsGetValue(i+1,6))+String.fromCharCode(6)+ValidasiText(a1.cellsGetValue(i+1,7))+String.fromCharCode(7);
			}
		}
		if (tmp!=""){

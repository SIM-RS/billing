...
<body>
<!--div class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'">&nbsp;<img src="sort/sortascending.gif" border="0" width="16" height="16">&nbsp;&nbsp;&nbsp;<i>Sort Ascending</i></div>
<img src="sort/addfilter.gif" border="0" width="123" height="1">
<div class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'">&nbsp;<img src="sort/sortascending.gif" border="0" width="16" height="16">&nbsp;&nbsp;&nbsp;<i>Sort Ascending</i></div-->
...
<table width="130" height="72" cellpadding="0" cellspacing="0" border="0">
	...
	<tr class="itemtable">
		<td align="center"><input name="tflt" type="text" id="tflt" size="10" style="text-align:center"></td>
	</tr>
	<tr class="itemtable">

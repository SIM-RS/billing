...
switch ($act){
	...
	case "posting":
		...
		$query = "insert into jurnal(FK_ID_AK_POSTING, FK_ID_POSTING, FK_ID_USER_APP, NO_TRANS, NO_PASANGAN, FK_SAK, TGL, TGL_VERIFIKASI, NO_KW, KEPADA, ALAMAT, URAIAN, DEBIT, KREDIT, TGL_ACT, FK_IDUSER, D_K, TIPE_JURNAL, JENIS, FK_TRANS, FK_LAST_TRANS, STATUS, NO_BUKTI, MS_BEBAN_JENIS_ID, CC_RV_KSO_PBF_UMUM_ID, CC_RV_ID, KSO_ID, PBF_ID, VENDOR_ID, SELISIH, PAJAK, POSTING, VERIFIKASI, flag) VALUES ";
        ...
        while ($rw=mysql_fetch_array($rs)){
			...
			$query .= "('".$rw['FK_ID_AK_POSTING']."','".$rw['FK_ID_POSTING']."','".$rw['FK_ID_USER_APP']."','".$rw['NO_TRANS']."','".$rw['NO_PASANGAN']."','".$rw['FK_SAK']."','".$tgl_posting_popup."','".$rw['TGL_VERIFIKASI']."','".mysql_real_escape_string($rw['NO_KW'])."','".mysql_real_escape_string($rw['KEPADA'])."','".mysql_real_escape_string($rw['ALAMAT'])."','".mysql_real_escape_string($rw['URAIAN'])."','".$rw['DEBIT']."','".$rw['KREDIT']."','".$rw['TGL_ACT']."','".$rw['FK_IDUSER']."','".$rw['D_K']."','".$rw['TIPE_JURNAL']."','".$rw['JENIS']."','".$rw['FK_TRANS']."','".$rw['FK_LAST_TRANS']."','".$rw['STATUS']."','".$rw['NO_BUKTI']."','".$rw['MS_BEBAN_JENIS_ID']."','".$rw['CC_RV_KSO_PBF_UMUM_ID']."','".$rw['CC_RV_ID']."','".$rw['KSO_ID']."','".$rw['PBF_ID']."','".$rw['VENDOR_ID']."','".$rw['SELISIH']."','".$rw['PAJAK']."','".$rw['POSTING']."','".$rw['VERIFIKASI']."','".$rw['flag']."'), ";
          
            // $sql= mysql_query(""); //decyber_jurnal
						// echo $sql."<br>batas";
            // $rs=mysql_query($sql);
            // echo "<br>";
            // if($sql){
		...
		// echo $query;
		  ...
		  $sql= mysql_query($query); //decyber_jurnal
						// echo $sql."<br>batas";
            // $rs=mysql_query($sql);
            // echo "<br>";
            if($sql){
...
var url;
	...
	url='newMA_utils_pj.php?idtr='+idtr+'&newMAId='+nMAId+'&IdCCRVKSOPBF='+IdCCRV;
	//alert(url);

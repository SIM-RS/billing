...
if ($jBeban=="" && $_REQUEST["jbeban_id"]>0) $jBeban=$_REQUEST["jbeban_id"];
$strjBeban="";
if ($jBeban>0) $strjBeban=" AND (detil_transaksi.fk_ms_beban_jenis='$jBeban' OR detil_transaksi.fk_ms_beban_jenis=0)";
$idma=$_REQUEST['idma'];
...
FROM detil_transaksi INNER JOIN JENIS_TRANSAKSI ON detil_transaksi.fk_jenis_trans = JENIS_TRANSAKSI.JTRANS_ID INNER JOIN MA_SAK ON detil_transaksi.fk_ma_sak = MA_SAK.MA_ID WHERE JENIS_TRANSAKSI.JTRANS_ID=".$_GET[jurnal].$strjBeban." ORDER BY detil_transaksi.dk, detil_transaksi.fk_ms_beban_jenis, MA_SAK.MA_KODE";
	  //echo $sql;
	  //$rs=mysql_query($sql);
		$rs=mysql_query($sql);
    ...
    <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
	  ...
	  <td class="tdisi"><?php echo $rows['ket'];?>&nbsp;</td>

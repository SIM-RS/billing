	...
	<td align="left" height="430">
        <div align="center">
            <table width="980" border="0" cellpadding="0" cellspacing="0" class="txtinput">
                ...
                <tr>
                  <td style="padding-right:20px; text-align:right;" width="42%" height="25">Ket / No Slip</td>
                  <td width="58%">:&nbsp;<input id="noSlip" name="noSlip" size="30" class="txtleft" type="text" value="" /></td>
                </tr>
                <tr>
...
<script>
	...
	a1.setColHeader("NO,NO SLIP,UNIT FARMASI,NILAI,NILAI HPP,POSTING<BR><input type='checkbox' name='chkAll' id='chkAll' onClick='chkKlik(this.checked);'>&nbsp;&nbsp;&nbsp;&nbsp;");
	a1.setSubTotal(",,SubTotal :&nbsp;,0,0,");
	a1.setIDColHeader(",,,,,");
	a1.setColWidth("40,140,500,100,100,50");
	a1.setCellAlign("center,center,left,right,right,center");
	a1.setSubTotalAlign("center,center,right,right,right,center");
	...
	//alert("../unit/penjualanObatTunai_utils.php?grd=penjualanObat&kso="+document.getElementById('cmbKso').value+"&tanggal="+document.getElementById('tgl').value+"&tempat="+document.getElementById('cmbTmp').value+"&posting="+document.getElementById('cmbPost').value+"&cmbFarmasi="+document.getElementById('cmbFarmasi').value);
	a1.baseURL("../unit/penjualanObatTunai_utils.php?grd=penjualanObat&tanggal="+document.getElementById('tgl').value+"&posting="+document.getElementById('cmbPost').value+"&cmbFarmasi="+document.getElementById('cmbFarmasi').value);
	a1.Init();
	...
	var tmp;
		...
		if (val!=undefined){
			...
			a1.cellSubTotalSetValue(4,tmp[2]);
			a1.cellSubTotalSetValue(5,tmp[3]);
			if(key=='Error'){
	...
	var url;
		//alert(grd);
		if (grd=="gridbox"){		
			url="../unit/penjualanObatTunai_utils.php?grd=penjualanObat&kso="+document.getElementById('cmbKso').value+"&tanggal="+document.getElementById('tgl').value+"&tempat="+document.getElementById('cmbTmp').value+"&posting="+document.getElementById('cmbPost').value+"&cmbFarmasi="+document.getElementById('cmbFarmasi').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			//alert(url);
			a1.loadURL(url,"","GET");
		}
	}
	...
	function kirim(){
	var url;
		url="../unit/penjualanObatTunai_utils.php?grd=penjualanObat&kso="+document.getElementById('cmbKso').value+"&tanggal="+document.getElementById('tgl').value+"&tempat="+document.getElementById('cmbTmp').value+"&posting="+document.getElementById('cmbPost').value+"&cmbFarmasi="+document.getElementById('cmbFarmasi').value;
		//alert(url);
		a1.loadURL(url,"","GET");
	}
	...
	var url;
		...
		url="../unit/penjualanObatTunai_utils.php?grd=penjualanObat&tanggal="+document.getElementById('tgl').value+"&posting="+document.getElementById('cmbPost').value+"&idUser=<?php echo $iduser; ?>"+"&cmbFarmasi="+document.getElementById('cmbFarmasi').value+"&noSlip="+document.getElementById('noSlip').value;

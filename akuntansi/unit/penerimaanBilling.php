	...
	<td align="left" height="430">
        <div align="center">
            <table width="980" border="0" cellpadding="0" cellspacing="0" class="txtinput">
                ...
                <tr>
                    <td height="30" style="padding-left:150px;"><select id="cmbPost" name="cmbPost" class="txtinput" style="background-color:#FFFFCC; color:#990000;" onChange="change()">
	...
	var url;
		...
		for (var i=0;i<a1.getMaxRow();i++){
			if (a1.obj.childNodes[0].childNodes[i].childNodes[3].childNodes[0].checked){
				...
				tmp2+=idata[0]+"|"+idata[1]+"|"+ValidasiText(a1.cellsGetValue(i+1,3));
			}
		}
		if (tmp!=""){

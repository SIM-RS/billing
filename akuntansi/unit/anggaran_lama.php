...
switch ($act){
	case "save":
			...
			$sql="insert into anggaran(FK_MAID,CC_RV_KSO_PBF_UMUM_ID,BEBAN_JENIS_ID,FK_IDUNIT,BULAN,TAHUN,NILAI,flag) values($id_sak,'$idccrvpbfumum',0,$fk_idunit,$inpbulan,$inpta,'$saldo_awal','$flag')"; //decyber_anggaran
		...
		break;
	case "edit":
			$sql="update anggaran set FK_MAID='$id_sak',CC_RV_KSO_PBF_UMUM_ID='$idccrvpbfumum',FK_IDUNIT=$fk_idunit,BULAN='$inpbulan',TAHUN='$inpta', NILAI='$saldo_awal' where SALDO_ID=$saldo_id";
			// echo $sql;
			$rs=mysql_query($sql);
		break;
	case "delete":
		$sql="delete from anggaran where saldo_id=$saldo_id";
		$rs=mysql_query($sql);
		//echo $sql;
		break;
}
  ...
  <table width="90%" cellpadding="0" cellspacing="0" border="0">
    ...
    <table width="90%" border="0" cellpadding="1" cellspacing="0">
      <tr class="headtable">
		...
		<td id="SALDO_AWAL" width="120" class="tblheader" onClick="ifPop.CallFr(this);">NILAI</td>

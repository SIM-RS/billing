...
<script>
document.getElementById("logout").innerHTML='<a class="a1" href="../logout.php">Logout</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
</script>
...
INNER JOIN $dbbilling.b_ms_pegawai mp ON bb.user_act=mp.id ORDER BY mp.nama");
                ...
                <tr>
                    <td height="30" style="padding-left:45px;"><select id="cmbPost" name="cmbPost" class="txtinput" style="background-color:#FFFFCC; color:#990000;" onChange="disable(this.value);change();">
...
<script>
	...
	a1.setColHeader("NO,TGL SLIP,UNIT PELAYANAN,KSO,NAMA PASIEN,KASIR,NILAI,NILAI SLIP,PILIH<BR><input type='checkbox' name='chkAll' id='chkAll' onClick='chkKlik(this.checked);'>&nbsp;&nbsp;&nbsp;&nbsp;");
	...
	a1.setColWidth("40,80,150,130,150,120,100,100,60");
	a1.setCellAlign("center,left,left,left,left,right,right,center");
	a1.setSubTotalAlign("center,center,center,center,right,right,right,right,left");
	...
	//alert("../unit/utils2.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value);
	a1.baseURL("../unit/utils2.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value);
	a1.Init();
	...
	var url;
		//alert(grd);
		if (grd=="gridbox"){		
			url="../unit/utils2.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			//alert(url);
			a1.loadURL(url,"","GET");
		}
	}
	...
	var url;
		url="../unit/utils2.php?grd=loadkasir&tanggal="+document.getElementById('tgl').value;
	...
	function kirim(){
		...
		url="../unit/utils2.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value;
	...
	var url2;
		...
		if (tmp!="")
		{
			...
			{
				url="../unit/utils2.php?act=posting&grd=penerimaanBillingKasir&idUser=<?php echo $iduser; ?>&tanggal="+document.getElementById('tgl').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp;
				//alert(tmp2);
				//alert(url);
				a1.loadURL(url,"","GET");
			}
	...
	function setSubTotal(sim,slip){
		a1.cellSubTotalSetValue(6,sim);
		a1.cellSubTotalSetValue(7,slip);
	}
	...
	function CetakKwitansi()
	{
		...
		var no_bukti = sisip[5];
		var tgl1 = sisip[8].split("-");

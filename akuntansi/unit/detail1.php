...
FROM detil_transaksi INNER JOIN JENIS_TRANSAKSI ON detil_transaksi.fk_jenis_trans = JENIS_TRANSAKSI.JTRANS_ID INNER JOIN MA_SAK ON detil_transaksi.fk_ma_sak = MA_SAK.MA_ID WHERE JENIS_TRANSAKSI.JTRANS_ID=".$_GET[jurnal].$strjBeban;
	  //echo $sql;
	  //$rs=mysql_query($sql);
		$rs=mysql_query($sql);

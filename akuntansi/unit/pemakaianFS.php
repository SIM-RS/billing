	...
	<td align="left" height="430">
        <div align="center">
            <table width="980" border="0" cellpadding="0" cellspacing="0" class="txtinput">
                ...
                <tr>
                    <td height="30" style="padding-left:95px;"><select id="cmbPost" name="cmbPost" class="txtinput" style="background-color:#FFFFCC; color:#990000;" onChange="change()">
...
<script>
	...
	a1.baseURL("../unit/pemakaianFS_utils.php?grd=PemakaianFS&tanggal="+document.getElementById('tgl').value);
	a1.Init();
	...
	var url;
		//alert(grd);
		if (grd=="gridbox"){		
			url="../unit/pemakaianFS_utils.php?grd=PemakaianFS&tanggal="+document.getElementById('tgl').value+"&posting="+document.getElementById('cmbPost').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			//alert(url);
			a1.loadURL(url,"","GET");
		}
	}
	...
	function kirim(){
	var url;
		url="../unit/pemakaianFS_utils.php?grd=PemakaianFS&tanggal="+document.getElementById('tgl').value+"&posting="+document.getElementById('cmbPost').value;
		//alert(url);
		a1.loadURL(url,"","GET");
	}
	...
	var tmp='',tmp2='',idata='';
	var url;
		url="../unit/pemakaianFS_utils.php?grd=PemakaianFS&tanggal="+document.getElementById('tgl').value+"&posting="+document.getElementById('cmbPost').value+"&idUser=<?php echo $iduser; ?>";

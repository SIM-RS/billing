        ...
        <div align="center">
            <table width="980" border="0" cellpadding="0" cellspacing="0" class="txtinput">
                ...
                <tr>
                    ...
                    <td height="30" align="right" style="padding-right:10px;"><BUTTON type="button" id="btnPosting" onClick="PostingJurnal()"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Posting >> Jurnal</BUTTON></td>
                </tr>
                <tr>
...
<script>
	...
	a1.setColHeader("NO,TGL,NO BUKTI,FARMASI,KSO,UNIT PELAYANAN,NILAI JUAL,NILAI HPP,POSTING<BR><input type='checkbox' name='chkAll' id='chkAll' onClick='chkKlik(this.checked);'>&nbsp;&nbsp;&nbsp;&nbsp;");
	a1.setSubTotal(",,,,,SubTotal :&nbsp;,0,0,");
	a1.setIDColHeader(",,no_bukti,nFarmasi,nKso,nUnit,,,");
	a1.setColWidth("30,80,110,110,160,170,90,90,50");
	a1.setCellAlign("center,center,center,center,center,left,right,right,center");
	a1.setSubTotalAlign("center,center,center,center,center,right,right,right,left");
	...
	var url;
		//alert(grd);
		if (grd=="gridbox"){		
			url="penjualanObat_utils.php?grd=penjualanObat&kso="+document.getElementById('cmbKso').value+"&tanggal="+document.getElementById('tgl').value+"&tempat="+document.getElementById('cmbTmp').value+"&posting="+document.getElementById('cmbPost').value+"&cmbFarmasi="+document.getElementById('cmbFarmasi').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			//alert(url);
			a1.loadURL(url,"","GET");
		}
	}

...
<script>
	...
	function CetakKwitansi()
	{
		...
		// alert(sisip);
		var no_bukti = sisip[1]; // sisip[5];
		var tgl1 = sisip[2].split("-"); // sisip[8].split("-");
		...
		{
			window.open('../kwitansi/bukti.php?kw='+no_bukti+'&tipe=3&tgl='+sisip[2]+'&no_post='+idPosting+"&terima="+terima);
			clear();
		}
	}

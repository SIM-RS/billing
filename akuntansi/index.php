...
<table width="1000" border="0" cellspacing="0" cellpadding="0" class="tblbody">
 <tr>
	...
	<form action="logproces.php" method="post">
        ...
        <tr valign="bottom">
			<td height="28"><div align="right"><img src="icon/unlock.gif" alt="unlock" width="48" height="48"></div></td>
			<td>&nbsp;</td>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="374">
        <tr>
          <td width="374" class="pageName">Sistem Informasi Akuntansi </td>
		</tr>

		<tr>
          <td class="bodyText"><p>Sistem ini digunakan untuk membantu pencatatan 
              transaksi akuntansi di lingkungan Rumah Sakit Kota Tangerang </p>
            <p>&nbsp;</p>
            <p>&nbsp;</p></td>
        </tr>
      </table>

  ...
  <form name="form1" method="post" action="">
    ...
    <table width="85%" border="0" cellspacing="0" cellpadding="4">
      <tr class="headtable"> 
        ...
        <td id="KG_KODE" width="17%" class="tblheader" onClick="ifPop.CallFr(this);">Kode 
          Kegiatan </td>
        <td id="KG_KET" width="78%" class="tblheader" onClick="ifPop.CallFr(this);">Nama 
          Kegiatan </td>
      </tr>
	  <?php 
	  if ($filter!=""){
	  ...
	  $sql="select kg_id from KEGIATAN where KG_TYPE=2 and KG_TAHUN<=$ta and KG_TAHUN1>=$ta and KG_ISLAST=1".$filter;
	  //echo $sql."<br>";
	...
	if ($page=="" || $page=="0") $page="1";
  	...
  	$sql="select top $perpage * from KEGIATAN where KG_TYPE=2 and KG_TAHUN<=$ta and KG_TAHUN1>=$ta and KG_ISLAST=1 and kg_id not in (select top $tpage kg_id from KEGIATAN where KG_TYPE=2 and KG_TAHUN<=$ta and KG_TAHUN1>=$ta and KG_ISLAST=1".$filter." order by ".$sorting.")".$filter." order by ".$sorting;
	//echo $sql."<br>";

...
require_once '../Excell/Format.php';
require_once '../Excell/BIFFwriter.php';
require_once '../Excell/Worksheet.php';
require_once '../Excell/Parser.php';
require_once '../Excell/Root.php';
require_once '../Excell/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        include_once '../Excell/Validator.php';

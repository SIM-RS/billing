...
$kw = $_REQUEST['kw'];
$sql = "SELECT ma.MA_KODE,ma.MA_NAMA,ma.CC_RV_KSO_PBF_UMUM,j.* FROM (SELECT * FROM $dbakuntansi.jurnal WHERE TGL='$tgl' AND NO_KW='$kw' AND SELISIH=0 AND PAJAK=0) AS j
INNER JOIN $dbakuntansi.ma_sak ma ON j.FK_SAK=ma.MA_ID"; 
//echo $sql;
$q = mysql_query($sql);

$nRS="RSUD KOTA TANGERANG";
$nAlamatRS="Jl. Jendral Sudirman No. 101 Tangerang";
$nBukti="";

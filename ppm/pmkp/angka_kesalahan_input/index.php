...
$title = 'Angka Kesalahan Input';
$thData = ['No','Nama','Tanggal Pemeriksaan','Tanggal Kesalahan Input','Kesalahan Input','Action'];
$namaTable = "ppi_angka_kesalahan_input";
$act = "tampil_data_angka_kesalahan_input";
$laporan = "laporan.php";
?>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#rekapModal">Angka</button>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="form-input">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Tanggal Kesalahan Input</label>
                                <input type="date" name="tanggal-salah" id="tanggal-salah" class="form-control">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Kesalahan Input</label>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-angka-kesalahan-input">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        let tanggal_salah = $('#tanggal-salah').val();
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-angka-kesalahan-input")
    ...
    function editData(val){
        ...
        $('#tanggal-salah').val(arrData[3]);
        $('#pilihan').val(arrData[4]);
        $('#dokter').val(arrData[5]);
        $('#btn-act').val("edit-angka-kesalahan-input");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-angka-kesalahan-input");
        $('#btn-act').html("Save");
    }
</script>

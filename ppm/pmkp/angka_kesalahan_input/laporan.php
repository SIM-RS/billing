...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP ANGKA KESALAHAN INPUT ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="35">ANGKA KESALAHAN INPUT HASIL LABORATORIUM RSU PRIMA</th>
    </tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, 'KESALAHAN INPUT') ?>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_angka_kesalahan_input pa ON pa.id_kunjungan = k.id

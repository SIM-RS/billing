...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP WAKTU TANGGAP GAWAT DARURAT ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">WAKTU TANGGAP GAWAT DARURAT RSU ANDHIKA</th>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_waktu_tanggap_gawat_darurat pa ON pa.id_kunjungan = k.id

...
$thData = ['No','Nama','Waktu Datang','Waktu Pelayanan','<= 5 Menit','Action'];
$namaTable = "ppi_waktu_tanggap_gawat_darurat";
$act = "tampil_data_waktu_tanggap_gawat_darurat";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-waktu-tanggap-gawat-darurat">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-waktu-tanggap-gawat-darurat")
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-waktu-tanggap-gawat-darurat");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-waktu-tanggap-gawat-darurat");
        $('#btn-act').html("Save");
    }
</script>

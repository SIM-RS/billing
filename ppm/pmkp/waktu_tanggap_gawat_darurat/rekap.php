...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="REKAP WAKTU TANGGAP GAWAT DARURAT ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table class="table table-bordered table-sm">
    ...
    <?php
        ...
        pa.pilihan
    FROM 
        ppi_waktu_tanggap_gawat_darurat pa

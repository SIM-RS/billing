...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP OBAT SESUAI FORMALIUM ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="34">PENGGUNAAN OBAT SESUAI FORMULARIUM NASIONAL RSU PRIMA</th>
    </tr>
    <tr>
        <th class="tengah" colspan="34">TAHUN <?= $tahun ?></th>
    </tr>
    <tr><?php getTd(34) ?></tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, 'OBAT SESUAI FORMALIUM') ?>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_obat_sesuai_formalium pa ON pa.id_kunjungan = k.id
...
<table border="1" class="table table-bordered table-sm">
    ...
    <tr>
        ...
        <th class="tengah" rowspan="4">No. RM</th>
        <th class="tengah" rowspan="4">Nama DPJP</th>
        <th class="tengah" colspan="38">Bulan : <?= $bulan ?></th>
    </tr>
    <tr>

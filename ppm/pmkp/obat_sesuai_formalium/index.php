...
$title = 'Obat Sesuai Formalium';
$thData = ['No','Nama','Tanggal Pemantauan','Sesuai Formalium','Action'];
$namaTable = "ppi_obat_sesuai_formalium";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="form-input">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Sesuai Formalium</label>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-obat-sesuai-formalium">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-obat-sesuai-formalium")
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-obat-sesuai-formalium");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-obat-sesuai-formalium");
        $('#btn-act').html("Save");
    }
</script>

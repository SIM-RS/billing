...
$title = 'Penanganan Obat Yang Harus Di Waspadai';
$thData = ['No','Nama','Waktu Datang','Waktu Pelayanan','Sesuai','Action'];
$namaTable = "ppi_penanganan_obat";
$act = "tampil_penanganan_obat";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-penanganan-obat">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-penanganan-obat");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-penanganan-obat");
        $('#btn-act').html("Save");
    }
</script>

...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP KETEPATAN WAKTU ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="35">KETEPATAN WAKTU LAPOR NILAI KRITIS LABORATORIUM RSU PRIMA</th>
    </tr>
    <tr>
        <th class="tengah" colspan="35">TAHUN <?= $tahun ?></th>
    </tr>
    <tr><?php getTd(35) ?></tr>
    <tr>
    ...
    <tr>
        ...
        <th class="tengah" rowspan="4">Tanggal Pemeriksaan</th>
    ...
    <tr>
        <?php getTd(15, 2, false, 'WAKTU LAPOR') ?>
    </tr>
    <tr>
        <?php getTdKedua(15, 0, ['<10 MENIT', '>10 MENIT']) ?>
    </tr>
    <?php
    ...
    FROM
        ...
        INNER JOIN ppi_ketepatan_waktu_lapor pa ON pa.id_kunjungan = k.id
    ...
    while($rows = $dataPasien->fetch_assoc()){
        echo "<tr>";
            ...
            echo "<td>".$rows['tanggal_pemeriksaan']."</td>";
            for($i = 1; $i <= 15; $i++){

...
$title = 'Ketepatan Waktu Lapor Nilai Kritis Lab';
$thData = ['No','Nama','Tanggal Pemeriksaan','Tanggal Waktu Lapor','Waktu Lapor','Action'];
$namaTable = "ppi_ketepatan_waktu_lapor";
$act = "tampil_data_ketepatan_waktu_lapor";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="form-input">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Tanggal Waktu Lapor</label>
                                <input type="date" name="tanggal-lapor" id="tanggal-lapor" class="form-control">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-ketepatan-waktu-lapor">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        let tanggal_lapor = $('#tanggal-lapor').val();
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-ketepatan-waktu-lapor")
    ...
    function editData(val){
        ...
        $('#tanggal-lapor').val(arrData[3]);
        $('#pilihan').val(arrData[4]);
        $('#dokter').val(arrData[5]);
        $('#btn-act').val("edit-ketepatan-waktu-lapor");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-ketepatan-waktu-lapor");
        $('#btn-act').html("Save");
    }
</script>

...
$title = 'Pembatalan atau Penundaan Operasi';
$thData = ['No','Nama','Tanggal Operasi','Jenis Operasi','Tunda Operasi','Tanggal Tunda Operasi','Action'];
$namaTable = "ppi_pembatalan_operasi";
$act = "tampil_data_pembatalan_operasi";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="form-input">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Tanggal Pembatalan/Penundaan Operasi</label>
                                <input type="date" name="tanggal-pembatalan" id="tanggal-pembatalan" class="form-control">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-pembatalan-operasi">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        let tanggal_pembatalan = $('#tanggal-pembatalan').val();
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-pembatalan-operasi")
    ...
    function editData(val){
        ...
        $('#tanggal-pembatalan').val(arrData[4]);
        $('#pilihan').val(arrData[5]);
        $('#dokter').val(arrData[6]);
        $('#btn-act').val("edit-pembatalan-operasi");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-pembatalan-operasi");
        $('#btn-act').html("Save");
    }
</script>

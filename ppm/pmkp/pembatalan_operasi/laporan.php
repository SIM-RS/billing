...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP PEMBATALAN OPERASI ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">PEMBATALAN ATAU PENUNDAAN OPERASI ELEKTIF RSU PRIMA</th>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_pembatalan_operasi pa ON pa.id_kunjungan = k.id

...
$thData = ['No','Nama','Waktu Datang','Waktu Pelayanan','Penerapan','Action'];
$namaTable = "ppi_komunikasi_efektif";
$act = "tampil_komunikasi_efektif";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-komunikasi-efektif">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-komunikasi-efektif")
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-komunikasi-efektif");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-komunikasi-efektif");
        $('#btn-act').html("Save");
    }
</script>

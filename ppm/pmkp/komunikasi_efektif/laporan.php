...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP KOMUNIKASI EFEKTIF ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">PERSENTASE PENERAPAN READ BACK / EJA ULANG / TBAK RSU ANDHIKA</th>
    </tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, ' Penerapan') ?>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_komunikasi_efektif pa ON pa.id_kunjungan = k.id

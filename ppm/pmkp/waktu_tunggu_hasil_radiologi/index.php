...
$title = 'Waktu Tunggu Hasil Radiologi';
$thData = ['No','Nama','Waktu Datang','Waktu Pelayanan','<= 3 Jam','Action'];
$namaTable = "ppi_waktu_tunggu_hasil_radiologi";
$act = "tampil_data_waktu_tunggu_hasil_radiologi";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-waktu-tunggu-hasil-radiologi">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-waktu-tunggu-hasil-radiologi")
    ...
    function editData(val){
        ...
        $('#jam_selesai').val(arrData[5]);
        $('#btn-act').val("edit-waktu-tunggu-hasil-radiologi");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-waktu-tunggu-hasil-radiologi");
        $('#btn-act').html("Save");
    }
</script>

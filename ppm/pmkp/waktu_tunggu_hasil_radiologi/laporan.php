...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP WAKTU TUNGGU HASIL RADIOLOGI ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">WAKTU TUNGGU HASIL RADIOLOGI RSU ANDHIKA</th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <th class="tengah" rowspan="4">Jam Periksa</th>
        <th class="tengah" rowspan="4">Jam Selesai Hasil</th>
    ...
    FROM
        ...
        INNER JOIN ppi_waktu_tunggu_hasil_radiologi pa ON pa.id_kunjungan = k.id
    ...
    while($rows = $dataPasien->fetch_assoc()){
        echo "<tr>";
            ...
            echo "<td>".$rows['jam_dilayani']."</td>";
            echo "<td>".$rows['jam_selesai']."</td>";
            for($i = 1; $i <= 15; $i++){

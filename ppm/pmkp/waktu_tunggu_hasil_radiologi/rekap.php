...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="REKAP WAKTU TUNGGU HASIL RADIOLOGI ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table class="table table-bordered table-sm">
    ...
    <tr>
        <th class="tengah" colspan="6">RSU ANDHIKA</th>
    </tr>
    <tr>
        <?php getTd(6) ?>
    </tr>
    ...
    <tr>
        ...
        <th rowspan="2">Jam Periksa</th>
        <th colspan="2">Jam Selesai Hasil</th>
    </tr>
    <tr>
        <th>Ya</th>
        <th>Tidak</th>
    ...
    <?php
        ...
        pa.jam_selesai
    FROM 
        ppi_waktu_tunggu_hasil_radiologi pa

...
$title = 'Pemberian Obat Sesuai Resep';
$thData = ['No','Nama','Tanggal Pemantauan','Sesuai Resep','Action'];
$namaTable = "ppi_pemberian_obat_sesuai_resep";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-pemberian-obat-sesuai-resep">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-pemberian-obat-sesuai-resep")
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-pemberian-obat-sesuai-resep");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-pemberian-obat-sesuai-resep");
        $('#btn-act').html("Save");
    }
</script>

...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP PEMBERIAN OBAT SESUAI RESEP ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="34">PEMBERIAN OBAT SESUAI RESEP RSU PRIMA</th>
    </tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, 'SESUAI RESEP') ?>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_pemberian_obat_sesuai_resep pa ON pa.id_kunjungan = k.id

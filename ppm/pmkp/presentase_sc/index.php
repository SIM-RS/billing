...
$title = 'Presentase SC';
$thData = ['No','Nama','Tanggal Pemantauan','Persalinan','Action'];
$namaTable = "ppi_presentase_sc";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="form-input">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Tipe Persalinan</label>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-presentase-sc">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-presentase-sc");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-presentase-sc");
        $('#btn-act').html("Save");
    }
</script>

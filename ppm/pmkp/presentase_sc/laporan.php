...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP PRESENTASE SC ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">PRESENTASI TINDAKAN SECTIO CAESARIA RSU PRIMA</th>
    </tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, 'PERSALINAN') ?>
    </tr>
    <tr>
        <?php getTdKedua(15, 0, ['SC', 'NORMAL']) ?>
    </tr>
    <?php
    ...
    FROM
        ...
        INNER JOIN ppi_presentase_sc pa ON pa.id_kunjungan = k.id

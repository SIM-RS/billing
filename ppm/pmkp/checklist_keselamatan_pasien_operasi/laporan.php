...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP CHECKLIST KESELAMATAN PASIEN OPERASI  ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">CHECKLIST KESELAMATAN PASIEN OPERASI RSU ANDHIKA</th>
    </tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, 'CHECKLIST KESELAMATAN') ?>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_checklist_keselamatan_pasien_operasi pa ON pa.id_kunjungan = k.id
...
<table border="1" class="table table-bordered table-sm">
    ...
    <tr>
        <?php getTd(15, 2, false, 'TUNDA OPERASI') ?>
    </tr>
    <tr>
        <?php getTdKedua(15, 0, ['YA', 'TIDAK']) ?>
    </tr>

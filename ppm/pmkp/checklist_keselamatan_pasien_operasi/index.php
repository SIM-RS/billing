...
$thData = ['No','Nama','Tanggal Operasi','Jenis Operasi','Checklist Keselamatan','Tanggal Dilayani','Action'];
$namaTable = "ppi_checklist_keselamatan_pasien_operasi";
$act = "tampil_keselamatan_pasien_operasi";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form id="form-input">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Tanggal Dilayani</label>
                                <input type="date" name="tanggal-dilayanu" id="tanggal-dilayani" class="form-control">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Cheklist Keselamatan</label>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-keselamatan-pasien-operasi">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        let tanggal_dilayani = $('#tanggal-dilayani').val();
        ...
        $.ajax({
            ...
            data : {
                ...
                user_id : user_id,
                tanggal : tanggal,
                tanggal_dilayani : tanggal_dilayani,
                pilihan : pilihan,
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-keselamatan-pasien-operasi")
    ...
    function editData(val){
        ...
        $('#tanggal-dilayani').val(arrData[4]);
        $('#pilihan').val(arrData[5]);
        $('#dokter').val(arrData[6]);
        $('#btn-act').val("edit-keselamatan-pasien-operasi");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-keselamatan-pasien-operasi");
        $('#btn-act').html("Save");
    }
</script>

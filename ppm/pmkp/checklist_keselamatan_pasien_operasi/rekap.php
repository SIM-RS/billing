...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="REKAP CHECKLIST KESELAMATAN PASIEN OPERASI ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<center>
<h4>REKAP INFEKSI LUKA DAERAH OPERASI
<br>
RSU ANDHIKA</h4>
</center>
<table class="table table-bordered table-sm">
PERIODE : <?= $printOutPutPeriode ?>
    <tr>
        <?php getTd(6) ?>
    </tr>
    <tr>
    ...
    <?php
        ...
        pa.pilihan
    FROM 
    ppi_checklist_keselamatan_pasien_operasi pa

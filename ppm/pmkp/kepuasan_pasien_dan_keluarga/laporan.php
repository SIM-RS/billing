...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="ANGKA KEPUASAN PASIEN RAWAT INAP RSU ANDHIKA ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">ANGKA KEPUASAN PASIEN RAWAT INAP RSU ANDHIKA</th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <th class="tengah" rowspan="4">Tgl Masuk Rawat</th>
        <th class="tengah" rowspan="4">Tgl Pulang</th>
    ...
    FROM
        ...
        INNER JOIN ppi_kepuasan_pasien  pa ON pa.id_kunjungan = k.id

...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP INFEKSI OPERASI ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="38">INFEKSI DAERAH LUKA OPERASI RSU PRIMA</th>
    </tr>
    <tr>
        <th class="tengah" colspan="38">TAHUN <?= $tahun ?></th>
    </tr>
    <tr><?php getTd(38) ?></tr>
    <tr>
    ...
    <tr>
        ...
        <th class="tengah" rowspan="4">Tanggal Operasi</th>
        <th class="tengah" rowspan="4">Jenis Operasi</th>
        <th class="tengha" rowspan="4">Tanggal Masuk Rawat</th>
        <th class="tengha" rowspan="4">Tanggal Pulang</th>
    ...
    FROM
        ...
        INNER JOIN ppi_infeksi_operasi_pmkp pa ON pa.id_kunjungan = k.id

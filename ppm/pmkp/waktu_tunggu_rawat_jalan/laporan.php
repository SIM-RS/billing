...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP WAKTU TUNGGU RAWAT JALAN ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">WAKTU TUNGGU RAWAT JALAN RSU PRIMA</th>
    </tr>
    <tr>
    ...
    $dataPasien = $konek->rawQuery("SELECT
        ...
        k.tgl_act
    FROM
        ppi_waktu_rawat_jalan pa
        INNER JOIN rspelindo_billing.b_kunjungan k  ON pa.id_kunjungan = k.id

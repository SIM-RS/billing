...
$title = 'Kelengkapan Asesmen 1 x 24 Jam';
$thData = ['No','Nama','Tanggal','Rekam Medis','Action'];
$namaTable = "ppi_kelengkapan_asesmen";
$act = "tampil_data_kelengkapan_asesmen";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-kelengkapan-asesmen">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $('#btn-act').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status == 200){
                    if(act == "simpan-kelengkapan-asesmen")
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-kelengkapan-asesmen");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-kelengkapan-asesmen");
        $('#btn-act').html("Save");
    }
</script>

...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP KELENGKAPAN RESEP OBAT ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="34">KELENGKAPAN RESEP OBAT RSU PRIMA</th>
    </tr>
    <tr>
    ...
    FROM
        ...
        INNER JOIN ppi_kelengkapan_resep_obat pa ON pa.id_kunjungan = k.id

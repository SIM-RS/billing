...
if ($_REQUEST['act'] == "excell") {
    ...
    header('Content-Disposition: attachment; filename="LAP ASESMEN PASIEN DIAGNOSA ' . $bulanData[$_REQUEST['bulan']] . ' ' . $_REQUEST['tahun'] . '.xlsx"');
}
...
<table border="1" class="table table-bordered table-sm">
    <tr>
        <th class="tengah" colspan="36">ANGKA PASIEN RAWAT INAP RSU PRIMA CIPTA HUSADA YANG BELUM DITEGAKAN DIAGNOSA SETELAH 3 HARI</th>
    </tr>
    <tr>
    ...
    <tr>
        <?php getTd(15, 2, false, 'DIAGNOSA') ?>
    </tr>
    <tr>
        <?php getTdKedua(15, 0, ['<3h', '>3h']) ?>
    </tr>
    <?php
    ...
    FROM
        ...
        INNER JOIN ppi_pasien_asesmen pa ON pa.id_kunjungan = k.id

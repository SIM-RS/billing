...
$thData = ['No','Nama','Tanggal Pemantauan','Diagnosa','Action'];
$namaTable = "ppi_pasien_asesmen";
$act = "tampil_data_pasien_asesmen";
$laporan = "laporan.php";
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" name="btn-act" id="btn-act" type="button" value="simpan-pasien-asesmen">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function editData(val){
        ...
        $('#btn-act').val("edit-pasien-asesmen");
        $('#btn-act').html("Edit");
    ...
    function btnCloseButtonClick(){
        resetForm('form-input');
        $('#btn-act').val("simpan-pasien-asesmen");
        $('#btn-act').html("Save");
    }
</script>

...
<div class="card mt-2">
    ...
    <div class="card-body">
        ...
        <button class="btn btn-success btn-sm margin-left-auto" id="print-data" type="button" onclick="clickPrint(this.value)">Print</button>
...
<script>
    ...
    $('#lihat-data').on('click', function() {
        ...
        let act = $(this).val();
        $('#print-data').val(id + '|' + id_kunjungan);
    ...
    function clickPrint(val){
        let pecah = val.split("|");
        window.open('<?= $BASE_URL ?>' + '/mirm/laporan.php?id_pasien='+pecah[0]+'&id_kunjungan='+pecah[1],'_blank');
    }

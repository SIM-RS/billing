...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#exampleModal">Laporan Plebitis</button>
            <button type="button" id="lihat-grafik" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#graphicModal" value="utils.php|graphInfus">Grafik</button>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahModalLabel">Tambah Data Plebitis</h5>
                ...
                <form id="infus-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="">Angka Kejadian Plebitis</label>
                                <input type="text" name="angkaKejadianPlebitis" id="angkaKejadianPlebitis" class="form-control">
                            </div>
                        </div>
                    </div>
                </form>
                <!-- <button class="btn btn-sm btn-success" name="actInpus" id="actInpus" type="button" value="simpan">Save</button> -->
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="btnCloseButtonClick()">Close</button>
                <button class="btn btn-success" name="actInpus" id="actInpus" type="button" value="simpan">Save</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="infus/LapInfus.php" method="post" target="_blank">
                    <div class="form-group">
                        <label for="">Ruangan</label>
...
<script>
    ...
    $('#actInpus').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == 200) {
                    if(act == 'simpan') alert('Berhasil memasukan data');
                    ...
                    if(act == 'simpan') alert('Gagal memasukan data');

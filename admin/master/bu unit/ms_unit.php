	...
	<td align="center" style="font-size:large">.: Master Unit :.</td>
        ...
        <tr>
       		<td height="30" valign="bottom" align="right">
                ...
                <img alt="tambah" style="cursor: pointer" src="../images/tambah.png" onClick="location='ms_unit_detail.php'" />&nbsp;&nbsp;
...
ri.setHeader("No,Kode Unit,Nama Unit,Nama Panjang,Level,Aktif");
ri.setColId("NO,kodeunit,namaunit,namapanjang,level,AKTIF");
ri.setColType("string,string,string,string,string,string");
ri.setColWidth("50,100,250,350,50,100");

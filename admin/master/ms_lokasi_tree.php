...
<table width="1000" align="center" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
 <tr>
	<td align="center" nowrap="nowrap">
		<font size="3"><b>.: Daftar Master Tree Lokasi :.</b></font>
	</td>
                    
 </tr>
<tr>
<td align="right" bgcolor="#FFFFFF"><span style="align:right"><button value="Tambah data" onClick="location='ms_lokasi_detail.php?origin=pindah&act=add'" style="cursor:pointer"> Tambah Data <img alt="tambah" style="cursor: pointer" src="../images/tambah.png" />&nbsp;
                   </button></span>&nbsp;&nbsp;</td>                
                </tr>
                           ...
                           $strSQL = "select * from ms_lokasi order by kodelokasi";
                            ...
                            while ($rows=mysql_fetch_array($rs)) {
                               ...
                               // $islast = $rows["islast"];
                                ...
                                if ($lvl > 0)
                                    $tree[$cnt][2]= "ms_lokasi_detail.php?origin=pindah&act=edit&id=".$rows['idlokasi'];
	...
	<tr bgcolor="whitesmoke">
		<td align="center"><button class="Enabledbutton" id="backbutton" onClick="location='ms_lokasi.php'" title="Back" style="cursor:pointer">

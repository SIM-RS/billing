...
function simpan(action)
	{
		if(ValidateForm('txtPenjamin,txtAlmt','ind'))
		{
			...
			var url = "ms_kso_util.php?act="+action+"&id="+id+"&kode=<?php echo $rw['kode']; ?>&nama="+nama+"&kpid="+kpid+"&alamat="+almt+"&telp="+telp+"&fax="+fax+"&kontak="+kontak+"&caktif="+caktif+"&kel_pasien="+kel_pasien+"&diskon="+diskon+"&tipe="+tipe+"&cjamin="+cjamin+"&keterangan="+encodeURIComponent(keterangan);
			//alert(url);
			ri.loadURL(url);

...
var MonthName=["Januari", "Februari", "Maret", "April", "Mei", "Juni","Juli","Agustus", "September", "Oktober", "Nopember", "Desember"];
...
function NewCssCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds,pLoaded) {	
	if(pLoaded) fungsi=pLoaded;
...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
    ...
    if (UseImageFiles)
    {
       vCalTime+="<input type='button' value='kosong' onclick='document.getElementById(\""+Cal.Ctrl+"\").value=\"00-00-0000 00:00:00\";closewin(\"" + Cal.Ctrl + "\"); stopSpin();if(fungsi!=\"\") fungsi(id);'/>     <img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='../images/cal_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    ...
    funcCalback+="if(fungsi!='') fungsi(id);";//tambahan fungsi setelah pengisian tgljam selesai
    funcCalback+="}\n";    
	//alert(funcCalback);

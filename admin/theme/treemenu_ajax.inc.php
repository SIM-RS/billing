<?php  
  ...
  //echo (strpos($browser,"MSIE")>0)?"ie":"mozilla";
  ...
  $img_expand   = $tree_img_path."/tree_expand.gif";
  $img_collapse = $tree_img_path."/tree_collapse.gif";
  $img_line     = $tree_img_path."/tree_vertline.gif";  
  $img_split	= $tree_img_path."/tree_split.gif";
  $img_end      = $tree_img_path."/tree_end.gif";
  $img_leaf     = $tree_img_path."/tree_leaf.gif";
  $img_spc      = $tree_img_path."/tree_space.gif";
    ...
    if ($visible[$cnt])
    {
      ...
      if ($tree[$cnt+1][0]>$tree[$cnt][0])
      {
        ...
        if ($expand[$cnt]==0)
			...
			echo "<td width=16><a href=\"javascript:loadtree('".$script."&*-*".$target."*-*cmbGroup*-*".$params."#$cnt"."','','$pars')\"><img width='16' height='16' src=\"".$img_expand."\" border=no></a></td>";
        else
            echo "<td width=16><a href=\"javascript:loadtree('".$script."&*-*".$target."*-*cmbGroup*-*".$params."*-*".$cnt."#$cnt"."','','".$pars."')\"><img width='16' height='16' src=\"".$img_collapse."\" border=no></a></td>";         
      }
      else
      {
        /*************************/

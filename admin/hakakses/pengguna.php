...
<tr>
	<td align="left">
        ...
        <tr>
			<td align="center" style="font-size:18px; font-weight:bold; font-family: "Courier New", Courier, monospace">.: Setting Hak Akses Menu :.</td>
		</tr>
        <tr>
			<td>&nbsp;</td>
		</tr>
        <tr>
            ...
            <select id="cmbModul" onchange="loadTab()">         	
                <?php
				 $sql="select *from ms_modul where aktif=1 order by id asc";
			...
			<input type="hidden" id="idPeg" name="idPeg" /><input type="hidden" id="namax" name="namax" />
            </td>
		</tr>
        <tr>
			<td>&nbsp;</td>
...
function loadTab()
{
	...
	if(tab=='a0'){
		...
		if(modul_id == 2)
		{
			if(document.getElementById('idPeg').value!='')
			{
				tabbar.forceLoad(tab,"tmptlayanan.php?modul="+document.getElementById('cmbModul').value+"&idPeg="+document.getElementById('idPeg').value+"&namax="+document.getElementById('namax').value);
			}
			else
			{
				alert('Pilih Group Petugas terlebih dahulu'); return false;
			}
		}
		if(modul_id == 3)
		{
			if(document.getElementById('idPeg').value!='')
			{
				tabbar.forceLoad(tab,"tmptlayanan_billing.php?modul="+document.getElementById('cmbModul').value+"&idPeg="+document.getElementById('idPeg').value+"&namax="+document.getElementById('namax').value);
			}
			else
			{
				alert('Pilih Group Petugas terlebih dahulu'); return false;
		...
		{
			tabbar.forceLoad(tab,"blank.php");
		}
	}
}
...
tabbar.addTab("a4", "Tempat Layanan", "130px");
...
tabbar.setContentHref("a4", "blank.php");
...
case 'a3':
	...
	break;
case 'a4':
	if(document.getElementById('cmbModul').value==2)
	{
		if(document.getElementById('idPeg').value!='')
		{
			tabbar.setContentHref("a4", "tmptlayanan.php?modul="+document.getElementById('cmbModul').value+"&idPeg="+document.getElementById('idPeg').value+"&namax="+document.getElementById('namax').value);
		}
		else
		{
			alert('Pilih Group Petugas terlebih dahulu'); return false;
	...
	else if(document.getElementById('cmbModul').value==1)
	{
		if(document.getElementById('idPeg').value!='')
		{
			tabbar.setContentHref("a4", "tmptlayanan_billing.php?modul="+document.getElementById('cmbModul').value+"&idPeg="+document.getElementById('idPeg').value+"&namax="+document.getElementById('namax').value);
		}
		else
		{
			alert('Pilih Group Petugas terlebih dahulu'); return false;

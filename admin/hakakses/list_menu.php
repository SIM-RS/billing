			...
			<input type="hidden" name="data" id="data"/>
				<table width="1000" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" align="center">
					<tr height="100">
						...
						Modul :
						<select name="modul" id="modul" class="txtinput" onChange="window.location='list_menu.php?id='+ document.getElementById('modul').value+'&idx='+document.getElementById('group').value;">
						<?php 
						$modul_id=$_GET['id'];
						...
						<?php } ?>
						</select> <a href="add_menu_akses.php">Tambah Data</a>
						</td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
					...
					<td colspan="3" align="center">
							<table width="700" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFBF0">
								...
								<tr class="header">
									...
									<td width="335" align="center" class="tblheader">Master Menu</td>
									<td width="100" align="center" class="tblheader">Status</td>
									</tr> 
										<?php $no=0; 
		
												$sql="SELECT m.id,m.kode,m.nama,m.level,m.modul_id,IF(n.menu_id=m.id,1,0) NL,m.aktif FROM ms_menu m
													LEFT JOIN (SELECT ga.menu_id,ga.grp_id FROM ms_grup_akses ga WHERE ga.grp_id='$grp_id') n ON n.menu_id=m.id
													WHERE m.modul_id='$modul_id' GROUP BY m.kode";
												//echo $sql;
												$rs=mysql_query($sql);
												$i=0;
								...
								<tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
									...
									<td class="tdisi" align="center" style="vertical-align:middle">
									<?php 
									if ($rw['aktif']=='1'){

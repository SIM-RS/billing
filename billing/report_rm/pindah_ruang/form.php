	...
	<table width=100% cellspacing=0 cellpadding=0 style='border-collapse:collapse; font:12px tahoma;'>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style='border-collapse:collapse; font:12px tahoma;'>
			  <thead>
			    <tr>
			      ...
			      <th width="190">Dosis</th>
			      <th width="100">Jumlah</th>
			      <th width="150">Obat-obat Sisa</th>
			      <th width="50"><input type="button" style='cursor:pointer;' value="+" class="tambahRow2" /></th>
			      </tr>
			    </thead>
			  <tbody class="obatRow">
			    <? 
						...
						while($rsCatat2 = mysql_fetch_array($queryCatat2)){
							echo '<tr class="itemRow2">
									<input type="hidden" id="rawID2" name="rawID2[]" value="1" />
									<td width=40 height=20 align=center>
										<input type="hidden" id="obatID" name="obatID[]" value="'.$rsCatat2['obat_id'].'" />'.$no.'
									</td>
									<td width=240 align="center"><input type="text" class="catatan" id="nama_obat" name="nama_obat[]" value="'.$rsCatat2['nama_obat'].'" /></td>
									<td width=190><input type="text" class="catatan" id="dosis" name="dosis[]" value="'.$rsCatat2['dosis'].'" /></td>
									<td width=100><input type="text" class="catatan" id="jumlah_obat" name="jumlah_obat[]" value="'.$rsCatat2['jumlah_obat'].'" /></td>
									<td width=150><input type="text" class="catatan" id="sisa_obat" name="sisa_obat[]" value="'.$rsCatat2['sisa_obat'].'" /></td>
					...
					<? 
						...
						while($rsCatat = mysql_fetch_array($queryCatat)){
							echo '<tr class="itemRow">
									...
									<td width=40 height=20 align=center>
									<input type="hidden" id="catatID" name="catatID[]" value="'.$rsCatat['catatan_id'].'" />'.$no.'
									</td>
		...
		<tr>
			<td colspan=6 align=center style='padding-top:10px;'>
                ...
                <input type="hidden" id="deleteObat" name="deleteObat" />

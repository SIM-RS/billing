...
switch($act){
	case 'save':
		...
		$sqInsert = "INSERT INTO b_obat_pindah_ruang (nama_obat, dosis, jumlah_obat, sisa_obat, serah_terima_id) VALUES
					('{$nama_obat}', '{$dosis}', '{$jumlah_obat}', '{$sisa_obat}', '{$idSerahTerima}')";
	...
	case 'edit':
		...
		if($queryUpdate){
			...
			if($obat_id != ''){
			$queUpdate = "UPDATE b_obat_pindah_ruang
						  SET nama_obat = '{$nama_obat}', dosis = '{$dosis}', jumlah_obat = '{$jumlah_obat}', sisa_obat = '{$sisa_obat}'
						  WHERE obat_id = '{$obat_id}'";
			mysql_query($queUpdate);
			}else{
			$queInsert = "INSERT INTO b_obat_pindah_ruang (nama_obat, dosis, jumlah_obat, sisa_obat, serah_terima_id) VALUES
					('{$nama_obat}', '{$dosis}', '{$jumlah_obat}', '{$sisa_obat}', '{$serah_terima_id}')";

...
<title>KOP SURAT RESMI RS</title>
</head>
<style>
        .gb{
...
<form id="form1" name="form1" action="surat_pernyataan_act.php">
...
<table width="800" border="0" style="font:12px tahoma;">
  <tr>
    <td width="851" style="font: 12px tahoma;"><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      <col width="27" />
      <col width="64" />
      <col width="20" />
      <col width="138" />
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="12"><span class="style4">Yang bertanda tangan di bawah ini:</span></td>
        <td></td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="3"><span class="style4">Nama</td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="3"><span class="style4">Rumah Sakit</span></td>
        <td colspan="10">: <span class="style4">Rumah Sakit Pelindo I Kota Medan</span></td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="12"><span class="style4">Menyatakan dengan sesungguhnya bahwa,</span></td>
        <td>&nbsp;</td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="12" align="justify" class="style3"><p><span class="style4">1. Saya telah menerima penjelasan mengenai pemeriksaan uji silang serasi (crossmatching) dengan hasil</span></p>
          <p><span class="style4">TIDAK COCOK/INCOMPATIBLE terhadap sampel darah.</span><br />
  &nbsp;&nbsp;&nbsp;</p></td>
        <td>&nbsp;</td>
      </tr>
      <tr height="">
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td width="52">&nbsp;</td>
        <td colspan="2"><span class="style4">- OS</span></td>
        <td colspan="6">:
          <label>
            <input name="texos" type="text" id="texos" />
            <span class="style3"><span class="style4">&nbsp;</span></span>          </label></td>
        <td width="45">&nbsp;</td>
        <td colspan="3">&nbsp;</td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><span class="style4">- No. Reg/Med. Rec</span></td>
        <td colspan="10"><span class="style4">:
            <label for="name"></label>  
            <?=$dP['no_rm'];?>
        </span></td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><span class="style5">-<span class="style4"> Gol. Darah/Rhesus</span></span></td>
        <td colspan="10"><span class="style4">:
            <?=$dP['gol_darah'];?>
        </span></td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><span class="style4">- Bagian/Ruangan</span></td>
        <td colspan="10"><span class="style5">:
            <span class="style4">
            <?=$kamar;?>
            <label for="name"></label>
          /
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><span class="style4">- Rumah Sakit</span></td>
        <td colspan="10">: <span class="style4">Rumah Sakit Pelindo I Kota Medan</span></td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td align="justify" colspan="12"><span class="style4">2. Saya menyatakan tetap akan menggunakan darah dengan hasil <strong>TIDAK COCOK/INCOMPATIBLE</strong> tersebut untuk <br />
&nbsp;&nbsp;&nbsp;&nbsp;kebutuhan transfusi OS di atas.</span></td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td align="justify" colspan="12"><span class="style4">3. Saya bersedia bertanggung jawab atas penggunaan darah dengan hasil <strong>TIDAK COCOK/INCOMPATIBLE</strong> tersebut, dan <br />
&nbsp;&nbsp;&nbsp;&nbsp;tidak akan menuntut pihak unit Donor Darah PMI Kota Medan jika terjadi hal-hal yang tidak diinginkan.</span></td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="12"><span class="style4">Demikian pernyataan ini saya buat untuk dipergunakan sebagaimana mestinya.</span></td>
        <td></td>
      </tr>
      <tr height="">
        <td>&nbsp;</td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="4"><span class="style4">Medan, <?php echo date("j F Y")?></span></td>
        <td width="60"></td>
        <td width="47"></td>
        <td width="96">&nbsp;</td>
        <td width="9">&nbsp;</td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="3"><span class="style4">Yang menyatakan:</span></td>
        <td colspan="3">&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="3"><span class="style4">( <strong>
          <?=$dP['dr_rujuk'];?>
        </strong>)</span></td>
        <td colspan="4">&nbsp;</td>
        <td colspan="4">&nbsp;</td>
  ...
  <tr>
    <td style="border:1px solid #000000;"><table width="800" border="0" align="center">
      <tr>
        <td width="790"></td>
      </tr>
      <tr>
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
		...
		function resetF(){
			...
			//$('#id').val('');
			//$('#txt_anjuran').val('');
            $('#inObat').load("surat_pernyataan_form.php");
			//centang(1,'L')
			}
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("surat_pernyataan_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Datah Kop Surat Resmi");
        ...
        a.baseURL("surat_pernyataan_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("surat_pernyataan.php?id="+id+"&idKunj=<?=$idKunj?>&idPel=<?=$idPel?>&idUsr=<?=$idUsr?>","_blank");
		document.getElementById('id').value="";
				//}
		}

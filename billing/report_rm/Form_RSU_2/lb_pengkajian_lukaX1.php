...
$exD=mysql_fetch_array(mysql_query($sqlD));
  ...
  <tr style="height:14.1pt;">
    ...
    <td class="excel19"></td>
    <td class="excel19"></td>
    <td class="excel19" colspan="5">(<input type="text" name="ttperawat" id="ttperawat" />)</td>
    <td class="excel19"></td>
    <td class="excel19"></td>
  </tr>
  <tr style="height:14.1pt;">
  ...
  <tr style="height:14.1pt;">
    ...
    <td colspan="13" class="excel56" style="border-right:.5pt solid black;height:14.1pt;" align="center">(<input type="text" name="ttkepala" id="ttkepala" />)</td>
    </tr>
  <tr style="height:14.1pt;">
...
<tr height="30">
    ...
    parent.alertsize(document.body.scrollHeight);
        ...
        function ambilData()
        {
            ...
            var p="txtId*-*"+sisip[0]+"*|*riwayat_alergi*-*"+sisip[63]+"*|*lukaisi*-*"+sisip[64]+"*|*etioisi*-*"+sisip[65]+"*|*klinisisi*-*"+sisip[66]+"*|*kulitisi*-*"+sisip[67]+"*|*nyeriisi*-*"+sisip[68]+"*|*tipeeksudatisi*-*"+sisip[69]+"*|*hasillab*-*"+sisip[70]+"*|*posisiisi*-*"+sisip[71]+"*|*tgllab*-*"+sisip[26]+"*|*dressingisi*-*"+sisip[27]+"*|*dressingisi2*-*"+sisip[72]+"*|*dekubitusisi*-*"+sisip[28]+"*|*penunjangisi*-*"+sisip[29]+"*|*hslpemeriksaanisi*-*"+sisip[30]+"*|*ttperawat*-*"+sisip[73]+"*|*ttkepala*-*"+sisip[74]+"";
            //alert(sisip[63]);
            fSetValue(window,p);
		...
		function awal(){
			...
			var p="txtId*-**|*riwayat_alergi*-**|*lukaisi*-**|*etioisi*-**|*klinisisi*-**|*kulitisi*-**|*nyeriisi*-**|*tipeeksudatisi*-**|*hasillab*-**|*dressingisi2*-**|*posisiisi*-**|*ttperawat*-**|*ttkepala*-*";
			fSetValue(window,p);

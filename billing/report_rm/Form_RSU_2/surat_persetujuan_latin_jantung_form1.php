...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <tr height="20">
    <td height="20" colspan="11" align="center"> <strong><u>(<?php echo $pasien['nama_pegawai'];?>)</u></strong> </td>
  </tr>
  <tr height="20">
        ...
        function simpan(action)
        {
            ...
            {*/
                $("#form1").ajaxSubmit({
					...
					batal();
						a.loadURL("surat_persetujuan_latin_jantung_utils.php?grd=true&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>"+"&idKunj=<?=$idKunj?>"+"&saksi=<?=$saksi?>"+"&idUser=<?=$idUsr?>","","GET");
						//goFilterAndSort();
          //  }
		  /*alert("surat_persetujuan_latin_jantung_utils.php?grd=true&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>"+"&idKunj=<?=$idKunj?>"+"&saksi=<?=$saksi[0]?>"+"&idUser=<?=$idUser?>");*/
        }

          ...
          <tr>
            ...
            <td width="584" scope="col"><table width="584">
              ...
              <tr>
                ...
                <td width="17">:</td>
                <td colspan="3"><strong>GCS E V M : <?=$GCS?></strong></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
          ...
          <tr>
            <td scope="col"><table width="300">
              ...
              <tr>
                ...
                <td width="11">:</td>
                <td width="68"><input name="volume_priming" type="text" id="volume_priming" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
                <td width="87">ml</td>
                </tr>
              <!--tr>
                <td>2.</td>

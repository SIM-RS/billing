...
<table width="850" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td align="right">
			<?php if($_REQUEST['report']!=1){?><button id="btnTmbh" name="btnTmbh" onclick="showFormKonsen()" type="button"><img src="../icon/add.gif" width="16" height="16" />&nbsp;Tambah</button><?php }?>
			<div style="display:none"><button id="btnEdit" name="btnEdit" onclick="editKonsen()" type="button"><img src="../icon/edit.gif" width="16" height="16" />&nbsp;Ubah</button>
			<button id="btnHapus" name="btnHapus" onclick="hapusKonsen()" type="button"><img src="../icon/edit.gif" width="16" height="16" />&nbsp;Hapus</button></div>
...
$(function () {
	...
	window.cetakKonsen = function () {
		...
		window.open('1.inform_konsen_print.php?idKunj=<?php echo $kunjunganId; ?>&idPel=<?php echo $pelayananId; ?>&id='+id,"_blank");
	}
});

...
<form name="form1" id="form1" action="vaccination_screening_act.php">
    ...
    <td colspan="2"><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="">
        ...
        <td colspan="5"><label for="dokter"></label>
          <label for="tgl"></label>
          <input type="tgl" name="tgl" id="tgl" onclick="gfPop.fPopCalendar(document.getElementById('tgl'),depRange);" /></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="">
        ...
        <td colspan="2"><input id="radio[]" type="radio" name="radio[0]" value="2" />
      ...
      <tr height="">
        ...
        <td>&nbsp;</td>
        <td colspan="6"><label for="derita"></label>
          <input name="derita" type="text" id="derita" /></td>
        </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="6">&nbsp;</td>
      ...
      <tr height="">
        ...
        <td colspan="2"><label for="checkbox5">
          <input id="radio[]" type="radio" name="radio[1]" value="1" />
          Ya / <em>Yes</em></label></td>
        <td colspan="2"><input id="radio[]" type="radio" name="radio[1]" value="2" />
      ...
      <tr height="">
        ...
        <td>&nbsp;</td>
        <td colspan="6"><label for="sebut"></label>
          <input type="text" name="sebut" id="sebut" /></td>
        </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="6">&nbsp;</td>
      ...
      <tr height="">
        ...
        <td>&nbsp;</td>
        <td colspan="2"><label for="checkbox5">
          <input id="radio[]" type="radio" name="radio[2]" value="1" />
          Ya / <em>Yes</em></label></td>
        <td colspan="2"><input id="radio[]" type="radio" name="radio[2]" value="2" />
          <label for="checkbox4">Tidak / <em>No</em></label></td>
        <td>&nbsp;</td>
        <td></td>
      </tr>
      <tr height="">
        ...
        <td colspan="2"><label for="checkbox6">
          <input id="radio[]" type="radio" name="radio[3]" value="1" />
          Ya / <em>Yes</em></label></td>
        <td colspan="2"><input id="radio[]" type="radio" name="radio[3]" value="2" />
      ...
      <tr height="">
        ...
        <td colspan="2"><label for="checkbox7">
          <input id="radio[]" type="radio" name="radio[4]" value="1" />
          Ya / <em>Yes</em></label></td>
        <td colspan="2"><input id="radio[]" type="radio" name="radio[4]" value="2" />
      ...
      <tr height="">
        ...
        <td colspan="2"><label for="checkbox8">
          <input id="radio[]" type="radio" name="radio[5]" value="1" />
          Ya / <em>Yes</em></label></td>
        <td colspan="2"><input id="radio[]" type="radio" name="radio[5]" value="2" />
      ...
      <tr height="">
        ...
        <td colspan="2"><label for="checkbox9">
          <input id="radio[]" type="radio" name="radio[6]" value="1" />
          Ya / <em>Yes</em></label></td>
        <td colspan="2"><input id="radio[]" type="radio" name="radio[6]" value="2" />
      ...
      <tr height="">
        ...
        <td>&nbsp;</td>
        <td colspan="6"><input type="text" name="riwayat" id="riwayat" /></td>
        </tr>
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="6">&nbsp;</td>
...
<script type="text/javascript">
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("vaccination_screening_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Vaccination Screening");
        a.setColHeader("NO,NO RM,TANGGAL VAKSINASI,PENYAKIT PERNAH DIDERITA,RIWAYAT VAKSINASI,TGL INPUT,PENGGUNA");
        a.setIDColHeader(",no_rm,tgl,derita,riwayat,tgl_act,nama_usr");
        ...
        a.baseURL("vaccination_screening_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("vaccination_screening_cetak.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

...
$sqlP="SELECT p.*,TIMESTAMPDIFF(YEAR,p.tgl_lahir,CURDATE()) AS usia,pl.tgl_act tgl_konsul,mk.nama AS nm_kls,u.nama AS nm_unit, bk.no_reg, IF(p.alamat <> '',CONCAT(p.alamat,' RT. ',p.rt,' RW. ',p.rw, ' Kec. ',bw.nama, ' Kota ',bw1.nama),'-') AS almt_lengkap, IFNULL(bmp.nama,'-') AS nm_dokter
FROM b_pelayanan pl 
...
?>
      ...
      <tr height="20">
        ...
        <td>:</td>
        <td colspan="8" class="gb">&nbsp;<? echo $dP1['ket']?></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>

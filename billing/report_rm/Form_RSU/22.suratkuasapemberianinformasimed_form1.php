...
$sqlP="SELECT 
  ...
  bp.nama AS nama_pegawai, lik.`saksi`, lik.`alamat` AS alamat_saksi, lik.`ktp` AS ktp_saksi
FROM
  b_pelayanan pl 
...
<body>
<div id="form_input" align="center" style="display:blok">
      ...
      <tr>
        <td><table cellspacing="0" cellpadding="0">
          ...
          <tr height="20">
            ...
            <td></td>
            <td></td>
            <td colspan="9">No. Permintaan Informasi Medis:</td>
            <td></td>
          </tr>
          <tr height="20">
            <td height="20">&nbsp;</td>
          ...
          <tr height="20">
            ...
            <td colspan="15"><label>
                ...
                <input type="hidden" name="idUser" id="idUser" value="<?php echo $idUser; ?>" />
              	...
              	<!--<input name="penerima_kuasa" type="text" id="penerima_kuasa" size="50" />-->
                
				<?
                $nm_saksi=explode('*|*', $dP['saksi']);
				echo $nm_saksi[0];
				?>
              </label></td>
            <td></td>
          ...
          <tr height="20">
            ...
            <td></td>
            <td valign="top">:</td>
            <td colspan="15"><?=$dP['alamat_saksi']?></td>
            <td></td>
          </tr>
          <tr height="20">
            <td height="20">&nbsp;</td>
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="18">Selaku:    Pasien/Suami/Istri/Orang Tuan/Ayah/Ibu/Wali/Anak/Penanggung jawab*) yang    mendapat</td>
            <td></td>
            <td></td>
            <td></td>
          </tr>
          ...
          <tr height="20">
            ...
            <td></td>
            <td>:</td>
            <td colspan="11"><?=tgl_ina($dP['tgl_act']);?></td>
            <td>&nbsp;</td>
            <td></td>
          </tr>
          <tr height="20">
            ...
            <td></td>
            <td>:</td>
            <td colspan="12"><?=$dP['nama_pegawai'];?></td>
            <td></td>
          </tr>
          <tr height="20">
            <td height="20">&nbsp;</td>
          ...
          <tr height="32">
            <td height="32" colspan="22"><div align="center">-------------------------------------------------------------------------------K H U S U S -----------------------------------------------------------------------------</div></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td><table cellspacing="2">
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="20">Untuk memberikan    informasi medis mengenai diri saya/pasien tersebut diatas*), baik secara    lisan maupun&nbsp;</td>
            <td></td>
          </tr>
          <tr height="20">
            <td height="20">&nbsp;</td>
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="6">Perorangan/Perusahaan/Asuransi*)</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
      ...
      <tr>
        <td><table cellspacing="0" cellpadding="0">
          ...
          <tr height="20">
            ...
            <td></td>
            <td>:</td>
            <td colspan="12">___________________________________________________________________</td>
            <td></td>
          </tr>
          <tr height="20">
            <td height="20">&nbsp;</td>
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="7">Medan, <?php echo date("j F Y")?></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
...
<script type="text/javascript">
        function simpan(action){
            if(ValidateForm('penerima_kuasa,alamat,no_ktp,tgl_r,tgl_l,tgl_ra,hasil_lain,hubungan')){
				$("#form1").ajaxSubmit({

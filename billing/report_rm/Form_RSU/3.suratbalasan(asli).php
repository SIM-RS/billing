...
<table width="766" border="0" style="font:12px tahoma;">
  <tr>
    <td width="760"><table width="497" border="0" align="right" cellpadding="4" bordercolor="#000000" style="border-collapse:collapse; border:1px solid #000000;">
      <tr>
...
&nbsp;Thn</td>
  ...
  <tr>
    <td style="font:bold 15px tahoma;">SURAT BALASAN</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="20">
        ...
        <td></td>
        <td>:</td>
        <td colspan="5" class="gb">Dr.&nbsp;<?=$dP['dr_rujuk']?></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>

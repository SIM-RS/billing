...
<table width="800" border="0" style="font:12px tahoma;">
  <tr>
    <td width="851" style="font:bold 16px tahoma;"><table cellspacing="0" cellpadding="0" style="border-collapse:collapse; border:1px solid #000000;">
      <col width="64" span="5" />
      <col width="12" />
      <col width="64" span="8" />
      <tr height="25">
      ...
      <tr height="25">
        <td height="25"></td>
        <td colspan="11"><div align="center"><span class="style14">CITO</span></div></td>
        <td></td>
        <td></td>
      </tr>
      <tr height="20">
      ...
      <tr height="20">
        ...
        <td colspan="4"><span class="style15">
            <?=$dP['nama'];?>&nbsp;&nbsp;&nbsp; <span class="style15" <?php if($dP['sex']=='L'){echo 'style="padding:0px 2px 0px 2px; border:1px #000 solid;"';}?>>L</span><span class="style15"> / P</span></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td><span class="style15">:</span></td>
        <td colspan="4"><label>
          <input name="alasan" type="text" id="alasan" />
        </label></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td></td>
        <td></td>
        <td colspan="3"><span class="style15">Medan :
      ...
      <tr height="20">
        ...
        <td colspan="3"><span class="style15">(
          <label>
              <input name="petugas" type="text" id="petugas" />
              </label>
          )</span></td>
        <td></td>
        <td></td>
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
		...
		function resetF(){
			...
			//$('#id').val('');
			//$('#txt_anjuran').val('');
            $('#inObat').load("formulir_permintaan_darah_form.php");
			//centang(1,'L')
			}

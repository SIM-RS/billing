...
$(function () 
{
	$('#selesai_tindakan').timeEntry({show24Hours: true, showSeconds: true});
...
<title>Lembaran Tracking Endoskopi & Bronchoskopi</title>
<style type="text/css">
<!--
...
<table width="800" border="0" style="font:12px tahoma;">
  <tr>
    <td><div align="left">
      <table width="911" height="683" border="0" align="center">
        <tr>
        ...
        <tr>
          <td height="396"><table width="492" height="378" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font:12px tahoma;">
              <col width="164" />
              <col width="11" />
              <col width="140" />
              <col width="105" />
              <tr height="20">
                <td width="4" height="20" class="style1">&nbsp;</td>
                <td colspan="5" class="style1">Proses Pemakaian Sekarang / Pasien Berikutnya :</td>
              </tr>
              <tr height="20">
                <td height="20" colspan="2" class="style1">&nbsp;</td>
                <td width="24" class="style1"></td>
                <td width="86" class="style1"></td>
                <td colspan="2" class="style1">&nbsp;</td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
                <td width="219" height="20" class="style1">Tanggal - Date</td>
                <td class="style1"></td>
                <td colspan="3" class="style1"><label><span class="style15">
                  <input id="s_tgl" name="s_tgl" type="text" value= "<?php echo date("d-m-Y");?>" onclick="gfPop.fPopCalendar(document.getElementById('s_tgl'),depRange);" />
                </span></label>                </td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
                ...
                <td height="20" class="style1">&nbsp;</td>
                <td class="style1"><label>
                  <input name="s_teskebocoran" type="radio" value="1" />
                  Baik</label>                </td>
                <td colspan="2" class="style1"><label>
<input name="s_teskebocoran" type="radio" value="2" />                  
Gagal</label>                </td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
                ...
                <td height="20" class="style1">&nbsp;</td>
                <td colspan="3" class="style1"><label>
              ...
              <tr height="20">
                ...
                <td class="style1"></td>
                <td class="style1"><label>
<input name="s_cekair" type="radio" value="1" />                  
Ya</label>                </td>
                <td width="150" class="style1"><label>
                  <input name="s_cekair" type="radio" value="2" />
                  Tidak</label>                </td>
              ...
              <tr height="20">
                ...
                <td height="20" class="style1">&nbsp;</td>
                <td class="style1"><label>
                  <input name="s_cekalkohol" type="radio" value="1" />
                  Ya</label>                </td>
                <td class="style1"><label>
<input name="s_cekalkohol" type="radio" value="2" />                  
Tidak</label>                </td>
                <td class="style1">&nbsp;</td>
              </tr>
              <tr height="20">
                ...
                <td height="20" class="style1">Penanggung Jawab</td>
                <td height="20" class="style1">&nbsp;</td>
                <td colspan="3" class="style1"><input name="s_pj2" type="text" id="s_pj2" /></td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
                <td height="20" class="style1">&nbsp;</td>
                <td height="20" class="style1">&nbsp;</td>
                <td colspan="3" class="style1"><label></label>                </td>
              </tr>
          </table></td>
          <td><table width="474" height="374" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font:12px tahoma;">
              ...
              <tr height="20">
                ...
                <td class="style1"></td>
                <td colspan="2" class="style1"><label><span class="style15">
                  <input id="a_tgl" name="a_tgl" type="text" value= "<?php echo date("d-m-Y");?>" onclick="gfPop.fPopCalendar(document.getElementById('a_tgl'),depRange);" />
                </span></label>                </td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
                ...
                <td height="20" class="style1">&nbsp;</td>
                <td class="style1"><label>
<input name="a_teskebocoran" type="radio" value="1" />                  
Baik</label>                </td>
                <td class="style1"><label>
                  <input name="a_teskebocoran" type="radio" value="2" />
                  Gagal</label>                </td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
              ...
              <tr height="20">
                ...
                <td class="style1"></td>
                <td class="style1"><label>
<input name="a_cekair" type="radio" id="a_cekair" value="1" />                  
Ya</label>                </td>
                <td class="style1"><label>
<input name="a_cekair" type="radio" id="a_cekair" value="2" />                  
Tidak</label>                </td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
                ...
                <td height="20" class="style1">&nbsp;</td>
                <td class="style1"><label>
                  <input name="a_cekalkohol" type="radio" id="a_cekalkohol" value="1" />
                  Ya</label>                </td>
                <td class="style1"><label>
                  <input name="a_cekalkohol" type="radio" id="a_cekalkohol" value="2" />
                  Tidak</label>                </td>
              </tr>
              <tr height="20">
                <td height="20" class="style1">&nbsp;</td>
        ...
        <tr>
          <td colspan="2"><table width="767" height="985" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font:12px tahoma;">
            <col width="64" span="2" />
            <col width="86" />
            <col width="63" />
            <col width="86" />
            ...
            <tr height="20">
              ...
              <td width="17"></td>
              <td colspan="11">Diagnosa Keperawatan    Yang Muncul :</td>
            </tr>
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td colspan="9">1. Gangguan rasa aman : 
                <label>
                cemas b</label>/
                <label>
            ...
            <tr height="20">
              <td height="35"></td>
              <td></td>
              <td colspan="9">2. Gangguan rasa nyaman : 
                <label>
            ...
            <tr height="20">
              ...
              <td></td>
              <td>:</td>
              <td colspan="3">1. Anesfar</td>
              <td colspan="2"><label>
                <input name="anesfar" type="text" id="anesfar" />
              mg/iv</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">2. pethidine</td>
              <td colspan="2"><label>
                <input name="pethidine" type="text" id="pethidine" />
              mg/iv</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">3. Andrenaline</td>
              <td colspan="2"><label>
                <input name="andrenaline" type="text" id="andrenaline" />
              mg</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">4. Recopol</td>
              <td colspan="2"><label>
                <input name="recopol" type="text" id="recopol" />
              mg</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">5. SA</td>
              <td colspan="2"><label>
                <input name="sa" type="text" id="sa" />
              mg</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">6. Buscopan</td>
              <td colspan="2"><label>
                <input name="buscopan" type="text" id="buscopan" />
              mg</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">7. Aetoxysclerol</td>
              <td colspan="2"><label>
                <input name="aetoxysclerol" type="text" id="aetoxysclerol" />
              mg</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">8. Factu Supp</td>
              <td colspan="2"><label>
                <input name="factusup" type="text" id="factusup" />
              </label></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td></td>
              <td colspan="3">9. Xylocain Spray</td>
              <td colspan="2"><label>
                <input name="xylocain" type="text" id="xylocain" />
              </label></td>
              <td></td>
              <td></td>
            </tr>
            ...
            <tr height="20">
              ...
              <td width="73">TD :
                <label></label></td>
              <td width="109"><input name="td" type="text" id="td" size="15" />                
                 mmHg</td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td colspan="3">SPO2 :
                <label>
                <input name="spo2" type="text" id="spo2" size="15" />
                </label></td>
              <td colspan="2">R : 
                <label>
                <input name="r" type="text" id="r" size="15" />
                x/m</label></td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td></td>
              <td colspan="2"><label>
                <input name="radiobutton[4]" type="radio" onclick="tampil(this);" value="1" />
                Ada 
                </label></td>
              <td><input name="radiobutton[4]" type="radio" value="2" />
Tidak 
              <td>Bila ada: </td>
              <td width="109">    <div id="status" style="display: none"> <input style="display:inline;" name="_cc" type="text" size="30" id="_cc"/>
    </div></td>
            </tr>
            <tr height="20">
              <td height="20"></td>
              ...
              <td><input name="radiobutton[5]" type="radio" value="2" />
Kurang</td>
              <td><input name="radiobutton[5]" type="radio" value="3" />
Rusak</td>
              <td>&nbsp;</td>
              <td></td>
              <td></td>
            ...
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td colspan="9">1. Gangguan rasa nyaman:
                <label>
                Nyeri b</label>                <label></label>/ d proses tindakan ENDOSKOPY</td>
              <td>&nbsp;</td>
              <td></td>
            </tr>
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td colspan="9">2. Potensial perdarahan saluran cerna atas / bawah
                <label>
            ...
            <tr height="20">
              ...
              <td></td>
              <td colspan="3"><label>
                <input name="rest_infeksi" type="hidden" id="rest_infeksi" />
              </label></td>
              <td colspan="2"></td>
              <td></td>
              <td></td>
            ...
            <tr height="20">
              ...
              <td></td>
              <td colspan="3"><label>
                <input name="restiaspirasi" type="hidden" id="restiaspirasi" />
              </label></td>
              <td colspan="2"></td>
              <td></td>
              <td></td>
            ...
            <tr height="20">
              ...
              <td></td>
              <td colspan="3"><label>
                <input name="resti_syok" type="hidden" id="resti_syok" />
              </label></td>
              <td colspan="2"></td>
              <td></td>
              <td></td>
            ...
            <tr height="20">
              ...
              <td colspan="3" >Jam
                <label>
                <input name="selesai_tindakan" type="text" id="selesai_tindakan" size="15"    value="<?=date('H:i:s')?> 
				";  />
            ...
            <tr height="20">
              ...
              <td><input name="radiobutton[7]" type="radio" value="2" />
Kanan</td>
              <td colspan="2"><input name="radiobutton[7]" type="radio" value="3" />
Terlentang</td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td><input name="radiobutton[8]" type="radio" value="2" />
Sedang</td>
              <td colspan="2"><input name="radiobutton[8]" type="radio" value="3" />
Buruk (CM/Delir/Coma) </td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td width="37"><input name="radiobutton[9]" type="radio" value="2" />
1</td>
              <td><input name="radiobutton[9]" type="radio" value="3" />
2 Jam</td>
              <td colspan="2"></td>
              <td></td>
              <td></td>
            ...
            <tr height="20">
              ...
              <td>:</td>
              <td><label>
                <input name="spuit_5cc" type="text" id="spuit_5cc" size="15" />
                </label></td>
              <td></td>
              <td colspan="3">i. Tegaderm</td>
              <td colspan="2">:
                <input name="tegaderm" type="text" id="tegaderm" size="15" /></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td>b. Spuit 3cc</td>
              <td>:</td>
              <td><input name="spuit_3cc" type="text" id="spuit_3cc" size="15" /></td>
              <td></td>
              <td colspan="3">j. Aquabidest</td>
              <td colspan="2">:
                <input name="aquabides" type="text" id="aquabides" size="15" /></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td>c. Spuit 10cc</td>
              <td>:</td>
              <td><input name="spuit_10cc" type="text" id="spuit_10cc" size="15" /></td>
              <td></td>
              <td colspan="3">k. Xylocain Jelly</td>
              <td colspan="2">:                
                <label>
                <input name="xylocain2" type="text" id="xylocain2" size="15" />
                </label></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              ...
              <td>d. Spuit 20cc</td>
              <td>:</td>
              <td><input name="spuit_20cc" type="text" id="spuit_20cc" size="15" /></td>
              <td></td>
              <td colspan="3">l. Selang O2</td>
              <td colspan="2">:
                <input name="selangO2" type="text" id="selangO2" size="15" /></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td>e. Infus set / Blood Set  </td>
              <td>:</td>
              <td><input name="infus_set" type="text" id="infus_set" size="15" /></td>
              <td></td>
              <td colspan="3">m. Alkohol Swab</td>
              <td colspan="2">:
                <input name="alkohol_swab" type="text" id="alkohol_swab" size="15" /></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td>f. Cidex opa / eidezime</td>
              <td>:</td>
              <td><input name="cidex_opa" type="text" id="cidex_opa" size="15" /></td>
              <td></td>
              <td colspan="3">n. Nacl 0,9%</td>
              <td colspan="2">:
                <input name="nacl" type="text" id="nacl" size="15" /></td>
              <td></td>
              <td></td>
            </tr>
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td>g. Vasofik No. 20.22.24</td>
              <td>:</td>
              <td><input name="vasofik" type="text" id="vasofik" size="15" /></td>
              <td></td>
              <td colspan="3"></td>
              <td colspan="2"></td>
              <td></td>
            ...
            <tr height="20">
              <td height="20"></td>
              <td></td>
              <td>h. Neddle No. 23</td>
              <td>:</td>
              <td><input name="neddle" type="text" id="neddle" size="15" /></td>
              <td></td>
              <td colspan="3"></td>
              <td colspan="2"></td>
              <td></td>
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
        ...
        function ambilData(){		
			...
			$('#s_tanda').val(sisip[7]);
			$('#s_skope').val(sisip[8]);
			$('#s_nobath').val(sisip[9]);
			$('#s_nomulai').val(sisip[10]);
			$('#s_selesai').val(sisip[11]);
			$('#s_pj1').val(sisip[12]);
			s_cekair(sisip[13]);
			s_cekalkohol(sisip[14]);
			$('#s_pj2').val(sisip[15]);
			$('#a_tgl').val(sisip[16]);
			a_teskebocoran(sisip[17]);
			$('#a_tanda').val(sisip[18]);
			$('#a_skope').val(sisip[19]);
			$('#a_nobath').val(sisip[20]);
			$('#a_nomulai').val(sisip[21]);
			$('#a_selesai').val(sisip[22]);
			$('#a_pj1').val(sisip[23]);
			cekair(sisip[24]);
			a_cekalkohol(sisip[25]);

			$('#a_pj2').val(sisip[26]);
			$('#radiobutton[0]').val(sisip[27]);
			$('#radiobutton[1]').val(sisip[28]);
			$('#radiobutton[2]').val(sisip[29]);
			//$('#radiobutton[3]').val(sisip[30]);
			tiga(sisip[30]);
			
			$('#_cc').val(sisip[30]);
			lima(sisip[30]);
			$('#anesfar').val(sisip[31]);
			$('#pethidine').val(sisip[32]);
			$('#andrenaline').val(sisip[33]);
			$('#recopol').val(sisip[34]);
			$('#sa').val(sisip[35]);
			$('#buscopan').val(sisip[36]);
			$('#aetoxysclerol').val(sisip[37]);
			$('#factusup').val(sisip[38]);
			$('#xylocain').val(sisip[39]);
			$('#td').val(sisip[40]);
			$('#spo2').val(sisip[41]);
			$('#r').val(sisip[42]);
			empat(sisip[43]);
			//$('#radiobutton[4]').val(sisip[43]);
			$('#radiobutton[5]').val(sisip[44]);
			$('#radiobutton[6]').val(sisip[45]);
			$('#potensial_perdarahan').val(sisip[46]);
			$('#rest_infeksi').val(sisip[47]);
			$('#restiaspirasi').val(sisip[48]);
			$('#resti_syok').val(sisip[49]);
			$('#selesai_tindakan').val(sisip[50]);
			tujuh(sisip[52]);
			delapan(sisip[52]);
			sembilan(sisip[53]);
			$('#spuit_5cc').val(sisip[54]);
			$('#spuit_3cc').val(sisip[55]);
			$('#spuit_10cc').val(sisip[56]);
			$('#spuit_20cc').val(sisip[57]);
			$('#infus_set').val(sisip[58]);
			$('#cidex_opa').val(sisip[59]);
			$('#vasofik').val(sisip[60]);
			$('#neddle').val(sisip[61]);
			$('#tegaderm').val(sisip[62]);
			$('#aquabides').val(sisip[63]);
			$('#xylocain2').val(sisip[64]);
			$('#selangO2').val(sisip[65]);
			$('#alkohol_swab').val(sisip[67]);
			$('#nacl').val(sisip[68]);
			$('#_cc').val(sisip[69]);
        ...
        a.setHeader("Data Lembaran Tracking Endoskopi & Bronchoskopi");
...
//				}else{	
		...
		var list=tes.split(',');
		var list1 = document.form1.elements['s_teskebocoran'];
		var list2 = document.form1.elements['s_teskebocoran'];
		...
		function s_cekair(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['s_cekair'];
		var list2 = document.form1.elements['s_cekair'];
		...
		if ( list2.length > 1 )
		{
		 for (i = 1; i < list2.length; i++)
		  ...
		  function s_cekalkohol(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['s_cekalkohol'];
		var list2 = document.form1.elements['s_cekalkohol'];
		...
		function a_teskebocoran(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['a_teskebocoran'];
		var list2 = document.form1.elements['a_teskebocoran'];
		...
		if ( list2.length > 1 )
		{
		 for (i = 1; i < list2.length; i++)
		  ...
		  function cekair(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['a_cekair'];
		var list2 = document.form1.elements['a_cekair'];
		...
		function a_cekalkohol(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['a_cekalkohol'];
		var list2 = document.form1.elements['a_cekalkohol'];
		...
		if ( list2.length > 1 )
		{
		 for (i = 1; i < list2.length; i++)
		  ...
		  function tiga(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['radiobutton[3]'];
		var list2 = document.form1.elements['radiobutton[3]'];
		...
		if ( list2.length > 1 )
		{
		 for (i = 1; i < list2.length; i++)
		  ...
		  function empat(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['radiobutton[4]'];
		var list2 = document.form1.elements['radiobutton[4]'];
		...
		if ( list2.length > 1 )
		{
		 for (i = 1; i < list2.length; i++)
		  ...
		  function lima(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['radiobutton[5]'];
		var list2 = document.form1.elements['radiobutton[5]'];
		...
		if ( list2.length > 1 )
		{
		 for (i = 1; i < list2.length; i++)
		  ...
		  function tujuh(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['radiobutton[7]'];
		var list2 = document.form1.elements['radiobutton[7]'];
		var list3 = document.form1.elements['radiobutton[7]'];
			...
			if ( list3.length > 2 )
		{
		 for (i = 2; i < list3.length; i++)
		  ...
		  function delapan(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['radiobutton[8]'];
		var list2 = document.form1.elements['radiobutton[8]'];
		var list3 = document.form1.elements['radiobutton[8]'];
		 ...
		 for (i = 2; i < list3.length; i++)
			{
			  if (list3[i].value==list[2])
			  {
			   list3[i].checked = true;
				  ...
				  function sembilan(tes){
		var list=tes.split(',');
		var list1 = document.form1.elements['radiobutton[9]'];
		var list2 = document.form1.elements['radiobutton[9]'];
...
$('input:radio[name="radiobutton[4]"]').change(
    function tampil(){
        if ($(this).val() == 1) {
            $('#status').slideDown(600);
        }
			...
			document.getElementById('_cc').value="";
        }

...
&nbsp;Thn</td>
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="20">
        <td>&nbsp;</td>
        <td colspan="3" valign="top">Keluhan Utama<br><em>Chief Compliant</em></td>
        <td valign="top">:</td>
        <td colspan="8" ><textarea name="keluhan" cols="40" rows="5" id="keluhan"></textarea></td>
        <td></td>
      </tr>
      <tr height="20">
        <td>&nbsp;</td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="3" valign="top">Hasil pemeriksaan yang ditemukan<br><em>Examination Result</em></td>
        <td valign="top">:</td>
        <td colspan="8" ><textarea name="hasil" cols="40" rows="5" id="hasil"></textarea></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
...
?>
      ...
      <tr height="20">
        ...
        <td><input id="c_chk[]" type="checkbox" name="c_chk[0]" value="Mohon konsul satu kali" /></td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td></td>
        <td><input id="c_chk[]" type="checkbox" name="c_chk[1]" value="Mohon untuk rawat bersama" /></td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td ></td>
        <td><input id="c_chk[]" type="checkbox" name="c_chk[2]" value="Mohon untuk alih rawat" /></td>

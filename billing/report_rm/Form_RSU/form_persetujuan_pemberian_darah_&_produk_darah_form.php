...
<table width="800" border="0" style="font:12px tahoma;">
  ...
  <tr>
    <td colspan="2" style="font:bold 16px tahoma;"><table cellspacing="0" cellpadding="0" style="border:1px solid #000000; font:12px tahoma;">
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="14"><div align="center" class="style4">FORMULIR PERSETUJUAN PEMBERIAN DARAH DAN PRODUK    DARAH</div></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        ...
        <td colspan="4">:
          <?=$dP['nama'];?></td>
        <td></td>
        <td colspan="3">No. Rekan Medik : </td>
        <td><?=$dP['no_rm'];?></td>
        <td></td>
        <td colspan="2">&nbsp;</td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td>:
          <label></label></td>
        <td width="130"><input type="text" maxlength="10" value="<?php echo $date_now;?>" onFocus="this.select();" onBlur="if(this.value==''){this.value='<?php echo $date_now;?>'}" onKeyUp="setTgl(event,this)" name="textgl_lahir" id="textgl_lahir" size="17" onClick="gfPop.fPopCalendar(document.getElementById('textgl_lahir'),depRange,gantiUmur);"/>      &nbsp;    &nbsp; &nbsp;</td>
      ...
      <tr height="20">
        ...
        <td colspan="4">&nbsp;&nbsp;&nbsp;Hubungan dengan pihak yang diwakili :
          <label></label></td>
        <td colspan="5"><input name="texhubungan" type="text" id="texhubungan" /></td>
        <td></td>
        <td></td>
        <td colspan="2"></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="14"><label>
          <input name="checkbox[0]" type="checkbox" id="checkbox[0]" value="0" />
          </label>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="14"><label>
          <input name="checkbox[1]" type="checkbox" id="checkbox[1]" value="1" />
          </label>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="10"><label>
          <input name="checkbox[2]" type="checkbox" id="checkbox[2]" value="2" />
          </label>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="14"><span class="style10">_</span>atas pemberian darah dan produk    darah terhadap diri saya sendiri / pihak yang sya wakili.</td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="2"><div align="center"><span class="style9"><span class="style8">(</span>&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style8">)</span></div></td>
        <td colspan="3"><div align="center"><span class="style9"><span class="style8">(&nbsp;</span>&nbsp;</span><?=$dP['dr_rujuk'];?>
          &nbsp;&nbsp;<span class="style8">)</span></div></td>
        <td></td>
        <td width="47"><label> <span class="style8">(

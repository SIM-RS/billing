    ...
    <td><table width="800" border="0" style="border:1px solid #000000">
      <tr>
        <td><table cellspacing="0" cellpadding="0">
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="20">RS PELINDO I,    beralamat di 
              <?=$dP2['alamat'];?></td>
            <td></td>
          </tr>
          <tr height="20">
      ...
      <tr>
        <td><table cellspacing="2">
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="8">Medan, <?php echo date("j F Y")?></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
      ...
      <tr>
        <td><table cellspacing="0" cellpadding="0">
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="4" align="center"><strong><u><?=$dP2['penerima_kuasa'];?></u></strong></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>

...
$dG=mysql_fetch_array(mysql_query("select * from b_form_persetujuan_pemberian_darah where id='$_REQUEST[id]'"));
?>
<style>
.kotak{
  ...
  <tr>
    <td colspan="2"><table cellspacing="0" cellpadding="0" style="border:1px solid #000000; font:12px tahoma;">
      ...
      <tr height="20">
        ...
        <td>:
          <label></label></td>
        <td width="130"><?=$dG['taggal_lahir'];?>          &nbsp;    &nbsp; &nbsp;</td>
        <td width="12"><span class="style11">/</span></td>
        <td><label></label>
          <?=$dG['umur'];?></td>
        <td width="47"> tahun,</td>
        <td width="138">&nbsp;</td>
        <td colspan="3"> Jenis Kelamin</td>
        <td width="57">:
          <label>
            <input name="radiobutton" type="radio" value="1" <? if ($dG['jenis_kelamin']=='1') { echo "checked='checked'";}?>/>
            L</label></td>
        <td width="102"><label>
          <input name="radiobutton" type="radio" value="2" <? if ($dG['jenis_kelamin']=='2') { echo "checked='checked'";}?>/>
          P</label></td>
        <td></td>
        <td></td>
      </tr>

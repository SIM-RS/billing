    ...
    <BR>
        <center><table width="828" style="border:1px #000 solid; border-collapse:collapse">
          ...
          <tr>
            ...
            <input name="penyakit" type="text" id="penyakit" size="50" /></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><center><input type="button" name="simpen" id="simpen" class="tblTambah" value="Simpan" onclick="simpan();document.getElementById('tampil_input').style.display='none'"/> 

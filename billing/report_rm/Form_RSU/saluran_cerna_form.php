...
<form id="form1" name="form1" action="saluran_cerna_act.php">
...
<table width="800" border="0" style="font:12px tahoma;">
  <tr>
    <td width="336"><div align="left">
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p class="style3">CEKLIST    PELAYANAN ENDOSKOPI SALURAN CERNA</p>
    </div></td>
    <td width="515"><table width="508" border="0" align="right" cellpadding="4" bordercolor="#000000" style="border-collapse:collapse; border:1px solid #000000;">
      <tr>
  ...
  <tr>
    <td colspan="2" style="font:bold 16px tahoma;"><div align="left">
      <table width="855" height="950" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font:12px tahoma;">
        <col width="64" />
        <col width="102" />
        <col width="254" />
        <col width="11" />
        ...
        <tr height="20">
          ...
          <td><span class="style7">Tanggal </span></td>
          <td><label>
            <input id="tgl" name="tgl" type="text" value= "<?php echo date("d-m-Y");?>" onclick="gfPop.fPopCalendar(document.getElementById('tgl'),depRange);" />
          </label></td>
          <td width="27"></td>
          <td></td>
        </tr>
        ...
        <tr height="20">
          ...
          <td width="149">&nbsp;</td>
          <td></td>
          <td><span class="style5">Dr. Pengirim : </span>            <?=$dP['dr_rujuk'];?></td>
          </tr>
        <tr height="20">
          <td height="20"></td>
          <td colspan="2"></td>
        ...
        <tr height="20">
          <td height="20">&nbsp;</td>
          <td><span class="style5">Identitas : </span></td>
          <td><span class="style5">
            <input type="text" name="txtIdentitas" id="txtIdentitas" />
          </span></td>
          <td></td>
          <td></td>
        </tr>
        <tr height="20">
          <td height="20"></td>    <td colspan="2"></td>
          <td></td>
          <td></td>
        </tr>
        <tr height="20">
        ...
        <tr height="20">
          ...
          <td></td>
          <td><label>
            <input name="txtGastroskkopi" type="text" id="txtGastroskkopi" size="40" />
            </label>          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label>
            <input name="txtKolonoskopi" type="text" id="txtKolonoskopi" size="40" />
            </label>          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label></label>
              <input name="txtLigasi" type="text" id="txtLigasi" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label></label>
              <input name="txtPolipectomi" type="text" id="txtPolipectomi" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label></label>
              <input name="txtKauterisasi" type="text" id="txtKauterisasi" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label></label>
              <input name="txtSthemoroid" type="text" id="txtSthemoroid" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label></label>
              <input name="txtSafari" type="text" id="txtSafari" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          <td colspan="2"><span class="style5">h. Kolonoskopi &amp; STH&nbsp;</span></td>
          <td></td>
          <td><input name="txtKolonoskopisth" type="text" id="txtKolonoskopisth" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          ...
          <td></td>
          <td><label></label>
              <input name="txtPolipectomihautensasi" type="text" id="txtPolipectomihautensasi" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="20"></td>
          <td colspan="2"><span class="style5">j. Heat Probe Vikuskager / Ovodeni&nbsp;</span></td>
          <td></td>
          <td><input name="txtHeadprobe" type="text" id="txtHeadprobe" size="40" />          </td>
        </tr>
        <tr height="20">
          <td height="32"></td>
          <td colspan="2"></td>
...
?>
        ...
        <tr height="20">
          <td height="20"></td>
          <td colspan="2"><span class="style5">a. Keaadaan Umum</span></td>
          <td>:</td>
          <td><?=$dP['ku2'];?></td>
        </tr>
        <tr height="20">
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("saluran_cerna_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        ...
        a.baseURL("saluran_cerna_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("saluran_cerna.php?id="+id+"&idKunj=<?=$idKunj?>&idPel=<?=$idPel?>&idUsr=<?=$idUsr?>","_blank");
		document.getElementById('id').value="";
				//}
		}

...
<table width="766" border="0" style="font:12px tahoma;">
  ...
  <tr>
    ...
    <input type="hidden" name="idUsr" id="idUsr" size="5" value="<?php echo $_SESSION['userId']; ?>" /></td>
        <td width="20"></td>
        <td width="64"></td>
        <td width="51"></td>
        <td width="99"></td>
...
?>
      ...
      <tr height="20">
        ...
        <td></td>
        <td></td>
        <td colspan="6" align="center"><span class="gb1">
          (<u><b><?=$dokter?></b></u>)
        </span></td>
        <td></td>
      </tr>
...
//			else
//			{	
				window.open('3.suratbalasan_view.php?idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idUser=<?=$idUser?>&idPasien=<?=$idPasien?>&id='+rowid,"_blank");

...
k.cara_keluar, a.bb as bb2, a.tb as tb2, IFNULL(pg.nama,'-') AS dr_rujuk,kk.no_reg as no_reg2,
IF(
    p.alamat <> '',
    CONCAT(
      p.alamat,
...
&nbsp;Thn</td>
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td>Kepada<br><em>To</em></td>
        <td></td>
        <td></td>
        <td>:</td>
        <td colspan="5"><label for="dokter"></label><?=$dG['nama2'];?></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="12">Dengan ini kami hadapkan pasien untuk konsultasi dan tindak lanjut <br> <em>Herewith, we would like    to refer the&nbsp; following patient for    your consultation and follow up</em></td>
        <td></td>
      </tr>
      <tr height="20">
        <td>&nbsp;</td>
      ...
      <tr height="20">
        ...
        <td colspan="3">Keluhan Utama<br><em>Chief Compliant</em></td>
        <td>:</td>
        <td colspan="8" ><?=$dG['keluhan'];?></td>
        <td></td>
      </tr>
      <tr height="20">
        <td>&nbsp;</td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="3">Hasil pemeriksaan yang ditemukan<br><em>Examination Result</em></td>
        <td>:</td>
        <td colspan="8" ><?=$dG['hasil'];?></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="2" rowspan="2" valign="top">Diagnosa<br/>
          <em>Diagnosis</em></td>
        <td rowspan="2"></td>
...
?>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="3">Terimakasih kerjasamanya <br> <em>Thank you for your    cooperation</em></td>
        <td>:</td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <?php 
	  $isi=explode(",",$dG['pilihan']);
	  ?>
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td ><label for="checkbox"></label></td>
        <td><input disabled="disabled" type="checkbox" name="checkbox" value="checkbox" <? if($isi[0]=='Mohon konsul satu kali') { echo "checked='checked'";}?> /></td>
        <td colspan="8">Mohon konsul satu kali<br><em>Single Consultation (only)</em></td>
        <td></td>
        <td></td>
        <td></td>
      </tr>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td></td>
        <td><input disabled="disabled" type="checkbox" name="checkbox" value="checkbox" <? if($isi[1]=='Mohon untuk rawat bersama') { echo "checked='checked'";}?> /></td>
        <td colspan="3">Mohon untuk rawat bersama<br><em>Join responsibility</em></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td ></td>
        <td><input disabled="disabled" type="checkbox" name="checkbox" value="checkbox" <? if($isi[2]=='Mohon untuk alih rawat') { echo "checked='checked'";}?> /></td>
        <td colspan="2">Mohon untuk alih rawat<br><em>Transfer responsibility</em></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td></td>
        <td></td>
        <td colspan="6"><div align="center"><em>Attending Doctor,</em></div></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
      ...
      <tr height="20">
        ...
        <td></td>
        <td></td>
        <td colspan="6"><div align="center"><em>Name and signature</em></div></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>

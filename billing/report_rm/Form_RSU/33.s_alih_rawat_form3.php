...
body{background:#FFF;}
        ...
        <div align="center">
          ...
          <!--  <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="2" align="center" >
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="12" align="center"><div id="form_in" style="display:block;">
                <form name="form1" id="form1" action="33.s_alih_rawat_act.php">
  ...
  <tr>
    <td colspan="13">Asuhan Gizi Anak</td>
  </tr-->
  ...
  <tr style="border:1px solid">
    <td colspan="13"><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="20">
        ...
        <td>:</td>
        <td colspan="8"><input type="text" id="nm_w" name="nm_w"></input>
		<select id="sex_w" name="sex_w">
      ...
      <tr height="20">
        ...
        <td>:</td>
        <td colspan="8"><input type="text" id="umur_w" name="umur_w"></input></td>
		<td>&nbsp;</td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
        ...
        <td>:</td>
        <td colspan="8"><input type="text" id="no_ktp_w" name="no_ktp_w"></input></td>
		<td>&nbsp;</td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
        ...
        <td>:</td>
        <td colspan="8"><textarea name="almt_w" cols="45" rows="5" class="textArea" id="almt_w"></textarea></td>
		<td>&nbsp;</td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
        ...
        <td>:</td>
        <td colspan="8"><input type="text" id="no_telp_w" name="no_telp_w"></input></td>
		<td>&nbsp;</td>
      </tr>
      <!--tr height="20">
        <td height="20">&nbsp;</td>
        ...
        <td>:</td>
        <td colspan="8" ><input type="text" id="tgl" name="tgl" onclick="gfPop.fPopCalendar(document.getElementById('tgl'),depRange);"></input></td>
		<td>&nbsp;</td>
      </tr-->
      <tr height="20">
      ...
      <tr height="20">
        <td height="20" colspan="13">Dalam hal ini atas nama mewakili : 
		<select name="jns_w" id="jns_w"><option value="">Pilih</option>
			...
			<option value="Keluarga">Keluarga</option></select></td>
      </tr>
	  <tr height="20">
        <td height="20" colspan="13">&nbsp;</td>
      </tr>
	  ...
	  <tr height="20">
        ...
        <td>:</td>
        <td colspan="8"><?=$dP['nm_unit'];?>&nbsp;/&nbsp;<?=$dP['nm_kls'];?></td>
		<td>&nbsp;</td>
      </tr>
	  <tr height="20">
        <td height="20">&nbsp;</td>
      ...
      <tr height="20">
        <td colspan="3">Dokter yang <strong>Merawat</strong> saat ini</td>
        <td colspan="9">:&nbsp;<?=$dP['drnya']?>&nbsp;&nbsp;Spesialis : <?=$dP['spec']?></td>
        <td>&nbsp;</td>
      </tr>
	  <tr height="20">
      ...
      <tr height="20">
        <td height="20" colspan="13">Alasan mengganti dokter yang merawat adalah : </td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
        <td colspan="11"><textarea name="alasan" cols="45" rows="5" class="textArea" id="alasan"></textarea></td>
        <td>&nbsp;</td>
      </tr>
      <tr height="20">
        <td height="20" colspan="13">&nbsp;</td>
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
        ...
        function ambilData(){	
			...
			$('#sex_w').val(sisip[1]);
			$('#jns_w').val(sisip[2]);
			$('#id_dokter_pengganti').val(sisip[3]);
			$('#nm_w').val(sisip[4]);
			$('#umur_w').val(sisip[5]);
			$('#no_ktp_w').val(sisip[6]);
			$('#almt_w').val(sisip[7]);
			$('#no_telp_w').val(sisip[8]);
			$('#alasan').val(sisip[9]);
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("33.s_alih_rawat_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Surat Alih rawat");
        a.setColHeader("NO,NO RM,NAMA PASIEN,NAMA PJ,UMUR PJ,NO KTP PJ,ALAMAT PJ,NO TELP PJ,ALASAN,TGL INPUT,PENGGUNA");
        a.setIDColHeader(",no_rm,nm_pasien,,,,,,,,");
        a.setColWidth("50,100,300,300,300,100,100,100,100,100,100");
        ...
        a.baseURL("33.s_alih_rawat_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("33.s_alih_rawat.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUser?>","_blank");
				//}
		}

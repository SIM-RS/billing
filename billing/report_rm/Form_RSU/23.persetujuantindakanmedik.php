...
<title>Persetujuan Tindakan Medik Depan</title>
</head>
<?
//include "setting.php";
?>
...
//include "setting.php";
$sql2="SELECT a.*,b.nama as nama2,c.nama as nama3 
	FROM b_tindakan_medik a 
	LEFT JOIN b_ms_tindakan b ON b.id=a.id_tindakan1
	LEFT JOIN b_ms_tindakan c ON c.id=a.id_tindakan2
...
<table width="800" border="0" align="center" style="font:12px tahoma;">
  ...
  <tr>
    <td style="font:bold 14px tahoma;">COSENT TO MEDICAL/SURGICAL TREATMENT</td>
  </tr>
  <tr>
    <td><table width="809" border="0" style="border:1px solid #000000;">
      ...
      <tr>
        <td><table cellspacing="2" cellpadding="2">
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="7" style="font:10px tahoma;">The undersigned consent    to undergo the operation/procedure of:</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="10"><strong><?=$dP2['nama2'];?></strong></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td></td>
          </tr>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="3" style="font:10px tahoma;">Which will be conducted    by doctor:</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="11" style="font:10px tahoma;">The nature, purpose dan    potential complications of which has been explained to me by the above    mentined doctor</td>
            <td></td>
            <td></td>
          </tr>
          <tr height="20">
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="7" style="font:10px tahoma;">I have also been    explained clearly regarding alternative procedures as follows:</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="20">
            <td height="20">&nbsp;</td>
            <td colspan="11"><strong><?=$dP2['nama3'];?></strong></td>
            <td>&nbsp;</td>
            <td></td>
          </tr>
          <tr height="20">
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="3">The undersigned who    consent to:</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="9" style="font:10px tahoma;">The transfusion of blood    and other blood derived products as the surgeon or physician feels necessary</td>
            <td></td>
            <td></td>
            <td></td>
          </tr>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="10" style="font:10px tahoma;">The attending    physician/surgeon seeking consultation or assistance form other relevant    specialist when it is</td>
            <td></td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="5" style="font:10px tahoma;">needed during the course    of this operation/prosedure</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="10" style="font:10px tahoma;">Patient may be admitted    to the Intensive&nbsp; Care Unit based on    patient's condition-For any medical care and&nbsp;</td>
            <td></td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="6" style="font:10px tahoma;">treatment that is    normally conducted in the Intensive Care</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="9" style="font:10px tahoma;">In the event of staff    receiving a needlestick/splash injury, agree to laboratory testing of my    blood</td>
            <td></td>
            <td></td>
            <td></td>
          </tr>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="3" style="font:10px tahoma;">Risk/Benefits of proposed    procedure (s)</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td rowspan="2"></td>
            <td colspan="10" style="font:10px tahoma;">Just as there may be    benefits to the procedure(s) proposed, I also understand that medical and    surgical procedure</td>
            <td></td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="2">involve risk such as:</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="11">The risk include    allergic reaction, bleeding, blood clots, infections, side effects of drugs    and even loss of body function or life</td>
            <td></td>
          </tr>
          <tr height="20">
            <td height="20">&nbsp;</td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="11" style="font:10px tahoma;">I also acknowledge that    the particular risk enumerated in the attachment are associated with the    procedure (s) proposed</td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td></td>
            <td colspan="2">for me</td>
            <td></td>
            <td></td>
            <td></td>
            <td colspan="6"></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="5" style="font:10px tahoma;">Complications, Unforeseen    Conditions, Results</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="12" style="font:10px tahoma;">I am aware that in the    practice of medicine, other unexpected risk or complications not discussed my    occur. I also understand that</td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="12" style="font:10px tahoma;">during the course of the    proposed prosedure (s) unforeseen conditions may be revealed requiring the    performance of prosedures</td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="11" style="font:10px tahoma;">specifically related to    the consented surgery and I authorize such procedures to be performed. I    futher acknowledge that no</td>
            <td></td>
            <td></td>
          </tr>
          <tr height="17">
            <td height="17">&nbsp;</td>
            <td colspan="8" style="font:10px tahoma;">guarantee or promises    have been given to me concerning the result of any procedure</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            ...
            <tr>
              <td><table cellspacing="0" cellpadding="0">
                  ...
                  <tr height="20">
                    <td height="20">&nbsp;</td>
                    <td></td>
                    <td colspan="5">Disetujui oleh pasien /    Consent by patient</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                  ...
                  <tr height="20">
                    <td height="20">&nbsp;</td>
                    <td></td>
                    <td colspan="4">Signature of doctor and    Full Name</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td colspan="5">Signature of hospital    witness and full name</td>
                  </tr>
                  <tr height="20">
                    <td height="20">&nbsp;</td>
                    <td>&nbsp;</td>
        ...
        <td><table width="809" border="0" style="border:1px solid #000000;">
            <tr>
              <td><table cellspacing="0" cellpadding="0">
                  ...
                  <tr height="17">
                    <td height="17">&nbsp;</td>
                    <td colspan="13">Where the patient is    below 21 years old or invalid or for some other reason, unable to sign the    above, the hospital reserves the discretion</td>
                  </tr>
                  <tr height="17">
                    <td height="17">&nbsp;</td>
                  ...
                  <tr height="20">
                    <td height="20">&nbsp;</td>
                    <td colspan="13">* Jelaskan alasan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    &hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;..</td>
                  </tr>
                  <tr height="17">
                    <td height="17">&nbsp;</td>
                  ...
                  <tr height="17">
                    <td height="17">&nbsp;</td>
                    <td></td>
                    <td colspan="8">Confirm that I have    authority to sign the consent form on behalf of the patient</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                  ...
                  <tr height="17">
                    <td height="17">&nbsp;</td>
                    <td></td>
                    <td colspan="6">Have read and understand    and accept all information on this consent form</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                  ...
                  <tr height="17">
                    <td height="17">&nbsp;</td>
                    <td></td>
                    <td colspan="10">Confirm that I have been    explained and fully understand about the treatment/procedure to be performed</td>
                    <td></td>
                    <td></td>
                  </tr>
                  <tr height="20">
                  ...
                  <tr height="20">
                    <td height="20" colspan="14"><div align="center"><tr id="trTombol">

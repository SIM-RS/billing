...
$sqlP="SELECT pl.tgl as tgl2, bk.no_reg, p.*,TIMESTAMPDIFF(YEAR,p.tgl_lahir,CURDATE()) AS usia,mk.nama AS nm_kls, p.gol_darah as gol_darah2, u.nama AS nm_unit,IFNULL(pg.nama,'-') AS dr_rujuk, a.ku as ku2, a.kesadaran as kes2,
...
<form id="form1" name="form1" action="formulir_permintaan_darah_act.php">
...
<table width="800" border="0" style="font:12px tahoma;">
  <tr>
    <td width="297" style="font:bold 16px tahoma;"><p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>PELAYANAN REHABILITASI MEDIK </p></td>
    <td width="572" style="font:bold 16px tahoma;"><table width="508" border="0" align="right" cellpadding="4" bordercolor="#000000" style="border-collapse:collapse; border:1px solid #000000;">
      <tr>
        <td width="124"><span class="style15">Nama Pasien</span></td>
        <td width="173"><span class="style15">:
          <?=$dP['nama'];?>
        </span></td>
        <td width="75"><span class="style15"></span></td>
        <td width="102"><span class="style15"></span></td>
      </tr>
      <tr>
        ...
        <td><span class="style15">Usia</span></td>
        <td><span class="style15">:
          <?=$dP['usia'];?>
          Thn</span></td>
      </tr>
  ...
  <tr>
    <td colspan="2" style="font:bold 16px tahoma;"><table width="798" height="564" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border:0px;">
      <tr height="70">
        <td height="41" width="117"><div align="center" class="style16">TANGGAL</div></td>
        <td width="562"><div align="center" class="style16">PEMERIKSAAN</div></td>
        <td width="111"><div align="center" class="style16">PARAF</div></td>
        </tr>
      <tr height="70">
        <td height="480"><span class="style15">
          <?=tglSQL($dP['tgl2']);?>
        </span></td>
        <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="2" ><table width="800" border="0" align="center">
      ...
      <tr>
        <td align="center"><span class="noline">
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("formulir_permintaan_darah_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Fromulir Permintaan Darah");
        ...
        a.baseURL("formulir_permintaan_darah_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("formulir_permintaan_darah.php?id="+id+"&idKunj=<?=$idKunj?>&idPel=<?=$idPel?>&idUsr=<?=$idUsr?>","_blank");
		document.getElementById('id').value="";
				//}
		}

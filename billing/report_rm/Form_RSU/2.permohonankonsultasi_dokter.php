...
WHERE k.pelayanan_id='$idPel1'";
$qK=mysql_query($sqlK);
$rwK=mysql_fetch_array($qK);
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="20">
        ...
        <td></td>
        <td>:</td>
        <td colspan="5" class="gb"><? echo $rwK['dokter'];?></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
...
?>
      ...
      <tr height="20">
        ...
        <td>:</td>
        <td colspan="8" class="gb">&nbsp;<?
		$query = "SELECT ket FROM b_konsul WHERE pelayanan_id = '$idPel1' ORDER BY id DESC LIMIT 1";
...
-->      <tr height="20">
      ...
      <tr height="20">
		...
		$sDok="SELECT mp.nama FROM b_konsul a INNER JOIN b_ms_pegawai mp ON a.dokter_perujuk=mp.id WHERE a.id='".$_REQUEST['idKon']."'";

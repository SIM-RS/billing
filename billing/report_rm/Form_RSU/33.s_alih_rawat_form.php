...
<form id="form1" name="form1" action="33.s_alih_rawat_act.php">
...
<table width="808" border="0" style="font:12px tahoma;">
  <tr>
    <td width="802" style="font:12px tahoma;"><table align="center" cellpadding="2" cellspacing="0" style="border:1px solid #000000;">
      <col width="64" />
      <col width="20" />
      <col width="132" />
      <col width="20" />
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("33.s_alih_rawat.php?id="+id+"&idKunj=<?=$idKunj?>&idPel=<?=$idPel?>&idUsr=<?=$idUsr?>","_blank");
		document.getElementById('id').value="";
				//}
		}

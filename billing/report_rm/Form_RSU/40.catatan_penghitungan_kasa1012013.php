                ...
                <td width="777" align="center"><div id="intable">
                  <table width="1060" border="1" id="tblkegiatan" cellpadding="2" style="border-collapse:collapse;">
                    ...
                    <tr>
                      ...
                      <td align="center"><input name="j_awal[]" type="text" id="j_awal[]" size="3" onkeyup="hitung()"/></td>
...
// right cell
		...
		if(!isIE){
			...
			el = document.createElement('<input name="j_awal[]"/>');
		}
		el.type = 'text';
		el.value = '';
		el.size = 3;
...
// right cell
		...
		if(!isIE){
			...
			el = document.createElement('<input name="tambahan1[]"/>');
		}
		el.type = 'text';
		el.value = '';
		el.size = 3;
...
// right cell
		...
		if(!isIE){
			...
			el = document.createElement('<input name="tambahan2[]"/>');l
		}
		el.type = 'text';
		el.value = '';
		el.size = 3;
...
// right cell
		...
		if(!isIE){
			...
			el = document.createElement('<input name="tambahan3[]"/>');
		}
		el.type = 'text';
		el.value = '';
		el.size = 3;
...
// right cell
		...
		if(!isIE){
			...
			el = document.createElement('<input name="tambahan4[]"/>');
		}
		...
		if(!isIE){
			...
			el = document.createElement('<input name="tambahan5[]"/>');
		}
		...
		if(!isIE){
			...
			el = document.createElement('<input name="j_sementara"/>');
		}
		...
		if(!isIE){
			...
			el = document.createElement('<input name="tambahan[]"/>');
		}
		...
		if(!isIE){
			...
			el = document.createElement('<input name="j_akhir[]"/>');
		}
...
function ambilData(){		
	...
	$('#jam').val(sisip[5]);
	$('#jam2').val(sisip[6]);
	//$('#jumlah_kasa').val(sisip[7]);
	//$('#jumlah_jarum').val(sisip[8]);
	//$('#jumlah_instrumen').val(sisip[9]);
	//$('#jumlah_pisau').val(sisip[10]);
	$('#txtId').val(sisip[0]);

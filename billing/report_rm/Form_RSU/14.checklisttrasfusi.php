...
LEFT JOIN lap_inform_konsen li ON k.id=li.kunjungan_id AND pl.id=li.pelayanan_id
WHERE pl.id='$idPel';";
    ...
    <td style="border:1px solid #000000;"><table width="800" border="0">
      ...
      <tr>
        <td colspan="2"><table cellspacing="0" cellpadding="0">
          ...
          <tr height="20">
            <td colspan="6" height="20"><div align="center"><strong>(<?=$dP['penanggung'];?>)</strong></div></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
          ...
          <tr height="20" id="trTombol">
            <td colspan="16" height="20" align="center"><input type="submit" name="button" id="button" value="Cetak" onclick="cetak(document.getElementById('trTombol'));" />

    ...
    <td colspan="3">
      <table>
        <tr>
          <td width="180">
            Tekanan darah
            <input name="tekanan_darah" type="text" id="tekanan_darah" size="3" />
            mmHg </td>
          <td width="173">
            Pernafasan
          ...
          <td width="139">
            Nadi
            <input name="nadi" type="text" id="nadi" size="3" />
            X/menit </td>
          <td width="111">
            Suhu
            <input name="suhu" type="text" id="suhu" size="3" />      &deg;
            C
            </td>
          </tr>
        </table>
  ...
  <tr>
    ...
    <table align="center" width="781" border="1" id="tblObat" cellpadding="2" style="border-collapse:collapse;">
      ...
      <tr>
        ...
        <td align="center" valign="middle"><img alt="del" src="../icon/del.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Menghapus" onClick="if (confirm('Yakin Ingin Menghapus Data?')){removeRowFromTable(this);}"></td>
      </tr>
    </table>
    </div>
    </td>
...
<td><input type="text" id="dokter" name="dokter[]"><?php /*?><?php
...
// right cell
 ...
 // right cell
                ...
                if(!isIE){
                    el = document.createElement('img');
                    el.setAttribute('onClick','if (confirm(\'Yakin Ingin Menghapus Data?\')){removeRowFromTable2(this);}');
                }else{

...
<input type="hidden" name="idPel" value="<?=$idPel?>" />
                ...
                <input type="hidden" name="pengkajian_id" id="pengkajian_id" value="<?=$id?>"/>
      ...
      <tr>
        ...
        <table width="600" height="auto" border="1" align="left" cellpadding="2" id="tblObat" style="border-collapse:collapse;">
          <tr>
            ...
            <?
					$no=1;
					$sql2="select * from b_ms_pengkajian_pasien_anak1 where pengkajian_id ='$id'";	
          ...
          <tr bgcolor="<?=$bg?>">
            ...
            <td align="center"><?=$dH['jenis'];?></td>
            <td align="center"><?=$dH['keterangan1'];?></td>
            <td align="center"><?=$dH['jenis2'];?></td>
            <td align="center"><?=$dH['keterangan2'];?></td>
            </tr>
            <?
				$no++;
			}
      ...
      <tr>
        ...
        <div id="inObat2">
          <table width="600" height="auto" border="1" align="left" cellpadding="2" id="tblObat2" style="border-collapse:collapse;">
            ...
            <?
					$no=1;
					$sql2="select * from b_ms_pengkajian_pasien_anak2 where pengkajian_id ='$id'";	
					$query=mysql_query($sql2);
            ...
            <tr bgcolor="<?=$bg?>">
              <td align="center"><?=$no?></td>
              <td align="center"><?=$d2['jenis_pemeriksaan']?></td>
              <td align="center"><?=$d2['bagian']?></td>
              <td align="center"><?=$d2['lembar']?></td>
              <td align="center"><?=$d2['keterangan']?></td>
            </tr>
            <?
					$no++;
				}

...
memahami alternatif pemberian darah    dan produk darah</td>
      ...
      <tr height="20">
        ...
        <td colspan="17" rowspan="2" align="justify"><label for="textfield5"></label>
          <!--<textarea disabled="disabled" name="alasan" cols="70" id="alasan"><?=$dG['alasan']?></textarea>--><?=$dG['alasan']?></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        ...
        <td align="justify">&nbsp;</td>
        <td colspan="2" align="center">(<strong><u><?=$dP['dr_rujuk'];?></u></strong>)</td>
        <td align="center">&nbsp;</td>
        <td colspan="2" align="center"><label for="textfield9"></label>
          (<strong><u><?=$dG['saksi1']?></u></strong>)</td>
        <td colspan="5" align="center"><label for="textfield8"></label>
          (<strong><u><?=$dG['saksi2']?></u></strong>)</td>
        </tr>
      <tr height="20">
        <td height="20"></td>
        <td>&nbsp;</td>

...
<table width="800" border="0" style="font:12px tahoma;">
  ...
  <tr>
    <td colspan="2" style="font:bold 16px tahoma;"><table cellspacing="0" cellpadding="0" style="border:1px solid #000000; font:12px tahoma;">
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="10"><div align="center" class="style4">FORMULIR PERSETUJUAN PEMBERIAN DARAH DAN PRODUK    DARAH</div></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        ...
        <td></td>
        <td></td>
        <td colspan="2">No. Rekan Medik : </td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="5">Saya yang bertanda tangan di bawah ini,</td>
        <td></td>
        <td></td>
        <td colspan="2"></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td>:
          <label>
            <input name="texnama" type="text" id="texnama" />
          </label></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="2">Tanggal lahirUmur</td>
        <td>:
          <label>
            <input name="textgl_lahir" type="text" id="textgl_lahir" />
          </label></td>
        <td>/
          <label>
            <input name="texumur" type="text" id="texumur" size="15" />
          </label></td>
        <td>tahun,</td>
      ...
      <tr height="20">
        ...
        <td>:
          <label>
            <input name="texalamat" type="text" id="texalamat" />
          </label></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td>:
          <label>
            <input name="texno_tlp" type="text" id="texno_tlp" />
          </label></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td colspan="4">Hubungan dengan pihak yang diwakili :
          <label>
            <input name="texhubungan" type="text" id="texhubungan" />
          </label></td>
        <td>&nbsp;</td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="10">telah membaca atau dibacakan keterangan pada    formedukasi transfusi darah dan telah dijelaskan hal-hal terkait mengenai    prosedur transfusi darah yang akan dilakukan terhadap diri saya sendiri /    pihak yang saya wakili *),</td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="3">dan saya menyatakan untuk</td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="10">atas pemberian darah dan produk    darah terhadap diri saya sendiri / pihak yang sya wakili.</td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        ...
        <td>tanggal</td>
        <td><label>
          <input name="textgl" type="text" id="textgl" />
        </label></td>
        <td>jam</td>
        <td colspan="2"><label>
          <input name="texjam" type="text" id="texjam" />
        </label></td>
        <td></td>
        <td colspan="2"></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td></td>
        <td colspan="2"><label> (
          <input name="texsaksi1" type="text" id="texsaksi1" size="22" />
          )</label></td>
        <td>&nbsp;</td>
        <td colspan="2"><div align="center">
            <label> (
              <input name="texsaksi2" type="text" id="texsaksi2" />
            </label>
          )</div></td>
        <td></td>
        <td></td>

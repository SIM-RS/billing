...
<table width="800" border="0" align="center" style="font:12px tahoma;">
  ...
  <tr>
    <td colspan="2"><table cellspacing="0" cellpadding="0" style="border:1px solid #000000; font:12px tahoma;">
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="13"><div align="center" class="style4 style11"><strong>FORMULIR PERSETUJUAN PEMBERIAN DARAH DAN PRODUK    DARAH</strong></div></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
...
?>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="8">&nbsp;&nbsp;&nbsp;Saya yang bertanda tangan di bawah ini,</td>
        <td></td>
        <td></td>
        <td colspan="2"></td>
        <td></td>
      ...
      <tr height="20">
        ...
        <td>:
          <label></label></td>
        <td colspan="4"><?=tglSQL($dG['taggal_lahir']);?>          &nbsp;&nbsp;<span class="style11">/</span>
          <label></label>
          <?=$dG['umur'];?>           tahun,</td>
        <td colspan="3"> Jenis Kelamin</td>
        <td width="54">:
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="8">&nbsp;&nbsp;&nbsp;Hubungan dengan pihak yang diwakili :
          <label>
          &nbsp; &nbsp;<?=$dG['hubungan'];?>
          </label></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="13">&nbsp;&nbsp;&nbsp;telah membaca atau dibacakan keterangan pada    formedukasi transfusi darah dan telah dijelaskan hal-hal terkait mengenai prosedur transfusi darah yang akan dilakukan terhadap diri saya sendiri /    pihak yang saya wakili *),</td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="4" bgcolor="#FFFFFF"><span class="style10">_</span>dan saya menyatakan untuk</td>
        <td></td>
        <td colspan="3"></td>
        <td></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="13"><span class="style10">_</span>atas pemberian darah dan produk    darah terhadap diri saya sendiri / pihak yang saya wakili.</td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20"></td>
      ...
      <tr height="20">
        ...
        <td colspan="2"><div align="center">Dokter</div></td>
        <td></td>
      ...
      <tr height="20">
        <td height="20"></td>
        <td colspan="2"><div align="center">(<strong><u><?=$dG['name'];?></u></strong>)</div></td>
        <td colspan="2"><div align="center">(<strong><u><?=$dP['dr_rujuk'];?></u></strong>)</div></td>
        <td></td>
        <td colspan="3"><label></label>
          <div align="center">(<strong><u><?=$dG['saksi1'];?></u></strong>)</div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><div align="center">(<strong><u><?=$dG['saksi2'];?></u></strong>)</div></td>
        <td>&nbsp;</td>
        <td></td>
      </tr>
      <tr height="20">

...
$sqlP="SELECT p.*,TIMESTAMPDIFF(YEAR,p.tgl_lahir,CURDATE()) AS usia,mk.nama AS nm_kls,u.nama AS nm_unit,pl.unit_id AS unitId,IFNULL(pg.nama,'-') AS dr_rujuk
FROM b_pelayanan pl 
...
/*$sqlB="SELECT * 
	  FROM anamnese a 
	  WHERE a.PEL_ID='".$idPel."' AND a.KUNJ_ID='".$idKunj."';";
$dB=mysql_fetch_array(mysql_query($sqlB));*/
//include "setting.php";
?>
...
<table width="755" border="0" cellpadding="4" style="font:12px tahoma;">
      ...
      <tr>
        <td><table width="900">
          ...
          <tr>
            ...
            <td><input type="checkbox" name="check[5]" id="check[]" value="5"/> 
              Tinggi
  </td>
            </tr>
          </table></td>
        ...
        <td><table width="900" border="1" style="border-collapse:collapse">
          <tr>
            <td width="300" scope="col"><table width="300">
              ...
              <tr>
                <td>Riwayat Penyakit Sekarang : <strong><?=$RPS?></strong><div style="display:none"><label for="riwayat"></label>
                  <textarea name="riwayat" id="riwayat" cols="45" rows="5"></textarea></div></td>
              </tr>
              <tr>
                <td>Riwayat Penyakit Dahulu : <strong><?=$RPD?></strong></td>
              </tr>
              <tr>
                <td>Riwayat Penyakit Keluarga : <strong><?=$RPK?></strong></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                </tr>
            ...
            <td width="584" scope="col"><table width="584">
              ...
              <tr>
                <td colspan="3">BB Kering : <? //=$bb;?><input name="bbkering" type="text" id="bbkering" size="3"  /> Kg</td>
                <td>TB : <?
               				if($tb=="")
							{
								?>
	                                <input name="tbadan" type="text" id="tbadan" size="3"  />
                                <?
							}else{
								echo $tb;
							}
				?> 
                <!--<input name="tbadan" type="text" id="tbadan" size="3"  />--> cm</td>
                <td>BMI : 
              ...
              <tr>
                <td>Mata </td>
                <td>:</td>
                <td colspan="3"><?=$AMATA?><label for="mata"></label>
                  <input type="hidden" name="mata" id="mata" /></td>
                </tr>
              <tr>
                <td>Pulma</td>
                <td>:</td>
  ...
  <tr>
    <td colspan="5"><table width="900" border="1" style="border-collapse:collapse">
      ...
      <tr>
        <td><table width="900" border="1" style="border-collapse:collapse">
          <tr>
            <td colspan="18"><strong>Anjuran/usulan tindak lanjut : <?=$UTINLANJUT;?></strong></td>
            </tr>
          <tr>
                ...
                <tr>
                  <td><table width="800">
                    ...
                    <tr>
                      ...
                      <td width="50">5
                        <input type="checkbox" name="check[11]" id="check[]" class="skala_nyeri" value="11"/></td>
                      <td width="50">6
          ...
          <tr>
            <td scope="col"><table width="450">
              <tr>
                ...
                <td width="79">  Kg</td>
                <td width="19">&nbsp;</td>
                <td width="115" colspan="2">BB Post HD 
                  <input name="bb_post_hd" type="text" id="bb_post_hd" size="3"  /> Kg</td>
                </tr>
              <tr>
                <td colspan="2">Intradialitik Weight Gain 
                  <input name="iwg" type="text" id="iwg" size="3" />
                  Kg </td>
                <td>&nbsp;</td>
                <td colspan="2">KT/V
                <input name="ktv" type="text" id="ktv" size="3" />
                </td>
                <!--<td>&nbsp;</td>-->
             </tr>
              <tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td><?=$TENSI?>  /  <?=$TENSI_DIASTOLIK?>   mmHg</td>
                <td>&nbsp;</td>
                </tr>
              <tr>
        ...
        <td><table width="900">
          ...
          <tr>
            ...
            <td width="152">Jenis Dialiser :
              <input style="display:none;" name="jenis_dialiser" type="text" id="jenis_dialiser" size="5" />
              <input type="checkbox" name="check[20]" id="check[]" value="20"/> New</td>
            <td width="71"><!--<input type="checkbox" name="check[20]" id="check[]" value="20"/> -->
            <input type="checkbox" name="check[21]" id="check[]" value="21" onclick="reuse(this.checked);" /> Reuse &nbsp;
			<script type="text/javascript">
				function reuse(cek){
					if(cek==true){
						document.getElementById('reuse_ke').value="";
						document.getElementById('reuse_ke').style.display="inline-block";
					} else {
						document.getElementById('reuse_ke').style.display="none";
						document.getElementById('reuse_ke').value="";
					}
				}
			</script>
            ...
            <input style="display:none;" name="reuse_ke" type="text" id="reuse_ke" size="5" />
            <!--input style="display:none;" name="dialiser_ke" type="text" id="dialiser_ke" size="5" /-->
            </td>
            <td>Tipe Dialiser</td>
          ...
          <tr>
            ...
            <td><input type="checkbox" name="check[22]" id="check[]" value="22"/> 
              AV Shunt</td>
            <td>TCV: </td>
            <td><input id="tcv" type="text" size="5" name="tcv" onKeyUp="sumsemua(this.value,4)"></td>
          ...
          <tr>
            ...
            <td><input type="checkbox" name="check[24]" id="check[]" value="24" /> 
              Famoral</td>
            <td>Volume AVBL :</td>
            <td><input id="avbl" type="text" size="5" name="avbl" onKeyUp="sumsemua(this.value,4)"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td>Total Volume :</td>
            <td><input id="total_volume" type="text" size="5" name="total_volume" readonly></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td scope="col"><table width="300">
              ...
              <tr>
                ...
                <td width="91">&nbsp;</td>
                <td width="11">&nbsp;</td>
                <td width="68"><input type="hidden" name="volume_priming" id="volume_priming" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
                <td width="87">&nbsp;</td>
                </tr>
              <!--tr>
                <td>2.</td>
              ...
              <tr>
                ...
                <td>Sisa priming</td>
                <td>:</td>
                <td><input name="sisa_priming" type="text" id="sisa_priming" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
                <td>ml</td>
                </tr>
              <tr>
                <td>2.</td>
                <td>Cairan drip</td>
                <td>:</td>
                <td><input name="cairan_drip" type="text" id="cairan_drip" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
                <td>ml</td>
                </tr>
              <tr>
                <td>3.</td>
                <td>Darah</td>
                <td>:</td>
                <td><input name="darah" type="text" id="darah" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
                <td>ml</td>
                </tr>
              <tr>
                <td>4.</td>
                <td>Wash Out</td>
                <td>:</td>
                <td><input name="wash_out" type="text" id="wash_out" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
                <td>ml</td>
              </tr>
			  <tr>
			    <td>5</td>
			    <td>Minum</td>
			    <td>:</td>
			    <td><input name="minum" type="text" id="minum" size="5" onKeyUp="sumsemua(this.value,1)" /></td>
			    <td>ml</td>
			    </tr>
			  <tr>
				<td>&nbsp;</td>
                <td>Total</td>
                <td>:</td>
                <td><input name="totaljml" type="text" id="totaljml" size="5" readonly /></td>
                <td>ml</td>
			  </tr>
              <tr>
			  ...
			  <tr>
                ...
                <td>Urine</td>
                <td>:</td>
                <td><input name="OUrine" type="text" id="OUrine" size="5" onKeyUp="sumsemua(this.value,2)" /></td>
                <td>ml</td>
			  </tr>
			  <tr>
				<td>2.</td>
                <td>Muntah</td>
                <td>:</td>
                <td><input name="OMuntah" type="text" id="OMuntah" size="5" onKeyUp="sumsemua(this.value,2)" /></td>
                <td>ml</td>
			  </tr>
			  <tr>
				<td>3.</td>
                <td>Ultrafiltrasi</td>
                <td>:</td>
                <td><input name="OUltra" type="text" id="OUltra" size="5" onKeyUp="sumsemua(this.value,2)" /></td>
                <td>ml</td>
			  </tr>
			  <tr>
				<td>&nbsp;</td>
                <td>Total</td>
                <td>:</td>
                <td><input name="Ototaljml" type="text" id="Ototaljml" size="5" readonly /></td>
                <td>ml</td>
			  </tr>
              <tr>
                <td colspan="5"><!--<div style="border:#000 1px solid"></div>-->&nbsp;</td>
			  ...
			  <tr>
				<td>&nbsp;</td>
                <td><b>Total Balace</b></td>
                <td><b>:</b></td>
                <td><input name="balance" type="text" id="balance" size="5" readonly /></td>
                <td>ml</td>
			  </tr>
              <!--<tr>
                <td>&nbsp;</td>
            ...
            <td scope="col" valign="top"><table width="300">
              <tr>
              ...
              <tr>
                ...
                <td width="6">:</td>
                <td width="40"><input name="cc_transfusi" type="text" id="cc_transfusi" size="5" /></td>
                <td width="106">cc</td>
                </tr>
              <tr>
                <td>Jumlah</td>
      ...
      <tr>
        <td><div id="intable"><table border="1" align="center" class="tanggal" id="datatable" style="border-collapse:collapse">
          ...
          <tr>
            ...
            <td>
            <!--<input type='text' name='keterangan[]' id='keterangan0' size="25">-->
            <textarea id="keterangan0" name="keterangan[]" cols="25" rows="1"></textarea>
            </td>
          ...
          <tr>
            <td width="450" scope="col"><table width="450">
              ...
              <tr>
               ...
               <tr>
                <td><input type="checkbox" name="check[48]" id="check[]" value="48" /></td>
                <td>Epotrex</td>
                </tr>
              </table></td>
            <td scope="col"><table width="450">
      ...
      <tr>
        <td><table width="900" border="1" style="border-collapse:collapse">
          ...
          <tr>
            <td width="450" scope="col"><strong>Perawat yang bertugas: <?=$_SESSION['nm_pegawai']?><? //$dP['dr_rujuk']?></strong><br />Paraf</td>
			...
			echo $dok['nama'];*/
			?></strong><select id="dokter" name="dokter" class="txtinput inputInformKonsen">
  ...
  <tr>
    <td colspan="5"><table width="900" border="1" style="border-collapse:collapse; display:none;">
      <tr>
...
<td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="20%" align="right"><button type="button" id="btnTree" name="btnTree" style="color:#000;" value="Tampilan Tree" onclick="cetak()" class="tblViewTree" >Cetak</button></td>
                    <td width="5%">&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
...
<script type="text/javascript">
isiCombo('cmbDok','65','<?php echo $idUsr; ?>','dokter',null);
...
function sumsemua(par,parr){
	if(isNumeric(par)==true){
		if(parr==1){
			//var a = $('#volume_priming').val();
			//$('#cairan_keluar').val(sisip[20]);
			var b = $('#sisa_priming').val();
			var c = $('#cairan_drip').val();
			var d = $('#darah').val();
			var e = $('#wash_out').val();
			var ef = $('#minum').val();
			//var baru = (a*1)+(b*1)+(c*1)+(d*1)+(e*1)+(ef*1);
			var baru = (b*1)+(c*1)+(d*1)+(e*1)+(ef*1);
			$('#totaljml').val(baru);
			sumsemua(0,3);
		} else if(parr==2){
			var f = $('#OUrine').val();
			var g = $('#OMuntah').val();
			var h = $('#OUltra').val();
			var Obaru = (f*1)+(g*1)+(h*1);
			$('#Ototaljml').val(Obaru);
			sumsemua(0,3);
		} 
		else{
			var iii = $('#totaljml').val();
			var jjj = $('#Ototaljml').val();
			var balance = (iii*1)-(jjj*1);
			$('#balance').val(balance);
		}
	} else {
...
function tambah(){
	...
	$('#tampil_input').slideDown(1000,function(){
		toggle();
		$('#intable').load("20.tabel_hemodialisis.php?type=cek&id=");
	});
}       
...
function tambahrow(){
	...
	td13.innerHTML="<textarea id='keterangan"+idx+"' name='keterangan[]' cols='25' rows='1'></textarea>";
...
function ambilData(){					
	...
	//var totaljml = (sisip[19]*1)+(sisip[21]*1)+(sisip[22]*1)+(sisip[23]*1)+(sisip[24]*1);
	//$('#totaljml').val(totaljml);
	...
	$('#OUrine').val(sisip[65]);
	$('#OMuntah').val(sisip[66]);
	$('#OUltra').val(sisip[67]);
	
	//$('#totaljml').val(sisip[68]);
	//$('#Ototaljml').val(sisip[69]);
	$('#bbkering').val(sisip[70]);
	$('#tbadan').val(sisip[71]);
	$('#ktv').val(sisip[72]);
	
	$('#minum').val(sisip[73]);
	$('#dokter').val(sisip[74]);
	$('#reuse_ke').val(sisip[75]);
	$('#tcv').val(sisip[76]);
	$('#avbl').val(sisip[77]);
	$('#total_volume').val(sisip[78]);
	
	$('#cc_transfusi').val(sisip[79]);

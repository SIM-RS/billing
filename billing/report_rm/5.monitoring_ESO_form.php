  ...
  <tr>
    ...
    <td colspan="2"><table width="407" border="0" cellpadding="4" style="border:1px solid #000000;">
      ...
      <tr>
        <td>No. RM </td>
        <td>:</td>
        <td><?=$dP['no_rm']?> No. Registrasi : <?=$dP['no_reg2']?></td>
      </tr>
      <tr>
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("5.monitoring_ESO.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUser?>","_blank");
				//}
		}

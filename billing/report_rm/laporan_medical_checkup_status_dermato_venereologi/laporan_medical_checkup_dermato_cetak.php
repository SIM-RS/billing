...
$dG=mysql_fetch_array(mysql_query("select * FROM b_laporan_dermato where id='$_REQUEST[id]'"));
?>
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="20">
        ...
        <td valign="top">:</td>
        <td colspan="9" ><textarea name="anjuran2" cols="50" rows="2" disabled="disabled" id="anjuran2"><?=$dG['keluhan'];?>
        </textarea></td>
        <td></td>
      </tr>
      <tr height="20">
      ...
      <tr height="20">
        ...
        <td valign="top">:</td>
        <td colspan="3" ><label for="keluhan"></label>
          <?=$dG['alergi'];?></td>
        <td style="border-left:1px solid#000">&nbsp;</td>
...
?>
      ...
      <tr height="20">
        ...
        <td valign="top">:</td>
        <td colspan="9" ><textarea name="anjuran" cols="50" rows="2" disabled="disabled" id="anjuran"><?=$dG['anjuran'];?>
        </textarea></td>
        <td></td>
      </tr>
      <tr height="20">

...
<style>
	...
	input {
        ...
        <script type="text/JavaScript" language="JavaScript" src="../../include/jquery/jquery.numeric.js"></script>
...
<table width="800" border="0" cellspacing="0" cellpadding="0" class="container">
  ...
  <tr height="20" class="form-row">
	...
	<tr height="20" class="form-row">
		...
		<?
			...
			{
				?>
          			<input type="text" id="Nbb" class="txtInput" name="Nbb" onkeyup="fimt();"/>      
                <?
			}else{
				echo $pasien['BB'];
			}
		?><input type="hidden" id="bb" name="surat[bb]" value="<?php echo $surat['bb']; ?>" />&nbsp;kg</td>
		<td>&nbsp;</td>
	...
	<tr height="20" class="form-row">
		...
		<? 
			...
			{
				?>
				<input type="text" id="Ntb" class="txtInput" name="Ntb" onkeyup="fimt();"/>
                <?
			}else{
				echo $pasien['TB'];
			}
		?><input type="hidden" id="tb" name="surat[tb]" value="<?php echo $surat['tb']; ?>" />&nbsp;cm</td>
		<td>&nbsp;</td>
	...
	<tr height="23" class="form-row">
		...
		//echo round($imt, 2);
		?>
        <label id="imtN"><? echo round($imt, 2);?></label>
        <input type="hidden" id="imt" name="surat[imt]" value="<?php echo $surat['imt']; ?>" />&nbsp;&nbsp;&nbsp;kg/m<font class="font5403"><sup>2</sup></font></td>
		<td></td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input type="text" id="skor_antropomerti_6" onKeyUp="tambah();" name="surat[skor_antropomerti_6]" value="<?php echo $surat['skor_antropomerti_6']; ?>" /></td>
		<td><strong>Skor (2), &lt; 18,5</strong></td>
	</tr>
	<tr height="20" class="form-row">
		<td height="20">&nbsp;</td>
		<td>Perubahan BB dalam 2 minggu</td>
		<td align="center"><input type="text" id="skor_antropomerti_12" onKeyUp="tambah();" name="surat[skor_antropomerti_12]" value="<?php echo $surat['skor_antropomerti_12']; ?>" /></td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_perubahan_intake_makan" onKeyUp="tambah();" name="surat[skor_perubahan_intake_makan]" type="text" value="<?php echo $surat['skor_perubahan_intake_makan']; ?>" /></td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_perubahan_gastrointestinal" onKeyUp="tambah();" name="surat[skor_perubahan_gastrointestinal]" type="text" value="<?php echo $surat['skor_perubahan_gastrointestinal']; ?>" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr height="23" class="form-row">
		<td height="23">&nbsp;</td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_perubahan_kapasitas_fungsi" onKeyUp="tambah();" name="surat[skor_perubahan_kapasitas_fungsi]" type="text" value="<?php echo $surat['skor_perubahan_kapasitas_fungsi']; ?>" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr height="23" class="form-row">
		<td height="23">&nbsp;</td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_penyakit_gizi" onKeyUp="tambah();" name="surat[skor_penyakit_gizi]" type="text" value="<?php echo $surat['skor_penyakit_gizi']; ?>" /></td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_penilaian_fisik" name="surat[skor_penilaian_fisik]" type="text" value="<?php echo $surat['skor_penilaian_fisik']; ?>" /></td>
  ...
  <tr height="20" class="form-row separator">
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_total" readonly="readonly" name="surat[skor_total]" type="text" value="<?php echo $surat['skor_total']; ?>" /></td>
  ...
  <tr>
    <td colspan="4" align="center"><?php if($report!=1){?><button>Simpan</button>&nbsp;<?php }?>
</td>
  </tr>
</table>
...
<script type="text/javascript">
	...
	function fimt()
	{
		var tb = document.getElementById("tb").value = document.getElementById("Ntb").value;
		var bb = document.getElementById("bb").value = document.getElementById("Nbb").value;
		tb = tb/100;
		if(tb == 0 || isNaN(tb) == true || tb == "")
		{
			tb = 1;
		}
		
		if(bb == "" || isNaN(bb) == true || bb == 0)
		{
			bb = 0;
		}
		var imt = bb / (tb*tb);
		//alert(Math.floor(imt));
		jQuery("#imt").val(Math.floor(imt));
		jQuery("#imtN").text(Math.floor(imt));
	}
	...
	jQuery(function(){
		jQuery("#bb, #tb, #imt, #skor_antropomerti_6, #skor_antropomerti_12, #skor_perubahan_intake_makan, #skor_perubahan_gastrointestinal, #skor_perubahan_kapasitas_fungsi, #skor_penyakit_gizi").keydown(function(e) {
	...
	function tambah(){
		<?php if($report!=1){?>
		var tot = 0;
		var a = parseFloat(jQuery("#skor_antropomerti_6").val());
		var b = parseFloat(jQuery("#skor_antropomerti_12").val());
		var c = parseFloat(jQuery("#skor_perubahan_intake_makan").val());
		var d = parseFloat(jQuery("#skor_perubahan_gastrointestinal").val());
		var e = parseFloat(jQuery("#skor_perubahan_kapasitas_fungsi").val());
		var f = parseFloat(jQuery("#skor_penyakit_gizi").val());
		//var g = parseFloat(jQuery("#skor_penilaian_fisik").val());
		
		//var tot =(a+b+c+d+e+f+g);
		tot =(a+b+c+d+e+f);
		jQuery("#skor_total").val(tot);
		return false;
		<?php }?>
	}
	<?php if($report==1){?>
	jQuery("#skor_antropomerti_6").prop("readonly",true);
	jQuery("#skor_antropomerti_12").prop("readonly",true);
	jQuery("#skor_perubahan_intake_makan").prop("readonly",true);
	jQuery("#skor_perubahan_gastrointestinal").prop("readonly",true);
	jQuery("#skor_perubahan_kapasitas_fungsi").prop("readonly",true);
	jQuery("#skor_penyakit_gizi").prop("readonly",true);
	jQuery("#skor_penilaian_fisik").prop("readonly",true);
	<?php }?>

	...
	$('.tambah').click(function(){
		...
		$('.pemberian_edukasi').append('<tr height="40" class="item">' +
				'<td height="40" align="center">' +
					...
					'<input type="text" id="tanggal_jam" style="width:100px;"/>' +
				'</td>' +
				'<td align="center"><input type="text" id="bagian" style="width:90px;"/></td>' +
				'<td align="center"><input type="text" id="informasi" style="width:350px;"/></td>' +
  ...
  <tr height="35">
    <td colspan="6"><table border="1" cellpadding="0" cellspacing="0">
      ...
      <tbody class="pemberian_edukasi">
		<?php
		$sql = "select a.*, DATE_FORMAT(a.tanggal_jam, '%d-%m-%Y %H:%i') tanggal_jam2
		...
		while($rows = mysql_fetch_assoc($query)){
			...
			<tr height="35" class="item">
				<td height="35" align="center">
					...
					<input type="text" id="tanggal_jam" style="width:120px;" value="<?php echo $rows['tanggal_jam2']; ?>"/>
				</td>
				<td align="center"><input type="text" id="bagian" style="width:90px;" value="<?php echo $rows['bagian']; ?>"/></td>

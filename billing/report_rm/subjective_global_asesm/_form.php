...
<table width="800" border="0" cellspacing="0" cellpadding="0" class="container">
  ...
  <tr height="20" class="form-row">
	...
	<tr height="20" class="form-row">
		<td height="20">&nbsp;</td>
		<td>BB&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="bb" name="surat[bb]" value="<?php echo $surat['bb']; ?>" />&nbsp;&nbsp;&nbsp;kg</td>
		<td>&nbsp;</td>
		<td><strong>IMT :</strong></td>
	</tr>
	<tr height="20" class="form-row">
		<td height="20">&nbsp;</td>
		<td>TB&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="tb" name="surat[tb]" value="<?php echo $surat['tb']; ?>" />&nbsp;&nbsp;&nbsp;cm</td>
		<td>&nbsp;</td>
		<td><strong>Skor (0), &gt; 20 atau 30 (Obese)</strong></td>
	</tr>
	<tr height="23" class="form-row">
		<td height="23">&nbsp;</td>
		<td>IMT&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="imt" name="surat[imt]" value="<?php echo $surat['imt']; ?>" />&nbsp;&nbsp;&nbsp;kg/m<font class="font5403"><sup>2</sup></font></td>
		<td></td>
	...
	<tr height="20" class="form-row">
		...
		<td align="center"><input id="skor_penilaian_fisik" onKeyUp="tambah();" name="surat[skor_penilaian_fisik]" type="text" value="<?php echo $surat['skor_penilaian_fisik']; ?>" /></td>
  ...
  <tr>
    <td colspan="4" align="center"><button>Simpan</button></td>
  </tr>
</table>
...
<script type="text/javascript">
	jQuery(function(){
		jQuery("#bb, #tb, #imt, #skor_antropomerti_6, #skor_antropomerti_12, #skor_perubahan_intake_makan, #skor_perubahan_gastrointestinal, #skor_perubahan_kapasitas_fungsi, #skor_penyakit_gizi, #skor_penilaian_fisik").keydown(function(e) {

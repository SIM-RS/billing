...
<table width="800" border="0" cellspacing="0" cellpadding="0" class="container">
  ...
  <tr height="20" class="form-row">
	...
	<tr height="20" class="form-row">
		<td height="20">&nbsp;</td>
		<td>BB&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<input type="text" name="surat[bb]" value="<?php echo $surat['bb']; ?>" readonly="readonly" />&nbsp;&nbsp;&nbsp;kg</td>
		<td>&nbsp;</td>
		<td><strong>IMT :</strong></td>
	</tr>
	<tr height="20" class="form-row">
		<td height="20">&nbsp;</td>
		<td>TB&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<input type="text" name="surat[tb]" value="<?php echo $surat['tb']; ?>" readonly="readonly" />&nbsp;&nbsp;&nbsp;cm</td>
		<td>&nbsp;</td>
		<td><strong>Skor (0), &gt; 20 atau 30 (Obese)</strong></td>
	</tr>
	<tr height="23" class="form-row">
		<td height="23">&nbsp;</td>
		<td>IMT&nbsp;&nbsp;:&nbsp;&nbsp;<input type="text" name="surat[imt]" value="<?php echo $surat['imt']; ?>" readonly="readonly" />&nbsp;&nbsp;&nbsp;kg/m<font class="font5403"><sup>2</sup></font></td>
		<td></td>
  ...
  <tr height="20" style='height:15.0pt'>
	...
	<tr height="20" style='height:15.0pt'>
		<td height="20" class="xl63403" style='height:15.0pt'></td>
		<td class="xl66403" colspan=2>Medan, <?=date('d M Y')?></td>
		<td class="xl63403"></td>
	</tr>
	<tr height="20" style='height:15.0pt'>
		<td height="20" class="xl63403" style='height:15.0pt'></td>
  ...
  <tr>
    <td colspan="4" align="center"><a href="<?php echo $BASE_URL.'&act=edit'; ?>">Ubah</a>

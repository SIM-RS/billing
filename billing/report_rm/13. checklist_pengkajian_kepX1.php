...
<table width="1087" border="0" cellpadding="4" style="font:12px tahoma">
  ...
  <tr>
        ...
        <td class="noline" colspan="5" align="right"><input name="button" type="button" id="btnPrint" onclick="cetak(document.getElementById('trTombol'));" value="Print"/>
                <input name="button" type="button" id="btnTutup" onclick="window.close();" value="Tutup"/></td>
      </tr><tr><td width="708" align="center"><div align="center"></div></td>
  </tr>
</table>
</body>

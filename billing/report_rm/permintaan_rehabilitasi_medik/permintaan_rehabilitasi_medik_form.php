...
<form name="form1" id="form1" action="permintaan_rehabilitasi_medik_act.php">
...
?>
      ...
      <tr height="">
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="4"><input id="c_chk[]" type="checkbox" name="c_chk[7]" value="8" />
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="3"><input id="c_chk[]" type="checkbox" name="c_chk[8]" value="9" />
          <label for="checkbox">Micro Wave Diathhermy</label></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="4"><input id="c_chk[]" type="checkbox" name="c_chk[9]" value="10" />
      ...
      <tr height="">
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="4"><input id="c_chk[]" type="checkbox" name="c_chk[11]" value="12" onclick="enable_text(this.checked)" />
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="3"><input id="c_chk[]" type="checkbox" name="c_chk[13]" value="14" />
          <label for="checkbox44">Chest Phisio Therapy (CPT)</label></td>
        <td colspan="3">&nbsp;</td>
        <td colspan="4"><input id="c_chk[]" type="checkbox" name="c_chk[14]" value="15" />
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="5"><input id="c_chk[]" type="checkbox" name="c_chk[15]" value="16" />
          <label for="checkbox43">Nebulizer + Chest Phisio Therapy (CPT)</label></td>
        <td>&nbsp;</td>
        <td colspan="4"><input id="c_chk[]" type="checkbox" name="c_chk[16]" value="17" />
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="3"><input id="c_chk[]" type="checkbox" name="c_chk[17]" value="18" />
          <label for="checkbox13">1 Modalitas, Nebulizer, CPT</label></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="4"><input id="c_chk[]" type="checkbox" name="c_chk[18]" value="19" />
      ...
      <tr height="">
        <td>&nbsp;</td>
        <td colspan="5"><input id="c_chk[]" type="checkbox" name="c_chk[20]" value="21" />
...
<script type="text/javascript">
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("permintaan_rehabilitasi_medik_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Permintaan Rehabilitasi Medik");
        a.setColHeader("NO,NO RM,NAMA,NO FORMULIR,TGL INPUT,PENGGUNA");
        ...
        a.baseURL("permintaan_rehabilitasi_medik_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("permintaan_rehabilitasi_medik_cetak.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

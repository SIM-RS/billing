...
$sqlP="SELECT 
  ...
  bp.nama AS nama_pegawai, lik.`saksi`, an.`BB`, an.`TB`, an.`SUHU`, an.`TENSI` 
FROM
  b_pelayanan pl 
    ...
    <td colspan="2"><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="">
        ...
        <td colspan="2"><label for="textfield"></label>
          <?=$dP['BB'];?><label for="dokter"></label>          Kg</td>
      ...
      <tr height="">
        ...
        <td colspan="3">:
          <?=$dP['TENSI'];?>          <label for="textfield4"></label>          mmHg</td>
        <td></td>
        </tr>
      <tr height="">
        <td>&nbsp;</td>
      ...
      <tr height="20">
        ...
        <td></td>
        <td></td>
        <td colspan="6"><div align="center">(<strong><?=$dP['nama_pegawai'];?></strong>)</div></td>
        <td></td>
        </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>

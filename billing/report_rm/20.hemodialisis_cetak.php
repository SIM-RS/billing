...
$sql1="select a.*,( a.cairan_keluar + a.sisa_priming + a.cairan_drip + a.darah + a.wash_out + a.minum ) jml,
		( a.urine + a.muntah + a.ultra ) Ojml, b.nama namadokter
 FROM b_ms_hemodialisis a
 LEFT JOIN b_ms_pegawai b ON a.dokter = b.id where a.id='$id'";
...
<table width="755" border="0" cellpadding="4" style="font:12px tahoma;">
  ...
  <tr>
    <td colspan="5"><table width="936" border="1" style="border-collapse:collapse">
      <tr>
        <td width="923"><table width="914">
          <tr>
            <td width="495">Tanggal&nbsp;:&nbsp;<?=tglSQL($data['tanggal1'])?> </td>
            <td width="407">Pukul&nbsp;:&nbsp;<?=$data['pukul1'];?></td>
            </tr>
          </table></td>
        </tr>
      <tr>
        <td><table width="915">
          <tr>
            ...
            <td width="261"><input type="checkbox" name="check[0]" id="check[]" value="0"/>
              <label for="a">Obat</label></td>
            <td width="298"><input type="checkbox" name="check[1]" id="check[]" value="1" />
              Makanan</td>
            </tr>
          </table></td>
        </tr>
      <tr>
        <td><table width="916">
          <tr>
            <td width="233"><strong>PENGKAJIAN</strong></td>
            <td width="230">Resiko Jatuh</td>
            <td width="143">&nbsp;</td>
            <td width="149">&nbsp;</td>
            <td width="137">&nbsp;</td>
            </tr>
      ...
      <tr>
        <td><table width="924" border="1" style="border-collapse:collapse">
          <tr>
            <td width="300" scope="col"><table width="300">
              ...
              <tr>
                <td>Riwayat Penyakit Sekarang : <strong>
                  <?=$RPS?>
                  </strong>
              ...
              <tr>
                <td>Riwayat Penyakit Dahulu : <strong>
                  <?=$RPD?>
                </strong></td>
              </tr>
              <tr>
                <td>Riwayat Penyakit Keluarga : <strong>
                  <?=$RPK?>
                </strong></td>
              </tr>
              <tr>
            ...
            <td width="608" scope="col"><table width="606">
              <tr>
              ...
              <tr>
                <td colspan="3">BB Kering : <?=$data['bbkering']?> Kg</td>
                <td>TB : <?
                	if($tb=="")
					{
						echo $data['tbadan'];
              ...
              <tr>
                <td width="135"><strong>Keadaan Umum</strong></td>
                <td width="13">:</td>
  ...
  <tr>
    <td colspan="5"><table width="900" border="1" style="border-collapse:collapse">
      ...
      <tr>
        <td><table width="926" border="1" style="border-collapse:collapse">
          <tr>
            <td><strong>Anjuran/usulan tindak lanjut : <?=$UTINLANJUT;?> </strong></td>
            </tr>
          <tr>
            <td><div align="center">
      ...
      <tr>
        <td><table width="927" border="1" style="border-collapse:collapse">
          <tr>
            ...
            <td width="461" scope="col"><table width="463">
              <tr>
        ...
        <td><table width="928">
          ...
          <tr>
            ...
            <td width="71"><input type="checkbox" name="check[20]" id="check[]" value="20"/> 
              New</td>
			<?php
				$checked2 = explode(',',$data['checked']);
			?>
            <td colspan="2"><input type="checkbox" name="check[21]" id="check[]" value="21" />
              Reuse<?php
				if(in_array('21', $checked2, true)) echo " : ".$data['reuse'];
			?></td>
          ...
          <tr>
            ...
            <td>TCV :</td>
            <td><?=$data['tcv']?></td>
            <td colspan="2">Jenis Dialisat</td>
            <td colspan="2"><input type="checkbox" name="check[23]" id="check[]" value="23" /> Bikarbonat</td>
            <td>&nbsp;</td>
            </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="2"><input type="checkbox" name="check[25]" id="check[]" value="25" /> 
        ...
        <td><table width="927" border="1" style="border-collapse:collapse;">
          <tr>
            ...
            <td width="461" scope="col"><table width="463">
              ...
              <tr>
                <td>&nbsp;</td>
                <td width="20"><input type="checkbox" name="check[32]" id="check[]" value="32" /></td>
                <td width="403"> Pendarahan</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
      ...
      <tr>
        <td><table width="931" border="1" style="border-collapse:collapse">
          <tr>
            <td width="300" scope="col"><table width="300">
              <tr>
 ...
 <!--               <td width="19">1.</td>
			  ...
			  <tr>
                <td>&nbsp;</td>
                <td>Total Balance (Intake - Output)</td>
                <td>:</td>
                <td colspan="2"><?=($data['jml']-$data['Ojml'])?> ml</td>
              </tr>
              </table></td>
            <td width="300" valign="top" scope="col"><table width="300">
              <tr>
                <td colspan="4"><strong>Tranfusi darah</strong></td>
                </tr>
              <tr>
                <td colspan="4">Jenis <?=$data['jenis_transfusi']?> : <?=$data['cc_transfusi']?> cc</td>
                </tr>
              <tr>
            ...
            <td width="309" valign="top" scope="col"><table width="310">
              <tr>
      ...
      <tr>
        <td><table width="934">
          <tr>
            ...
            <td width="472" scope="col"><table width="470">
              <tr>
                <td width="432" scope="col">Jam pemberian : 
      ...
      <tr>
        <td><table width="932" border="1" style="border-collapse:collapse">
          <tr>
            <td width="442" scope="col"><strong>Pemeriksaan setelah Dialisis</strong><br />
              <em>On Discharge</em></td>
            <td width="474" scope="col"><strong> Pukul</strong> : 
              <?=$data['jam_setelah']?>
              <br />
              <em> Time</em></td>
            </tr>
      ...
      <tr>
        <td><table width="932" border="1" style="border-collapse:collapse">
          <tr>
            <td width="634" scope="col"><p><strong>Kondisi :</strong></p>
              <p>
                <?=$data['kondisi_setelah']?>
                <br />
              </p></td>
            <td width="282" scope="col"><table width="250">
              <tr>
      ...
      <tr>
        <td><table width="932" border="1" style="border-collapse:collapse">
          <tr>
            <td width="441" scope="col"><strong>Catatan untuk hemodialisis selanjutnya</strong></td>
            <td width="475" scope="col"><strong>Hemodialisis Selanjutnya</strong></td>
            </tr>
          <tr>
            <td width="441" scope="col"><?=$data['catatan_hemodialisis1']?></td>
            <td width="475" scope="col">Hari &nbsp;&nbsp;: 
              <?=$data['tgl_selanjutnya']?></td>
            </tr>
          <tr>
            <td width="441" scope="col"><?=$data['catatan_hemodialisis2']?></td>
            <td width="475" scope="col">Pukul :  
              <?=$data['jam_selanjutnya']?></td>
            </tr>
          <tr>
            <td width="441" scope="col"><strong>Perawat yang bertugas: <?=$_SESSION['nm_pegawai']?><? //$dP['dr_rujuk']?></strong><br />Paraf</td>
            <td width="475" scope="col"><strong>Dokter : 
            <?

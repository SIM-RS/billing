...
<table width="832" border="0" align="center" cellpadding="2" cellspacing="2" style="font:12px tahoma;border:1px solid #999999; padding:5px; ">
  ...
  <?
  	$query12 = "select DISTINCT id_traveling,terapi from b_detil_traveling where id_traveling = ".$_REQUEST['id']."";
	$execq = mysql_query($query12);
	$noB=1;
	while($dExecQ=mysql_fetch_array($execq))
	{
  ?>
  <tr>
    <td colspan="8"><?=$noB?>.&nbsp; 

...
<table width="832" border="0" align="center" cellpadding="2" cellspacing="2" style="font:12px tahoma;border:1px solid #999999; padding:5px; ">
  ...
  <tr>
    ...
    <textarea cols="40" name="keluhan" id="keluhan"/></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>: <textarea cols="40" name="penyakit_dahulu" id="penyakit_dahulu" /></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Kesadaran</td>
    <td>: 
    <input type="text" name="kesadaran" id="kesadaran" size="50" /></td>
  </tr>
  <tr>
    <td>BB</td>
    <td>: 
    <input type="text" name="bb" id="bb" size="50" /></td>
  </tr>
  <tr>
    <td>Pernafasan</td>
    <td>: 
  ...
  <tr>
    <td>Suhu</td>
    <td>: 
    <input type="text" name="suhu" id="suhu" size="50" /></td>
  </tr>
  <tr>
    <td>Kepala</td>
    <td>: 
      <textarea cols="40" name="kepala" id="kepala" /></textarea></td>
  </tr>
  <tr>
    <td>Mata</td>
    <td>: 
  ...
  <tr>
    <td>Leher</td>
    <td>: 
      <textarea cols="40" name="leher" id="leher" /></textarea></td>
  </tr>
  <tr>
    <td>Paru-paru</td>
    <td>: 
      <textarea cols="40" name="paru_paru" id="paru_paru" /></textarea></td>
  </tr>
  <tr>
    <td>Jantung</td>
    <td>: 
      <textarea cols="40" name="jantung" id="jantung" /></textarea></td>
  </tr>
  <tr>
    <td>Abdomen</td>
    <td>:    
      <textarea cols="40" name="abdomen" id="abdomen" /></textarea></td>
  </tr>
  <tr>
    <td>Extremitas </td>
    <td>: 
...
var a=new DSGridObject("gridbox");
	...
	a.setColHeader("NO,KELUHAN UTAMA,PERJALANAN PNYKT,PNYKT LAIN/ALERGI OBAT,PENYAKIT2 DAHULU,KEADAAN UMUM,KESADARAN,BB,PERNAFASAN,SUHU,KEPALA,MATA,THT,GIGI MULUT,LEHER,PARU-PARU,JANTUNG,ABDOMEN,EXTREMITAS,DIAGNOSIS KERJA,DIAGNOSIS DIFFERENSIAL,PENGOBATAN,DIIT,LABORATORIUM,RADIOLOGI,EKG,LAIN LAIN,PENGGUNA");
	a.setIDColHeader(",keluhan,perjalanan,penyakit_lain,penyakit_dahulu,keadaan_umum,kesadaran,bb,pernafasan,suhu,kepala,mata,tht,gigi_mulut,leher,paru_paru,jantung,abdomen,extremitas,diagnosis_kerja,diagnosis_diff,pengobatan,diit,lab,radiologi,ekg,dll,user_log");
	a.setColWidth("50,150,75,125,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,75,100");
	a.setCellAlign("center,left,left,center,center,left,center,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	a.setCellHeight(20);
	a.setImgPath("../../icon");

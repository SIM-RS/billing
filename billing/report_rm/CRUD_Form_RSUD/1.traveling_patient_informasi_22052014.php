...
function tambah()
{
	clear_text('id,act,tindakan_perminggu,lama_hd,cairan_konsentrat,bb_kering,sarana_hubungan,kenaikan,tkn_drh_sblm,tkn_drh_ssdh,jns_dialiser,kec_aliran,heparinasi,dosis_awal,rhesusu,trans_darah_trkhr,hb,ureum,creatinin,kalium,phospor,hbsag,anti_hcv,anti_hiv,terapi1,terapi2,terapi3,terapi4,terapi5');
	show_form();
	$('#act').val('tambah');
}
function edit()

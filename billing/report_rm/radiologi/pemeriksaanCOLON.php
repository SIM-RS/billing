...
<title>PEMERIKSAAN COLON INLOOP</title>
<style type="text/css">
<!--
...
$dG=mysql_fetch_array(mysql_query("select *,DATE_FORMAT(tgl_datang ,'%d %M %Y') AS tgl_prt, DATE_FORMAT(tgl_datang,'%W') AS hari from b_ms_periksa_colon where id='$_REQUEST[id]'"));
?>
<body>
<table width="775" border="0" cellpadding="4" style="font:12px tahoma;">
  <tr>
    <td colspan="3" align="center" style="font-weight:bold
    ">FORMULIR PERJANJIAN<br/>PEMERIKSAAN COLON INLOOP</td>
    </tr>
  <tr>
  ...
  <tr>
    <td width="212" align="left">Nama Pasien</td>
    <td width="424">:&nbsp;<?=$dP['nama']?></td>
    <td width="107">&nbsp;&nbsp;</td>
  </tr>
  <tr>
...
WIB makan terakhir.</li>
      <li>Jam 
        <?=$dG['jam_siap2']?> 
WIB makan/minum  garam inggris sebanyak 30 gram atau dulkolax 6 tablet, selanjutnya puasa sampai pemeriksaan dilaksanakan.
       Jam 
          <?=$dG['jam_siap3']?> pasien di klisma.</li>
    <li>Jam 
        <?=$dG['jam_siap4']?>
         WIB
pasien datang ke Bagian Radiologi RS PELINDO I dalam keadaan puasa dianjurkan tidak banyak bicara dan tidak merokok.</li>
       </ol></td>
  </tr>
  <tr>

...
$(function () 
{
  ...
  var arrRange = depRange = [];
        ...
        <title>FORM PEMERIKSAAN BNO / IVP</title>
        <style>
        .gb{
...
body{background:#FFF;}
        ...
        <div align="center">
          ...
          <!--  <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="2" align="center" >
                ...
                <form name="form1" id="form1" action="pemeriksaanBNO_act.php">
  ...
  <tr>
    <td colspan="3"><ol>
      ...
      <li>Jam 
        <input type="text" name="txtJam2" id="txtJam2" value="<?=date('H:i:s')?>"/> WIB makan terakhir/minum dulkolax 6 tablet atau garam inggris 30 gram.</li>
        <li>Jam <input type="text" name="txtJam3" id="txtJam3" value="<?=date('H:i:s')?>"/> WIB minum terakhir, selanjutnya puasa sampai pemeriksaan dilaksanakan.</li>
    <li>Jam 
        <input type="text" name="txtJam4" id="txtJam4" value="<?=date('H:i:s')?>"/> pasien datang ke Bagian Radiologi RS PELINDO I (dalam keadaan puasa, dan dianjurkan selama berpuasa tidak banyak bicara / tidak merokok).</li>
       </ol></td>
  </tr>
  <tr>
...
<script type="text/javascript">
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("pemeriksaanBNO_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Pemeriksaan BNO / IVP");
        ...
        a.baseURL("pemeriksaanBNO_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("pemeriksaanBNO.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

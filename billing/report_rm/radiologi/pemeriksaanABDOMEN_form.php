        ...
        <div align="center">
          ...
          <!--  <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="2" align="center" >
                ...
                <form name="form1" id="form1" action="pemeriksaanABDOMEN_act.php">
  ...
  <tr>
    <td colspan="3"><ol>
      ...
      <li> Cara pemberian
        ...
        <ol type="A">
          <li>Minum sebanyak 150 cc pada jam : <input type="text" name="txtJam1" id="txtJam1" value="<?=date('H:i:s')?>"/></li>
          <li>Minum sebanyak 150 cc pada jam : <input type="text" name="txtJam2" id="txtJam2" value="<?=date('H:i:s')?>"/></li>
         <li>Minum sebanyak 150 cc pada jam : <input type="text" name="txtJam3" id="txtJam3" value="<?=date('H:i:s')?>"/></li>
   ...
   parent.alertsize(document.body.scrollHeight);
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("pemeriksaanABDOMEN_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Pemeriksaan CT SCAN ABDOMEN");
        ...
        a.baseURL("pemeriksaanABDOMEN_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("pemeriksaanABDOMEN.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

...
switch(strtolower($_REQUEST['act'])){
	case 'tambah':
	$sql="INSERT INTO b_form_radiologi_1 (
  pelayanan_id,
  kunjungan_id,
  no_formulir,
  isi,
...
";
  ...
  user_act='$idUsr' WHERE id='".$_REQUEST['txtId']."'";
	...
	break;
	case 'hapus':
		$sql="DELETE FROM b_form_radiologi_1 WHERE id='".$_REQUEST['txtId']."'";
		$ex=mysql_query($sql);
		if($ex){

        ...
        <div align="center">
          ...
          <!--  <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            ...
            <table width="1000" border="0" bordercolor="#FF0000" cellspacing="0" cellpadding="2" align="center" >
                ...
                <form name="form1" id="form1" action="pemeriksaanRADIOLOGI2_act.php">
    ...
    <td><table width="99%" border="0" style="border:1px solid #000000; font:12px tahoma">
      <tr>
        <td><table width="99%" border="0">
          ...
          <tr>
            <td>Diagnosa / Keterangan Klinik : &nbsp;<input type="hidden" id="diagnosa" name="diagnosa" value="<?php echo $diag ?>" /><?php echo $diag ?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><input type="checkbox" name="isi_chk[4]" value="5" id="isi_chk[]" />
              <strong>CONTRAS</strong></td>
            <td colspan="2"><input type="checkbox" name="isi_chk[5]" value="6" id="isi_chk[]" />
          ...
          <tr>
			...
			<tr>
			<td>
              <input type="checkbox" name="isi_chk[16]" value="17" id="isi_chk[]" />
              Orbita</td>
            <td colspan="2">
              <input type="checkbox" name="isi_chk[17]" value="18" id="isi_chk[]" /> 
              Upper Extrimitas </span></td>
            </tr>            
			<tr>
			<td>
             <input type="checkbox" name="isi_chk[18]" value="19" id="isi_chk[]" />
              IAC/Cochlea/Temporal</td>
            <td colspan="2">
              <input type="checkbox" name="isi_chk[19]" value="20" id="isi_chk[]" />
              Lower Extrimitas </span></td>
            </tr>            
			<tr>
			<td>
              <input type="checkbox" name="isi_chk[20]" value="21" id="isi_chk[]" />
              Mandibula</td>
            <td colspan="2">
              <input type="checkbox" name="isi_chk[21]" value="22" id="isi_chk[]" /> 
              Cervical</span></td>
            </tr>            
			<tr>
			<td>
              <input type="checkbox" name="isi_chk[22]" value="23" id="isi_chk[]" />
              Maxila</td>
            
			<td colspan="2">
              <input type="checkbox" name="isi_chk[23]" value="24" id="isi_chk[]" />
              Thoracal</span></td>
            </tr>           
			<tr>
			 <td>
              <input type="checkbox" name="isi_chk[24]" value="25" id="isi_chk[]" />
              Larynx</td>
           <td colspan="2">
              <input type="checkbox" name="isi_chk[25]" value="26" id="isi_chk[]" /> 
              Lumbosacral</span></td>
            </tr>           
			<tr>
			 <td>
              <input type="checkbox" name="isi_chk[26]" value="27" id="isi_chk[]" />
              Tyroid</td>
            <td colspan="2">
              <input type="checkbox" name="isi_chk[27]" value="28" id="isi_chk[]" /> 
              Cocygys</span></td>
            </tr>            
			<tr>
			<td>
              <input type="checkbox" name="isi_chk[28]" value="29" id="isi_chk[]" />
              Parotis</td>
           <td colspan="2">&nbsp;</td>
            </tr>            
			<tr>
...
Neck</td>
			  ...
			  <tr>
			    ...
			    <td colspan="2"><input type="checkbox" name="isi_chk[31]" value="32" id="isi_chk[]" />
		        CTA Femoral </td>
		      </tr>
			  <tr>
			  <td><input type="checkbox" name="isi_chk[32]" value="33" id="isi_chk[]" />
CTA Carotis </td>
              <td colspan="2"><input type="checkbox" name="isi_chk[33]" value="34" id="isi_chk[]" />
CTA Lower Extrimitas.................</td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[34]" value="35" id="isi_chk[]" />
CTA Pulmonary </td>
              <td colspan="2"><input type="checkbox" name="isi_chk[35]" value="36" id="isi_chk[]" />
CTA Lower Extrimitas.................</td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[36]" value="37" id="isi_chk[]" />
CTA Thoracic </td>
              <td colspan="2"><input type="checkbox" name="isi_chk[37]" value="38" id="isi_chk[]" />
CTA Venogravi Uper extremitas </td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[38]" value="39" id="isi_chk[]" />
CTA Abdominal </td>
              <td colspan="2"><input type="checkbox" name="isi_chk[39]" value="40" id="isi_chk[]" />
CTA Venografi Lower Extremitas </td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[40]" value="41" id="isi_chk[]" />
CTA Renal </td>
              <td colspan="2">&nbsp;</td>
              </tr>            
			  <tr>
...
CTA Iliaca </td>
              ...
              <td colspan="2"><input type="checkbox" name="isi_chk[43]" value="44" id="isi_chk[]" />
              Urography non contrast</td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[44]" value="45" id="isi_chk[]" />
CT Calsium Score </td>
              <td colspan="2"><input type="checkbox" name="isi_chk[45]" value="46" id="isi_chk[]" /> 
              Urography contrast</td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[46]" value="47" id="isi_chk[]" />
CT Cardiac </td>
              <td colspan="2"><input type="checkbox" name="isi_chk[47]" value="48" id="isi_chk[]" />
              Broncography</td>
              </tr>            
			  <tr>
			  <td><input type="checkbox" name="isi_chk[48]" value="49" id="isi_chk[]" /> 
			  Colonography</td>
              <td colspan="2"><input type="checkbox" name="isi_chk[49]" value="50" id="isi_chk[]" />
...
CT Agioscopy </td>
  ...
  <tr>
    <td><div align="right">FORM-RAD-02-00</div></td>
  </tr>
</table> 
             </form>   
...
/*			 var p="tgl_kaji*-*"+sisip[2]
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("pemeriksaanRADIOLOGI2_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Pemeriksaan Radiologi 2");
        ...
        a.baseURL("pemeriksaanRADIOLOGI2_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("pemeriksaanRADIOLOGI2.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

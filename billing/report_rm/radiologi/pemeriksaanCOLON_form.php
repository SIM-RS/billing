...
$(function () 
{
	...
	$('#txtJam3').timeEntry({show24Hours: true, showSeconds: true});
	$('#txtJam4').timeEntry({show24Hours: true, showSeconds: true});
});
  var arrRange = depRange = [];
</script>
        <title>FORM PEMERIKSAAN COLON INLOOP</title>
        <style>
        .gb{
...
body{background:#FFF;}
        ...
        <div align="center">
          ...
          <!--  <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="2" align="center" >
                ...
                <form name="form1" id="form1" action="pemeriksaanCOLON_act.php">
  ...
  <tr>
    ...
    ">FORMULIR PERJANJIAN<br/>
    PEMERIKSAAN COLON INLOOP</td>
    </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">Untuk Pemeriksaan BNO / IVP degan persiapan sebagai berikut :</td>
  </tr>
  <tr>
    <td colspan="3"><ol>
      <li>2(dua) hari sebelum pemeriksaan dilakukan pasien dianjurkan makan makanan lunak yang mudah dicerna seperti : bubur + kecap + abon atau buah-buahan. Sebaiknya makanan yang berserat seperti : daging,sayuran dilunakkan.</li>
      <li>Jam 
        <span><input type="text" name="txtJam1" id="txtJam1" value="<?=date('H:i:s')?>"/></span>
       WIB makan terakhir (sehari sebelum pemeriksaan / hari pemeriksaan).</li>
      <li>Jam 
       <span> <input type="text" name="txtJam2" id="txtJam2" value="<?=date('H:i:s')?>"/>
       </span> WIB makan/minum  garam inggris sebanyak 30 gram atau dulkolax 6 tablet, selanjutnya puasa sampai pemeriksaan dilaksanakan. Jam <span>
<input type="text" name="txtJam3" id="txtJam3" value="<?=date('H:i:s')?>"/></span> pasien di klisma.</li>
    <li>Jam 
        <span><input type="text" name="txtJam4" id="txtJam4" value="<?=date('H:i:s')?>"/></span> pasien datang ke Bagian Radiologi RS PELINDO I dalam keadaan puasa dianjurkan tidak banyak bicara dan tidak merokok.</li>
       </ol></td>
  </tr>
  <tr>
...
<script type="text/javascript">
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("pemeriksaanCOLON_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Pemeriksaan COLON INLOOP");
        ...
        a.baseURL("pemeriksaanCOLON_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("pemeriksaanCOLON.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

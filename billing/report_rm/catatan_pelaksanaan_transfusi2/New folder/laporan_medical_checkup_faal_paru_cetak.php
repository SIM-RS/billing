  ...
  <tr>
    <td><table cellspacing="0" cellpadding="2" style="border:1px solid #000000;">
      ...
      <tr height="20">
        ...
        <td>:</td>
        <td colspan="4" class="gb">&nbsp;<?php echo date("j F Y")?></td>
        <td></td>
      </tr>
      <tr height="20">
        <td height="20">&nbsp;</td>
...
<script type="text/javascript">
    ...
    parent.alertsize(document.body.scrollHeight);
        ...
        function simpan(action){
            if(ValidateForm('dokter,keluhan')){
				$("#form1").ajaxSubmit({
	...
	toggle();
        ...
        function goFilterAndSort(grd){
            ...
            a.loadURL("2.permohonankonsultasi_util.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&idPel=<?=$idPel?>","","GET");
        }
        var a=new DSGridObject("gridbox");
        a.setHeader("Data Permohonan Konsultasi");
        a.setColHeader("NO,NO RM,Dokter,Keluhan Utama,Hasil Pemeriksaan,TGL INPUT,PENGGUNA");
        ...
        a.baseURL("2.permohonankonsultasi_util.php?idPel=<?=$idPel?>");
        a.Init();
...
//					alert("Pilih data terlebih dahulu");
//				}else{	
		window.open("2.permohonankonsultasi_cetak.php?id="+rowid+"&idPel=<?=$idPel?>&idKunj=<?=$idKunj?>&idPasien=<?=$idPsn?>&idUser=<?=$idUsr?>","_blank");
				//}
		}

...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" language="JavaScript" src="theme/js/dsgrid.js"></script>
            ...
            <![endif]-->
            <title>Sistem Informasi Manajemen Rumah Sakit Pelindo I</title>
    </head>
    ...
    <body bgcolor="#80ABB5">
        <div align="center">
            ...
            <span style="float: left; font-size: 10px; padding-top: 5px">Copy Right by Majapahit Cipta Mandiri &copy; 2016</span>
            <?php
                if(isset($_SESSION['userId'])){
                    ...
                    ?>
                    <span>Login dengan user 'astuti' dan password 'astuti'</span>			  
                    <?php

...
if(par=="up"){
	...
	var subs=encodeURIComponent(document.getElementById('txtSxxx').value)+"|"+encodeURIComponent(document.getElementById('txtOxxx').value)+"|"+encodeURIComponent(document.getElementById('txtAxxx').value)+"|"+encodeURIComponent(document.getElementById('txtPxxx').value)+"|"+encodeURIComponent(document.getElementById('txtIxxx').value)+"|"+encodeURIComponent(document.getElementById('txtExxx').value)+"|"+encodeURIComponent(document.getElementById('txtRxxx').value);

<head>
	...
	<title>Tindakan RAD</title>
	<? 
		$date_now = gmdate('d-m-Y',mktime(date('H')+7)); 
		if($_REQUEST['view'] == "tidak"){
			if($_REQUEST['tmpLayLab'] == 61){			
				include 'data.php';
			}
		}
	?>
...
<body>
	<form id="tindakanLab" action="action.php" type="post">
		<table align=center cellspacing=5 cellpadding=0 style='border:.5pt solid windowtext; width:100%; height:auto; overflow:hidden;'>
			<tr>
				<td style='font-size:16px; text-align:center; font-weight:bold; text-decoration:underline;'>List Tindakan Radiologi</td>
			</tr>
			<tr>
				<td>

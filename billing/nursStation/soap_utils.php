...
switch(strtolower($_REQUEST['act'])){
	case 'ins':
	$sql1="INSERT INTO $dbaskep.ask_soap (pelayanan_id,tgl,ket_S,ket_O,ket_A,ket_P,ket_I,ket_E,ket_R,user_id,user_act,tgl_act,jenis) VALUES ('$idPel','$t','$subs[0]','$subs[1]','$subs[2]','$subs[3]','$subs[4]','$subs[5]','$subs[6]','$userId','$userId',now(),'$jenis')";
		mysql_query($sql1);
		break;
	case 'up':

<table id="tbl_tab_diag" width="850" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr class="diag1">
		<td width="0%">&nbsp;</td>
		<td width="15%">&nbsp;</td>
		<td width="51%"><span style="vertical-align:middle;"><input type="checkbox" id="chkICD_manual" name="chkICD_manual" style="vertical-align:middle; cursor:pointer" onchange="cekICD_manual()"/> Diagnosa Manual</span></td>
		<td width="34%">&nbsp;</td>
		<td width="0%">&nbsp;</td>
	</tr>
	<tr class="diag1">
    ...
    <tr id="trDiagnosaKlinis">
		<td>&nbsp;</td>
		<td align="right">Diagnosa Klinis :&nbsp;</td>
		<td><label><input type="checkbox" id="chkKlinis" name="chkAkhir"/> Ya</label>
        </td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
    ...
    <tr id="trDiagnosaBanding">
		<td>&nbsp;</td>
		<td align="right">Diagnosa Banding :&nbsp;</td><!--jokerdiag-->
        ...
        <input id="btnTambahDiagBanding" type="button" value="+" style="display:none" onclick="fTambahDiagBanding();" /--><input name="txtDiagBanding" type="text" size="48" autocomplete="off" class="txtinput" />
        <input id="btnTambahDiagBanding" type="button" value="+" onclick="fTambahDiagBanding();" /></td>
		<!--td>&nbsp;</td>
		<td>&nbsp;</td-->
	</tr>
	<tr class="diag1">

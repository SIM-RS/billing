<?php 
	//session_start();
	$baseurl = "http://".$_SERVER["SERVER_NAME"]."/simrs/askep";
	$rooturl = "http://".$_SERVER["SERVER_NAME"]."/simrs/askep";
...
<link rel="STYLESHEET" type="text/css" href="<?php echo $rooturl?>/default.css">

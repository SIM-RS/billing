<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_checklist_kesiapan_operasi WHERE id = '{$_REQUEST['id']}'");
...
<body>
    <div align="center">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            <tr>
                <td height="30">&nbsp;RM 21.20 CEKLIS KESELAMATAN OPERASI</td>
            </tr>
        </table>
    ...
    <script>
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM CEKLIS KESELAMATAN OPERASI");
           gridTarifDokter.setColHeader("No,Tanggal Kunjungan,Tanggal Pelayanan,Tanggal Anamnesa,Tempat Layanan, Petugas,Action");
            ...
            gridTarifDokter.baseURL("../function/grid_2.php?namaTable=rm_checklist_kesiapan_operasi&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

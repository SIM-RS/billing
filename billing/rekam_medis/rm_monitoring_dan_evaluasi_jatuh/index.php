<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_monitoring_dan_evaluasi_jatuh WHERE id = '{$_REQUEST['id']}'");
...
<body>
    <div align="center">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            <tr>
                <td height="30">&nbsp;RM 5.2.2 & RM 5.2.3 LEMBAR  MONITORING DAN EVALUASI  PENCEGAHAN PASIEN JATUH</td>
            </tr>
        </table>
    ...
    <script>
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM LEMBAR  MONITORING DAN EVALUASI  PENCEGAHAN PASIEN JATUHI");
            ...
            gridTarifDokter.baseURL("../function/grid_4.php?namaTable=rm_monitoring_dan_evaluasi_jatuh&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

...
<html lang="en">
  <head>
    ...
    <title>PERSETUJUAN/PENOLAKAN TINDAKAN TRANSFUSI</title>
...
<body>
  <div id="pdf-area" style=" width: 260mm;  margin: auto;">
...
<div class="box-pasien" style="float: right; padding-right: 0px;">
    <p align='right' style="margin: 0px;;">RM24.1/PHCM</p>
...
<hr style="border: 1px solid black; margin:0px; padding:0px; margin-top:2px;">
  ...
  <h5>
    <p>
    <strong> PERSETUJUAN/PENOLAKAN TINDAKAN TRANSFUSI</strong>
...
<table border="1" align="center" cellpadding="7" style="width: 240mm; font-size: 18px;">
    ...
    <tbody>
      <tr><td><div>
    <p align="center" >
        <strong>PERSETUJUAN TINDAKAN TRANSFUSI </strong>
        ...
        <tr>
            <td width="678" valign="top">
                ...
                <p>
                    dengan ini menyatakan SETUJU untuk dilakukannya tindakan <b>TRANSFUSI</b> produk darah 
      ...
      Lain ....................
         ...
         if($pasien['sex']== 'L'){ 
          ...
          ?> 
                ...
                <p>
                    Belawan, Tanggal : <?= date('d/m/yy') ?> Pukul :
                    <?= date('h:i:s') ?>
                    <br>
                     <br>
                   <center> Saksi</center>
...
<table border="1" align="center" cellpadding="7" style="width: 240mm; font-size: 18px;">
    ...
    <tbody>
      <tr><td><div>
    <p align="center" >
        <strong>PENOLAKAN TINDAKAN TRANSFUSI </strong>
...
dijelaskan seperti di atas kepada saya, termasuk risiko dan komplikasi yang mungkin timbul apabila tindakan tersebut tidak dilakukan

            
                </p>
                <p>
              
                 Saya bertanggungjawab secara penuh atas segala akibat yang mungkin timbul sebagai akibat penolakan tindakan kedokteran tersebut.        
                </p>
                <p>
                    <strong> </strong>
                </p>
                <div style="float: right;">
                <p>
                   Belawan : <?= hari_ini() ?>, Tanggal : <?= date('d/m/yy') ?> Pukul :
                    <?= date('h:i:s') ?>
                    <br>
                     <br>
                   <center> Saksi</center>
  ...
  <div class=''btn-group'>
    ...
    function pdf() {
      const pdf = document.getElementById("pdf-area");
          var opt = {
              margin: 0,
              filename: "RM 24.1 <?=$rwPasien['nama']?>.pdf",

...
<head>
  ...
  <title> FORM INPUT PERSETUJUAN/PENOLAKAN TINDAKAN TRANSFUSI </title>
...
<body>
  ...
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;FORM INPUT PERSETUJUAN/PENOLAKAN TINDAKAN TRANSFUSI</td>
                ...
                <form action='func.php?<?= $idKunj ?>&idPel=<?= $idPel ?>&idPasien=<?= $idPasien ?>&idUser=<?= $idUser ?>' method='POST'>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <textarea class="form-control" id="diagnosis_wd_dan_dd" name='diagnosis_wd_dan_dd' required></textarea>
                    </div>

                    <div class="col">
                      <label for="dasar_diagnosis"> dasar diagnosis:</label>

                      <textarea class="form-control" id="dasar_diagnosis" name='dasar_diagnosis' required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      ...
                      <textarea class="form-control" id="tindakan_kedokteran" name='tindakan_kedokteran' required></textarea>
                    </div>

                    <div class="col">
                      <label for="indikasi_tindakan"> indikasi tindakan:</label>

                      <textarea class="form-control" id="indikasi_tindakan" name='indikasi_tindakan' required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      ...
                      <textarea class="form-control" id="tata_cara" name='tata_cara' required></textarea>
                    </div>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <textarea class="form-control" id="risiko" name='risiko' required></textarea>
                    </div>

                    <div class="col">
                      <label for="komplikasi"> komplikasi:</label>

                      <textarea class="form-control" id="komplikasi" name='komplikasi' required></textarea>
                    </div>

                    <div class="col">
                      <label for="prognosis"> prognosis:</label>

                      <textarea class="form-control" id="prognosis" name='prognosis' required></textarea>
                    </div>

                    <div class="col">
                      <label for="alternatif_risiko"> alternatif risiko:</label>

                      <TEXTAREA class="form-control" id="alternatif_risiko" name='alternatif_risiko' required></TEXTAREA>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-5">
                      ...
                      <TEXTAREA class="form-control" id="lain_lain" name='lain_lain' required></TEXTAREA>
                    </div>

<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_2_7_p_bedah WHERE id = '{$_REQUEST['id']}'");
...
<body>
  ...
  spawn();
        ...
        function spawn(){
            ...
            gridTarifDokter.baseURL("../function/grid.php?namaTable=rm_2_7_p_bedah&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

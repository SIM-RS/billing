...
<head>
  ...
  <title> Form pemantauan anestesi lokal </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form pemantauan anestesi lokal</td>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $data['tanggal_tindakan'] . "</td>";
                          echo "<td>" . $data['diagnosa'] . "</td>";
                          echo "<td>" . $data['nama_tindakan'] . "</td>";
                          echo "<td>" . $data['pembedah'] . "</td>";
                          echo "<td>" . $data['ruang_poli'] . "</td>";

                          echo "<td>" . $data['pembuat_laporan'] . "</td>";

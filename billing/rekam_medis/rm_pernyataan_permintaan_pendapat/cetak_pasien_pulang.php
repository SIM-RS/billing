...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <link rel="icon" href="../favicon.png">
       <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <title>PERNYATAAN PERMINTAAN PENDAPAT LAIN / SECOND OPINION</title>
    <style type="text/css">
    @media print {
      #print {
        display: none;
...
<b>No.RM :</b> 
  ...
  <br>
  <hr>
     <center> <h4>PERNYATAAN PERMINTAAN PENDAPAT LAIN / SECOND OPINION</h4></center>
                  <?php
                  $id = $_REQUEST['id'];
...
$result = mysql_query("SELECT * FROM rm_barang_pasien");
              ...
              $queryview = mysql_query("SELECT * FROM rm_pernyataan_permintaan_pendapat WHERE id='$id' ",$konek);
...
<br><br>
Sehubungan kebutuhan pertimbangan pendapat dokter lain atau second opinion bagi pasien, saya memahami perlunya manfaat second opinion setelah diberikan penjelasan, kesempatan bertanya dan mendapat jawaban yang lengkap dari dokter yang merawat, sehingga saya bertanggung jawab atas segala beban biaya second opinion.
<br><br>
Saya juga menyadari bahwa perbedaan pendapat ahli dalam ilmu kedokteran dapat terjadi karena ilmu kedokteran bukanlah suatu hal yang pasti dan selalu mengikuti perkembangan ilmu pengetahuan.
<br><br>
Demikian pernyataan ini saya buat dengan sebenarnya dihadapan saksi-saksi, tanpa ada paksaan dari pihak lain.
<br><br>
</p>
  <div class="box-pasien" style="float: right; padding-right: 220px;">
...
<p><b>
  Catatan : Bila pasien tidak kompeten / tidak bisa menerima informasi, maka dapat diwakili keluarga atau seseorang yang diberi hak untuk memberikan pernyataan permintaan pendapat lain. 
</b></p>
<? } ?>

...
while($rows = mysql_fetch_assoc($query)){
	...
	$dataBalik = tanggal($rows['tanggal_kunjungan']).chr(3).tanggal($rows['tanggal_pelayanan']).chr(3).tanggal($rows['tanggal_anamnesa']).chr(3).$rows['nama_tempat_layanan'].chr(3);

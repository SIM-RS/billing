...
$sql = "SELECT
	...
	pd.tanggal_act as tanggal_anamnesa
FROM
	{$namaTable} pd
...
while($rows = mysql_fetch_assoc($query)){
	...
	$dataBalik .= '<a style="margin:3px" href="cetak.php?id='.$rows['id'].'" target="_blank"><button type="button"><img src="../../icon/printer.png" width="16" height="16">Print</button></a>';
	
	$dataBalik .= '<a target="_blank" style="margin:3px" href="cetak.php?pdf='.$rows['id'].'&idKunj='.$_GET['idKunj'].'&idPel='.$_GET['idPel'].'&idPasien='.$_GET['idPasien'].'&idUser='.$_GET['idUser'].'&tmpLay='.$_REQUEST['tmpLay'].'"><button type="button"><img src="../../icon/printer.png" width="16" height="16"> PDF</button></a>';

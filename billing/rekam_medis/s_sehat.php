...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="margin-top:0px">
        <table width="600" border="0" cellspacing="0" cellpadding="0" align="left" class="kwi">
            <tr>
                <td colspan="2" style="font-size:12px; border:1px solid #000;" align="center"><table border="0">
                  <tr>
                    <td style="font:26px bold tahoma" height="100" width="350">RS PELINDO I</td>
                    <td><table border="0">
  <tr>
    <td style="border:1px solid #000;font:17px bold tahoma;" height="50" width="250">SURAT KETERANGAN SEHAT</td>
            ...
            <tr class="kwi">
                <td height="30" colspan="2" align="left" style="font-size:13px">
                Yang bertanda tangan dibawah ini, Dokter <strong>RS PELINDO I</strong>, dengan ini menerangkan bahwa telah memeriksa dengan teliti :&nbsp;</td>
            </tr>
            <tr class="kwi">
            ...
            <tr class="kwi">
                <td colspan="2">
                    ...
                    <tr>
                            ...
                            <td width="10%" style="font-size:12px">&nbsp;</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">&nbsp;</td>
                            <td width="30%" style="font-size:12px">&nbsp;<?php ?></td>
                    </tr>
                    <tr>
                            <td width="11%" style="font-size:12px">Pekerjaan</td>
                            <td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                    ...
                    <tr>
                     ...
                     <tr>
                            <td width="11%" style="font-size:12px" colspan="6">Maka kedapatan berbadan sehat dan tidak cacat untuk : <strong><? echo $jml;?></strong></td>
                            <!--<td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px">&nbsp;<?php echo strtolower($rw['alamat']);?></td>-->
                            <!--<td width="10%" style="font-size:12px">Unit</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>

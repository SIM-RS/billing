<table width="850" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr id="trPrioritas" style="display:none">
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;<input type="hidden" id="cek_id" name="cek_id" /><input type="hidden" id="cek_baris" name="cek_baris" /><input type="hidden" id="cek_ksg" name="cek_ksg" /></td>
		<td>&nbsp;<input type="hidden" id="cek_baris_kasus" name="cek_baris_kasus" /><input type="hidden" id="cek_ksg_kasus" name="cek_ksg_kasus" /></td>
		<td colspan="2" align="right"><!--<div id="DivHapusManual" style="display:none;text-align:left;">--><input type="hidden" id="cek_id_kasus" name="cek_id_kasus" /><input type="button" id="HapusManual" name="HapusManual" value="Hapus" onclick="DelManual();" style="display:none;" disabled="disabled" class="tblHapus"/>&nbsp;&nbsp;&nbsp;<input type="button" id="TambahManual" name="TambahManual" value="Tambah" onclick="AddManual();" style="display:none;" class="tblTambah"/><!--</div>--></td>
		<td>&nbsp;</td>
	</tr>
    <tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3">
			<div id="gridbox1" style="width:850px; height:270px; background-color:white; overflow:hiiden;"></div>
            <br />

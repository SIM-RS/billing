...
<html lang="en">
  <head>
    ...
    <title> FORM Asuhan Keperawatan </title>
  ...
  <body>
    <div  style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
          ...
          <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
                <tbody><tr>
                    <td height="30" class="tblatas" style="text-align: left;">&nbsp;FORM Asuhan Keperawatan</td>
...
<th>Dokter</th> 
    ...
    <?php
      ...
      foreach($getall as $data){
        ...
        echo "<td>".$no++."</td>"; 
echo "<td>".$data['diagnosa_kerja']."</td>"; 
echo "<td>".$data['kebutuhan']."</td>"; 
echo "<td>".$data['pemeriksaan']."</td>"; 
echo "<td>".$data['keperawatan']."</td>"; 

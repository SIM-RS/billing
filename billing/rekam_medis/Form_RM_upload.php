...
<?php
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#008484"  align="center" class="hd2">
              <tr>
                    <td height="30">&nbsp;FORM UPLOAD GAMBAR REKAM MEDIS</td>
					<td align="right">&nbsp;</td>
                </tr>
            </table>
                    ...
                    <td colspan="2">
                        <fieldset>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                                ...
                                <tr>
                                	<td colspan="2" align="center" style="border:1px solid #000; background-color:#03F; color:#FFF;">UPLOAD GAMBAR</td>
                                </tr>
                                <tr>
                                	<td colspan="2" style="vertical-align:top; border:1px solid #000;" align="left">
                                    <div style="margin-bottom:10px;" id="div_rad">
                                  	<iframe id="frameRad" src="f_radiologi.php" style="border:none; height:300px; width:100%"></iframe>
                                  </div>
                                    </td>
                                	<!--<td width="50%" style="vertical-align:top" align="left">
                                ...
                                <tr>
                                	<td colspan="2" align="center" style="border:1px solid #000; background-color:#03F; color:#FFF;">
                                    <input type="button" id="sGRM" class="sGRM" value="Simpan Gambar" onclick="simpanB();" />
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
          ...
          <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#008484"  class="hd2">
                ...
                <table width="1000" border="0" cellpadding="0" cellspacing="0" class="tabel" align="center">
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left" style="padding-left:20px;"><div class="TabView" id="TabView" style="width:900px; height:400px"></div></td>
...
// ===============================================================================================================================
		...
		function showGrid(){
			...
			a1.baseURL("RM_rekap_utils.php?grd=true&tgl="+document.getElementById('txtTgl').value);
            a1.Init();
			...
			a4.attachEvent("onRowClick","loadFormulirRM");
            a4.onLoaded(loadFormulirRM);
			a4.baseURL("RM_rekap_utils.php?grd4=true&kunjungan_id="+document.getElementById('kunjungan_id').value);
            a4.Init();
			...
			a2.baseURL("RM_rekap_utils.php?grd2=true&pelayanan_id="+document.getElementById('pelayanan_id').value);
            a2.Init();
			
			a3 = new DSGridObject("gridbox3");
            a3.setHeader("DATA REPORT RM");
            a3.setColHeader("NO,CEKLIST,ANALISA,VIEW,KODE,NAMA");
            a3.setIDColHeader(",,,,,");
            a3.setColWidth("30,50,50,50,100,250");
			a3.setCellType("txt,chk,chk,txt,txt,txt");
            a3.setCellAlign("center,center,center,center,center,left");
            a3.setCellHeight(20);
            a3.setImgPath("../icon");
            a3.setIDPaging("paging3");
            a3.attachEvent("onRowClick","cekZXC");
            a3.onLoaded(cekAnalisa);
			a3.baseURL("RM_rekap_utils.php?grd3=true&parent_id="+document.getElementById('formulir_id').value+'&pelayanan_id='+document.getElementById('pelayanan_id').value);
            a3.Init();
		...
		function simpanB()
		{
			...
			//alert(getIdPasien+"\n"+getIdKunj+"\n"+getIdPel+"\n"+userID);
			document.getElementById('frameRad').contentWindow.aplod(action,getIdKunj,getIdPel,getIdPasien,userID);
		}
		...
		function cekList(x){
			...
			Request('RM_rekap_utils.php?grd3=false&baris='+baris+'&act='+act+'&id='+id+'&pelayanan_id='+idPel+'&formulir_id='+document.getElementById('formulir_id').value+'&userId=<?php echo $userId; ?>','spanSukRM','','GET',hslCekList,'noLoad');
		}
		...
		function ambilDataReportRM(){
			...
			a3.loadURL("RM_rekap_utils.php?grd3=true&parent_id="+sisip+'&pelayanan_id='+document.getElementById('pelayanan_id').value,'','GET');
		}
		...
		function ambilDataPasien(){
			...
			a4.loadURL("RM_rekap_utils.php?grd4=true&kunjungan_id="+document.getElementById('kunjungan_id').value,'','GET');
		...
		function loadFormulirRM(){
			...
			a2.loadURL("RM_rekap_utils.php?grd2=true&pelayanan_id="+document.getElementById('pelayanan_id').value,'','GET');
		...
		function saring(){
			...
			if(document.getElementById('chkHistory').checked){
				url = "RM_rekap_utils.php?grdH=true&no_rm="+no_rm+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			}
			else{
				url = "RM_rekap_utils.php?grd=true&tgl="+tgl+"&no_rm="+no_rm+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			}
			a1.loadURL(url,"","GET");
		}
		...
		function filterNoRM(ev,par){
			if(ev.which==13){
				...
				var tgl=document.getElementById('txtTgl').value;
				var no_rm=document.getElementById('txtFilter').value;
				var url = "RM_rekap_utils.php?act=view&grd=true&tgl="+tgl+"&no_rm="+no_rm;
				a1.loadURL(url,"","GET");
			}
		}
		...
		function goFilterAndSort(grd){
			var tgl=document.getElementById('txtTgl').value;
			var no_rm=document.getElementById('txtFilter').value;
			var url = "RM_rekap_utils.php?grd=true&tgl="+tgl+"&no_rm="+no_rm;
			
			if (grd=="gridbox"){		
				url="RM_rekap_utils.php?grd=true&tgl="+tgl+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
				a1.loadURL(url,"","GET");
			}
		}
		...
		function simpan(){
			if(confirm('Pasien dengan norm '+document.getElementById('norm').value+'. Apakah sudah benar ?')){			
				...
				var url = "RM_rekap_utils.php?act=save&grd=true&tgl="+tgl+"&no_rm="+no_rm+"&statusKeluar="+cmbPilihan+"&kunjungan_id="+document.getElementById('kunjungan_id').value+"&status_medik="+document.getElementById('status_medik').value;
				a1.loadURL(url,"","GET");
			}
		}
...
function viewHistory(c){
	...
	if(c.checked){
		...
		url = "RM_rekap_utils.php?act=view&grd=true&tgl="+tgl+"&no_rm="+no_rm+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
	}
	a1.loadURL(url,"","GET");
}

function viewReportRM(i){
	var data = a3.getRowId(i).split('|');
	load_popup_iframe(data[4],data[5]);
}

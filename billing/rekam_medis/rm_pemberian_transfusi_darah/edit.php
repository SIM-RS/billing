...
<head>
  ...
  <title> Form Edit rm_pemberian_transfusi_darah </title>
...
<body>
  ...
  <div style="background-color: #EAF0F0 ; width: 1000px; margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form Edit Pemberian Transfusi Darah</td>
                      ...
                      <div class="col">
                        ...
                        foreach ($one as $data) { ?>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" id="dasar_diagnosis" name='dasar_diagnosis' value="<?php echo $data['dasar_diagnosis']; ?>" required>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" id="indikasi_tindakan" name='indikasi_tindakan' value="<?php echo $data['indikasi_tindakan']; ?>" required>
                          </div>
                          <div class="form-group">
                            <label for="biaya_pengelolaan"> biaya pengelolaan:</label>
                            <input type="text" class="form-control" id="rupiah" name='biaya_pengelolaan' value="<?php echo $data['biaya_pengelolaan']; ?>" required>

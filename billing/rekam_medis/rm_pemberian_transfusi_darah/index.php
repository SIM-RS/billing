...
<head>
  ...
  <title> Form Pemberian Transfusi Darah </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form Pemberian Transfusi Darah</td>
                ...
                <div class='table-responsive'>
                  <table class='table table-sm table-hover table-bordered table-striped' style='background-color: white;'>
                    <thead>
                      <tr align="center">
                        <th>No</th>
                        <th>Dokter pelaksana tindakan</th>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $data['dokter_pelaksana_tindakan'] . "</td>";
                          echo "<td>" . $data['pemberi_informasi'] . "</td>";
                          echo "<td>" . $data['penerima_informasi'] . "</td>";
   ...
   &nbsp;
                ...
                <input type='hidden' name='id' value='" . $data['id'] . "'>
                <input type='submit' name='print' Value='Print' class='btn btn-info ' onclick='return confirm('Kamu Yakin akan menghapus data ini ?')'>
                     </form>

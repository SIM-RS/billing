...
?>    
<table width="700" id="tblDiagnosaAsterix" border="0" cellpadding="1" cellspacing="0">
	<tr class="headtable">
...
?>
	<tr id="lstDiagAsterix<?php echo $i; ?>" lang="<?php echo $arfvalue; ?>" class="itemtableReq" onMouseOver="this.className='itemtableMOverReq'" onMouseOut="this.className='itemtableReq'" onClick="fSetICDX_RM_Asterix(this.lang);">

...
<head>
  ...
  <title> Form permintaan laboratorium </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form permintaan laboratorium</td>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $data['klinis'] . "</td>";
                          echo "<td>" . $data['diagnosis'] . "</td>";

                          echo "<td>" . $data['urine'] . "</td>";
                          echo "<td>" . $data['thyroid'] . "</td>";

                          echo "<td>" . $data['elektrolit'] . "</td>";
                          echo "<td>" . $data['feces'] . "</td>";
                          echo "<td>" . $data['pancreas'] . "</td>";

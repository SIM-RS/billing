...
SELECT '".$id_degger."','".$catatan."',NOW(),'".$user_act."',ms_diagnosa_id AS ms_diagnosa_id_lama,diagnosa_id,degger_id,'1',kunjungan_id,pelayanan_id,tgl,user_id,type_dokter,primer,akhir,klinis,banding,mati,kasus_baru FROM b_diagnosa_rm WHERE id = '".$id."';";
	mysql_query($que);
...
SELECT id,'Perubahan Pada Degger Sehingga Menghapus Asterix',NOW(),'".$user_act."',ms_diagnosa_id AS ms_diagnosa_id_lama,diagnosa_id,degger_id,'1',kunjungan_id,pelayanan_id,tgl,user_id,type_dokter,primer,akhir,klinis,banding,mati,kasus_baru FROM b_diagnosa_rm WHERE degger_id = '".$id_degger."'";
	mysql_query($que);

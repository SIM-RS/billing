...
<!--                    <td align="right" colspan="2" style=" padding-left:10px;">
    ...
    <script type="text/javascript">
		...
		function lihat1()
		{
			...
			a.loadURL("tmpt_layanan_utils.php?th="+th+"&bln="+bln+"&unit_id="+unit_id,"","GET");
		}
		...
		function hapus_minta(a1,b,c)
		{
			...
			if(confirm("Yakin Ingin Menghapus Data"))
			{
				if(a1==0)
				{
					a.loadURL("tmpt_layanan_utils.php?proses=del&param1="+b+"&param2="+c+"&th="+document.getElementById('ta').value+"&bln="+document.getElementById('bulan').value,"","GET");
					//batal();
        ...
        a.setHeader("Daftar Permintaan Obat");
        a.setColHeader("NO,Tanggal,No Permintaan,Unit Tujuan,Kepemilikan,Status,Proses");
        ...
        a.baseURL("tmpt_layanan_utils.php?th="+document.getElementById('ta').value+"&bln="+document.getElementById('bulan').value+"&unit_id="+document.getElementById('cmbTmpLay').value);
        a.Init();

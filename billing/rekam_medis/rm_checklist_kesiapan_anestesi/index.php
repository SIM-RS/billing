...
<head>
  ...
  <title> FORM CHECK LIST KESIAPAN ANESTESI </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;FORM CHECK LIST KESIAPAN ANESTESI</td>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $data['diagnosis'] . "</td>";
                          echo "<td>" . $data['jenis_operasi'] . "</td>";
                          echo "<td>" . $data['teknik_anesthesi'] . "</td>";
                          echo "<td>" . $data['tgl_tindakan'] . "</td>";
                          echo "<td>" . $data['penata_anesthesi'] . "</td>";
                          echo "<td>" . $data['dr_ahli_anesthesi'] . "</td>";

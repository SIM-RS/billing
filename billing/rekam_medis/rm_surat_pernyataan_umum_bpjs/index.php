...
<head>
  ...
  <title> Form surat pernyataan umum bpjs </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form surat pernyataan umum bpjs</td>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $data['hubungan'] . "</td>";
                          echo "<td>" . $data['diagnosa_pasien'] . "</td>";
                          echo "<td>" . $data['case_manager'] . "</td>";

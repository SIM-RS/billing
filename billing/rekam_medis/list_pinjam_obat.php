...
<table width="1000" border="0" cellspacing="1" cellpadding="0" align="center" class="tabel">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
    <td colspan="2" align="right"><button type="button" id="btTambah" name="btTambah" onClick="location='pinjam_obat.php'">Buat Peminjaman Baru</button></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
...
<script>
	...
	a.baseURL("list_pinjam_obat_util.php?tmpLay=0");
	a.Init();

<table width="850" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td>
			<div id="detail_resep">
				<div id="gridboxResepDetail" style="width:850px; height:150px; background-color:white;"></div>
				<!--br>

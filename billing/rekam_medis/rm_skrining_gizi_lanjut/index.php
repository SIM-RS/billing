<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_15_6_skrining_gizi_lanjut WHERE id = '{$_REQUEST['id']}'");
...
<body>
    <div align="center">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            <tr>
                <td height="30">&nbsp;RM 15.6 Skrining Gizi Lanjut</td>
            </tr>
        </table>
    ...
    <script>
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM Skrining Gizi Lanjut");
            gridTarifDokter.setColHeader("No,Tanggal Anamnesa,BB,TB,IMT,Tinggi Lutut,LLA,Opsi");
            gridTarifDokter.setIDColHeader(",pd.tgl_act,pd.BB,pd.TB,pd.IMT,pd.tinggi_lutut,pd.LLA");
            ...
            gridTarifDokter.baseURL("../function/grid_3.php?namaTable=rm_15_6_skrining_gizi_lanjut&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

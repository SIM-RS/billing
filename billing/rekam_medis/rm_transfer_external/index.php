...
<html lang="en">
  <head>
    ...
    <title> Form transfer external </title>
  ...
  <body>
    <div  style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
          ...
          <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
                <tbody><tr>
                    <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form transfer external</td>
...
echo "<td>".$data['ppjp']."</td>"; 
echo "<td>".$data['rs_tujuan']."</td>"; 
echo "<td>".$data['alasan_transfer']."</td>"; 
echo "<td>".$data['tanggal_transfer']."</td>"; 
echo "<td>".$data['petugas_yang_menyerahkan']."</td>"; 
echo "<td>".$data['petugas_yang_menerima']."</td>"; 

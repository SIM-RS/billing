	...
	<div id="divDetil" align="center" style="display:none;">
       <div align="center">
        ...
        <div id="divICD10" style="display:none;width:880px" class="popup">
            ...
            <img alt="close" src="../icon/x.png" width="32" class="popup_closebox" onclick="batalICD_RM()" style="float:right; cursor: pointer; display: none;" />
			<img alt="close" src="../icon/x.png" width="32" onclick="batalICD_RMx()" style="float:right; cursor: pointer" />
                ...
                <fieldset><legend id="lgn_icd">Kode ICD X</legend>
                    <table border=0 width="760">
                        <tr>
                            ...
                            <input type="hidden" id="ms_diagnosa_ICD_RM_cdgn2" name="ms_diagnosa_ICD_RM_cdgn2" />
            ...
            <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
              ...
              <td class="tdisi"><img src="../icon/del.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Menghapus" onClick="if (confirm('Yakin Ingin Menghapus Data?')){removeRowFromTable(this);}"><!--<input type="checkbox" id="racik" name="racik">--><!--<input id="HapusAsterix" name="HapusAsterix" class="hapusasterix2" type="image" src="../icon/del.gif" width="16" height="16" align="absmiddle" onclick="if (confirm('Yakin Ingin Menghapus Data?')){removeRowFromTable(this);}" title="Klik Untuk Menghapus" />--></td>
                        ...
                        <tr>
                            <td colspan="2" align="center"><input type="button" value="Simpan" id="button_updateICD_RM" name="button_updateICD_RM" onclick="updateICD_RM();"/></td>
                        </tr>
                    </table>
                </fieldset>
                </form>
         ...
         <div id="divICD10_v2" style="display:none;width:880px" class="popup">
            <span id="spn_ICD_RM_v2" style="display:none"></span>
            <img alt="close" src="../icon/x.png" width="32" class="popup_closebox" onclick="batalICD_RM_v2()" style="float:right; cursor: pointer; display: none;" />
			<img alt="close" src="../icon/x.png" width="32" onclick="batalICD_RMx_v2()" style="float:right; cursor: pointer" />
            
            <form id="form_icd_rm_v2" name="form_icd_rm_v2" >
                <fieldset><legend id="lgn_icd_v2">Kode ICD X</legend>
                    <table border=0 width="760">
                        <tr>
                            <td width="241" align="right"><span id="spn_icd_v2">ICD X</span>&nbsp;:&nbsp;</td>
                            <td width="533">
							<input type="hidden" id="tot_asterix_v2" name="tot_asterix_v2" />
                            <input type="hidden" id="deggernya_v2" name="deggernya_v2" />
                            <input type="hidden" id="isinyaid_v2" name="isinyaid_v2" />
                            <input type="hidden" id="barisx_v2" name="barisx_v2" />
                            <input type="hidden" id="id_degger_v2" name="id_degger_v2" />
                            <input type="hidden" id="cek_degger_v2" name="cek_degger_v2" />
							<input type="hidden" id="cek_degger_cdgn_v2" name="cek_degger_cdgn_v2" />
                            <input type="hidden" id="id_diagnosa_ICD_RM_v2" name="id_diagnosa_ICD_RM_v2" />
                            <input type="hidden" id="ms_diagnosa_ICD_RM_v2" name="ms_diagnosa_ICD_RM_v2" />
                            <input type="hidden" id="ms_diagnosa_ICD_RM_cdgn_v2" name="ms_diagnosa_ICD_RM_cdgn_v2" />
                            <input type="hidden" id="ms_diagnosa_ICD_RM_cdgn2_v2" name="ms_diagnosa_ICD_RM_cdgn2_v2" />
                            <input type="hidden" id="kode_diagnosa_ICD_RM_v2" name="kode_diagnosa_ICD_RM_v2" />
                            <input type="hidden" id="kode_diagnosa_ICD_RM_cdgn_v2" name="kode_diagnosa_ICD_RM_cdgn_v2" />
                            <input id="txtICD10_v2" name="txtICD10_v2" size="50" onKeyUp="suggest_ICD_RM_v2(event,this);" autocomplete="off" class="txtinput">
                            <input type="hidden" id="txtICD10_cdgn_v2" name="txtICD10_cdgn_v2" />
                            <input type="hidden" id="pernahHapusAsterix_v2" name="pernahHapusAsterix_v2" />
                            <div id="divICD_RM_v2" align="left" style="position:absolute; z-index:0; height: 200px; width: 620px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC; layer-background-color: #CCCCCC;"></div>
                            <div id="loadHapusAsterix_v2"></div></td>
                        </tr>
                        <tr>
                        	<td align="right">Prioritas&nbsp;:&nbsp;</td>
                            <td><input type="hidden" id="txtPrioritas_cdgn" name="txtPrioritas_cdgn" /><select id="txtPrioritas" name="txtPrioritas">
                            	<option value="1" label="Utama">Utama</option>
                                <option value="0" label="Sekunder">Sekunder</option>
                            </select></td>
                        </tr>
                        <tr id="trCatatan_v2" style="display:none;">
                        	<td align="right">Catatan&nbsp;:&nbsp;</td>
                            <td><input id="txtCatatan_v2" name="txtCatatan_v2" size="50" class="txtinput"></td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2">
                            <div id="AsterixShow_v2" style="display:none">
                            <table id="tblJual_v2" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
            <tr> 
              <td colspan="5" align="center" class="jdltable"><hr></td>
            </tr>
            <tr> 
              <td colspan="4" align="center" class="jdltable">DAFTAR ASTERIX</td>
              <td align="right" valign="bottom"><input type="button" value="+" onClick="addRowToTable_v2();" /></td>
            </tr>
            <tr class="headtable"> 
              <td width="27" class="tblheaderkiri">No</td>
              <td width="80" class="tblheader">Kode</td>
              <td width="333" class="tblheader">Asterix<div id="divICD_RM_Asterix_v2" align="left" style="position:absolute; z-index:0; height: 230px; width:620px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC; color:black;"></div></td>
              <td width="274" class="tblheader">Catatan</td>
              <td class="tblheader" width="40">Hapus</td>
            </tr>
            <tr class="itemtable" onMouseOver="this.className='itemtableMOver'" onMouseOut="this.className='itemtable'"> 
              <td class="tdisikiri" width="27">1</td>
              <td class="tdisi" align="left"><input type="text" name="txtKodeAsterix_v2" id="txtKodeAsterix_v2" class="txtinput txtKodeAsterix2" size="10" disabled="disabled" /></td>
              <td class="tdisi" align="left"><input type="hidden" id="degger_id_v2" name="degger_id_v2" class="degger_id2"/>
    						<input type="hidden" id="ms_diagnosa_Asterix_v2" name="ms_diagnosa_Asterix_v2" class="ms_diagnosa_Asterix2"/>
                            <input type="hidden" id="ms_diagnosa_Asterix_cdgn_v2" name="ms_diagnosa_Asterix_cdgn_v2" class="ms_diagnosa_Asterix2"/>
                            <input type="hidden" id="kode_diagnosa_Asterix_v2" name="kode_diagnosa_Asterix_v2" class="kode_diagnosa_Asterix2"/>
                            <input type="text" name="txtAsterix_v2" id="txtAsterix_v2" class="txtinput txtAsterix2" size="50" onKeyUp="suggest_Asterix_v2(event,this);" autocomplete="off" /></td>
              <td class="tdisi"><input type="text" id="txtCatatanAsterix_v2" name="txtCatatanAsterix_v2" size="43" onkeyup="AddRow_v2(event,this)" class="txtinput txtCatatanAsterix2"/></td>
              <td class="tdisi"><img src="../icon/del.gif" border="0" width="16" height="16" align="absmiddle" class="proses" title="Klik Untuk Menghapus" onClick="if (confirm('Yakin Ingin Menghapus Data?')){removeRowFromTable_v2(this);}"><!--<input type="checkbox" id="racik" name="racik">--><!--<input id="HapusAsterix" name="HapusAsterix" class="hapusasterix2" type="image" src="../icon/del.gif" width="16" height="16" align="absmiddle" onclick="if (confirm('Yakin Ingin Menghapus Data?')){removeRowFromTable(this);}" title="Klik Untuk Menghapus" />--></td>
            </tr>
          </table></div>&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center"><input type="button" value="Simpan" id="button_updateICD_RM_v2" name="button_updateICD_RM_v2" onclick="updateICD_RM_v2();"/></td>
                        </tr>
                    </table>
                </fieldset>
                </form>
                ...
                <fieldset><legend>Kasus</legend>
                    <table border=0 width="350">
                        <tr>
                            ...
                            <td><input type="text" id="txtCatatanHapusAsterix" name="txtCatatanHapusAsterix" size="43" class="txtinput"/><input type="hidden" id="parHapusAsterix" name="parHapusAsterix" size="43" class="txtinput"/><input type="hidden" id="parHapusAsterix_v2" name="parHapusAsterix_v2" size="43" class="txtinput"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                ...
                <fieldset><legend>Kasus</legend>
                    <table border=0 width="350">
                        <tr>
                            ...
                            <td><input type="hidden" id="cek_kasusUtil" name="cek_kasusUtil" />
...
// ===============================================================================================================================
		...
		function showGrid(){
			...
			b.setColHeader("NO,TANGGAL,DIAGNOSA,ICD-10 [RM],KASUS,DOKTER,CODER,USER PELAYANAN,PRIORITAS,AKHIR,KLINIS,BANDING,UNIT");
			b.setIDColHeader(",,nama,icdrm,,dokter,coder,petugas,,,,,");
			b.setColWidth("30,100,240,80,100,200,200,200,80,70,70,70,70");
			b.setCellAlign("center,center,left,center,center,left,left,left,center,center,center,center,center,center");
			b.setCellHeight(20);
			b.setImgPath("../icon");
			b.setIDPaging("paging1");
			b.attachEvent("onRowClick","ambilDataDiag");
			b.onLoaded(aktifkanButton);
		...
		document.getElementById('cek_id_kasus').value = '';
		...
		function ambilDataDiag()
		{
			...
			toltip();
			var cek=b.cellsGetValue(b.getSelRow(),3);
			//alert(cek);
			//alert(sisip[10]);
			if(cek=='<span style="text-decoration:none">-</span>'){
			document.getElementById('HapusManual').style.display='inline';
			document.getElementById("HapusManual").disabled = false;
			document.getElementById('cek_id_kasus').value=sisip[10];
			}else{
		...
		//}else if(mTab.getTabAktif()==1){
			b.loadURL("tindiag_utils.php?grd1=true&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj,"","GET");
		//}else if(mTab.getTabAktif()==2){
			f.loadURL("tindiag_utils.php?grd=true&pelayanan_id="+getIdPel,"","GET");
		//}else if(mTab.getTabAktif()==3){
		...
		function cekTab(a){
			if(a==57){
				mTab.setTabCaption2("ANAMNESA,DIAGNOSA,TINDAKAN,RESEP");
		...
		function goFilterAndSort(grd){
			...
			if (grd=="gridbox"){		
				...
				//url="RM_utils.php?grd=true&tgl="+tgl+"&cmbKunjungan="+cmbKunjungan+"&filter="+f.getFilter()+"&sorting="+f.getSorting()+"&page="+f.getPage();
				url="tindiag_utils.php?grd=true&pelayanan_id="+getIdPel+"&filter="+f.getFilter()+"&sorting="+f.getSorting()+"&page="+f.getPage();
				f.loadURL(url,"","GET");
			}
		}
...
if(ksg!=1){
	...
	document.getElementById('ms_diagnosa_ICD_RM_cdgn2').value=sisip[12];
...
function fSetICD_RM_v2(id,baris,ksg){
	var zxc = b.cellsGetValue(baris+1,3);
	//batalICD_RM();
	document.getElementById('lgn_icd_v2').innerHTML="Kode ICD X";
	document.getElementById('spn_icd_v2').innerHTML="ICD X";
	new Popup('divICD10_v2',null,{modal:true,position:'rm',duration:1});
	//document.getElementById('divICD10').style.top='1000px';
	document.getElementById('divICD10_v2').popup.show();
	document.getElementById('txtICD10_v2').focus();
	document.getElementById('barisx_v2').value=baris;
	
if(ksg!=1){
	//alert(ksg);
	var sisip=b.getRowId(baris+1).split("|");
	
	batalICD_RM2_v2(sisip[14]);
	document.getElementById('tot_asterix_v2').value=sisip[14];
	document.getElementById('kode_diagnosa_ICD_RM_v2').value=sisip[9];
	document.getElementById('kode_diagnosa_ICD_RM_cdgn_v2').value=sisip[9];
	document.getElementById('id_degger_v2').value=sisip[10];
	document.getElementById('cek_degger_v2').value=sisip[11];
	document.getElementById('cek_degger_cdgn_v2').value=sisip[11];
	document.getElementById('ms_diagnosa_ICD_RM_v2').value=sisip[12];
	document.getElementById('ms_diagnosa_ICD_RM_cdgn_v2').value=sisip[12];
	document.getElementById('ms_diagnosa_ICD_RM_cdgn2_v2').value=sisip[12];
	document.getElementById('txtICD10_v2').value=sisip[9]+" - "+sisip[13];
	document.getElementById('txtICD10_cdgn_v2').value=sisip[9]+" - "+sisip[13];
	
	jQuery('#txtPrioritas').val(sisip[4]);
	document.getElementById('txtPrioritas_cdgn').value=sisip[4];
	document.getElementById('isinyaid_v2').value=sisip[16];
	
		if(sisip[14]!=''){
				//alert(sisip[14]);
var tbl = document.getElementById('tblJual_v2');
tbl.deleteRow(3);
/*var lastRow = tbl.rows.length;
	  for (var i=2;i<lastRow;i++){
		var tds = tbl.rows[i].getElementsByTagName('td');
...
if(document.getElementById('pernahHapusAsterix_v2').value==""){
document.getElementById('pernahHapusAsterix_v2').value=1;
}
				/*var isiin=sisip[15].split("***");
					var ok=isiin[0].split("**");
				addRowToTable2(ok[0]);*/
				...
				for (var j=0;j<sisip[14];j++){
					...
					var ok=isiin[j].split("**");
					//alert(j);//alert(ok[2]);alert(ok[0]);
					document.form_icd_rm_v2.degger_id_v2[j].value=ok[0];
					document.form_icd_rm_v2.ms_diagnosa_Asterix_v2[j].value=ok[1];
					document.form_icd_rm_v2.ms_diagnosa_Asterix_cdgn_v2[j].value=ok[1];
					document.form_icd_rm_v2.kode_diagnosa_Asterix_v2[j].value=ok[2];
					//document.forms[0].txtAsterix[j].value=ok[2]+" - "+ok[3];
					document.form_icd_rm_v2.txtKodeAsterix_v2[j].value=ok[2];
					document.form_icd_rm_v2.txtAsterix_v2[j].value=ok[3];
					//document.forms[0].HapusAsterix[j].value=ok[0];
					//alert(document.forms[0].HapusAsterix[j].value);
					//addRowToTable();		
				}
			}else{
var cekHapus = document.getElementById('pernahHapusAsterix_v2').value;				
		/*if(cekHapus==""){
				var isiin=sisip[15].split("***");
				//alert(isiin[j]);
				var ok=isiin[0].split("**");
				...
				addRowToTable2_v2(ok[0]);
		//}	
				document.forms['form_icd_rm_v2'].elements['degger_id_v2'].value=ok[0];
				document.forms['form_icd_rm_v2'].elements['ms_diagnosa_Asterix_v2'].value=ok[1];
				document.forms['form_icd_rm_v2'].elements['ms_diagnosa_Asterix_cdgn_v2'].value=ok[1];
				document.forms['form_icd_rm_v2'].elements['kode_diagnosa_Asterix_v2'].value=ok[2];
				//document.forms[0].txtAsterix[j].value=ok[2]+" - "+ok[3];
				document.forms['form_icd_rm_v2'].elements['txtKodeAsterix_v2'].value=ok[2];
				document.forms['form_icd_rm_v2'].elements['txtAsterix_v2'].value=ok[3];
				//document.getElementById('HapusAsterix').value=ok[0];
		//}
		}	
		}
	...
	if(sisip[11]==1){
		document.getElementById('AsterixShow_v2').style.display='block';
	}else{
		document.getElementById('AsterixShow_v2').style.display='none';
	}
}else{
	batalICD_RM_v2();
	document.getElementById('AsterixShow_v2').style.display='none';
	...
	if(document.getElementById('xxxicdrm_'+baris).value=='1'){
		document.getElementById('trCatatan_v2').style.display='table-row';
		//jQuery(".txtCatatanAsterix2").prop('disabled', false);
		//document.getElementById('txtCatatanAsterix').disabled = false;
	}
	else{
		document.getElementById('trCatatan_v2').style.display='none';
		//jQuery(".txtCatatanAsterix2").prop('disabled', true);
		//document.getElementById('txtCatatanAsterix').disabled = true;
	}
	jQuery(".txtKodeAsterix2_v2").prop('disabled', true);
	document.getElementById('id_diagnosa_ICD_RM_v2').value=id;
...
function DelManual(){
 if (confirm('Apakah Anda Yakin Ingin Menghapus Data ?')){
	var cek_id_kasus=document.getElementById('cek_id_kasus').value;
	url = "ICD_RM_util_v2.php?act=updateicdxrm2&cek_id_kasus="+cek_id_kasus+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&user_act=<?php echo $userId; ?>";
	
	Request(url,'spn_ICD_RM_v2','','GET',showICD_RM_v2,'noload');
	b.loadURL("tindiag_utils.php?grd1=true&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj,"","GET");
 }
}

function bersihManual(){
//alert(document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length);
	if (document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length > 1){
		for(var i=document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length+2;i>(1+2);i--){			
			var del=i;
			var tbl=document.getElementById('tblJual_v2');
			tbl.deleteRow(del);
		}
	...
	document.getElementById('barisx_v2').value='';
	document.getElementById('id_degger_v2').value='';
	document.getElementById('cek_degger_v2').value='';
	document.getElementById('id_diagnosa_ICD_RM_v2').value='';
	document.getElementById('ms_diagnosa_ICD_RM_v2').value='';
	document.getElementById('ms_diagnosa_ICD_RM_cdgn_v2').value='';
	document.getElementById('kode_diagnosa_ICD_RM_v2').value='';
	document.getElementById('txtICD10_v2').value='';
	document.getElementById('txtCatatan_v2').value='';
	...
	document.form_icd_rm_v2.degger_id_v2.value = '';
	document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.value = '';
	document.form_icd_rm_v2.kode_diagnosa_Asterix_v2.value = '';
	document.form_icd_rm_v2.txtKodeAsterix_v2.value = '';
	document.form_icd_rm_v2.txtAsterix_v2.value = '';
	document.form_icd_rm_v2.txtCatatanAsterix_v2.value = '';
	
	//document.form_icd_rm.racik.checked = false;
	//document.form_icd_rm_v2.txtKodeAsterix_v2.disabled = false;
	
	//document.getElementById('divICD_RM_v2').style.display='none';
	//document.getElementById('AsterixShow_v2').style.display='none';
}
...
function updateICD_RM(){
	...
	var ms_diagnosa_ICD_RM_cdgn=document.getElementById('ms_diagnosa_ICD_RM_cdgn2').value;
	var txtCatatan=document.getElementById('txtCatatan').value;
	var url;
	var cekdong=document.getElementById('txtICD10').value;
	var isitxt=document.getElementById('spn_icd').innerHTML;
	
	if(cekdong=='')
	{
		alert('Isikan '+isitxt+' Terlebih Dahulu !');
		document.getElementById("button_updateICD_RM").disabled = false;
	} else 
	{
		//degger
		var cdata='';
		...
		if (document.getElementById('lgn_icd').innerHTML=="Kode ICD X"){
			url = "ICD_RM_util.php?act=updateicdxrm&id_diagnosa_ICD_RM="+id_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM="+ms_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM_cdgn="+ms_diagnosa_ICD_RM_cdgn+"&txtCatatan="+txtCatatan+"&fdata="+cdata+"&cek_degger="+cek_degger+"&id_degger="+id_degger+"&isinyaid="+isinyaid+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&user_act=<?php echo $userId; ?>";
		}else{
			url = "ICD_RM_util.php?act=updateicd9cm&id_diagnosa_ICD_RM="+id_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM="+ms_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM_cdgn="+ms_diagnosa_ICD_RM_cdgn+"&txtCatatan="+txtCatatan+"&fdata="+cdata+"&cek_degger="+cek_degger+"&id_degger="+id_degger+"&isinyaid="+isinyaid+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&user_act=<?php echo $userId; ?>";
		}
		// alert(url);
		Request(url,'spn_ICD_RM','','GET',showICD_RM,'noload');
		document.getElementById("button_updateICD_RM").disabled = true;
		b.loadURL("tindiag_utils.php?grd1=true&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj,"","GET");
		f.oadURL("tindiag_utils.php?grd=true&pelayanan_id="+getIdPel,"","GET");
...
function aktifkanButton(){
	document.getElementById("button_updateICD_RM").disabled = false;
	document.getElementById("button_updateICD_RM_v2").disabled = false;
}

function updateICD_RM_v2(){
document.getElementById("button_updateICD_RM_v2").disabled = true;
	var isinyaid=document.getElementById('isinyaid_v2').value;
	var id_degger=document.getElementById('id_degger_v2').value;
	var cek_degger=document.getElementById('cek_degger_v2').value;
	var id_diagnosa_ICD_RM=document.getElementById('id_diagnosa_ICD_RM_v2').value;
	var ms_diagnosa_ICD_RM=document.getElementById('ms_diagnosa_ICD_RM_v2').value;
	var ms_diagnosa_ICD_RM_cdgn=document.getElementById('ms_diagnosa_ICD_RM_cdgn2_v2').value;
	var txtCatatan=document.getElementById('txtCatatan_v2').value;
	var txtPrioritas=document.getElementById('txtPrioritas').value;
	var txtPrioritas_cdgn=document.getElementById('txtPrioritas_cdgn').value;
	var url;
	var cekdong=document.getElementById('txtICD10_v2').value;
	var isitxt=document.getElementById('spn_icd').innerHTML;
...
var ctemp;
var sx1,sx2;
	if (document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length){
		for (var i=0;i<document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length;i++){
			ctemp=document.form_icd_rm_v2.ms_diagnosa_Asterix_v2[i].value.split('|');
			/*if (document.forms[0].racik[i].checked==true){
				sx4="1";
			}else{
				sx4="0";
			}*/
			sx1=document.form_icd_rm_v2.txtCatatanAsterix_v2[i].value;
			sx2=document.form_icd_rm_v2.degger_id_v2[i].value;
			sx3=document.form_icd_rm_v2.ms_diagnosa_Asterix_cdgn_v2[i].value;
			sx4="";
			while (sx1.indexOf(".")>-1){
				sx1=sx1.replace(".","");
			}
		...
		if (cdata!=''){
			...
			document.form_icd_rm_v2.txtAsterix_v2[i].focus();
			alert('Isikan Asterix Terlebih Dahulu !');
			return false;
		}
	}else{
		if (document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.value==""){
			document.form_icd_rm_v2.txtAsterix_v2.focus();
			alert('Isikan Asterix Terlebih Dahulu !');
			return false;
		}
		ctemp=document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.value.split('|');
		/*if (document.forms[0].racik.checked==true){
			sx4="1";
		}else{
			sx4="0";
		}*/
		sx1=document.form_icd_rm_v2.txtCatatanAsterix_v2.value;
		sx2=document.form_icd_rm_v2.degger_id_v2.value;
		sx3=document.form_icd_rm_v2.ms_diagnosa_Asterix_cdgn_v2.value;
		sx4="";
		while (sx1.indexOf(".")>-1){
			sx1=sx1.replace(".","");
		}
	...
	//alert(ms_diagnosa_ICD_RM);
	//alert(ms_diagnosa_ICD_RM_cdgn);
	if (document.getElementById('lgn_icd_v2').innerHTML=="Kode ICD X"){
		url = "ICD_RM_util_v2.php?act=updateicdxrm&id_diagnosa_ICD_RM="+id_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM="+ms_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM_cdgn="+ms_diagnosa_ICD_RM_cdgn+"&txtCatatan="+txtCatatan+"&fdata="+cdata+"&cek_degger="+cek_degger+"&id_degger="+id_degger+"&isinyaid="+isinyaid+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&txtPrioritas="+txtPrioritas+"&txtPrioritas_cdgn="+txtPrioritas_cdgn+"&user_act=<?php echo $userId; ?>";
	}else{
		url = "ICD_RM_util_v2.php?act=updateicd9cm&id_diagnosa_ICD_RM="+id_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM="+ms_diagnosa_ICD_RM+"&ms_diagnosa_ICD_RM_cdgn="+ms_diagnosa_ICD_RM_cdgn+"&txtCatatan="+txtCatatan+"&fdata="+cdata+"&cek_degger="+cek_degger+"&id_degger="+id_degger+"&isinyaid="+isinyaid+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&txtPrioritas="+txtPrioritas+"&txtPrioritas_cdgn="+txtPrioritas_cdgn+"&user_act=<?php echo $userId; ?>";
	}
	//alert(url);
	Request(url,'spn_ICD_RM_v2','','GET',showICD_RM_v2,'noload');
	b.loadURL("tindiag_utils.php?grd1=true&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj,"","GET");
...
document.getElementById('divICD10_v2').popup.hide();
}
}
...
function showICD_RM(){
	...
	if(document.getElementById('spn_ICD_RM').innerHTML=='ok'){
		if (document.getElementById('lgn_icd').innerHTML=="Kode ICD X"){
			...
			zxc = '<div class="overout" onmouseover="degger('+document.getElementById('id_diagnosa_ICD_RM').value+')"><span style="color:#0000FF" title="Klik Untuk Mengubah ICD-9CM" onclick="fSetICD_9CM('+document.getElementById('cek_idTind').value+','+document.getElementById('cek_barisTind').value+','+document.getElementById('cek_ksgTind').value+');">'+document.getElementById('kode_diagnosa_ICD_RM').value+'</span></div>';
...
function showICD_RM_v2(){
	var zxc;
	if(document.getElementById('spn_ICD_RM_v2').innerHTML=='ok'){
		if (document.getElementById('lgn_icd_v2').innerHTML=="Kode ICD X"){
			zxc = '<div class="overout" onmouseover="degger('+document.getElementById('id_diagnosa_ICD_RM_v2').value+')"><span style="color:#0000FF" title="Klik Untuk Mengubah ICD-10" onclick="fSetICD_RM('+document.getElementById('cek_id').value+','+document.getElementById('cek_baris').value+','+document.getElementById('cek_ksg').value+');">'+document.getElementById('kode_diagnosa_ICD_RM_v2').value+'</span></div>';
			b.cellsSetValue(b.getSelRow(),4,zxc);
			//document.getElementById('xxxicdrm_'+document.getElementById('id_diagnosa_ICD_RM').value).value='1';
			
		}else{
			zxc = '<div class="overout" onmouseover="degger('+document.getElementById('id_diagnosa_ICD_RM_v2').value+')"><span style="color:#0000FF" title="Klik Untuk Mengubah ICD-9CM" onclick="fSetICD_9CM('+document.getElementById('cek_idTind').value+','+document.getElementById('cek_barisTind').value+','+document.getElementById('cek_ksgTind').value+');">'+document.getElementById('kode_diagnosa_ICD_RM_v2').value+'</span></div>';
			f.cellsSetValue(f.getSelRow(),4,zxc);
			//document.getElementById('xxxicd9cm_'+document.getElementById('id_diagnosa_ICD_RM').value).value='1';
		}
		alert('simpan berhasil.');
	...
	else if(document.getElementById('spn_ICD_RM_v2').innerHTML=='error'){
		alert('simpan gagal.');
	}
	else if(document.getElementById('spn_ICD_RM_v2').innerHTML=='ok2'){
		alert('hapus berhasil.');
	}
	else if(document.getElementById('spn_ICD_RM_v2').innerHTML=='error2'){
		alert('hapus gagal.');
	}
	else{
		alert(document.getElementById('spn_ICD_RM_v2').innerHTML);
	}
	batal('btnBatalDiag');
}
...
function suggest_ICD_RM_v2(e,par){
	var keywords=par.value;//alert(keywords);
	if(e == 'cariDiag'){
		if(document.getElementById('divICD_RM_v2').style.display == 'block'){
			document.getElementById('divICD_RM_v2').style.display='none';
		}
		else{
			//alert(document.getElementById('lgn_icd').innerHTML);
			if (document.getElementById('lgn_icd_v2').innerHTML=="Kode ICD X"){
				//alert('icd-x');
				Request('diagnosalist_ICD_RM_v2.php?findAll=true&aKeyword='+keywords+'&unitId='+getIdUnit+'&PK=0' , 'divICD_RM', '', 'GET' );
			}else{
				//alert('icd-9cm');
				Request('diagnosalist_ICD_RM_v2.php?findAll=true&aKeyword='+keywords+'&unitId='+getIdUnit+'&PK=0&is_icd9cm=1' , 'divICD_RM', '', 'GET' );
			}
			if (document.getElementById('divICD_RM_v2').style.display=='none') fSetPosisi(document.getElementById('divICD_RM_v2'),par);
			document.getElementById('divICD_RM_v2').style.display='block';
		}
	}
	else{
		if(keywords==""){
			...
			//alert(key);
			if (key==38 || key==40){
				var tblRow=document.getElementById('tblDiagnosa_v2').rows.length;
				if (tblRow>0){
					//alert(RowIdx);
					if (key==38 && RowIdx>0){
						RowIdx=RowIdx-1;
						document.getElementById('lstDiag_v2'+(RowIdx+1)).className='itemtableReq';
						if (RowIdx>0) document.getElementById('lstDiag_v2'+RowIdx).className='itemtableMOverReq';
					}else if (key == 40 && RowIdx < tblRow){
						RowIdx=RowIdx+1;
						if (RowIdx>1) document.getElementById('lstDiag_v2'+(RowIdx-1)).className='itemtableReq';
						document.getElementById('lstDiag_v2'+RowIdx).className='itemtableMOverReq';
					}
				}
			}
			else if (key==13){
				if (RowIdx>0){
					if (fKeyEnt==false){
						fSetICDX_RM(document.getElementById('lstDiag_v2'+RowIdx).lang);
					}else{
						fKeyEnt=false;
					}
				}
				...
				if (document.getElementById('lgn_icd_v2').innerHTML=="Kode ICD X"){
					//alert('icd-x');
					Request('diagnosalist_ICD_RM_v2.php?aKeyword='+keywords+'&unitId='+getIdUnit+'&PK=0', 'divICD_RM_v2', '', 'GET' );
				}else{
					//alert('icd-9cm');
					Request('diagnosalist_ICD_RM_v2.php?aKeyword='+keywords+'&unitId='+getIdUnit+'&PK=0&is_icd9cm=1', 'divICD_RM_v2', '', 'GET' );
				}
				if (document.getElementById('divICD_RM_v2').style.display=='none') fSetPosisi(document.getElementById('divICD_RM_v2'),par);
				document.getElementById('divICD_RM_v2').style.display='block';
			}
...
function suggest_Asterix_v2(e,par){
	var keywords=par.value;//alert(keywords);
  ...
  if (jmlRow > 2){
	...
	if(keywords==""){
		document.getElementById('divICD_RM_Asterix_v2').style.display='none';
	}else{
		var key;
		if(window.event) {
		  key = window.event.keyCode; 
		...
		//alert(key);
		if (key==38 || key==40){
			var tblRow=document.getElementById('tblDiagnosaAsterix_v2').rows.length;
			if (tblRow>0){
				//alert(RowIdx);
				if (key==38 && RowIdx>0){
					RowIdx=RowIdx-1;
			...
			fKeyEnt=false;
			//jQuery("#txtKodeAsterix").prop('disabled', false);
			Request('diagnosalist_ICD_RM_Asterix_v2.php?aKeyword='+keywords+'&unitId='+getIdUnit+'&PK=0&no='+i, 'divICD_RM_Asterix_v2', '', 'GET' );		
			if (document.getElementById('divICD_RM_Asterix_v2').style.display=='none') {	
				fSetPosisi_asterix(document.getElementById('divICD_RM_Asterix_v2'),par);
				//document.getElementById('divICD_RM_Asterix').style.top='600px';
			}
			document.getElementById('divICD_RM_Asterix_v2').style.display='block';
		}
	}
}
...
function fSetICDX_RM_v2(par){
	var cdata=par.split("*|*");
	if(document.getElementById("cek_degger_v2").value == 1 && document.getElementById("ms_diagnosa_ICD_RM_cdgn_v2").value!=cdata[0] && document.getElementById("tot_asterix_v2").value != 0){
	//if(document.getElementById("ms_diagnosa_ICD_RM_cdgn").value!=cdata[0]){
	//if(document.getElementById("tot_asterix").value != 0){
		if (confirm('Apakah Anda Yakin Ingin Mengubah Data ?')){
			//alert(document.getElementById("id_degger").value);
				var id_degger = document.getElementById("id_degger_v2").value;
				jQuery("#loadHapusAsterix_v2").load("updateAsterix_v2.php?cp=true&id_degger="+id_degger+"&user_act=<?php echo $userId; ?>");
				batalICD_RM3_v2();
	
				document.getElementById("ms_diagnosa_ICD_RM_v2").value=cdata[0];
				//document.getElementById("ms_diagnosa_ICD_RM_cdgn").value=cdata[0];
				document.getElementById("kode_diagnosa_ICD_RM_v2").value=cdata[2];
				document.getElementById("txtICD10_v2").value=cdata[2]+" - "+cdata[1];
				document.getElementById('divICD_RM_v2').style.display='none';
				document.getElementById("cek_degger_v2").value=cdata[3];
				//document.getElementById('AsterixShow').style.display='block';
				//alert(cdata[3]);
				if(cdata[3]==1){
					document.getElementById('AsterixShow_v2').style.display='block';
				...
				document.getElementById("ms_diagnosa_ICD_RM_v2").value=document.getElementById("ms_diagnosa_ICD_RM_cdgn_v2").value;
				//document.getElementById("ms_diagnosa_ICD_RM_cdgn").value=cdata[0];
				document.getElementById("kode_diagnosa_ICD_RM_v2").value=document.getElementById("kode_diagnosa_ICD_RM_cdgn_v2").value;
				document.getElementById("txtICD10_v2").value=document.getElementById("txtICD10_cdgn_v2").value;
				document.getElementById('divICD_RM_v2').style.display='none';
				document.getElementById("cek_degger_v2").value=document.getElementById("cek_degger_v2").value;
		}
	//}
	//}
	}else if(document.getElementById("cek_degger_v2").value == 1 && document.getElementById("ms_diagnosa_ICD_RM_cdgn_v2").value!=cdata[0]){
		if (confirm('Apakah Anda Yakin Ingin Mengubah Data ?')){
				batalICD_RM3_v2();
		...
		document.getElementById("ms_diagnosa_ICD_RM_v2").value=cdata[0];
		document.getElementById("ms_diagnosa_ICD_RM_cdgn_v2").value=cdata[0];
		//document.getElementById("ms_diagnosa_ICD_RM_cdgn").value=cdata[0];
		document.getElementById("kode_diagnosa_ICD_RM_v2").value=cdata[2];
		document.getElementById("kode_diagnosa_ICD_RM_cdgn_v2").value=cdata[2];
		document.getElementById("txtICD10_v2").value=cdata[2]+" - "+cdata[1];
		document.getElementById("txtICD10_cdgn_v2").value=cdata[2]+" - "+cdata[1];
		document.getElementById('divICD_RM_v2').style.display='none';
		document.getElementById("cek_degger_v2").value=cdata[3];
		document.getElementById("cek_degger_cdgn_v2").value=cdata[3];
		//document.getElementById('AsterixShow').style.display='block';
		//alert(cdata[3]);
		if(cdata[3]==1){
			document.getElementById('AsterixShow_v2').style.display='block';
		...
		document.form_icd_rm_v2.txtKodeAsterix_v2.disabled = true;
	}
}
...
function fSetICDX_RM_Asterix_v2(par){
	var cdata=par.split("*|*");
	/*document.getElementById("ms_diagnosa_Asterix").value=cdata[0];
	document.getElementById("kode_diagnosa_Asterix").value=cdata[2];
	document.getElementById("txtAsterix").value=cdata[2]+" - "+cdata[1];*/
	//alert(cdata[3]);
if(document.form_icd_rm_v2.kode_diagnosa_Asterix_v2.length==undefined){
		kedua=0;
	}
	if ((cdata[0]*1)==0){
		if(kedua==1){
			//document.forms[0].idP[(cdata[0]*1)].value=cdata[1];
			document.form_icd_rm_v2.ms_diagnosa_Asterix_v2[(cdata[0])].value=cdata[1];
			document.form_icd_rm_v2.kode_diagnosa_Asterix_v2[(cdata[0])].value=cdata[3];
			//document.form_icd_rm.txtAsterix[(cdata[0])].value=cdata[3]+" - "+cdata[2];
			document.form_icd_rm_v2.txtKodeAsterix_v2[(cdata[0])].value=cdata[3];
			document.form_icd_rm_v2.txtAsterix_v2[(cdata[0])].value=cdata[2];
			document.form_icd_rm_v2.txtCatatanAsterix_v2[(cdata[0])].focus();
		}
		if(kedua==0){
			document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.value=cdata[1];
			document.form_icd_rm_v2.kode_diagnosa_Asterix_v2.value=cdata[3];
			//document.form_icd_rm.txtAsterix.value=cdata[3]+" - "+cdata[2];
			document.form_icd_rm_v2.txtKodeAsterix_v2.value=cdata[3];
			document.form_icd_rm_v2.txtAsterix_v2.value=cdata[2];
			//document.getElementById('txtCatatanAsterix').focus();
...
function batalICD_RMx(){
var cek = document.getElementById('cek_ksg').value;
if(cek==1){
	batalICD_RM();
	document.getElementById('divICD10').popup.hide();
}else{
if(document.getElementById('ms_diagnosa_ICD_RM').value!=document.getElementById('ms_diagnosa_ICD_RM_cdgn2').value){
var isitxt=document.getElementById('spn_icd').innerHTML;
	alert('Simpan '+isitxt+' Terlebih Dahulu !');
}else{
var cek_degger=document.getElementById('cek_degger').value;
var cdata='';
var cdataCek=0;
...
var sx1,sx2;
	if (document.forms[0].ms_diagnosa_Asterix.length){
		for (var i=0;i<document.forms[0].ms_diagnosa_Asterix.length;i++){
			...
			sx1=document.forms[0].txtCatatanAsterix[i].value;
			sx2=document.forms[0].degger_id[i].value;
			sx3=document.forms[0].ms_diagnosa_Asterix[i].value;
			sx4=document.forms[0].ms_diagnosa_Asterix_cdgn[i].value;
			while (sx1.indexOf(".")>-1){
				sx1=sx1.replace(".","");
			}
			while (sx2.indexOf(".")>-1){
		...
		if (cdata!=''){
			if(cdataCek==1){
				alert('Simpan Asterix Terlebih Dahulu !');
			}else{
				batalICD_RM();
				document.getElementById('divICD10').popup.hide();
			}
		...
		if (document.forms[0].ms_diagnosa_Asterix.value==""){
			...
			if(document.forms[0].degger_id.value==''){
				alert('Simpan Asterix Terlebih Dahulu !');
			}else if(document.forms[0].ms_diagnosa_Asterix.value!=document.forms[0].ms_diagnosa_Asterix_cdgn.value){
				alert('Simpan Asterix Terlebih Dahulu !');
			}else{
				batalICD_RM();
				document.getElementById('divICD10').popup.hide();
...
//alert(document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length);
	...
	document.getElementById('txtICD10_v2').value='';
	document.getElementById('txtCatatan_v2').value='';
	document.getElementById('txtPrioritas_cdgn').value='';
...
//alert(document.form_icd_rm.ms_diagnosa_Asterix.length);
	...
	document.getElementById('txtICD10_v2').value='';
	document.getElementById('txtCatatan_v2').value='';
	document.getElementById('tot_asterix_v2').value='';
	document.getElementById('txtPrioritas_cdgn').value='';
...
//alert(document.form_icd_rm.ms_diagnosa_Asterix.length);
	...
	document.form_icd_rm_v2.degger_id_v2.value = '';
	document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.value = '';
	document.form_icd_rm_v2.ms_diagnosa_Asterix_cdgn_v2.value = '';
	document.form_icd_rm_v2.kode_diagnosa_Asterix_v2.value = '';
	document.form_icd_rm_v2.txtKodeAsterix_v2.value = '';
	document.form_icd_rm_v2.txtAsterix_v2.value = '';
	document.form_icd_rm_v2.txtCatatanAsterix_v2.value = '';
...
function fSetKasusICD_RM(id,baris,ksg){
	document.getElementById('cek_baris_kasus').value=baris;
	document.getElementById('cek_ksg_kasus').value=ksg;
	if(ksg==1){
		alert("Anda harus koding terlebih dahulu!");	
	}else{
	//alert(id);
	document.getElementById('cek_kasusUtil').value=id;
	var sisip=b.getRowId(baris+1).split("|");
	jQuery('#cmbKasusDiag').val(sisip[18]);
...
function updateKasusICD_RM(){
	var cek=document.getElementById('cek_kasusUtil').value;
	var id_diagnosa_ICD_RM=document.getElementById('id_diagnosa_ICD_RM').value;
	var id_diagnosa_ICD_RM_v2=document.getElementById('id_diagnosa_ICD_RM_v2').value;
	
	var ms_diagnosa_ICD_RM=document.getElementById('ms_diagnosa_ICD_RM').value;
	var ms_diagnosa_ICD_RM_v2=document.getElementById('ms_diagnosa_ICD_RM_v2').value;
	
	var id=document.getElementById('id_degger').value;
	var id_v2=document.getElementById('id_degger_v2').value;
	var url;

//alert(cek);	
 if(cek==0){
	url = "ICD_RM_util_v2.php?act=updatekasusicdxrm&kasus_baru="+document.getElementById('cmbKasusDiag').value+"&ms_diagnosa_ICD_RM="+ms_diagnosa_ICD_RM_v2+"&id_diagnosa_ICD_RM="+id_diagnosa_ICD_RM_v2+"&id_diag_rm="+id_v2+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&user_act=<?php echo $userId; ?>";
 }else{
	url = "ICD_RM_util.php?act=updatekasusicdxrm&kasus_baru="+document.getElementById('cmbKasusDiag').value+"&ms_diagnosa_ICD_RM="+ms_diagnosa_ICD_RM+"&id_diagnosa_ICD_RM="+id_diagnosa_ICD_RM+"&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj+"&user_act=<?php echo $userId; ?>";
 } 
...
function showKasusICD_RM(){
	...
	if(document.getElementById('cek_kasusUtil').value==0){
		zxc = '<span style="color:#0000FF" title="Klik Untuk Mengubah Kasus ICD-10" onclick="fSetKasusICD_RM('+document.getElementById('id_diagnosa_ICD_RM_v2').value+','+document.getElementById('cek_baris_kasus').value+','+document.getElementById('cek_ksg_kasus').value+');">'+labelKasusICD+'</span>';
	}else{
		zxc = '<span style="color:#0000FF" title="Klik Untuk Mengubah Kasus ICD-10" onclick="fSetKasusICD_RM('+document.getElementById('id_diagnosa_ICD_RM').value+','+document.getElementById('cek_baris_kasus').value+','+document.getElementById('cek_ksg_kasus').value+');">'+labelKasusICD+'</span>';
	}
...
function fSetICD_9CM(id,baris,sdh){
document.getElementById('cek_idTind').value=id;
document.getElementById('cek_barisTind').value=baris;
document.getElementById('cek_ksgTind').value=sdh;
...
if(sdh==1){
	var sisip=f.getRowId(baris+1).split("|");
	document.getElementById('kode_diagnosa_ICD_RM').value=sisip[10];
	document.getElementById('ms_diagnosa_ICD_RM').value=sisip[10];
	document.getElementById('ms_diagnosa_ICD_RM_cdgn').value=sisip[10];
	document.getElementById('ms_diagnosa_ICD_RM_cdgn2').value=sisip[10];
	document.getElementById('txtICD10').value=sisip[10]+" - "+sisip[11];
}
...
function HapusAsterixnya_v2(par,tez){
	//alert(par);
	/*new Popup('divHapusAsterix',null,{modal:true,position:'rm',duration:1});
	document.getElementById('divHapusAsterix').popup.show();*/
	document.getElementById("parHapusAsterix_v2").value=par;
...
if (document.form_icd_rm_v2.ms_diagnosa_Asterix_v2.length>1){
  //for (var i=0;i<document.forms[0].ms_diagnosa_Asterix.length;i++){
  var cat=document.form_icd_rm_v2.txtCatatanAsterix_v2[i].value;
  var alasan=document.form_icd_rm_v2.txtAsterix_v2[i].value;
  //alert(cat);
  //}
}else{
  /*if(cekHapus==1){
	...
	var cat=document.forms['form_icd_rm_v2'].elements['txtCatatanAsterix_v2'].value;
	//var cat=document.forms[0].txtCatatanAsterix.value;
	var alasan=document.forms['form_icd_rm_v2'].elements['txtAsterix_v2'].value;
	//var alasan=document.forms[0].txtAsterix.value;
  //}
	//alert(cat);
}
	
	var isi = document.getElementById("parHapusAsterix_v2").value;
	//var cat = document.getElementById("txtCatatanHapusAsterix").value;
	var id_degger=document.getElementById('id_degger_v2').value;
	//alert(cat);
  if(cat==""){
	...
	if (confirm('Yakin Ingin Menghapus Data?')){
		jQuery("#loadHapusAsterix_v2").load("updateAsterix_v2.php?in=true&catatan="+cat+"&id="+isi+"&id_degger="+id_degger+"&user_act=<?php echo $userId; ?>");
	  	removeRowFromTable2_v2(tez);
		b.loadURL("tindiag_utils.php?grd1=true&pelayanan_id="+getIdPel+"&kunjungan_id="+getIdKunj,"","GET");
	}
  }
}
...
//	alert(isIE);
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'txtKodeAsterix_v2';
  	el.setAttribute('disabled', "true");
  }else{
  	el = document.createElement('<input name="txtKodeAsterix_v2" />');
  }
  el.type = 'text';
  //el.id = 'txtSubTot'+(iteration-1);
  el.size = 10;
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'degger_id_v2';
  }else{
  	el = document.createElement('<input name="degger_id_v2"/>');
  }
  el.type = 'hidden';
  el.value = '';
  el.className = 'degger_id2_v2';
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'ms_diagnosa_Asterix_v2';
  }else{
  	el = document.createElement('<input name="ms_diagnosa_Asterix_v2"/>');
  }
  el.type = 'hidden';
  el.value = '';
  el.className = 'ms_diagnosa_Asterix2';
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'ms_diagnosa_Asterix_cdgn_v2';
  }else{
  	el = document.createElement('<input name="ms_diagnosa_Asterix_cdgn_v2"/>');
  }
  el.type = 'hidden';
  el.value = '';
  el.className = 'ms_diagnosa_Asterix2';
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'kode_diagnosa_Asterix_v2';
  }else{
  	el = document.createElement('<input name="kode_diagnosa_Asterix_v2"/>');
  }
  el.type = 'hidden';
  el.value = '';
  el.className = 'kode_diagnosa_Asterix2';
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'txtAsterix_v2';
	el.setAttribute('OnKeyUp', "suggest_Asterix_v2(event,this);");
	el.setAttribute('autocomplete', "off");
  }else{
  	el = document.createElement('<input name="txtAsterix_v2" onkeyup="suggest_Asterix_v2(event, this);" autocomplete="off" />');
  }
  el.type = 'text';
  //el.id = 'txtAsterix'+(iteration-1);
  el.size = 50;
  ...
  if(!isIE){
  	el = document.createElement('input');
  	el.name = 'txtCatatanAsterix_v2';
  	el.setAttribute('OnKeyUp', "AddRow_v2(event,this);");
	//el.setAttribute('readonly', "true");
  }else{
  	el = document.createElement('<input name="txtCatatanAsterix_v2" onkeyup="AddRow_v2(event,this);" />');
  }
  el.type = 'text';
  //el.id = 'txtSubTot'+(iteration-1);
  el.size = 43;
  ...
  if(!isIE){
  	el = document.createElement('img');
  	el.setAttribute('onClick','if (confirm(\'Yakin Ingin Menghapus Data?\')){removeRowFromTable_v2(this);}');
  }else{
  	el = document.createElement('<img name="img" onClick="if (confirm(\'Yakin Ingin Menghapus Data?\')){removeRowFromTable_v2(this);}"/>');
  }
  el.src = '../icon/del.gif';
  el.border = "0";
  el.width = "16";
...
//  cellRight.setAttribute('class', 'tdisi');
  ...
  document.form_icd_rm_v2.txtAsterix_v2[iteration-3].focus();
...
function addRowToTable2_v2(par)
{
//use browser sniffing to determine if IE or Opera (ugly, but required)
	var isIE = false;
	if(navigator.userAgent.indexOf('MSIE')>0){isIE = true;}
...
//	alert(isIE);
  ...
  if(!isIE){
  	el = document.createElement('img');
  	el.setAttribute('onClick','HapusAsterixnya_v2('+par+',this)');
  }else{
  	el = document.createElement('<img name="img" onClick="HapusAsterixnya_v2('+par+',this)"/>');
  }
  el.src = '../icon/del.gif';
  el.border = "0";
  el.width = "16";
...
function addRowToTable3_v2(par)
{
//use browser sniffing to determine if IE or Opera (ugly, but required)
	var isIE = false;
	if(navigator.userAgent.indexOf('MSIE')>0){isIE = true;}
...
function removeRowFromTable_v2(cRow)
{
  var tbl = document.getElementById('tblJual_v2');
  var jmlRow = tbl.rows.length;
  if (jmlRow > 4){
...
function removeRowFromTable2_v2(cRow)
{
  var tbl = document.getElementById('tblJual_v2');
  var jmlRow = tbl.rows.length;
  if (jmlRow > 4){

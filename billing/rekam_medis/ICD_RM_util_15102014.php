...
switch(strtolower($_REQUEST['act'])) {
	...
	if($cek_degger=='1'){	//cek apakah degger & asterix
		  ...
		  if($cekLagi['ms_diagnosa_id'] == '0'){
			...
			(diagnosa_rm_id,catatan,tgl_act,user_act,ms_diagnosa_id_lama,ms_diagnosa_id_baru,diagnosa_id,degger_id)
			SELECT '$id_degger','$txtCatatan',NOW(),'$user_act',ms_diagnosa_id AS ms_diagnosa_id_lama,'$ms_diagnosa_id',diagnosa_id,degger_id FROM b_diagnosa_rm WHERE id = '".$id_degger."' ";
			//echo $sInsert."<br/>";
			mysql_query($sInsert);
				  ...
				  if($arfvalue[0]!=$arfvalue[3]){
					if($arfvalue[2]!=''){	
					  if($arfvalue[0]!=''){
						...
						$sql="insert into b_diagnosa_rm_act
						(diagnosa_rm_id,catatan,tgl_act,user_act,ms_diagnosa_id_lama,ms_diagnosa_id_baru,diagnosa_id,degger_id)
						SELECT '$arfvalue[2]','$arfvalue[1]',NOW(),'$user_act',ms_diagnosa_id AS ms_diagnosa_id_lama,'$arfvalue[0]',diagnosa_id,degger_id FROM b_diagnosa_rm WHERE id = '".$arfvalue[2]."' ";

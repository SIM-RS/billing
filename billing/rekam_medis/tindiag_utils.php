...
if($statusProses=='Error') {
    ...
    if($grd == "true") {
        ...
        , tin.kode,ifnull(p.nama,'-') as dokter,t.ms_tindakan_unit_id,t.user_id,k.nama as kelas, t.type_dokter,t.tgl_act as tanggal, tin.klasifikasi_id, peg.nama AS petugas,IFNULL((SELECT kode_icd_9cm FROM b_tindakan_icd9cm WHERE b_tindakan_id=t.id),'-') icd9cm,IFNULL((SELECT b.STR FROM b_tindakan_icd9cm a LEFT JOIN mrconso b ON a.kode_icd_9cm=b.CODE WHERE b_tindakan_id=t.id),'-') nameicd9cm
	FROM b_tindakan t
...
//		FROM (SELECT d.diagnosa_id AS id,d.ms_diagnosa_id,
///*md.kode,md.nama as nama1,IF(d.diagnosa_manual IS NULL,md.nama,d.diagnosa_manual) AS nama,*/
//IFNULL(md.kode,(SELECT mdrm.kode FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 AND drm.diagnosa_id=d.diagnosa_id)) AS kode,
//IFNULL(md.nama,(SELECT mdrm.nama FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 AND drm.diagnosa_id=d.diagnosa_id)) AS nama1,
//IF(d.diagnosa_manual IS NULL,md.nama,d.diagnosa_manual) AS nama,
//IFNULL((SELECT mdrm.kode FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 and drm.diagnosa_id=d.diagnosa_id),'-') icdrm,
//IF((SELECT drm.ms_diagnosa_id FROM b_diagnosa_rm drm WHERE drm.degger_id = 0 AND drm.diagnosa_id = d.diagnosa_id)!=0,(SELECT drm.ms_diagnosa_id FROM b_diagnosa_rm drm WHERE drm.degger_id = 0 AND drm.diagnosa_id = d.diagnosa_id),d.ms_diagnosa_id) ms_diag_rm,
//IFNULL((SELECT drm.id FROM b_diagnosa_rm drm WHERE drm.degger_id = 0 AND drm.diagnosa_id = d.diagnosa_id),'') id_diag_rm,
//IFNULL((SELECT mdrm.degger FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 AND drm.diagnosa_id=d.diagnosa_id),IFNULL((SELECT mdrm.degger FROM b_ms_diagnosa mdrm WHERE mdrm.id = d.ms_diagnosa_id),'0')) cekdegger,
//d.pelayanan_id,d.user_id,
//p.nama AS dokter,p2.nama AS petugas,d.primer,IF(d.primer=1,'Utama','Sekunder') AS utama,d.akhir,
...
//(SELECT drm.kasus_baru FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 and drm.diagnosa_id=d.diagnosa_id) AS var_kasus_baru,
//DATE_FORMAT(d.tgl_act, '%d-%m-%Y %H:%i:%s') AS tgldiag,
//(SELECT p3.nama FROM b_diagnosa_rm drm INNER JOIN b_ms_pegawai p3 ON p3.id = drm.user_act WHERE drm.degger_id=0 AND drm.diagnosa_id=d.diagnosa_id) AS coder
//FROM b_diagnosa d 
//LEFT JOIN b_ms_diagnosa md ON md.id=d.ms_diagnosa_id
//INNER JOIN b_pelayanan pl ON pl.id = d.pelayanan_id
//INNER JOIN b_ms_pegawai p ON p.id = d.user_id
//INNER JOIN b_ms_pegawai p2 ON p2.id = d.user_act
...
//		*, 1 act,
//		IF(var_kasus_baru=0,'Lama',IF(var_kasus_baru=1,'Baru','-')) AS d_kasus 
//		FROM (SELECT d.b_diagnosa_id AS id,d.ms_diagnosa_id,
///*md.kode,md.nama as nama1,IF(d.diagnosa_manual IS NULL,md.nama,d.diagnosa_manual) AS nama,*/
//IFNULL(md.kode,(SELECT mdrm.kode FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 AND drm.diagnosa_id=d.b_diagnosa_id)) AS kode,
//IFNULL(md.nama,(SELECT mdrm.nama FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 AND drm.diagnosa_id=d.b_diagnosa_id)) AS nama1,
//IF(d.diagnosa_manual IS NULL,md.nama,d.diagnosa_manual) AS nama,
//IFNULL((SELECT mdrm.kode FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 and drm.diagnosa_id=d.b_diagnosa_id),'-') icdrm,
//IF((SELECT drm.ms_diagnosa_id FROM b_diagnosa_rm drm WHERE drm.degger_id = 0 AND drm.diagnosa_id = d.b_diagnosa_id)!=0,(SELECT drm.ms_diagnosa_id FROM b_diagnosa_rm drm WHERE drm.degger_id = 0 AND drm.diagnosa_id = d.b_diagnosa_id),d.ms_diagnosa_id) ms_diag_rm,
//IFNULL((SELECT drm.id FROM b_diagnosa_rm drm WHERE drm.degger_id = 0 AND drm.diagnosa_id = d.b_diagnosa_id),'') id_diag_rm,
//IFNULL((SELECT mdrm.degger FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 AND drm.diagnosa_id=d.b_diagnosa_id),IFNULL((SELECT mdrm.degger FROM b_ms_diagnosa mdrm WHERE mdrm.id = d.ms_diagnosa_id),'0')) cekdegger,
//d.pelayanan_id,d.user_id,
//p.nama AS dokter,p2.nama AS petugas,d.primer,IF(d.primer=1,'Utama','Sekunder') AS utama,d.akhir,
//IF(d.kasus_baru=0,'Lama',IF(d.kasus_baru=1,'Baru','-')) AS d_kasus,
//IF(d.akhir=1,'Ya','Tidak') AS d_akhir,IF(d.klinis=1,'Ya','Tidak') AS klinis,IF(d.banding=1,'Ya','Tidak') AS banding, d.type_dokter, md.dg_kode,mu.nama unit,
//(SELECT drm.kasus_baru FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id=0 and drm.diagnosa_id=d.b_diagnosa_id) AS var_kasus_baru,
//DATE_FORMAT(d.tgl_act, '%d-%m-%Y %H:%i:%s') AS tgldiag,
//'' AS coder
...
//		IF(var_kasus_baru=0,'Lama',IF(var_kasus_baru=1,'Baru','-')) AS d_kasus 
//		FROM (SELECT d.diagnosa_id AS id,d.ms_diagnosa_id,
///*IFNULL(md.kode,mdrm.kode) AS kode,*/
//IFNULL(mdrm.kode,md.kode) AS kode,
//IFNULL(md.nama,mdrm.nama) AS nama1,
//IFNULL(mdrm.nama,md.nama) AS nama2,
//IF(d.diagnosa_manual IS NULL,md.nama,d.diagnosa_manual) AS nama,
//IFNULL(mdrm.kode,'-') icdrm,
//IF(drm.ms_diagnosa_id!=0,drm.ms_diagnosa_id,d.ms_diagnosa_id) ms_diag_rm,
//IFNULL(drm.id,'') id_diag_rm,
//IFNULL(mdrm.degger,IFNULL(mdrm.degger,'0')) cekdegger,
//d.pelayanan_id,d.user_id,
//p.nama AS dokter,p2.nama AS petugas,d.primer,IF(d.primer=1,'Utama','Sekunder') AS utama,d.akhir,
//IF(d.kasus_baru=0,'Lama',IF(d.kasus_baru=1,'Baru','-')) AS d_kasus,
//IF(d.akhir=1,'Ya','Tidak') AS d_akhir,IF(d.klinis=1,'Ya','Tidak') AS klinis,IF(d.banding=1,'Ya','Tidak') AS banding, d.type_dokter, md.dg_kode,mu.nama unit,
//(drm.kasus_baru) AS var_kasus_baru,
//DATE_FORMAT(d.tgl_act, '%d-%m-%Y %H:%i:%s') AS tgldiag,
//(p3.nama) AS coder
//
//FROM b_diagnosa d 
//LEFT JOIN b_ms_diagnosa md ON md.id=d.ms_diagnosa_id
//
//LEFT JOIN (SELECT * FROM b_diagnosa_rm WHERE degger_id=0) drm ON drm.diagnosa_id=d.diagnosa_id
//LEFT JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id
//LEFT JOIN b_ms_pegawai p3 ON p3.id = drm.user_act
//
//INNER JOIN b_pelayanan pl ON pl.id = d.pelayanan_id
//INNER JOIN b_ms_pegawai p ON p.id = d.user_id
//INNER JOIN b_ms_pegawai p2 ON p2.id = d.user_act
//INNER JOIN b_ms_unit mu ON pl.unit_id = mu.id
//WHERE d.kunjungan_id = '".$kunjungan_id."'  GROUP BY d.diagnosa_id) AS gab $filter
//
//UNION
//
//SELECT 
...
//LEFT JOIN b_ms_diagnosa md ON md.id=d.ms_diagnosa_id
//
//LEFT JOIN (SELECT * FROM b_diagnosa_rm WHERE degger_id=0) drm ON drm.diagnosa_id=d.b_diagnosa_id
//LEFT JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id
//LEFT JOIN b_ms_pegawai p3 ON p3.id = drm.user_act
//
//INNER JOIN b_pelayanan pl ON pl.id = d.pelayanan_id
...
//INNER JOIN b_ms_pegawai p2 ON p2.id = d.user_act
//INNER JOIN b_ms_unit mu ON pl.unit_id = mu.id
//WHERE d.kunjungan_id = '".$kunjungan_id."' GROUP BY d.b_diagnosa_id) AS gab $filter
//order by act ASC, $sorting";
...
$sql="SELECT 
		*, 0 act,
		IF(var_kasus_baru=0,'Lama',IF(var_kasus_baru=1,'Baru','-')) AS d_kasus 
		FROM (SELECT * FROM
(SELECT d.diagnosa_id AS id,d.ms_diagnosa_id,
/*IFNULL(md.kode,mdrm.kode) AS kode,*/
IFNULL(mdrm.kode,md.kode) AS kode,
IFNULL(md.nama,mdrm.nama) AS nama1,
IFNULL(mdrm.nama,md.nama) AS nama2,
...
IFNULL(mdrm.degger,IFNULL(mdrm.degger,'0')) cekdegger,
d.pelayanan_id,d.user_id,
p.nama AS dokter,p2.nama AS petugas,IFNULL(drm.primer,d.primer) AS primer,IF(IFNULL(drm.primer=1,d.primer=1),'Utama','Sekunder') AS utama,d.akhir,
IF(d.kasus_baru=0,'Lama',IF(d.kasus_baru=1,'Baru','-')) AS d_kasus,
IF(d.akhir=1,'Ya','Tidak') AS d_akhir,IF(d.klinis=1,'Ya','Tidak') AS klinis,IF(d.banding=1,'Ya','Tidak') AS banding, d.type_dokter, md.dg_kode,mu.nama unit,
(drm.kasus_baru) AS var_kasus_baru,
DATE_FORMAT(d.tgl_act, '%d-%m-%Y %H:%i:%s') AS tgldiag,
...
LEFT JOIN (SELECT * FROM b_diagnosa_rm WHERE degger_id=0 and kunjungan_id = '".$kunjungan_id."') drm ON drm.diagnosa_id=d.diagnosa_id
LEFT JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id
LEFT JOIN b_ms_pegawai p3 ON p3.id = drm.user_act
...
INNER JOIN b_ms_pegawai p2 ON p2.id = d.user_act
INNER JOIN b_ms_unit mu ON pl.unit_id = mu.id
WHERE d.kunjungan_id = '".$kunjungan_id."' and d.banding=0 GROUP BY d.diagnosa_id) AS gab2

UNION

SELECT * FROM
(SELECT drm.diagnosa_id AS id,IFNULL(d.ms_diagnosa_id,drm.ms_diagnosa_id) AS ms_diagnosa_id,
/*IFNULL(md.kode,mdrm.kode) AS kode,*/
IFNULL(mdrm.kode,md.kode) AS kode,
IFNULL(md.nama,mdrm.nama) AS nama1,
IFNULL(mdrm.nama,md.nama) AS nama2,
...
FROM (SELECT * FROM b_diagnosa_rm WHERE degger_id=0 and kunjungan_id = '".$kunjungan_id."') drm 
LEFT JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id
LEFT JOIN b_ms_pegawai p3 ON p3.id = drm.user_act

LEFT JOIN b_diagnosa d ON drm.diagnosa_id=d.diagnosa_id
LEFT JOIN b_ms_diagnosa md ON md.id=d.ms_diagnosa_id

LEFT JOIN b_pelayanan pl ON pl.id = drm.pelayanan_id
LEFT JOIN b_ms_pegawai p ON p.id = d.user_id
LEFT JOIN b_ms_pegawai p2 ON p2.id = d.user_act
LEFT JOIN b_ms_unit mu ON pl.unit_id = mu.id
WHERE drm.kunjungan_id = '".$kunjungan_id."' and drm.banding=0) AS gab2) AS gab $filter
...
SELECT 
		*, 1 act,
		IF(var_kasus_baru=0,'Lama',IF(var_kasus_baru=1,'Baru','-')) AS d_kasus 
		FROM (SELECT * FROM
(SELECT d.b_diagnosa_id AS id,d.ms_diagnosa_id,
/*IFNULL(md.kode,mdrm.kode) AS kode,*/
IFNULL(mdrm.kode,md.kode) AS kode,
IFNULL(md.nama,mdrm.nama) AS nama1,
IFNULL(mdrm.nama,md.nama) AS nama2,
...
LEFT JOIN (SELECT * FROM b_diagnosa_rm WHERE degger_id=0 and kunjungan_id = '".$kunjungan_id."') drm ON drm.diagnosa_id=d.b_diagnosa_id
LEFT JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id
LEFT JOIN b_ms_pegawai p3 ON p3.id = drm.user_act
...
INNER JOIN b_ms_pegawai p2 ON p2.id = d.user_act
INNER JOIN b_ms_unit mu ON pl.unit_id = mu.id
WHERE d.kunjungan_id = '".$kunjungan_id."' and d.banding=0 GROUP BY d.b_diagnosa_id) AS gab2

UNION

SELECT * FROM
(SELECT drm.diagnosa_id AS id,IFNULL(d.ms_diagnosa_id,drm.ms_diagnosa_id_lama) AS ms_diagnosa_id,
/*IFNULL(md.kode,mdrm.kode) AS kode,*/
IFNULL(mdrm.kode,md.kode) AS kode,
IFNULL(md.nama,mdrm.nama) AS nama1,
IFNULL(mdrm.nama,md.nama) AS nama2,
IF(d.diagnosa_manual IS NULL,md.nama,d.diagnosa_manual) AS nama,
IFNULL(mdrm.kode,'-') icdrm,
IF(drm.ms_diagnosa_id_lama!=0,drm.ms_diagnosa_id_lama,d.ms_diagnosa_id) ms_diag_rm,
IFNULL(drm.diagnosa_rm_id,'') id_diag_rm,
IFNULL(mdrm.degger,IFNULL(mdrm.degger,'0')) cekdegger,
drm.pelayanan_id,d.user_id,
p.nama AS dokter,p2.nama AS petugas,IFNULL(drm.primer,d.primer) AS primer,IF(IFNULL(drm.primer=1,d.primer=1),'Utama','Sekunder') AS utama,d.akhir,
IF(d.kasus_baru=0,'Lama',IF(d.kasus_baru=1,'Baru','-')) AS d_kasus,
...
FROM (SELECT * FROM b_diagnosa_rm_act WHERE degger_id=0 and hapus = 1 and kunjungan_id = '".$kunjungan_id."') drm 
LEFT JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id_lama=mdrm.id
LEFT JOIN b_ms_pegawai p3 ON p3.id = drm.user_act

LEFT JOIN b_diagnosa_act d ON drm.diagnosa_id=d.b_diagnosa_id
LEFT JOIN b_ms_diagnosa md ON md.id=d.ms_diagnosa_id
...
ORDER BY act ASC, $sorting";
    ...
    elseif($grdAnamnesa == "true") {	//Anamnese
         $sql = "SELECT a.*, DATE_FORMAT(a.TGL,'%d-%m-%Y %H:%i') AS tgltok, p.nama AS dokter
				...
				WHERE a.PASIEN_ID = '".$_REQUEST['pasien_id']."' and snurs = 0 ORDER BY a.anamnese_id DESC";
    }
...
WHERE b_resep.id_pelayanan = '".$pelayanan_id."' AND b_resep.no_resep='".$_REQUEST['no_resep']."' AND b_resep.apotek_id='".$_REQUEST['apotek_id']."' AND b_resep.tgl='".$_REQUEST['tgl_resep']."'";
        ...
        while ($rows=mysql_fetch_array($rs)) {
		  ...
		  if(mysql_num_rows($rs_an) > 0){
			...
			if($rows["act"]=='0'){
				...
				$icd9rm="<span style='color:#0000FF' title='Klik Untuk Mengubah ICD-9CM' onclick='fSetICD_9CM(".$rows["id"].",".$i.",".$sudah.");'>".$dataicd9cm."</span>";
			}

            $sisip = $rows['id']."|".$rows['ms_tindakan_kelas_id']."|".$rows['ms_tindakan_unit_id']."|".$rwJns['parent_id']."|".$rows['user_id']."|".$rows['kunjungan_id']."|".$rows['unit_act']."|".$rows['type_dokter']."|".$rows['klasifikasi_id'].'|'.$dokter_an.'|'.$rows["icd9cm"].'|'.$rows["nameicd9cm"];
            $i++;
    ...
    elseif($grd1 == "true") {
        while ($rows=mysql_fetch_array($rs)) {
			...
			if($dig==''){
				$dig="-";
				$isiicdrm="xxxicdrm_".$i;
			}else{
				$isiicdrm="xxxicdrm_".$rows[id];
			}
			...
			if($rows["act"]=='0'){
				$icdrm="<div id='Div".$i."' onmouseover='degger(".$i.")'><span style='color:#0000FF' onclick='fSetICD_RM(".$rows["id"].",".$i.",".$ksg.");'>".$dataicdrm."</span></div>";
				$xxxicdrm="<input type='hidden' id='$isiicdrm' value='".$sudah."'>";
				$kasusicdrm="<span style='color:#0000FF' title='Klik Untuk Mengubah Kasus ICD-10' onclick='fSetKasusICD_RM(".$rows["id"].",".$i.",".$ksg.");'>".$datakasusicdrm."</span>";
			}
		...
		$tot = "";
		if($rows['id_diag_rm']!=''){	
		$que2="SELECT drm.id,drm.ms_diagnosa_id,drm.degger_id AS degger,mdrm.kode,mdrm.nama FROM b_diagnosa_rm drm INNER JOIN b_ms_diagnosa mdrm ON drm.ms_diagnosa_id=mdrm.id WHERE drm.degger_id = '".$rows['id_diag_rm']."' order by drm.id";
		//echo $que2;
		$que2=mysql_query($que2);
		$tot=mysql_num_rows($que2);
		while ($isix=mysql_fetch_array($que2)) {
			$isinya .= $isix['id']."**".$isix['ms_diagnosa_id']."**".$isix['kode']."**".$isix['nama']."**".$isix['degger']."***";
			$vb .=	$isix['id']."---";
			$isi .= $isix['kode']." - ".$isix['nama']."<br/>";
		}
			if($isi==''){$isi = "Tidak ada Asterix";}
		}else{$isi = "Tidak ada Asterix";}
			
            $sisip=$rows["id"]."|".$rows['user_id']."|".$rows['ms_diagnosa_id']."|".$rows['type_dokter']."|".$rows['primer']."|".$rows['akhir']."|".$gol_id."|".$gol."|".$isPK."|".$rows['kode']."|".$rows['id_diag_rm']."|".$rows['cekdegger']."|".$rows['ms_diag_rm']."|".$rows['nama2']."|".$tot."|".$isinya."|".$vb."|".$isi."|".$rows['var_kasus_baru'];
            $i++;
			
			$dt.=$sisip.chr(3)."<span $css>".number_format($i,0,",","")."</span>".chr(3)."<span $css>".$rows["tgldiag"]."</span>".chr(3)."<span $css>".$dig."</span>".chr(3)."<span $css>".$xxxicdrm.$icdrm."</span>".chr(3)."<span $css>".$kasusicdrm."</span>".chr(3)."<span $css>".$rows["dokter"]."</span>".chr(3)."<span $css>".$rows["coder"]."</span>".chr(3)."<span $css>".$rows["petugas"]."</span>".chr(3)."<span $css>".$rows["utama"]."</span>".chr(3)."<span $css>".$rows['d_akhir']."</span>".chr(3)."<span $css>".$rows['klinis']."</span>".chr(3)."<span $css>".$rows['banding']."</span>".chr(3)."<span $css>".$rows['unit']."</span>".chr(6);
        }
    }
    elseif($grd2 == "true") {
        while ($rows=mysql_fetch_array($rs)) {

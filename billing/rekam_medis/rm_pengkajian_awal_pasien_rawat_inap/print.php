...
if (isset($_REQUEST['cetak'])) {
    ...
    $data = mysql_fetch_assoc(mysql_query("SELECT * FROM rm_pengkajian_awal_pasien_ri WHERE id = '{$_REQUEST['cetak']}'"));
  ...
  if (isset($_REQUEST['pdf'])) {
    echo '';
    $print_mode = true;
    $data = mysql_fetch_assoc(mysql_query("SELECT * FROM rm_pengkajian_awal_pasien_ri WHERE id = '{$_REQUEST['pdf']}'"));
...
<div style="border:1px solid black">
	<table>
		<tr>
			<td colspan="2">Tanggal Masuk Ruang Rawat : <?=input($arr_data[$i-1], "data_{$i}", "date", "", "");$i++;?> (Perawat)</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>: <?=input($arr_data[$i-1], "data_{$i}", "date", "", "width:250px");$i++;?>  </td>
		</tr>
		<tr>

...
function showICD_RM(){
	...
	if(document.getElementById('spn_ICD_RM').innerHTML=='ok'){
		if (document.getElementById('lgn_icd').innerHTML=="Kode ICD X"){
			zxc = '<div class="overout" onmouseover="degger('+document.getElementById('id_diagnosa_ICD_RM').value+')"><span style="color:#0000FF" title="Klik Untuk Mengubah ICD-10" onclick="fSetICD_RM('+document.getElementById('id_diagnosa_ICD_RM').value+','+document.getElementById('barisx').value+');">'+document.getElementById('kode_diagnosa_ICD_RM').value+'</span></div>';

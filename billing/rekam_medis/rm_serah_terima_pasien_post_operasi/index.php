...
<html lang="en">
  <head>
    ...
    <title> Form serah terima pasien post operasi </title>
  ...
  <body>
    <div  style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
          ...
          <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
                <tbody><tr>
                    <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form serah terima pasien post operasi</td>
...
echo "<td>".$data['tgl_op']."</td>"; 
echo "<td>".$data['tindakan']."</td>";  
echo "<td>".$data['petugas_recovery_yang_menyerahkan']."</td>"; 
echo "<td>".$data['petugas_ruangan_yang_menerimah']."</td>"; 

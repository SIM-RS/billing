<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_12_2_resiko_jatuh_morse_fall_scale WHERE id = '{$_REQUEST['id']}'");
...
<body>
    <div align="center">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            <tr>
                <td height="30">&nbsp;RM 12.3 ASESMEN RESIKO JATUH MORSE FALL SCALE</td>
            </tr>
        </table>
    ...
    <script>
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM ASESMEN RESIKO JATUH MORSE FALL SCALE");
            ...
            gridTarifDokter.baseURL("../function/grid_2.php?namaTable=rm_12_2_resiko_jatuh_morse_fall_scale&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

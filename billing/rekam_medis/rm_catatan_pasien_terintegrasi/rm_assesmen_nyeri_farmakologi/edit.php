...
<head>
  ...
  <title> Form Edit Assesmen Nyeri Farmakologi </title>
...
<body>
  ...
  <div style="background-color: #EAF0F0 ; width: 1000px; margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form Edit Assesmen Nyeri Farmakologi</td>
                  ...
                  foreach ($one as $data) { ?>
                    ...
                    <div class='row'>
                      <div class="col">
                        ...
                        <input type="text" class="form-control" id="ruangan" name='ruangan' placeholder='ruangan' value="<?php echo $data['ruangan']; ?>" required>
                      </div>

                      <div class="col">
                        <label for="intervensi_yang_diberikan"> intervensi yang diberikan:</label>
                        <input type="text" class="form-control" id="intervensi_yang_diberikan" name='intervensi_yang_diberikan' value="<?php echo $data['intervensi_yang_diberikan']; ?>">
                      </div>
                    </div>
                    <br>
                    <br>
                    <div class='row'>
                      <div class="col">
                        ...
                        <input type="text" class="form-control" id="skala_nyeri_pertama" name='skala_nyeri_pertama' value="<?php echo $data['skala_nyeri_pertama']; ?>">
                      ...
                      <div class="col">
                        ...
                        <input type="text" class="form-control" id="skala_nyeri_kedua" name='skala_nyeri_kedua' value="<?php echo $data['skala_nyeri_kedua']; ?>">
                      </div>
                    </div>

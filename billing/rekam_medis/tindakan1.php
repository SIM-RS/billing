<table width="850" border="0" cellpadding="0" cellspacing="1" align="center">
    <tr>
        ...
        <td width="35%" align="right"><div id="divLab"><input id="nomorLab" name="nomorLab" size="10" class="txtinput" readonly="readonly"/></div>&nbsp;&nbsp;&nbsp;</td>
        <td width="5%">&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td><select id="cmbDokTind" name="cmbDokTind" class="txtinput" onkeypress="setDok('btnSimpanTind',event);">
    ...
    <tr>
        <td>&nbsp;</td>
        <td colspan="3">
            <div id="gridboxTind" style="width:850px; height:170px; background-color:white;"></div>
            <br/>

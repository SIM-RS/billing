...
<?php endif; ?>
  ...
  <table border="1px" class="text-left" style="width:100%">
          ...
          <div class="col-6">
            <table>
              <tr>
                ...
                <td>:</td>
                <td><?php
                  if (dataKunjungan()['tgl_pulang_ak'] == "") {
                    echo input($arr_slide1[$i-1], "slide1_{$i}", "date", "");$i++;
                  } else {
                    echo dataKunjungan()['tgl_pulang_ak'];
                  }
                ?></td>
              </tr>
              <tr>
          ...
          <div class="col-6">
            <table>
              <tr>
                ...
                <td>
                  <?php
                    if ($dataPasien['nama_ortu'] != "" && $dataPasien['nama_suami_istri'] != "") {
                      echo $dataPasien['nama_ortu'] . "/" . $dataPasien['nama_suami_istri'];
                    } elseif($dataPasien['nama_ortu'] == "" && $dataPasien['nama_suami_istri'] != "") {
                      echo $dataPasien['nama_suami_istri'];
                    } elseif($dataPasien['nama_ortu'] != "" && $dataPasien['nama_suami_istri'] == "") {
                      echo $dataPasien['nama_ortu'];
                    }
                  ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <?php if ($dataPasien["sex"] == "L"): ?>
                    ...
                    <input checked type='radio'>&nbsp;Laki-Laki&emsp;
                    <input type='radio' disabled="true">&nbsp;Perempuan<br>
                    <span class='text-right'>Male</span>&emsp;&emsp;&emsp;&emsp;&nbsp;<span>Female</span>

                  <?php else: ?>

                    <input disabled="true" type='radio'>&nbsp;Laki-Laki&emsp;
                    <input checked type='radio'>&nbsp;Perempuan<br>
                    <span class='text-right'>Male</span>&emsp;&emsp;&emsp;&emsp;&nbsp;<span>Female</span>
          ...
          <div class="col-6">
            <table>
              <tr>
                ...
                <td>:</td>
                <td>
                  <?php if (dataKelas()['nama'] != "" && dataKelas()['nama_kmr'] != ""): ?>
                    <?= dataKelas()['nama']; ?> / <?= dataKelas()['nama_kmr']; ?>
                  <?php elseif (dataKelas()['nama'] == "" && dataKelas()['nama_kmr'] != ""): ?>
                    <?= dataKelas()['nama_kmr']; ?>
                  <?php else: ?>
                    <?= dataKelas()['nama']; ?>
                  <?php endif ?>
    ...
    <tr>
      <td>
        Diagnosis Primer ( Primary Diagnose) :<br>
        <?php while ($dataDiag = mysql_fetch_assoc($MyDataDiag['primer'])): ?>
          <?= $dataDiag['tgl_act'] . " ~ " . $dataDiag['nama'] . "<br>"; ?>
        <?php endwhile; ?>
      </td>
      <td>Kode ICD 10 :<br><?=input($arr_slide1[$i-1], "slide1_{$i}", "text", "");$i++;?></td>
    </tr>
    <tr>
      <td>Diagnosis Sekunder & Diagnosis Penyerta ( Secondary Diagnose & Comorbid Diagnose)  :<br>
        <?php while ($dataDiag = mysql_fetch_assoc($MyDataDiag['sekunder'])): ?>
          <?= $dataDiag['tgl_act'] . " ~ " . $dataDiag['nama'] . "<br>"; ?>
        <?php endwhile; ?>
      </td>
      <td>Kode ICD 10 :<br><?=input($arr_slide1[$i-1], "slide1_{$i}", "text", "");$i++;?></td>
...
<?php elseif (isset($_REQUEST['id'])): ?>
  ...
  <a target="_blank" href='index.php?<?= "idKunj={$_REQUEST['idKunj']}&idPel={$_REQUEST['idPel']}&idPasien=&idUser={$_REQUEST['idUser']}&tmpLay=&cetak={$check['id']}" ?>' class="btn btn-primary text-center m-2">Cetak</a>
      <a target="_blank" href='index.php?<?= "idKunj={$_REQUEST['idKunj']}&idPel={$_REQUEST['idPel']}&idPasien=&idUser={$_REQUEST['idUser']}&tmpLay=&pdf={$check['id']}" ?>' class="btn btn-primary text-center m-2">Cetak PDF</a>

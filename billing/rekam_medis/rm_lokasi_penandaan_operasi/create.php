...
<head>
  ...
  <title> Form Input lokasi penandaan operasi </title>
...
<body>
  ...
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form Input lokasi penandaan operasi </td>
              ...
              <div class='container-fluid'>
                ...
                <form action='func.php?<?= $idKunj ?>&idPel=<?= $idPel ?>&idPasien=<?= $idPasien ?>&idUser=<?= $idUser ?>' method='POST'>
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="prosedur" name='prosedur' placeholder='prosedur' required></textarea>
                  </div>

                  <div class="form-group">
                    <label for="tanggal_prosedur"> Tanggal prosedur:</label>
                    <input type="date" class="form-control" id="tanggal_prosedur" name='tanggal_prosedur' placeholder='tanggal_prosedur' required>
                  </div>

...
<head>
  ...
  <title> Form Penadaan Lokasi Operasi</title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form lokasi penandaan operasi</td>
              ...
              <div class='container-fluid'>
                ...
                <div class='table-responsive'>
                  <table class='table table-hover table-bordered table-striped' style='background-color: white;'>
                    ...
                    <tbody>
                      <?php
                      $getwhere = GetWhere($idKunj, $idPasien);
                      $no = 1;
                      if (isset($getwhere)) {
                        foreach ($getwhere as $data) {
                          echo "<tr align='center'>";
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $data['prosedur'] . "</td>";
                          echo "<td>" . $data['tanggal_prosedur'] . "</td>";

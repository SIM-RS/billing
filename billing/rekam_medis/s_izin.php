        ...
        <table width="500" border="0" cellspacing="0" cellpadding="0" align="left" class="kwi">
            ...
            <tr class="kwi">
                <td height="30" colspan="2" align="center" style="font-weight:bold;font-size:13px">
                    <u>&nbsp;Surat Keterangan <? echo $jns1;?></u></td>
            </tr>
            <tr class="kwi">
                <td height="30" colspan="2" align="left" style="font-weight:bold;font-size:13px">
                    &nbsp;Menerangkan Bahwa :&nbsp;
                </td>
            </tr>
            <tr class="kwi">
                <td colspan="2">
                    ...
                    <tr>
                            <td width="11%" style="font-size:12px">Nama</td>
                            ...
                            <td width="30%" style="font-size:12px">&nbsp;<?php echo $rw['no_rm'];?><?php //echo strtolower($rw['tgl_lahir']);?></td>
                    </tr>
                    <tr>
                            <td width="11%" style="font-size:12px">Umur</td>
                            <td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px">&nbsp;<?php echo $rw['umur_thn'];?></td>
                            <td width="20%" style="font-size:12px">Jenis Kelamin</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td width="30%" style="font-size:12px">&nbsp;<?php echo strtolower($rw['sex']);?></td>
                    </tr>
                    <tr>
                            <td width="20%" style="font-size:12px">Pangkat / Golongan</td>
                            <td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px">&nbsp;<?php echo $rw['nm_pangkat'];?></td>
                            <td width="10%" style="font-size:12px">NRP/NIP</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td width="30%" style="font-size:12px">&nbsp;<?php echo $rw['nip'];?></td>
                    </tr>
                    <tr>
                            <td width="11%" style="font-size:12px">Kesatuan</td>
                            <td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px" colspan="4">&nbsp;<?php echo $rw['nama_satuan'];?></td>
                            <!--<td width="10%" style="font-size:12px">No. RM</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>
                    ...
                    <tr>
                            ...
                            <td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px" colspan="4">&nbsp;<?php echo strtolower($rw['alamat']);?></td>
                            <!--<td width="10%" style="font-size:12px">Unit</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td width="30%" style="font-size:12px">&nbsp;<?php echo $rw['nmUnit'];?></td>-->
                    </tr>
                    <tr>
                            <td width="11%" style="font-size:12px" colspan="6">Memerlukan <? echo $jns1;?> selama :</td>
                            <!--<td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                     ...
                     <tr>
                            <td width="11%" style="font-size:12px" colspan="6">(<? echo $jml;?>) Hari karena sakit terhitung dari tanggal</td>
                            <!--<td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px">&nbsp;<?php echo strtolower($rw['alamat']);?></td>-->
                            <!--<td width="10%" style="font-size:12px">Unit</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>
                    ...
                    <tr>
                            <td width="11%" style="font-size:12px" colspan="6"><?php echo $rw['tgl1'];?> s/d <?php echo $rw['tgl2'];?></td>
                            <!--<td width="2%" align="center" style="font-weight:bold;font-size:12px">:</td>
                            <td style="font-size:12px">&nbsp;<?php echo strtolower($rw['alamat']);?></td>-->
                            <!--<td width="10%" style="font-size:12px">Unit</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:12px">:</td>
			...
			?>
                ...
                <center>Dokter yang Memeriksa</center><br/>&nbsp;<br/>&nbsp;<br/>&nbsp;<br/><center>(<?php echo $rw['dok_rujuk'];?>)</center></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>

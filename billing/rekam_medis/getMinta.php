...
$sqlb="SELECT * FROM dbapotek_tangerang.a_unit WHERE unit_billing = $idunit";
...
$sql="SELECT * FROM (SELECT * FROM dbapotek_tangerang.a_minta_obat WHERE unit_id=$idbaru AND MONTH(tgl)=$bulan AND YEAR(tgl)=$th2 AND no_bukti LIKE '$kodeunit/UP/$th2-$th1/%') AS t1 ORDER BY no_bukti DESC LIMIT 1";
//echo $sql."<br>";
$rs1=mysql_query($sql);

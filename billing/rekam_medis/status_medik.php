                ...
                <fieldset><!--legend id="lgnJudul"></legend-->
                    <table border=0 width="380px">
						<tr id="radioCheck">
							<td width="38%">&nbsp;</td>
							<td>
								<!-- input type="checkbox" name="dokterc" id="dokterc" onclick="edokter(this.checked)" /><label for="dokterc">Dokter</label-->
								<input type="radio" name="dokterc" id="dokterc" value="1" onclick="edokter(this.value)" /><label for="dokterc">Dokter</label>
								<input type="radio" name="dokterc" id="dokterc2" value="2" onclick="edokter(this.value)" /><label for="dokterc2">Managemen</label>
							</td>
						</tr>
                        <tr id="rwJnsLay">
                        ...
                        <fieldset>
                            <table width="75%" align="center">
                                <tr id="trTgl">
									...
									<!-- <td height="30">Flag</td> -->
                                    <td align="center">:</td>
                                    <td>
									<input type="hidden" disabled class="txtinputreg" name="flag" id="flag" size="5" tabindex="3" value="<?php echo $flag; ?>"/>&nbsp;
                                    </td>
                                </tr>
                    ...
                    <td colspan="2">
                        <fieldset>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
								...
								<tr>
									<td>
										<div id="kotak" style="background:#B300B9; margin-right:10px;"></div>Buku status telah keluar <br />
...
<script type="text/JavaScript" language="JavaScript">
	...
	function cetak_label()
	{
		...
		var cIdKunj = document.getElementById('kunjungan_id').value;
		var cIdPas = document.getElementById('pasien_id').value;
		
		if (cIdKunj==""){
			alert("Pilih Kunjungan Pasien Terlebih Dahulu !");
		}else{
			window.open('../loket/cetakLabelP.php?idPas='+cIdPas+'&idKunj='+cIdKunj+'&userId=<?php echo $userId;?>','','height='+h1+',width='+w1+',top='+TopPosition+',left='+LeftPosition+',scrollbars='+scroll+',resizable');
		}
		//batal();
	}
	...
	function batal(){
		...
		// alert('batal');
		document.getElementById('dokterc').checked = false;
		document.getElementById('dokterc2').checked = false;
		document.getElementById('statusKlik').value="";
		document.getElementById('chkDokterPengganti').checked = false;
		// document.querySelector('input[name="dokterc"]').checked = false;
		isiCombo('JnsLayanan','','','',showTmpLay);
	}
	...
	function simpan(sts){
		if(confirm('Yakin ?')){
			...
			// var dipinjam = document.getElementById('dokterc').checked;
			var dipinjam = (sts == 2) ? document.querySelector('input[name="dokterc"]:checked').value : 0;
			...
			var parDokter = '';
			if(sts==2){
				parDokter = '&dokterId='+dokterId+'&dipinjam='+dipinjam+'&pengganti='+a;
			}

...
<head>
  ...
  <title> Form Dugaan Reaksi Transfusi</title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp; Form Dugaan Reaksi Transfusi</td>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $data['jenis_komponen_darah'] . "</td>";
                          echo "<td>" . $data['golongan_darah'] . "</td>";
                          echo "<td>" . $data['perkiraan_vol_transfusi'] . "</td>";

                          echo "<td>" . $data['gejala_tanda_klinis'] . "</td>";

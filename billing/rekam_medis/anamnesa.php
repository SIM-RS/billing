...
<fieldset>
    ...
    <tr>
            <td colspan="4">Nama Pasien&nbsp;:&nbsp; <label id="nmPA" class="nmPA"></label>&nbsp;:&nbsp;
            No RM&nbsp;:&nbsp; <label id="nmRM" class="nmRM"></label>
            </td>
        </tr>
        <tr>
            <td colspan="4">Umumr&nbsp;:&nbsp; <label id="umrPA" class="umrPA"></label>&nbsp;&nbsp;
            <br />
            Alamat&nbsp;:&nbsp; <label id="almt" class="almt"></label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="border-top:1px solid black; padding-top:5px; text-decoration:underline;">II. PEMERIKSAAN FISIK333</td>
        </tr>
        <tr>
            <td colspan="4">
                <table width="100%">
                             ...
                             <div id="pNeurologi" align="center" style="overflow:auto;height:0px;">
                        		<table width="100%">
                                    <tr>
                                        ...
                                        <td id="ab">Tanda Rangsangan Meningeal</td>
                                        <td id="ab">&nbsp;<input type="radio" id="pup3" class="pup3" name="pupil2" onclick="cekR(pup3)" />Dbn <br />
                                                    ...
                                                    &nbsp;<input type="radio" id="pup6" class="pup6" name="pupil2" onclick="cekR(pup6)" />Karning <input type="text" id="karningP" class="karningP" value="" disabled="disabled" /> <br />
                                        </td>                                            
                                    </tr>
                                    <tr>
                                        <td>Nervus Craniales</td>
                                        ...
                                        <td id="ab">Refek Patologis</td>
                                        <td id="ab">&nbsp;<textarea id="cmbPatologis" name="cmbPatologis" cols="35"></textarea>
                                        </td>                                            
                                    </tr>
                                    <tr>
                                        <td>Sensorik</td>
                                        <td>&nbsp;<input type="radio" id="pup9" class="pup9" name="pupil4" onclick="cekR(pup10)" /> Dbn<br />
                                        ...
                                        <td id="ab">Otonom</td>
                                        <td id="ab">&nbsp;<textarea id="cmbOtonom" name="cmbOtonom" cols="35"></textarea>
                                        </td>                                            
                                    </tr>
                                    <tr>
                                        <td>Pemeriksaan Khusus</td>
                                        <td>&nbsp;<textarea id="cmbPKhusus" name="cmbPKhusus" cols="35"></textarea>
                                        </td>
                                        <td id="ab"></td>
                                        <td id="ab"></td>                                            
                                    </tr>

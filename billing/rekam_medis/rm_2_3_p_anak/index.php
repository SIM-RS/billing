<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_2_3_p_anak WHERE id = '{$_REQUEST['id']}'");
...
<body>
        ...
        <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="tabel">
            ...
            <tr>
                <td align="left">
					...
					<a target="_blank" href="form.php?idKunj=<?= $_REQUEST['idKunj'] ?>&idPel=<?= $_REQUEST['idPel'] ?>&idPasien=&idUser=<?= $_REQUEST['idUser'] ?>&tmpLay=<?= $_REQUEST['tmpLay'] ?>"><button type="button"><img src="../../icon/add.gif" width="16" height="16">Tambah</button></a><br><br>
  ...
  spawn();
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM P. BEDAH");
            ...
            gridTarifDokter.baseURL("../function/grid.php?namaTable=rm_2_3_p_anak&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

...
<head>
  ...
  <title> Form dokumen pelayanan kamar </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form dokumen pelayanan kamar</td>
              ...
              <div class='container-fluid'>
                ...
                <div class='table-responsive'>
                  <table class='table table-sm table-hover table-bordered table-striped' style='background-color: white;'>
                    <h6>Laporan pelayanan kamar operasi</h6>
                    <thead>
                      <tr align='center'>
                        <th>No</th>

                        <th>Ruang pemulihan</th>
                        <th>Ruangan</th>
                        <th>Keterangan</th>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $data['laporan_operasi_ruang_pemulihan'] . "</td>";
                          echo "<td>" . $data['laporan_operasi_ruangan'] . "</td>";
                          echo "<td>" . $data['laporan_operasi_keterangan'] . "</td>";

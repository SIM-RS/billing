...
{	
	$i++;
	$proses = "<a href='rpinjam_obat.php?no_bukti=".$rows['no_bukti']."&unit_tujuan=".$rows['UNIT_NAME']."&sunit=".$unit_id."&user=".$iduser."'><img src='../icon/lihat.gif' border='0' width='16' height='16' align='absmiddle' title='Klik Untuk Melihat Detail'></a>";

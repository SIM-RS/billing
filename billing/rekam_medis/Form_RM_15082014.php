...
// ===============================================================================================================================
		...
		function showGrid(){
			...
			b.setColHeader("NO,TANGGAL,DIAGNOSA,ICD-10 [RM],DOKTER,PRIORITAS,KASUS,AKHIR,KLINIS,BANDING,UNIT");
			b.setIDColHeader(",,nama,icdrm,dokter,,,,,,");
			b.setColWidth("30,100,240,80,200,80,100,70,70,70,70");
			b.setCellAlign("center,center,left,center,left,center,center,,center,center,center,center");
			b.setCellHeight(20);
			b.setImgPath("../icon");
		...
		function detail(i){
			...
			if(batalKunj == 1){
				jQuery('#batalKunjungan').html('Pasien Batal Berkunjung Ke '+tmpLayanan);
			} else {
		...
		function filterNoRM(ev,par){
			if(ev.which==13){
				...
				var no_rm=document.getElementById('txtFilter').value;
				var cmbKunjungan=document.getElementById('cmbKunjungan').value;
				var url = "RM_utils.php?act=view&grd=true&tgl="+tgl+"&no_rm="+no_rm+"&cmbKunjungan="+cmbKunjungan;
				a1.loadURL(url,"","GET");
			}
		}

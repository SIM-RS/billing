<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_2_4_p_obgin WHERE id = '{$_REQUEST['id']}'");
...
<body>
    <div align="center">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            <tr>
                <td height="30">&nbsp;RM 2.4 P. OBGIN</td>
            </tr>
        </table>
        <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="tabel">
            ...
            <tr>
                <td align="left">
                    ...
                    <a style="color: white;" target="_blank" href="tb_obgin/index.php?idKunj=<?= $_REQUEST['idKunj'] ?>&idPel=<?= $_REQUEST['idPel'] ?>&idPasien=&idUser=<?= $_REQUEST['idUser'] ?>&tmpLay=<?= $_REQUEST['tmpLay'] ?>"><button type="button"><img src="../../icon/edit.gif" width="16" height="16">Edit Tabel</button></a>
                    <br><br>
    ...
    <script>
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM P. OBGIN");
            ...
            gridTarifDokter.baseURL("../function/grid_obgin.php?namaTable=rm_2_4_p_obgin&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

<?php
    ...
    if (isset($_REQUEST["id"])) {
        mysql_query("DELETE FROM rm_21_13_laporan_anestesi WHERE id = '{$_REQUEST['id']}'");
...
<body>
    <div align="center">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
            <tr>
                <td height="30">&nbsp;RM 21.13 LAPORAN ANESTESI</td>
            </tr>
        </table>
    ...
    <script>
        ...
        function spawn(){
            ...
            gridTarifDokter.setHeader("RM LAPORAN ANESTESI");
            ...
            gridTarifDokter.baseURL("../function/grid_4.php?namaTable=rm_21_13_laporan_anestesi&idPasien="+<?= $dataPasien['id'] ?>+"&idKunj="+<?= $_REQUEST['idKunj'] ?>+"&idPel="+<?= $_REQUEST['idPel'] ?>+"&idUser="+<?= $_REQUEST['idUser'] ?>+"&tmpLay="+<?= $_REQUEST['tmpLay'] ?>);

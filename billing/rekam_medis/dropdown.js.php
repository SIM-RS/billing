...
function mmLoadMenus() {
  ...
  if($rwSub['tipe']==1){
  ?>
  mm_menu_0814123211_4_<?php echo $no_m; ?>.addMenuItem("<?php echo $rwSub['nomor_dokumen']; ?><?php echo $rwSub['nama']; ?>","load_popup_iframe('<?php echo $rwSub['legend']; ?>','<?php echo $rwSub['link']; ?>?report=1')");
  <?php
  }
  ...
  ?>
  mm_menu_0814123211_4_<?php echo $no_m; ?>.addMenuItem("<?php echo $rwSub['nomor_dokumen']; ?><?php echo $rwSub['nama']; ?>","<?php echo $rwSub['link']; ?>?report=1");
  <?php
  }
  $no_s++;
  }

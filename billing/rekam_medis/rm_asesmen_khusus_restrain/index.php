...
<html lang="en">
  <head>
    ...
    <title> Form asesmen khusus restrain </title>
  ...
  <body>
    <div  style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
          ...
          <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
                <tbody><tr>
                    <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form  asesmen khusus restrain</td>
...
<a href='create.php?idKunj=<?=$idKunj?>&idPel=<?=$idPel?>&idPasien=<?=$idPasien?>&idUser=<?=$idUser?>' class='btn btn-primary' style="color: white;">Tambah</a>
    ...
    if(!empty($_SESSION['message'])){ ?>
      ...
      <?php unset($_SESSION['message']); unset($_SESSION['mType']); ?>
    <?php } ?>
    
    <br>
    <div class='table-responsive'>
    <table class='table table-sm table-hover table-bordered table-striped' style='background-color: white;'>
    <thead>
      <tr align='center'>
      <th>No</th>
<th>Hasil observasi</th> 
<th>Pertimbangan klinis</th> 
<th>Restrain non farmakologi</th> 
<th>Restrain farmakologi</th> 

<th>Pendidikan restrain keluarga</th> 
...
echo "<td>".$data['hasil_observasi']."</td>"; 
echo "<td>".$data['pertimbangan_klinis']."</td>"; 
echo "<td>".$data['restrain_non_farmakologi']."</td>"; 
echo "<td>".$data['restrain_farmakologi']."</td>"; 
echo "<td>".$data['pendidikan_restrain_keluarga']."</td>"; 

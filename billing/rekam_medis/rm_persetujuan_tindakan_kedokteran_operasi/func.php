...
function GetAll($idKunj, $idPasien)
{
  ...
  $query = "SELECT * FROM rm_persetujuan_tindakan_kedokteran_operasi WHERE id_kunjungan = '$idKunj' AND id_pasien ='$idPasien'";
...
function GetOne($id)
{
  ...
  $query = "SELECT * FROM  `rm_persetujuan_tindakan_kedokteran_operasi` WHERE  `id` =  '$id'";
  $exe = mysql_query($query);
  while ($data = mysql_fetch_array($exe)) {
    $datas[] = array(
      'id' => $data['id'],
...
function Insert()
{
  ...
  $query = "INSERT INTO `rm_persetujuan_tindakan_kedokteran_operasi` (`id`,`dokter_pelaksana_tindakan`,`pemberi_informasi`,`penerima_informasi`,`diagnosis_wd_dan_dd`,`dasar_diagnosis`,`tindakan_kedokteran`,`indikasi_tindakan`,`tata_cara`,`tujuan`,`risiko`,`komplikasi`,`prognosis`,`alternatif_risiko`,`lain_lain`,`id_kunjungan`,`id_pelayanan`,`id_pasien`,`id_user`, `tgl_act`)
VALUES (NULL,'$dokter_pelaksana_tindakan','$pemberi_informasi','$penerima_informasi','$diagnosis_wd_dan_dd','$dasar_diagnosis','$tindakan_kedokteran','$indikasi_tindakan','$tata_cara','$tujuan','$risiko','$komplikasi','$prognosis','$alternatif_risiko','$lain_lain','$id_kunjungan','$id_pelayanan','$id_pasien','$id_user', NULL)";
  $exe = mysql_query($query);
  if ($exe) {
    // kalau berhasil
...
function Delete($id)
{
  ...
  $query = "DELETE FROM `rm_persetujuan_tindakan_kedokteran_operasi` WHERE `id` = '$id'";
  $exe = mysql_query($query);
  if ($exe) {
    // kalau berhasil

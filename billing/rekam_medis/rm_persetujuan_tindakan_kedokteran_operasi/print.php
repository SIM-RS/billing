...
<head>
    ...
    <title> Persetujuan Tindakan Kedokteran Operasi </title>
...
left join b_ms_wilayah a on a.id=p.prop_id where p.id='" . $idPasien . "' ";
        ...
        <div class="box-pasien" style="float: right; padding-right: 0px;">
            <p align='right' style="margin: 0px;;">RM 21/PHCM</p>
        ...
        <hr style="margin:0px; padding:0px; margin-top:13px;">
        ...
        <center>
            ...
            <div class='container'>
                ...
                <table border="1" align="center" cellpadding="5" style="width: 210mm;">
                    <tbody>
                        <tr>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div>
                                <p align="center">
                                    <strong>PERSETUJUAN TINDAKAN KEDOKTERAN </strong>
                    ...
                    <tr>
                        <td width="678" valign="top">
                            ...
                            <p>
                                <strong>Dengan Ini Menyatakan SETUJU Dilakukan Tindakan / Pengobatan </strong>
    ...
    function pdf() {
      const pdf = document.getElementById("pdf-area");
          var opt = {
              margin: 0,
              filename: "RM 21 <?=$rwPasien['nama'];?>.pdf",

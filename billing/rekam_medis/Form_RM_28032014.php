...
// ===============================================================================================================================
		...
		function saring(){
			...
			if(document.getElementById('chkHistory').checked){
				...
				url = "RM_utils.php?grd=true&tgl="+tgl+"&no_rm="+no_rm+"&cmbKunjungan="+cmbKunjungan+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			}
			a1.loadURL(url,"","GET");
		}
...
function resumeMedis(){
	...
	if(document.getElementById('cmbKunjungan').value=='1'){

...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo getProtokol().$_SERVER['SERVER_NAME'].$base_addr."/billing/theme/print.css" ?>" />
...
-->
			<?php
				$sql ="SELECT hr.*,mp.nama from b_hasil_rad hr left JOIN b_ms_pegawai mp 
			ON mp.id = hr.user_id 

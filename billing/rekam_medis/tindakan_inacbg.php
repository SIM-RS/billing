<table width="850" border="0" cellpadding="0" cellspacing="1" align="center">
    ...
    <tr>
        ...
        <td colspan="2"><input name="mtId" id="mtId" type="hidden">
            <input name="tindakan_id" id="tindakan_id" type="hidden">
            <input id="tindakan_nama" name="tindakan_nama" size="80" onKeyUp="suggest1(event,this);" autocomplete="off" class="txtinput">
		  	<input type="button" class="txtinput" value="cari" onclick="suggest1('cariTind',this);" >
            <div id="divtindakanINACBG" align="left" style="position:absolute; z-index:1; height: 230px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC;"></div>
	   </td>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr style="display:none;">
	 ...
	 <tr>
        ...
        <td><input id="txtQty" name="txtQty" type="text" size="3" class="txtcenter"/>
	   </td>
        <!--td colspan="2">&nbsp;</td-->
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><select id="cmbDokTind" name="cmbDokTind" class="txtinput" onkeypress="setDok('btnSimpanTind',event);" onchange="cekDokter();">
    ...
    <tr>
        ...
        <td align="center" height="28">
            ...
            <input type="button" id="btnSimpanTindINACBG" name="btnSimpanTindINACBG" value="Tambah" onclick="simpan(this.value,this.id,'txtTind');" class="tblTambah"/>
            <input type="button" id="btnHapusTindINACBG" name="btnHapusTindINACBG" value="Hapus" onclick="hapus(this.id);" disabled="disabled" class="tblHapus"/>
            <input type="button" id="btnBatalTindINACBG" name="btnBatalTindINACBG" value="Batal" onclick="batal(this.id)" class="tblBatal"/></td>
        <td>&nbsp;</td>
    </tr>
    <!--tr>
            <td>&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;</td>
        <td colspan="3">
            <div id="gridboxTindINACBG" style="width:850px; height:150px; background-color:white;"></div>
            <br/>
            <div id="pagingTindINACBG" style="width:850px;"></div>
        </td>
        <td>&nbsp;</td>
    </tr>
</table>

<?php
	...
	$dataP = mysql_fetch_assoc(mysql_query("SELECT nama FROM b_ms_pegawai WHERE id = '{$_REQUEST['idUser']}'"));


if (isset($_REQUEST['cetak'])) {
    header("Location:print.php?cetak={$_REQUEST['cetak']}&idKunj={$_REQUEST['idKunj']}&idPel={$_REQUEST['idPel']}&idUser={$_REQUEST['idUser']}&idPasien={$_REQUEST['idPasien']}&tmpLay={$_REQUEST['tmpLay']}");
  }

  if (isset($_REQUEST['pdf'])) {
    header("Location:print.php?pdf={$_REQUEST['pdf']}&idKunj={$_REQUEST['idKunj']}&idPel={$_REQUEST['idPel']}&idUser={$_REQUEST['idUser']}&idPasien={$_REQUEST['idPasien']}&tmpLay={$_REQUEST['tmpLay']}");
  }

  if (isset($_REQUEST['id'])) {
	header("Location:edit.php?id={$_REQUEST['id']}&idKunj={$_REQUEST['idKunj']}&idPel={$_REQUEST['idPel']}&idUser={$_REQUEST['idUser']}&idPasien={$_REQUEST['idPasien']}&tmpLay={$_REQUEST['tmpLay']}");
  }
...
<br>
        ...
        <ul>
            <li>
                Nama :
				<?=input($pasien['nama'], "data_{$i}", "text", "", "height:20px;", "");$i++;?>
            </li>
            <li>
                Umur/Jenis Kelamin : <?=input($y, "data_{$i}", "text", "", "height:20px;", "");$i++;?> tahun, &nbsp;

                <?php
                if ($pasien['sex'] == 'L') { ?>
				<?=input("Laki-Laki", "data_{$i}", "text", "", "height:20px;", "");$i++;?>
				<?php 
                } else { ?>
                <?=input("Wanita", "data_{$i}", "text", "", "height:20px;", "");$i++;?>
				<?php 
				}
                ?>
            ...
            <li>
                Alamat :
				<?=input($pasien['alamat'], "data_{$i}", "text", "", "height:20px;", "");$i++;?>
            </li>
            <li>
                No. Telp :
        ...
        <div style="float:right;">
            ...
            <b>Pihak yang dijelaskan,
                <br><br>
                <br><br>
                ( <?=input($pasien['nama'], "data_{$i}", "text", "", "height:20px;", "");$i++;?> )</b>
        </div>
        <br><br><br>
        <p><b>
                ...
                <br><br>
                <br><br>
                ( <?=input($dataP["nama"], "data_{$i}", "text", "", "height:20px;", "");$i++;?> )

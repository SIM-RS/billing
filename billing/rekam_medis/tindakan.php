<table width="850" border="0" cellpadding="0" cellspacing="1" align="center">
    ...
    <tr style="display:none">
        <td>&nbsp;<input type="hidden" id="cek_idTind" name="cek_idTind" /><input type="hidden" id="cek_barisTind" name="cek_barisTind" /><input type="hidden" id="cek_ksgTind" name="cek_ksgTind" /></td>
        <td>&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;</td>
        <td colspan="3">
            <div id="gridboxTind" style="width:850px; height:300px; background-color:white;"></div>
            <br/>

...
?>    
<table width="700" id="tblDiagnosa_v2" border="0" cellpadding="1" cellspacing="0">
	<tr class="headtable">
...
?>
	<tr id="lstDiag_v2<?php echo $i; ?>" lang="<?php echo $arfvalue; ?>" class="itemtableReq" onMouseOver="this.className='itemtableMOverReq'" onMouseOut="this.className='itemtableReq'" onClick="fSetICDX_RM_v2(this.lang);">

...
<head>
  ...
  <title> Form Assesmen Nyeri Farmakologi </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form Assesmen Farmakologi</td>
...
&nbsp;
                <a href='print_one.php?id=$data[id]&idKunj=$idKunj&idPel=$idPel&idPasien=$idPasien&idUser=$idUser' class='btn btn-info' style='color: white;'>Print</a>      

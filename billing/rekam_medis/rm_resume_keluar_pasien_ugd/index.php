...
<head>
  ...
  <title> Form resume keluar pasien ugd </title>
...
<body>
  <div style="background-color: #EAF0F0 ; width: 1000px;  margin: auto;">
    ...
    <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
      <tbody>
        <tr>
          <td height="30" class="tblatas" style="text-align: left;">&nbsp;Form resume keluar pasien ugd</td>
                    ...
                    <tbody>
                      ...
                      if (isset($getall)) {
                        foreach ($getall as $data) {
                          ...
                          echo "<td>" . $data['perkembangan_penyakit'] . "</td>";
                          echo "<td>" . $data['kondisi_pasien'] . "</td>";
                          echo "<td>" . $data['penyebab_langsung_kematian'] . "</td>";
                          echo "<td>" . $data['masalah'] . "</td>";
                          echo "<td>" . $data['cara_pulang'] . "</td>";

...
function DSGridObject(id){
	...
	this.setHeader=function(str,par){
		document.getElementById('hdrcaption_'+id).childNodes[0].innerHTML = str;
		if (par==false){
			document.getElementById('hdrcaption_'+id).style.visibility='collapse';
		}
	}
	...
	this.setSelRow=function(row){
		...
		document.getElementById(id).selectedRow=row;
		var tbl2=document.getElementById('tblgrid_'+id);
		var crow2=tbl2.rows[document.getElementById(id).selectedRow-1];
		crow2.className='GridItemSelected';
	}
	...
	this.setSorting=function(x){
		return document.getElementById(id).sorting = x;
	}
	this.getSorting=function(){
		return document.getElementById(id).sorting;
	}
	this.setFilter=function(x){
		document.getElementById(id).filter = x;
	}

...
function mmLoadMenus() {
   ...
   window.mm_menu_0814123211_0 = new Menu("root", 240, 25, "verdana", 11,"#003366", "#FF6600", "#64CCFC", "#ffffff","left", "middle", 3, 0, 100, -5, 7,true, true, true, 0, true, true);
   mm_menu_0814123211_0.addMenuItem("RINCIAN RJ/RD","cetakRincian(101);");
   mm_menu_0814123211_0.addMenuItem("RINCIAN RI","cetakRincian(102);");
   mm_menu_0814123211_0.addMenuItem("RINCIAN RJ/RD+RI","cetakRincian(103);");
   mm_menu_0814123211_0.addMenuItem("RINCIAN OBAT RJ/RD","cetakRincian(105);");
   mm_menu_0814123211_0.addMenuItem("RINCIAN OBAT RI","cetakRincian(106);");
   mm_menu_0814123211_0.addMenuItem("RINCIAN OBAT RJ/RD+RI","cetakRincian(107);");
   mm_menu_0814123211_0.addMenuItem("REKAP RJ/RD","cetakRincian(108);");
   mm_menu_0814123211_0.addMenuItem("REKAP RI","cetakRincian(109);");
   mm_menu_0814123211_0.addMenuItem("REKAP RJ/RD+RI","cetakRincian(110);");
   mm_menu_0814123211_0.addMenuItem("FORM KONFIRMASI KEPULANGAN (KRS)","cetakRincian(104);");
   ...
   window.mm_menu_0814123211_4a = new Menu("root", 170, 25, "verdana", 11,"#003366", "#FF6600", "#64CCFC", "#ffffff","left", "middle", 3, 0, 100, -5, 7,true, true, true, 0, true, true);
   mm_menu_0814123211_4a.addMenuItem("RINCIAN RJ/RD","CetakRincianTagihan(0);");
   mm_menu_0814123211_4a.addMenuItem("RINCIAN RI","CetakRincianTagihan(1);");
   mm_menu_0814123211_4a.addMenuItem("RINCIAN RJ/RD + RI","CetakRincianTagihan(2);");
   //mm_menu_0814123211_4a.addMenuItem("REKAP KSO RI","CetakRekapKSOTagihan(1);");
   //mm_menu_0814123211_4a.addMenuItem("REKAP KSO RJ/RD + RI","CetakRekapKSOTagihan(2);");
   mm_menu_0814123211_4a.addMenuItem("REKAP RJ/RD","CetakRekapTagihan(0);");
   mm_menu_0814123211_4a.addMenuItem("REKAP RI","CetakRekapTagihan(1);");
   mm_menu_0814123211_4a.addMenuItem("REKAP RJ/RD + RI","CetakRekapTagihan(2);");

   window.mm_menu_0814123211_5 = new Menu("root", 225, 25, "verdana", 11,"#003366", "#FF6600", "#64CCFC", "#ffffff","left", "middle", 3, 0, 100, -5, 7,true, true, true, 0, true, true);
   mm_menu_0814123211_5.addMenuItem("RINCIAN TINDAKAN RJ / IGD","RincianTagihan(0);");
   mm_menu_0814123211_5.addMenuItem("RINCIAN TINDAKAN RI","RincianTagihan(1);");
   mm_menu_0814123211_5.addMenuItem("RINCIAN TINDAKAN RJ / IGD + RI","RincianTagihan(2);"); 
   
   window.mm_menu_0814123211_5a = new Menu("root", 170, 25, "verdana", 11,"#003366", "#FF6600", "#64CCFC", "#ffffff","left", "middle", 3, 0, 100, -5, 7,true, true, true, 0, true, true);
   mm_menu_0814123211_5a.addMenuItem("LAB PK","RincianTindakan(58);");
   mm_menu_0814123211_5a.addMenuItem("LAB PA","RincianTindakan(59);");
   mm_menu_0814123211_5a.addMenuItem("RADIOLOGI","RincianTindakan(61);");
   mm_menu_0814123211_5a.addMenuItem("RINCIAN OBAT RJ/RD","CetakRincian(0);");
   mm_menu_0814123211_5a.addMenuItem("RINCIAN OBAT RI","CetakRincian(1);");
   mm_menu_0814123211_5a.addMenuItem("RINCIAN OBAT RJ/RD+RI","CetakRincian(2);");
   ...
   mm_menu_0814123211_4_0.addMenuItem("1. INFORM KONSEN","load_popup_iframe('INFORM KONSEN','../report_rm/1.inform_konsen.php')");
   ...
   mm_menu_0814123211_4_0.addMenuItem("17. OBS HARIAN BAYI","ReportRm(17);");
	...
	mm_menu_0814123211_4_3.addMenuItem("1. PENOLAKAN TIND.MEDIS","load_popup_iframe('PENOLAKAN TINDAKAN MEDIS','../report_rm/Form_RSU_2/penolakan_tind_medis_form.php')");
	mm_menu_0814123211_4_3.addMenuItem("2. SURAT KET.PEMERIKSA MATA","load_popup_iframe('SURAT KETERANGAN PEMERIKSA MATA','../report_rm/Form_RSU_2/s_ket_periksa_mata.php')");
	mm_menu_0814123211_4_3.addMenuItem("3. RESEP KACAMATA","load_popup_iframe('RESEP KACAMATA','../report_rm/Form_RSU_2/resep_kcmta_form.php')");
	mm_menu_0814123211_4_3.addMenuItem("4. MEDICAL CHEKUP(BDH WANITA)","load_popup_iframe('MEDICAL CHEKUP(BDH WANITA)','../report_rm/Form_RSU_2/med_chckup_stat_bdh_wnta_form.php')");
	mm_menu_0814123211_4_3.addMenuItem("5. MEDICAL CHEKUP(DENTAL)","load_popup_iframe('MEDICAL CHEKUP(DENTAL)','../report_rm/Form_RSU_2/l_med_chckup_stat_dental.php')");
	mm_menu_0814123211_4_3.addMenuItem("6. RESUM MEDIS","load_popup_iframe('RESUM MEDIS','../report_rm/Form_RSU_2/resum_medis_form.php')");
	mm_menu_0814123211_4_3.addMenuItem("7. PENGAWASAN KHUSUS BAYI","load_popup_iframe('PENGAWASAN KHUSUS BAYI','../report_rm/Form_RSU_2/pngwsn_khsus_bayi.php')");
	mm_menu_0814123211_4_3.addMenuItem("8. NEONEATUS DISCHARGE","load_popup_iframe('NEONEATUS DISCHARGE','../report_rm/Form_RSU_2/neonatus_discharge_form.php')");
	mm_menu_0814123211_4_3.addMenuItem("9. PENGKAJIAN LUKA","load_popup_iframe('PENGKAJIAN LUKA','../report_rm/Form_RSU_2/lb_pengkajian_luka.php')");

				...
				<tr bgcolor="whitesmoke">
					<td>
						<?php	
						  ...
						  $PATH_INFO ='http://'.$_SERVER['HTTP_HOST'].$base_addr.'/billing/setting/settingaplikasi_treeview.php';
						  ...
						  while ($rows=mysql_fetch_array($rs)){
								 ...
								 $arfvalue=$par[0]."*-*".$rows['id']."*|*".$par[1]."*-*".$mkode."*|*".$par[2]."*-*".$rows['level']."*|*".$par[3]."*-*".($rows['level']+1);
								 if ($c_level>0)

...
switch(strtolower($_REQUEST['act']))
{
	...
	case 'simpan':
		...
		{
			case 'btnSimpanGroup':
				$sqlUpdate="UPDATE b_ms_group SET kode='".$kodebr."', nama = '".$_REQUEST['nama']."', ket = '".$_REQUEST['ket']."', aktif = '".$_REQUEST['aktif']."' WHERE id = '".$_REQUEST['id']."'";
				break;
...
if($grdtab2 == "true")
{
	$sql="SELECT id,kode,nama,ket,if(aktif=1,'Aktif','Tidak Aktif') as aktif FROM b_ms_group ".$filter." order by ".$sorting;
}

...
function  act1(li){
	...
	case "update":
		...
		gd3.loadURL("joborderUtils.php?grdTindCic=1&grd=order&asal=<?=$_REQUEST['asal']?>&petugas=<?=$_SESSION['userId']?>&act1="+li+"&idPtgs="+idPtgs+"&id="+id+"&idUnit="+idUnit+"&idAlat="+idAlat+"&kdOrder="+kdOrder+"&tglOrder="+tglOrder+"&jmlh="+jmlh+"&tipe="+$("#tipejenis").val(),'','GET');
		kosong();
...
function goFilterAndSort(abc){
	if (abc=="gridbox"){
		gd3.loadURL("joborderUtils.php?grd=order&asal=<?=$_REQUEST['asal']?>&petugas=<?=$_SESSION['userId']?>&filter="+gd3.getFilter()+"&sorting="+gd3.getSorting()+"&page="+gd3.getPage()+"&tipe="+$("#tipejenis").val(),"","GET");
...
function del(){
	...
	gd3.loadURL("joborderUtils.php?grdTindCic=1&grd=order&asal=<?=$_REQUEST['asal']?>&petugas=<?=$_SESSION['userId']?>&act1=hapus&id="+id+"&tipe="+$("#tipejenis").val(),'','GET');
	gd3.Init();
	document.getElementById('save').innerHTML='<img src="../icon/save.gif" width="25" height="25" align="absmiddle" />&nbsp;Tambah';
	document.getElementById('delete').innerHTML='<img src="../icon/delete2.gif" width="25" height="25" align="absmiddle" />&nbsp;Hapus';
	document.getElementById('delete').disabled=true;
...
gd3.baseURL("joborderUtils.php?grd=order&asal=<?=$_REQUEST['asal']?>&petugas=<?=$_SESSION['userId']?>&tipe="+$("#tipejenis").val());
gd3.Init();
...
function filter(){
		...
		var stOrd = document.getElementById('stOrd').value;
				...
				//alert(url);
        gd3.loadURL("joborderUtils.php?grd=order&asal=<?=$_REQUEST['asal']?>&petugas=<?=$_SESSION['userId']?>&stOrd="+stOrd+"&bln="+bln+"&thn="+thn+"&tipe="+$("#tipejenis").val(),'','GET');
        }

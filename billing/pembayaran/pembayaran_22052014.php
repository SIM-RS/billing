			  ...
			  &nbsp;Th&nbsp;&nbsp;<input type="text" style="text-align:center;" class="txtinputreg" name="Bln" id="Bln" size="3" tabindex="9" onkeyup="gantiTgl()"/>&nbsp;Bln--></td>
                ...
                <tr>
                    ...
                    <td colspan="7" align="center"><input name="btnPrint" id="btnPrint" type="button" class="tblCetak" value="&nbsp;&nbsp;&nbsp;Cetak" onClick="cetakPembayaran();" disabled="disabled" />&nbsp;
                        ...
                        <input type="button" value="Print Ulang" class="tblBtn" onClick="printUlang();" />&nbsp;
...
*/			}
        ...
        function ambilData()
        {
            ...
            var p="txtIdBayar*-*"+sisipan[0]+"*|*txtIdKunj*-*"+sisipan[1]+"*|*txtnobukti*-*"+a1.cellsGetValue(a1.getSelRow(),2)+"*|*txttgl*-*"+a1.cellsGetValue(a1.getSelRow(),3)+"*|*lblbiaya*-*"+sisipan[2]+"*|*txtKeringanan*-*"+sisipan[3]+"*|*txtTitipan*-*"+sisipan[4]+"*|*txtbayar*-*"+a1.cellsGetValue(a1.getSelRow(),4)+"*|*txtterima*-*"+a1.cellsGetValue(a1.getSelRow(),5)+"*|*txtJaminan*-*"+sisipan[7]+"*|*tipe*-*"+((sisipan[5]=='0')?'false':'true')+"*|*btnSimpan*-*true*|*btnHapus*-*<?php echo $disableHapus; ?>*|*btnPrint*-*false*|*rincianPas*-*false";
            fSetValue(window,p);
            abc="PilihPembayaran";
            //document.getElementById('tipe').value=0;
        ...
        function RincianTagihan(x){
			...
			*/
			window.open('tagihanPasien.php?idKunj='+idKunj+'&idPel='+document.getElementById('txtIdPel').value+'&idUser=<?php echo $userId;?>&inap=0&tipe='+x,'_blank');
        }
		...
		function RincianTagihanPrint(){
			...
			*/
			...
			window.open('tagihanPasien_print.php?idKunj='+idKunj+'&idPel='+document.getElementById('txtIdPel').value+'&idUser=<?php echo $userId;?>&inap=0&tipe='+document.getElementById('cmbTipe').value+'&kasir='+document.getElementById('txtKasir').value+'&tglprint='+document.getElementById('txtTglPrint').value+'&txtTglSel='+document.getElementById('txtTglSel').value+'&cmbTgl='+document.getElementById('cmbTgl').value,'_blank');

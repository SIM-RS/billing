...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../unit_pelayanan/jquery_multiselect/jquery-ui.css" />
        <link rel="stylesheet" type="text/css" href="../unit_pelayanan/jquery_multiselect/jquery.multiselect.css" />
        <link rel="stylesheet" type="text/css" href="../unit_pelayanan/jquery_multiselect/style.css" />
        <script type="text/JavaScript" language="JavaScript" src="../include/jquery/jquery-1.9.1.js"></script>
        <script type="text/javascript" src="../unit_pelayanan/jquery_multiselect/jquery-ui.min.js"></script>
        <script type="text/javascript" src="../unit_pelayanan/jquery_multiselect/src/jquery.multiselect.js"></script>
        ...
        <div align="center">
            ...
            <table width="1000" border="0" cellspacing="1" cellpadding="0" class="tabel" align="center">
				...
				<!-- <tr>
                    ...
                    <td colspan="3"> -->
					<input type="hidden" class="txtinputreg" name="flag" id="flag" size="20" tabindex="3" value="<?php echo $flag; ?>"/>
					<!-- </td>
                    <td colspan="3" align="center"></td>
                    <td>&nbsp;</td>
                </tr> -->
			  ...
			  &nbsp;Th&nbsp;&nbsp;<input type="text" style="text-align:center;" class="txtinputreg" name="Bln" id="Bln" size="3" tabindex="9" onkeyup="gantiTgl()"/>&nbsp;Bln--></td>
                            ...
                            <tr>
                                <td width="34%">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td width="48%" align="right">Diskon &nbsp;</td>
                                            <td width="52%">
                                                <select name="type-diskon" id="type-diskon" class="txtinputreg">
                                                    <option value="1">Nominal</option>
                                                    <option value="2">Presentase</option>
                                                </select>
                                                <input type="text" name="txtdiskon" class="txtinputreg" id="txtdiskon" style="text-align: right;" value="0" size="10">
                                                <input type="hidden" name="txtnilaidiskon" id="txtnilaidiskon" value="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="48%" height="34" align="right" id="tdPembayaran" style="color:#0000FF">Pembayaran &nbsp;</td>
                                            <td width="52%"><input name="txtbayar" class="txtinputreg" id="txtbayar" style="text-align:right" value="0" size="10" onkeyup="cek();" />
                                                <input type="hidden" name="txtTotalDiskonDokter" id="txtTotalDiskonDokter" value="0">
                                                <input type="hidden" name="txtPemberiDiskon" id="txtPemberiDiskon" value="0">
                                            </td>
                                        </tr>
                                        <tr id="trSisa">
                                            <td width="48%" align="right">Sisa &nbsp;</td>
                                            <td width="52%"><input name="txtsisa" class="txtinputreg" id="txtsisa" style="text-align:right" value="0" size="10" readonly="readonly" /></td></tr>
                                        <tr>
                ...
                <tr>
                    ...
                    <button class="button btn-info" data-target="#kwitansiModal" onclick="getNoKwitansiPcr()" data-toggle="modal">
                        Kwitansi PCR
                    </button>
                    <button id="btn-diskon-dokter" type="button" class="button btn-primary" data-toggle="modal" data-target="#staticBackdrop">
                      Diskon Dokter
                    </button>
                    </td>
                    <td>&nbsp;</td>
            ...
            <div class="modal fade text-left" id="kwitansiModal" tabindex="-1" aria-labelledby="kwitansiModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="kwitansiModalLabel">TANDA TERIMA PCR UMUM</h5>
                    <button type="button" onclick="getNoKwitansiPcr()" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form id="total_pcr_form">
                    <input type="hidden" name="idPasienPcr" id="idPasienPcr">
                    <input type="hidden" id="nokwitansiPcr" name="nokwitansiPcr">
                    <input type="hidden" name="noUrutKwitansi" id="noUrutKwitansi">
                    <input type="hidden" name="idPelayananPcr" id="idPelayananPcr">
                    <input type="hidden" name="idPelayananPcrCetak" id="idPelayananPcrCetak">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="">Nomer RM</label>
                                <input type="text" class="form-control" id="nomorrm" name="nomorrm" onkeyup="listPasienPcr(event,'show',this.value)">
                            </div>
                            <div class="form-group">
                                <label for="">Nama </label>
                                <input type="text" name="namaPasienPcr" id="namaPasienPcr" class="form-control" onkeyup="listPasienPcr(event,'show',this.value)">
                                <div id="div_pasien_pcr" align="center" class="div_pasien" style="display:none"></div></td>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                                <textarea class="form-control" name="alamatPasienPcr" id="alamatPasienPcr"></textarea>
                            </div>        
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label>Total</label>
                                <input type="text" name="totalPcr" class="form-control text-right" id="totalPcr" value="0">
                            </div>
                            <div class="form-group">
                                <label>Jumlah Uang Terima</label>
                                <input type="text" name="jmlUangTerima" onkeyup="uangKembali(this.value)" class="form-control text-right" id="jmlUangTerima" value="0">
                            </div>
                            <div class="form-group">
                                <label>Jumlah Uang Kembali</label>
                                <input type="text" name="jmlUangKembali" class="form-control text-right" id="jmlUangKembali" value="0">
                            </div>  
                        </div>
                    <input type="hidden" name="userIdInput" id="userIdInput" value="<?= $_SESSION['user_id'] ?>">
                    <input type="hidden" name="userIdCetak" id="userIdCetak" value="">
                    </div>
                    </form>
                    <input type="hidden" name="idPembayaranPcr" id="idPembayaranPcr">
                    <button class="btn btn-info btn-sm" id="btnCetakPcr" onclick="cetakPembayaranPcr()">Cetak Kwitansi</button>
                    <button class="btn btn-primary btn-sm" id="btnRefreshGridPcr" onclick="refreshGridPcr(document.getElementById('idPasienPcr').value)">Refresh</button>

                    <div id="pcrKwitansi" style="width: 100%"></div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" onclick="getNoKwitansiPcr()" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-warning" onclick="document.getElementById('total_pcr_form').reset();refreshGridPcr(0);getNoKwitansiPcr();document.getElementById('btnDeletePembayaranPcr').style.display = 'none';">Cancel</button>
                    <button style="display: none;" class="btn btn-danger" id="btnDeletePembayaranPcr" onclick="deleteDataPembayaranPcr()">Delete</button>
                    <button type="button" onclick="saveTotalPcr()" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
<table border="0" cellpadding="0" cellspacing="0" class="hd2" width="1000">
				...
				<tr>
                    <td width="35%"><table width="100%">
						<tr>
							...
							<td width="3%">:</td>
							<td width="67%"><input type="text" readonly size="10" id="rm1" class="txtinputreg">
                            </td>
						</tr>
						<tr>
							<td>Nama Pasien</td>
        ...
        <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Diskon Dokter</h5>
                <button type="button" onclick="removeDiskonDokter()" id="close-btn-diskon" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                    <button class="btn btn-sm btn-success" id="btn-tambah-diskon-dokter">Tambah</button>
                    <form id="form-diskon-dokter">
                    <table id="table-diskon-dokter" class="table table-sm table-borderles">
                        
                    </table>
                    </form>
              </div>
              <div class="modal-footer">
                <button type="button" onclick="removeDiskonDokter()" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button"  class="btn btn-primary" onclick="setDiskonDokter()">Save</button>
              </div>
            </div>
          </div>
        </div>
        <input type="hidden" name="tmp-diskon-dokter" id="tmp-diskon-dokter">        
</body>
    <script type="text/JavaScript">
        ...
        var cabang = 1;
        var dokter_tindakan = '';
        var pcr2 = new DSGridObject("pcrKwitansi");
        pcr2.setHeader("TOTAL BIAYA");
        pcr2.setColHeader("NO,NAMA,NO KWITANSI,TANGGAL BAYAR,TOTAL PCR,JUMLAH UANG TERIMA,JUMLAH UANG KEMBALI");
        pcr2.setIDColHeader("no,nama,no_kwitansi,tanggal_bayar,total_pcr,jumlah_uang_terima,jumlah_uang_kembali");
        pcr2.setColWidth("20,185,200,100,100,100");
        pcr2.setCellAlign("center,left,center,center,right,right,right");
        pcr2.setCellType("txt,txt,txt,txt,txt,txt,txt");
        pcr2.setCellHeight(20);
        pcr2.setImgPath("../icon");
        // pcr2.setIDPaging("pagginationpcr");
        pcr2.attachEvent("onRowClick","ambilDataPcr2"); 

        function refreshGridPcr(getIdPasienPcr){
            pcr2.baseURL("pembayaran_pcr.php?grd=getData&id_pasien="+getIdPasienPcr);
            pcr2.Init();
        }

        function saveTotalPcr(act){
            let idPasienPcr = document.getElementById('idPasienPcr').value;
            if(idPasienPcr == ''){
                return alert('Harap pilih pasien');
            }
            let totalPcr = document.getElementById('totalPcr').value;
            let jmlUangTerima = document.getElementById('jmlUangTerima').value;
            let jmlUangKembali = document.getElementById('jmlUangKembali').value;
            let kwitansiPcr = document.getElementById('nokwitansiPcr').value
            let noUrutKwitansi = document.getElementById('noUrutKwitansi').value;
            jQuery.ajax({
                url: 'pembayaran_pcr.php',
                method:'post',
                data:{
                    id_pasien : idPasienPcr,
                    total_pcr : totalPcr,
                    no_kwitansi : kwitansiPcr,
                    no_urut_kwitansi : noUrutKwitansi,
                    jumlah_uang_terima : jmlUangTerima,
                    jumlah_uang_kembali : jmlUangKembali,
                    id_pelayanan : document.getElementById('idPelayananPcr').value,
                ...
                success:function(data){
                    if(data.status == 1){
                        ...
                        refreshGridPcr(idPasienPcr);
                        document.getElementById('total_pcr_form').reset();
                        getNoKwitansiPcr();
                        document.getElementById('btnDeletePembayaranPcr').style.display = 'none';
                    }else if(data.status == 3){
                        alert('Pasien sudah dilakukan pembayaran');
                        document.getElementById('btnDeletePembayaranPcr').style.display = 'none';
                        getNoKwitansiPcr();
                        refreshGridPcr(idPasienPcr);
                    }
        ...
        function uangKembali(val){
            let totalPcr = parseInt(document.getElementById('totalPcr').value);
            let jmlUangTerima = parseInt(val);
            if(jmlUangTerima >= totalPcr){
            document.getElementById('jmlUangKembali').value = jmlUangTerima - totalPcr;
            }else{
                document.getElementById('jmlUangKembali').value = 0;
            }
        }
        ...
        function listPasienPcr(feel,how,stuff){
            var kasir2 = 82;
            var jenisKasir2 = '1,57,60,64,66,62,44';

            if(how == 'show'){
            if(feel.which==13 && document.getElementById('div_pasien_pcr').style.display!='block'){
                    if (stuff==''){
                        ...
                        keyword=stuff;
                        document.getElementById('div_pasien_pcr').style.display='block';
                        //alert('pasien_list.php?act=cari&kasir='+kasir+'&jenisKasir='+jenisKasir+'&keyword='+stuff);
                        Request('pasien_list_pcr.php?act=cari&kasir='+kasir2+'&jenisKasir='+jenisKasir2+'&keyword='+stuff,'div_pasien_pcr','','GET');
                        RowIdx=0;
                        
                        document.getElementById('det_obt').innerHTML='';
                    }
                }
                else if ((feel.which==38 || feel.which==40) && document.getElementById('div_pasien_pcr').style.display=='block'){
                    //alert(feel.which);
                    var tblRow=document.getElementById('pasien_table_pcr').rows.length;
                    if (tblRow>0){
                        //alert(RowIdx);
                    ...
                    if (stuff==''){
                        ...
                        keyword=stuff;
                        document.getElementById('div_pasien_pcr').style.display='block';
                        //alert('pasien_list.php?act=cari&kasir='+kasir2+'&jenisKasir='+jenisKasir2+'&keyword='+stuff+'&status=all');
                        Request('pasien_list_pcr.php?act=cari&kasir='+kasir2+'&jenisKasir='+jenisKasir2+'&keyword='+stuff+'&status=all','div_pasien_pcr','','GET');
                        RowIdx=0;
                    }
                }
                    ...
                    document.getElementById('div_pasien_pcr').style.display='none';
                }
            }
        }
        ...
        function setPasienPcr(val){
            let dataPasienPcr = val.split('|');
            console.log(dataPasienPcr);
            pcr2.baseURL("pembayaran_pcr.php?grd=getData&id_pasien="+dataPasienPcr[0]);
            pcr2.Init();
            document.getElementById('idPasienPcr').value = dataPasienPcr[0];
            document.getElementById('nomorrm').value =  dataPasienPcr[7];
            document.getElementById('namaPasienPcr').value = dataPasienPcr[3];
            document.getElementById('alamatPasienPcr').value = dataPasienPcr[4];
            document.getElementById('div_pasien_pcr').style.display = 'none';
            document.getElementById('idPelayananPcr').value = dataPasienPcr[2];
            jQuery.ajax({
                url :'pembayaran_pcr.php',
                method:'post',
                data:{
                    act : 'getNoUrutKwitansi',
                },
                dataType : 'json',
                success:function(data){
                    let date = new Date();
                    ...
                    let tanggal = date.getDate().toString().length == 1 ? "0"+date.getDate().toString() : date.getDate().toString();
                    let lenZero = 7;
                    let pDataNoKwi = data.no_kwi.toString().length;
                    let no_kwi = tahun[2] + tahun[3] + '.' + month + '.' + tanggal + '.';
                    for(let i = 0; i < lenZero - pDataNoKwi; i++){
                        no_kwi += "0".toString();
                    }
                    no_kwi += data.no_kwi;
                    console.log(no_kwi);
                    document.getElementById('noUrutKwitansi').value = data.no_kwi;
                    document.getElementById('nokwitansiPcr').value = no_kwi;
                }
            });
        }

        function getNoKwitansiPcr(){
            jQuery.ajax({
                url :'pembayaran_pcr.php',
                method:'post',
                data:{
        ...
        function simpan(action)
        {
            if(ValidateForm('NoRm,txtnobukti,txttgl,txtbayar','ind'))
            {
                ...
                if (document.getElementById("txtbayar").value=="0"){
                    ...
                    let diskonDokter = document.getElementById('txtTotalDiskonDokter').value;
                    let dokterPemberiDiskon = document.getElementById('tmp-diskon-dokter').value;
                    nilai = parseFloat(nilai) + parseFloat(document.getElementById('txtnilaidiskon').value) + parseInt(diskonDokter);
				...
				if(tagihan==0){
					...
					if(statres==1){			//pmbyrn!=tagihan 	; pmbyrn>tagihan
						 if(tot_obtz==0){
							url="bayar_utils.php?versi=<?php echo $versi;?>&grd=true&act="+action+"&idBayar="+idBayar+"&idKunj="+idKunj+"&idPel="+idPel+"&nobukti="+nobukti+"&tgl="+tgl+"&tagihan="+tagihan+"&nilai="+nilai+"&jaminan_kso="+jaminan_kso+"&titipan="+titipan+"&keringanan="+keringanan+"&dibayaroleh="+dibayaroleh+"&userId=<?php echo $userId;?>&tipe="+tipe+"&idKasir="+kasir+"&jenisKasir="+jenisKasir+"&ksoId="+ksoId+"&bayarIGD="+cbayarIGD+"&flag="+flag+"&jenisKunj="+jenisKunj+"&retursisa="+retursisa+"&jenisKunj="+dataPasien[28]+"&unitId="+unitId+"&statpembyrn=1&diskonBilling="+document.getElementById('txtnilaidiskon').value;
							//alert("billing");
                            console.log('url if --- 1');
                            
                            if(diskonDokter != 0 || diskonDokter != '' || diskonDokter != undefined){
                                url += "&diskonDokter="+diskonDokter;
                                url += "&dokterPemberiDiskon="+dokterPemberiDiskon;
                            }

						 }else{
							url="bayar_utils.php?versi=<?php echo $versi;?>&grd=true&act="+action+"&idBayar="+idBayar+"&idKunj="+idKunj+"&idPel="+idPel+"&nobukti="+nobukti+"&tgl="+tgl+"&tagihan="+tagihan+"&nilai="+nilai+"&jaminan_kso="+jaminan_kso+"&titipan="+titipan+"&keringanan="+keringanan+"&dibayaroleh="+dibayaroleh+"&userId=<?php echo $userId;?>&tipe="+tipe+"&idKasir="+kasir+"&jenisKasir="+jenisKasir+"&ksoId="+ksoId+"&bayarIGD="+cbayarIGD+"&jenisKunj="+jenisKunj+"&retursisa="+retursisa+"&flag="+flag+"&jenisKunj="+dataPasien[28]+"&unitId="+unitId+"&statpembyrn=2&jmlresep="+tot_obtz+"&bykresep="+bykresz+"&detresep="+cdataz+"&norm="+norm+"&diskonBilling="+document.getElementById('txtnilaidiskon').value;
                            ...
                            console.log('url else --- 1');

						 }
					}else if(statres==2){	//pmbyrn<=tagihan	; pmbyrn>=total_obat
						url="bayar_utils.php?versi=<?php echo $versi;?>&grd=true&act="+action+"&idBayar="+idBayar+"&idKunj="+idKunj+"&idPel="+idPel+"&nobukti="+nobukti+"&tgl="+tgl+"&tagihan="+tagihan+"&nilai="+nilai+"&jaminan_kso="+jaminan_kso+"&titipan="+titipan+"&keringanan="+keringanan+"&dibayaroleh="+dibayaroleh+"&userId=<?php echo $userId;?>&tipe="+tipe+"&idKasir="+kasir+"&jenisKasir="+jenisKasir+"&ksoId="+ksoId+"&bayarIGD="+cbayarIGD+"&jenisKunj="+jenisKunj+"&flag="+flag+"&retursisa="+retursisa+"&jenisKunj="+dataPasien[28]+"&unitId="+unitId+"&statpembyrn=2&jmlresep="+tot_obtz+"&bykresep="+bykresz+"&detresep="+cdataz+"&norm="+norm+"&diskonBilling="+document.getElementById('txtnilaidiskon').value;
						...
						//alert("obat full+sisanya billing2");
                            console.log('url if --- 2');

					}else if(statres==3){	//pmbyrn>=min_resep
						url="bayar_utils.php?versi=<?php echo $versi;?>&grd=true&act="+action+"&idBayar="+idBayar+"&idKunj="+idKunj+"&idPel="+idPel+"&nobukti="+nobukti+"&tgl="+tgl+"&tagihan="+tagihan+"&nilai="+nilai+"&jaminan_kso="+jaminan_kso+"&titipan="+titipan+"&keringanan="+keringanan+"&dibayaroleh="+dibayaroleh+"&userId=<?php echo $userId;?>&tipe="+tipe+"&idKasir="+kasir+"&jenisKasir="+jenisKasir+"&ksoId="+ksoId+"&bayarIGD="+cbayarIGD+"&jenisKunj="+jenisKunj+"&flag="+flag+"&retursisa="+retursisa+"&jenisKunj="+dataPasien[28]+"&unitId="+unitId+"&statpembyrn=3&jmlresep="+tot_obtz+"&bykresep="+bykresz+"&detresep="+cdataz+"&norm="+norm+"&tes="+tes+"&otomasi="+otomasi+"&diskonBilling="+document.getElementById('txtnilaidiskon').value;
						//alert("obat bbrp resep+sisanya billing1");
                            console.log('url if --- 3');

					}else if(statres==4){	//pmbyrn<min_resep
						url="bayar_utils.php?versi=<?php echo $versi;?>&grd=true&act="+action+"&idBayar="+idBayar+"&idKunj="+idKunj+"&idPel="+idPel+"&nobukti="+nobukti+"&tgl="+tgl+"&tagihan="+tagihan+"&nilai="+nilai+"&jaminan_kso="+jaminan_kso+"&titipan="+titipan+"&keringanan="+keringanan+"&dibayaroleh="+dibayaroleh+"&userId=<?php echo $userId;?>&tipe="+tipe+"&idKasir="+kasir+"&jenisKasir="+jenisKasir+"&flag="+flag+"&ksoId="+ksoId+"&bayarIGD="+cbayarIGD+"&jenisKunj="+jenisKunj+"&retursisa="+retursisa+"&jenisKunj="+dataPasien[28]+"&unitId="+unitId+"&statpembyrn=1"+"&diskonBilling="+document.getElementById('txtnilaidiskon').value;
						//alert("billing");
                            console.log('url if --- 4');

					}else if(statres==5){	//centang
						url="bayar_utils.php?versi=<?php echo $versi;?>&grd=true&act="+action+"&idBayar="+idBayar+"&idKunj="+idKunj+"&idPel="+idPel+"&nobukti="+nobukti+"&tgl="+tgl+"&tagihan="+tagihan+"&nilai="+nilai+"&jaminan_kso="+jaminan_kso+"&titipan="+titipan+"&keringanan="+keringanan+"&dibayaroleh="+dibayaroleh+"&userId=<?php echo $userId;?>&tipe="+tipe+"&idKasir="+kasir+"&jenisKasir="+jenisKasir+"&ksoId="+ksoId+"&bayarIGD="+cbayarIGD+"&jenisKunj="+jenisKunj+"&retursisa="+retursisa+"&jenisKunj="+dataPasien[28]+"&unitId="+unitId+"&statpembyrn=3&jmlresep="+tot_obtz+"&bykresep="+bykresz+"&flag="+flag+"&detresep="+cdataz+"&norm="+norm+"&tes="+tes+"&otomasi="+otomasi+"&cekbilling="+bill+"&masukbilling="+bilingmasuk+"&diskonBilling="+document.getElementById('txtnilaidiskon').value;
						//alert("obat bbrp resep+sisanya billing2");
                            console.log('url if --- 5');
        ...
        function ambilData()
        {
			...
			sisipan[10]+"*|*txtterima*-*"+sisipan[11]+"*|*txtJaminan*-*"+sisipan[7]+"*|*tipe*-*"+((sisipan[5]=='0')?'false':'true')+"*|*btnSimpan*-*true*|*btnHapus*-*false*|*btnPrint*-*false*|*rincianPas*-*false*|*txtKasirId*-*"+sisipan[12]+"*|*type-diskon*-*"+1+"*|*txtdiskon*-*"+sisipan[14]+"*|*txtTotalDiskonDokter*-*"+sisipan[16]+"*|*tmp-diskon-dokter*-*"+sisipan[15];
            fSetValue(window,p);
		...
		*/
        ...
        function hapus()
        {
            ...
            Request("bayar_action.php?action=getLimit&idbayar="+rowid,'limithapus','','GET',function(){
                ...
                // == Jika data ada, dan userId bukan Admin
                if(data > 0 && userId !== 732){
                    alert('Sudah melebihi 1 hari, tidak bisa dihapus!!!');
                    batal();
                // == Jika data ga ada, dan UserId Admin
                } else {
                    if(confirm("Anda yakin menghapus Data Pembayaran "+a1.cellsGetValue(a1.getSelRow(),2)))
                    {
                        document.getElementById('cekBayar').value = 0;
                        url="bayar_utils.php?nomor=15&versi=<?php echo $versi; ?>&grd=true&idKunj="+dataPasien[9]+"&idKasir="+idKasir+"&act=hapus&rowid="+rowid+"&jenisKunj="+dataPasien[28]+"&userId=<?php echo $userId;?>";
                        //alert(url);
                        a1.loadURL(url,"","GET");
                    }
                    batal();
        ...
        function batal(){
			...
			document.getElementById('bayar2').value='';
			document.getElementById('totalobat1').value='';
            document.getElementById('tmp-diskon-dokter').value = "";
            document.getElementById('txtTotalDiskonDokter').value = "0";
            document.getElementById('txtnilaidiskon').value = "0";
        ...
        function deleteDataPembayaranPcr(){
            if(document.getElementById('idPelayananPcr').value == '') return alert('Harap pilih data pembayaran!');
            if(confirm('Yakin Ingin Menghapus Data Pembayaran Ini ?')){
                jQuery.ajax({
                    ...
                    data : {
                        act : 'delete',
                        id : document.getElementById('idPelayananPcr').value,
                    },
                    dataType :'json',
                    success:function(data){
                        if(data.status == 1){
        ...
        function ambilDataPcr2(){
            ...
            console.log(dataPcr);
            document.getElementById('idPelayananPcrCetak').value = dataPcr[0];
            document.getElementById('idPembayaranPcr').value = dataPcr[1];
            document.getElementById('userIdCetak').value = dataPcr[2];
            document.getElementById('btnDeletePembayaranPcr').style.display = 'block';
            jQuery('#btnCetakPcr').attr('disabled',false);

        }
        function cetakPembayaranPcr(){
            let idKunjungan = document.getElementById('idPelayananPcrCetak').value;
            let idPembayaranPcr = document.getElementById('idPembayaranPcr').value;
            let userIdCetak = document.getElementById('userIdCetak').value;
            window.open("cetakPembayaranPcr.php?kunjungan_id="+idKunjungan+"&idBayar="+idPembayaranPcr+"&idUser="+userIdCetak);
        }

        jQuery('#txtdiskon').on('keyup',function(){
            hitungDiskon();
        });
        ...
        /**
         * @author Ismul
         * Pembuatan diskon dokter
         */

         //Get data dokter        
        jQuery('#btn-tambah-diskon-dokter').click(function(){
            addRowDiskon(<?= $userId ?>);
        });

        function addFormDiskonJikaAdaDatanyaPadaForm(val){
            if(val != '' && val != undefined){
                let data = val.split('**');
                console.log(data.length);
                for(let i = 0; i < data.length; i++){
                    let valueForm = data[i].split(':');
                    addRowDiskon(valueForm[0],valueForm[1]);
                }
            }else{
                console.log('ada kesini');
                jQuery('#table-diskon-dokter').append(`<tr>
                            <td>
                                <select id="diskon-dokter-1" name="diskon-dokter-1" class="form-control">
                                    <option value="">-Dokter-</option>
                                </select>
                            </td>
                            <td>
                                <input type="text" name="diskon-dokter-val-1" value="0" id="diskon-dokter-val-1" class="form-control">
                            </td>
                            <td>
                                <button onclick="removeRow(this)" type="button" class="btn btn-sm btn-danger">Delete</button>
                            </td>
                        </tr>`);
                isiCombo('cmbDokSemua','',<?= $userId ?>,'diskon-dokter-1');
            }
        }

        function addRowDiskon(user_id,nominalval = 0){
            //get last child
            let last = document.getElementById('table-diskon-dokter').children[0].children.length;
            
            //get id dokter dari child
            let idDokter = document.getElementById('table-diskon-dokter').children[0].children[last-1].children[0].children[0].id.split('-');
            //set id dokter
            let idDokterElement = idDokter[0] + '-' + idDokter[1] + '-' + (parseInt(idDokter[2]) + 1);            
            //element yang akan di masukan ke table
            let appendElement = `<tr>
                            <td>
                                <select id="${idDokterElement}" name="${idDokterElement}" class="form-control">
                                    <option value="">-Dokter-</option>
                                </select>
                            </td>
                            <td>
                                <input type="text" name="diskon-dokter-val-1" id="diskon-dokter-val-1" value="${nominalval}" class="form-control">
                            </td>
                            <td>
                                <button onclick="removeRow(this)" type="button" class="btn btn-sm btn-danger">Delete</button>
                            </td>
                        </tr>`;
            //masukan ke element table
            jQuery('#table-diskon-dokter').append(appendElement);
            //masukan data dokter ke form
            isiCombo('cmbDokSemua','',user_id,idDokterElement);
        }

        function removeDiskonDokter(){
            //get length data
            let panjang = document.getElementById('table-diskon-dokter').children[0].children.length;
            for(let i = panjang-1; i > -1; i--){
                document.getElementById('table-diskon-dokter').children[0].children[i].children[2].children[0].click();
            }
        }

        function setDiskonDokter(){
            let panjang = document.getElementById('table-diskon-dokter').children[0].children.length;
            let diskonDokterData = "";
            let totalDiskonBeri = 0;
            for(let i = 0; i < panjang; i++){
                let getIdDokter = document.getElementById('table-diskon-dokter').children[0].children[i].children[0].children[0].value;
                let getValueDiskon = document.getElementById('table-diskon-dokter').children[0].children[i].children[1].children[0].value;
                diskonDokterData += getIdDokter + ':' + getValueDiskon + '**';
                totalDiskonBeri += parseInt(getValueDiskon);
            }
            diskonDokterData = diskonDokterData.slice(0,-2);
            jQuery('#tmp-diskon-dokter').val(diskonDokterData);
            jQuery('#txtTotalDiskonDokter').val(totalDiskonBeri);
            alert('Berhasil memasukan diskon dokter');
            hitungDiskon();
            jQuery('#close-btn-diskon').trigger('click');
        }
        ...
        function removeRow(elm){
            ...
            if(panjang > 1){
                ...
                document.getElementById('form-diskon-dokter').reset();
            }
        }

        jQuery('#btn-diskon-dokter').click(function(){
            let diskonFromTmpForm = jQuery('#tmp-diskon-dokter').val();
            addFormDiskonJikaAdaDatanyaPadaForm(diskonFromTmpForm);
        });

        function hitungDiskon(){
            let totalTagihan = jQuery('#lblbiaya').val();
            let keringanan = parseInt(jQuery('#txtKeringanan').val());
            let sudahBayar = parseInt(jQuery('#txtSudahBayar').val());
            let jumlahResep = parseInt(jQuery('#jmlresep').val());
            console.log(jumlahResep);
            //total tagihan di kurangi dengen jumlah resep karena yang bisa di beri diskon hanya billing
            let hasil = totalTagihan - (keringanan + sudahBayar + jumlahResep);
            let diskon = 0;
            let nilaiDiskon = 0;
            if(jQuery('#type-diskon').val() == 2){
                diskon = parseFloat(hasil - (hasil * (jQuery('#txtdiskon').val() / 100)));
                nilaiDiskon = parseFloat((hasil * (jQuery('#txtdiskon').val() / 100)));
                console.log(nilaiDiskon);
            }else{
                diskon = hasil - jQuery('#txtdiskon').val();
                nilaiDiskon = jQuery('#txtdiskon').val();
            }
            if(jQuery('#txtTotalDiskonDokter').val() != '' || jQuery('#txtTotalDiskonDokter').val() != undefined){
                diskon -= jQuery('#txtTotalDiskonDokter').val();
            }
            diskon += jumlahResep;
            jQuery('#txtnilaidiskon').val(nilaiDiskon);
            jQuery('#txtbayar').val(diskon);
        }
    </script>

                ...
                <td colspan="2">
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="1%" align="center" style="font-weight:bold;font-size:16px">:</td>
                            <td width="30%" style="font-size:16px">&nbsp;<?php echo $tglOut;?></td>
                        </tr>
                        <tr>
...
LEFT JOIN b_ms_kelas mKls ON tk.kelas_id=mKls.id WHERE kunjungan_id='$idKunj' AND p.id='".$rwUnit['id']."'";
                        ...
                        <tr>
                            ...
                            <td></td>
                                ...
                                <?php
                                if ($ksoid==1) {
										$sTind="SELECT t.id,DATE_FORMAT(t.tgl,'%d-%m-%Y') tgl,mt.nama nmTind, (t.biaya*t.qty) AS biaya, (t.biaya_pasien*t.qty) AS iurbiaya,(t.biaya_kso*t.qty) AS biaya_kso,t.bayar bayar,t.bayar_kso bayarKSO,t.qty cTind										 
FROM b_tindakan t 
...
INNER JOIN b_ms_unit mu ON t.unit_act=mu.id 
WHERE t.pelayanan_id='".$rwUnit['id']."' AND user_id='".$rwKonsul['user_id']."' ORDER BY t.id";
                                }else {
										$sTind="SELECT t.id,DATE_FORMAT(t.tgl,'%d-%m-%Y') tgl,mt.nama nmTind, (t.biaya*t.qty) AS biaya,(t.biaya_kso*t.qty) AS biaya_kso,(t.biaya_pasien*t.qty) AS iurbiaya,t.bayar bayar,t.bayar_kso bayarKSO,t.qty cTind 
FROM b_tindakan t 
INNER JOIN b_ms_tindakan_kelas mtk ON t.ms_tindakan_kelas_id=mtk.id 
INNER JOIN b_ms_tindakan mt ON mtk.ms_tindakan_id=mt.id 
            ...
            <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-weight:bold;font-size:16px">
                	<tr>
                        ...
                        <td width="10%">&nbsp;</td>
                        <td width="25%" align="center"><? $kotaRS?> <?php gmdate('d F Y',mktime(date('H')+7));?></td>
                    </tr>
                    <tr>

<?php
	...
	$query = "SELECT b.no_kwitansi, b.dibayaroleh, (b.nilai) as nilai,b.nilai_diskon,b.nilai_diskon_dokter,p.nama AS kasir, DATE_FORMAT(b.tgl,'%d %M %Y') AS tgl_bayar
				FROM b_bayar b 
	...
	$bayar = $row['nilai'] - $row['nilai_diskon'] - $row['nilai_diskon_dokter'];

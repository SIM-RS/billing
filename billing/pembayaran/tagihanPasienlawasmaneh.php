...
GROUP BY ao.OBAT_ID";
						...
						<tr>
                            <td align="left" height="20">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td colspan="2" align="right" style="font-weight:bold; border-top:solid #000000 1px; font-size:12px">Grand Total (Tind + Obat)&nbsp;</td>
                            <td align="right" style="font-weight:bold; border-top:solid #000000 1px; font-size:12px"><?php echo number_format(($bTot+$sBiaya),0,",",".");?>&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" height="20">&nbsp;</td>
                            <td align="center">&nbsp;</td>

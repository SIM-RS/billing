...
GROUP BY ao.OBAT_ID";
            ...
            <tr class="kwi" style="display:none">
                <td width="607">&nbsp;</td>
                <td width="293" style="font-weight:bold;font-size:16px"><?=$kotaRS?>, <?php if($rw['tglP']!=''){ 
				echo gmdate('d F Y'),$rw['tglP']); } else { echo gmdate('d F Y',mktime(date('H')+7)); 
				}?>
				<br/>
            ...
            <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-weight:bold;font-size:16px">
                	<tr>
                        ...
                        <td width="10%">&nbsp;</td>
                        <td width="25%" align="center"><?=$kotaRS?>, <?php if($rw['tglP']!=''){ 
							echo gmdate('d F Y'),$rw['tglP']); } else { echo gmdate('d F Y',mktime(date('H')+7)); 
						}?></td>
                    </tr>
                    <tr>

...
?>
	...
	<table width="1000" id="tabel-isi" style="border:1px dashed #000;">
		<tr>
		  ...
		  <td align="center" style="font-weight:bold;"><img src="../images/logo.png" width="61" height="50"  /></td>
		  <td colspan="5" align="left">PT. PELABUHAN INDONESIA I PERSERO <br>RUMAH SAKIT PELABUHAN MEDAN </td>
	  </tr>
		...
		<tr>
			<td height="25" colspan="3" class="kiri" style="font-weight:bold">Rp. <?=currency($bayar).",-&nbsp;&nbsp;&nbsp;";?></td>
            <td>&nbsp;</td>
            <td width="350">&nbsp;</td>

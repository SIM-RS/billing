								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#008484" class="hd2">
									...
									?>
										<td height="32" style="padding-left:20px; text-align:left; font-size:22px; text-transform:uppercase; color:#0000FF; font-weight:bold;">
											...
											Tempat Layanan : <?php echo $rw['nama']?>
										</td>
									</tr>
								</table>
			...
			*/
			...
			function goFilterAndSort(grd){
				if (grd=="gridbox"){
					...
					antrian.loadURL("pelayanankunjungan_utils.php?grd=true&saring=true&idunit=<?php echo $idunit; ?>&filter="+antrian.getFilter()+"&sorting="+antrian.getSorting()+"&page="+antrian.getPage(),"","GET");
				}
			}
		
			antrian = new DSGridObject("gridbox");
			antrian.setHeader("DATA KUNJUNGAN PASIEN");
			antrian.setColHeader("NO ANTRI,NO RM,NAMA,STATUS PASIEN");
			antrian.setIDColHeader(",no_rm,nama,");
			antrian.setColWidth("100,100,450,400");
			antrian.setCellAlign("center,center,left,center");

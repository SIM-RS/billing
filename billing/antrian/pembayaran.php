...
<table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
	<tr>
		<td height="30">&nbsp;DAFTAR ANTRIAN PEMBAYARAN</td>
	</tr>
</table>
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="txtinput">
  ...
  <table border="0" width="1000" cellpadding="0" cellspacing="0" class="hd2">
  <tr height="30">
...
<script>
	...
	a.setColHeader("TANGGAL,NO ANTRIAN,NO RM,NAMA PASIEN,ALAMAT,DESA,STATUS PASIEN,TEMPAT LAYANAN,KELAS,BIAYA,KURANG");
	//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
	a.setColWidth("75,100,50,120,170,100,120,170,75,100,100");
	a.setCellAlign("center,center,center,center,left,left,center,center,center,right,right");
	a.setCellHeight(20);
	a.setImgPath("../icon");

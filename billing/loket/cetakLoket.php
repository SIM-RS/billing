...
INNER JOIN b_ms_tindakan mt ON mtk.ms_tindakan_id=mt.id WHERE t.kunjungan_id = '".$rw1['id']."' AND mt.klasifikasi_id=11 AND mt.id<>2363";
    ...
    <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2" align="center" style="font-size:10px; font-family: verdana;"><?=$kotaRS?>,&nbsp;&nbsp;<?php echo $rw1['tgl'];?></td>
    </tr>
    <tr>
        <td height="50">&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;</td>
        <td align="center" style="font-family: verdana; font-size:10px;">&nbsp;<?php if ($rw1["kso_id"]==1) echo "(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)"; ?></td>
        <td colspan="2" style="text-decoration:underline; font-family: verdana; font-size:10px;" align="center">(<?php echo $rwKasir['nama']; ?>)</td>
    </tr>
    <tr>
        <td><?php echo date('H:i',strtotime($row['tgl_act']));?></td>
        <td align="center">&nbsp;<?php if ($rw1["kso_id"]==1) echo "Kasir"; ?></td>

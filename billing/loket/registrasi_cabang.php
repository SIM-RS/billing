...
<html>
		...
		<span id="fKonfirmasi" style="display:none;"></span>
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="0" class="tabel" align="center">
					...
					//}
                     ?>
						<fieldset style="display:inline-block; float:right;">
                            <legend>Loket</legend>
                            <select id="asal" name="asal" onChange="decUser();batal('1');" style="width:auto" class="txtinputreg"></select>
						</fieldset>
                ...
                <tr>
                    ...
                    <td width="213">&nbsp;NIK :&nbsp;
                        <input name="NoKTP" id="NoKTP" tabindex="2" size="20" class="txtinputreg" maxlength="16" onKeyUp="listPasien(event,'show',this.id)" />
                    ...
                    <td width="193"><input type="text" name="NmOrtu" id="NmOrtu" size="30" tabindex="3" class="txtinputreg" /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">Nama :&nbsp;</td>
                    <td colspan="2"><input type="text" class="txtinputreg requiredField" name="Nama" id="Nama" size="61" tabindex="4" onKeyUp="listPasien(event,'show',this.id)" />                    </td>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        ...
                        &nbsp;Pendidikan :&nbsp;<select name="Pendidikan" id="Pendidikan" tabindex="7" class="txtinputreg"></select>
                        &nbsp;Pekerjaan :&nbsp;<select name="Pekerjaan" id="Pekerjaan" tabindex="8" class="txtinputreg" ></select>                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text" class="txtcenterreg requiredField" maxlength="10" value="<?php echo $date_now;?>" onFocus="this.select();"  onKeyUp="" name="TglLahir" id="TglLahir" size="11" tabindex="9" />
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text" class="txtinputreg" name="Alamat" id="Alamat" size="40" onKeyUp="listPasien(event,'show',this.id)" tabindex="17"  />
			...
			RW. <input type="text" class="txtinputreg" id="rw" name="rw" size="3" tabindex="19" />
                ...
                <tr>
                    ...
                    <td>
                        <select name="TmpLayanan" id="TmpLayanan" tabindex="34" class="txtinputreg requiredField" onChange="this.title=this.value;setKelas('setThrough');cJPasien();"></select>
			...
			Status :&nbsp;
                ...
                <tr>
                    ...
                    <div id="tombol1" style="border:1px solid #CCC; background-color:#FFF; margin-left:15px; padding:5px;">
                        ...
                        <input id="cetak" name="cetak" type="button" value="Cetak Kwitansi" disabled="disabled" onClick="cetak()" />
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function listPasien(feel,how,txtId){
			...
			if(how=='show')
			{
				...
				if(feel.which==13 && keyword!=stuff)
				{
					...
					else
					{
						...
						if(txtId == 'NoRm')
						{
							...
							document.getElementById('div_pasien').style.display='none';	
							//document.getElementById('div_pasien').style.display='block';
							Request('pasien_list.php?act=cari&txt='+txtId+'&keyword='+norm,'div_pasien','','GET',GetPasienByNorm);
						}
						else if(txtId == 'NoKTP')
						{
							stuff = document.getElementById('Nama').value+'<?php echo chr(3);?>'+document.getElementById('Alamat').value+'<?php echo chr(3);?>'+document.getElementById('NoKTP').value; //alert(stuff);
				...
				else if ((feel.which==38 || feel.which==40) && document.getElementById('div_pasien').style.display=='block')
				{
					...
					var url = 'pasien_list.php?act=cari&txt='+txtId+'&keyword='+stuff+'&status=all'; //alert(url);
					Request(url,'div_pasien','','GET');
				}
        ...
        function setPasien(val){
			...
			if (dataPasien.length>29){
				...
				+"*|*NoAnggota*-*"+dataPasien[19]+"*|*HakKelas*-*"+dataPasien[20]+"*|*StatusPenj*-*"+dataPasien[21]+"*|*txtIdKunj*-*"+dataPasien[22]+"*|*TglKunj*-*"+dataPasien[23]+"*|*AslMasuk*-*"+dataPasien[24]+"*|*StatusPas*-*"+dataPasien[18]+"*|*TglSJP*-*"+dataPasien[25]+"*|*NoSJP*-*"+dataPasien[26]+"*|*NoKTP*-*"+dataPasien[32]+"*|*desx*-*"+dataPasien[33]+"*|*kecx*-*"+dataPasien[34]+"*|*kabx*-*"+dataPasien[35]+"*|*prop*-*"+dataPasien[36]+"*|*darah*-*"+dataPasien[37];
				//alert(dataPasien);
    ...
    defaultId => value yang akan diselected
        ...
        function simpan(action)
        {
			...
			if (document.getElementById('btnSimpan').value=="Tambah" || document.getElementById('btnSimpan').value=="Simpan"){
				...
				if (document.getElementById('asal').value==""){
					...
					if(ValidateForm('NoRm,Nama,TglLahir,th,Bln,hari,TglKunj,AslMasuk,cmbProp,cmbKab,StatusPas,cmbKec,cmbDesa,JnsLayanan,TmpLayanan,cmbKelas','ind'))
					{
						...
						if (glob_tmpLay==document.getElementById("TmpLayanan").value && document.getElementById('btnSimpan').value=="Tambah" && document.getElementById("JnsLayanan").value!='44'){
        ...
        function ambilData(multi)
        {
            ...
            var p="txtIdPasien*-*"+sisipan[1]+"*|*txtIdKunj*-*"+sisipan[0]+"*|*NoRm*-*"+sisipan[2]+"*|*NoBiling*-*"+sisipan[3]
                ...
                +"*|*prev_inap*-*"+sisipan[34]+"*|*StatusPenj*-**|*"+defSim+"*|*btnHapus*-*"+disableHapus+"*|*HakKelas*-*"+sisipan[33]+"*|*NoKTP*-*"+sisipan[37]+"*|*prop*-*"+sisipan[44]+"*|*darah*-*"+sisipan[46]+"*|*noReg1*-*"+sisipan[45]+"*|*kabx*-*"+sisipan[43]+"*|*kecx*-*"+sisipan[42]+"*|*desx*-*"+sisipan[41];
	...
	//Diagnosa
	   ...
	   function evUpdtStatusPx(){
        ...
        a.setColHeader("NO,NO RM,NAMA,PENJAMIN,TEMPAT LAYANAN,DOKTER,KELAS,ALAMAT");
        a.setIDColHeader(",no_rm,nama,nama_kso,tempat_layanan,dokter,kelas,alamat");
        a.setColWidth("30,70,200,180,150,180,80,260");
        a.setCellAlign("center,center,left,center,center,left,center,left");
        a.setCellHeight(20);
        a.setImgPath("../icon");

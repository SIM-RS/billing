			...
			if (mysql_errno()==0){
				...
				if($inap == 0) {
					...
					if($tarip != 0) {
						...
						$sqlRetribusi="insert into b_tindakan (ms_tindakan_kelas_id,ms_tindakan_unit_id,ak_ms_unit_id,ak_akun_utip,jenis_kunjungan,kunjungan_id,pelayanan_id,kso_id,kso_kelas_id,kelas_id,tgl,biaya,biaya_pasien,biaya_utip,biaya_kso,bayar,bayar_kso,bayar_pasien,lunas,user_id,type_dokter,tgl_act,user_act,unit_act) values('".$idTindAdm."','".$tmpLayanan."','".$ak_ms_unit_id."','$ak_akun_utip','".$cJenisKunj."','".$idKunj."',".$idPel.",'".$statusPas."','".$hakKelas."','$kelas','$tglKun',".$tarip.",'$beban_pasien','$tarip_utip','$beban_kso',".$bayar.",'$bayar_kso','$bayar_pasien','$lunas','".$_REQUEST['dokter_id']."','".$_REQUEST['dokterPengganti']."',NOW(),$userId,$asal)";

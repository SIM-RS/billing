...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="txtinput">
  ...
  <tr>
    ...
    <td colspan="2">
		...
		<br />
		<table width="300" height="100" cellpadding="0" cellspacing="0" align="right">
							<tr>
								<td colspan="2"><label style="background-color:#00FFFF">Komponen Pembentuk Tarif (201)</label></td>
							</tr>
							<tr class="headtable">
								<td width="50%" align="left">Komponen</td>
  ...
  <tr>
  	<td>&nbsp;</td>
    <td>Kode Panggil&nbsp;&nbsp;&nbsp;<input size="50" /></td>
    <td>&nbsp;</td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
  	...
  	<td>&nbsp;</td>
    <td>Tarif&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input size="50" /></td>
    <td><a href="tarif3.php"><input type="button" value="&nbsp;&nbsp;&nbsp;< 1&nbsp;&nbsp;&nbsp;"></a>&nbsp;<input type="button" disabled="disabled" value="&nbsp;&nbsp;&nbsp;> 2&nbsp;&nbsp;&nbsp;"></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
  ...
  <tr height="30">
   	<td><input type="button" value="&nbsp;&nbsp;&nbsp;Link&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Tambah&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;<input type="button" disabled="disabled" value="&nbsp;&nbsp;&nbsp;Koreksi&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Hapus&nbsp;&nbsp;&nbsp;" /></td>
		<td align="right"><input type="button" value="&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tarif3.php"><input type="button" value="&nbsp;&nbsp;&nbsp;Selesai&nbsp;&nbsp;&nbsp;" /></a></td>
  </tr>
</table>
</div>
</body>
...
a.setHeader("TARIF TINDAKAN DALAM LAYANAN URINE LENGKAP");	
a.setColHeader("KODE PANGGIL,KELAS,TARIF");
//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
a.setColWidth("200,150,150");

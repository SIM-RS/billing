    ...
    <script type="text/javascript">
        function simpan(action){
            if(ValidateForm('txtKodeAk,txtNama,rdInap1,rdInap0,chAktif','ind')){
                ...
                a.loadURL("tmpt_layanan_utils.php?act="+action+"&id="+id+"&kode="+kode+"&kodeAk="+kodeAk+"&nama="+nama+"&level="+level+"&cakupan="+cakupan+"&parentId="+parentId+"&parentKode="+parentKode+"&ket="+ket+"&ktgr="+ktgr+"&inap="+inap+"&aktif="+aktif+"&cabang="+cabang,"","GET");
                batal();
            }
        }

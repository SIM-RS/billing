        ...
        <div align="center">
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="2" align="center" class="tabel">
				...
				<tr>
                    ...
                    <td width="45%">
						<select name="cabang" id="cabang" class="txtinput" onchange="changeCabang(this.value);" disabled>
							<?php 
                ...
                <tr>
                    ...
                    <td width="45%">
                        ...
                        <input type="button" class="btninput" id="btnParent" name="btnParent" value="..." title="Pilih Induk" onClick="OpenWnd('tmpt_layanan_tree_view.php?<?php echo $qstr_ma_sak; ?>&cabang='+document.getElementById('cabang').value,800,500,'msma',true)" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select id="txtKtgr" name="txtKtgr" onchange="setCakupan(this.value)" class="txtinput">
						   ...
						   <?php
						   $qry="select *from b_ms_kategori_unit ";
						   $exe=mysql_query($qry);
						  ...
						  while($show=mysql_fetch_array($exe)){ 
                           ...
                           <!-- <option value="1">Loket</option>
							...
							<option value="<?php echo $show['id'];?>" >  <?php echo $show['kategori'];?></option>
                    		 <?php }?> 
					 
					 </select>  
						
                     <input type="hidden" disabled class="txtinputreg" name="flag" id="flag" size="22" tabindex="3" value="<?php echo $flag; ?>"/>
                ...
                <tr>
                    ...
                    <td><button type="button" id="btnTree" name="btnTree" value="Tampilan Tree" onclick="window.location='tmpt_layanan_tree.php?cabang='+document.getElementById('cabang').value" class="tblViewTree">Tampilan Tree</button></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
    ...
    <script type="text/javascript">
        function simpan(action){
            if(ValidateForm('txtKodeAk,txtNama,rdInap1,rdInap0,chAktif','ind')){
                ...
                a.loadURL("tmpt_layanan_utils.php?act="+action+"&id="+id+"&kode="+kode+"&kodeAk="+kodeAk+"&nama="+nama+"&level="+level+"&cakupan="+cakupan+"&parentId="+parentId+"&parentKode="+parentKode+"&ket="+ket+"&ktgr="+ktgr+"&inap="+inap+"&aktif="+aktif+"&flag="+flag+"&cabang="+cabang,"","GET");
                batal();
            }
        }
		...
		isiCombo('listcabang','','<?php echo $cabang; ?>','cabang','',0);
        ...
        function changeCabang(cab){
            ...
            a.loadURL("tmpt_layanan_utils.php?cabang="+cab,"","GET");
        }
		
        function goFilterAndSort(grd){
            //alert("tmpt_layanan_utils.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage());
			cabang = document.getElementById('cabang').value;
            a.loadURL("tmpt_layanan_utils.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&cabang="+cabang,"","GET");
        }
        ...
        a.baseURL("tmpt_layanan_utils.php?cabang=<?=$cabang?>");
        a.Init();

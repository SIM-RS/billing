...
<table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
	<tr>
		<td height="30">&nbsp;FORM SETTING KLASIFIKASI PENUNJANG</td>
	</tr>
</table>
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="txtinput">  
  ...
  <tr>
    ...
    <td width="25%" align="right">Referensi&nbsp;</td>
    <td width="20%">&nbsp;<select id='cmbTempat'>
		<option></option>
	</select></td>
    <td width="5%">&nbsp;</td>
  </tr>
...
<script>
	...
	//a.setHeader("NAMA LAYANAN");	
	a.setColHeader("NAMA LAYANAN");
	...
	//b.setHeader("NAMA LAYANAN");	
	b.setColHeader("NAMA LAYANAN");
	//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
	b.setColWidth("300");
	b.setCellAlign("left");
	b.setCellHeight(20);

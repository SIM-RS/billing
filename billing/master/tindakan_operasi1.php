    ...
    <body>
        ...
        <div align="center" id="div_tindakan">
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
                <tr>
                    <td height="30">&nbsp;FORM SETTING TINDAKAN OPERASI</td>
                </tr>
            </table>
...
<script type="text/JavaScript" language="JavaScript">
    ...
    function goFilterAndSort(grd){
        if(grd=="gridbox"){
            //alert("tindakan_operasi_utils.php?grd=1&unitId="+document.getElementById('cmbUnit').value+"&filter="+b.getFilter()+"&sorting="+b.getSorting()+"&page="+b.getPage());
    ...
    c.setColHeader("Pilih,Nama Tindakan,Kelompok,Klasifikasi");

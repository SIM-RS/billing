...
<table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
                <tr>
                    <td height="30">&nbsp;MASTER ALAT KEDOKTERAN</td>
                </tr>
            </table>
...
gd_a.baseURL("alat_utils.php?grd=1");
gd_a.Init();
...
gd_b.baseURL("alat_utils.php?grd=2");
gd_b.Init();
...
function kanan(){
	kirimkanan();
	Request("alat_utils.php?act=kanan"+"&data="+data,'temp_diag','','GET',load_grid2,'noload');
}

function kiri(){
	kirimkiri();
	Request("alat_utils.php?act=kiri"+"&data="+data,'temp_diag','','GET',load_grid2,'noload');
}
function goFilterAndSort(abc){
	//alert(abc);
	if (abc=="grid1"){
		gd_a.loadURL("alat_utils.php?grd=1"+"&filter="+gd_a.getFilter()+"&sorting="+gd_a.getSorting()+"&page="+gd_a.getPage(),"","GET");
	}
	if (abc=="grid2"){
		gd_b.loadURL("alat_utils.php?grd=2"+"&filter="+gd_b.getFilter()+"&sorting="+gd_b.getSorting()+"&page="+gd_b.getPage(),"","GET");
	}
}
<!--======================act2==================================================-->
...
function load_grid2(){
	gd_a.loadURL("alat_utils.php?grd=1","","GET");
	gd_b.loadURL("alat_utils.php?grd=2","","GET");
}

...
mTab.setTabCaption("MASTER SATUAN LAB,MASTER KELOMPOK PEMERIKSAAN,TINDAKAN PEMERIKSAAN LAB,NORMAL HASIL LABORATORIUM");
mTab.setTabCaptionWidth("200,250,200,220");
mTab.onLoaded(showgrid);
mTab.setTabPage("lab_tab1.php,lab_tab3.php,lab_tab4.php,lab_tab2.php");
//mTab.
var tab1;
var tab2;
var tab3a;

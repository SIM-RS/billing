...
<script>
	...
	function simpan(action)
	{
		if(ValidateForm('txtPenjamin,txtAlmt','ind'))
		{
			...
			a.loadURL("penjamin_utils.php?grd=1&act="+action+"&id="+id+"&kode=<?php echo $rw['kode']; ?>&nama="+nama+"&kpid="+kpid+"&alamat="+almt+"&telp="+telp+"&fax="+fax+"&kontak="+kontak+"&caktif="+caktif+"&kode="+kode,"","GET");
	...
	function batal()
	{
		var p="txtId*-**|*txtPenjamin*-**|*txtAlmt*-**|*txtTlp*-**|*txtFax*-**|*txtKontak*-**|*txtKodePenjamin*-**|*btnSimpan*-*Tambah*|*btnHapus*-*true";
		fSetValue(window,p);		
	}

...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="txtinput">
  ...
  <tr>
    ...
    <td><a href="tarif2.php"><input type="button" value="&nbsp;&nbsp;&nbsp;< 1&nbsp;&nbsp;&nbsp;"></a>&nbsp;<a href="tarif4.php"><input type="button" value="&nbsp;&nbsp;&nbsp;> 2&nbsp;&nbsp;&nbsp;"></a></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
  ...
  <tr height="30">
   	<td><input type="button" value="&nbsp;&nbsp;&nbsp;Link&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Tambah&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Koreksi&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Hapus&nbsp;&nbsp;&nbsp;" /></td>
		<td align="right"><input type="button" value="&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tarif2.php"><input type="button" value="&nbsp;&nbsp;&nbsp;Selesai&nbsp;&nbsp;&nbsp;" /></a></td>
  </tr>
</table>
</div>
</body>

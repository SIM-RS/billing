...
mTab.setTabCaption("SPESIALISASI PELAKSANA,PELAKSANA LAYANAN,SETTING PELAKSANA");
mTab.setTabCaptionWidth("310,310,320");
mTab.onLoaded(showgrid);
mTab.setTabPage("pel_tab1.php,pel_tab2.php,pel_tab3.php");
...
function showgrid()
{
	...
	tab2.setColHeader("NO,NIP,NAMA,SPESIALISASI");
	tab2.setIDColHeader(",nip,nama,kelompok");
	tab2.setColWidth("20,60,100,60");
	tab2.setCellAlign("center,left,left,left");
	...
	tab3a.setColHeader("pilih,NAMA PELAKSANA");
...
function simpan(action,tabName){
	if(tabName=='tab1'){
		if(ValidateForm("txtKode,txtSpe")){
		...
		tab1.loadURL("pelaksana_layanan_utils.php?grd=tab1&act="+action+"&id="+id+"&spe="+spe+"&aktif="+aktif,"","GET");
		}
	}
	...
	//alert("pelaksana_layanan_utils.php?grd=tab2&act="+action+"&id="+id+"&nip="+nip+"&nama="+nama+"&tmpLhr="+tmpLhr+"&tglLhr="+tglLhr+"&alamat="+alamat+"&tlp="+tlp+"&hp="+hp+"&sex="+sex+"&agama="+agama+"&cmbStatus="+cmbStatus+"&peg="+peg+"&peg2="+peg2+"&spe="+spe+"&uid="+uid+"&pass="+pass+"&conPass="+conPass+"&chAktif="+aktif+"&idUser=<?php echo $userId;?>");
		tab2.loadURL("pelaksana_layanan_utils.php?grd=tab2&act="+action+"&id="+id+"&nip="+nip+"&nama="+nama+"&tmpLhr="+tmpLhr+"&tglLhr="+tglLhr+"&alamat="+alamat+"&tlp="+tlp+"&hp="+hp+"&sex="+sex+"&agama="+agama+"&cmbStatus="+cmbStatus+"&peg="+peg+"&peg2="+peg2+"&spe="+spe+"&uid="+uid+"&pass="+pass+"&conPass="+conPass+"&chAktif="+aktif+"&idUser=<?php echo $userId;?>","","GET");
	}
	batal(tabName);
}
...
function pindahKanan(){
	...
	if(idTin==''){
		...
		tab3b.loadURL("pelaksana_layanan_utils.php?grd=tab3b&act=tambah&id="+idTin+"&unitId="+document.getElementById('TmpLayanan').value,"","GET");
...
function pindahKiri(){		
	...
	if(idTinUnit==''){
		...
		tab3b.loadURL("pelaksana_layanan_utils.php?grd=tab3b&act=hapus&id="+idTinUnit+"&unitId="+document.getElementById('TmpLayanan').value,"","GET");
		idTinUnit='';
	}
}
</script>

...
//include("../koneksi/konek.php");
	...
	FROM
	  b_ms_diagnosa md order by md.kode";
	  ...
	  while ($rows=mysql_fetch_array($rs)){
		...
		//	$rr=$rows["nama"];
			 ...
			 $arfvalue="txtId*-*".$rows['id']."*|*txtKode*-*".$koding."*|*txtDiag*-*".$rows['nama']."*|*txtParentLvl*-*".($rows['level']-1)."*|*txtLevel*-*".$rows['level']."*|*txtParentId*-*".$rows['parent_id']."*|*txtParentKode*-*".$rows['parent_kode']."*|*cmbSur*-*".$rows['surveilance']."*|*isAktif*-*".$chkAktif."*|*txtGol*-*".$txtGol."*|*dg_kode*-*".$dg_kode."*|*act1*-*Edit";
			 $arfvalue=str_replace('"',chr(3),$arfvalue);
			 $arfvalue=str_replace("'",chr(5),$arfvalue);
			 $arfvalue=str_replace(chr(92),chr(92).chr(92),$arfvalue);
			 //pembatas fungsi ini fungsi untuk delete
			 $arfvaluex="txtId*-*".$rows1['id']."*|*txtKode*-*".$koding."*|*txtDiag*-*".$rows1['nama']."*|*txtParentLvl*-*".($rows1['level']-1)."*|*txtLevel*-*".$rows1['level']."*|*txtParentId*-*".$rows1['parent_id']."*|*txtParentKode*-*".$rows1['parent_kode']."*|*cmbSur*-*".$rows1['surveilance']."*|*isAktif*-*".$chkAktif."*|*txtGol*-*".$txtGol."*|*dg_kode*-*".$dg_kode."*|*act1*-*Edit";

...
<script>
	function simpan(action)
	{
		if(ValidateForm('txtKode,txtDiag,txtLevel,cmbSur,isAktif','ind','txtGol'))
		{
			...
			a.loadURL("diag_utils.php?grd=true&act="+action+"&id="+id+"&kode="+kode+"&nama="+nama+"&level="+level+"&parentId="+parentId+"&parentKode="+parentKode+"&sur="+sur+"&aktif="+aktif+"&kdgol="+dg_kode,"","GET");
	...
	a.setColHeader("NO,KODE ICD,DIAGNOSIS ICD,LEVEL,PARE.NT ID,PARENT KODE,SURVEILANCE,ISLAST,STATUS AKTIF,GOL.");
	a.setIDColHeader(",kode,nama,level,,,,,,");
	a.setColWidth("50,75,150,75,75,75,75,75,75,100");
	a.setCellAlign("center,left,left,center,center,center,center,center,center,left");
	a.setCellHeight(20);
	a.setImgPath("../icon");

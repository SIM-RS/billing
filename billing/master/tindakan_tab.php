...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!-- div tindakan-->
        <div align="center" id="div_tindakan" style="height:100%">
            ...
            <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tabel">
                ...
                <!-- <tr>
                    ...
                    <td>&nbsp;<label><input type="hidden" disabled class="txtinputreg" name="flag" id="flag" size="32" tabindex="3" value="<?php echo $flag; ?>"/></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr> -->
                <tr>
                ...
                <tr>
                    ...
                    <td height="30">
                        <input type="button" id="btnSimpan1" name="btnSimpan" value="Tambah" onclick="simpan(this.value);" class="tblTambah"/>
                        <input type="button" id="btnHapus1" name="btnHapus" value="Hapus" onclick="hapus(this.title);" disabled="disabled" class="tblHapus"/>
                        <input type="button" id="btnBatal1" name="btnBatal" value="Batal" onclick="batal()" class="tblBatal"/>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
        ...
        ?>
            ...
            <?  endwhile;
                    ...
                    <td>&nbsp;</td>
                     <td align="right"><input type="button" id="btnKelas" class="btninput" value="Set kelas dan Tarif" onclick="goToKelas()"/>
                     <!-- <a href='import_tindakan/form.php' ><input type="button" id="btnKelas" class="btninput" value="Upload Tindakan"/></a> -->
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
        ...
        <div align="center" id="div_kelas" style="display:none">
            <!--<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="hd2">
                <tr>
            ...
            <table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tabel">
                ...
                <tr>
                    ...
                    <td>&nbsp;<input class="txtinput" id="txtTarif" name="txtTarif" size="16" value="0" />
                ...
                <tr>
                    ...
                    <td>&nbsp;<label><input type="checkbox" size="16" id="txtManual" name="txtManual" class="txtinput" checked="checked"/>&nbsp;Aktif</label></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
    ...
    function saveRA(act){
        ...
        var id_klasifikasi=document.getElementById('id_klasifikasi').value;
        gRA.loadURL('klasifikasi_util.php?act='+act+'&txtRiwayatAlergi='+txtRiwayatAlergi+'&id_klasifikasi='+id_klasifikasi+'&kode_klasifikasi='+kode_klasifikasi+'&flag='+flag+'&status='+status,'','GET');
        batalRA();
    }
    ...
    function saveRB(act){
        ...
        gRB.loadURL('kelompok_util.php?act='+act+'&kelompok_tindakan='+kelompok_tindakan+'&id_kelompok='+id_kelompok+'&kode_kelompok='+kode_kelompok+'&klasi='+klasi+'&status='+status2+'&flag='+flag+'&klasifikasi='+document.getElementById("klasi").value,'','GET');
        batalRB();
    }
    //----------------------------------------//
        ...
        function simpanKelas(action)
        {
            ...
            b.loadURL("tindakan_kls_utils.php?grd=true&act="+action+"&id="+id+"&tindId="+document.getElementById('txtId').value+"&kls="+kls+"&tarif="+tarif+"&aktif="+aktif+"&retribusi="+retribusi+"&param="+param+"&flag="+flag+"&penjamin="+penjamin+"&user_id=<?php echo $user_id; ?>","","GET");
        ...
        function simpan(action)
        {
            if(ValidateForm('txtKode,txtNama,isAktif','ind'))
            {
                ...
                a.loadURL("tindakan_utils.php?grd=true&act="+action+"&id="+id+"&unit="+unit_id+"&kode="+kode+"&nama="+nama+"&kodeAskes="+kodeAskes+"&namaAskes="+namaAskes+"&klasId="+klas_id+"&kelTinId="+kel_id+"&aktif="+aktif+"&flag="+flag+"&icd9cm="+icd9cm,"","GET");
                batal();
                /*

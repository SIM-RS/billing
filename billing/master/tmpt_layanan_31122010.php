...
<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <table width="1000" border="0" cellspacing="0" cellpadding="2" align="center" class="tabel">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label><input type="radio" id="rdInap0" name="rdInap" value="0" checked="checked" />Tidak</label>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
    ...
    <script type="text/javascript">
        function simpan(action){
            if(ValidateForm('txtNama,rdInap1,rdInap0,chAktif','ind')){
                ...
                a.loadURL("tmpt_layanan_utils.php?act="+action+"&id="+id+"&kode="+kode+"&nama="+nama+"&level="+level+"&cakupan="+cakupan+"&parentId="+parentId+"&parentKode="+parentKode+"&ket="+ket+"&ktgr="+ktgr+"&inap="+inap+"&aktif="+aktif,"","GET");
                batal();
            }
        }
        ...
        function ambilData(){		
            ...
            var p="txtId*-*"+sisip[0]+"*|*txtKode*-*"+kodeBaru+"*|*cakupan*-*"+sisip[1]+"*|*txtNama*-*"+a.cellsGetValue(a.getSelRow(),3)+"*|*txtLevel*-*"+a.cellsGetValue(a.getSelRow(),4)+"*|*txtParentLvl*-**|*txtParentKode*-*"+a.cellsGetValue(a.getSelRow(),5)+"*|*txtKet*-*"+a.cellsGetValue(a.getSelRow(),6)+"*|*rdInap0*-*"+((a.cellsGetValue(a.getSelRow(),8)=='Ya')?'false':'true')+"*|*rdInap1*-*"+((a.cellsGetValue(a.getSelRow(),8)=='Ya')?'true':'false')+"*|*chAktif*-*"+((a.cellsGetValue(a.getSelRow(),9)=='Aktif')?'true':'false')+"*|*btnSimpan*-*Simpan*|*btnHapus*-*false";
            fSetValue(window,p);
        ...
        function batal(){
            var p="txtId*-**|*txtKode*-**|*txtNama*-**|*txtLevel*-**|*txtParentLvl*-**|*txtParentId*-**|*txtParentKode*-**|*txtKet*-**|*rdInap0*-*true*|*rdInap1*-*false*|*chAktif*-*true*|*btnSimpan*-*Tambah*|*btnHapus*-*true";
            fSetValue(window,p);
        }

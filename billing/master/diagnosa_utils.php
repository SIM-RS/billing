...
if($grd == "true")
{
	echo $sql="SELECT id,kode,nama,level,parent_id,parent_kode,islast,if(surveilance=1,'Ya','Tidak') as surveilance,if(aktif=1,'Aktif','Tidak') as aktif FROM b_ms_diagnosa where parent_id = '".$_REQUEST['idInduk']."' order by ".$sorting;
}

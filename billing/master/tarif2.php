...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center" class="txtinput">
  ...
  <tr>
  	<td>&nbsp;</td>
    <td>Nama Layanan&nbsp;&nbsp;&nbsp;<input size="50" /></td>
    <td><input type="button" value="&nbsp;&nbsp;&nbsp;Hasil&nbsp;&nbsp;&nbsp;">&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Paket&nbsp;&nbsp;&nbsp;"></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
    <td>Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  type="checkbox" checked="checked" />&nbsp;Paket Pemeriksaan</td>
    <td><a href="tarif1.php"><input type="button" value="&nbsp;&nbsp;&nbsp;< 1&nbsp;&nbsp;&nbsp;"></a>&nbsp;<a href="tarif3.php"><input type="button" value="&nbsp;&nbsp;&nbsp;> 2&nbsp;&nbsp;&nbsp;"></a></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
  ...
  <tr height="30">
   	<td><input type="button" value="&nbsp;&nbsp;&nbsp;Link&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Tambah&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Koreksi&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;Hapus&nbsp;&nbsp;&nbsp;" /></td>
		<td align="right"><input type="button" value="&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tarif1.php"><input type="button" value="&nbsp;&nbsp;&nbsp;Selesai&nbsp;&nbsp;&nbsp;" /></a></td>
  </tr>
</table>
</div>
</body>
...
a.setHeader("LAYANAN DALAM KELOMPOK URINE");	
a.setColHeader("NAMA KELOMPOK LAYANAN,STATUS PAKET");
//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
a.setColWidth("200,200");

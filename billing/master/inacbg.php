...
<tr bgcolor="whitesmoke" style="background-color:#663333; color:#FDFFFA; font-weight:bold; font-size:14px">
    <td align="left" colspan="2">&nbsp;<img title="Level Teratas" onClick="<?php echo "window.location='inacbg_icd9cm.php'" ?>" style="cursor:pointer; width:25" src="../icon/folder_up.png">&nbsp;<img title="Naik 1 Level" onClick="<?php echo "window.location='inacbg_icd9cm.php?PAUI=".$fb[0]."&b=".$fb[1]."'" ?>" style="cursor:pointer; width:25" src="../icon/folder_root.png"></td>
</tr>
<?php
/*

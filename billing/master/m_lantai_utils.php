...
switch(strtolower($_REQUEST['act']))
{
	case 'tambah':
		...
		{
			case 'Pendidikan':
				$sqlTambah="insert into b_ms_pendidikan (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			
			case 'Pekerjaan':
				$sqlTambah="insert into b_ms_pekerjaan (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
				
			case 'Agama':
				$sqlTambah = "INSERT INTO b_ms_agama (agama,aktif) values('".$_REQUEST['agm']."','".$_REQUEST['aktif']."')";
				break;
				
			case 'Asal Rujukan':
				$sqlTambah="insert into b_ms_asal_rujukan (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
				
			case 'Tujuan Rujukan':
				$sqlTambah="insert into b_ms_tujuan_rujukan (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			
			case 'Cara Keluar':
				$sqlTambah="insert into b_ms_cara_keluar (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			
			case 'Keadaan Keluar':
				$sqlTambah="insert into b_ms_keadaan_keluar (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			
			case 'Cara Bayar':
				$sqlTambah="insert into b_ms_cara_bayar (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			
			case 'Daftar Puskesmas':
				$sqlTambah="insert into b_ms_daftar_puskesmas (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
				
			case 'Daftar RS Lain':
				$sqlTambah="insert into b_ms_asal_rumahsakit (namars,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			
			case 'Daftar Dokter Non RS':
				$sqlTambah="insert into b_ms_dokter_nonrs (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
				
			case 'Layanan Lain-Lain':
				$sqlTambah="insert into b_ms_layanan_lain (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
				
			case 'Jenis Kepegawaian':
				$sqlTambah="insert into b_ms_pegawai_jenis (Nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
			case 'Lantai':
				$sqlTambah="insert into b_ms_kamar_lantai (nama,aktif) values('".$_REQUEST['nama']."','".$_REQUEST['aktif']."')";
				break;
	...
	case 'simpan':
		...
		{
			case 'Pendidikan':
				$sqlUpdate="update b_ms_pendidikan set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
				
			case 'Pekerjaan':
				$sqlUpdate="update b_ms_pekerjaan set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Agama':
				$sqlUpdate = "UPDATE b_ms_agama SET agama='".$_REQUEST['agm']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";
			
			case 'Asal Rujukan':
				$sqlUpdate="update b_ms_asal_rujukan set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Tujuan Rujukan':
				$sqlUpdate="update b_ms_tujuan_rujukan set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Cara Keluar':
				$sqlUpdate="update b_ms_cara_keluar set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Keadaan Keluar':
				$sqlUpdate="update b_ms_keadaan_keluar set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Cara Bayar':
				$sqlUpdate="update b_ms_cara_bayar set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Daftar Puskesmas':
				$sqlUpdate="update b_ms_daftar_puskesmas set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
				
			case 'Daftar RS Lain':
				$sqlUpdate="update b_ms_asal_rumahsakit set namars='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			
			case 'Daftar Dokter Non RS':
				$sqlUpdate="update b_ms_dokter_nonrs set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
				
			case 'Layanan Lain-Lain':
				$sqlUpdate="update b_ms_layanan_lain set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
				
			case 'Jenis Kepegawaian':
				$sqlUpdate="update b_ms_pegawai_jenis set Nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
			case 'Lantai':
				$sqlUpdate="update b_ms_kamar_lantai set nama='".$_REQUEST['nama']."',aktif='".$_REQUEST['aktif']."' where id='".$_REQUEST['id']."'";	
				break;
	...
	case 'hapus':
		switch($_REQUEST["ref"])
		{
			...
			case 'Jenis Kepegawaian':
				...
				break;
			case 'Lantai':
				$sqlHapus="delete from b_ms_kamar_lantai where id='".$_REQUEST['rowid']."'";
				break;
...
elseif($grd9 == "true")
{
	$sql = "SELECT id,namars,if(aktif=1,'Aktif','Tidak') as aktif FROM b_ms_asal_rumahsakit".$filter." order by ".$sorting;	
}
elseif($grd10 == "true")
{
...
elseif($grdLantai == "true")
{
	$sql = "SELECT id,nama as nama,if(aktif=1,'Aktif','Tidak') as aktif FROM b_ms_kamar_lantai ".$filter." order by ".$sorting;	
}
...
elseif($grd9 == "true")
{
	...
	{
		$i++;
		$dt.=$rows["id"].chr(3).number_format($i,0,",","").chr(3).$rows["namars"].chr(3).$rows["aktif"].chr(6);
	}
}
elseif($grd10 == "true")
{

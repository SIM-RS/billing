...
<iframe height="72" width="130" name="sort"
 ...
 <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right"><a href="ref_wilayah_kec.php"><input type="button" id="prev" name="prev" value="&nbsp;Prev&nbsp;"/></a>&nbsp;&nbsp;&nbsp;<input type="button" id="next" disabled="disabled" name="next" value="&nbsp;Next&nbsp;"/></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td width="5%">&nbsp;</td>
  ...
  <tr>
  	<td>&nbsp;</td>
    <td align="right">Nama Desa/Kelurahan&nbsp;&nbsp;&nbsp;</td>
    <td><input id="nm_desa" name="nm_desa" size="24" /></td>
    <td>&nbsp;</td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
...
<script>
	...
	a.setColHeader("KODE WILAYAH,NAMA DESA/KELURAHAN");
	//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
	a.setColWidth("100,150");
	a.setCellAlign("center,center");
	a.setCellHeight(20);
	a.setImgPath("../icon");

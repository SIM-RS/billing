...
<iframe height="72" width="130" name="sort"
 ...
 <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
  ...
  <tr>
  	<td>&nbsp;</td>
    <td colspan="3" style="color:#660000" height="30"><b>Data Wilayah (Kota pada Provinsi BALIKPAPAN)</b></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right"><a href="ref_wilayah_prof.php"><input type="button" id="prev" name="prev" value="&nbsp;Prev&nbsp;"/></a>&nbsp;&nbsp;&nbsp;<a href="ref_wilayah_kec.php"><input type="button" id="next" name="next" value="&nbsp;Next&nbsp;"/></a></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td width="5%">&nbsp;</td>
  ...
  <tr>
  	<td>&nbsp;</td>
    <td align="right">Nama Kab/Kodya&nbsp;&nbsp;&nbsp;</td>
    <td><input id="nm_kab" name="nm_kab" size="24" /></td>
    <td>&nbsp;</td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
...
<script>
	...
	a.setColHeader("KODE WILAYAH,JUMLAH KAB/KODYA,JUMLAH KECAMATAN,JUMLAH DESA/KELURAHAN");
	//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
	a.setColWidth("100,150,150,150");

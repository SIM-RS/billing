...
<script>
	function simpan(action)
	{
		if(ValidateForm('txtKode,txtDiag,txtLevel,cmbSur,isAktif','ind','txtGol'))
		{
			...
			a.loadURL("diag_utils.php?grd=true&act="+action+"&id="+id+"&kode="+kode+"&nama="+nama+"&level="+level+"&parentId="+parentId+"&parentKode="+parentKode+"&sur="+sur+"&aktif="+aktif+"&kdgol="+dg_kode+"&emergency="+emergency,"","GET");

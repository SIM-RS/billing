...
<script>
	...
	function simpan(action)
	{
		if(ValidateForm('txtPenjamin,txtAlmt','ind'))
		{
			...
			var kpid = document.getElementById("idKepemilikan").value;
			...
			var kode = document.getElementById("txtKodePenjamin").value;
			var caktif=1;
			
			if (document.getElementById("chkAktif").checked==false) caktif=0;
			...
			a.loadURL("penjamin_utils.php?grd=1&act="+action+"&id="+id+"&kode=<?php echo $rw['kode']; ?>&nama="+nama+"&kpid="+kpid+"&alamat="+almt+"&telp="+telp+"&fax="+fax+"&kontak="+kontak+"&caktif="+caktif+"&kode="+kode+"&flag="+flag+"&margin="+margin,"","GET");
			...
			document.getElementById("txtKodePenjamin").value = '';
	...
	function ambilData()
	{
		...
		var p="txtId*-*"+sisip[0]+"*|*idKepemilikan*-*"+sisip[2]+"*|*txtMargin*-*"+sisip[3]+"*|*txtKodePenjamin*-*"+a.cellsGetValue(a.getSelRow(),1)+"*|*txtPenjamin*-*"+a.cellsGetValue(a.getSelRow(),2)+"*|*txtAlmt*-*"+a.cellsGetValue(a.getSelRow(),4)+"*|*txtTlp*-*"+a.cellsGetValue(a.getSelRow(),5)+"*|*txtFax*-*"+a.cellsGetValue(a.getSelRow(),6)+"*|*txtKontak*-*"+a.cellsGetValue(a.getSelRow(),7)+"*|*btnSimpan*-*Simpan*|*btnHapus*-*false";
		fSetValue(window,p);
		document.getElementById('btnDet').style.display='block';
		
		document.getElementById('ksoId').value=sisip[0];
		if (sisip[1]==1){
			document.getElementById('chkAktif').checked=true;
		}else{
			document.getElementById('chkAktif').checked=false;
		}
	...
	function batal()
	{
		var p="txtId*-**|*txtMargin*-**|*txtPenjamin*-**|*txtAlmt*-**|*txtTlp*-**|*txtFax*-**|*txtKontak*-**|*txtKodePenjamin*-**|*btnSimpan*-*Tambah*|*btnHapus*-*true";
		fSetValue(window,p);		
	}
	
	function detKso(){
		location="detail_kso.php?ksoId="+document.getElementById('ksoId').value;
	}
	...
	function pindahKanan(){
		if(document.getElementById('cmbKso').value=='' ){
			...
			c.loadURL("penjamin_utils.php?grd=3&act=tambah&id="+idTin+"&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			b.loadURL("penjamin_utils.php?grd=2&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			idTin='';
			}
		}
	...
	function pindahKiri(){
		if(document.getElementById('cmbKso').value=='' ){
			...
			c.loadURL("penjamin_utils.php?grd=3&act=hapus&id="+idTdk+"&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			b.loadURL("penjamin_utils.php?grd=2&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			idTdk='';
			}
		}		
	...
	function simpanHP(action){
		if(ValidateForm('txtNilaiJamin','ind'))
		{
			...
			e.loadURL("penjamin_utils.php?grd=5&act="+action+"&ksoId="+idKso+"&id="+id+"&kelas="+kelas+"&flag="+flag+"&nilai="+nilai,"","GET");
			batalHP();			
		}
	}
	...
	function simpanPaket(action){
		if(ValidateForm('txtPaket,txtNilaiPaket,cmbInstalPaket,cmbStatusPaket,cmbFrekPaket','ind'))
		{
			...
			var flag = document.getElementById('flag').value;
			//alert("penjamin_utils.php?grd=true&act="+action+"&id="+id+"&kode=<?php echo $rw['kode']; ?>&nama="+nama+"&alamat="+almt+"&telp="+telp+"&fax="+fax+"&kontak="+kontak);
			f.loadURL("penjamin_utils.php?grd=6&act="+action+"&ksoId="+idKso+"&id="+id+"&nama="+nama+"&nilai="+nilai+"&instal="+instal+"&flag="+flag+"&status="+status+"&frekuensi="+frekuensi,"","GET");
			batalPaket();			
		}
	}
	...
	function pindahKananPaket(){		
		...
		//alert("penjamin_utils.php?grd=3&act=tambah&id="+idTin+"&ksoId="+idKso);
		h.loadURL("penjamin_utils.php?grd=8&act=tambah&id="+dataTind+"&paketId="+idPaket+"&flag="+document.getElementById('flag').value,"","GET");
		g.loadURL("penjamin_utils.php?grd=7&paketId="+idPaket+"&flag="+document.getElementById('flag').value,"","GET");
		dataTind='';
		}
	}
	var dataDetil='';
	function pindahKiriPaket(){
		...
		if(dataDetil==''){
			...
			h.loadURL("penjamin_utils.php?grd=8&act=hapus&id="+dataDetil+"&paketId="+idPaket+"&flag="+document.getElementById('flag').value,"","GET");
			g.loadURL("penjamin_utils.php?grd=7&paketId="+idPaket+"&flag="+document.getElementById('flag').value,"","GET");
			dataDetil='';
		}
	...
	function pindahLuarPaketKanan(){		
		...
		m.loadURL("penjamin_utils.php?grd=10&act=tambah&id="+dataTindLuar+"&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
		l.loadURL("penjamin_utils.php?grd=9&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
		dataTindLuar='';
		}
	}
	...
	function pindahLuarPaketKiri(){
		...
		if(dataTindLuarPaket==''){
			...
			//alert("penjamin_utils.php?grd=10&act=tambah&id="+dataTindLuar+"&ksoId="+idKso);
			m.loadURL("penjamin_utils.php?grd=10&act=hapus&id="+dataTindLuarPaket+"&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			l.loadURL("penjamin_utils.php?grd=9&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			dataTindLuarPaket='';
		}
	...
	function pindahAkomodasiKanan(){		
		...
		if(dataAkomodasiKiri==''){
			...
			//alert("penjamin_utils.php?grd=10&act=tambah&id="+dataTindLuar+"&ksoId="+idKso);
		n.loadURL("penjamin_utils.php?grd=12&act=tambah&id="+dataAkomodasiKiri+"&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
		n0.loadURL("penjamin_utils.php?grd=11&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
		dataAkomodasiKiri='';
		}
	}
	var dataAkomodasi='';
	function pindahAkomodasiKiri(){
		...
		if(dataAkomodasi==''){
			...
			//alert("penjamin_utils.php?grd=10&act=tambah&id="+dataTindLuar+"&ksoId="+idKso);
			n.loadURL("penjamin_utils.php?grd=12&act=hapus&id="+dataAkomodasi+"&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			n0.loadURL("penjamin_utils.php?grd=11&ksoId="+idKso+"&flag="+document.getElementById('flag').value,"","GET");
			dataAkomodasi='';
		}
	...
	function showgrid(){
		...
		a.setColHeader("KODE,NAMA PENJAMIN,KEPEMILIKAN,ALAMAT,TELEPON,FAX,KONTAK,AKTIF");
		a.setIDColHeader("kode,nama,kepemilikan,,,,,aktif");
		a.setColWidth("50,250,100,300,100,100,100,80");
		a.setCellAlign("center,left,center,left,left,left,left,center");
		a.setCellHeight(20);
		a.setImgPath("../icon");
		...
		b.setIDColHeader(",Nama,kelompok,klasifikasi");
		...
		c.setColHeader("<input type='checkbox' id='chk_c' onchange='cek_all(this.id)' />,Tindakan,Kelompok,Klasifikasi");
		...
		l.setColHeader("<input type='checkbox' id='chk_l' onchange='cek_all(this.id)' />,Nama tindakan,Kelompok,Klasifikasi");
		...
		m.setColHeader("<input type='checkbox' id='chk_m' onchange='cek_all(this.id)' />,Nama tindakan,Kelompok,Klasifikasi,Biaya");
		m.setIDColHeader(",nama,kelompok,klasifikasi,nilai");
		m.setColWidth("30,250,200,100,100");
		m.setCellAlign("left,left,left,center,right");
		...
		n0.setColHeader("<input type='checkbox' id='chk_n0' onchange='cek_all(this.id)' />,Nama tindakan,Kelompok,Klasifikasi");
		...
		n.setColHeader("<input type='checkbox' id='chk_n' onchange='cek_all(this.id)' />,Nama tindakan,Kelompok,Klasifikasi");
	...
	function cek_all(a){
		if(a=='chk_b'){
			...
			if(document.getElementById(a).checked){
				for(var i=0;i<l.obj.childNodes[0].rows.length;i++){	
					l.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = true;		
				}
			}
			else{
				for(var i=0;i<l.obj.childNodes[0].rows.length;i++){	
					l.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = false;		
				}
			}
		}
		else if(a=='chk_m'){
			if(document.getElementById(a).checked){
				for(var i=0;i<m.obj.childNodes[0].rows.length;i++){	
					m.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = true;		
				}
			}
			else{
				for(var i=0;i<m.obj.childNodes[0].rows.length;i++){	
					m.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = false;		
				}
			}
		}
		else if(a=='chk_n0'){
			if(document.getElementById(a).checked){
				for(var i=0;i<n0.obj.childNodes[0].rows.length;i++){	
					n0.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = true;		
				}
			}
			else{
				for(var i=0;i<n0.obj.childNodes[0].rows.length;i++){	
					n0.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = false;		
				}
			}
		}
		else if(a=='chk_n'){
			if(document.getElementById(a).checked){
				for(var i=0;i<n.obj.childNodes[0].rows.length;i++){	
					n.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = true;		
				}
			}
			else{
				for(var i=0;i<n.obj.childNodes[0].rows.length;i++){	
					n.obj.childNodes[0].childNodes[i].childNodes[0].childNodes[0].checked = false;		
				}
			}
		}
	}

...
<table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
	<tr>
		<td height="30">&nbsp;FORM MASTER KAMAR</td>
	</tr>
</table>
...
<table width="1000" border="0" cellspacing="1" cellpadding="0" align="center" class="tabel">
  ...
  <tr>
    ...
    <td colspan="3" align="center">
		...
		<div id="paging2" style="width:900px;padding-top:20px;"></div>	</td>
    <td width="5%">&nbsp;</td>
  </tr>
  <tr>
	<td width="5%">&nbsp;</td>
...
<script>
	...
	{		
		if(ValidateForm('txtKode,txtNama,cmbUnit','ind'))
		{
			...
			a.loadURL("kamar_utils.php?grd=true&act="+action+"&id="+id+"&unit="+unit_id+"&kode="+kode+"&nama="+nama+"&jmlTT="+jmlTT+"&jmlTTB="+jmlTTB+"&aktif="+aktif,"","GET");
	...
	function simpanTarif(action)
	{
		...
		b.loadURL("kamar_utils.php?grd2=true&act="+action+"&id="+id+"&idKamar="+idKamar+"&unit="+unit_id+"&tarif="+tarif+"&kelas="+kelas,"","GET");
		batalTarif();
	}
	...
	function ambilData()
	{
		...
		var p="txtId*-*"+sisipan[0]+"*|*txtKode*-*"+a.cellsGetValue(a.getSelRow(),2)+"*|*txtNama*-*"+a.cellsGetValue(a.getSelRow(),3)+"*|*cmbJnsLay*-*"+sisipan[2]+"*|*txtJmlTT*-*"+a.cellsGetValue(a.getSelRow(),5)+"*|*txtJmlTTB*-*"+a.cellsGetValue(a.getSelRow(),6)+"*|*isAktif*-*"+((a.cellsGetValue(a.getSelRow(),7)=='Aktif')?'true':'false')+"*|*btnSimpan*-*Simpan*|*btnHapus*-*false";
		//alert(p);
		fSetValue(window,p);
	...
	function ambilDataTarif()
	{
		...
		var p="txtIdTarif*-*"+sisipan[0]+"*|*txtTarif*-*"+b.cellsGetValue(b.getSelRow(),3)+"*|*cmbJnsLay*-*"+sisipan[3]+"*|*cmbKls*-*"+sisipan[1]+"*|*btnSimpanTarif*-*Simpan*|*btnHapusTarif*-*false";
		//alert(p);
		fSetValue(window,p);
	...
	a.setHeader("KAMAR");	
	a.setColHeader("NO,KODE,NAMA KAMAR,UNIT,TEMPAT TIDUR,TEMPAT TIDUR BAYANGAN,STATUS AKTIF");
	a.setIDColHeader(",kode,nama,unit,,");
	a.setColWidth("30,50,160,160,100,120,100");
	a.setCellAlign("center,left,left,left,center,center,center");
	a.setCellHeight(20);
	a.setImgPath("../icon");
	...
	b.setColHeader("NO,UNIT,NAMA KAMAR,KELAS,TARIF KAMAR");
	b.setIDColHeader(",unit,nama,kelas,");
	b.setColWidth("30,200,200,200,200");
	b.setCellAlign("center,left,left,center,right");
	b.setCellHeight(20);
	b.setImgPath("../icon");

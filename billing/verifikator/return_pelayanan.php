    ...
    <iframe height="72" width="130" name="sort"
        ...
        <iframe height="193" width="168" name="gToday:normal:agenda.js"
         ...
         <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center" >
                <tr>
                    <td height="30">&nbsp;Form Return Pelayanan</td>
                    <td align="right"><img src="../icon/close.png" id="btnClose" style="cursor:pointer" onClick="tutupFormReturn()"></td>
                </tr>
            </table>
            
    <div id="list_return" style="display:block">
    <input type="hidden" id="val" />
    <input type="hidden" id="no_rm" />
    <input type="hidden" id="no_ret" />
	<table width="1000" border="0" cellpadding="0" style="background:#FFFFFF;" cellspacing="0" align="center">
                <tr>
                	<td>&nbsp;</td>
                </tr>
                <tr>
				  ...
				  <img src="../images/plus.jpg" width="30" height="30" style="cursor:pointer" onClick="tambah()" title="Klik untuk menambah data"/>&nbsp;
				  <img src="../images/edit.jpg" width="30" height="30" title="Klik untuk mengedit data" onClick="buka()" style="cursor:pointer" />&nbsp; 
				  <img src="../images/del.jpg" width="30" height="30" title="Klik untuk menghapus data" onClick="hapusReturn()" style="cursor:pointer" /></td>
                </tr>
                <tr>
                    <td height="30" colspan="2">
					<div id="gridReturn" style="width: 990px; height:500px; border:none; display:block"></div>
       ...
       <div id="form_return" style="display:none">     
            <table width="1000" border="1" cellspacing="0" cellpadding="0" class="txtinput" align="center" height="450">
                <tr>
                    <td valign="top" height="50" style="background-color:#99CAF2;">
                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px; font-family:verdana;">
                            ...
                            <tr>                                
                                <td colspan="3">No. Return : <input type="text" id="no_return" name="no_return" class="txtinput" value="" ></td>
                                <td colspan="3">Flag : <input type="hidden" disabled class="txtinputreg" name="flag" id="flag" size="15" tabindex="30" value="<?php echo $flag; ?>"/></td>
                ...
                <tr>
                    <td valign="top">
                        <fieldset>
                            ...
                            <input type="button" size="3" id="btnShowTinDown" value="&or;" style="display:inline;cursor:pointer;" onClick="document.getElementById('divTindakan').style.height='0px';document.getElementById('divTableTindakan').style.height='300px';this.style.display='none';document.getElementById('btnShowTinUp').style.display='inline';"/>
                            <input type="button" size="3" id="btnShowTinUp" value="&and;" style="display:none;cursor:pointer;" onClick="document.getElementById('divTindakan').style.height='0px';document.getElementById('divTableTindakan').style.height='0px';this.style.display='none';document.getElementById('btnShowTinDown').style.display='inline';"/>
                            ...
                            <div id="divTableTindakan" align="center"  style="overflow:auto;height:0px;">
                                <div id="gb" style="width: 950px; height:270px; border:none; display:block"></div>
            					<div id="pg" style="width: 950px; display:none"></div>
                            </div>
                    ...
                    <td valign="top">
                        <fieldset>
                            ...
                            <div id="divTindakankamar_" align="center" style="height:0px; overflow:auto">
                                 <div id="gbtk" style="width: 950px; height:250px; border:none; display:block"></div>
                                 <!--br><br-->
            					 <div id="pgtk" style="width: 950px; display:none"></div>
                            </div>
                ...
                <tr>
                    <td valign="top">
      						 ...
      						 <div align="center">
                             <br>
                            <button type="button" onClick="prosesHapus()" style="cursor:pointer"><img src="../images/arrow_up.png" width="25" align="absmiddle">&nbsp;&nbsp;Batal</button>
                            <button type="button" onClick="prosesReturn()" style="cursor:pointer"><img src="../images/arrow_down.png" width="25" align="absmiddle">&nbsp;Return</button>
                            <button type="button" onClick="cetakReturn()" style="cursor:pointer"><img src="../icon/printer.png" width="25" align="absmiddle">&nbsp;Cetak Return</button><br><br>
                            </div>
                            <div id="divReturnTindakan" align="center"  style="overflow:auto;height:300px;">
                                <div id="gbr" style="width: 950px; height:270px; border:none; display:block"></div>
            					<div id="pgr" style="width: 950px; display:none"></div>
                            </div>
            ...
            <script>
                ...
                function setPasien(val){
                   ...
                   // Request('koreksi_utils.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&tabel=pelayanan'+'&jnsRwt='+jnsRwt,'divPelayanan','','GET',afterPel,'ok');
					...
					ggr.loadURL('return_pelayanan_util.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt,'','GET');
		...
		//alert(ev.which);
                ...
                function simpan(id){
                    ...
                    Request('koreksi_utils.php?id='+id+'&tgl='+tgl+'&idTind='+idTind+'&jml='+jml+'&biaya='+biaya+'&biayaKso='+biayaKso+'&biayaPasien='+biayaPasien+'&bayarPasien='+bayarPasien+'&statusVer='+statusVer+'&act=save&idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&tabel=tindakan'+'&jnsRwt='+jnsRwt+'&flag='+flag+'&IdUser='+cIdUser,'divTindakan','','GET',getCatatan,'ok');
                    if(jnsRwt=='1'){
                        Request('koreksi_utils.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&tabel=tindakan_kamar','divTindakanKamar','','GET');
                        document.getElementById('trTinKamar').style.visibility="visible";
                    }
                ...
                function simpanKamar(id){
                    ...
                    Request('koreksi_utils.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&tabel=tindakan'+'&flag='+flag+'&jnsRwt='+jnsRwt,'divTindakan','','GET',getCatatan,'ok');
                    if(jnsRwt=='1'){
                        ...
                        Request('koreksi_utils.php?id='+id+'&unit='+unit+'&kamar='+kamar+'&kelas='+kelas+'&tglIn='+tglIn+'&tglOut='+tglOut+'&statusOut='+statusOut+'&bebanKso='+bebanKso+'&bebanPasien='+bebanPasien+'&act=save_kamar&idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&tabel=tindakan_kamar'+'&flag='+flag+'&IdUser='+cIdUser,'divTindakanKamar','','GET','','ok');
                        document.getElementById('trTinKamar').style.visibility="visible";
                    }
                    else{
                        document.getElementById('trTinKamar').style.visibility="collapse";
                ...
                function simpanKunjungan(id){
                    ...
                    Request('koreksi_utils.php?kid='+id+'&pulang='+pulang+'&tglSJP='+tglSJP+'&tglMsk='+tglMsk+'&tglPlg='+tglPlg+'&kelas_id='+kelas_id+'&baruLama='+baruLama+'&kso_id='+kso_id+'&flag='+flag+'&kso_kelas_id='+kso_kelas_id+'&act=save&idKunj='+dataPasien[8]+'&tabel=kunjungan','divKunjungan','','GET',afterKunj,'ok');                   
                ...
                function simpanPelayanan(id){
                    ...
                    Request('koreksi_utils.php?pid='+id+'&pTgl='+pTgl+'&pKsoId='+pKsoId+'&pKelasId='+pKelasId+'&pTglKRS='+pTglKRS+'&dilayani='+dilayani+'&act=save&idKunj='+dataPasien[8]+'&flag='+flag+'&tabel=pelayanan'+'&jnsRwt='+jnsRwt,'divPelayanan','','GET',afterPel,'ok');
                ...
                function tambahKamar(){
                    ...
                    Request('koreksi_utils.php?&pelayanan='+pelayanan+'&tkKamar='+kamar+'&tarip='+tarip+'&bayar='+bayar+'&bayarpasien='+bayarpasien+'&idPasien='+dataPasien[0]+'&flag='+flag+'&idKunj='+dataPasien[8]+'&act=tambah_kamar&tabel=tindakan_kamar','divTindakanKamar','','GET','','ok');
					tk.loadURL('tindakan_kamar_util.php?idPasien='+document.getElementById('txtIdPasien').value+'&idKunj='+document.getElementById('txtKunjId').value+'&jnsRwt='+document.getElementById('cmbJnsRwt').value+'&flag='+document.getElementById('flag').value,'','GET');
                }
...
function editTindakanKamar(){
	...
	Request('koreksi_utils.php?id='+id+'&unit='+unit+'&kamar='+kamar+'&kelas='+kelas+'&tglIn='+tglIn+'&tglOut='+tglOut+'&statusOut='+statusOut+'&bebanKso='+bebanKso+'&bebanPasien='+bebanPasien+'&act=save_kamar&idPasien='+document.getElementById('txtIdPasien').value+'&idKunj='+document.getElementById('txtKunjId').value+'&flag='+document.getElementById('flag').value+'&tabel=tindakan_kamar'+'&IdUser='+cIdUser,'getNote','','GET');
	alert('success');
...
function editPelayanan(){
   var jnsRwt = document.getElementById('cmbJnsRwt').value; 
	...
	//alert('success');
    g.loadURL('pelayanan_util.php?pid='+id+'&pTgl='+pTgl+'&pKsoId='+pKsoId+'&pKelasId='+pKelasId+'&pTglKRS='+pTglKRS+'&flag='+flag+'&dilayani='+dilayani+'&act=save&idPasien='+document.getElementById('txtIdPasien').value+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt,'','GET');
}
...
function editTindakan(){
	...
	Request('koreksi_utils.php?id='+id+'&tgl='+tgl+'&idTind='+idTind+'&jml='+jml+'&biaya='+biaya+'&biayaKso='+biayaKso+'&flag='+flag+'&biayaPasien='+biayaPasien+'&bayarPasien='+bayarPasien+'&statusVer=&act=save&idPasien='+document.getElementById('txtIdPasien').value+'&idKunj='+document.getElementById('txtKunjId').value+'&tabel=tindakan'+'&jnsRwt='+document.getElementById('cmbJnsRwt').value+'&IdUser='+cIdUser,'getNote','','GET');
	alert('success');
...
function saveTambahResep(){
	...
	rsp.loadURL('resep_util.php?grid=1&act=tambah&data='+data+'&idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&jnsRwt='+document.getElementById('cmbJnsRwt').value+'&flag='+document.getElementById('flag').value,'','GET');
...
function tambahResep(){
	...
	rr.loadURL('resep_util.php?grid=3&tgl1='+document.getElementById('tglrsp1').value+'&flag='+document.getElementById('flag').value,'','GET');
}
...
function prosesReturn(){
	...
	if(proses==false){
		alert('Pilih/cek tindakan yang ingin di return');
		return false;
	}
	var no_return = document.getElementById('no_return').value;
	//alert("proses_return.php?retur=ya&no_return="+no_return+"&fdata="+fdata);
	Request("proses_return.php?retur=ya&no_return="+no_return+"&fdata="+fdata,'divSelesai','','GET',habisReturn,'noLoad');
}
...
rt.setHeader(" ",false);
rt.setColHeader("No,Tanggal,No Return,Tgl Kunjungan,Tempat Layanan,No RM,Nama Pasien,Alamat");
//rt.setIDColHeader(",kode,nama,ket,");
rt.setColWidth("30,70,70,70,70,70,150,200");
rt.setCellAlign("center,center,left,center,left,center,left,left");
rt.setCellType("txt,txt,txt,txt,txt,txt,txt,txt");
rt.setCellHeight(20);
rt.setImgPath("../icon");
rt.setIDPaging("pagingReturn");
rt.attachEvent("onRowClick","ambilPel");
rt.onLoaded(konfirmasi);
rt.baseURL("list_return_util.php?bln=<?php echo date('m'); ?>&thn=<?php echo date('Y'); ?>");
rt.Init();
...
function ambilPel(){
	var no_rm=rt.cellsGetValue(rt.getSelRow(),6);
...
function hapusReturn(){
	...
	if(confirm('Yakin ingin mengapus data ini ???')){
		rt.loadURL("list_return_util.php?act=hapus&no_return="+document.getElementById('no_ret').value,'','GET');
	}
	rt.loadURL("list_return_util.php",'','GET');
}
...
function tutupFormReturn(){
	...
	rt.loadURL("list_return_util.php?bln="+document.getElementById('cmbBulan').value+"&thn="+document.getElementById('cmbTahun').value,'','GET');
}
...
function setKosong(){
	...
	ggr.loadURL('return_pelayanan_util.php?idPasien=0&idKunj=0&jnsRwt=0','','GET');
...
function cetakReturn(){
	window.open('lap_return_pelayanan.php?idKunj='+dataPasien[8]+'&jnsRwt='+document.getElementById('cmbJnsRwt').value);
}

...
switch(strtolower($tabel)){
    ...
    case 'tindakan':
        ...
        if($_REQUEST['act']=='save'){
            $sqlUpdate="update b_tindakan set ms_tindakan_kelas_id='$idTind',tgl='".tglSQL($tgl)."',qty='$jml',biaya='$biaya',biaya_kso='$biayaKso',biaya_pasien='$biayaPasien',bayar='".$jml*$bayarPasien."',bayar_pasien='$bayarPasien'".$fUser." where id='$id'";
			//echo $sqlUpdate."<br>";
            if(mysql_query($sqlUpdate)){
                $notice='Simpan Berhasil!';

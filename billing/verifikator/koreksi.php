        ...
        <iframe height="193" width="168" name="gToday:normal:agenda.js"
         ...
         <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
            ...
            <table width="1000" border="1" cellspacing="0" cellpadding="0" class="txtinput" align="center" height="450">
                <tr>
                    <td valign="top" height="50" style="background-color:#66CC66;">
                        <fieldset>
...
g.setHeader(" ",false);
g.setColHeader("No,Jenis Layanan,Tempat Layanan,Tempat Layanan Asal,Penjamin (KSO),Kelas,Tanggal Datang,Tanggal Pulang,Dokter Tujuan,Status Dilayani,Proses");
//g.setIDColHeader(",kode,nama,ket,");
g.setColWidth("30,100,90,70,70,70,70,70,100,70,70");
g.setCellAlign("center,left,left,left,left,left,center,center,left,center,center");
...
function ambilPel(){
	...
	document.getElementById('tempat_layanan_id').value=sisipan[2];
	document.getElementById('cek_inap').value=sisipan[5];
	//alert(sisipan[0]);
	...
	if(sisipan[8] == 0){
			isiCombo('cmbDok',unit,sisipan[7],'cmbDokTujuanUnitInap');
			document.getElementById('chkDokterPenggantiTujuanUnitInap').checked = false;
	}
	else{
		isiCombo('cmbDokPengganti',unit,sisipan[7],'cmbDokTujuanUnitInap');
		document.getElementById('chkDokterPenggantiTujuanUnitInap').checked = true;
	}
...
function gaksido(){
	...
	document.getElementById('tempat_layanan').value='';
	document.getElementById('layanan_asal').value='';
	document.getElementById('penjamin').value='';
	document.getElementById('kelas').value='';
	document.getElementById('tanggal_datang').value='';
	document.getElementById('tanggal_pulang').value='';
	document.getElementById('status').value='';
	document.getElementById('penjamin_id').value='';
	document.getElementById('pelayanan_id').value='';
	document.getElementById('tempat_layanan_id').value='';
	document.getElementById('cek_inap').value='';
}

function gantiDokterTujuanInap(comboDokter,statusCek){
	if(statusCek==true){
		isiCombo('cmbDokPengganti',document.getElementById('tempat_layanan_id').value,'','cmbDokTujuanUnitInap');
	}
	else{
		isiCombo('cmbDok',document.getElementById('tempat_layanan_id').value,'','cmbDokTujuanUnitInap');
	}	
}
...
function editPelayanan(){
   var jnsRwt = document.getElementById('cmbJnsRwt').value; 
	...
	var inap = document.getElementById('cek_inap').value;
	var idDokTujuanUnitInap = document.getElementById('cmbDokTujuanUnitInap').value;
	var isDokTujuanPengganti = 0;
	if(document.getElementById("chkDokterPenggantiTujuanUnitInap").checked == true){
	...
	//alert('success');
    g.loadURL('pelayanan_util.php?pid='+id+'&pTgl='+pTgl+'&pKsoId='+pKsoId+'&pKelasId='+pKelasId+'&pTglKRS='+pTglKRS+'&dilayani='+dilayani+'&act=save&idPasien='+document.getElementById('txtIdPasien').value+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt+'&sCout='+sCout+'&sBtl='+sBtl+'&usrId='+usrId+'&inap='+inap+'&idDokTujuan='+idDokTujuanUnitInap+'&isDokTujuanPengganti='+isDokTujuanPengganti,'','GET');
}
...
<div id="popPelayanan" style="display:none; width:700px" class="popup">
<table border="0" cellpadding="0" cellspacing="1" align="center" class="tabel">
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td>
			<input type="hidden" id="tempat_layanan_id" name="tempat_layanan_id" />
			<input type="hidden" id="cek_inap" name="cek_inap" />
			<input id="tempat_layanan" name="tempat_layanan" size="40" class="txtinput" readonly></td>
        <td colspan="2" rowspan="4" valign="top">&nbsp;
	   </td>
    </tr>
    <tr>
	...
	<tr id="trDokTujuanUnit" style="">
        ...
        <td><select id="cmbDokTujuanUnitInap" name="cmbDokTujuanUnitInap" class="txtinput" onChange="">
			<option value="">-Dokter-</option>
        </select>
        <label><input type="checkbox" id="chkDokterPenggantiTujuanUnitInap" value="1" onChange="gantiDokterTujuanInap('cmbDokTujuanUnitInap',this.checked);"/>Dokter Pengganti</label></td>
    </tr>
    <tr>
        <td>&nbsp;</td>

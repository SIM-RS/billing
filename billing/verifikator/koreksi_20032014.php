         ...
         <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
            ...
            <script>
				...
				function cetakResumeMedis(){
					...
					//var jenislayanan = document.getElementById('cmbJnsRwt').value;
					...
					if(inap=='0'){
						...
						window.open('../unit_pelayanan/resumemedis_inap.php?idKunj='+KunjId+'&idPel='+pelId+'&idPasien='+pas_id+'&jenislayanan='+jenislayanan,'_blank');
					}
				}

         ...
         <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2" align="center">
            ...
            <table width="1000" border="1" cellspacing="0" cellpadding="0" class="txtinput" align="center" height="450">
                ...
                <tr>
                    <td valign="top">
                        <fieldset>
                            <legend>Data Tindakan&nbsp;&nbsp;&nbsp;<span id="divSelesai" style="color:#0000ff;background-color:#ffff00;"></span></legend>
                            <div id="divTableTindakan" align="center"  style="overflow:auto;height:300px;">
                                <div id="gb" style="width: 950px; height:290px; border:none; display:block"></div>
                ...
                <tr id="trTinKamar" style="visibility:collapse; display:none;">
                    <td valign="top">
                        <fieldset>
...
gg.setHeader(" ",false);
gg.setColHeader("No,Jenis Layanan,Tempat Layanan,Tanggal,Tindakan,Kelas,Jumlah,Tarif RS,Tarif KSO,Iur Bayar,Bayar Pasien,Return");
//g.setIDColHeader(",kode,nama,ket,");
gg.setColWidth("30,100,90,70,120,70,50,50,50,50,50,50");
gg.setCellAlign("center,left,left,left,left,left,center,right,right,right,right,center");
gg.setCellType("txt,txt,txt,txt,txt,txt,txt,txt,txt,txt,txt,txt");
gg.setCellHeight(20);
gg.setImgPath("../icon");
gg.setIDPaging("pg");
...
function prosesReturn(id){
	if(document.getElementById('chkReturn_'+id).checked){
		Request("proses_return.php?retur=ya&id_bt="+id,'divSelesai','','GET',selesaiReturn,'ok');
	}
	else{
		Request("proses_return.php?retur=tidak&id_bt="+id,'divSelesai','','GET',selesaiReturn,'ok');
	}
}

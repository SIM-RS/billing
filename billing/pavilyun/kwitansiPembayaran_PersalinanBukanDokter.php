...
<?php
		...
		$namaBulan = array ('','Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','Nopember','Desember');		
            if($jenis=='8'){
                $ifJenis="AND (mt.klasifikasi_id<>'11' AND mt.klasifikasi_id<>'13' AND mt.klasifikasi_id<>'14') AND mt.nama LIKE 'partus%' AND (u.parent_id='50' OR n.parent_id='50')";
				$judul = 'PERSALINAN BUKAN DOKTER';				
            }           
?>
<style>
	.jdl
...
<table width="800" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
    ...
    <tr>
		<td colspan="2" height="70" valign="top" style="font-size:14px; text-align:center; text-transform:uppercase; font-weight:bold;">Pembagian jasa <br>tindakan <?php echo $judul;?> selain dokter</td>
	</tr>
	<tr>
		...
		<td colspan="2">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr>
					...
					<td class="jdlKn" width="30%" colspan="3">NILAI JASA TINDAKAN UNTUK</td>					
				</tr>
				<tr>
				     <td class="jdl" width="10%">KEBERSAMAAN</td>
					<td class="jdl" width="10%">MANAGEMEN</td>
					<td class="jdlKn" width="10%">ASISTEN</td>
				...
				<tr>
					...
					<td class="isi" align="right">
						  ...
						  $managemen=(80/100*$rw['nilai'])*10/100;								
                            ...
                            ?>&nbsp;
                         </td><td class="isiKn" align="right">
                            <?php $asisten=(80/100*$rw['nilai'])*6/100;								
				...
				<tr>
					...
					<td class="isi" align="right" style="font-weight:bold;"><?php echo number_format($jml_managemen,0,'','.');?>&nbsp;</td>
					<td class="isiKn" align="right" style="font-weight:bold;">
                       <?php

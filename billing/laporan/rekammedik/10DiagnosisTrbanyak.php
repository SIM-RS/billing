...
<title>10 Diagnosis Terbanyak PP Rawat Jalan - P. ANAK</title>
</head>
...
<table width="925" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="4" align="center" height="50" style="font-size:15px;"><b>Laporan 10 Diagnosis Terbanyak PP <?php echo $rwUnit1['nama'];?> - <?php if($rwUnit2['nama']=="") echo 'Semua'; else echo $rwUnit2['nama'] ?> - Pasien <?php if($rwKso['nama']=="") echo 'Semua'; else echo $rwKso['nama'] ?><br />
  ...
  <tr>
  	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td colspan="2" align="right">Tgl Cetak: <?php echo $date_now;?></td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
	<td>&nbsp;</td>

					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
						...
						<?php
								if($stsKunj=='0'){ 
									...
									INNER JOIN b_ms_pegawai mp ON mp.id = b_pelayanan.dokter_tujuan_id
						...
						<tr>
							...
							*/
							$sql="SELECT IF(d.ms_diagnosa_id=0,d.diagnosa_manual,md.nama) diagnosa1,
								...
								UNION ALL
 SELECT '' AS diagnosa1, bmdn.nama AS diagnosa, bmdn.kode AS icd10 FROM b_diagnosa_rm bdr INNER JOIN b_ms_diagnosa bmdn ON bdr.ms_diagnosa_id = bmdn.id
 WHERE bdr.kunjungan_id = '".$rw["kunjungan_id"]."' AND bdr.diagnosa_id = 0";
							//echo $sql."<br>";
							$rs1=mysql_query($sql);
							$diagnosa="";

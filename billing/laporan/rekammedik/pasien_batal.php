...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr>
    <td colspan="13" align="center" height="70" valign="top" style="font-size:14px; text-transform:uppercase"><b>Laporan  Pasien BATAL BERKUNJUNG <?php echo $rwUnit1['nama'] ?> - <?php if($rwUnit2['nama']=="") echo 'Semua'; else echo $rwUnit2['nama'] ?><br /><?php echo $Periode;?></b></td>
  </tr>
  <tr>
  ...
  <tr height="30">
	...
	<td width="20%" style="border-top:1px solid; border-bottom:1px solid;">&nbsp;Alasan</td>
	<td width="17%" align="right" style="border-top:1px solid; border-bottom:1px solid;">Unit Tujuan&nbsp;&nbsp;&nbsp;</td>  
  </tr>
  <?php
		...
		$sqlDiag = "SELECT bmp.no_rm, bmp.nama, bmp.sex, bmk.nama AS nm_kso, bp.tgl, bmu.nama AS nm_unit, bp.ket_batal FROM b_pelayanan bp
...
INNER JOIN b_ms_kso bmk ON bp.kso_id = bmk.id
  ...
  <tr>
    ...
    <td colspan="2" style="text-transform:uppercase">&nbsp;<?php echo tglSQL($rwDiag['tgl']); ?></td>
    <td>&nbsp;<?php echo $rwDiag['ket_batal']; ?></td>
  ...
  <tr>
	...
	<td style="border-bottom:1px solid;">&nbsp;</td>
	<td width="7%" style="border-bottom:1px solid;">&nbsp;</td>
	<td width="13%" style="border-bottom:1px solid;">&nbsp;</td>
	<td width="4%" style="border-bottom:1px solid;">&nbsp;</td>
    <td width="2%" style="border-bottom:1px solid;">&nbsp;</td>
	<td width="5%" style="border-bottom:1px solid;">&nbsp;</td>
	<td width="4%" style="border-bottom:1px solid;">&nbsp;</td>
	<td width="5%" style="border-bottom:1px solid;">&nbsp;</td>
	<td width="8%" style="border-bottom:1px solid;">&nbsp;</td>
	<td style="border-bottom:1px solid;">&nbsp;</td>
    <td style="border-bottom:1px solid;">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
  	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td colspan="11" align="right">Tgl Cetak:&nbsp;<?php echo $date_now.'&nbsp;Jam:&nbsp;'.$jam;?>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td colspan="11" align="right">Yang Mencetak</td>
  </tr>
  <tr>
  	<td colspan="13" height="50" valign="bottom" align="center">&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td colspan="11" align="right"><b><?php echo $rwPeg['nama'];?></b>&nbsp;</td>
  </tr>
  <tr id="trTombol">
        <td class="noline" align="center" colspan="13">

			...
			<legend>Kriteria Laporan</legend>
				<table width="450" align="center">
					...
					<tr id="stsKunj2">
						...
						<?php 
							$sStatus = "SELECT 
							  'SEMUA' AS id, 'SEMUA' AS nama, 1 AS temp 
							UNION
							SELECT 
							  id, nama, temp 
							FROM
					...
					<tr id="stsPas">
						...
						<td width="60%">&nbsp;<select name="StatusPas" id="StatusPas" tabindex="22" class="txtinput" style="width:200px"></select></td>
					</tr>
                    <tr id="trKecelakaan">
					...
					<tr>
						<td colspan="2" align="center"><input type="button" value="Tampilkan" onclick="submitLap()"/>&nbsp;<input type="button" value="Excel" onclick="submitLapExcel()" /><input type="hidden" id="isExcel" name="isExcel" /></td>
					</tr>
				</table>
		</fieldset>
...
function submitLapExcel(){
	document.getElementById('isExcel').value = 'yes';
	submitLap();
	document.getElementById('isExcel').value = 'no';
}

...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="5" align="center" height="50" style="font-size:15px;"><b>Laporan Kasus Penyakit Pasien Berdasarkan Tempat Layanan</b><br /><b><?php echo $Periode;?></b></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="3" align="right">Tanggal Cetak :&nbsp; <?php echo $date_now;?>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <?php
		...
		while($rwTmp = mysql_fetch_array($rsTmp))
		{
			$qBaru = "SELECT COUNT(k.pasien_id) AS jml
					...
					WHERE pk.kasus = '1' AND pl.kso_id = '".$rwTmp['id']."' AND pl.unit_id = '".$_REQUEST['TmpLayanan']."' $waktu ";
			...
			$qLama = "SELECT COUNT(k.pasien_id) AS jml
					...
					INNER JOIN b_pelayanan pl ON pl.kunjungan_id = k.id 
					INNER JOIN b_pasien_keluar pk ON pk.pelayanan_id = pl.id 
					WHERE pk.kasus = '0' AND pl.kso_id = '".$rwTmp['id']."' AND pl.unit_id = '".$_REQUEST['TmpLayanan']."' $waktu ";
			...
			$qK = "SELECT COUNT(k.pasien_id) AS jml
				FROM b_kunjungan k 
				INNER JOIN b_pelayanan pl ON pl.kunjungan_id = k.id 
				WHERE pl.unit_id = '".$_REQUEST['TmpLayanan']."' AND pl.kso_id = '".$rwTmp['id']."' $waktu ";
			$rsK = mysql_query($qK);

...
<tr><td>DATA KEADAAN MORBIDITAS PASIEN RAWAT JALAN <?php echo $rwUnit22; ?></td></tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0"  style="border-collapse:collapse">
  <tr>
    ...
    <th rowspan="2">No. DTD</th>
    <th rowspan="2">No. Daftar Terperinci</th>
    <th rowspan="2">Golongan Sebab Penyakit</th>
    <th colspan="18">Jumlah Pasien Kasus Menurut Golongan Umum dan Sex</th>
    <th colspan="2">Kasus Baru Menurut Jenis Kelamin</th>
    <th rowspan="2">Jumlah Kasus Baru (23+24)</th>
...
<!--			<td><?php echo  ($P7==0)? '': $P7;?></td>-->
	...
	?>
    	<tr>
			...
			<td colspan="2"><?php if($tL3+$tP3==0) echo ''; else echo $tL3+$tP3; ?></td>

	...
	<table width="1000" border="0" cellspacing="0" cellpadding="0" class="txtinput" align="center" height="450">
		...
		<td valign="top">
			...
			<tr>
                ...
                <li><a href="javascript:void(0)" onclick="popupReport58_N();variabel=1;sts=1;tipe=0;pil=0;change()">Jumlah Kunjungan Rawat Jalan Per Kecamatan</a></li>
                <li><a href="javascript:void(0)" onclick="popupReport21_new();variabel=0;sts=1;tipe=3;pil=0;change();">Rekapitulasi Data Pasien Masih Dirawat</a></li>
...
<script type="Text/JavaScript">
	...
	function popupReport21_new(){
	document.getElementById('cmbWaktu').value= '';
	setBln();
	document.getElementById('laporan').value = 'RekapPasienMaihDirawat';
	changeM();
	new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
	$('popup_div1').popup.show(); 
    $('popup_div1').scrollTo();
	document.getElementById('form1').action='masukInap_new.php';
    } 
	...
	function popupReport58_N(){
	document.getElementById('cmbWaktu').value= '';
	setBln();
	new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
	$('popup_div1').popup.show(); 
    $('popup_div1').scrollTo();
	document.getElementById('form1').action='MultigunaPerKecamatan.php';
    }
    </script>
</html>
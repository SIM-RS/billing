...
<head>
    ...
    <!--diatas ini diperlukan untuk menampilkan popup-->
      	<!--link type="text/css" href="/simrs/rm/menu.css" rel="stylesheet" />
        <script type="text/javascript" src="/simrs/rm/jquery.js"></script>
        <script type="text/javascript" src="/simrs/rm/menu.js"></script-->
...
<body>
	...
	<table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
	    <tr>
		<td height="30">&nbsp;LAPORAN REKAS MEDIS</td>
        <td width="20%" height="20" align="right"><a id="aharef" href="../../../rm/home.php"><img alt="close" src="../../icon/x.png" width="32"></a>&nbsp;</td>
	    </tr>
	</table>
	<table width="1000" border="0" cellspacing="0" cellpadding="0" class="txtinput" align="center" height="450">
		...
		<td valign="top">
			...
			<tr>
				...
				<li><a href="javascript:void(0)" onclick="popupReport10();variabel=0;sts=1;tipe=0;pil=0;change()">Rujukan Penunjang Medik</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport11();variabel=0;sts=1;tipe=0;pil=0;change()">Diagnosis Pasien Berdasarkan Tempat Layanan</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport30();variabel=1;sts=1;tipe=8;pil=0;change()">Diagnosis Pasien Per Diagnosa dan Tempat Layanan</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport12();variabel=0;sts=1;tipe=0;pil=0;change()">15 Diagnosis Pasien Berdasarkan Tempat Layanan</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport28();variabel=0;sts=1;tipe=0;pil=0;change()">10 Diagnosis Pasien Meninggal Berdasarkan Tempat Layanan</a></li>
				...
				<li><a href="javascript:void(0)" onclick="popupReport14();variabel=1;sts=1;tipe=2;pil=0;change()">Keadaan Morbiditas Pasien Berdasarkan Tempat Layanan</a></li>
				...
				<li><a href="javascript:void(0)" onclick="popupReport21();variabel=0;sts=1;tipe=3;pil=0;change()">Rekapitulasi Data Pasien Masuk Rawat Inap</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport22();variabel=0;sts=1;tipe=4;pil=0;change()">Rekapitulasi Data Pasien Keluar Rawat Inap</a></li>
				...
				<li><a href="javascript:void(0)" onclick="popupReport29();variabel=0;sts=2;tipe=7;pil=1;change()">Rekapitulasi Komplikasi Akibat Penggunaan Napza</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport26();variabel=0;sts=2;tipe=7;pil=1;change()">Rekapitulasi Jenis Obat Yang Dipergunakan Pada Pasien Gangguan Mental Dan Perilaku Akibat Penggunaan Napza Menurut Pekerjaannya</a></li>
				<li><a href="javascript:void(0)" onclick="popupReport20();variabel=0;sts=1;tipe=0;pil=0;change()">Cara Bayar Berdasarkan Tempat Layanan Inap</a></li>
			    </ol>
			    </td>
			</tr>
		    </table>
...
<script type="Text/JavaScript">
	...
	new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
	$('popup_div1').popup.show();
	document.getElementById('form1').action='masukInap.php';
    } 

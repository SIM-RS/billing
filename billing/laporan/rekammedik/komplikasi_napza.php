...
if($_POST['isExcel']=='yes'){
	...
	header('Content-Disposition: attachment; filename="komplikasi_napza.xls"');
}
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr>
    <td valign="top" height="70" style="text-transform:uppercase; font-weight:bold; font-size:14px; text-align:center;">komplikasi akibat penggunaan napza<br>penderita <?php echo $txtJenis." - ".$txtTempat; ?><br><?php echo $Periode;?></td>
  </tr>
  <tr>
...
AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '148' AND '189') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '7280' AND '7285') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '8067' AND '8134') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '8288' AND '8321') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '8322' AND '8333') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '1043' AND '1086') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '1087' AND '1146') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '12403' AND '12454') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '12834' AND '12835') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '12493' AND '12502') AND b_pasien_keluar.kasus='1' $fUnit";
	...
	INNER JOIN b_diagnosa_rm ON b_diagnosa_rm.pelayanan_id=b_pelayanan.id INNER JOIN b_pasien_keluar ON b_pasien_keluar.pelayanan_id=b_pelayanan.id
	WHERE b_pelayanan.unit_id_asal='12' $waktu
	AND (b_diagnosa_rm.ms_diagnosa_id BETWEEN '13380' AND '13399') AND b_pasien_keluar.kasus='1' $fUnit";

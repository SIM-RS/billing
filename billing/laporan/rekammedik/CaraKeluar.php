...
<title>Kasus Rawat Jalan - P. ANAK</title>
</head>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3" style="font-size:13px;"><b><?=$namaRS?><br /><?=$alamatRS?><br />Telepon <?=$tlpRS?><br /><?=$kotaRS?></b></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="3" align="center" height="50" style="font-size:15px;"><b>Laporan Cara Keluar Pasien Berdasarkan Penjamin Pasien<br /><?php echo $Periode;?></b></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" align="right">Yang Mencetak :&nbsp;<?php echo $rwPeg['nama'];?>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
				...
				<?php
					...
					while($rwck=mysql_fetch_array($rsck))
					{
						$qJml = "SELECT COUNT(pl.pasien_id) AS jml
								...
								AND pk.cara_keluar = '".$rwck['cara_keluar']."' AND k.kso_id = '".$rwSt['id']."' $waktu";

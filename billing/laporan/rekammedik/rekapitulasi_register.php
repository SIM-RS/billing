...
<table border="0" cellpadding="0" cellspacing="0" width="750" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
    ...
    <tr>
        ...
        <td>&nbsp;</td>
        <td class="kiri">&nbsp;5.3</td>
        <td class="kiri">&nbsp;Batal Jenis Kasus Pasien</td>
        <td class="kanan">&nbsp;<?php
        $rw53=$rw1['jml']-($rw51['jml']+$rw52['jml']);
		echo $rw53;
		?></td>
    </tr>
    <tr>
        ...
        <td>&nbsp;</td>
        <td class="kiri">&nbsp;6</td>
        <td class="kiri">&nbsp;Cara Pembayaran/<br>&nbsp;Kelompok Pasien</td>
        <td class="kanan">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="kiri">&nbsp;Batal ke Poli</td>
        <?php 
		## Edited
			$batalPoli = "select count(id) jml from b_pelayanan where batal = 1 AND $unit $waktu";
			$dBatal = mysql_fetch_array(mysql_query($batalPoli));
			$totTdkPasPol = $dBatal['jml']; //$totJumPas-$totPasPol; 
		## End Edited
		?>
        <td class="kanan" id="totTdkPasPol"><?php if($totTdkPasPol==0) echo ""; else echo $totTdkPasPol; ?>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>   
    <tr>
        <td colspan="5">&nbsp;</td>
	...
	<tr>
		<td colspan="7" style="border-top:1px solid #000; padding-top:5px; font-size:11px;" align="right">

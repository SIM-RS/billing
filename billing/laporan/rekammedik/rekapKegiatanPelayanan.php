...
if($_POST['isExcel']=='yes'){
	...
	header('Content-Disposition: attachment; filename="rekapKegiatanPelayanan.xls"');
}
...
<table width="800" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
	...
	<tr>
		<td style="text-transform:uppercase; font-size:14px; font-weight:bold; text-align:center" height="70" valign="top">Rekapitulasi Kegiatan Pelayanan Tempat Layanan<br><?php echo $Periode;?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			<tr style="font-weight:bold">
				<td width="7%" height="30" style="border-bottom:1px solid; border-top:1px solid;" align="center">&nbsp;No</td>
				<td width="55%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Nama Tindakan</td>
			...
			<tr height="30" style="font-weight:bold">
				...
				<td style="border-bottom:1px solid; border-top:1px solid; font-weight:bold;" align="right">TOTAL&nbsp;</td>
				<td style="border-bottom:1px solid; border-top:1px solid; text-align:right"><?php echo $sub;?>&nbsp;</td>
			</tr>
		</table>
		</td>
	</tr>

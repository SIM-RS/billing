...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  <tr>
    ...
    <th scope="col" rowspan="2">No. DTD</th>
    <th scope="col" rowspan="2">No. Daftar Terperinci</th>
    <th scope="col" rowspan="2">Golongan Sebab Penyakit</th>
    ...
    <th scope="col" rowspan="2">Jumlah Kasus Baru (23+24)</th>
    <th scope="col" rowspan="2">Jumlah Pasien Keluar Mati</th>    
  </tr>
  <tr>
 ...
 <!-- <tr>
  ...
  <tr id="nomor">
    ...
    <td colspan="2"><div align="center">5</div></td>
    <!--<td><div align="center">6</div></td>-->
    <td colspan="2"><div align="center">6</div></td>
   <!-- <td><div align="center">8</div></td>-->
    <td colspan="2"><div align="center">7</div></td>
    <!--<td><div align="center">10</div></td>-->
    <td colspan="2"><div align="center">8</div></td>
    <!--<td><div align="center">12</div></td>-->
    <td colspan="2"><div align="center">9</div></td>
    <!--<td><div align="center">14</div></td>-->
    <td colspan="2"><div align="center">10</div></td>
    <!--<td><div align="center">16</div></td>-->
    <td colspan="2"><div align="center">11</div></td>
   <!-- <td><div align="center">18</div></td>-->
    <td colspan="2"><div align="center">12</div></td>
    <!--<td><div align="center">20</div></td>-->
    <td colspan="2"><div align="center">13</div></td>
...
$waktu $fKso AND d.kasus_baru=1 AND d.primer=1 GROUP BY k.kel_umur,mp.sex";
	...
	?>
		<tr>
			...
			<td colspan="2"><?php echo  ($L1+$P1==0)? '': $L1+$P1;?></td>
			<!--<td><?php echo  ($P1==0)? '': $P1;?></td>-->
			<td colspan="2"><?php echo  ($L2+$P2==0)? '': $L2+$P2;?></td>
			<!--<td><?php echo  ($P2==0)? '': $P2;?></td>-->
			<td colspan="2"><?php echo  ($L3+$P3==0)? '': $L3+$P3;?></td>
			<!--<td><?php echo  ($P3==0)? '': $P3;?></td>-->
			<td colspan="2"><?php echo  ($L4+$P4==0)? '': $L4+$P4;?></td>
			<!--<td><?php echo  ($P4==0)? '': $P4;?></td>-->
			<td colspan="2"><?php echo  ($L5+$P5==0)? '': $L5+$P5;?></td>
			<!--<td><?php echo  ($P5==0)? '': $P5;?></td>-->
			<td colspan="2"><?php echo  ($L6+$P6==0)? '': $L6+$P6;?></td>
			<!--<td><?php echo  ($P6==0)? '': $P6;?></td>-->
			<td colspan="2"><?php echo  ($L7+$P7==0)? '': $L7+$P7;?></td>
			<!--<td><?php echo  ($P7==0)? '': $P7;?></td>-->
			<td colspan="2"><?php echo  ($L8+$P8==0)? '': $L8+$P8;?></td>
			<!--<td><?php echo  ($P8==0)? '': $P8;?></td>-->
			<td colspan="2"><?php echo  ($L9+$P9==0)? '': $L9+$P9;?></td>
	...
	?>
    	<tr>
			...
			<td colspan="2"><?php if($tL1+$tP1==0) echo ''; else echo $tL1+$tP1; ?></td>
			<!--<td><?php if($tP1==0) echo ''; else echo $tP1; ?></td>-->
			<td colspan="2"><?php if($tL2+$tP2==0) echo ''; else echo $tL2+$tP2; ?></td>
			<!--<td><?php if($tP2==0) echo ''; else echo $tP2; ?></td>-->
			<td colspan="2"><?php if($tL3+$tP==0) echo ''; else echo $tL3+$tP; ?></td>
			<!--<td><?php if($tP3==0) echo ''; else echo $tP3; ?></td>-->
			<td colspan="2"><?php if($tL4+$tP4==0) echo ''; else echo $tL4+$tP4; ?></td>
			<!--<td><?php if($tP4==0) echo ''; else echo $tP4; ?></td>-->
			<td colspan="2"><?php if($tL5+$tP5==0) echo ''; else echo $tL5+$tP5; ?></td>
			<!--<td><?php if($tP5==0) echo ''; else echo $tP5; ?></td>-->
			<td colspan="2"><?php if($tL6+$tP6==0) echo ''; else echo $tL6+$tP6; ?></td>
			<!--<td><?php if($tP6==0) echo ''; else echo $tP6; ?></td>-->
			<td colspan="2"><?php if($tL7+$tP7==0) echo ''; else echo $tL7+$tP7; ?></td>
			<!--<td><?php if($tP7==0) echo ''; else echo $tP7; ?></td>-->
			<td colspan="2"><?php if($tL8+$tP8==0) echo ''; else echo $tL8+$tP8; ?></td>
			<!--<td><?php if($tP8==0) echo ''; else echo $tP8; ?></td>-->
			<td colspan="2"><?php if($tL9+$tP9==0) echo ''; else echo $tL9+$tP9; ?></td>

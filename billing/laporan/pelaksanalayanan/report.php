				...
				<tr>
					<td style="line-height:30px;">
						 <ol>
						 	...
						 	<li><a href="javascript:void(0)" onclick="popupReport5();variabel=0;sts=1;tipe=2;change()">Rekap Pembagian Jasa Pelayanan Dokter Pavilyun</a></li>
						 	<li><a href="javascript:void(0)" onclick="popupReport3();variabel=1;sts=1;tipe=3;change()">Rekap Pembagian Jasa Konsul/Visite Dokter Pavilyun</a></li>
						 	<li><a href="javascript:void(0)" onclick="popupReport8();variabel=1;sts=1;tipe=3;change()">Rekap Pembagian Jasa Pelayanan Tindakan Operatif Dokter Pavilyun</a></li>
						 	<li><a href="javascript:void(0)" onclick="popupReport9();variabel=1;sts=1;tipe=3;change()">Rekap Pembagian Jasa Pelayanan Tindakan Non-Operatif Dokter Pavilyun</a></li>
						 	<li><a href="javascript:void(0)" onclick="popupReport4();variabel=0;sts=1;tipe=3;change()">Rekap Pendapatan Pavilyun Dan Rincian Japel</a></li>
						 	<li><a href="javascript:void(0)" onclick="popupReport6();variabel=1;sts=1;tipe=4;change()">Laporan Honor Dokter Pavilyun</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport10();variabel=0;sts=1;tipe=9;change()">Laporan Tindakan Pasien OK</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport11();variabel=1;sts=1;tipe=1;change()">Pembagian Pendapatan Tarif Tindakan</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport12();variabel=1;sts=1;tipe=1;change()">Rekap Guarantee Dokter</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport13();variabel=1;sts=1;tipe=5;change()">Pendapatan Dokter Terbanyak</a></li>
						 	<!--li><a href="javascript:void(0)" onclick="popupReport7();variabel=0;sts=1;tipe=2;change()">Laporan Penerimaan Pavilyun</a></li-->
						 </ol>
					</td>
				</tr>
			</table>
...
//isiCombo(id,val,defaultId,targetId,evloaded)
	isiCombo('JnsLayanan','','','',showTmpLay);
	isiCombo('JnsLayananOK','','','',showTmpLayOK);
	isiCombo1('StatusPas');
	
	
	function showTmpLayOK(){
		isiCombo('TmpLayananOK',document.getElementById('JnsLayananOK').value);
	}
	function showTmpLay(){
	...
	function change()
	{
		...
		if(variabel==1)
		{
			...
			isiCombo('TmpLayananPav',document.getElementById('JnsLayananPav').value);
			isiCombo('TmpLayananPavInap',document.getElementById('JnsLayananPav').value);
			//isiCombo('cmbJnsOK','','','JnsLayananOK',showTmpLayOK);
		...
		if(tipe==0)
		{
			...
			document.getElementById('JnsOK').style.display = 'none';
			document.getElementById('TmpOK').style.display = 'none';
		}
		else if(tipe==1)
		{
		...
		else if(tipe==9)
		{
			...
			document.getElementById('TmpPav').style.display = 'none';
			document.getElementById('TmpPavInap').style.display = 'none';
			document.getElementById('JnsOK').style.display = 'table-row';
			document.getElementById('TmpOK').style.display = 'table-row';
		}
		else if(tipe==5)
		{
			document.getElementById('rwJnsLay').style.display = 'none';
	...
	function popupReport3()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='rekapJasa.php';
	}
	...
	function popupReport4()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='PendapatanJapel.php';
	}
	...
	function popupReport5()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='rekapPelTind.php';
	}
	...
	function popupReport6()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='honor.php';
	}
	...
	function popupReport8()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='operatif.php';
	}
	...
	function popupReport9()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='nonoperatif.php';
	}
	...
	function popupReport10()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='rekapTindOK.php';
	}
	...
	function popupReport11()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='LaporanPembagianTarifDokterRs.php';
	}
	...
	function popupReport12()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='LaporanGuarantee.php';
	}
	...
	function popupReport13()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='pendapatanDokterTerbanyak.php';
	}
</script>
</html>
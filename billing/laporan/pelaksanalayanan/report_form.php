		...
		<fieldset>
			<legend>Kriteria Laporan</legend>
				<table width="450" align="center">
                    ...
                    <tr id="JnsOK">
						<td align="right">Jenis Layanan</td>
						<td>&nbsp;<select id="JnsLayananOK" name="JnsLayananOK" class="txtinput" onchange="change()"></select></td>
					</tr>
					<tr id="TmpOK">
						<td align="right">Tempat Layanan</td>
						<td>&nbsp;<select id="TmpLayananOK" name="TmpLayananOK" class="txtinput"></select>
					</tr>
					<tr id="rwPelaksana">
					...
					<tr>
						<td colspan="2">
							<input type="submit" value="Export Excell" name="export" style="float:left"/>

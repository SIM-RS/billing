...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div align="center">
            ...
            <form method="get" target="_blank">
                <table width="1000" border="0" cellspacing="0" cellpadding="0" class="txtinput" align="center">
                    ...
                    <tr>
                        <td colspan="2" align="center"><input value="&nbsp;&nbsp;&nbsp;Tempat Layanan&nbsp;&nbsp;&nbsp;" type="button" onclick="getLap()"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
        ...
        <div id="div_laporan" style="display:none;width:70%; height:80%" class="popup">
            <img alt="close" src="../icon/x.png" width="32" class="popup_closebox" style="cursor: pointer" />
        </div>
    </body>
    <script type="text/JavaScript">
        ...
        function getLap()
        {
            ...
            Request("Tempat Layanan/IsiDiv.php?jnsLay="+JnsLayanan+"&tmptLay="+TmpLayanan+"&stsPas="+StatusPas+"&tglAwal="+tglAwal+"&tglAkhir="+tglAkhir, 'div_laporan', "", "GET");
        ...
        function lap1()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('Tempat Layanan/BukuRegisterPasien.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
        ...
        function lap2()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('Tempat Layanan/BukuDiagPasien.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
        ...
        function lap3()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('Tempat Layanan/BukuTindPasien.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
        ...
        function lap4()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('Tempat Layanan/RujukanPenunjangMedik.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }

...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div align="center">
                ...
                <tr>
                                            ...
                                            <tr>
                                                <td colspan="2" align="center">
                                                    <div id="trBulan" style="display:none">
                                                        <select class="txtinput" id="cmbBln" name="cmbBln"><option></option></select>&nbsp;<select class="txtinput" id="cmbThn" name="cmbThn"><option></option></select>
                                                    </div></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" align="center">
					...
					Periode : <input size="10" value="<?php echo $date_now;?>" class="txtcenter" id="tglAwal" name="tglAwal" readonly="readonly"/>&nbsp;<input type="button" class="btninput" id="btnTglAwal" name="btnTgl" value=" V " onClick="gfPop.fPopCalendar(document.getElementById('tglAwal'),depRange);" />&nbsp;s.d.&nbsp;<input size="10" value="<?=$date_now;?>" class="txtcenter" id="tglAkhir" name="tglAkhir" />&nbsp;<input type="button" class="btninput" id="btnTglAkhir" name="btnTgl" value=" V " onClick="gfPop.fPopCalendar(document.getElementById('tglAkhir'),depRange);" />
                                            ...
                                            <tr>
                                                ...
                                                <td width="60%">&nbsp;<select name="TmpLayanan" id="TmpLayanan" tabindex="27" class="txtinput" onchange="isiCombo('cmbPelaksana',this.value)"></select></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;<select id="cmbKom" name="cmbKom" class="txtinput"></select></td>
                                            </tr>
                                            <tr>
                                                <td align="right">Pelaksana</td>
                                                <td>&nbsp;<select id="cmbPelaksana" name="cmbPelaksana" class="txtinput"><option></option></select></td>
                                            </tr>
                                        </table>
                                    </fieldset>		</td>
                            </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="hd2" width="1000">
                <tr height="30">
                    ...
                    <td align="right"><a href="../index.php"><input class="btninput" type="button" value="&nbsp;&nbsp;&nbsp;Keluar&nbsp;&nbsp;&nbsp;" /></a>&nbsp;</td>
                </tr>
            </table>
        </div>

        <div id="div_laporan" style="display:none;width:800px; height:525px" class="popup">
            ...
            <fieldset>
                ...
                <table width="775px" align="center" border="0">
                    <tr>
                        <td width="50%" onclick="uang1()" style="cursor:pointer">Penerimaan Berdasarkan Nama Kasir</td>
                        <td width="50%"><a href="" target="_blank">Penerimaan Berdasarkan Kunjungan Utama</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Rekapitulasi Penerimaan Berdasarkan Kunjungan Utama</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Piutang Pasien Berdasarkan Tempat Layanan</a></td>
                        <td><a href="" target="_blank">Piutang Pasien Berdasarkan Penjamin Pasien</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Pendapatan Berdasarkan Klasifikasi Layanan (Pasien Pulang)</a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="" target="_blank">Pendapatan Berdasarkan Penjamin Pasien</a></td>
                        <td><a href="" target="_blank">Penerimaan Berdasarkan Penjamin Pasien</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Klaim Jaminan Berdasarkan Penjamin Pasien</a></td>
                    </tr>
                    <tr>
                        <td onclick="uang2()" style="cursor:pointer;">Distribusi Pendapatan</td>
                        <td><a href="" target="_blank">Distribusi Penerimaan</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Distribusi Klaim Jaminan</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Distribusi Pendapatan Medik Operatif</a></td>
                        <td><a href="" target="_blank">Distribusi Penerimaan Medik Operatif</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Distribusi Klaim Jaminan Medik Operatif</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Penerimaan Bulanan</a></td>
                        <td><a href="" target="_blank">Penerimaan Rentang Waktu</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Penerimaan Harian</a></td>
                        <td><a href="" target="_blank">Realisasi Penerimaan</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Distribusi Penerimaan</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Pendapatan Berdasarkan Kelompok Layanan per Pasien</a></td>
                        <td><a href="" target="_blank">Penerimaan Berdasarkan Kelompok Layanan per Pasien</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Piutang Berdasarkan Kelompok Layanan per Pasien</a></td>
                        <td><a href="" target="_blank">Pendapatan Berdasarkan Uraian Layanan per Pasien</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Penerimaan Berdasarkan Uraian Layanan per Pasien</a></td>
                        <td><a href="" target="_blank">Piutang Berdasarkan Uraian Layanan per Pasien</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Pendapatan Berdasarkan Tempat Layanan</a></td>
                        <td><a href="" target="_blank">Penerimaan Berdasarkan Tempat Layanan</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Piutang Berdasarkan Tempat Layanan</a></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Laporan Penyesuaian</a></td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </fieldset>
    ...
    <script type="text/JavaScript">
        ...
        isiCombo('cmbKom');
        isiCombo('TmpLayanan','','','',showPelaksana);
        function showPelaksana(){
            isiCombo('cmbPelaksana',document.getElementById('TmpLayanan').value);
        }
        ...
        function isiCombo(id,val,defaultId,targetId,evloaded)
        {
            ...
            Request('../combo_utils.php?id='+id+'&value='+val+'&defaultId='+defaultId+'&all=1',id,'','GET',evloaded);
        }
        ...
        function uang1()
        {
            ...
            window.open('keuangan/RekapPenerimaanNamaKasir.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir+'&userId=<?php echo $userId;?>','_blank');
        }
        ...
        function uang2()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            var komponen = document.getElementById("cmbKom").value;
            var pelaksana = document.getElementById("cmbPelaksana").value;
            window.open('keuangan/DistPendapatan.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir+'&komponen='+komponen+'&pelaksana='+pelaksana+'&userId=<?php echo $userId;?>','_blank');
        }
    </script>
</html>
<?php 

...
<div id="popup_div1" class="popup" style="width:500px;display:none;">
    ...
    <br>
    <form id="form1" action="kunjungan_pasien.php" method="post" target="_blank">
        ...
        <fieldset>
            ...
            <table width="450" align="center">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <div id="trBulan" style="display:none">
                            <select class="txtinput" id="cmbBln" name="cmbBln" onchange="bulanan()">
                                <option></option>
                            </select>&nbsp;
                            <select class="txtinput" id="cmbThn" name="cmbThn" onchange="bulanan()">
                                <option></option>
                            </select>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <div id="trPeriode" style="display:none">
                            Periode :
                            <input size="10" value="<?php echo $date_now;?>" class="txtcenter" id="tglAwal" name="tglAwal" readonly="readonly"/>&nbsp;<input type="button" class="btninput" id="btnTglAwal" name="btnTgl" value=" V " onClick="gfPop.fPopCalendar(document.getElementById('tglAwal'),depRange);" />
                            &nbsp;s.d.&nbsp;
                            <input size="10" value="<?php echo $date_now;?>" class="txtcenter" id="tglAkhir" name="tglAkhir" />&nbsp;
                ...
                <tr>
                    <td width="35%" align="right">Jenis Layanan</td>
                    <td width="65%">&nbsp;
                        <select name="JnsLayanan" id="JnsLayanan" tabindex="26" class="txtinput" onchange="isiCombo('TmpLayanan',this.value)"></select>
                    </td>
                </tr>
                <tr>
                    <td width="35%" height="25" align="right">Tempat Layanan</td>
                    <td width="65%">&nbsp;
                        <select name="TmpLayanan" id="TmpLayanan" tabindex="27" class="txtinput"></select>
                    </td>
                </tr>
                <tr>
                    <td width="35%" align="right">Status Pasien</td>
                    <td width="65%">&nbsp;
                        <select name="StatusPas" id="StatusPas" tabindex="22" class="txtinput"></select>
                    </td>
                </tr>
                <!--tr>

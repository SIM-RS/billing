...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div align="center">
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
                <tr>
                    <td height="30">&nbsp;LAPORAN KUNJUNGAN</td>
                </tr>
            </table>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="5" align="center" class="list_laporan">
                            <tr>
                                <td style="line-height:30px;">
                                    <ol>
                                        <li><a href="javascript:void(0)" onclick="popupReport1()">Rekapitulasi Kunjungan Pasien</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport2()">Rekapitulasi Kunjungan Pasien Per-Poli</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport3()">Rekapitulasi Kunjungan Pasien Per-Penjamin</a></li>
                                    </ol>
                                </td>
                            </tr>
                        </table>
    ...
    <script type="Text/JavaScript">
        ...
        function popupReport1()
        {
            ...
            document.getElementById('form1').action = 'pasKunjLab.php';
        }
        ...
        function popupReport2()
        {
            new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
            $('popup_div1').popup.show();
            document.getElementById('form1').action = 'kunjLab.php';
        }

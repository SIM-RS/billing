    ...
    <body>
        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
            ...
            <tr>
				...
				<td width="20%" align="right" style="font-size: 12px; border-bottom:#00FF00 solid 1px; border-top:#00FF00 1px solid; font-weight:bold; text-transform:uppercase; padding-right:10px;">&nbsp;Tarif Perda</td>
                        </tr>
                        <?php

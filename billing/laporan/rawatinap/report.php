			...
			<table width="100%" border="0" cellpadding="2" cellspacing="5" align="center" class="list_laporan">
				<tr>
					<td style="line-height:30px;">
						 <ol>
						 	<li><a href="javascript:void(0)" onclick="popupReport1();variabel=0;kso=0;change()">JUMLAH KUNJUNGAN</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport2();variabel=0;kso=0;change()">ASAL PASIEN</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport3();variabel=0;kso=0;change()">ALASAN PASIEN MRS</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport4();variabel=0;kso=0;change()">PASIEN KRS</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport5();variabel=0;kso=0;change()">JUMLAH PASIEN MENURUT CARA PEMBAYARAN</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport6();variabel=0;kso=0;change()">PENDAPATAN</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport7();variabel=0;kso=0;change()">JUMLAH PASIEN MENINGGAL MENURUT CARA PEMBAYARAN</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport8();variabel=0;kso=1;change()">DATA 10 BESAR PENYAKIT</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport9();variabel=0;kso=1;change()">DATA POLA KEMATIAN</a></li>
						 </ol>
					</td>
				</tr>
			</table>
...
<script>
	isiCombo1('StatusPas');
	isiCombo('JnsLayananInapSaja','','','',showTmpLayInap);
	...
	function popupReport1()
	{
		...
		document.getElementById('form1').action='jumlahkunjungan.php';
	}
	...
	function popupReport3()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='alasanpasienmrs.php';
	}
	...
	function popupReport4()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='pasienkrs.php';
	}
	...
	function popupReport5()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='jmlpasienbayar.php';
	}
	...
	function popupReport7()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='jmlpasienmeninggalbayar.php';
	}
	...
	function popupReport8()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='datapenyakit.php';
	}
	...
	function popupReport9()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='datakematian.php';
	}
</script>
</html>
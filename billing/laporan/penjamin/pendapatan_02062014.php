  ...
  <tr>
    <td>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			?>
			<tr>
				<td colspan="14" height="28" valign="bottom">&nbsp;<b><?php echo $rwUn['nama'];?></b></td>
			</tr>
		<?php
		...
		?>
		<tr>
		  <td colspan="14" style="padding-left:30px; font-weight:bold; text-transform:uppercase;" height="28"><?php echo $wKso['nama'];?></td>
	    </tr>
			<?php 
...
WHERE b_pelayanan.kso_id = '".$wKso['id']."' AND b_pelayanan.unit_id = '".$rwUn['id']."' $waktu 
GROUP BY b_kunjungan.id ORDER BY b_pelayanan.tgl,b_ms_pasien.nama";
			//echo $Pas."<br>";
			...
			$sqlRet ="SELECT SUM(b_tindakan.biaya_pasien) AS retUm, SUM(b_tindakan.biaya_kso) AS retKso FROM b_tindakan INNER JOIN b_ms_tindakan_kelas 
...
WHERE b_ms_tindakan.klasifikasi_id = '11' AND b_tindakan.pelayanan_id = '".$rwPas['pelayanan_id']."'";
			...
			$sqlTin = "SELECT SUM(b_tindakan.biaya_pasien) AS tindUm, SUM(b_tindakan.biaya_kso) AS tindKso 
				FROM b_tindakan
...
FROM b_tindakan 
INNER JOIN b_pelayanan ON b_tindakan.pelayanan_id = b_pelayanan.id 
WHERE b_pelayanan.unit_id = '58' AND b_pelayanan.unit_id_asal = '".$rwUn['id']."' AND b_tindakan.kunjungan_id = '".$rwPas['kunjungan_id']."') AS t";
			//echo $sqlLabA."<br>";
...
WHERE b_pelayanan.unit_id = '65' AND b_pelayanan.unit_id_asal = '".$rwUn['id']."' AND b_tindakan.kunjungan_id = '".$rwPas['kunjungan_id']."'";
		...
		$rowEnd = mysql_fetch_array($rsEnd);
			...
			<td align="right"><?php echo number_format($end,0,",",".")?>&nbsp;</td>
				<td align="right">0&nbsp;</td>
				<?php
					$biayaTotal = $ret+$tind+$pa+$pk+$rad+$hd+$ok+$end;
				?>

...
<table width="1200" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
	...
	<tr valign="top" style="padding-left:5px;">
        ...
        <td style="text-align:center;"><?php echo $rw['tgl_keluar'];?></td>
        <td align="center">&nbsp;</td>
        <?php
        $qDiag = "SELECT 
			b_ms_diagnosa.*,
		...
		<td align="left">&nbsp;<?php echo $rw['alamat'];?></td>
		<td align="center"><?php echo $rw['kelurahan'];?></td>
        <td style="text-align:center;"><?php echo $rw['kecamatan'];?></td>
	</tr>
	<?php	
	}
	?>

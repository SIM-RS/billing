		...
		<fieldset>
			<legend>Kriteria Laporan</legend>
				<table width="450" align="center">
					...
					<tr>
                    	<td>&nbsp;</td>
						<td align="right">&nbsp;&nbsp;<input type="button" value="Tampilkan" onclick="fSubmit()" />&nbsp;<input id="btnExpExcl" type="button" value="Export --> Excell" style="display:none" onClick="window.open('../klaimInap_Excell.php?JnsLayananDenganInap='+JnsLayananDenganInap.value+'&TmpLayananInapSaja='+TmpLayananInapSaja.value+'&cmbWaktu='+cmbWaktu.value+'&cmbBln='+cmbBln.value+'&cmbThn='+cmbThn.value+'&tglAwal='+tglAwal.value+'&tglAkhir='+tglAkhir.value+'&tglAwal2='+tglAwal2.value+'&StatusPas0='+StatusPas0.value);"/></td>
					</tr>
				</table>

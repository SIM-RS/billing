...
<table width="1200" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
	<tr>
		<td colspan="15"><b><?=$namaRS?><br /><?=$alamatRS?><br />Telepon <?=$tlpRS?><br /><?=$kotaRS?></b></td>
	</tr>
	<tr>
		<td colspan="15" align="center" height="70" valign="top" style="font-size:14px; text-transform:uppercase"><b>PELAKSANAAN PELAYANAN KESEHATAN MASYARAKAT KOTA MEDAN<br /><?php if($rwKso['nama']=="") echo 'Semua'; else echo $rwKso['nama'] ?><br /><?php echo $Periode;?></b></td>
	</tr>
	<tr style="font-weight:bold">
		<td colspan="6" height="30">&nbsp;JENIS LAYANAN :&nbsp;<?php echo $txtJenis;?></td>
		<td width="4%">&nbsp;</td>
        <td width="10%">&nbsp;</td>
        <td colspan="4">&nbsp;</td>
	...
	<tr height="30">
		...
		<td width="14%" align="left" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;NAMA PASIEN</td>
		<td width="10%" align="center" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;UMUR</td>
		<td width="7%" rowspan="2" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">TGL MASUK</td>
		...
		<td width="10%" align="left" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;DIAGNOSA</td>
        <td width="9%" align="left" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;ALAMAT</td>
        <td width="6%" align="center" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">KEL</td>
        ...
        <td width="7%" align="center" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">BIAYA YANG DISETUJUI</td>
        <td width="5%" align="center" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">SELISIH</td>
		<td width="9%" align="center" rowspan="2" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">KETERANGAN SELISIH</td>
	</tr>
	<tr>
	</tr>
	...
	$sql="SELECT 
		...
		SUM(t.qty*t.biaya_kso) AS biaya_kso,
		kel.nama kelurahan,
		kec.nama kecamatan
		FROM b_kunjungan k
	...
	<tr valign="top" style="padding-left:5px;">
		...
		<td align="center"><?php echo strtoupper($rw['no_rm']);?></td>
		...
		echo $rw['umur_thn']." THN ".$rw['umur_bln']." BLN ".$rw['umur_hr']." HR";	// $umur;
      ...
      <?php
		...
		*/
		$qDiag = "SELECT 
							...
							inner join b_diagnosa ON b_diagnosa.diagnosa_id = b_diagnosa_rm.diagnosa_id
							left join b_ms_diagnosa as b_ms_diagnosa2 ON b_ms_diagnosa2.id = b_diagnosa.ms_diagnosa_id 
							WHERE b_diagnosa.kunjungan_id = '".$rw['id']."' ";
...
INNER JOIN {$dbapotek}.a_obat ao ON ap.OBAT_ID=ao.OBAT_ID";
        ...
        <td align="right"><?php if($excel == 1){ echo /* number_format($rw['biaya_kso']+$tObat,0,'.',',');  */ ($rw['biaya_kso']+$tObat); } else { echo number_format($rw['biaya_kso']+$tObat,0,',','.'); echo '&nbsp;'; } ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td colspan="11" align="center" style="font-weight:bold">TOTAL&nbsp;</td>
        <td align="right" style="font-weight:bold"><?php if($excel == 1){ echo /* number_format($rw['biaya_kso']+$tObat,0,'.',',');  */ $total; } else { echo number_format($total,0,',','.'); echo '&nbsp;'; }
	...
	<tr id="trTombol">
        <td colspan="17" class="noline" align="center">
            <input id="btnPrint" type="button" value="Print/Cetak" onClick="cetak(document.getElementById('trTombol'));"/>
            <input id="btnTutup" type="button" value="Tutup" onClick="window.close();"/>        </td>
    </tr>
	<tr height="30"><td colspan="17">&nbsp;</td></tr>
</table>
</body>
<?php	
mysql_close($konek);

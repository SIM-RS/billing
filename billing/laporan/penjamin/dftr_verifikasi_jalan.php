...
<table width="1200" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
	...
	<tr>
		<td colspan="11" align="center" height="70" valign="top" style="font-size:14px; text-transform:uppercase"><b>PELAKSANAAN PELAYANAN KESEHATAN MASYARAKAT KOTA MEDAN<br /><?php if($rwKso['nama']=="") echo 'Semua'; else echo $rwKso['nama'] ?><br /><?php echo $Periode;?></b></td>
	</tr>
	...
	<tr height="30">
		<td width="2%" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;NO</td>
		<td width="6%" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;NO RM</td>
		<td width="16%" align="left" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;NAMA PASIEN</td>
		<td width="3%" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;UMUR</td>
		<td width="3%" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;JK</td>
		<td align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;TGL KUNJ</td>
		<td width="17%" align="left" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;DIAGNOSA</td>
        <td width="5%" align="right" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">BIAYA&nbsp;</td>
        <td width="17%" align="left" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;ALAMAT</td>
        <td width="8%" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;KELURAHAN</td>
		<td width="9%" align="center" style="font-weight:bold; border-bottom:1px solid; border-top:1px solid;">&nbsp;KECAMATAN</td>
	</tr>
	<?php
	...
	<tr valign="top" style="padding-left:5px;">
		...
		<td style="text-align:center;"><?php echo $rw['tgl_masuk'];?></td>
        <?php
        $qDiag = "SELECT 
			b_ms_diagnosa.*,

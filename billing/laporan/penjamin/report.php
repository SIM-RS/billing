...
<?php
	...
	include("../../koneksi/konek.php");include("../../header1.php");
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="5" align="center" class="list_laporan">
				<tr>
					<td style="line-height:30px;">
						 <ol>
							<li><a href="javascript:void(0)" onclick="popupReport3()">Rekap Tagihan Pasien Non Inap</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport4()">Rekap Pendapatan Tempat Layanan Non Inap</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport7()">Rekap Pendapatan Tempat Layanan Inap</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport8()">Rekap Pendapatan Tempat Layanan Inap Pasien Pulang/KRS</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport9()">Rekap Klaim KSO</a></li>
						 </ol>
					</td>
				</tr>
			</table>
...
<script>
	...
	function showTmpLay(){
		isiCombo1('TmpLayananBukanInap',document.getElementById('JnsLayanan').value);
	}
	...
	{
		document.getElementById('tipe_lap').value='3';
		...
		document.getElementById('btnExpExcl').style.display = 'none';
		document.getElementById('btnExpExclKSO').style.display = 'none';
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='klaimPas.php';
	}
	
	function popupReport4()
	{
		document.getElementById('tipe_lap').value='4';
		document.getElementById('rwJnsLay').style.display = 'table-row';
		document.getElementById('rwTmpLay').style.display = 'table-row';
		document.getElementById('trJenisM').style.display = 'none';
		document.getElementById('trTempatM').style.display = 'none';
	...
	{
		document.getElementById('tipe_lap').value='7';
		document.getElementById('rwJnsLay').style.display = 'none';
		document.getElementById('rwTmpLay').style.display = 'none';
		document.getElementById('trJenisM').style.display = 'none';
		document.getElementById('trTempatM').style.display = 'none';
		/*document.getElementById('rwJnsLayInap').style.display = 'table-row';
		document.getElementById('rwTmpLayInap').style.display = 'table-row';*/
		document.getElementById('rwJnsLayInap').style.display = 'none';
		document.getElementById('rwTmpLayInap').style.display = 'none';
		document.getElementById('btnExpExclKSO').style.display = 'none';
		document.getElementById('btnExpExcl').style.display = 'inline-table';
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='klaimInap.php';
	}
	
	function popupReport8()
	{
		document.getElementById('tipe_lap').value='8';
		document.getElementById('rwJnsLay').style.display = 'none';
		document.getElementById('rwTmpLay').style.display = 'none';
		document.getElementById('trJenisM').style.display = 'none';
		document.getElementById('trTempatM').style.display = 'none';
		...
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='pasienPulang.php';
	}
	...
	{
		document.getElementById('tipe_lap').value='9';
		changeM();
		...
		document.getElementById('rwTmpLayInap').style.display = 'none';
		document.getElementById('btnExpExcl').style.display = 'none';
		document.getElementById('btnExpExclKSO').style.display = 'inline-block';
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='dftr_verifikasi2.php';
	}
</script>
</html>
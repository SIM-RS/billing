...
<body>
<table border="0" cellspacing="0" cellpadding="0" class="tabel" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  <tr>
  ...
  <tr>
    <td align="center">
		<table width="2415" border="0" cellpadding="0" cellspacing="0" style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
			<tr valign="top">
				<td width="30" class="jdl">No</td>
				<td width="60" class="jdl">No MR</td>
				<td width="200" class="jdl">Nama Penderita<br />No Peserta<br />Nama Peserta<br></td>
				<td width="170" class="jdl">Nama Perusahaan</td>
				<td class="jdl">
					<table width="1955" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
						<tr style="text-align:center; font-weight:bold;">
							<td width="200" class="right">Diagnosa</td>
							<td width="74" class="right">MRS</td>
							<td width="74" class="right">KRS</td>
							<td width="37" class="right">Hari<br />RWT</td>
							<td width="74" class="right">Ruang<br />Rawat</td>
							<td width="74" class="right">Kelas</td>
							<td width="74" class="right">Kamar</td>
							<td width="74" class="right">Makan</td>
							<td width="74" class="right">Tindakan Non Operatif</td>
							<td width="74" class="right">Jasa Visite</td>
							<td width="55" class="right">Konsul Gizi</td>
							<td width="55" class="right">Konsul Poli</td>
							<td width="74" class="right">Tindakan Operatif</td>
							<td width="74" class="right">PK</td>
							<td width="74" class="right">PA</td>
							<td width="55" class="right">Rad</td>
							<td width="55" class="right">HD</td>
							<td width="55" class="right">Ends</td>
							<td width="74" class="right">Jumlah Tindakan</td>
							<td width="55" class="right">Obat</td>
							<td width="74" class="right">Jumlah Tindakan<br />+ Obat</td>
							<td width="55" class="right">PMI</td>
							<td width="74" class="right">Jumlah</td>
							<td width="74" class="right">Bayar Tunai</td>
							<td width="74" class="right">Total<br />Biaya Px</td>
							<td width="74" class="right">Status<br />Verifikasi</td>
						    <td width="74" class="right">Penjamin<br />Px</td>
						</tr>
				  </table>
			  </td>
			</tr>
			<form>
			<?php
				 $igd = $kamar = $makan = $tindakanNO = $visite = $gizi = $poli = $tindakanO = $lab = $rad = $pa = $jmlTindakan = $obat
			...
			?>
			<tr valign="top">
				<td style="text-align:center;" class="tbl"><?php echo $i;?></td>
				<td class="tbl" style="text-align:center;"><?php echo $rw['no_rm'];?></td>
				<td class="tbl" style="padding-left:5px; text-transform:uppercase"><?php echo $rw['pasien'];?><br>
				<span id="txtNoP<?php echo $i;?>"><?php echo $rw['no_anggota'];?></span><br />
				<span id="NamaP<?php echo $i;?>"><?php echo $rw['nama_peserta'];?></span></td>
				<td class="tbl" style="padding-left:5px; text-transform:uppercase;"><span id="txtPerusahaan<?php echo $i;?>" onclick="popUpKantor('<?php echo $rw['no_rm']."||".$rw['pasien']."||".$rw['no_anggota']."||".$rw['nama_peserta']."||".$rw['inst_id']."||".$rw['id']."||".$i;?>')" style="cursor:pointer;"><?php echo $rw['instansi'];?></span></td>
				<td class="tbl"> 
					<table width="1955" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
						<tr>
							<td colspan="10">
								<table width="830" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
								<?php
	...
	DATEDIFF(IFNULL(b_tindakan_kamar.tgl_out,NOW()),b_tindakan_kamar.tgl_in)))) AS jHr, b_ms_kso.nama AS penjamin, 
									...
									{							 
										...
										$jmlMkn = $jmlMkn + $bmakan;
										 ...
										 $qTin = "SELECT SUM(t.total) AS jml,SUM(t.total_umum) AS jml_umum FROM (SELECT b_tindakan.id, b_tindakan.biaya_kso, b_tindakan.qty, 
												 ...
												 WHERE b_pelayanan.kunjungan_id = '".$rw['kunjungan_id']."' AND b_tindakan.jenis_kunjungan = '3' AND b_tindakan.pelayanan_id='".$rwLop['pelayanan_id']."'
										 ...
										 $qVisite = "SELECT SUM(t.biaya) AS jml,SUM(t.biaya_umum) AS jml_umum FROM (SELECT SUM(b_tindakan.qty*b_tindakan.biaya_kso) AS biaya,SUM(b_tindakan.qty*b_tindakan.biaya_pasien) AS biaya_umum 
													 ...
													 AND b_pelayanan.kunjungan_id = '".$rw['kunjungan_id']."' AND b_tindakan.jenis_kunjungan = 3 AND b_tindakan.pelayanan_id='".$rwLop['pelayanan_id']."' GROUP BY b_tindakan.id) AS t";
										 //echo $qVisite."<br>";
							 	...
							 	?>
									<tr>
										<td width="200" style="border-right:1px solid #000000; border-bottom:1px solid #000000; text-align:left; font-size:9px; padding-left:5px;"><input id="pelId" name="pelId" value="<?php echo $rwLop['pelayanan_id'];?>" type="hidden" />
										...
										<td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo $rwLop['masuk']?></td>
										<td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo $rwLop['keluar']?></td>
										<td width="38" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo $rwLop['jHr']?></td>
										<td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo $rwLop['kamar']?><input id="txtUnitId" name="txtUnitId" type="hidden" value="<?php echo $rwLop['unit_id'];?>" /></td>
										<td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo $rwLop['kelas']?></td>
										<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bkamar,0,",",".");?></td>
										<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bmakan,0,",","."); ?></td>
                                        <td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bTinTmp,0,",",".");?></td>
										<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bVisiteTmp,0,",","."); ?></td>
									</tr>
				  					<?php 	
											$j++;
									}	?>
							...
							<?php
								 ...
								 $qPoli = "SELECT SUM(t.total) AS jml,SUM(t.total_umum) AS jml_umum FROM (SELECT b_tindakan.id, 
								 			b_tindakan.biaya_kso, b_tindakan.qty, b_ms_tindakan.nama, b_ms_tindakan.klasifikasi_id, 
											b_tindakan.qty*b_tindakan.biaya_kso AS total,
											b_tindakan.qty*b_tindakan.biaya_pasien AS total_umum, 
											b_pelayanan.unit_id FROM b_pelayanan INNER JOIN b_tindakan ON 
											b_tindakan.pelayanan_id = b_pelayanan.id INNER JOIN b_ms_tindakan_kelas ON 
											b_ms_tindakan_kelas.id = b_tindakan.ms_tindakan_kelas_id 
											INNER JOIN b_ms_tindakan ON b_ms_tindakan.id = b_ms_tindakan_kelas.ms_tindakan_id 
											INNER JOIN b_ms_unit ON b_ms_unit.id = b_pelayanan.unit_id
											WHERE b_pelayanan.kunjungan_id = '".$rw['kunjungan_id']."' AND 
											b_tindakan.jenis_kunjungan = '3' AND b_ms_unit.parent_id IN (1,132)
											AND b_ms_tindakan.id NOT IN (742,746,747,748,749,2387) 
											AND b_ms_tindakan.klasifikasi_id NOT IN (13,14) ) AS t";
								 //echo $qGizi."<br>";
								...
								?>			
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bGizi,0,",",".");?></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bPoli,0,",",".");?></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php if($bOp!="") echo number_format($rwOp['jml'],0,",","."); else echo "-";?></td>
							...
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bPa,0,",",".");?></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bRad,0,",",".");?></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bHd,0,",",".");?></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($bEnd,0,",",".");?></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php echo number_format($jmlTind,0,",","."); ?>
								<input type="text" id="jml_tind" value="<?php echo $jmlTind;?>" style="display:none" /></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><?php if($bObat=="") echo "0"; else echo number_format($bObat,0,",",".");?></td>
							<?php $jumlahTindakan = $jmlTind+$bObat;?>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><input size="6" id="jml_to" class="isi" value="<?php echo $jumlahTindakan;?>" readonly style="text-align:right" /></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><input size="4" id="pmi" onkeyup="summary(this,<?php echo $j;?>)" class="isi" style="text-align:right" /></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><input size="6" id="jml" class="isi" value="<?php echo $jumlahTindakan;?>" readonly style="text-align:right" /></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><input size="6" id="bayar" class="isi" readonly style="text-align:right" value="<?php echo $Bayar;?>" /></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><input size="6" id="total" class="isi" value="<?php echo $jumlahTindakan+$Bayar;?>" readonly style="text-align:right" /></td>
							<td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;color:<?php echo ($verifikasi==0 || $verifikasi=='')?'#990000':'#000099';?>"><?php echo ($verifikasi==0 || $verifikasi=='')?'belum':'sudah';?></td>
						    <td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000; font-weight:bold;"><?php echo $rwLop['penjamin'];?></td>
						</tr>
				  </table>
			  </td>
			</tr>
			...
			<tr valign="top">
				<td style="text-align:center;" class="tbl">&nbsp;</td>
				<td class="tbl" style="text-align:center;">&nbsp;</td>
				<td class="tbl" style="padding-left:5px; text-transform:uppercase">&nbsp;</td>
				<td class="tbl" style="padding-left:5px;">&nbsp;</td>
				<td class="tbl">		 
					<table width="1955" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
						<tr>
							<td width="620" height="25" style="border-right:1px solid #000000; border-bottom:1px solid #000000; text-align:left; text-align:center; font-weight:bold;">TOTAL</td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_kamar" style="text-align:right"><?php echo number_format($kamar,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_makan" style="text-align:right"><?php echo number_format($makan,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_nonOperatif" style="text-align:right"><?php echo number_format($tindakanNO,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_visite" style="text-align:right"><?php echo number_format($visite,0,",",".");?></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_gizi" style="text-align:right"><?php echo number_format($gizi,0,",",".");?></span></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_gizi" style="text-align:right"><?php echo number_format($poli,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_operatif" style="text-align:right"><?php echo number_format($tindakanO,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_lab" style="text-align:right"><?php echo number_format($lab,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_pa" style="text-align:right"><?php echo number_format($pa,0,",",".");?></span></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_rad" style="text-align:right"><?php echo number_format($rad,0,",",".");?></span></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_rad" style="text-align:right"><?php echo number_format($hd,0,",",".");?></span></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_rad" style="text-align:right"><?php echo number_format($end,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_jumlahTindakan" style="text-align:right"><?php echo number_format($jmlTindakan,0,",",".");?></span></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_obat" style="text-align:right"><?php echo number_format($obat,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_tindakanObat" style="text-align:right"><?php echo number_format($jumlahTindakanObat,0,",",".");?></span></td>
							<td width="55" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_pmi" style="text-align:right"><?php echo number_format($pmi,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_jumlahPmi" style="text-align:right"><?php echo number_format($jumlahTindakanPmi,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_bayar" style="text-align:right"><?php echo number_format($jumlahBayar,0,",",".");?></span></td>
							<td width="74" style="text-align:right; padding-right:5px; border-bottom:1px solid #000000; border-right:1px solid #000000;"><span id="span_totalBiaya" style="text-align:right"><?php echo number_format($totalBiaya,0,",",".");?></span></td>
							<td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;">&nbsp;</td>
						    <td width="74" style="text-align:center; border-bottom:1px solid #000000; border-right:1px solid #000000;">&nbsp;</td>
						</tr>
				  </table>
			  </td>

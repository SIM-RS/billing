...
<table width="1200" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr>
	...
	<b>Buku Register Pasien <?php if($_REQUEST['JnsLayanan']<>'0') echo $rwUnit1['nama']; ?> - <?php if($_REQUEST['TmpLayanan']=='0') echo "SEMUA"; echo $rwUnit2['nama'] ?><br />
  ...
  <tr style="font-weight:bold">
    ...
    <td width="8%" align="center" style="border-bottom:1px solid; border-top:1px solid;"><?= $_REQUEST['TmpLayanan'] == 232 ? "Tanggal Lahir" : "Umur" ?></td>
    ...
    <td width="11%" style="border-bottom:1px solid; border-top:1px solid;" align="center">Unit Pelayanan</td>
 ...
 /* query - dicoba ya... */
  ...
  $sqlPas = "SELECT DATE_FORMAT(k.tgl,'%d/%m/%Y') AS tgl,DATE_FORMAT(p.tgl_lahir,'%d/%m/%Y') as tgl_lahir_pasien, p.no_rm, p.nama AS pasien, 
p.sex, k.umur_thn,k.umur_bln,
  k.umur_hr, IF(k.isbaru=1,'Baru','Lama') AS kunjungan, p.alamat,
  u.nama                 AS unitPelayanan,
...
INNER JOIN b_ms_unit u ON u.id = pl.unit_id
WHERE 1=1 $fUnit $waktu and pl.kso_id = '".$rwK['id']."' GROUP BY k.id,pl.id";
	//
	// echo $sqlPas."<br>";
  ...
  <tr style="font-size:10px" valign="top">
	...
	<td align="center">&nbsp;<?= $_REQUEST['TmpLayanan'] == 232 ? $rwPas['tgl_lahir_pasien']  :$rwPas['umur_thn']."th ".$rwPas['umur_bln']."bln ".$rwPas['umur_hr']."hr";?></td>
	<td style="text-transform:capitalize">&nbsp;<?php echo $rwPas['alamat'];?></td>
	<td>&nbsp;<?php echo $rwPas['kunjungan']; ?></td>
	<td style="text-transform:uppercase"><?php echo $rwPas['unitPelayanan']; ?></td>

...
if($_REQUEST['TmpLayanan']!=0){
	...
	$fUnit = " AND pl.jenis_layanan=".$_REQUEST['JnsLayanan'];
	$tmpNama = "SEMUA";
}
...
?>
	<table width="800" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td align="center" style="font-weight:bold; font-size:15px">LAPORAN PEMERIKASAAN/TINDAKAN <?php echo $tmpNama; ?><br/><?php echo $Periode;?></td>
		</tr>
		<tr>
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
                    <td width="20px" align="center" style="border-bottom:#000000 1px solid; border-right:#000000 1px solid; border-top:#000000 solid 1px">No.</td>
                    <td width="35%" align="center" style="border-bottom:#000000 1px solid; border-right:#000000 1px solid; border-top:#000000 solid 1px">Dokter</td>
					...
					<?
						...
						$nm_dok = "";
						$tulis;
						$query = "SELECT bmp.nama AS nm_dokter, mt.nama AS tindakan, SUM(t.qty) AS jml FROM b_ms_tindakan mt
								...
								LEFT JOIN b_ms_pegawai bmp ON t.user_id = bmp.id
								WHERE 0=0 $fUnit $waktu 
								GROUP BY bmp.nama, mt.nama ";
						$exec = mysql_query($query);
						while($dquery = mysql_fetch_array($exec))
						{
							if($nm_dok == $dquery['nm_dokter'])
							{
								$tulis = "";
							}else{
								$tulis = $dquery['nm_dokter'];
								$nm_dok = $dquery['nm_dokter'];
							}
							...
							?>
                            	<tr>
                               		<td align="center" style="border-top:1px solid #000;"><?=$ii;?></td>
                                    <td style="border-top:1px solid #000;">&nbsp;<?php echo $tulis;?></td>
                                    <td style="border-top:1px solid #000;">&nbsp;<?php echo $dquery['tindakan'];?></td>
                                    <td align="center" style="border-top:1px solid #000;"><?php echo $dquery['jml'];?></td>
                                </tr>
                            <?
							}else{
								?>

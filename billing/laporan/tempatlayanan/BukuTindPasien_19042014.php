...
<table width="800" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr style="font-weight:bold">
    ...
    <td width="7%" style="border-top:1px solid;">&nbsp;No. RM</td>
    <td width="25%" style="border-top:1px solid;">&nbsp;Nama Pasien</td>
    <td width="5%" align="center" style="border-top:1px solid;">JK</td>
    <td width="5%" align="center" style="border-top:1px solid;">Umur</td>
    ...
    <td width="13%" style="border-top:1px solid;">&nbsp;</td>
  </tr>
  <tr style="font-weight:bold">
 ...
 <?php
  	$sql1 = "SELECT pl.id, DATE_FORMAT(t.tgl,'%d/%m/%Y') AS tgl, p.no_rm, p.nama, p.sex, 
			k.umur_thn, DATE_FORMAT(pl.tgl,'%d/%m/%Y') AS tglLay, DATE_FORMAT(tk.tgl_in,'%d/%m/%Y') AS mrs
			FROM b_ms_pasien p 
			...
			WHERE pl.unit_id = '".$_REQUEST['TmpLayanan']."' $waktu AND pl.kso_id = '".$rwK['id']."'
			GROUP BY k.id";
...
WHERE t.pelayanan_id='".$rw1['id']."' GROUP BY mt.id,t.user_id";

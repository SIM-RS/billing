...
<table width="1000" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
    ...
    <tr>
        <td style="text-transform:uppercase; font-size:14px; font-weight:bold; text-align:center;" height="70" valign="top">data pasien rawat inap<br>asal tempat layanan <?php echo $rwTmp['nama'];?> <u><?php echo $rwJns['nama'];?></u> <br><?php echo $Periode;?></td>
    </tr>
    <tr>
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
                ...
                <?php
                    $sql = "SELECT b_ms_unit.id, b_ms_unit.nama, COUNT(b_pelayanan.id) AS jml FROM b_pelayanan
                            ...
                            WHERE b_pelayanan.unit_id_asal='".$tmpLay."' $waktu
                ...
                <?php
                        $qDt = "SELECT b_ms_pasien.id AS pasien_id, b_pelayanan.id AS pelayanan_id, b_ms_pasien.no_rm, b_ms_pasien.nama AS pasien, b_kunjungan.alamat AS alamat,
                                b_kunjungan.umur_thn, b_kunjungan.umur_bln, b_ms_pasien.sex, b_ms_kso.nama AS kso
                                FROM b_ms_pasien
                                ...
                                WHERE b_pelayanan.unit_id='".$rw['id']."'  AND b_pelayanan.unit_id_asal='".$tmpLay."' $waktu GROUP BY b_pelayanan.id";
                ...
                <tr valign="top">
                    ...
                    <td style="text-align:right;"><?php if($rwDt['umur_thn']==0) echo $rwDt['umur_bln'].' bln'; else if($rwDt['umur_bln']==0) echo $rwDt['umur_thn'].' thn'; else echo $rwDt['umur_thn'].' thn '.$rwDt['umur_bln'].' bln';?>&nbsp;</td>

...
<?php
	...
	if($tmpLay != "0"){
		...
		$fUnit = "b_pelayanan.jenis_layanan = '".$jnsLay."'";
		$tmpNama = "SEMUA";
	}
...
<table width="800" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
	...
	<tr>
		<td height="70" valign="top" style="text-align:center; text-transform:uppercase; font-size:14px; font-weight:bold;">laporan klaim jaminan <?php echo $rwUnit1['nama'].'&nbsp;-&nbsp;'.$tmpNama; ?><br><?php echo $Periode;?></td>
	</tr>
	<tr>
		<td height="30"><table width="100%" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><tr><td style="font-weight:bold;" width="50%">&nbsp;Tempat Layanan:&nbsp;<?php echo $tmpNama;?></td><td width="50%" style="text-align:right">Yang Mencetak:&nbsp;<b><?php echo $rwPeg['nama'];?></b>&nbsp;</td></tr></table></td>
	</tr>
	<tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr>
					...
					<td width="10%" align="right" style="border-top:1px solid; border-bottom:1px solid; font-weight:bold;">Tarif RS&nbsp;</td>
				...
				<?
					$sql = "SELECT DATE_FORMAT(b_kunjungan.tgl,'%d-%m-%Y') AS tgl,
						...
						INNER JOIN b_pelayanan ON b_pelayanan.kunjungan_id = b_kunjungan.id
						INNER JOIN b_tindakan ON b_tindakan.pelayanan_id = b_pelayanan.id
						WHERE $fUnit $waktu AND b_kunjungan.kso_id = '".$rwK['id']."'

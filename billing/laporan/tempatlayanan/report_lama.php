			...
			<table width="100%" border="0" cellpadding="2" cellspacing="5" align="center" class="list_laporan">
				<tr>
					<td style="line-height:30px;">
						 <ol>
						 	<li><a href="javascript:void(0)" onclick="popupReport1();variabel=0;tipe=0;sts=1;change()">Buku Register Pasien</a>&nbsp;/&nbsp;<a href="javascript:void(0)" onclick="popupReport33();variabel=0;tipe=6;sts=1;change()">Buku Register Penunjang Medik</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport2();variabel=0;tipe=0;sts=1;change()">Buku Diagnosis Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport3();variabel=0;tipe=0;sts=1;change()">Buku Tindakan Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport29();variabel=0;tipe=3;sts=0;change()">Buku Triage Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport30();variabel=0;tipe=4;sts=0;change()">Buku Pasien MRS</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport31();variabel=1;tipe=5;sts=1;change()">Rekapitulasi Data Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport7();variabel=0;tipe=0;sts=1;change()">Penerimaan Konsul</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport6();variabel=0;tipe=0;sts=1;change()">Pengiriman Konsul</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport4();variabel=0;tipe=0;sts=1;change()">Rujukan Penunjang Medik</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport8();variabel=0;tipe=0;sts=1;change()">Kegiatan Pelayanan</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport12();variabel=1;tipe=0;sts=1;change()">Kunjungan Tempat Layanan</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport20();variabel=0;tipe=0;sts=1;change()">Cara Masuk Pasien Berdasarkan Tempat Layanan</a></li>
							...
							<li><a href="javascript:void(0)" onclick="popupReport13();variabel=0;tipe=0;sts=1;change()">Kunjungan Pasien Berdasarkan Penjamin Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport14();variabel=0;tipe=0;sts=1;change()">Asal Pasien Pasien Berdasarkan Penjamin Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport15();variabel=0;tipe=0;sts=1;change()">Kasus Penyakit Pasien Berdasarkan Penjamin Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport16();variabel=0;tipe=0;sts=1;change()">Cara Keluar Pasien Bersadarkan Penjamin Pasien</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport28();variabel=0;tipe=2;sts=1;change()">Rekapitulasi Pasien Keluar Tempat Layanan Rawat Inap</a></li>
							...
							<li><a href="javascript:void(0)" onclick="popupReport21();variabel=0;tipe=0;sts=1;change()">Diagnosis Tempat Layanan</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport22();variabel=1;tipe=0;sts=1;change()">15 Diagnosis Terbanyak</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport23();variabel=0;tipe=0;sts=1;change()">Pendapatan Tempat Layanan</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport25();variabel=0;tipe=0;sts=1;change()">Penerimaan Tempat Layanan (Semua Pasien)</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport26();variabel=0;tipe=0;sts=1;change()">Klaim Jaminan Tempat Layanan</a></li>
							...
							<li><a href="javascript:void(0)" onclick="popupReport5();variabel=0;tipe=0;sts=1;change()">Pemeriksaan/Tindakan</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport5_new();variabel=0;tipe=0;sts=1;change()">Jumlah Pemeriksaan/Tindakan Perdokter</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport9();variabel=0;tipe=0;sts=1;change()">Kunjungan</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport10();variabel=0;tipe=0;sts=1;change()">Rekapitulasi Kunjungan</a></li>
							<li><a href="javascript:void(0)" onclick="popupReport11();variabel=0;tipe=0;sts=1;change()">Buku Transaksi Tindakan</a></li>
                            ...
                            <li><a href="javascript:void(0)" onclick="popupReport36();variabel=0;tipe=0;sts=1;change()">Waktu Tunggu Pasien</a>
						 </ol>
					</td>
				</tr>
			</table>

	...
	<fieldset>
		...
		<table width="450" align="center">
			...
			<tr>
				...
				<td colspan="2"><!--input type="submit" value="Tampilkan" style="float:right" /--><div style="float:right"><button type="submit" id="tampil" style="cursor:pointer"><img src="../../icon/zoom_in.png" width="24" align="absmiddle" />&nbsp;Tampilkan</button>&nbsp;<button type="button" id="btnExpExcl" style="cursor:pointer" onClick="zxc()"><img src="../../icon/excel.png" width="24" align="absmiddle" />&nbsp;Export ke Excel</button></div></td>
			</tr>
		</table>
	</fieldset>
	</form>

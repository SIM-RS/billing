...
<table width="800" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr style="font-weight:bold">
    ...
    <td width="7%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">No. RM</td>
    <td width="20%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Nama Pasien</td>
    <td width="6%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">Tgl Kunjungan</td>
    <td width="6%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">Tgl Selesai</td>
    <td width="6%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">Waktu Tunggu</td>
    ...
    <td width="20%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Alamat</td>
    <td width="6%" style="border-bottom:1px solid; border-top:1px solid;">Kunjungan</td>
    <td width="13%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Asal Pasien</td>

		...
		<tr>
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
                    <td width="35%" align="center" style="border-bottom:#000000 1px solid; border-right:#000000 1px solid; border-top:#000000 solid 1px">No.</td>
					...
					<?
						...
						$query = "SELECT bmp.nama AS nm_dokter, mt.nama AS tindakan, SUM(t.qty) AS jml FROM b_ms_tindakan mt
								...
								$waktu GROUP BY bmp.nama, mt.nama ";

...
<table width="925" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
	...
	<tr>
		<td>&nbsp;<b>Tempat Layanan: <?php echo $tmpNama;?></b></td>
	</tr>
	<tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr style="font-weight:bold; font-size:12px">
					...
					<td width="2%" style="border-top:1px solid; border-bottom:1px solid;">&nbsp;JK</td>
					<td width="8%" style="border-top:1px solid; border-bottom:1px solid;">&nbsp;Umur</td>
					<td width="7%" style="border-top:1px solid; border-bottom:1px solid;">&nbsp;Alamat</td>
					<td width="16%" style="border-top:1px solid; border-bottom:1px solid;">&nbsp;Tgl. Transaksi - Layanan</td>
				...
				<?php
						$sql2 = "SELECT pl.id, DATE_FORMAT(k.tgl_act, '%d/%m/%Y %H:%i:%s') AS tgl, 
								...
								k.umur_thn,k.umur_bln,k.umur_hr, p.alamat, p.nama, p.sex,
				...
				<tr>
					...
					<td style="text-align:center"><?php echo $rw2['umur_thn'].' thn '.$rw2['umur_bln'].' bln'.$rw2['umur_hr'].' hr';?></td>

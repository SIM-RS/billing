...
if($tmpLayanan == 0) {
    $id = $jnsLayanan;
    $fTmp = " k.jenis_layanan = $jnsLayanan ";
}
else {
    $fTmp = " k.unit_id = $tmpLayanan ";
}
    ...
    <body>
        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
            ...
            <tr>
				...
				<td width="20%" align="right" style="font-size: 12px; border-bottom:#000000 solid 1px; border-top:#000000 1px solid; font-weight:bold">&nbsp;Tarif Perda</td>
                        </tr>
                        <?php

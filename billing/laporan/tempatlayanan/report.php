				...
				<tr>
					<td style="line-height:30px;">
						 <ol>
                            ...
                            <li><a href="javascript:void(0)" onclick="popupReport40();variabel=1;tipe=0;sts=1;change()">Laporan Pasien PCR</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport45();variabel=1;tipe=0;sts=1;change()">Laporan Pasien Antigen</a></li>
                            <li><a href="javascript:void(0)" onclick="variabel=1;tipe=13;sts=1;change();popupReport37();">Realisasi Produksi</a></li>
                            <li><a href="javascript:void(0)" onclick="variabel=1;tipe=7;sts=1;change();popupReport41();">Laporan Konsultasi / Visite Dokter Terbanyak</a></li>
                            <li><a href="javascript:void(0)" onclick="variabel=1;tipe=7;sts=1;change();popupReport42();">Laporan Penjualan Obat Terbanyak</a></li>
                            <li><a href="javascript:void(0)" onclick="variabel=1;tipe=13;sts=1;change();popupReport43();">Realisasi Produksi Gabungan</a></li>
						 </ol>
					</td>
				</tr>
			</table>
...
<script>
	...
	isiCombo('listcabang','','','cmbInstansi','',1);
	...
	function isiCombo(id,val,defaultId,targetId,evloaded,all_list)
	{
		...
		//if (id=='listcabang'){
		//	alert('../../combo_utils.php?id='+id+'&value='+val+'&defaultId='+defaultId+'&all='+all_list);
		//}
		Request('../../combo_utils.php?id='+id+'&value='+val+'&defaultId='+defaultId+'&all='+all_list,targetId,'','GET',evloaded);
	}
	...
	function isiCombo2(id,val,defaultId,targetId,evloaded)
	{
		if(targetId=='' || targetId==undefined)
		{
			...
			Request('../../combo_utils.php?id='+id+'&value='+val+'&all=1&reg=1&defaultId='+defaultId,targetId,'','GET',evloaded);
	}
	...
	function setBln(val)
	{
		if(val=='Harian')
		{
			...
			document.getElementById('trHarian').style.display = "table-row";
		}
		else if(val=='Bulanan')
		{
	...
	function change()
	{
		...
		document.getElementById('trPeriodeRpt').style.display='table-row';
		document.getElementById('trInstansi').style.display = 'none';
		//alert(variabel);
		if(variabel==1){
		...
		if(tipe==1){
			...
			document.getElementById('trTempatM').style.display = 'none';
			 ...
			 document.getElementById('trPeriodeRpt').style.display='none';
		}else if(tipe==7){
			document.getElementById('trDilayani').style.display='none';
			document.getElementById('trJns').style.display='none';
			document.getElementById('trTmp').style.display='none';
	...
	function popupReport40(){
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('statusPcr').style.display = 'block';
		document.getElementById('hideKata').style.display = 'block';
		document.getElementById('form1').action='LapLabPcr.php';
		document.getElementById('btnExpExcl2').style.display = 'block';
	...
	function popupReport45(){
		...
		document.getElementById('btnExpExcl3').style.display = 'block';
	...
	function popupReport41(){
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='konsultasiTerbanyak.php';
	}

	function popupReport42(){
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='penjualanObatPasienTerbanyak.php';
	}
	...
	function popupReport43(){
		...
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='RekapProduksiGabungan.php';
	}
</script>
</html>
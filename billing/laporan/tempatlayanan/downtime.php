...
?>
<table width="1003" height="446" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  <tr>
    <td colspan="10"><b><?=$namaRS?><br /><?=$alamatRS?><br />Telepon <?=$tlpRS?><br /><?=$kotaRS?></b></td>
  </tr>
  <tr>
    <td colspan="10" align="center" height="70" valign="top" style="font-size:14px; text-transform:uppercase">
	<b>Informasi kunjungan Pasien <?php echo $rwUnit1['nama'] ?> - <?php if($_REQUEST['TmpLayanan']=='0') echo "SEMUA"; echo $rwUnit2['nama'] ?><br />
  ...
  <tr style="font-weight:bold">
    ...
    <td width="5%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">No. RM</td>
    <td width="16%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Nama Pasien</td>
    <td width="7%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">Tgl Kunjungan</td>
    <td width="5%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">Tgl Selesai</td>
    <td width="5%" style="border-bottom:1px solid; border-top:1px solid; text-align:center;">Waktu Tunggu</td>
    <td width="2%" align="center" style="border-bottom:1px solid; border-top:1px solid;">JK</td>
    <td width="6%" align="center" style="border-bottom:1px solid; border-top:1px solid;">Umur</td>
    <td width="14%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Alamat</td>
    <td width="7%" style="border-bottom:1px solid; border-top:1px solid;">Kunjungan</td>
    <td width="9%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Asal Pasien</td>
    <td width="21%" style="border-bottom:1px solid; border-top:1px solid;">&nbsp;Dokter</td>
  </tr>
  <?php
  ...
  ?>
  <tr>
	<td colspan="10" height="30" valign="bottom">&nbsp;<b><?php echo $rwK['nama'];?></b></td>
  </tr>
  <?php
 /* query - dicoba ya... */
  
  $sqlPas = "SELECT DATE_FORMAT(pl.tgl_act,'%d/%m/%Y %h:%i:%s') AS tgl, p.no_rm, p.nama AS pasien, 
p.sex, k.umur_thn,k.umur_bln,k.umur_hr, IF(k.isbaru=1,'Baru','Lama') AS kunjungan, p.alamat,
(SELECT nama FROM b_ms_unit WHERE id = pl.unit_id_asal) AS asal,
mp.nama AS dokter, pl.id, t.ms_tindakan_kelas_id, DATE_FORMAT(pl.tgl_masuk,'%d/%m/%Y %h:%i:%s') AS tgl_masuk, TIMEDIFF(pl.tgl_masuk,pl.tgl_act) AS selisih
FROM b_ms_pasien p
...
WHERE $fUnit $waktu and pl.kso_id = '".$rwK['id']."' GROUP BY k.id,pl.id";
  ...
  <tr style="font-size:10px" valign="top">
    ...
    <td align="center">&nbsp;&nbsp;<?php echo $rwPas['tgl_masuk'];?></td>
    <td align="center">&nbsp;&nbsp;<?php echo $rwPas['selisih'];?></td>
	<td align="center">&nbsp;<?php echo $rwPas['sex'];?></td>
	<td align="center">&nbsp;<?php echo $rwPas['umur_thn'].' thn '.$rwPas['umur_bln'].' bln'.$rwPas['umur_hr'].' hr';?></td>

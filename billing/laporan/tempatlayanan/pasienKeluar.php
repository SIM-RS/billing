...
<table width="800" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
	...
	<tr>
		<td height="70" valign="top" style="font-size:14px; font-weight:bold; text-align:center; text-transform:uppercase;">laporan pasien keluar - <?php echo $rwUnit1['nama'];?><br>tempat layanan - <?php if($tmpLayanan==0) echo "SEMUA"; else echo $tmpNama; ?><br><?php echo $Periode;?></td>
	</tr>
	<tr>
		<td>

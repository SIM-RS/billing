...
<table width="925" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr>
    <td align="center" height="70" valign="top" style="text-transform:uppercase; font-size:14px; font-weight:bold">kunjungan pasien <?php echo $tmpNama; ?><br /><?php echo $Periode;?></td>
  </tr>
  <tr>

		...
		<td>
			<table border="0" width="60%" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" align="center">
				...
				<tr>
					...
					<td style="text-align:right; padding-right:20px; border-bottom:1px solid; border-top:1px solid; border-left:1px solid; border-right:1px solid;">&nbsp;<?php echo $rwUnit2['nama'];?></td>
				</tr>
				<?php
...
WHERE b_pelayanan.unit_id = '".$_REQUEST['TmpLayanan']."' $waktu $fKso

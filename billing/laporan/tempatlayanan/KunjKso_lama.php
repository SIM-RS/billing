...
<table width="750" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr>
    <td colspan="5" align="center" height="70" valign="top" style="font-size:14px; text-transform:uppercase"><b>Laporan Kunjungan Berdasarkan Penjamin Pasien <?php if($rwKso['nama']=="") echo 'Semua'; else echo $rwKso['nama'] ?><br />Jenis Layanan <?php echo $rwUnit1['nama'];?>&nbsp;Tempat Layanan <?php echo $rwUnit2['nama'];?>
  ...
  <tr>
  	<td colspan="5" style="text-decoration:underline">&nbsp;<?php echo $rwUnit2['nama']?></td>
  </tr>
  <?php
		$fKso = '';

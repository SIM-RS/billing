...
<title>Kinerja Operator Kunjungan</title>
</head>
...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="4" align="center" height="50" style="font-size:15px;"><b>Laporan Kinerja Operator Kunjungan<br />Jenis Layanan <?php echo $rwUnit1['nama']?>  Jenis Layanan <?php if($_REQUEST['TmpLayanan']=='0') echo 'Semua'; else echo $rwUnit2['nama']?> Status Pasien <?php if($_REQUEST['StatusPas']=='0') echo 'Semua'; else echo $rwKso['nama']?><br/>
  ...
  <?php
  	$sqlPet = "SELECT mp.id,mp.nama,COUNT(k.id) jml FROM b_kunjungan k INNER JOIN b_ms_pegawai mp ON k.user_act=mp.id INNER JOIN b_ms_unit mu ON k.unit_id=mu.id WHERE k.tgl BETWEEN '".$tglAwal2."' AND '".$tglAkhir2."' $fKso $fUnit GROUP BY k.user_act";

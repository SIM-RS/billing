...
<html xmlns="http://www.w3.org/1999/xhtml">
                            ...
                            <tr>
                                <td style="line-height:30px;">
                                    <ol>
                                        ...
                                        <li><a href="javascript:void(0)" onclick="popupReport7_1()" style="text-transform:capitalize">Rekapitulasi Laporan Penerimaan Kasir Rawat Jalan</a></li>
    ...
    <script type="text/JavaScript">
		...
		function popupReport7_1()
        {
            ...
            new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
            $('popup_div1').popup.show();
            document.getElementById('form1').action='penerimaan_kasir_pendaftaran_baru.php';
        }

...
$worksheet->write($row, $column, $pemkabRS, $sheetTitleFormat3);
...
$row += 1;
$worksheet->write($row, $column, $namaRS, $sheetTitleFormat3);
$worksheet->writeBlank($row, 1, $UnitTitleFormat);
$worksheet->writeBlank($row, 2, $UnitTitleFormat);
$worksheet->writeBlank($row, 3, $UnitTitleFormat);
$worksheet->mergeCells($row,0,$row,3);
$row += 1;
$worksheet->write($row, $column, $alamatRS, $sheetTitleFormat3);
$worksheet->writeBlank($row, 1, $UnitTitleFormat);
$worksheet->writeBlank($row, 2, $UnitTitleFormat);
$worksheet->writeBlank($row, 3, $UnitTitleFormat);
$worksheet->mergeCells($row,0,$row,3);
$row += 1;
$worksheet->write($row, $column, "Telepon ".$tlpRS, $sheetTitleFormat3);
$worksheet->writeBlank($row, 1, $UnitTitleFormat);
$worksheet->writeBlank($row, 2, $UnitTitleFormat);
$worksheet->writeBlank($row, 3, $UnitTitleFormat);
$worksheet->mergeCells($row,0,$row,3);

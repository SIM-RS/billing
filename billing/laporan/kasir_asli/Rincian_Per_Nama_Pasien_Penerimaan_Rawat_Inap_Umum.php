...
<tr>
	...
	<tr valign="top">
		...
		<tr style="text-align:center; font-weight:bold;">
			<td width="5%" class="right">MRS</td>
			<td width="5%" class="right">KRS</td>
...
WHERE mu.inap = '1' $fKso ORDER BY p.id";
	...
	<tr valign="top" class="isigrid">
		...
		<tr>
			...
			<td width="4%" align="right" class="isidlm"><?php echo number_format($rwGizi['jml'],0,",",".");?></td>
	...
	<tr valign="top">
		...
		<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="5" width="20%" height="25" class="isidlm" style="font-weight:bold;text-align:center;border-left:1px solid #000">TOTAL</td>
			...
			<td width="4%" align="right" class="isidlm"><?php echo number_format($gizi,0,",",".");?></td>

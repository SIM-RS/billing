...
$worksheet->write($row,$column,$pemkabRS,$unitTitleFormat);
$row += 1;
$worksheet->write($row,$column,$namaRS,$unitTitleFormat);
$row += 1;
$worksheet->write($row,$column,$alamatRS,$unitTitleFormat);
$row += 1;
$worksheet->write($row,$column,"Telepon ".$tlpRS,$unitTitleFormat);
$row += 2;
...
$worksheet->write($row,$column+15,"KONSUL POLI",$columnTitleFormat);
$worksheet->write($row,$column+16,"REHAB MEDIK",$columnTitleFormat);
$worksheet->write($row,$column+17,"TINDAKAN OPERATIF",$columnTitleFormat);
$worksheet->write($row,$column+18,"LAB PK",$columnTitleFormat);
$worksheet->write($row,$column+19,"RAD",$columnTitleFormat);
$worksheet->write($row,$column+20,"PA",$columnTitleFormat);
$worksheet->write($row,$column+21,"ENDOSCOPY",$columnTitleFormat);
$worksheet->write($row,$column+22,"HD",$columnTitleFormat);
$worksheet->write($row,$column+23,"JUMLAH TINDAKAN",$columnTitleFormat);
$worksheet->write($row,$column+24,"BAYAR TINDAKAN",$columnTitleFormat);
$worksheet->write($row,$column+25,"OBAT",$columnTitleFormat);
$worksheet->write($row,$column+26,"BAYAR OBAT",$columnTitleFormat);
$worksheet->write($row,$column+27,"PMI",$columnTitleFormat);
$worksheet->write($row,$column+28,"JUMLAH OBAT + TINDAKAN YANG DIBAYAR",$columnTitleFormat);
$worksheet->write($row,$column+29,"KEKURANGAN BAYAR",$columnTitleFormat);
...
while($rw = mysql_fetch_array($rs)){			
	...
	$jmlTin = $jmlMkn + $jmlKmr + $rwTin['jml'] + $rwVisite['jml'] + $rwGizi['jml'] + $rwIGD['jml'] + $rwPoli['jml'] + $rwRehab['jml'] + $rwOp['jml'] + 
	...
	$worksheet->write($row-1,$column+15,$rwPoli['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+16,$rwRehab['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+17,$rwOp['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+18,$rwPk['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+19,$rwRad['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+20,$rwPa['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+21,$rwEnd['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+22,$rwHd['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+23,$jmlTind,$regularFormatRFB);
	$worksheet->write($row-1,$column+24,$Bayar,$regularFormatRFB);
	$worksheet->write($row-1,$column+25,$rwObat['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+26,$rwObat['jml'],$regularFormatRFB);
	$worksheet->write($row-1,$column+27,$pmi,$regularFormatRFB);
	$worksheet->write($row-1,$column+28,$jumlahTindakan,$regularFormatRFB);
	$worksheet->write($row-1,$column+29,$krgByr,$regularFormatRFB);
...
$worksheet->write($row,$column+15,$poli,$TotFormatRF);
$worksheet->write($row,$column+16,$rehab,$TotFormatRF);
$worksheet->write($row,$column+17,$tindakanO,$TotFormatRF);
$worksheet->write($row,$column+18,$lab,$TotFormatRF);
$worksheet->write($row,$column+19,$rad,$TotFormatRF);
$worksheet->write($row,$column+20,$pa,$TotFormatRF);
$worksheet->write($row,$column+21,$end,$TotFormatRF);
$worksheet->write($row,$column+22,$hd,$TotFormatRF);
$worksheet->write($row,$column+23,$jmlTindakan,$TotFormatRF);
$worksheet->write($row,$column+24,$jmlTindakanByr,$TotFormatRF);
$worksheet->write($row,$column+25,$obat,$TotFormatRF);
$worksheet->write($row,$column+26,$byrobat,$TotFormatRF);
$worksheet->write($row,$column+27,$totpmi,$TotFormatRF);
$worksheet->write($row,$column+28,$jumlahTindakanObat,$TotFormatRF);
$worksheet->write($row,$column+29,$totkrgByr,$TotFormatRF);

...
<title>Rincian Pendapatan Rawat Inap KSO</title>
<style type="text/css">
...
<tr>
	<td align="center" valign="top" height="70" style="font-weight:bold; font-size:14px; text-transform:uppercase">rincian per nama pasien penerimaan rawat inap kso<br /><?php echo $Periode;?></td>
</tr>
<tr>
	<td align="center">
	<table width="100%" cellpadding="0" cellspacing="0" style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
	<tr valign="top">
		<td width="41" class="jdl" rowspan="2" valign="middle">No</td>
		<td width="41" class="jdl" rowspan="2" valign="middle">No MR</td>
		<td width="111" class="jdl" rowspan="2" valign="middle">Nama Pasien</td>
		<td width="91" class="jdl" rowspan="2" valign="middle">Status</td>
        <td class="jdl" colspan="20" valign="middle">Tagihan KSO</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">Jaminan KSO</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">IUR Bayar</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">Bayar Tindakan</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">OBAT</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">Bayar Obat</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">PMI</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">Jumlah Tindakan + Obat</td>
        <td width="71" class="jdl" valign="middle" rowspan="2">Kekurangan Bayar</td>
    </tr>
	<tr>
        <td width="69" class="jdl">MRS</td>
        <td width="71" class="jdl">KRS</td>
        <td width="71" class="jdl">HARI RAWAT</td>
        <td width="71" class="jdl">RUANG RAWAT</td>
        <td width="71" class="jdl">KELAS</td>
        <td width="71" class="jdl">KAMAR</td>
        <td width="71" class="jdl">MAKAN</td>
        <td width="71" class="jdl">TINDAKAN NON OPERATIF</td>
        <td width="71" class="jdl">JASA VISITE</td>
        <td width="71" class="jdl">KONSUL GIZI</td>
        <td width="71" class="jdl">IGD</td>
        <td width="71" class="jdl">KONSUL POLI</td>
        <td width="71" class="jdl">REHAB MEDIK</td>
        <td width="71" class="jdl">TINDAKAN OPERATIF</td>
        <td width="71" class="jdl">LAB PK</td>
        <td width="71" class="jdl">RAD</td>
        <td width="71" class="jdl">PA</td>
        <td width="71" class="jdl">ENDOSCOPY</td>
        <td width="71" class="jdl">HD</td>
        <td width="71" class="jdl">JUMLAH TINDAKAN</td>
	</tr>
	<form>
	<?php
	$fKso = "AND p.kso_id != '1'";
    /*if($stsPas!=0) $fKso = "AND p.kso_id = '".$stsPas."'";
    if($tmpLay==0){ 
...
WHERE mu.inap = '1' $fKso ORDER BY p.id";
	...
	<tr valign="top" class="isigrid">
		<td class="isicol" width="50" style="text-align:center;"><?php echo $i;?></td>
		<td class="isicol" width="50" style="text-align:center;"><?php echo $rw['no_rm'];?></td>
		<td class="isicol" width="100" style="padding-left:5px; text-transform:uppercase"><?php echo $rw['pasien'];?><br>
			<span id="txtNoP<?php echo $i;?>"><?php echo $rw['no_anggota'];?></span><br />
			<span id="NamaP<?php echo $i;?>"><?php echo $rw['nama_peserta'];?></span></td>
		<td class="isicol" width="100" style="padding-left:5px; text-transform:uppercase;" align="center"><?php echo $rw['nama']; ?></td>
		<td width="497" class="tbl" colspan="7"> 
			...
			{					 
				...
				?>
			<tr>
				<td class="isidlmkiri" width="13%" align="center"><?php echo $rwLop['masuk']?><br /></td>
				<td class="isidlm" width="13%" align="center"><?php echo $rwLop['keluar']?></td>
				<td class="isidlm" width="14%" align="center"><?php echo $rwLop['jHr']?></td>
				...
				<td class="isidlm" width="15%" align="right"><?php echo number_format($rwKamar['jml'],0,",",".");?></td>
				<td class="isidlmkanan" width="15%" align="right"><?php echo number_format($rwMakan['jml'],0,",","."); ?></td>
			</tr>
			<?php
			$j++;
			...
			?>
        <td width="71" align="right" class="isidlm"><?php if($rwLop['unit_id']=='47' || $rwLop['unit_id']=='63') echo "-"; else echo number_format($rwTin['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwVisite['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwGizi['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwIGD['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwPoli['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwRehab['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwOp['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwPk['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwRad['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwPa['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwEnd['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwHd['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($jmlTind,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwTin['jml2'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwTin['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($Bayar,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwObat['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rwObat['jml'],0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($pmi,0,",",".");?></td>
        <?php $jumlahTindakan = $Bayar+$rwObat['jml'];?>
        <td width="71" align="right" class="isidlm"><?php echo number_format($jumlahTindakan,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($krgByr,0,",",".");?></td>
	</tr>
	<?php
	}
	?>
	...
	<tr valign="top">
		<td width="50" class="last">&nbsp;</td>
		<td width="50" class="last">&nbsp;</td>
		<td width="100" class="last">&nbsp;</td>
		<td width="100" class="last">&nbsp;</td>
        <td colspan="5" width="355" height="25" class="isidlm" style="font-weight:bold;text-align:center;border-left:1px solid #000">TOTAL</td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($kamar,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($makan,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($tindakanNO,0,",",".");?></span></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($visite,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($gizi,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($igd,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($poli,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rehab,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($tindakanO,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($lab,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($rad,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($pa,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($end,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($hd,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($jmlTindakan,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($JKSO,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($tin,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($jmlTindakanByr,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($obat,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($byrobat,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($totpmi,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($jumlahTindakanObat,0,",",".");?></td>
        <td width="71" align="right" class="isidlm"><?php echo number_format($totkrgByr,0,",",".");?></td>
    </tr>
	</table>	
	</td>
</tr>

  	...
  	<td colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			<tr style="text-align:center; font-weight:bold;">
				...
				<td width="21%" style="border-top:1px solid; border-bottom:1px solid;" align="left">Tempat Layanan</td>
            ...
            ?>
            <tr>
            	<td colspan="7" style="font-weight:bold;"><?php echo $rwPetugas['nama']; ?></td>
            </tr>
			<?php
			$sql = "SELECT
					*

...
<?php
	...
	$st_setor = $_REQUEST['st_setor'];
				
	$fst_setor = "";
	$jdl_setor = "";
	if ($st_setor=='1'){
		$fst_setor = " AND (DATE(b.disetor_tgl)='0000-00-00' OR b.disetor_tgl IS NULL)";
		$jdl_setor = " (BELUM SETOR)";
	}
...
<table id="tblPrint" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
  ...
  <tr>
    <td colspan="2" align="center" height="70" valign="top" style="font-size:14px; text-transform:uppercase;"><b>Laporan Penerimaan Kasir<?php echo $jdl_setor;?><br />Periode <?php echo $tglAwal[0]." ".$arrBln[$tglAwal[1]]." ".$tglAwal[2].' s/d '.$tglAkhir[0]." ".$arrBln[$tglAkhir[1]]." ".$tglAkhir[2]?></b></td>
  </tr>
  <tr>
  	...
  	<td colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			...
			<tr style="text-align:center; font-weight:bold;">
				...
				<td width="60px" style="border-top:1px solid; border-bottom:1px solid;">Tgl Setor</td>
				...
				?>
				<td width="130px" style="border-top:1px solid; border-bottom:1px solid; padding-right:20px;" align="right">Diskon RS</td>
				<td width="130px" style="border-top:1px solid; border-bottom:1px solid; padding-right:20px;" align="right">Diskon Dokter</td>
			...
			<?php
				...
				$sql = "SELECT gb.id, gb.no_kwitansi, gb.nm_kasir, SUM(gb.nilai) nilai, gb.nilai nilaiBayar,
					...
					while($data = mysql_fetch_array($query)){
						$ctgl_setor=$data['tgl_setor'];
						$style_setor="";
						if ($data['st_setor']==0){
							$ctgl_setor="Blm Setor";
							$style_setor=" style='color:#FF0000;'";
						}
						echo "<tr>";
						echo "<td align='center'>{$no}</td>";
						echo "<td align='center'>".$data['tgl']." ".$data['jam']."</td>";
						echo "<td align='center'".$style_setor.">".$ctgl_setor."</td>";

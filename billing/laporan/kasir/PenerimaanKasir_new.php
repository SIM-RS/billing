  	...
  	<td colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			...
			<tr>
				...
				<td style="text-align:right; padding-right:20px;"><?php echo number_format($rwPas['nilai'] - $rwPas['nilai_diskon'] - $rwPas['nilai_diskon_dokter'],0,",",".");?></td>
			</tr>
			<?php
					$no++;
					$sub = $sub + $rwPas['nilai'] - $rwPas['nilai_diskon'] - $rwPas['nilai_diskon_dokter'];
					}

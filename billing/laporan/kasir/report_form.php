...
<div id="popup_div1" class="popup" style="width:500px;display:none;">
    ...
    <form id="form1" name="form1" action="PenerimaanPasien.php" method="post" target="_blank">
        ...
        <input id="st_setor" name="st_setor" type="hidden" value="0" />
        <fieldset>
            <legend>Kriteria Laporan</legend>
            <table width="450" align="center">
                <tr>
                    <td align="center" colspan="2">
                        <input size="10" value="<?php echo $date_now;?>" class="txtcenter" id="tglAwal" name="tglAwal" readonly/>
                        &nbsp;<input type="button" class="btninput" id="btnTglAwal" name="btnTgl" value=" V " onClick="gfPop.fPopCalendar(document.getElementById('tglAwal'),depRange);" />&nbsp;<input type="text" id="txtJam1" name="txtJam1" class="txtcenter" size="5" />
                        &nbsp;s.d.&nbsp;<input size="10" value="<?php echo $date_now;?>" class="txtcenter" id="tglAkhir" name="tglAkhir" />
                        &nbsp;<input type="button" class="btninput" id="btnTglAkhir" name="btnTgl" value=" V " onClick="gfPop.fPopCalendar(document.getElementById('tglAkhir'),depRange);" />&nbsp;<input type="text" id="txtJam2" name="txtJam2" class="txtcenter" size="5" />
                    </td>
                </tr>
                <tr id="rwJnsLay">
                ...
                <tr id="rwKasirAll">
                    <td align="right" width="30%">Kasir</td>
                    <td width="70%">&nbsp;<select id="cmbKsrAll" name="cmbKsrAll" class="txtinput"></select>
                    </td>
                </tr>
                <tr id="rwStatusPas">
                ...
                <tr id="rwStatusPasNonUmum">
                    <td width="30%" align="right">Status Pasien</td>
                    <td width="70%">&nbsp;<select name="StatusPasNonUmum" id="StatusPasNonUmum" tabindex="22" class="txtinput"></select>
                    </td>
                </tr>
                <tr>
					...
					<input type="button" value="Tampilkan" onclick="fSubmitKlik();" style="cursor:pointer;float:right" /></td>
                </tr>
            </table>
        </fieldset>
    </form>

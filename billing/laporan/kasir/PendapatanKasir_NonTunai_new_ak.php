  	...
  	<td colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			...
			<tr style="text-align:center; font-weight:bold;">
				...
				<td width="80px" style="border-top:1px solid; border-bottom:1px solid;">Jam</td>
				<td width="150px" style="border-top:1px solid; border-bottom:1px solid;">No.<br />Kunjungan</td>
				<td width="150px" style="border-top:1px solid; border-bottom:1px solid;">Tgl Kunjungan</td>
				<td width="120px" style="border-top:1px solid; border-bottom:1px solid;">No.RM</td>
					...
					$sql = "SELECT
							...
							FROM (SELECT
								  ...
								  SELECT
									...
									0                 AS `81009`,
									0                 AS `81010`,
									/*SUM((IF(t.status_out=0,DATEDIFF(IFNULL(t.tgl_out,k.tgl_pulang_ak),t.tgl_in)+1,IF(DATEDIFF(IFNULL(t.tgl_out,k.tgl_pulang_ak),t.tgl_in)=0,0,DATEDIFF(IFNULL(t.tgl_out,k.tgl_pulang_ak),t.tgl_in)+1)))* t.retribusi)*/ t.retribusi AS `81099`,
									0                 AS `41499`,
									0                 AS PPN_NILAI,
									peg.id            AS pegawai_id,
									peg.nama          AS pegawai_nama
			...
			<tr style="background:#efefef;">
				<td height="25" colspan="8" style="text-align:right; font-weight:bold; border-top:1px solid; ">GRAND TOTAL&nbsp;</td>

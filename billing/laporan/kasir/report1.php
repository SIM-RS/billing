                            ...
                            <tr>
                                <td style="line-height:30px;">
                                    <ol>
                                        ...
                                        <li><a href="javascript:void(0)" onclick="popupReport11(1)">Laporan Penerimaan Rawat Jalan Secara Keseluruhan</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport11(2)">Laporan Penerimaan Rawat Darurat Secara Keseluruhan</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport11(3)">Laporan Penerimaan Rawat Inap Secara Keseluruhan</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport12()">Rekapitulasi Penerimaan Kasir Rawat Inap</a></li>
										<li><a href="javascript:void(0)" onclick="popupReport17()">Rekapitulasi Penerimaan Kasir Rawat Inap 2</a></li>
                                        ...
                                        <!--li><a href="javascript:void(0)" onclick="popupReport18(0)">Laporan Rekapitulasi Penerimaan RSUD + PAVILYUN</a></li-->
                                        <!--li><a href="javascript:void(0)" onclick="popupReport18(1)">Laporan Rekapitulasi Penerimaan PAVILYUN</a></li-->
                                        <!--li><a href="javascript:void(0)" onclick="popupReport19()">Laporan Setoran Penerimaan Kasir</a></li>
										<hr /-->
										<li><a href="javascript:void(0)" onclick="popupReport23()">Laporan Setoran Penerimaan Kasir Berdasarkan Nama Kasir</a></li>
										<li><a href="javascript:void(0)" onclick="popupReport27()">Laporan Setoran Penerimaan Kasir / Pendapatan</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport28()">Laporan Pendapatan Non Tunai</a></li>
										<li><a href="javascript:void(0)" onclick="popupReport29()">Laporan Pendapatan ( Tunai + Non Tunai )</a></li>
                                        <!--li><a href="javascript:void(0)" onclick="popupReport24()">Laporan Pasien KRS Berdasarkan Tempat Layanan</a></li>
                                        <li><a href="javascript:void(0)" onclick="popupReport25()">Laporan Pasien KRS Berdasarkan Kasir</a></li>
										<li><a href="javascript:void(0)" onclick="popupReport26()">Laporan Tindakan Yang Dientri Setelah KRS</a--></li>
                                        <!--<li><a href="javascript:void(0)" onclick="popupReport20()">Laporan Iur Bayar</a></li>-->
                                    </ol>
                                </td>
                            </tr>
                        </table>

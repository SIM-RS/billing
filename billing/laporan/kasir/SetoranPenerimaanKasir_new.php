			...
			<?php
					if($nmKasir!=0){
						if ($kasir==0){
							...
							$fKasir = "b_bayar.kasir_id = '".$kasir."' AND b_bayar.disetor_oleh = '".$nmKasir."'";
							$fJnsKasir = " AND b_bayar.kasir_id = '".$kasir."' ";
						}
					}else{
						$fKasir = "1 = 1";
						$fJnsKasir = "";
						if ($kasir!="0"){
							$fKasir = "b_bayar.kasir_id = '".$kasir."'";
							$fJnsKasir = " AND b_bayar.kasir_id = '".$kasir."' ";
						}
					}
					$sqlNm = "SELECT 

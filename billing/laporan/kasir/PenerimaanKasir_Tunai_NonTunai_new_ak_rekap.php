  	...
  	<td colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			...
			<tr style="text-align:center; font-weight:bold;">
			  <td colspan="6" align="left">Tunai</td>
		  </tr>
			<tr style="text-align:center; font-weight:bold;">
			...
			<?php
				...
				$sql = "SELECT gb.id, gb.no_kwitansi, gb.nm_kasir, SUM(gb.nilai) nilai, gb.nilai nilaiBayar,
						...
						GROUP BY gb.tgl, gb.nm_kasir, gb.kso 
						ORDER BY gb.tgl ";
					//echo $sql;
			...
			<tr>
			  <td height="25" colspan="18" style="text-align:right; font-weight:bold; border-top:1px solid; ">&nbsp;</td>
		  	</tr>
			<tr style="text-align:center; font-weight:bold;">
			  <td colspan="6" align="left">Non Tunai</td>
		  </tr>
			<tr style="text-align:center; font-weight:bold;">
				<td width="30" style="border-top:1px solid; border-bottom:1px solid;">No</td>
			...
			<tr style="background:#efefef;">
				<td height="25" colspan="4" style="text-align:right; font-weight:bold; border-top:1px solid; ">TOTAL TUNAI + NON TUNAI&nbsp;</td>

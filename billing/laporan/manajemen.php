...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div align="center">
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
                <tr>
                    <td height="30">&nbsp;LAPORAN MANAJEMEN</td>
                </tr>
            </table>
        ...
        <div id="div_laporan" style="display:none;width:775px; height:475px" class="popup">
            <img alt="close" src="../icon/x.png" width="32" class="popup_closebox" style="float:right; cursor: pointer" />
            <fieldset>
                <legend>Laporan Manajemen</legend>
                <table width="750" align="center">
                    <tr>
                        <td width="50%" onclick="manj1()" style="cursor:pointer;">Kinerja Operator Pendaftaran Pasien Baru</td>
                        <td width="50%" onclick="manj2()" style="cursor:pointer;">Kinerja Operator Kunjungan</td>
                    </tr>
                    <tr>
                        <td onclick="manj3()" style="cursor:pointer">Kinerja Operator Penerimaan Retribusi Pemeriksaan</td>
                        <td><a href="" target="_blank">Kinerja Operator Tindakan</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Kinerja Operator Medik</a></td>
                        <td><a href="" target="_blank">Kinerja Kasir</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Kegiatan Pengguna Aplikasi</a></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Piutang Berdasarkan Tempat Layanan</a></td>
                        <td><a href="" target="_blank">Piutang Berdasarkan Penjamin Pasien</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Pendapatan Berdasarkan Jenis Layanan</a></td>
                        <td><a href="" target="_blank">Penerimaan Berdasarkan Jenis Layanan</a></td>
                    </tr>
                    <tr>
                        <td onclick="manj4()" style="cursor:pointer;">Klaim Jaminan Berdasarkan Jenis Layanan</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="" target="_blank">Klaim Jaminan Berdasarkan Tempat Layanan</a></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="" target="_blank">Klaim Jaminan Berdasarkan Klasifikasi Layanan</a></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="" target="_blank">Klaim Jaminan Berdasarkan Penjamin Pasien</a></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Pendapatan Berdasarkan Penjamin Pasien & Klasifikasi Layanan</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Penerimaan Berdasarkan Penjamin Pasien & Klasifikasi Layanan</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="" target="_blank">Klaim Jaminan Berdasarkan Penjamin Pasien & Klasifikasi Layanan</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Distribusi Pendapatan Medik Non Operatif</a></td>
                        <td><a href="" target="_blank">Distribusi Penerimaan Medik Non Operatif</a></td>
                    </tr>
                    <tr>
                        <td><a href="" target="_blank">Distribusi Klaim Jaminan Medik Non Operatif</a></td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </fieldset>
    ...
    <script type="text/JavaScript">
        ...
        function manj1()
        {
            ...
            window.open('manajemen/KinOperPendftrnPasienBaru.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
        ...
        function manj2()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('manajemen/LapKinerjaOperatorKunj.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
        ...
        function manj3()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('manajemen/LapKinerjaOperatorPenerimaan.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
        ...
        function manj4()
        {
            ...
            var tglAwal = document.getElementById("tglAwal").value;
            var tglAkhir = document.getElementById("tglAkhir").value;
            window.open('manajemen/KlaimJaminanJenisLayanan.php?jnsLay='+JnsLayanan+'&tmptLay='+TmpLayanan+'&stsPas='+StatusPas+'&tglAwal='+tglAwal+'&tglAkhir='+tglAkhir,'_blank');
        }
    </script>
</html>
<?php 

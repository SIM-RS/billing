...
<table width="700" border="0" style="border-collapse:collapse; font:12px arial">
  <tr>
    <td><table width="100%" border="0" style="border-collapse:collapse">
      <tr>
        ...
        <td width="59%" height="18"><span class="style1">Formulir RL 5.3 </span></td>
        <td width="32%" rowspan="3" style="border-bottom:2px solid #000000"><img src="pojok.png" /></td>
      </tr>
      <tr>
        <td height="18" ><span class="style1">Daftar 10 Besar Penyakit berdasarkan Pasien Pulang </span></td>
        </tr>
      <tr>
  ...
  <?php
  $que="SELECT * FROM b_profil;";
  $ident=mysql_fetch_array(mysql_query($que));
  $namaRS=$ident['nama'];
  ?>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="1" style="border-collapse:collapse">
      <tr>
        ...
        <td width="30%" rowspan="2"><div align="center"><strong>DESKRIPSI</strong></div></td>
        <td colspan="2" width="20%"><div align="center"><strong>Pasien Keluar Hidup Menurut Jenis Kelamin </strong></div></td>
        <td colspan="2" width="20%"><div align="center"><strong>Pasien Keluar Mati Menurut Jenis kelamin </strong></div>          <div align="center"></div></td>
        <td width="10%" rowspan="2"><div align="center"><strong>Total (Hidup &amp; Mati) </strong></div></td>
        </tr>
      <tr>
        <td width="10%"><div align="center"><strong>LK</strong></div></td>
        <td width="10%"><div align="center"><strong>PR</strong></div></td>
        <td><div align="center"><strong>LK</strong></div></td>
        <td><div align="center"><strong>PR</strong></div></td>
      </tr>
      <tr bgcolor="#CCCCCC">
...
SUM(IF(b_ms_pasien.sex = 'L' AND b_pasien_keluar.cara_keluar LIKE '%Meninggal' , 1, 0)) cow,
SUM(IF(b_ms_pasien.sex = 'P' AND b_pasien_keluar.cara_keluar LIKE '%Meninggal',  1, 0)) cew,
SUM(IF(b_ms_pasien.sex = 'L' AND b_pasien_keluar.cara_keluar NOT LIKE '%Meninggal' , 1, 0)) cow_hidup,
SUM(IF(b_ms_pasien.sex = 'P' AND b_pasien_keluar.cara_keluar NOT LIKE '%Meninggal',  1, 0)) cew_hidup,
...
$sql="SELECT tes.*, cow+cew+cow_hidup+cew_hidup AS jml
FROM(
SELECT 
  b_diagnosa.diagnosa_id id,
  b_ms_diagnosa.kode kode,
...
FROM
  b_ms_diagnosa 
  INNER JOIN b_diagnosa 
    ON b_ms_diagnosa.id = b_diagnosa.ms_diagnosa_id 
...
WHERE b_diagnosa.primer = 1 
  $fUnit $waktu 
	GROUP BY b_ms_diagnosa.id ) tes 
	ORDER BY jml DESC,nama
	LIMIT 10 ;";
...
?>		
      <tr>
        ...
        <td><div align="center"><?=$data['kode'];?></div>          </td>
        <td><?=$data['nama'];?></td>
        <td><div align="center">
          <?=$data['cow_hidup'];?>
        </div></td>
		...
		<?php
		$tot=$data['cow']+$data['cew']+$data['cow_hidup']+$data['cew_hidup'];
		?>

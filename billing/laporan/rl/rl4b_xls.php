...
$worksheet->write($row+1, 1, "Formulir RL 4B",$UnitTitleFormatL);
$worksheet->write($row+2,1, "DATA KEADAAN MORBIDITAS PASIEN RAWAT JALAN ".$rwUnit22."",$UnitTitleFormatL);
...
$worksheet->write($row, $column+4, "Jumlah Pasien Kasus Menurut Golongan Umum dan Sex", $columnTitleFormat);
...
$worksheet->write($row, $column+22, "Kasus Baru Menurut Jenis Kelamin", $columnTitleFormat);
...
$worksheet->write($row, $column+25, "Jumlah Kunjungan", $columnTitleFormat);
...
$worksheet->write($row, $column+25, ($jum_kunj==0)? '': $jum_kunj, $textBiasa2);
...
$worksheet->write($row, $column+25, ($tKunj==0)? '': $tKunj, $textBiasa2);

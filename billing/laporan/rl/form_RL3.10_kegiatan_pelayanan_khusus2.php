  ...
  <tr>
    <td><table width="100%" border="0" style="border-collapse:collapse">
      <tr>
        ...
        <td width="55%" height="32"><span class="style1">Formulir RL 3.10</span></td>
        <td width="36%" rowspan="2" style="border-bottom:2px solid #000000"><img src="pojok.png" /></td>
      </tr>
      <tr>
        <td height="24" style="border-bottom:2px solid #000000"><span class="style1">KEGIATAN PELAYANAN KHUSUS </span></td>
      </tr>

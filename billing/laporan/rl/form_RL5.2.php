...
<table width="700" border="0" style="border-collapse:collapse; font:12px arial">
  <tr>
    <td><table width="100%" border="0" style="border-collapse:collapse">
      <tr>
        <td width="9%" rowspan="3" style="border-bottom:2px solid #000000"><img src="logo-bakti-husada.jpg" width="49" height="60" /></td>
        <td width="55%" height="18"><span class="style1">Formulir RL 5.2 </span></td>
        <td width="36%" rowspan="3" style="border-bottom:2px solid #000000"><img src="pojok.png" /></td>
      </tr>
      <tr>
        <td height="18"><span class="style1">KUNJUNGAN <?php echo $txtJenis.' '.$txtTempat; ?></span></span></td>
      </tr>
      <tr>
        <td height="19" style="border-bottom:2px solid #000000">&nbsp;</td>
        </tr>
    </table></td>
  </tr>
  <tr>
...
$hasil = mysql_query($query); //echo $query;
$no = 1;

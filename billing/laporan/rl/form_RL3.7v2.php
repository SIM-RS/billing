...
<title>Kegiatan radiologi</title>
<style type="text/css">
<!--
.style1 {
	font-size: 14px;
...
*/
?>
<table width="600" border="0" style="border-collapse:collapse; font:12px arial">
  <tr>
    <td><table width="100%" border="0" style="border-collapse:collapse">
      <tr>
        ...
        <td width="59%" height="29"><span class="style1">Formulir RL 3.7 </span></td>
        <td width="32%" rowspan="2" style="border-bottom:2px solid #000000"><img src="pojok.png" /></td>
      </tr>
	  <tr>
        <td height="18" style="border-bottom:2px solid #000000" ><span class="style1">Kegiatan Radiologi </span></td>
        </tr>
...
WHERE b_ms_tindakan.klasifikasi_id=6 $waktu
GROUP BY b_ms_kelompok_tindakan.nama, b_ms_tindakan.nama";

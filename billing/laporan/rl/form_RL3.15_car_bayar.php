...
<table width="943" style="border-collapse:collapse;border:1px solid #000">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="7" rowspan="2"><div align="center"><strong>CAR BAYAR</strong></div></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="14"><table width="1215" border="1" style="border-collapse:collapse;">
      <tr>
        <th width="39" rowspan="2" scope="col">NO</th>
        <th width="151" rowspan="2" scope="col">CARA PEMBAYARAN</th>
        <th colspan="2" scope="col">PASIEN RAWAT INAP</th>
        <th width="77" rowspan="2" scope="col">JUMLAH PASIEN RAWAT JALAN</th>
        <th colspan="3" scope="col">JUMLAH PASIEN RAWAT JALAN</th>
        </tr>
      <tr>
        <th width="137" scope="col">JUMLAH PASIEN KELUAR</th>
        <th width="133" scope="col">JUMLAH LAMA DIRAWAT </th>
        <th width="97" scope="col">LABORATORIUM</th>
        <th width="101" scope="col">RADIOLOGI</th>
        <th width="74" scope="col">LAIN - LAIN</th>
        </tr>
      <tr>

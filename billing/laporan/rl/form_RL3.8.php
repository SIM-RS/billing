...
<table width="700" border="0" style="border-collapse:collapse; font:12px arial">
  <tr>
    <td><table width="100%" border="0" style="border-collapse:collapse">
      <tr>
        ...
        <td width="59%" height="30"><span class="style1">Formulir RL 3.8 </span></td>
        <td width="32%" rowspan="2" style="border-bottom:2px solid #000000"><img src="pojok.png" /></td>
      </tr>
      <tr>
        <td height="30" style="border-bottom:2px solid #000000"><span class="style1">PEMERIKSAAN LABORATORIUM </span></td>
        </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="1" style=" border:1px solid; border-collapse:collapse">
      <tr>
        <td width="8%" style="border-right:1px solid #000000"><div align="center"><strong>No. </strong></div></td>
        <td width="72%"><div align="center"><strong>Jenis Kegiatan </strong></div></td>
        <td width="20%"><div align="center"><strong>Jumlah Kunjungan </strong></div></td>
        </tr>
      <tr bgcolor="#CCCCCC">
...
INNER JOIN b_tindakan ON b_tindakan.kunjungan_id=b_kunjungan.id
...
WHERE b_ms_tindakan.klasifikasi_id=6 $waktu
GROUP BY b_ms_tindakan.nama";*/

$sql="SELECT 
  b_ms_kelompok_tindakan.nama kelompok,
...
FROM
  ...
  INNER JOIN b_ms_kelompok_tindakan 
    ON b_ms_kelompok_tindakan.id = b_ms_tindakan.kel_tindakan_id 
WHERE b_ms_tindakan.klasifikasi_id = 5 $waktu
GROUP BY b_ms_kelompok_tindakan.nama,
  b_ms_tindakan.nama";
...
while ($data=mysql_fetch_array($hasil))
{
			?>
				...
				<tr>
					...
					<td><div align="center"><?php echo $data['jml'];?> </div>					
					</td>
				</tr>      
<?php
$tot=$data['jml']+$tot;
...
?>
      <tr>
        ...
        <td bgcolor="#CCCCCC"><div align="center"><?=$tot;?></div></td>
      </tr>      
    </table></td>
    <tr id="trTombol">

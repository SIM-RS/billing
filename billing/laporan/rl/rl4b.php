...
<tr>
<td>Kode RS</td>
<td><input type="text" id="textKodeRS" name="textKodeRS" value="3671208S " style="text-align:center;" readonly size="50" />
</tr>
<tr>
<td>Nama RS</td>
...
$waktu AND d.kasus_baru=1 AND d.primer=1 GROUP BY k.kel_umur,mp.sex";
			...
			while($rw = mysql_fetch_array($rs)){
				//echo $rw['kel_umur']." -------<br />";
					...
					if($rw['kel_umur']==210) if($rw['sex']=='L'){ $L6=$rw['jml'];}else{$P6=$rw['jml'];}
					if($rw['kel_umur']==211) if($rw['sex']=='L'){ $L7=$rw['jml'];}else{$P7=$rw['jml'];}
					if($rw['kel_umur']==212) if($rw['sex']=='L'){ $L8=$rw['jml'];}else{$P8=$rw['jml'];}
					if($rw['kel_umur']==213) if($rw['sex']=='L'){ $L9=$rw['jml'];}else{$P9=$rw['jml'];}

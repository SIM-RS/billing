...
header('Content-Disposition: attachment; filename="Lap Jasa Pelaksana.xls"');
}
?>
<?php
  ...
  <tr>
	...
	?>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
			<tr height="30">
				<td style="border-top:1px solid; border-bottom:1px solid; border-left:1px solid;">&nbsp;NO</td>
				<td style="border-top:1px solid; border-bottom:1px solid; border-left:1px solid;">&nbsp;PELAKSANA</td>
				<td colspan="2" style="border-top:1px solid; border-bottom:1px solid; border-left:1px solid;">&nbsp;RETRIBUSI</td>
				<td style="border-top:1px solid; border-bottom:1px solid; border-left:1px solid; text-align:center">Jumlah<br />Px</td>
			  ...
			  <?php
					 $sqlJapel = "SELECT b_ms_pegawai.id, b_ms_pegawai.nama, COUNT(b_pelayanan.pasien_id) AS jmlPx, COUNT(b_tindakan.pelayanan_id) AS jmlTd
			FROM b_ms_pegawai
			...
			AND b_tindakan.user_id= '".$rwJapel['id']."' AND $waktu $penjamin";
						...
						$sqlTindakan="SELECT SUM(t.jmlTind) AS tindakan, SUM(t.jmlJapel) AS tjapel FROM (SELECT b_tindakan.biaya, b_tindakan.qty, b_tindakan.biaya*b_tindakan.qty AS jmlTind, 
b_tindakan_komponen.tarip, b_tindakan_komponen.tarip*b_tindakan.qty AS jmlJapel
FROM b_tindakan_komponen INNER JOIN b_tindakan ON b_tindakan_komponen.tindakan_id = b_tindakan.id 
INNER JOIN b_ms_tindakan_kelas ON b_ms_tindakan_kelas.id=b_tindakan.ms_tindakan_kelas_id 
INNER JOIN b_ms_tindakan ON b_ms_tindakan.id=b_ms_tindakan_kelas.ms_tindakan_id 
...
WHERE ".($unit!='semua'?"b_tindakan.ms_tindakan_unit_id= '".$unit."' AND":"")."
			...
			AND $waktu $penjamin) AS t";
			  ...
			  ?>
			  <tr>
				<td width="3%" style="border-left:1px solid; border-bottom:1px solid;" align="center"><?php echo $no;?></td>
				<td width="27%" style="border-left:1px solid; border-bottom:1px solid; text-transform:uppercase;">&nbsp;<?php echo $rwJapel['nama'];?></td>
				<td width="3%" style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
				<td width="9%" style="border-bottom:1px solid;" align="right"><?php echo number_format($rwRetribusi['retribusi'],0,",",".");?>&nbsp;&nbsp;&nbsp;</td>
				<td width="5%" style="border-left:1px solid; border-bottom:1px solid; padding-right:5px;" align="right"><?php echo $rwJapel['jmlPx'];?></td>
				<td width="3%" style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
				<td width="9%" style="border-bottom:1px solid;" align="right"><?php echo number_format($rwRetribusi['japel'],0,",",".");?>&nbsp;&nbsp;&nbsp;</td>
				<td width="3%" style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
				<td width="9%" style="border-bottom:1px solid;" align="right"><?php echo number_format($rwTindakan['tindakan'],0,",",".");?>&nbsp;&nbsp;&nbsp;</td>
				<td width="5%" style="border-left:1px solid; border-bottom:1px solid; padding-right:5px;" align="right"><?php echo $rwJapel['jmlTd'];?></td>
				<td width="3%" style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
				<td width="9%" style="border-bottom:1px solid;" align="right"><?php echo number_format($rwTindakan['tjapel'],0,",",".");?>&nbsp;&nbsp;&nbsp;</td>	
				<td width="3%" style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
				<?php $jml = $rwRetribusi['retribusi'] + $rwTindakan['tindakan'];?>
				<td width="9%" style="border-bottom:1px solid; border-right:1px solid;" align="right"><?php echo number_format($jml,0,",","."); ?>&nbsp;&nbsp;&nbsp;</td>
			  </tr>
			  <?php
					$no++;
					...
					$jmlJml = $jmlJml + $jml;
					$tjmlPx = $tjmlPx + $rwJapel['jmlPx'];
					$tjmlTd = $tjmlTd + $rwJapel['jmlTd'];
					}
			  ?>
			  <tr style="font-weight:bold;">
				...
				<td style="border-left:1px solid; border-bottom:1px solid; padding-right:5px;" align="right"><?php echo $tjmlPx?></td>
				<td style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
				...
				<td style="border-left:1px solid; border-bottom:1px solid; padding-right:5px;" align="right"><?php echo $tjmlTd?></td>
				<td style="border-left:1px solid; border-bottom:1px solid;" align="right">Rp.&nbsp;</td>
...
AND $waktu $penjamin GROUP BY b_ms_pegawai.id";					
			  ...
			  <tr>
				...
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td align="right" style="border-top:1px solid; font-size:12px; font-weight:bold;">&nbsp;</td>

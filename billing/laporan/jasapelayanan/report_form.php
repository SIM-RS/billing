...
<div id="popup_div1" class="popup" style="width:500px;display:none;">
    <div style="float:right; cursor:pointer" class="popup_closebox">
		...
		<br>
    <form id="form1" name="form1" action="japel.php" method="post" target="_blank">
			...
			<legend>Kriteria Laporan</legend>
				<table width="450" align="center">
					...
					<tr id="rwJnsLayBr">
					 ...
					 <tr id="rwTmpLayBr">
						<td align="right">Tempat Layanan</td>
						<td>&nbsp;<select name="TmpLayananBaru" id="TmpLayananBaru" tabindex="27" class="txtinput" onchange="isiCombo('cmbDokSemua',this.value,<?php echo $userId; ?>);"></select>
						</td>
					 </tr>
					<tr id="JnsPav">
						<td align="right">Jenis Layanan</td>
					...
					<tr>
						...
						<td colspan="2"><div style="float:right"><button type="submit" id="tampil"><img src="../../icon/zoom_in.png" width="24" align="absmiddle" />&nbsp;Tampilkan</button>&nbsp;<button type="button" id="btnExpExcl" onClick="zxc()"><img src="../../icon/excel.png" width="24" align="absmiddle" />&nbsp;Export ke Excel</button></div></td>
					</tr>
				</table>
		</fieldset>
    </form>

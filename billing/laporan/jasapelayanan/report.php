				...
				<tr>
					<td style="line-height:30px;">
						 <ol>
						 	...
						 	<li><a href="javascript:void(0)" onclick="popupReport1();variabel=1;sts=1;tipe=1;change()">Rincian Pendapatan Jasa Pelaksana</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport3();variabel=1;sts=1;tipe=1;change()">Rekap Penghitungan Jasa Pelaksana</a></li>
                            <li><a href="javascript:void(0)" onclick="popupReport4();variabel=1;sts=1;tipe=1;change()">Rincian Penghitungan Jasa Pelaksana</a></li>
						 </ol>
					</td>
				</tr>
			</table>
...
<script>
	...
	function showPel(){	
		...
		isiCombo('cmbDokJns',document.getElementById('TmpLayanan').value,<?php echo $userId; ?>);
	...
	function showDok(){
		...
		if(user==43){
			...
			//document.getElementById('rwPelaksanaDok').a
		}
	}
	...
	function popupReport1()
	{
		...
		document.getElementById('form1').action='rincian_pendapatan.php';
	}
	...
	function popupReport3()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='penghitungan.php';
	}
	...
	function popupReport4()
	{
		new Popup('popup_div1',null,{modal:true,position:'center',duration:0.5})
		$('popup_div1').popup.show();
		document.getElementById('form1').action='rincian_penghitungan.php';
	}

...
<table width="1000" border="0" cellspacing="0" cellpadding="0" class="tabel" align="center">
  ...
  <tr>
    ...
    <td width="20%">&nbsp;<select id="cmbKlasi" name="cmbKlasi" class="txtinput" onchange="loadGrid()"></select></td>
  	<td width="5%">&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
    <td align="right">Tempat Layanan</td>
    <td>&nbsp;<select id="TmpLayanan" name="TmpLayanan" class="txtinput" onchange="loadGrid()">
	</select></td>
    <td>&nbsp;</td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
...
<script>
	...
	function showTabel(){
		//alert("tabel_utils.php?grd3=true&jns="+document.getElementById('JnsLayanan').value+"&tmp="+document.getElementById('TmpLayanan').value+"&cmbKlasi="+document.getElementById('cmbKlasi').value);
	...
	function goFilterAndSort(grd){
		...
		if (grd=="gridbox"){
			...
			a.loadURL("tabel_utils.php?grd3=true&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage()+"&jns="+document.getElementById('JnsLayanan').value+"&tmp="+document.getElementById('TmpLayanan').value+"&cmbKlasi="+document.getElementById('cmbKlasi').value,"","GET");
	...
	a.setHeader("DATA TARIF TINDAKAN");
	a.setColHeader("KODE PANGGIL,KELOMPOK,NAMA TINDAKAN,KELAS,TARIF");
	a.setIDColHeader(",,b_ms_tindakan.nama,,");
	a.setColWidth("75,100,300,75,75");
	a.setCellAlign("center,left,left,left,right");
	a.setCellHeight(20);
	a.setImgPath("../icon");

    ...
    <td colspan="3" align="center">
		...
		<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="tabel" align="center">
		  ...
		  <tr>
			...
			<td width="20%">&nbsp;<select id="TmpLayanan" class="txtinput" onchange="ubahUnit();"></select></td>
			<td width="5%">&nbsp;</td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
		  ...
		  <tr>
			...
			<td colspan="5">&nbsp;<input type="text" class="txtcenterreg" id="tanggal" size="11" tabindex="22" value="<?php echo date('d-m-Y');?>"/>
...
function goFilterAndSort(){
	...
	grd.loadURL("jadwal_dokter_utils.php?unit_id="+unit_id+'&tanggal='+tanggal+"&filter="+grd.getFilter()+"&sorting="+grd.getSorting()+"&page="+grd.getPage(),"","GET");
}
...
grd.setColHeader("NO,WAKTU,NAMA,NIP");
grd.setIDColHeader(",jam,p.nama,nip");
grd.setColWidth("30,140,500,230");
grd.setCellAlign("center,center,left,center");

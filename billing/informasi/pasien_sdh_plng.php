...
<title>Informasi Pasien Yang Sudah Pulang</title>
</head>
...
<table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
	<tr>
		<td height="30">&nbsp;INFORMASI PASIEN YANG SUDAH PULANG</td>
	</tr>
</table>
<table width="1000" border="0" cellspacing="0" cellpadding="0" class="txtinput" align="center">
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;<input size="8" value="14/07/2010" />&nbsp;s/d&nbsp;<input size="8" value="14/07/2010" /></td>
	<td width="5%">&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
    ...
    <td colspan="2" align="left">&nbsp;<input size="30" /></td>
	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
    ...
    <td colspan="2">&nbsp;<select name="select">
      <option>ANGKASA PURA I, PT</option>
      ...
      <option>BHAKTI NADINA, PT</option>
    </select></td>
  ...
  <tr>
    ...
    <input type="checkbox" />&nbsp;Menampilkan semua data sesuai periode yang dipilih</td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
...
<script>
	...
	a.setColHeader("TANGGAL,NO RM,NAMA PASIEN,ALAMAT,TEMPAT LAYANAN,STATUS PASIEN,PETUGAS YANG MEMULANGKAN");
	//a.setIDColHeader(",,NoRM,Kode,Nama,Alamat,Penjamin,dokter,Poli");
	a.setColWidth("75,75,120,150,150,150,250");

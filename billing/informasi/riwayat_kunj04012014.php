...
<table width="1000" border="0" cellspacing="1" cellpadding="0" class="tabel" align="center">
  ...
  <td width="5%">&nbsp;</td>
    ...
    <td colspan="2">&nbsp;<input type="text" name="NoRm" id="NoRm" size="20" class="txtinputreg" tabindex="1" onkeyup="listPasien(event,'show',this.value,this.id)"/>
			<input type="hidden" id="hidRM" />
               <input id="txtIdKunj" name="txtIdKunj" type="hidden"/>&nbsp;</td>
  ...
  <td>&nbsp;</td>
    ...
    <td colspan="3">&nbsp;<input type="text" class="txtinputreg" name="Nama" id="Nama" size="50" tabindex="3" onkeyup="listPasien(event,'show',this.value)"/><div id="div_pasien" align="center" class="div_pasien"></div>
	</td>
    <td width="5%">&nbsp;</td>
    <td width="10%" align="right">Alamat</td>
    <td>&nbsp;<input id="txtalamat" name="txtalamat" size="50" class="txtinputreg"/></td>
  <td>&nbsp;</td>
  </tr>
  <tr>
  <td>&nbsp;</td>
    ...
    <td colspan="2">&nbsp;
    <select name="Gender" id="Gender" class="txtinputreg">
...
<script>
	...
	function goFilterAndSort(grd){
		//alert(grd);
		if (grd=="gridboxRiw1"){			
			riw1.loadURL("tabel_utils.php?grdRiw1=true&idKunj="+dataPasien[1]+"&idPas="+dataPasien[0]+"&filter="+riw1.getFilter()+"&sorting="+riw1.getSorting()+"&page="+riw1.getPage(),"","GET");
	...
	//alert(how);
		if(how=='show'){
			if(feel.which==13  && keyword!=stuff){
				...
				Request('pasien_list.php?act=cari&keyword='+stuff,'div_pasien','','GET');
				RowIdx=0;
			}
	...
	function setPasien(val)
	{
		...
		fSetValue(window,p);
		document.getElementById('div_pasien').style.display='none';
		riw1.loadURL("tabel_utils.php?grdRiw1=true&idKunj="+dataPasien[1]+"&idPas="+dataPasien[0],"","GET");
	}
	...
	function ambilDataRiw2()
	{
     ...
     function ambilAkses(){
        if(document.getElementById('spanRes').innerHTML > '0'){
            ...
            document.getElementById('btnDelKun').style.display = 'block';
        }
        else{
            document.getElementById('btnDelTin').style.display = 'none';
            document.getElementById('btnDelKun').style.display = 'none';
        }

...
<table width="1000" border="0" cellspacing="0" cellpadding="0" class="tabel" align="center">
  ...
  <td width="2%">&nbsp;</td>
    ...
    <td width="10%">&nbsp;</td>
	<td>Status Pulang</td>
    <td align="left" colspan="2"><select name="statusPul" id="statusPul" class="txtinput" onchange="goFilterAndSort('gridbox');">
  ...
  <td>&nbsp;</td>
    ...
    <td>&nbsp;<select name="StatusPas" id="StatusPas" onchange="showTabel();" class="txtinput"></select></td>
    <td>&nbsp;</td>
...
<script>	
	...
	function loadGrid(){
		...
		if (isLoaded==0){
			...
			a.setColHeader("NO,JENIS LAYANAN,TEMPAT LAYANAN,TGL MULAI,TGL SELESAI,NO RM,NAMA PASIEN,ALAMAT,STATUS PASIEN,PULANG");
			a.setIDColHeader(",jns_layanan,tmp_layanan,,,no_rm,nama,alamat,statuspas,");

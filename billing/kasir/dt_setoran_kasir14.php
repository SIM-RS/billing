        ...
        <tr>
            <td>
                <table width="100%">
                    ...
                    <img alt="tglAwal" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/simrs/billing/icon/archive1.gif" onClick="gfPop.fPopCalendar(document.getElementById('txtTglAwal'),depRange,getChange);" style="cursor: pointer"/>
                    &nbsp;s/d :&nbsp;                                    
                    ...
                    <img alt="tglAkhir" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/simrs/billing/icon/archive1.gif" onClick="gfPop.fPopCalendar(document.getElementById('txtTglAkhir'),depRange,getChange);" style="cursor: pointer"/>
                							</td>
                                            <td width="100">&nbsp;</td>
                                            <td>Tgl Setor</td>
                    ...
                    <img alt="tglSetor" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/simrs/billing/icon/archive1.gif" onClick="gfPop.fPopCalendar(document.getElementById('txtTglSetor'),depRange,getChange);" style="cursor: pointer"/></td>
                						</tr>
                						<tr>
                                        	<td>Nama Kasir</td>
...
function cetak(){
	window.open('cetak_setoran.php?tgl='+document.getElementById('txtTglSetor').value+'&kasir=<?=$_SESSION['userId'];?>'+"&filter="+b_kanan.getFilter());	
}
function kwitansi(){
	window.open('kwitansi.php?tgl='+document.getElementById('txtTglSetor').value+'&kasir=<?=$_SESSION['userId'];?>'+"&filter="+b_kanan.getFilter());	
}
function getChange(){

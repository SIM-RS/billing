...
<table width="850" border="0" cellpadding="0" cellspacing="1" align="center">
    ...
    <span id="temp_lab" style="display:none"></span>
</table>
</div>
<div id="tab_radiologi">
<form id="frmRad" name="frmRad" method="post">
<table width="850" border="0" cellpadding="0" cellspacing="1" align="center" style="padding-top:10px">
    ...
    <tr>
        ...
        <td align="right"><select id="cmbTipeHasilRad" name="cmbTipeHasilRad" class="txtinput">
                <option value="0">HTML</option>
                <option value="1">PDF</option>
                <!--option value="2">MS-WORD</option-->
            </select>&nbsp;<input type="button" size="10" class="txtinput" value="Cetak Hasil" onClick="cetakHslRad()" />&nbsp;<input type="button" onclick="lihatPemeriksaan2()" value="Lihat Permintaan" class="txtinput" size="10"></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td align="right">Tindakan :&nbsp;</td>
	...
	<tr>
        ...
        <td rowspan="2" colspan="2"><input type="hidden" id="id_hasil_rad" name="id_hasil_rad" /><input type="hidden" id="id_tind_rad" name="id_tind_rad" /><textarea id="txtHslRad" name="txtHslRad" class="txtHslRad" style="width:600px; height:300px"></textarea><span id="spnHasilRad" style="display:none"></span></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
    ...
    <tr>
        ...
        <td align="center" height="28">
            ...
            <input type="button" id="btnSimpanHslRad" name="btnSimpanHslRad" disabled="disabled" value="Simpan" onclick="fSimpanHslRad(this.value,this.id,'txtTind');" class="tblTambah"/>
            <!--button type="button" id="btnSimpanHslRad" name="btnSimpanHslRad" disabled="disabled" value="Tambah" onclick="fSimpanHslRadNew(this.value,this.id,'txtTind');" class="tblTambah"/>&nbsp;Simpan</button-->

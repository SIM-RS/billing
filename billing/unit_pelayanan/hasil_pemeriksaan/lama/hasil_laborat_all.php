...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	?>
		...
		<?=$alamatRS?> <?php echo strtoupper($kotaRS);?><br />
...
INNER JOIN b_ms_satuan_lab msl ON b.id_satuan=msl.id ORDER BY a.id_pelayanan,c.kode_urut";
			...
			?>
                ...
                <td colspan="2" align="center" valign="top" style="font-weight:bold;font-size:12px">Medan, <?php echo gmdate('d F Y',mktime(date('H')+7));?><br/>
				  <!--Penanggungjawab

...
function cetakHslRad(){
	...
	url = 'hasil_pemeriksaan/hasil_radiologi.php?idKunj='+getIdKunj+'&idPel='+getIdPel+'&id='+document.getElementById("id_hasil_rad").value+'&cmbTipeHasilRad='+document.getElementById("cmbTipeHasilRad").value;
	//url = 'hasil_pemeriksaan/hasil_radiologi_pdf.php?idKunj='+getIdKunj+'&idPel='+getIdPel+'&id='+document.getElementById("id_hasil_rad").value;
	//alert (url);
...
function pTemplateRad(){
	...
	Request('hasil_pemeriksaan/hasilRad_utils.php?grd=1&act=view&id='+document.getElementById("cmbTmpRad").value , 'tmpContent', '', 'GET',fSetContent,'NoLoad');
}
...
function fSetContent(){
	...
	editorCM.setValue(document.getElementById('tmpContent').innerHTML);
}
//Edit Tmpt Rad Bagus ->>
...
function fSimpanHslRad(action,id,cek){
	...
	var txtHslRad = editorCM.getValue();
	...
	//alert("hasil_pemeriksaan/hasilRad_utils.php?grd=true&act="+action+"&smpn="+id+"&pelayanan_id="+getIdPel+"&id="+id_hasil_rad+"&id_tind_rad="+id_tind_rad+"&isDokPengganti="+isDokPengganti+"&cmbDokHsl="+cmbDokHsl+"&judul="+encodeURIComponent(judul)+"&ket_klinis="+encodeURIComponent(ket_klinis)+"&userId="+userId);
	jQuery.ajax({
		type: "POST",
...
/*function fSimpanHslRadNew(action,id,cek){
	document.getElementById("txtHslRad_Tmp").value = tinyMCE.get("txtHslRad").getContent();
	jQuery("#frmTes").submit();
}

// Attach a submit handler to the form 
jQuery("#frmTes").submit(function(event) {
    ...
    jQuery.ajax({
        url: "hasil_pemeriksaan/hasilRad_utils.php?grd=true&act=simpan&pelayanan_id="+getIdPel+"&id="+id_hasil_rad+"&id_tind_rad="+id_tind_rad+"&isDokPengganti="+isDokPengganti+"&cmbDokHsl="+cmbDokHsl+"&judul="+judul+"&ket_klinis="+ket_klinis+"&userId="+userId,
        type: "post",
        data: values,
...
function ambilDataHslRad()
{
	...
	Request("hasil_pemeriksaan/hasilRad_utils.php?act=ambil_hasil&hasil_id="+sisip[0], "spnHasilRad", "", "GET",function(){
		...
		editorCM.setValue(document.getElementById('spnHasilRad').innerHTML);
	},"");

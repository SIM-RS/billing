...
CONCAT(DATE_FORMAT(p.tgl_act,'%h:%i:%s')) jam,
...
<title>Persiapan USG Abdomen</title>
<style>
...
<table width="100%" border="0" style="font:14px tahoma black; border-collapse:collapse;" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%">
	<tr><td width="19%">Nama Lengkap</td><td width="1%">:</td><td colspan="4"><?php echo $rw['nmPas']?></td></tr>
	<tr><td width="19%">Umur</td><td width="1%">:</td><td colspan="4"><?php echo $rw['th'].' thn '.$rw['bl'].' bln';?></td></tr>
    <tr><td width="19%">Hari / Tanggal</td><td width="1%">:</td><td width="30%"><?php echo $arrHr[$rw['hari']].' / '.$rw['tgljam']?></td>
      <td width="14%">Jam Pemeriksaan</td>
      <td width="1%">:</td>
      <td width="35%"><?=$rw['jam']?>&nbsp;</td>
    </tr>
	</table></td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
  <td align="center"><strong>PERSIAPAN PEMERIKSAAN USG ABDOMEN</strong></td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
  	<td><table width="100%"><tr><td>1. </td>
  	  <td>Pasien puasa 4 jam sebelum pemeriksaan (dari jam ..............)</td></tr>
	<tr><td>2. </td>
	  <td>1 jam sebelum pemeriksaan pasien banyak minum air putih dan tahan kencing sampai pemeriksaan dilakukan</td></tr>
  		</table>
  	</td>
  </tr>

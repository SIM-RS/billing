...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="margin-top:0px">
		...
		<?=$alamatRS?> Telepon <?=$tlpRS?><br/></b>&nbsp;                </td>
                <td width="127"></td>
            </tr>
            <tr>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <!--DWLayoutTable-->
						...
						<td align="center" style="border:#000000 solid 1px; font-weight:bold;font-size:12px">Jenis Pemeriksaan</td>
                            ...
                            <td align="center" width="150" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:12px">Tanggal Pemeriksaan</td>
...
WHERE id_kunjungan='$idKunj') AS a 
...
INNER JOIN b_ms_satuan_lab msl ON b.id_satuan=msl.id ORDER BY a.id_pelayanan,c.kode_urut";
			...
			?>
			<tr height="25">
                    <td align="left" colspan="7" style="padding-left:10px;font-size:12px;border-bottom:1px solid;border-top:1px solid" >&nbsp;<i><b><?php echo strtoupper($induk); ?></b></i></td>
			</tr>
			<tr height="25">
                    <td align="left" colspan="7" style="padding-left:10px;font-size:12px;border-bottom:1px solid;border-top:1px solid" >&nbsp;<i><b><?php echo $spasi.strtoupper($kelompok); ?></b></i></td>
			</tr>
			<?php
					}else{
						$induk=$dt1['parent'];
			...
			<tr height="25">
                    ...
                    <td align="center" style="font-size:12px"><?php echo $dt1['tglHasil']?></td
                    ><td align="center" style="font-size:12px">
					<?php //echo $dt1['hasil']."-".$dt1['hasilc'];
						if(is_numeric($dt1["hasil"]))
						{
							if(is_numeric($dt1["normal1"]))
							{
								if(($dt1["hasil"] > $dt1["normal2"]) || ($dt1["hasil"] < $dt1["normal1"]))
								{
									?>
									<b><? echo $dt1["hasilc"]; ?> * </b>
                                    <?
								...
								if(is_numeric(substr($dt1["normal1"],0,1)))
								{
									if(($dt1["hasil"] > $dt1["normal2"]) || ($dt1["hasil"] < $dt1["normal1"]))
									{
										?>
									...
									$pnj = -1 * (strlen($dt1["normal1"])-1);
									if(($dt1["hasil"] > substr($dt1["normal1"],$pnj)))
									{
										?>
										<b><? echo $dt1['hasilc']; ?> * </b>
										<?
...
//									echo substr($dt["normal2"],$pnj)."-".$pnj;	
			...
			?>
                ...
                <td colspan="2" align="center" valign="top" style="font-weight:bold;font-size:12px"><?=$kotaRS?>, <?php echo gmdate('d F Y',mktime(date('H')+7));?><br/>
				 <br/>&nbsp;<br/>&nbsp;<br/>&nbsp;<br/>( <?php 

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="margin-top:0px">
		...
		<?=$alamatRS?> Telepon <?=$tlpRS ?><br/>
                  </b>&nbsp;                </td>
                <td width="127"></td>
            </tr>
            <tr>
                <td width="732" height="5"></td>
                <td width="167" style="border-bottom:#000000 double 0px; border-top:#000000 solid 0px"></td>
                <td></td>
            </tr>
            <tr>
...
AND a.VISITNO='$idKunj'  ";
			...
			?>
		  	        <tr height="25">
                        <td colspan="8" align="left" bgcolor="#339900" style="padding-left:10px;font-size:12px;border-bottom:1px solid;border-top:1px solid" >&nbsp;<i><b><?php echo strtoupper($kelompok); ?></b></i></td>
			        </tr>
			<?php	
				...
				if (($subkelompok!=$dt1['sub_kelompok']) && ($dt1['sub_kelompok']!=$dt1['nama'])){
			        ...
			        <tr bgcolor="#009900" height="25">
                       <td colspan="8" align="left" bgcolor="#6FFF6F" style="padding-left:10px;font-size:12px;border-bottom:1px solid;border-top:1px solid" >&nbsp;&nbsp;&nbsp;<i><b><?php echo strtoupper($subkelompok); ?></b></i></td>
			        </tr>
					<?php
				} // end sub kelompok

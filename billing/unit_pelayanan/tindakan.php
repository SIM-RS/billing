...
<table width="850" border="0" cellpadding="0" cellspacing="1" align="center">
    <tr style="">
        ...
        <td width="14%">&nbsp;</td>
        <td width="49%">
            <span style="display:none"><label><input type="checkbox" id="chkTind" onclick="showUnit(this.checked)" class="chkinput"/>
		Pilih unit lainnya
            </label></span>
        </td>
        <td width="36%" align="right"><div id="divLab"><input id="nomorLab" name="nomorLab" size="10" class="txtinput" readonly/></div>&nbsp;&nbsp;&nbsp;</td>
        <td width="1%">&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="2">
			...
			<input name="akUnit" id="akUnit" type="hidden">
    ...
    <tr>
        ...
        <td><input id="txtBiaya" name="txtBiaya" type="text" size="10" class="txtinput" readonly />
            <input id="txtBiayaAskes" name="txtBiayaAskes" type="hidden" size="10" class="txtinput" readonly />
	   &nbsp;&nbsp;&nbsp;
...
<!-- </td>
    ...
    <tr id="trExprt" style="visibility:collapse;">
      <td>&nbsp;</td>
      <td align="right">Hasil Expertise :&nbsp;</td>
      <td><textarea id="txtExprt" name="txtExprt" cols="70" rows="1" class="txtinput"></textarea></td>
    </tr>
	<tr id="trExprt_pacs" style="visibility:collapse;">
      <td>&nbsp;</td>
      <td align="right">Hasil Pacs :&nbsp;</td>
      <td><button id="HasilPacs" name="HasilPacs" onclick="show_pacs_tind();">Lihat Hasil</button></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
	...
	<label><input type="checkbox" id="chkDokterPenggantiTind" value="1" onchange="gantiDokter('cmbDokTind',this.checked);"/>Dokter Pengganti</label-->
			<form name="form_dokter_tindakan">
				<select id="cmbDokTind" name="cmbDokTind" multiple="multiple" onkeypress="setDok('btnSimpanTind',event);" onchange="setSemDokter(this.value);" style="min-width:250px;">
					<option value="">-Dokter-</option>
				</select>
				<br />
				<label><input type="checkbox" id="chkDokterPenggantiTind" value="1" onchange="gantiDokter('cmbDokTind',this.checked);"/>Dokter Pengganti</label></form>
		</td>

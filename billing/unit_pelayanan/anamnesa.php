...
<fieldset>
    ...
    <tr id="trtglAnam">
           <td colspan="4">Tgl &nbsp;:&nbsp; <input type="text" class="txtcenter" readonly="readonly" name="TglAnamB" id="TglAnamB" size="11" value="<?php echo $date_now;?>"/>
                        ...
                        <td width="55%">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;<!--Status Gizi--></td>
                                    <td>&nbsp;<input type="text" size="20" id="cmbStatusGizi" name="cmbStatusGizi" style="display:none;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                    ...
                    <tr>
                    	<td colspan="2">
                        	<table width="100%">
                                ...
                                <tr id="gen">
                                	<td>&nbsp;Mata *</td>
                                    <td>&nbsp;<textarea id="aMata" name="aMata" cols="35"></textarea>
                                    </td> 
                                    <td>&nbsp;Kulit Kelamin *</td>
                                    <td>&nbsp;<textarea id="kKelamin" name="kKelamin" cols="35"></textarea>
                                    </td>                                                            
                                </tr>
                                <tr id="gen">

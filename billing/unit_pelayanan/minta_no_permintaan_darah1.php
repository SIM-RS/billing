...
//echo $no_pakai;
//echo "<input type="text" id="tgl" class="txtinput2" name="no_bukti" size="22" value="" />";
?>
<script language="javascript">
jQuery("#no_bukti").val("<? echo $no_pakai;?>");
</script>
<?
//echo "<input type=\"text\" value=\"$no_pakai\" class=\"txtinput2\" size=\"22\" id=\"no_bukti\" name=\"no_bukti\" />";
?>
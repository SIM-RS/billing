...
if(isset($_POST['prosescetak'])){
	...
	$numat=$_REQUEST['numat'];
	$npp=$_REQUEST['npp'];
	$jp=$_REQUEST['jp'];
	$sbbmati=$_REQUEST['sbbmati'];
	$kukre=$_REQUEST['kukre'];
	$jedi=$_REQUEST['jedi'];
	$almt=$_REQUEST['almt'];
	$berket=$_REQUEST['berket'];
	$nokber=$_REQUEST['nokber'];
	
	$sqlcc="update b_kunjungan k 
	INNER JOIN b_pelayanan p ON k.id = p.kunjungan_id 
	INNER JOIN b_pasien_keluar bkel ON bkel.pelayanan_id = p.id
	SET bkel.tmpm=$tmpm,bkel.numat=$numat,npp=$npp,jp=$jp,sbbmati=$sbbmati,kukre=$kukre,jedi=$jedi,almt='$almt',berket='$berket',nokber=$nokber
	WHERE k.id='$idKunj' AND p.id='$idPel' AND bkel.cara_keluar like '%Meninggal%'"; //echo $sqlcc;
	$qry=mysql_query($sqlcc);
	//echo mysql_error();
	
	echo "<script>window.location='s_mati_cetak.php?idKunj=$idKunj&idPel=$idPel&tmpm=$tmpm&idUser=$idUser&numat=$numat&npp=$npp&jp=$jp&sbbmati=$sbbmati&kukre=$kukre&jedi=$jedi&almt=$almt&berket=$berket&nokber=$nokber';</script>";
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<form action="" method="post" id="forms1" name="forms1">
  ...
  <tr>
    <td style="border:1px solid #000;font:16px bold tahoma;" height="50" width="266">SURAT KETERANGAN MENINGGAL</td>
            ...
            <tr class="kwi">
                ...
                <strong style="border-bottom:1px solid #000;">KETERANGAN MENINGGAL</strong></td>
            </tr>
            <tr class="kwi">
                <td colspan="2" align="center" style="font-size:13px">
                <?
					$sql1 = "SELECT IFNULL(MAX(id),0) + 1 AS urut FROM b_pasien_keluar WHERE YEAR(tgl_act) = YEAR(CURDATE()) AND MONTH(tgl_act) = MONTH(CURDATE()) AND cara_keluar = 'Meninggal'";
					$rsql1 = mysql_query($sql1);
					$dsql1 = mysql_fetch_array($rsql1);
                ?>
                <? echo $dsql1['urut'];?>\-IPJ\<? echo date("m");?>&nbsp;\&nbsp;<? echo date("Y");?></td>
            </tr>
            <tr class="kwi">
                <td height="30px" colspan="2" align="center" style="font-size:13px">&nbsp;</td>
            </tr>
            <tr class="kwi">
            ...
            <tr class="kwi">
                <td colspan="2">
                    ...
                    <tr>
                      ...
                      <td width="27%" style="font-size:12px" colspan="3"><input type="text" name="numat" value="<?php echo $rw['numat']; ?>" size="3" style="text-transform:uppercase;" />&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4"><input type="text" name="npp" value="<?php echo $rw['npp']; ?>" size="10" style="text-transform:uppercase;" /></td>
                    </tr>
					<tr>
                    ...
                    <tr>
                      ...
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4"><input type="text" name="tmpm" value="<?php echo $rw['tmpm']; ?>" size="3" style="text-transform:uppercase;" />&nbsp;1. RS 2. RB 3. Puskesmas 4. Rumah 5. Lain-lain</td>
                    </tr>
					<tr>
                      <td style="font-size:12px">11. Alamat Tempat Meninggal</td>
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4">Jl/Gg. <input type="text" name="almt" value="<?php echo $rw['almt']; ?>" size="45" style="text-transform:uppercase;" />&nbsp;</td>
                    </tr>
					<tr>
					...
					<tr>
                      ...
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4"><input type="text" name="jp" value="<?php echo $rw['jp']; ?>" size="3" style="text-transform:uppercase;" />&nbsp;1. Visum 2. Outopsi 3. Tidak Divisum</td>
                    </tr>
					<tr>
                      <td style="font-size:12px">14. Sebab Kematian (Menurut Dokter / Polisi)</td>
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4"></br><input type="text" name="sbbmati" value="<?php echo $rw['sbbmati'];?>" size="3" style="text-transform:uppercase;" />&nbsp;1. Sakit 2. Bersalin 3. Lahir Mati 4. Kec L.L 5. Kec Industri 6. Bunuh Diri 7. Pembunuhan/Penganiayaan 8. Lain-lain 9. Tidak Dapat Ditentukan</td>
                    </tr>
					<tr>
					...
					<tr>
                      ...
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4"><input type="text" name="kukre" value="<?php echo $rw['kukre'];?>" size="3" style="text-transform:uppercase;" />&nbsp;1. Medan 2. Luar Medan</td>
                    </tr>
					<tr>
                      <td style="font-size:12px">17. Jenazah di(*)</td>
                      <td align="center" style="font-weight:bold;font-size:12px">:</td>
                      <td style="font-size:12px" colspan="4"><input type="text" name="jedi" value="<?php echo $rw['jedi'];?>" size="3" style="text-transform:uppercase;" />&nbsp;1. Diawetkan 2. Tidak Diawetkan</td>
                    </tr>
                    <tr>
			...
			//echo $pegawai;
			?>
                <td width="603" style="font-size:12px"><br/><br/><br/>Yang Memberi Keterangan / Melapor<br/><br/><br/><br/><br/>(<input type="text" name="berket" value="<?php echo $rw['berket'];?>" size="20" style="text-transform:uppercase;" />)<br/>
				No. KTP/SIM :&nbsp;&nbsp;<input type="text" name="nokber" value="<?php echo $rw['nokber'];?>" size="20" style="text-transform:uppercase;" />
				<!--Petugas
            ...
            <tr id="trTombol">
                <td colspan="2" class="noline" align="center">
				    <button type="submit" name="prosescetak" id="prosescetak">PROSES</button>

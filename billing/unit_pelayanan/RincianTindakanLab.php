...
WHERE b_pelayanan.kunjungan_id = '".$_REQUEST['idKunj']."' AND b_ms_unit.parent_id = '57'";
...
GROUP BY t.tgl, pl.unit_id) AS t1 WHERE t1.unit_id = '".$rwLb['unit_id']."'";
				...
				?>
				 <tr>
					...
					<td height="28" style="border-top:2px groove; padding-right:20px; text-align:right; font-weight:bold;"><?php echo number_format($total,0,",",".");?></td>
				 </tr>
                 <?php 
					if ($jaminan>0){
				 ?>
	...
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td colspan="2" style="padding-right:50px; text-align:center;"><?=$kotaRS?>,&nbsp;&nbsp;<?php echo $date_now;?></td>
	</tr>
	<tr>
		<td height="20">&nbsp;</td>
		<td>&nbsp;</td>

                    ...
                    <table class="withline" width="100%" cellpadding=0 cellspacing=0>
                        ...
                        <tr>
							...
							?>
									...
									<?php 
										if($tmpDokter != $rwTind['dokter']){
											...
											echo "- <b>Dokter</b> : ".$rwTind['dokter']."<br />"; 
										}
									?>
									<?php 
										...
										//}
									?>
										<div class="kanann" style="margin-left:20px;">
									<?php
                            ...
                            <td class="tableContent" align="left" valign="top">
                                    <?php
                                   $qDiag="select d.diagnosa_id,u.nama as unit,IF(md.nama IS NULL, d.diagnosa_manual, md.nama) as diagnosa,IF(bp.nama IS NOT NULL,CONCAT('<br/>Dokter:&nbsp;',bp.nama),'') AS nm_dokter,

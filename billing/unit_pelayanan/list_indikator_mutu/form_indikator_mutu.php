...
<html>
	<head>
		...
		<script type="text/JavaScript" language="JavaScript" src="indikator_mutu.js"></script>
	</head>
	<body>
		<center>
		...
		<form action="action_indikator.php" method="POST" id="indikatormutu" name="indikatormutu">
			...
			<table cellspacing="2" cellpadding="2" style="border:1px solid #000000;">
				<tr>
					...
					<td width="100px" class="inputan"><input type="radio" id="ugdlengkap1" name="ugdlengkap" onclick="document.getElementById('hcekugdleng').style.display = 'none'; document.getElementById('hcekugdleng1').style.display = 'none';" value="1" <?=($ugdlengkap[0]=='1')?"checked":"";
					?> /><label for="ugdlengkap1">Ya</label></td>
					<td class="inputan"><input type="radio" id="ugdlengkap2" name="ugdlengkap"
					...
					value="0" <?=($ugdlengkap[0]== '0')?'checked':'';?> /><label for="ugdlengkap2">Tidak</label></td>
					<td></td>
					<td></td>
					<td></td>
				</tr>
			...
			<center style="margin-top:5px;">
				<input type="button" value="<?=$act?>" name="simpanmutu" id="simpanmutu" onclick="prosesIndikatorMutu();" />
				<!---button name="batalmutu" id="batalmutu" onclick="closeDivCheckIndikatorMutu(); return false;">Batal</button--->
			</center>
		</form>
		</center>
	</body>

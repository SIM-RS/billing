    ...
    elseif($grdAnamnesa == "true") {	//Anamnese
        while($rows=mysql_fetch_array($rs)) {
           $sisipan = $rows["ANAMNESE_ID"]."|".$rows['KUNJ_ID']."|".$rows['PEL_ID']."|".$rows['PASIEN_ID']."|".$rows['PEGAWAI_ID']."|".
			$rows['KU']."|".$rows['SOS']."|".$rows['RPS']."|".$rows['RPD']."|".$rows['RPK']."|".$rows['RA']."|".$rows['KUM']."|".$rows['GCS']."|".$rows['KESADARAN']."|".$rows['TENSI']."|".$rows['RR']."|".$rows['NADI']."|".$rows['SUHU']."|".$rows['BB']."|".$rows['GIZI']."|".$rows['KL']."|".$rows['COR']."|".$rows['PULMO']."|".$rows['INSPEKSI']."|".$rows['PALPASI']."|".$rows['AUSKULTASI']."|".$rows['PERKUSI']."|".$rows['EXT']."|".$rows['TENSI_DIASTOLIK']."|".$rows['LEHER']."|".$rows['ABDOMEN']."|".$rows['GENITALIA']."|".$rows['TB']."|".$rows['THORAX']."|".$rows['PUPIL']."|".$rows['TRMENINGGAL']."|".$rows['NCRAINALES']."|".$rows['RPATOLOGIS']."|".$rows['SENSORIK']."|".$rows['OTONOM']."|".$rows['PKHUSUS']."|".$rows['MOTOKIA']."|".$rows['MOTOKAA']."|".$rows['MOTOKIB']."|".$rows['MOTOKAB']."|".$rows['RFKIA']."|".$rows['RFKAA']."|".$rows['RFKIB']."|".$rows['RFKAB']."|".$rows['NPS']."|".$rows['PPENUNJANG']."|".$rows['PROGNOSIS']."|".$rows['SMENTALIS']."|".$rows['LKEPALA']."|".$rows['SGIZII']."|".$rows['KTELINGA']."|".$rows['KHIDUNG']."|".$rows['KTENGGOROKAN']."|".$rows['RKELAHIRAN']."|".$rows['RNUTRISI']."|".$rows['RIMUNISASI']."|".$rows['RTUMBUHKEMBANG']."|".$rows['ROAT']."|".$rows['RMEROKOK']."|".$rows['RASMA']."|".$rows['RKU']."|".$rows['RPSD']."|".$rows['RGPA']."|".$rows['UTINLANJUT']."|".$rows['AMATA']."|".$rows['KKELAMIN'];
            $i++;

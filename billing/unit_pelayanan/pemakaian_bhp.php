...
<table width="850" border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    ...
    <div id="divobat_bhp" align="left" style="position:absolute; z-index:1; height: 230px; width:400px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC;"></div>
	...
	<input type="hidden" name="user_act_bhp" id="user_act_bhp" size="10" class="txtinput"/></td>
  </tr>
  <tr>
    <td>Jumlah</td>
    <td>:</td>

...
pk.cara_keluar,IF(tgl_out IS NULL,DATEDIFF(NOW(),tgl_in),
DATEDIFF(tgl_out,tgl_in))+1 los,p.id pelId,(SELECT SUM(biaya_kso+biaya_pasien)
...
<table align="center" width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="30" colspan="2" style="font-weight:bold; border-bottom:#000000 1px solid; "><span>Nama RS : <?=$kotaRS?></span><span style="margin-left:150px">Kode RS : 3515015</span><span style="margin-left:150px">Kelas RS : B </span></td>
  </tr>
  <tr>

		...
		FROM b_tindakan_kamar WHERE pelayanan_id='".$pelayanan_id."'";
			...
			WHERE pd.kso_paket_id=$idpaket AND t1.tgl=CURRENT_DATE()";
						...
						if ($icd9cm=="true"){
							...
							$sqlTind="insert into b_tindakan (ms_tindakan_kelas_id,ms_tindakan_unit_id,jenis_kunjungan,pelayanan_id,kunjungan_id,kunjungan_kelas_id,kso_id,kso_kelas_id,kelas_id,tgl,ket,qty,biaya,biaya_kso,biaya_pasien,tgl_act,user_act,user_id,type_dokter,unit_act,exprt) values('".$_REQUEST['idTind']."','".$_REQUEST['unitId']."','".$cJenisKunj."','".$pelayanan_id."','".$kunjungan_id."','".$_REQUEST['kunjungan_kelas_id']."','".$_REQUEST['ksoId']."','".$kelas_id."','".$_REQUEST['ksoKelasId']."','".$tgltindak."','".$_REQUEST['ket']."',".$_REQUEST['qty'].",'".$biayaRS."','$biaya_kso','$biaya_pasien',now(),$userId,".$_REQUEST['idDok'].",'".$isDokPengganti."','".$_GET['unit_pelaksana']."','".$_REQUEST['exprt']."')";
							//echo $sqlTind."<br/>";
							mysql_query($sqlTind);
				...
				if($numCek == 0){
                    ...
                    if($_REQUEST['isInap']=='1') {
                        ...
                        if($res != 0 && $res != '' && isset($res)) {
                            ...
                            $sqlBTin = "insert into b_tindakan (ms_tindakan_kelas_id,ms_tindakan_unit_id,jenis_kunjungan,pelayanan_id,kunjungan_id,kunjungan_kelas_id,kso_id,kso_kelas_id,tgl,ket,biaya,biaya_pasien,biaya_kso,tgl_act,user_act,user_id,unit_act) values('".$rwTindKonsul['ms_tindakan_kelas_id']."','".$_REQUEST['tmpLay']."','".$pl_id."','".$rwNewPel['idpel']."','".$kunjungan_id."','".$_REQUEST['kunjungan_kelas_id']."','".$_REQUEST['ksoId']."','".$_REQUEST['ksoKelasId']."','".$tgltindak."','".$_REQUEST['ket']."','".$rwTindKonsul['tarip']."','$biaya_pasien','".$biaya_kso."',now(),'$userId',0,'".$_REQUEST['unitAsal']."')";
							//echo $sqlBTin."<br/>";
                            mysql_query($sqlBTin);
                            //".$_REQUEST['idDok']."

	...
	GROUP BY tbl.pelayanan_id";
				...
				if($rwCekDilayani['belum_dilayani']>0){
					...
					if($rowCek['inap'] == 1){
						...
						$sqlKunj = "update b_kunjungan set tgl_pulang = $tglPul, tgl_pulang_ak = $tglPul, pulang = 1, user_act_pulang = '".$userId."', kasir_id_pulang='$idKasir', unit_pulang = '".$rowCek['id']."' where id = '$kunjungan_id'";
						//echo $sqlKunj."<br>";
						$rsKunj = mysql_query($sqlKunj);
					}
					else{

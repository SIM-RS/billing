...
//   mm_menu_0814123211_0.addMenuItem("FORM KONFIRMASI KEPULANGAN (KRS)","cetakRincian(104);");
   ...
   window.mm_menu_0814123211_5 = new Menu("root", 170, 25, "verdana", 11,"#003366", "#FF6600", "#64CCFC", "#ffffff","left", "middle", 3, 0, 100, -5, 7,true, true, true, 0, true, true);
   mm_menu_0814123211_5.addMenuItem("INFORM KONSEN","load_popup_iframe('INFORM KONSEN','../report_rm/1.inform_konsen.php')");
   mm_menu_0814123211_5.addMenuItem("PERSETUJUAN TIND.MEDIK","load_popup_iframe('PERSETUJUAN TINDAKAN MEDIS','../report_rm/Form_RSU/23.persetujuantindakanmedik_form.php')");
   mm_menu_0814123211_5.addMenuItem("PENOLAKAN TIND.MEDIS","load_popup_iframe('PENOLAKAN TINDAKAN MEDIS','../report_rm/Form_RSU_2/penolakan_tind_medis_form.php')");
   mm_menu_0814123211_5.addMenuItem("ALL REKAM MEDIS","dashboardRekamMedis()");

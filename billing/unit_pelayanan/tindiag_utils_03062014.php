		...
		FROM b_tindakan_kamar WHERE pelayanan_id='".$pelayanan_id."'";
			...
			WHERE pd.kso_paket_id=$idpaket AND t1.tgl=CURRENT_DATE()";
						...
						if ($icd9cm=="true"){
							...
							$sqlTind="insert into b_tindakan (ms_tindakan_kelas_id,ms_tindakan_unit_id,jenis_kunjungan,pelayanan_id,kunjungan_id,kunjungan_kelas_id,kso_id,kso_kelas_id,tgl,ket,qty,biaya,biaya_kso,biaya_pasien,tgl_act,user_act,user_id,type_dokter,unit_act) values('".$_REQUEST['idTind']."','".$_REQUEST['unitId']."','".$cJenisKunj."','".$pelayanan_id."','".$kunjungan_id."','".$_REQUEST['kunjungan_kelas_id']."','".$_REQUEST['ksoId']."','".$_REQUEST['ksoKelasId']."','".$tgltindak."','".$_REQUEST['ket']."',".$_REQUEST['qty'].",'".$biayaRS."','$biaya_kso','$biaya_pasien',now(),$userId,".$_REQUEST['idDok'].",'".$isDokPengganti."','".$_GET['unit_pelaksana']."')";
							echo $sqlTind."<br/>";
							mysql_query($sqlTind);
...
FROM b_tindakan_kamar WHERE pelayanan_id='".$pelayanan_id."'";
	...
	WHERE pd.kso_paket_id=$idpaket AND t1.tgl='".$rwcekTindAsli["tgl"]."'";
				...
				if ($icd9cm=="true"){
					...
					$sqlUpdate="UPDATE b_tindakan SET tgl='".$tgltindak."', ms_tindakan_kelas_id = '".$_REQUEST['idTind']."',ms_tindakan_unit_id='".$_REQUEST['unitId']."', ket = '".$_REQUEST['ket']."', qty=".$_REQUEST['qty'].", biaya = '".$biayaRS."', user_act = $userId, user_id=".$_REQUEST['idDok'].",type_dokter='".$isDokPengganti."', biaya_pasien = '$biaya_pasien', biaya_kso = '$biaya_kso' WHERE id = '".$_REQUEST['id']."'";
...
WHERE t.pelayanan_id = '".$pelayanan_id."'
UNION
SELECT t.b_tindakan_id as id, t.qty, t.biaya, t.qty * t.biaya AS subtotal, t.kunjungan_id, t.ms_tindakan_kelas_id, 
t.pelayanan_id, t.ket, t.unit_act, tk.tarip, tin.nama
, tin.kode,IFNULL(p.nama,'-') AS dokter,t.ms_tindakan_unit_id,t.user_id,k.nama AS kelas, 
t.type_dokter,t.tgl_act AS tanggal2, t.tgl AS tanggal3,CONCAT(DATE_FORMAT(t.tgl,'%d-%m-%Y '),DATE_FORMAT(t.tgl_act,'%T')) AS tanggal, tin.klasifikasi_id, peg.nama AS petugas,'0' ms_tindakan_id_icd9cm,
'1' AS sampah

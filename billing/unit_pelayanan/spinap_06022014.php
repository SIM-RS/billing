...
<table align="left" width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
  	<td>Alamat</td>
  	<td colspan="6">:&nbsp;<?php echo $rwPas['alamat'];?></td>
  </tr>
  <tr>
  ...
  <tr>
  	<td>Ruang</td>
  	<td colspan="6">:&nbsp;<?php echo $rwPas['nama'];?></td>
  </tr>
  <tr>
  	<td>Nama Penanggung Jawab / Keluarga</td>
  	<td colspan="6">:&nbsp;<?php echo $rwPas['pj'];?></td>
  </tr>
  <tr>
  	<td>Alamat</td>
  	<td colspan="6">:&nbsp;<?php echo $rwPas['almtpj'];?></td>
  </tr>
  <tr>
  	<td>No Telp</td>
  	<td colspan="6">:&nbsp;<?php echo $rwPas['telp'];?></td>
  </tr>
  <tr>
  	<td align="right">&nbsp;</td>
  	<td align="right">&nbsp;</td>

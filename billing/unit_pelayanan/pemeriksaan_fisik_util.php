...
switch(strtolower($_REQUEST['act'])) {
    case 'tambah':
		$sql="insert into anamnese_pilih(urut,nama,tipe,flag) values ('".$txt_urut_fisik."','".$txt_nama_fisik."','".$tipex."','$flag')";
		mysql_query($sql);
	   	break;
	case 'simpan':
		$sql="update anamnese_pilih set urut='".$txt_urut_fisik."', nama='".$txt_nama_fisik."', tipe='".$tipex."',flag='$flag' where id='".$id."'";
		mysql_query($sql);
	   	break;
	case 'hapus':

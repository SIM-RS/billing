...
$sqlCb = "SELECT * FROM b_tindakan_kamar WHERE pelayanan_id='".$_REQUEST['idPel']."'";
$execK = mysql_query($sqlCb);
$dsqlCb = mysql_fetch_array($execK);

if($dsqlCb['kamar_id']!="")
{
	$sqlCb1 = "SELECT * FROM b_ms_kamar WHERE id = $dsqlCb[kamar_id]";
	$execK1 = mysql_query($sqlCb1);
	$dsqlCb1 = mysql_fetch_array($execK1);
}
            ...
            <td colspan="3">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr height="30">
                        ...
                        <td width="25%" style="border-bottom:1px solid;font-size: 13px; font-weight: bold">&nbsp;( <?php echo $rwPas['sex'];?> )&nbsp;Umur&nbsp;:&nbsp;<?php echo $rwPas['umur_thn'];?>&nbsp;tahun&nbsp;&nbsp;<?php echo $rwPas['umur_bln'];?>&nbsp;bulan&nbsp;&nbsp;<?php echo $rwPas['umur_hr'];?>&nbsp;hari</td>
        ...
        <tr>
            <td colspan="3">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="font-size: 13px; ">
                        <td style="border-left:1px solid;">&nbsp;</td>
                        <td>&nbsp;<span style="">Nama Kamar</span></td>
                        <td>:&nbsp;<span style="border-bottom:1px solid;"><?php echo $dsqlCb['nama'];?></span></td>
                    ...
                    <tr style="font-size: 13px; ">
                        ...
                        <td style="border-bottom:1px solid;">:&nbsp;<? echo $dsqlCb1['nama'];?>&nbsp;&nbsp;&nbsp;&nbsp;<!--<span style="" />Kelas&nbsp;:&nbsp;<?php echo $rwPas['kelas'];?>--></td>
        ...
        <tr>
            <td colspan="3">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="font-size: 13px; ">
                        <td style="border-left:1px solid;" align="center">7</td>
                        <td>Laboratorium</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;"><table width="100%" border="0">
        <?php $sqlL="SELECT d.id,d.nama_kelompok,c.nama,b.metode,IF(b.normal2='',b.normal1,CONCAT(b.normal1,' - ',b.normal2)) AS normal,
...
WHERE id_kunjungan='".$_REQUEST['idKunj']."') AS a 
...
?>
        ...
        <?php }?>  
                    ...
                    <tr style="font-size: 13px; ">
                        <td style="border-left:1px solid;" align="center">8.</td>
                        <td>Genitalia</td>
                        <td align="center">:</td>
                    ...
                    <tr style="font-size: 13px; ">
                        ...
                        <td style="border-right:1px solid;">
							<table width="100%" border="0">
								<?php 
									$sqlD="SELECT d.diagnosa_id, md.nama FROM b_diagnosa d
										LEFT JOIN b_ms_diagnosa md ON md.id=d.ms_diagnosa_id
										WHERE d.kunjungan_id='".$_REQUEST['idKunj']."';";
									$exD=mysql_query($sqlD);
									while($dD=mysql_fetch_array($exD)){
										$queryB = "SELECT ab.nama, CONCAT('[',ab.kode,']') AS kode FROM b_diagnosa_rm a 
										INNER JOIN b_diagnosa b ON a.diagnosa_id = b.diagnosa_id
										INNER JOIN b_ms_diagnosa ab ON a.ms_diagnosa_id = ab.id
										INNER JOIN b_ms_diagnosa bb ON b.ms_diagnosa_id = bb.id 
										WHERE a.diagnosa_id = $dD[diagnosa_id]";
										$dqueryB = mysql_fetch_array(mysql_query($queryB));
								?>
								<tr style="font-size: 13px;">
									<td class="gb"><?=$dD['nama']." ".$dqueryB['kode'];?></td>
								</tr>
								<?php }?>  
							</table>
							<table width="100%" border="0">
							<?php 
								$sqlD="SELECT d.diagnosa_id, d.diagnosa_manual FROM b_diagnosa d
									WHERE d.kunjungan_id='".$_REQUEST['idKunj']."' and diag_banding_id = 0 AND d.diagnosa_manual IS NOT NULL;";
								$exD=mysql_query($sqlD);
								while($dD=mysql_fetch_array($exD)){
									$queryB = "SELECT ab.nama, CONCAT('[',ab.kode,']') AS kode FROM b_diagnosa_rm a INNER JOIN
											b_diagnosa b ON a.diagnosa_id = b.diagnosa_id
											INNER JOIN b_ms_diagnosa ab ON a.ms_diagnosa_id = ab.id
											WHERE a.diagnosa_id = $dD[diagnosa_id]";
									$dqueryB = mysql_fetch_array(mysql_query($queryB));
							?>
								<tr style="font-size: 13px;">
									<td class="gb"><?=$dD['diagnosa_manual']." ".$dqueryB['kode'];?></td>
								</tr>
							<?php }?>  
							</table>
                        </td>
                    ...
                    <tr style="font-size: 13px; ">
                        <td style="border-left:1px solid;">&nbsp;</td>
                        <td>Diagnose Banding</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">
                        <table width="100%" border="0">
        <?php $sqlD="SELECT d.diagnosa_id, d.diagnosa_manual FROM b_diagnosa d
WHERE d.kunjungan_id='".$_REQUEST['idKunj']."' and diag_banding_id <> 0;";
$exD=mysql_query($sqlD);
while($dD=mysql_fetch_array($exD)){
	$queryB1 = "SELECT ab.nama, CONCAT('[',ab.kode,']') AS kode FROM b_diagnosa_rm a INNER JOIN
b_diagnosa b ON a.diagnosa_id = b.diagnosa_id
INNER JOIN b_ms_diagnosa ab ON a.ms_diagnosa_id = ab.id
WHERE a.diagnosa_id = $dD[diagnosa_id]";
	$dqueryB1 = mysql_fetch_array(mysql_query($queryB1));
?>
          <tr style="font-size: 13px;">
            <td class="gb"><?=$dD['diagnosa_manual']." ".$dqueryB1['kode']?></td>
          </tr>
        <?php }?>  
        </table>
                        </td>
					...
					<?php
						$sDA="SELECT d.diagnosa_id, GROUP_CONCAT(md.nama) AS da 
						...
						$queryB2 = "SELECT ab.nama, CONCAT('[',ab.kode,']') AS kode FROM b_diagnosa_rm a INNER JOIN
									b_diagnosa b ON a.diagnosa_id = b.diagnosa_id
									INNER JOIN b_ms_diagnosa ab ON a.ms_diagnosa_id = ab.id
									INNER JOIN b_ms_diagnosa bb ON b.ms_diagnosa_id = bb.id WHERE a.diagnosa_id = '$rwDA[diagnosa_id]'";
						$dqueryB2 = mysql_fetch_array(mysql_query($queryB2));
					?>
                    <tr style="font-size: 13px; ">
                        <td style="border-left:1px solid;">&nbsp;</td>
                        <td>Diagnose Akhir</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwDA['da']." ".$dqueryB2['kode']; ?></td>
                    </tr>
                    ...
                    <tr style="font-size: 13px; ">
                      ...
                      <tr style="font-size: 13px; ">
                        ...
                        <td>Status Gizi</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['SGIZII']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                    ...
                    <tr style="font-size: 13px; ">
                        ...
                        <td>NPS</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['NPS']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">28.</td>
                        <td>Status Mentalis</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['SMENTALIS']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">29.</td>
                        <td>Lingkar Kepala</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['LKEPALA']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">30.</td>
                        <td>Telinga</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['KTELINGA']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">31.</td>
                        <td>Hidung</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['KHIDUNG']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">32.</td>
                        <td>Tenggorok</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['KTENGGOROKAN']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">33.</td>
                        <td>Mata</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwAnam['AMATA']; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">34.</td>
                        <td>Kulit Kelamin</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php if($rwAnam['KKELAMIN']==0)
						{
							echo "";
						}else{
							echo $rwAnam['KKELAMIN'];
						}; ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">35.</td>
                        <td>Riwayat Kelahiran</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php 
							if($rwAnam['RKELAHIRAN']==0)
							{
								echo "";
							}else{
								echo $rwAnam['RKELAHIRAN'];
							}
						?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">36.</td>
                        <td>Riwayat Nutrisi</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php 
							if($rwAnam['RNUTRISI']!=0)
							{
								echo $rwAnam['RNUTRISI'];
							}
						?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">37.</td>
                        <td>Riwayat Imunisasi</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php if($rwAnam['RIMUNISASI']!=0){echo $rwAnam['RIMUNISASI'];} ?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">38.</td>
                        <td>Riwayat Tumbuh Kembang</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php if($rwAnam['RTUMBUHKEMBANG']!=0){echo $rwAnam['RTUMBUHKEMBANG'];} ?></td>
                    </tr>
                <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">39.</td>
                        <td>S O A P I E R</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">40.</td>
	...
	WHERE t.kunjungan_id = '".$_REQUEST['idKunj']."') as gab";
...
?>
          <tr>
            <td class="gb" style="font-size: 13px; "><?=$dT['nama']." ".$execB['kode_icd_9cm'];?></td>
          </tr>
        <?php }?>  
<?php $sqlT="SELECT ab.OBAT_NAMA, a.KET_DOSIS FROM b_resep a
...
?>
          <tr>
            <td class="gb" style="font-size: 13px; "><?=$dT['OBAT_NAMA']." (".$dT['KET_DOSIS'].")";?></td>
          </tr>
        <?php }?>  
		<tr>
<?php $sqlM="SELECT a.obat_manual, a.KET_DOSIS FROM b_resep a
WHERE kunjungan_id = ".$_REQUEST['idKunj']." AND a.obat_manual IS NOT NULL AND a.obat_manual <> ' '";
$exM=mysql_query($sqlM);
while($dT=mysql_fetch_array($exM)){
?>
			<td class="gb" style="font-size: 13px; "><?=$dT['obat_manual']." (".$dT['KET_DOSIS'].")";?></td>
          </tr>
        <?php }?> 
          <tr>
            <td class="gb">&nbsp;</td>
                    ...
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">41.</td>
                        <td>Keadaan waktu keluar RS</td>
                        <td align="center">:</td>
                        <td style="border-right:1px solid;">&nbsp;<?php echo $rwPas['keadaan_keluar'];?></td>
                    </tr>
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">42.</td>
                        <td>Prognosis</td>
                        <td align="center">:</td>
                    ...
                    <tr style="font-size: 13px; ">
                        <td align="center" style="border-left:1px solid;">43.</td>
                            ...
                            <table width="85%" align="center" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr style="font-size: 13px; ">
                                    ...
                                    <td align="left" style="padding-left: 20px; padding-top: 60px">
                                        (&nbsp;<?php /*echo $rwDok['nama'];*/ echo $rwPas['dokterMerawat']; ?>&nbsp;)
                                    </td>
                                </tr>
                            </table>
                        </td>
...
INNER JOIN b_ms_pegawai b ON a.user_act = b.id WHERE a.kunjungan_id = '".$_REQUEST['idKunj']."';";

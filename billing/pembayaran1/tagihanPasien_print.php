...
kso.nama nmKso,CONCAT(DATE_FORMAT(k.tgl,'%d-%m-%Y')) tgljam, 
...
WHERE k.id=$idKunj";
	...
	$sqlPas="SELECT no_rm,mp.nama nmPas,mp.alamat, mp.rt,mp.rw,mp.sex,mk.nama kelas, 
kso.nama nmKso,CONCAT(DATE_FORMAT(p.tgl,'%d-%m-%Y')) tgljam, 
DATE_FORMAT(IFNULL(p.tgl_krs,NOW()),'%d-%m-%Y %H:%i') tglP, mp.desa_id,mp.kec_id, 
(SELECT nama FROM b_ms_wilayah WHERE id=mp.kec_id) nmKec, 
(SELECT nama FROM b_ms_wilayah WHERE id=mp.desa_id) nmDesa, k.kso_id,k.kso_kelas_id,p.kelas_id,
k.umur_thn,
...
if ($inap=="1"){
	$sql="SELECT DATE_FORMAT(IFNULL(tk.tgl_in,p.tgl),'%d-%m-%Y') tgljam FROM b_pelayanan p INNER JOIN b_ms_unit mu ON p.unit_id=mu.id LEFT JOIN b_tindakan_kamar tk ON p.id=tk.pelayanan_id
                ...
                <td height="30" colspan="2" align="center" style="font-weight:bold;font-size:16px">
                    <u>&nbsp;Kwitansi Rincian Tagihan Pasien&nbsp;</u>
                     <?
						if($_REQUEST['jmlTC']>0)
						{
							echo "<br> <b>Bukan Sebagai Bukti Pembayaran</b><br>";
						}
                    ?>
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="30%" style="font-size:16px">&nbsp;<?php echo $tglIn;?></td>
                        </tr>
                        <tr>
                            ...
                            <td width="1%" align="center" style="font-weight:bold;font-size:16px">:</td>
                            <td width="30%" style="font-size:16px">&nbsp;<?php echo $_REQUEST['txtTglSel'];?></td>
                        </tr>
                        <tr>
                            <td width="11%" style="font-size:16px">Alamat</td>
                            <td width="2%" align="center" style="font-weight:bold;font-size:16px;">:</td>
                            <td style="font-size:16px">&nbsp;<?php echo strtolower($rw['alamat']." Kec. ".$rw['nmKec']);?></td>
                        ...
                        <tr>
                          ...
                          <td width="10%" style="font-size:16px">Umur</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:16px">:</td>
                        ...
                        <tr>
                            <td width="11%" style="font-size:16px">Kecamatan </td>
                            <td width="2%" align="center" style="font-weight:bold;font-size:16px">:</td>
                            <td style="font-size:16px">&nbsp;<?php echo strtolower($rw['nmKec']);?></td>
                            <td width="10%" style="font-size:16px">Status Pasien</td>
                            <td width="1%" align="center" style="font-weight:bold;font-size:16px">:</td>
                            <td width="30%" style="font-size:16px">&nbsp;<?php echo $rw['nmKso']?></td>
                        </tr>
                        <tr>
                            ...
                            <td width="1%" align="center" style="font-weight:bold;font-size:16px">:</td>
                            <td width="30%" style="font-size:16px">&nbsp;<?php echo $rw['kelas'];?></td>
                        </tr>
              </table>	</td>
            </tr>
            <tr class="kwi">
                <td height="30" colspan="2">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="613" align="center" style="border:#000000 solid 1px; font-weight:bold;font-size:16px">Tindakan</td>
                            <td align="center" width="134" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px">Tanggal</td>
                            <td align="center" width="141" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px">Jumlah</td>
                            <td align="center" width="117" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px"> <?php if ($for<>"1"){?>Biaya<?php }?></td>
						...
						WHERE p.kunjungan_id='$idKunj' AND p.unit_id<>$idUnitAmbulan AND p.unit_id<>$idUnitJenazah";
							*/
							$sUnit="SELECT DISTINCT p.id,mu.nama nmUnit,mu.id idUnit,mu.parent_id FROM b_pelayanan p
						INNER JOIN b_ms_unit mu ON p.unit_id=mu.id LEFT JOIN b_tindakan t ON p.id=t.pelayanan_id
						WHERE p.kunjungan_id='$idKunj' AND p.batal = 0";
                        }elseif ($tipe=="1") {
							/*
...
WHERE p.kunjungan_id='$idKunj' AND p.jenis_kunjungan=3 AND p.unit_id<>$idUnitAmbulan AND p.unit_id<>$idUnitJenazah";
							*/
							$sUnit="SELECT DISTINCT p.id,mu.nama nmUnit,mu.id idUnit,mu.parent_id 
FROM b_pelayanan p INNER JOIN b_ms_unit mu ON p.unit_id=mu.id LEFT JOIN b_tindakan t ON p.id=t.pelayanan_id 
WHERE p.kunjungan_id='$idKunj' AND p.jenis_kunjungan=3 AND p.batal = 0";
                        }elseif ($tipe=="0") {
							/*
                        	$sUnit="SELECT DISTINCT p.id,mu.nama nmUnit,mu.id idUnit,mu.parent_id 
FROM b_pelayanan p INNER JOIN b_ms_unit mu ON p.unit_id=mu.id LEFT JOIN b_tindakan t ON p.id=t.pelayanan_id 
...
LEFT JOIN b_ms_kelas mKls ON tk.kelas_id=mKls.id WHERE kunjungan_id='$idKunj' AND p.id='".$rwUnit['id']."'";
                        ...
                        <tr>
                            ...
                            <td></td>
                                ...
                                <?php
                                if ($ksoid==1) {
										$sTind="SELECT t.id,DATE_FORMAT(t.tgl,'%d-%m-%Y') tgl,mt.nama nmTind, (t.biaya*t.qty) AS biaya, (t.biaya*t.qty) AS iurbiaya,0 AS biaya_kso,t.bayar bayar,t.bayar_kso bayarKSO,t.qty cTind 
...
WHERE t.pelayanan_id='".$rwUnit['id']."' AND user_id='".$rwKonsul['user_id']."' ORDER BY t.id";
                                }else {
										$sTind="SELECT t.id,DATE_FORMAT(t.tgl,'%d-%m-%Y') tgl,mt.nama nmTind, (t.biaya*t.qty) AS biaya,(t.biaya_kso*t.qty) AS biaya_kso,(t.biaya_pasien*t.qty) AS iurbiaya,t.bayar bayar,t.bayar_kso bayarKSO,t.qty cTind FROM b_tindakan t INNER JOIN b_ms_tindakan_kelas mtk ON t.ms_tindakan_kelas_id=mtk.id INNER JOIN b_ms_tindakan mt ON mtk.ms_tindakan_id=mt.id 
WHERE t.kunjungan_id=".$idKunj." AND t.pelayanan_id=".$rwUnit['id']." AND user_id='".$rwKonsul['user_id']."' ORDER BY t.id";
                                }
                                //echo $sTind."<br>";
                        ...
                        <tr>
                            ...
                            <td align="center">&nbsp;</td>
                            <td align="right" style="font-weight:bold; font-size:16px">Sub Total&nbsp;</td>
                        ...
                        <tr>
                          <td align="left" style="padding-left:60px;font-size:16px">&nbsp;</td>
                          <td align="center">&nbsp;</td>
                          <td align="right" style="font-weight:bold; font-size:16px">Bayar&nbsp;</td>
						...
						if ($ksoid==1){
							...
							$selisih=$sBiaya-$sByr-$keringanan-$titipan;
						}else{
                        ...
                        <tr>
                            <td align="left" style="padding-left:60px; font-size:16px">&nbsp;</td>
                            <td align="right" style="font-weight:bold; font-size:16px" colspan="2">Total Biaya&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="right" style="font-weight:bold;font-size:16px" colspan="2">Dijamin KSO&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="right" style="font-weight:bold;font-size:16px" colspan="2">Titipan&nbsp;</td>
                        ...
                        <tr>
                            <td height="19" align="left" style="padding-left:60px;font-size:16px">&nbsp;</td>
                            <td align="right" style="font-weight:bold;font-size:16px" colspan="2">Keringanan&nbsp;</td>
                        ...
                        <tr>
                            <td height="19" align="left" style="padding-left:60px;font-size:16px">&nbsp;</td>
                            <td align="right" style="font-weight:bold;font-size:16px;" colspan="2">Total Bayar&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="right" style="font-weight:bold; font-size:16px" colspan="2">Kurang (Tind)&nbsp;</td>
            ...
            <tr>
                <td colspan="2">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="615" align="center" style="border:#000000 solid 1px; font-weight:bold;font-size:16px">Nama Obat</td>
                            <td align="center" width="138" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px">Cara Bayar</td>
                            <td align="center" width="136" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px">Tanggal</td>
                            <td align="center" width="173" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px">Jumlah</td>
                            <td align="center" width="163" style="border:#000000 solid 1px; border-left:none; font-weight:bold;font-size:16px">Biaya</td>
                        </tr>
                        <?php
                        //=====tipe=2-->RJ+RI, tipe=1-->RI, tipe=0-->RJ======
						if ($tipe=="2") {
...
WHERE p.kunjungan_id='$idKunj' AND p.jenis_kunjungan<>3) AS t2 INNER JOIN $dbapotek.a_penjualan ap ON t2.id=ap.NO_KUNJUNGAN WHERE ap.NO_PASIEN='".$rw['no_rm']."'";
                        ...
                        <tr>
							...
							//echo $klsId."<br>";
							$sKonsul="SELECT DISTINCT ap.NO_PENJUALAN,
							ap.DOKTER,
							ap.CARA_BAYAR,
							ac.nama,
							ap.UNIT_ID
							FROM $dbapotek.a_penjualan ap inner join $dbapotek.a_cara_bayar ac on ap.CARA_BAYAR=ac.id WHERE ap.NO_PASIEN='".$rw['no_rm']."' AND ap.NO_KUNJUNGAN='".$rwUnit['id']."'";
                            //echo $sKonsul."<br>";
                            $qKonsul=mysql_query($sKonsul);
                            while($rwKonsul=mysql_fetch_array($qKonsul)) {
                            	$sTot=0;
                        ...
                        <tr>
                            ...
                            <td></td>
								...
								FROM (SELECT * FROM $dbapotek.a_penjualan WHERE NO_KUNJUNGAN='".$rwUnit['id']."' AND NO_PENJUALAN='".$rwKonsul['NO_PENJUALAN']."' AND DOKTER like '".$rwKonsul['DOKTER']."' AND UNIT_ID = '".$rwKonsul['UNIT_ID']."' ) AS t2 
                        ...
                        <tr>
                            ...
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="right" style="font-weight:bold; border-bottom:solid #000000 1px;font-size:16px">Jamin KSO&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="center" style="border-top:solid #000000 1px; font-size:16px;">&nbsp;</td>
                            <td align="right" style="font-weight:bold; border-top:solid #000000 1px; font-size:16px">Total Biaya&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="right" style="font-weight:bold; font-size:16px">Total Bayar&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="right" style="font-weight:bold; font-size:16px">Kurang (Obat)&nbsp;</td>
                        ...
                        <tr>
                            <td align="left" height="20">&nbsp;</td>
                            <td colspan="3" align="right" style="font-weight:bold; font-size:16px">Grand Total (Tind + Obat)&nbsp;</td>
                            <td align="right" style="font-weight:bold; font-size:16px"><?php echo number_format(($bTot+$sBiaya),0,",",".");?>&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="left" height="20">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td colspan="2" align="right" style="font-weight:bold; font-size:16px">Kurang (Tind + Obat)&nbsp;</td>
            ...
            <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-weight:bold;font-size:16px">
                	<tr>
                        ...
                        <td width="10%">&nbsp;</td>
                        <td width="25%" align="center"><?php echo $_REQUEST['tglprint']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
						...
						?>
                    	<td align="center">(&nbsp;<?php echo $_REQUEST['kasir']; ?>&nbsp;)</td>
                        <td>&nbsp;</td>
                        <td align="center">&nbsp;</td>
                        <td>&nbsp;</td>

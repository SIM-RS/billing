        ...
        <div align="center">
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" class="hd2">
                <tr>
					...
					<?php 
					$qAkses = "SELECT ms_menu_id,mm.nama,mm.url FROM b_ms_group_petugas gp INNER JOIN b_ms_group_akses mga ON gp.ms_group_id = mga.ms_group_id INNER JOIN b_ms_menu mm ON mga.ms_menu_id=mm.id WHERE gp.ms_pegawai_id=$userId AND mga.ms_menu_id IN (37,39,42,54)";
            ...
            <table width="1000" border="0" cellspacing="1" cellpadding="0" class="tabel" align="center">
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" class="txtinputreg" name="Nama" id="Nama" size="56" tabindex="3" onkeyup="listPasien(event,'show',this.value)"/>
			  ...
			  &nbsp;Th&nbsp;&nbsp;<input type="text" style="text-align:center;" class="txtinputreg" name="Bln" id="Bln" size="3" tabindex="9" onkeyup="gantiTgl()"/>&nbsp;Bln--></td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="7" align="center"><input name="btnPrint" id="btnPrint" type="button" class="tblCetak" value="&nbsp;&nbsp;&nbsp;Cetak" onclick="cetakPembayaran();" />&nbsp;
...
<div id="divTind" style="display:none;width:750px; height:310px" align="center" class="popup">
    ...
    <script type="text/JavaScript">
        ...
        function hapus()
        {
            ...
            {
                //alert("bayar_utils.php?grd=true&idKunj="+dataPasien[9]+"&idKasir="+idKasir+"&act=hapus&rowid="+rowid)
                a1.loadURL("bayar_utils.php?grd=true&idKunj="+dataPasien[10]+"&idKasir="+idKasir+"&act=hapus&rowid="+rowid,"","GET");
            }
            batal();
        }

...
<body>
<table width="1200" border="0" cellspacing="0" cellpadding="0" align="left" class="kwi">
  <tr>
    ...
    <td colspan="2">
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="13%">Tgl Mulai</td>
<!--td width="1%" align="center" style="font-weight:bold">:</td-->
                				<td width="2%" align="center" >:</td>
			  <td width="26%">&nbsp;<?php echo $rw['tglM']?></td>
		  </tr>
			<tr>
				...
				<td width="2%" align="center" style="font-weight:bold">:</td>
			  <td width="26%">&nbsp;<?php echo $rw['tglP']?></td>
		  </tr>
			<tr>
				<td width="11%">Alamat</td>
				<td width="2%" align="center" style="font-weight:bold">:</td>
				<td colspan="3">&nbsp;<?php echo strtolower($rw['alamat'])?></td>
				<td width="13%">Kelas</td>
				<td width="2%" align="center" style="font-weight:bold">:</td>
			  <td width="26%">&nbsp;<?php echo strtolower($rw['kelas'])?></td>
		  </tr>
			<tr>
				<td width="11%">&nbsp;</td>
				<td width="2%" align="center" style="font-weight:bold">&nbsp;</td>
				<td width="11%">Kel. / Desa </td>
				<td width="2%" align="center" style="font-weight:bold">:</td>
			  <td width="33%">&nbsp;<?php echo strtolower($rw['nmDesa']);?></td>
			  <td width="13%">&nbsp;</td>
				<td width="2%" align="center" style="font-weight:bold">&nbsp;</td>
			  <td width="26%"></td>
		  </tr>
			<tr>
				<td width="11%">&nbsp;</td>
				<td width="2%" align="center" style="font-weight:bold"></td>
				<td width="11%">RT / RW </td>
				<td width="2%" align="center" style="font-weight:bold">:</td>
			  <td width="33%">&nbsp;<?php echo strtolower($rw['rt']." / ".$rw['rw']);?></td>
			  <td width="13%">&nbsp;</td>
				<td width="2%" align="center" style="font-weight:bold">&nbsp;</td>
			  <td width="26%"></td>
		  </tr>
			<tr>
				...
				<td width="13%">Status Pasien </td>
				<td width="2%" align="center" style="font-weight:bold">:</td>
			  <td width="26%">&nbsp;<?php echo strtolower($rw['nmKso'])?></td>
		  </tr>
		</table>	</td>
  </tr>
  <tr class="kwi">
    <td height="30" colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<!--td align="center" style="border-top:#000000 solid 1px; border-bottom:#000000 solid 1px; border-left:#000000 solid 1px; border-right:#000000 solid 1px; font-weight:bold;">Tindakan</td>
				<td align="center" style="border-top:#000000 solid 1px; border-bottom:#000000 solid 1px; border-right:#000000 solid 1px; font-weight:bold">Tanggal</td>
				<td align="center" style="border-top:#000000 solid 1px; border-bottom:#000000 solid 1px; border-right:#000000 solid 1px; font-weight:bold">Jumlah</td>
				<td align="center" style="border-top:#000000 solid 1px; border-bottom:#000000 solid 1px; border-right:#000000 solid 1px; font-weight:bold">Biaya</td-->
			
				<td align="center" style="border:#000000 solid 1px; font-weight:bold;">Tindakan</td>
				<td align="center" style="border:#000000 solid 1px; font-weight:bold">Tanggal</td>
				<td align="center" style="border:#000000 solid 1px; font-weight:bold">Jumlah</td>
				<td align="center" style="border:#000000 solid 1px; font-weight:bold">Biaya</td>
...
WHERE bt.bayar_id='$idbayar' AND t.pelayanan_id='".$rwUnit['id']."' AND user_id='".$rwKonsul['user_id']."' ORDER BY t.id";
			...
			<tr>
				...
				<td align="center">&nbsp;</td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px">Sub Total&nbsp;</td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px"><?php echo number_format($bTot,0,",",".")?>&nbsp;</td>
			</tr>
			<?php
				//$sBayar=$sByr;
			}?>
			<tr>
				<td align="left" style="padding-left:60px; border-top:#000000 solid 1px">&nbsp;</td>
				<td align="center" style="border-top:solid #000000 1px">&nbsp;</td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px">Total Biaya&nbsp;</td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px"><?php echo number_format($sBiaya,0,",",".")?>&nbsp;</td>
			</tr>
			<?php
			/*
          ...
          <?php }?>
			...
			<tr>
				...
				<td align="center"></td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px"></td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px"></td>
			<tr>
				<td align="left" style="padding-left:60px;">&nbsp;</td>
				<td align="center">&nbsp;</td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px">Kurang&nbsp;</td>
				<td align="right" style="font-weight:bold; border-top:solid #000000 1px"><?php echo number_format(($sBiaya-$sJaminKso-$dibayar-$keringanan-$titipan),0,",",".")?>&nbsp;</td>
			</tr>
	</table>	</td>
  </tr>
  <tr>

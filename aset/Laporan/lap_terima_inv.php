...
switch ($r_formatlap) {
    case "XLS" :
		...
		header('Content-Disposition: attachment; filename="Laporan_Penerimaan_Inventaris_'.date('d-m-Y').'.xls"');
        break;
    case "WORD" :
        Header("Content-Type: application/msword");
		header('Content-Disposition: attachment; filename="Laporan_Penerimaan_Inventaris_'.date('d-m-Y').'.doc"');
        break;
    default :
...
<html>
    <head>
        <title>Laporan Penerimaan Inventaris</title>
    ...
    <table width="450" border="0">
          <tr>
            <td width="200"><strong>SKPD</strong></td>
            <td width="250">: <strong>Rumah Sakit Umum Daerah</strong></td>
          </tr>
          <tr>
    ...
    <p>&nbsp;</p>
<p align="center"><strong><font size="4" face="Times New Roman, Times, serif">LAPORAN PENERIMAAN INVENTARIS</font><br />
...
<tr align="center" valign="top" bgcolor="#CCCCCC" class="HeaderBW">
                ...
                <td width="52" rowspan="2">
                    <font size="-2"><br />
                    Tanggal Terima</font>                </td>
<td width="109" rowspan="2"><font size="-2"><br />Dari</font></td>
    <td height="22" colspan="2"><font size="-2">Dokumen/Faktur</font></td>
    <td height="22" colspan="3"><font size="-2">Dasar Penerimaan</font></td>
                <td width="49" rowspan="2">
                <font size="-2"><br />
                        Nama Barang</font>                </td>
                
                <td width="33" rowspan="2"><font size="-2"><br />Banyak</font></td>
                
                <td width="33" rowspan="2"><font size="-2"><br />Satuan</font></td>
                
                <td width="41" rowspan="2"><font size="-2"><br />
                Harga Satuan (Rp)
</font></td>
                <td width="44" rowspan="2"><font size="-2"><br />
                Jumlah Harga (RP)
</font></td>
                <td colspan="2"><font size="-2">
                Bukti Surat Peneriamaan
</font></td>
    <td width="135" rowspan="2">
            ...
            <tr align="center" valign="top" bgcolor="#CCCCCC" class="HeaderBW">
              <td width="52"><font size="-2">Tanggal</font></td>
              <td width="56"><font size="-2">Nomor</font></td>
              <td width="44"><font size="-2">Jenis Surat</font></td>
              <td width="45"><font size="-2">Tanggal</font></td>
                <td width="45" height="10"><font size="-2">Nomor</font></td>
                <td width="49"><font size="-2">
Nomor</font></td>
                <td width="50"><font size="-2">Tanggal</font></td>
            </tr>
            <tr align="center" valign="top" bgcolor="#FFFFCC" class="SubHeaderBW">
			    ...
			    <?php
                        ...
                        where m.tgl_terima between '$r_tglawal' and '$r_tglakhir' and b.tipe=1 ";
                        //echo $strSQL."<br />";

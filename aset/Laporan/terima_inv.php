            ...
            <table width="1000" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding-top: 10px;" align="center">
                        ...
                        if ($_GET["par"]=="1") {
                            ?>
                        <form id="form1" name="form1" action="lap_terima_inv.php" method="post" target="Laporan Pengadaan Inventaris">
                            <table width="600" border="0" cellspacing="0" cellpadding="4">
                                <tr align="center">
                                    <td colspan="2" class="header">
                                        <strong><font size="2">Laporan Penerimaan Inventaris</font></strong>                                    </td>
                              </tr>
                                <!--tr>
                        ...
                        <form id="form1" name="form1" action="lap_luar_inv.php" method="post" target="Laporan Pengeluaran Inventaris">
                            <table width="600" border="0" cellspacing="0" cellpadding="4">
                                ...
                                <tr align="center">
                                    <td colspan="2" class="header2">
                                        <input name="submit" type="submit" id="submit" value="Tampilkan" onClick="if (document.getElementById('idunit').value=='') {alert('Pilih Unit / Satuan Kerja');return false;}" />                                    </td>
                                </tr>
                            </table>
                        <input name="idunit" type="hidden" id="idunit" value="" />
                            <input name="namaunit" type="hidden" id="namaunit" value="" />

...
<html>
    <head>
        <title>Laporan Pengadaan Habis Pakai</title>
...
<p align="center"><strong><font size="4" face="Times New Roman, Times, serif">PENGADAAN BARANG PAKAI HABIS</font><br />
	...
	<br />
        ...
        <table border=1 cellspacing="0" cellpadding="4" class="GridStyle" width="100%">
            <tr align="center" valign="top" bgcolor="#CCCCCC" class="HeaderBW">
                ...
                <td  rowspan="2">
                    <font size="-2"><br />
                    Jenis Barang yang di beli</font>                </td>
                <td height="22" colspan="2">
                    <font size="-2">Kontrak Jual Beli / Surat Pesanan Perintah Kerja</font></td>
                <td height="22" colspan="2"><font size="-2">SKO / SPMU / KWITANSI</font></td>
                <td height="22" colspan="4"><font size="-2">Jumlah</font></td>
                <td rowspan="2">
                    <font size="-2"><br />
                        Dipergunakan Pada Unit</font>                </td>
                <td  rowspan="2">
                    <font size="-2"><br />
                        Keterangan</font>                </td>
            </tr>
            ...
            <tr align="center" valign="top" bgcolor="#CCCCCC" class="HeaderBW">
              ...
              <td ><font size="-2">Tanggal</font></td>
              <td ><font size="-2">Nomor</font></td>
              <td ><font size="-2">Banyaknya</font></td>
	      <td ><font size="-2">Satuan</font></td>
              <td  height="10"><font size="-2">Harga Satuan (Rp.)</font></td>
              <td  height="10"><font size="-2">Jumlah Harga (Rp.)</font></td>
            </tr>
            <tr align="center" valign="top" bgcolor="#FFFFCC" class="SubHeaderBW">
                <td width="3%" height="10"><font size="-2">1</font></td>
                <td width="13%"height="10"><font size="-2">2</font></td>
                <td width="6%"height="10"><font size="-2">3</font></td>
                <td width="6%"height="10"><font size="-2">4</font></td>
                <td width="6%"height="10"><font size="-2">5</font></td>
                ...
                <td width="6%"height="10"><font size="-2">9</font></td>
                <td width="6%"height="10"><font size="-2">10</font></td>
                <td width="6%"height="10"><font size="-2">12</font></td>
				<td width="6%"height="10"><font size="-2">13</font></td>
            </tr>
			    <?php 
                        $strSQL="SELECT brg.namabarang,po.jenis_surat,po.tgl_po,po.no_po,msk.tgl_faktur,msk.no_faktur,msk.jml_msk,msk.satuan_unit,
                                        msk.harga_unit,(msk.jml_msk*msk.harga_unit) AS harga_total,u.namapanjang,rek.namarekanan,u.namaunit
                                FROM as_ms_barang brg INNER JOIN as_po po ON (brg.idbarang = po.ms_barang_id)
                                        INNER JOIN as_masuk msk ON (po.id = msk.po_id)
                                        INNER JOIN as_ms_rekanan rek ON (rek.idrekanan = po.vendor_id)
                                        LEFT JOIN as_ms_unit u ON u.idunit=po.unit_id
                                        WHERE msk.tgl_faktur BETWEEN '$r_tglawal' AND '$r_tglakhir' AND brg.tipe=2
                                        ORDER BY msk.tgl_faktur,msk.no_faktur,brg.namabarang";
                        //echo "<br>". $strSQL."<br />";
            ...
            <tr class="<?php echo $rowStyle ?>" valign="top">
                ...
                <td align="left" class="<?php echo $cellStyle ?>"><div align="center"><font size=1>
                  								<?php
                                                echo $rows["satuan_unit"];
                                                ?>
              </font></div></td>
                <td align="right" class="<?php echo $cellStyle ?>"><font size=1>
                  <?php
                                                echo number_format($rows["harga_unit"],0,'','.');
                                                ?>
                </font></td>
<td align="right" class="<?php echo $cellStyle ?>"><font size=1>
  <?php
                                                echo number_format($rows["harga_total"],0,'','.');

...
//	}
    ...
    <table border=1 cellspacing="0" cellpadding="4" style="border:1px solid #999999; border-collapse:collapse; border-bottom:0px;" width="100%">
  ...
  <td width="80" rowspan="2"><font size="-2"><br />
	...
	<div style="width:1325px; height:300px; overflow:auto; border:1px solid #CCCCCC;">
      <?php             
		...
		if($idunit!=0)
		{
               ...
               $strSQL .="SELECT k.tgl_gd, k.kode_transaksi, k.tgl_transaksi, u.namaunit, l.namalokasi, k.jml_klr, b.namabarang, k.nilai, (
                                    k.jml_klr * k.nilai
                                    ) AS jumlah_keluar, k.petugas_gudang
                                    FROM as_keluar k
                                    ...
                                    INNER JOIN as_masuk m ON o.msk_id = m.msk_id
                                    INNER JOIN as_po p ON m.po_id = p.id
                                    WHERE $change k.tgl_transaksi
                                    BETWEEN  '$r_tglawal'
                                    AND  '$r_tglakhir'
                                    AND b.tipe =2 and k.jml_klr>0 
                                    LIMIT 0 , 30";
                         //echo $strSQL."<br />";
                         //echo $change;
		...
		<!--            <tr class="<?php echo $rowStyle ?>" valign="top">
				...
				<td align="right"><?php echo number_format($rows["nilai"],0,'','.');?></td>
				<td align="right"><?php
	...
	<table width="1295">
      <tr>
        ...
        <td width="160" align="right" class="HeaderBW"><?php echo number_format($totalgeneral,0,'','.');?></td>
        <td width="296" colspan="2" class="HeaderBW">&nbsp;</td>
      </tr>
    </table>
    <br />
    <br />

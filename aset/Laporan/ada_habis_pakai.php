            ...
            <table width="1000" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding-top: 10px;" align="center">
                        <form id="form1" name="form1" action="lap_ada_habis_pakai.php" method="post" target="Laporan Kartu Inventaris Barang">
                            <table width="600" border="0" cellspacing="0" cellpadding="4">
                                <tr align="center">
                                    <td colspan="2" class="header">
                                        <strong><font size="2">Laporan Pengadaan Barang Pakai Habis</font></strong>                                    </td>
                                </tr>
                                <!--tr>

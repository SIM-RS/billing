...
?>
    <table id="tblObat" border="0" width="736" cellpadding="1" cellspacing="0">
    <tr>
    	<td width="28">No</td>
...
WHERE islast = 1 AND TRIM(namabarang) LIKE '%$aKeyword%' AND tipe='$cmb' ORDER BY kodebarang";
	  ...
	  ?>
      <tr id="<?php echo $i; ?>" lang="<?php echo $arfvalue; ?>" class="itemtableReq" onMouseOver="this.className='itemtableMOverReq'" onMouseOut="this.className='itemtableReq'" onClick="ValNamaBag(this.lang);" height="20">

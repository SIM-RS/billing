...
?>
    ...
    <head>
        ...
        <title>.: Laporan Pengeluaran Barang Pakai Habis :.</title>
    </head>
            ...
            <table width="1000" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <script>/* 
                                    ...
                                    <iframe id="treediv" scrolling="auto" width="1000" style="display: none;" src="../Aktivitas/unit_tree.php?<?php echo $unit_opener; ?>"></iframe>
                        <form id="form1" name="form1" action="laporan_keluar_habis_pakai.php" method="post" target="Laporan Kartu Inventaris Barang">
                            <table width="600" border="0" cellspacing="0" cellpadding="4">
                                <!--</a><tr>
                                    <td colspan="2" class="header">
                                        <strong><font size="2">Laporan Keluar Habis Pakai</font></strong>                                    
                                    </td>
                                </tr>
                                -->
                                <tr align="center">
                                    <td colspan="2" class="header">
                                        <strong><font size="2">Laporan Pengeluaran Barang Pakai Habis</font></strong>
                                    </td>
                                </tr>
								<tr>
                                    <td class="label"><strong>Unit / Satuan Kerja </strong></td>
                                    <td class="content">
                                        <input name="kodeunit" type="text" class="txtmustfilled" id="kodeunit" size="20" maxlength="15" readonly style="text-align:left;" />

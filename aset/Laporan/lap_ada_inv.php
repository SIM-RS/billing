...
switch ($r_formatlap) {
    case "XLS" :
		...
		header('Content-Disposition: attachment; filename="Laporan_Pengadaan_Inventaris_'.date('d-m-Y').'.xls"');
        break;
    case "WORD" :
        Header("Content-Type: application/msword");
		header('Content-Disposition: attachment; filename="Laporan_Pengadaan_Inventaris_'.date('d-m-Y').'.doc"');
        break;
    default :
	...
	<br />
		...
		<td height="10"><font size="-2">13</font></td>
			    ...
			    <?php
						...
						WHERE (po.tgl_po BETWEEN '$r_tglawal' AND '$r_tglakhir') AND brg.tipe=1

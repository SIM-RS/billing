...
<p align="center"><strong><font size="4" face="Times New Roman, Times, serif">LAPORAN PENGADAAN INVENTARIS</font><br />
		...
		<td height="10"><font size="-2">13</font></td>
			    ...
			    <?php
                        ...
                        $strSQL="SELECT brg.namabarang,po.jenis_surat,po.tgl_po,po.no_po,msk.tgl_faktur,msk.no_faktur,msk.jml_msk,msk.satuan_unit,
                                        ...
                                        FROM as_ms_barang brg
                                        INNER JOIN as_po po ON brg.idbarang = po.ms_barang_id
                                        ...
                                        WHERE msk.tgl_faktur BETWEEN '$r_tglawal' AND '$r_tglakhir' AND brg.tipe=1

...
if(isset($_POST['act']) && $_POST['act'] != '') {
    ...
    if($act == 'add') {
        $query = "insert into as_ms_barang (kodebarang,namabarang,tipebarang,level,mru,statuskode,metodedepresiasi,stddepamt,stddeppct,lifetime,nilairesidu
            ,akunaset,akundep,akunakdep,akundisloss,akundisgain,akunmaintenance,akunlease,idsatuan,t_userid,t_updatetime,t_ipaddress,tipe)
                values
                ('$kodebarang', '$namabarang', '$tipebarang', '$level', '$mru', '$statuskode', '$metodedepresiasi', '$stddepamt', '$stddeppct', '$lifetime', '$nilairesidu'
                , '$akunaset', '$akundep', '$akunakdep', '$akundisloss', '$akundisgain', '$akunmaintenance', '$akunlease', '$idsatuan', '$t_userid', now(), '$t_ipaddress', '$tipe')";
    }
    else if($act == 'edit') {
        $query = "update as_ms_barang set kodebarang = '$kodebarang', namabarang = '$namabarang', tipebarang = '$tipebarang', level = '$level', mru = '$mru'
                , statuskode = '$statuskode', metodedepresiasi = '$metodedepresiasi', stddepamt = '$stddepamt', stddeppct = '$stddeppct'
                , lifetime = '$lifetime', nilairesidu = '$nilairesidu', akunaset = '$akunaset', akundep = '$akundep', akunakdep = '$akunakdep'
                , akundisloss = '$akundisloss', akundisgain = '$akundisgain', akunmaintenance = '$akunmaintenance', akunlease = '$akunlease'
                , idsatuan = '$idsatuan', t_userid = '$t_userid', t_updatetime = now(), t_ipaddress = '$t_ipaddress', tipe = '$tipe'
            where idbarang = $id";
    }
...
?>
    ...
    <body>
        <div align="center">
            ...
            if($act == 'edit') {
                $par .= "&idbarang=$id";
                $query = "SELECT idbarang,kodebarang,namabarang,idsatuan,tipebarang,level,mru,statuskode,metodedepresiasi,stddepamt,stddeppct,lifetime,nilairesidu,akunaset,akundep,akunakdep,akundisloss,akundisgain,akunmaintenance,akunlease FROM as_ms_barang WHERE idbarang = '$id'";
                $rs = mysql_query($query);
                                ...
                                <form action="" id="form1" name="form1" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td width="60%" class="content">&nbsp;
                                            <input type="text" id="kodebarang" name="kodebarang" class="txtmustfilled" value="<?php echo $rows['kodebarang']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" class="label">&nbsp;Nama Barang</td>
                                        <td class="content">&nbsp;
                                            <input type="text" id="namabarang" name="namabarang" class="txtmustfilled" value="<?php echo $rows['namabarang']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="content">&nbsp;
                                            <select name="level" class="txt" id="level">
                                                <option value="1" <?php if ($rows["level"]==1) echo "selected"; ?>>1 - Golongan</option>
                                                <option value="2" <?php if ($rows["level"]==2) echo "selected"; ?>>2 - Bidang</option>
                                                <option value="3" <?php if ($rows["level"]==3) echo "selected"; ?>>3 - Kelompok</option>
                                                <option value="4" <?php if ($rows["level"]==4) echo "selected"; ?>>4 - Sub Kelompok</option>
                                                <option value="5" <?php if ($rows["level"]==5) echo "selected"; ?>>5 - Sub Sub Kel.</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="content">&nbsp;
                                            <input name="stddepamt" type="text" class="txt" id="stddepamt" value="<?php echo $rows["stddepamt"]; ?>" size="10" maxlength="15" />&nbsp;Rp.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="content">&nbsp;
                                            <input name="nilairesidu" type="text" class="txt" id="nilairesidu" value="<?php echo $rows["nilairesidu"]; ?>" size="10" maxlength="15" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="content">&nbsp;
                                            <input name="akundep" type="text" class="txt" id="akundep" value="<?php echo $rows["akundep"]; ?>" size="50" maxlength="30" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" class="label">&nbsp;Akun. Ak. Penyusutan</td>
                                        <td class="content">&nbsp;
                                            <input name="akunakdep" type="text" class="txt" id="akunakdep" value="<?php echo $rows["akunakdep"]; ?>" size="50" maxlength="30" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" class="label">&nbsp;Akun. Disposal Loss</td>
                                        <td class="content">&nbsp;
                                            <input name="akundisloss" type="text" class="txt" id="akundisloss" value="<?php echo $rows["akundisloss"]; ?>" size="50" maxlength="30" />
                                        </td>
                                    </tr>
                                    <tr>

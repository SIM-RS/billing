    ...
    <body style="border-width:0px;" bgcolor="#CCCCCC" topmargin="0" leftmargin="0" onLoad="javascript:if (window.focus) window.focus();">
        <div align="center">
            <table border=1 cellspacing=0 width="98%">
                        ...
                        if (isset($_REQUEST["p"])) {
                           ...
                           $strSQL = "select * from as_lokasi order by kodelokasi";
                            ...
                            while ($rows=mysql_fetch_array($rs)) {
                                ...
                                if ($lvl > 0)
                                    $tree[$cnt][2]= "javascript:fSetValue(window.opener,'".$par[0]."*-*".$rows['kodelokasi']."*|*".$par[1]."*-*".$rows['kodelokasi'].".');window.close();";
                ...
                <tr><td align="center"><input type="button" value="Top parent" onClick="window.close();"/></td></tr>
            </table>

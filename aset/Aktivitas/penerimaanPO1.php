...
?>
    ...
    <script type="text/javascript" language="javascript">
        ...
        po.setColHeader("NO,TANGGAL,NO GUDANG,NO PO,NO FAKTUR,VENDOR");
        po.setIDColHeader(",ta.tgl_terima,msk.no_gudang, po.no_po,msk.no_faktur,rek.namarekanan");
        po.setColWidth("50,100,150,150,150,275");

...
function goFilterAndSort(abc){
	if (abc=="gridbox"){
		mygrid1.loadURL("tnh_brg_util.php?kode=true&filter="+mygrid1.getFilter()+"&sorting="+mygrid1.getSorting()+"&page="+mygrid1.getPage(),"","GET");
	}
} 
...
mygrid1.baseURL("tnh_brg_util.php?kode=true&saring=true&saring=");
mygrid1.Init();

            ...
            <table border="0" width="1000" cellpadding="0" cellspacing="2" bgcolor="#FFFBF0">
                ...
                <form id="form1" name="form1" action="" method="post">
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                        <td colspan="5">&nbsp;Jatuh Tempo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo tglSQL($po_rekanan[3]);?>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="5">Jatuh Tempo Bayar :&nbsp;
                              ...
                              <img alt="calender" style="cursor:pointer" border=0 src="../images/cal.gif" align="absbottom" onClick="gfPop.fPopCalendar(document.getElementById('txtTglTempoBayar'),depRange);" />
                        </td>
                        <td width="3%">&nbsp;</td>
                    </tr>
                    <tr>
                            ...
                            <table id="tblpenerimaan" width="100%" border="0" cellpadding="1" cellspacing="0">
                                <tr class="headtable">
                                  ...
                                  <td id="qty_kemasan" width="184" class="tblheader">
                                    <p>Nama Barang</p></td>
                                  <td id="uraian" width="184" class="tblheader">
                                    <p>Uraian</p></td>
                                ...
                                if(isset($_GET['act']) && $_GET['act'] == 'edit' || isset($no_po)) {
                                    ...
                                    while ($rows=mysql_fetch_array($rs)) {
                                        ...
                                        if($_GET['act'] != 'edit'){
                                            $qty_kemasan_terima = ($qty_terima!=0)?(cekNull($rows['qty_satuan'])-$qty_terima):cekNull($rows['qty_satuan']);
                                ...
                                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
                                    ...
                                    <td class="tdisi" align="center">
                                    <input id="txtUraian" name="txtUraian" type="text" class="txtcenter" size="10" readonly="readonly" value="<?php echo $uraian; ?>" />                                    
                                    </td>
                                    <td class="tdisi" align="center">
                                ...
                                <td class="tdisi" align="center">
                                    ...
                                    <td class="tdisi" align="center">
                                    <input id="txtSubTotal" name="txtSubTotal" type="text" class="txtright" readonly="readonly" value="<?php echo $qty_kemasan_terima*$harga_satuan; ?>" />
                                    </td>
                                </tr>
                                        <?php

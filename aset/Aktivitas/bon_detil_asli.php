                                            ...
                                            <table id="tblJual" width="130%" border="0" cellpadding="0" cellspacing="0" align="center">
												...
												<tr>
                                                    ...
                                                    <td align="right" valign="bottom">
                                                        <input type="button" value="Tambah List Bon Barang" onClick="addRowToTable();" />
                                                    </td>
                                                </tr>
                                                <tr class="headtable">
                                                ...
                                                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
                                                    ...
                                                    <td class="tdisi" id="kode" align="center"><input type="text" name="kodebarang" id="kodebarang" value="<?php echo $rows1['kodebarang'];?>" size="20" class="txtinput"></td>
                                                    <td class="tdisi" align="center" width="220">
                                                        ...
                                                        <input type="text" name="namabarang" id="namabarang" class="txtinput" size="30" value="<?php echo $rows1['namabarang'];?>" autocomplete="off" />
													...
													<td class="tdisi" align="center" width="220">
                                                        ...
                                                        <input type="text" name="nmlokasi" id="nmlokasi" value="<?=$rows1['namalokasi'];?>" class="txtinput" onClick="lemparLokasi('par=idlokasi*kodelokasi*nmlokasi',this)" size="30" autocomplete="off" />
                                                             <img alt="tree" width="17" title='Struktur tree lokasi'  style="cursor:pointer" border=0 src="../images/view_tree.gif" align="absbottom" onClick="lemparLokasi('par=idlokasi*kodelokasi*nmlokasi',this)">
                                                ...
                                                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
                                                    ...
                                                    <td class="tdisi" id="kode" align="center"><input type="text" id="kodebarang" name="kodebarang" value="-" size="20" class="txtcenter"></td>
                                                    <td class="tdisi" align="center" width="220">
                                                        <input name="idbarang" id="idbarang" type="hidden" value="">
                                                        <input type="text" name="namabarang" id="namabarang" class="txtinput" onClick="lempar('<?php echo $barang_opener; ?>',this)" size="30" autocomplete="off" />
                                                             <img alt="tree" width="17" title='Struktur tree kode barang'  style="cursor:pointer" border=0 src="../images/backsmall.gif" align="absbottom" onClick="lempar('<?php echo $barang_opener; ?>',this)">
													 ...
													 <td class="tdisi" align="center" width="220">
                                                        ...
                                                        <input type="text" name="nmlokasi" id="nmlokasi" class="txtinput" onClick="lemparLokasi('par=idlokasi*nmlokasi',this)" size="30" autocomplete="off" />
                                                             <img alt="tree" width="17" title='Struktur tree lokasi'  style="cursor:pointer" border=0 src="../images/view_tree.gif" align="absbottom" onClick="lemparLokasi('par=idlokasi*kodelokasi*nmlokasi',this)">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function addRowToTable()
        {
            ...
            if(!isIE){
                ...
                el.name = 'nmlokasi';
                el.id = 'nmlokasi';
                tree.setAttribute('onClick', "lemparLokasi('par=idlokasi*kodelokasi*nmlokasi',this)");
                el.setAttribute('autocomplete', "off");
            }else{
...
?>
    ...
    function save(){
        ...
        if (document.forms[0].idunit.value==""){
        	 alert('Pilih Unit dahulu Terlebih Dahulu !');

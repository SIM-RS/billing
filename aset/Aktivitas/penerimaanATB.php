...
?>
    ...
    <head>
        ...
        <title>.: Penerimaan Aset Tak Bergerak :.</title>
    </head>
    ...
    <body>
        <div align="center">
            ...
            <table align="center" width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFBF0">
                ...
                <tr>
                    <td colspan="4" align="center" style="font-size:16px;">DAFTAR PENERIMAAN ASET TAK BERGERAK</td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="60%" align="right">
                        ...
                        <button type="button" onClick="location='penerimaanATB_detil.php?act=add'" style="cursor: pointer">
                            <img alt="add" src="../icon/add.gif" border="0" width="16" height="16" ALIGN="absmiddle" />
                            Penerimaan                        </button>
                        <button type="button" style="cursor: pointer" onClick="if(document.getElementById('id').value == '' || document.getElementById('id').value == null){alert('Pilih dulu Penerimaan yang akan diedit.');return;}location='penerimaanATB_detil.php?act=edit&id='+document.getElementById('id').value;">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function filter()
        {
            ...
            po.loadURL("penerimaanATB_util.php?bln="+bln+"&thn="+thn,"","GET");
        }
        ...
        function goFilterAndSort(grd)
        {
            ...
            var thn = document.getElementById("ta").value;
            if (grd=="gridbox"){
                po.loadURL("penerimaanATB_util.php?pilihan=penerimaan_atb&bln="+bln+"&thn="+thn+"&filter="+po.getFilter()+"&sorting="+po.getSorting()+"&page="+po.getPage(),"","GET");
            }
        }
        function ambilData()
        {
        ...
        po.setHeader(".: DAFTAR PENERIMAAN ASET TAK BERGERAK :.");
        po.setColHeader("NO,TANGGAL BATB,NO BATB,NO PO,NO GUDANG,VENDOR");
        po.setIDColHeader(",msk.tgl_faktur,msk.no_faktur, po.no_po,po.no_gudang,rek.namarekanan");
        po.setColWidth("50,100,100,200,200,");
        po.setCellAlign("center,center,center,center,center");
        po.setCellHeight(20);
        po.setImgPath("../icon");
        ...
        po.baseURL("penerimaanATB_util.php?bln="+document.getElementById("bulan").value+"&thn="+document.getElementById("ta").value);
        po.Init();
    </script>
</html>

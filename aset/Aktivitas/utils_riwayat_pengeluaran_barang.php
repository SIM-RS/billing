...
switch($pilihan) {
        case 'pengeluaran';
        $sql = "select petugas_gudang,date_format(a.tgl_gd,'%d-%m-%Y') as tglt, a.klr_id, a.kode_transaksi,b.kodebarang, b.namabarang, a.satuan, a.jml_klr,a.no_gd, c.namaunit, d.namalokasi 
                from as_keluar a inner join as_ms_barang b on a.barang_id=b.idbarang

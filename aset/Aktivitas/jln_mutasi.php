...
if(idunit=='' || idunit==null){
	...
	rek.loadURL('jln_util.php?act=berubah&idseri='+idseri+'&idunitlama='+idunitlama+'&idunitbaru='+idunitbaru+'&namaperugas='+namapetugas+'&jbtpetugas='+jabatanpetugas+'&catpetugas='+catpetugas+'&tglmutasi='+tglmutasi,'','GET');
	grid.Init();

        ...
        if(count($fdata) > 1) {
            ...
            for($i=0; $i<count($fdata); $i++) {
                ...
                if($data[8] != '' && isset($data[8])) {
                    $id .= $data[8].'|';
					$sqlIns="insert into user_log (log_user,log_time,log_action,log_query,log_ip) values ('".$_SESSION['id_user']."',sysdate(),'Update PO','update as_po set ms_barang_id = $data[0], jenis_surat = $jenis_surat, vendor_id = $vendor_id, no_po = $no_po, tgl_po = $tgl_po, judul=$judul, exp_kirim = $exp_kirim
            ...
            if($add_new == true) {
			$sqlIns2="insert into user_log (log_user,log_time,log_action,log_query,log_ip) values ('".$_SESSION['id_user']."',sysdate(),'Insert PO','insert into as_po (ms_barang_id,vendor_id,jenis_surat,no_po,tgl_po,judul,exp_kirim,qty_satuan,satuan,harga_satuan,subtotal,total,peruntukan,uraian,pembuat,verifikator) values $query_add','".$_SERVER['REMOTE_ADDR']."')";
					mysql_query($sqlIns2);
            ...
            if($data[8] == '' || !isset($data[8])) {
                ...
                mysql_query($query);
					$sqlIns1="insert into user_log (log_user,log_time,log_action,log_query,log_ip) values ('".$_SESSION['id_user']."',sysdate(),'Insert PO','insert into as_po (ms_barang_id,jenis_surat,vendor_id,no_po,tgl_po,judul,exp_kirim,qty_satuan,satuan,harga_satuan,subtotal,total,peruntukan,uraian,pembuat,verifikator) values ($data[0],$jenis_surat,$vendor_id,$no_po,$tgl_po,$judul,$exp_kirim,$data[1],$data[2],$data[3],$data[4],$data[5],$data[6],$data[7],$pemb,$veri)','".$_SERVER['REMOTE_ADDR']."')";
			mysql_query($sqlIns1);
                ...
                $sqlIns3="insert into user_log (log_user,log_time,log_action,log_query,log_ip) values ('".$_SESSION['id_user']."',sysdate(),'Update PO','update as_po set ms_barang_id = $data[0], jenis_surat = $jenis_surat, vendor_id = $vendor_id, no_po = $no_po, tgl_po = $tgl_po,judul=$judul, exp_kirim = $exp_kirim
    ...
    //pecah belum dicek,karena ada trouble pengiriman data saat dikurangi / ditambah
        ...
        if(count($fdata) > 1) {
            for($i=0; $i<count($fdata); $i++) {
				...
				$sqlIns4="insert into user_log (log_user,log_time,log_action,log_query,log_ip) values ('".$_SESSION['id_user']."',sysdate(),'Insert PO','insert into as_po (ms_barang_id,vendor_id,jenis_surat,no_po,tgl_po,judul,qty_satuan,satuan,harga_satuan,subtotal,total,peruntukan ,uraian,exp_kirim,tgl_act,pembuat,verifikator) values ($data[0],$vendor_id,$jenis_surat,$no_po,$tgl_po,$judul,$data[1],$data[2],$data[3],$data[4],$data[5],$data[6],$data[7],$exp_kirim,$t_updatetime,$pemb,$veri)','".$_SERVER['REMOTE_ADDR']."')";
			mysql_query($sqlIns4);
            }
        }
        else {
...
if($_GET['no_po'] != '' && isset($_GET['no_po'])) {
   ...
   $sql="select no_po from as_po s where month(s.tgl_po)=$th[1] and year(s.tgl_po)=$th[2] order by id desc limit 1";
    $rs1=mysql_query($sql);
...
<html>
                        ...
                        <form name="form1" id="form1" method="post" action="" onSubmit="save()">
                                            ...
                                            <table width="100%" border="0" cellpadding="1" cellspacing="0" align="center">
                                                <tr height="20">
                                                    ...
                                                    <td colspan="2">:
                                                        ...
                                                        <select id="jenis_surat" name="jenis_surat" class='txt' onChange="setp(this.value)">
                                                            <?php
							...
							: 
							  <input type="text" style="text-align:left" name="judul" id="judul" value="<?php echo $judul;?>" class="txt" size='75' />
												...
												<tr height="20">
													<td>Verifikator</td>
													<td>:<input type="text" class="txt" id="veri" name="veri" value="<?php echo $rows1['verifikator']?>"></td>
												</tr>
                                            </table>
                                        </div>
                                            ...
                                            <table id="tblJual" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="bottom">
                                                        <input type="button" style="width:250" value=" Tambah List PO " onClick="addRowToTable();" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
                                                    ...
                                                    <td class="tdisi" align="center">
                                                        ...
                                                        <img alt="tree" width="18" title='Struktur tree kode barang'  style="cursor:pointer" border=0 src="../images/view_tree.gif" align="absbottom" onClick="treebrg(this)">
                                                    </td>
                                                     <td class="tdisi">
                                                    ...
                                                    <input type="text" name="txtunit" id="txtunit" class="txtinput" size="20" onKeyUp="" autocomplete="off" />
                                                        <!--img alt="tree" width="18" title='Struktur tree unit'  style="cursor:pointer" border=0 src="../images/view_tree.gif" align="absbottom" onClick="treeunit(this);"-->
	...
	//	}
        ...
        function treebrg(par){
            ...
            OpenWnd('treebrgPO.php?no='+i,800,500,'msma',true);
            ...
            OpenWnd('treeunitPO.php?no='+i,800,500,'msma',true);
  ...
  cellLeft.appendChild(textNode);
            ...
            if(!isIE){
                ...
                el = document.createElement('<input name="unitid"/>');
            }
            el.type = 'hidden';
            el.value = '';

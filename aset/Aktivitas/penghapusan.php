                            ...
                            <table width="850" border="0" cellspacing="0" cellpadding="0" align="center" class="tabel">
                                <tr style="display: <?php echo $permit;?>">
                                    <td height="30" valign="bottom" align="right">
                                        ...
                                        <img alt="tambah" style="cursor: pointer" src="../images/tambah.png" onClick="location='detailPenghapusan.php?act=add'" />&nbsp;&nbsp;
                                        <img alt="edit" style="cursor: pointer" src="../images/edit.gif" onClick="location='detailPenghapusan.php?act=edit&idperubahan='+document.getElementById('txtId').value" />&nbsp;&nbsp;
                                ...
                                <tr>
                                    <td   nowrap>
                                        <strong>Jenis</strong> ( 301 = Penghapusan | 302 = Transfer Keluar )
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function hapus()
        {
            ...
            if("<?php echo isset($_SESSION['userid']);?>" == true){
                if(confirm("Anda yakin menghapus Data Perubahan "+brg.cellsGetValue(brg.getSelRow(),7)))
                {
                    ...
                    brg.loadURL("utils.php?pilihan=penghapusan&act=hapus_perubahan&rowid="+rowid,"","GET");
                }
            }
            else{
                alert('Session anda habis, silakan login ulang.');
                window.location = "<?php echo $def_loc;?>";
            }
        }
        ...
        function goFilterAndSort(grd)
        {
            ...
            if (grd=="gridbox"){
                ...
                brg.loadURL("utils.php?pilihan=penghapusan&filter="+brg.getFilter()+"&sorting="+brg.getSorting()+"&page="+brg.getPage(),"","GET");
            }
        }

        var brg=new DSGridObject("gridbox");
        brg.setHeader(".: Data Penghapusan :.");
        brg.setColHeader("ID,Unit,Tgl,T/K,Jenis,Kode,Nama Barang,No.Ref,SK,Void");
        ...
        brg.baseURL("utils.php?pilihan=penghapusan");
        brg.Init();
    </script>
</html>

...
if($_GET['id'] != '' && isset($_GET['id']) && $_GET['act'] == 'edit') {
   $sql = "SELECT * FROM as_masuk pe 
    ...
    $qry = "SELECT distinct po.no_po, vendor_id, rek.namarekanan, po.exp_kirim
            ...
            where po.no_po = '".$terima_po[1]."' order by po.tgl_po desc,po.no_po desc";
    $exe=mysql_query($qry);
    ...
    $qry='SELECT distinct po.no_po, vendor_id, rek.namarekanan,po.exp_kirim
            FROM as_po po INNER JOIN as_ms_rekanan rek ON rek.idrekanan = po.vendor_id
            where po.status = 0 order by po.tgl_po desc,po.no_po desc';
    $exe=mysql_query($qry);
    while($show=mysql_fetch_array($exe)) {
        $cmbNoPo .= "<option value='".$show['no_po'].'|'.$show['vendor_id'].'|'.$show['namarekanan'].'|'.$show['exp_kirim']."' ";
                        ...
                        <td colspan="8" align="center">
                            <table id="tblpenerimaan" width="100%" border="0" cellpadding="1" cellspacing="0">
                                <tr class="headtable">
                                  ...
                                  <td id="qty_kemasan" width="300" class="tblheader">
                                    <p>Nama Barang</p></td>
                                  <td id="uraian" width="100" class="tblheader">
                                    <p>Uraian</p></td>
                                  <td id="kemasan" width="78" class="tblheader">Satuan</td>
                                    <td width="84" class="tblheader">Jumlah Pesan</td>
                                     <td width="81" class="tblheader">Jumlah Diterima Sebelumnya</td>
                                  <td width="81" class="tblheader">Jumlah Diterima Sekarang</td>
                                    <td width="100" class="tblheader">Harga Satuan</td>
                                ...
                                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
                                    ...
                                    <td class="tdisi" align="center">
                                    <input id="txtUraian" name="txtUraian" type="text" class="txtcenter" size="10" readonly="readonly" value="<?php echo $uraian; ?>" />                                    </td>
                                    <td class="tdisi" align="center">
                                    <input id="txtSatuan" name="txtSatuan" type="text" class="txtcenter" size="7" readonly="readonly" value="<?php echo $satuan; ?>" />                                    </td>
                                <td class="tdisi" align="center">
                                <input id="txtJmlSatuan" name="txtJmlSatuan" type="text" class="txtcenter" size="7" readonly="readonly" value="<?php echo $qty_satuan; ?>" />                                    </td>
                                <td class="tdisi" align="center">
                                    <input id="txtJmlDiterima" name="txtJmlDiterima" type="text" class="txtcenter" size="7" readonly="readonly" value="<?php echo $qty_terima; ?>" />                                </td>
                                    <td class="tdisi" align="center">
                                        <input id="txtJmlPerKemasan" name="txtJmlPerKemasan" type="text" class="txtcenter" value="<?php echo $qty_kemasan_terima; ?>" onKeyUp="HitungSubTotal(<?php echo ($i-1); ?>);" size="7" />                                    </td>
                                    <td class="tdisi" align="center">
                                    <input id="txtHrgSatuan" size="10" name="txtHrgSatuan" type="text" class="txtright"readonly="readonly" value="<?php echo $harga_satuan; ?>" />                                    </td>
                                    <td class="tdisi" align="center">
                                    <input id="txtSubTotal" size="10" name="txtSubTotal" type="text" class="txtright" readonly="readonly" value="<?php echo $qty_kemasan_terima*$harga_satuan; ?>" />                                    </td>
                                </tr>
                                        <?php

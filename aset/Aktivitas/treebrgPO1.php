    ...
    <body style="border-width:0px;" bgcolor="#CCCCCC" topmargin="0" leftmargin="0" onLoad="javascript:if (window.focus) window.focus();" onBlur="window.close();">
        <div align="center">
            <table border=1 cellspacing=0 width="98%">
                ...
                <tr>
                <td>
						<select id="cmbfilter" name="cmbfilter" onChange="window.location='treebrgPO.php?no=<?=$no;?>&cmb='+this.value;">
		...
		WHERE tipe=$cmb ORDER BY kodebarang";
                        ...
                        while ($rows=mysql_fetch_array($rs)) {
                            ...
                            $arfvalue = $no."*|*".$rows['idbarang']."*|*".$rows['kodebarang']."*|*".$rows['namabarang']."*|*".$rows['idsatuan']."*|*".$rows['harga_beli_satuan'];
                            if ($islast>0)

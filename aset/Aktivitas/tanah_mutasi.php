 	...
 	<td align="center">
		<table width="708" align="center" cellpadding="3" cellspacing="0" class="tabel" >
		 ...
		 <tr>
			...
			<td class="content" width="469">&nbsp;
				...
				<input type="text" id="idUnit_lama" name="idUnit_lama" size="35" readonly value="<?php if($_REQUEST['unitlama']!='') echo $_REQUEST['unitlama']; else echo '-'?>" />    </td>
		</tr>
		<tr>
		 <tr>
			...
			<td class="content">&nbsp;
				<input name="kodeunit" type="text" class="txtunedited" readonly id="kodeunit" tabindex="2" size="15" maxlength="15" />                    
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="footer" align="center" colspan="2">
			  ...
			  <input type="button" id="cencel" name="cencel" value="Cencel" onclick="Lidia()" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
...
//alert('tanah_util.php?act=berubah&idseri='+idseri+'&idunitlama='+idunitlama+'&idunitbaru='+idunitbaru+'&namaperugas='+namapetugas+'&jbtpetugas='+jabatanpetugas+'&catpetugas='+catpetugas+'&tglmutasi='+tglmutasi);
	grid.loadURL('tanah_util.php?act=berubah&idseri='+idseri+'&idunitlama='+idunitlama+'&idunitbaru='+idunitbaru+'&namaperugas='+namapetugas+'&jbtpetugas='+jabatanpetugas+'&catpetugas='+catpetugas+'&tglmutasi='+tglmutasi,'','GET');
	grid.Init();
	document.getElementById('idmutasi').style.display='none';
	document.getElementById('tutup').style.display='block';
	 //window.opener.grid.loadURL('tanah_util.php?kode=true','','GET'); 
	}
} 
function Lidia(){
document.getElementById('idmutasi').style.display='none';

...
?>
                ...
                <tr>
                    <td align="center">
                        <table width="850" border="0" cellspacing="0" cellpadding="0" align="center" class="tabel">
                            ...
                            <tr>
                                <td align="center">
                                    <div id="gridbox" style="width:950px; height:320px; background-color:white; overflow:hidden;"></div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function tampil(){
            //document.write("utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglawal="+document.getElementById('txtTgl').value+"&tglAkhir="+document.getElementById('txtTgl2').value);
            rek.loadURL("utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglAwal="+document.getElementById('txtTgl').value+"&tglAkhir="+document.getElementById('txtTgl2').value,"","GET");
...
//            document.getElementById('harga').value = tmp[5];
            ...
            switch(val){
                case 'btn_act':
                    ...
                    Request(url, 'spanxx', '', 'GET', function(){
                        ...
                        url = 'utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglTagihan='+tgl+'&act='+par.value+'_opname&id='+id+'&qty='+qty+'&harga='+harga+'&barang_id='+barang_id+'&usr_id='+usr_id+'&satuan='+satuan;
                        //alert(url)
                        rek.loadURL(url,'','GET');
                    });
                ...
                /*case 'del':
                    if(confirm("Anda yakin menghapus Stok Opname "+rek.cellsGetValue(rek.getSelRow(),3))){
                        ...
                        var url = "utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglTagihan="+document.getElementById('txtTgl').value+"&act=hapus_opname&id="+id;
                        //alert(url)
                        rek.loadURL(url,"","GET");
                    }
                    break;*/
        ...
        function filter(){
            rek.loadURL("utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglAwal="+document.getElementById('txtTgl').value,"","GET");
        }

        function goFilterAndSort(pilihan){
            if (pilihan=="gridbox")
            {
                rek.loadURL("utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglAwal="+document.getElementById('txtTgl').value+"&tglAkhir="+document.getElementById('txtTgl2').value+"&filter="+rek.getFilter()+"&sorting="+rek.getSorting()+"&page="+rek.getPage(),"","GET");
                //document.write("utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglAwal="+document.getElementById('txtTgl').value+"&tglAkhir="+document.getElementById('txtTgl2').value+"&filter="+rek.getFilter()+"&sorting="+rek.getSorting()+"&page="+rek.getPage());
            }   
        }
        ...
        rek.setIDColHeader(",tglt,no_gd,kodebarang,namabarang,,,namaunit,namalokasi");
        ...
        rek.onLoaded(diLoad);
        rek.baseURL("utils_riwayat_pengeluaran_barang.php?pilihan=pengeluaran&tglAwal="+document.getElementById('txtTgl').value+"&tglAkhir="+document.getElementById('txtTgl2').value);
        rek.Init();
    </script>
</html>

...
m.msk_uraian,m.jml_msk,m.harga_unit,m.jml_msk*m.harga_unit AS subtotal, p.qty_satuan,(p.qty_terima -m.jml_msk) as sudah 
...
while($rwData=mysql_fetch_array($rsData)){
	...
	$pesan[$i] = ifBlankNbsp($rwData['qty_satuan']);
	$terima[$i] = ifBlankNbsp($rwData['sudah']);
...
<html>
    ...
    <body>
        <table width="800" border="0" style="font:12px Verdana, Arial, Helvetica, sans-serif">
            <tr>
                <td colspan="7" style="text-align:center;text-transform:uppercase;font:bold 14px Verdana, Arial, Helvetica, sans-serif;">penerimaan po </td>
            </tr>
            <tr>
                <td colspan="7" >&nbsp;</td>
            </tr>   
            <tr>
                ...
                <td width="1%">:</td>
                <td width="32%"><?php echo $tglTerima;?></td>
                <td width="2%">&nbsp;</td>
                <td width="14%">Supplier</td>
                <td width="1%">:</td>
                <td width="35%"><?php echo $namaSupplier;?></td>
            </tr>
            <tr>
                <td>No Penerimaan</td>
                <td>:</td>
                    ...
                    <table id="tabel" width="100%" border="0" cellpadding="0" cellspacing="0">
                       ...
                       for($k=0;$k<$i;$k++){
                        ...
                        <tr>
							...
							<td><?php echo $pesan[$k];?></td>
							<td><?php echo $terima[$k];?></td>

    ...
    if ($act == "edit") {
        if ($r_idtransaksi!=-1) { // Update Record
            ...
            if (isset($err) && $err != '')
                ...
                if (isset($err) && $err != '') {
                    ...
                    //redirect to perubahan.php
                    echo "<script>window.location = 'perubahan.php';</script>";
                }
            }
        }
        else {
        ...
        if (mysql_affected_rows()>0) {
            ...
            for ($i=1;$i<=$qtytransaksi;$i++) {
                ...
                $query = "insert into as_seri (idtransaksi,noseri,t_userid,t_updatetime,t_ipaddress) values ('$idtransaksi','$i','".$_SESSION['userid']."','now()','".$_SERVER['REMOTE_ADDR']."')";
                $rs = mysql_query($query);
                $err = mysql_error();
                if (isset($err) && $err != '')
                    echo "<script> alert('" . $err . "'); </script>";
                ...
                <table align="center" bgcolor="#FFFBF0" width="1000" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                            ...
                            <table width="753" cellpadding="4" cellspacing="0" align="center">
                                <tr>
                                    <td height="30" colspan="4" valign="bottom" align="right">
                                        <button class="Enabledbutton" id="backbutton" onClick="location='perubahan.php'" title="Back" style="cursor:pointer">
      				...
      				Save Record
                                        ...
                                        <button class="Disabledbutton" id="undobutton" onClick="location='detailPerubahan.php?<?php echo $par;?>'" title="Cancel / Refresh" style="cursor:pointer">
                                    ...
                                    <tr>
                                        ...
                                        <td class='content'>
                                            <select name="tok" class="txt" id="tok" tabindex="5">
                                                <option value="T" <?php if ($rows["tok"]=="T") echo "selected"; ?>>Tambah/Ubah</option>
                                                <option value="K" <?php if ($rows["tok"]=="K") echo "selected"; ?>>Kurang</option>
                                            </select>
                                            <select id="idjenistrans" name="idjenistrans" class="txt">
                                                <option value=""></option>
                                                <?php
                                                $query = "SELECT idjenistrans,keterangan FROM as_ms_jenistransaksi where substring(idjenistrans,1,1)='2'";
                                                $rs = mysql_query($query);
                                ...
                                <table border=0 cellspacing=0 cellpadding="4" class="GridStyle" width="750" bgcolor="#EDF1FE">
                                    ...
                                    <tr>
                                        ...
                                        <td width="493" class='content'>
                                            ...
                                            if ($idperubahan==-1) { ?>
                                            &nbsp;
                                            <img alt="daftar kode barang" title='daftar kode barang' style="cursor:pointer" border=0 src="../images/lookup.gif" align="absbottom" onClick="OpenWnd('lv_barang.php',410,300,'Barang',true)"><!--+document.getElementById('').value-->
                                            <img alt="daftar kode barang 2" title='daftar kode barang 2' style="cursor:pointer" border=0 src="../images/view_list.gif" align="absbottom" onClick="OpenWnd('lv_pickbarang.php',600,300,'Pick Barang',true)"><!--+document.getElementById('').value-->
                                            <img alt="struktur tree kode barang" title='Struktur tree kode barang'  style="cursor:pointer" border=0 src="../images/view_tree.gif" align="absbottom" onClick="OpenWnd('thing_tree.php?<?php echo $barang_opener; ?>',800,500,'msma',true)">
                                                <?php } ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label">Nilai Tambah/Kurang</td>

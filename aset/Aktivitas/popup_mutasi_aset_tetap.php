...
?>
<div id="div_popup" align="center" class="" style="display:none;position:absolute;top:60%;left:43%;width=350px;">
        ...
        <form id="form1" name="form1" action="" method="post">
            <table width="600" border="0" class="" cellpadding="0" cellspacing="0" style="margin-top: 50%; margin-left: 50%">
				...
				<tr>
					...
					<td class="content">&nbsp; <input type="text" id="namalokasi" name="namalokasi" size="35" readonly class="txtunedited" />&nbsp;<img alt="search" title='daftar ruangan' style="cursor:pointer" border=0 src="../images/lookup.gif" align="absbottom" onClick="OpenWnd('tree_lokasi.php?par=idlokasi*kodelokasi*namalokasi',600,500,'Daftar Ruangan',true)" /></td>
				</tr>
                <tr>
    ...
    function todo(act,form,dest)
    {
        ...
        switch(act){
            case 'hapus':
				...
				//alert("utils_seri.php?pilihan="+dest+"&act=hapus_"+dest+"&rowid="+rowid);
            ...
            case 'conf_mutasi':
                ...
                if(idunit_old == idunit){
                    alert("Unit masih sama dengan unit yang lama.");
                    return;
                }

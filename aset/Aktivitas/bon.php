...
?>
            <div>
                <table align="center" bgcolor="#FFFBF0" width="1000" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="center">
                            <table width="910" border="0" cellspacing="0" cellpadding="0" align="center" class="tabel">
                                <tr>
					...
					<button type="button" onClick="reportBon();" style="cursor: pointer">
                            ...
                            Print & Preview
                                        ...
                                        <img alt="tambah" src="../images/tambah.png" style="cursor: pointer" onClick="location='bon_detil_add.php?act=add'" />&nbsp;&nbsp;
					...
					{alert('Pilih dulu BON yang akan diedit.');return;}edit();" />&nbsp;&nbsp;
                                ...
                                <tr>
                                    <td align="center">
                                        <div id="gridbox" style="width:910px; height:300px; background-color:white; overflow:hidden;"></div>
                                        <div id="paging" style="width:910px;"></div>
                                    </td>
                                </tr>
                            </table>
	...
	function reportBon(){	    
        ...
        function edit(){
            ...
            window.location='bon_detil_edit.php?act=edit&no_bon='+document.getElementById('no_bon').value+'&tgl_bon='+document.getElementById('tgl_bon').value+'&tipe='+tipe;
        }
		...
		rek.loadURL("bon_util.php?act=hapus&kode="+kode+"&bln="+bln_bon+"&ta="+thn_bon+"&pilihan=tampil&bln="+document.getElementById('bulan').value+"&ta="+document.getElementById('ta').value,"","GET");
            }
        }
	...
	function balikTgl(tgl){
      ...
      //rek.loadURL("utils.php?pilihan=bon&filter="+rek.getFilter()+"&sorting="+rek.getSorting()+"&page="+rek.getPage()+"&bln="+document.getElementById('bulan').value+"&ta="+document.getElementById('ta').value,"","GET");
        ...
        rek.setColWidth("35,100,150,300,100,100,100");
		...
		//alert("bon_util.php?pilihan=tampil&bln="+document.getElementById('bulan').value+"&ta="+document.getElementById('ta').value);

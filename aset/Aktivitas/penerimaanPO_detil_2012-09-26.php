...
if(isset($_POST['act']) && $_POST['act'] != '') {
    ...
    if($act == 'add') {
		...
		*/
        ...
        header('location:penerimaanPO_detil.php');
    }
    else if($act == 'edit') {
        for($i=0; $i<count($data_submit)-1; $i++) {
            $status_terima = '';
...
if($_GET['id'] != '' && isset($_GET['id']) && $_GET['act'] == 'edit') {
   $sql = "SELECT * FROM as_masuk pe 
	    ...
	    where no_gudang = '".$terima_po[0]."' and no_po = '".$terima_po[1]."' and pe.no_faktur='".$terima_po[2]."'";
                ...
                <form id="form1" name="form1" action="" method="post">
                    ...
                    <tr>
                        ...
                        <td width="18%">&nbsp;:&nbsp;
                            ...
                            ?>                        </td>
                        <td width="8%">&nbsp;</td>
                        <td colspan="5">&nbsp;Tgl PO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo tglSQL($po_rekanan[4]);?>                     </td>
                        <td width="3%">&nbsp;</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                        <td colspan="4">&nbsp;</td>
                        <td align="right"><input type="button" id="barcode" name="barcode" value="Cetak Barcode" onClick="cetakbarcode();"  /></td>
                        <td>&nbsp;</td>
                    </tr>                   
                    <tr>
                        <td colspan="10">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="8" align="center">
                            <table id="tblpenerimaan" width="850" border="0" cellpadding="1" cellspacing="0" style="table-layout:fixed">
                                <tr class="headtable">
                                  ...
                                  <td id="qty_kemasan" width="200" class="tblheader">
                                    <p>Nama Barang</p></td>
                                  <td id="uraian" width="50" class="tblheader">
                                    <p>Uraian</p></td>
                                  <td id="kemasan" width="50" class="tblheader">Satuan</td>
                                    <td width="50" class="tblheader">Jumlah Pesan</td>
                                    <td width="75" class="tblheader">Peruntukan</td>
                                     <td width="75" class="tblheader">Jumlah Diterima Sebelumnya</td>
                                  <td width="75" class="tblheader">Jumlah Diterima Sekarang</td>
                                    <td width="75" class="tblheader">Harga Satuan</td>
                                  <td colspan="2" width="75" class="tblheader" style="">Sub Total</td>
                              </tr>
							  <tr>
							  <td colspan="13">
							  <div id="scrollable">
							  <table cellpadding="0" cellspacing="0" style="table-layout:fixed;" width="850">
                                <?php
                                ...
                                <tr class="itemtableA" onMouseOver="this.className='itemtableAMOver'" onMouseOut="this.className='itemtableA'">
                                    ...
                                    <td width="200" class="tdisi" align="center">                                        
                                        <?php echo $namabarang; ?></td>
                                    <td width="50" class="tdisi" align="center">
                                    <input id="txtUraian" name="txtUraian" type="text" class="txtcenter" size="5" readonly="readonly" value="<?php echo $uraian; ?>" />                                    </td>
                                    <td width="50" class="tdisi" align="center">
                                    <input id="txtSatuan" name="txtSatuan" type="text" class="txtcenter" size="5" readonly="readonly" value="<?php echo $satuan; ?>" />                                    </td>
                                <td width="50" class="tdisi" align="center">
                                <input id="txtJmlSatuan" name="txtJmlSatuan" type="text" class="txtcenter" size="5" readonly="readonly" value="<?php echo $qty_satuan; ?>" />                                    </td>
                                 <td width="75" class="tdisi" align="center">
                                <input id="unit" name="unit" type="text" class="txtcenter" size="8" readonly="readonly" value="<?php echo $namaunit; ?>" />                                    </td>
                                <td width="75" class="tdisi" align="center">
                                    <input id="txtJmlDiterima" name="txtJmlDiterima" type="text" class="txtcenter" size="8" readonly="readonly" value="<?php echo $qty_terima; ?>" />                                </td>
                                    <td width="75" class="tdisi" align="center">
                                        <input id="txtJmlPerKemasan" name="txtJmlPerKemasan" type="text" class="txtcenter" value="<?php echo $qty_kemasan_terima; ?>" onKeyUp="HitungSubTotal(<?php echo ($i-1); ?>);" size="8" />                                    </td>
                                    <td width="75" class="tdisi" align="center">
                                    <input id="txtHrgSatuan" size="8" name="txtHrgSatuan" type="text" class="txtright"readonly="readonly" value="<?php echo $harga_satuan; ?>" />                                    </td>
                                    <td colspan="2" width="75" class="tdisi" align="center">
                                    <input id="txtSubTotal" size="12" name="txtSubTotal" type="text" class="txtright" readonly="readonly" value="<?php echo $qty_kemasan_terima*$harga_satuan; ?>" />                                    </td>
            ...
            if(document.forms[0].chkItem.length){
                for(var i=0; i<document.forms[0].chkItem.length; i++){
                    data_submit += document.forms[0].chkItem[i].value+'*-*'+document.forms[0].chkItem[i].checked
                        ...
                        +'*-*'+document.forms[0].txtJmlDiterima[i].value

...
<body>
 <div id="popList" style="display:none; border:5px solid #6699CC; background-color:white;width:900; height:300" align="center"><br />
...
<tr>
	<td>&nbsp;</td>
	<td><center><div id="divbarang" align="center" style="z-index:1; width: 751px; left: 419px; top: 588px; height: 300px; overflow: scroll; border:1px solid; display:none; background-color: #CCCCCC; layer-background-color: #CCCCCC;"></div></center><!--button type="button" id="pilih" name="pilih" style="cursor:pointer" onclick="bla()">Pilih</button--></td>
</tr>
</table>
</div>
</body>

 ...
 *  */ 
if (!isset($request_data['tanggalperiksa']) || !isset($request_data['kodepoli']) || !isset($request_data['polieksekutif'])) {
    http_response_code(401);
    echo json_encode([
        "metadata" => [
...
$response = $antrean_model->get_rekap_antrean($kodepoli, $tanggalperiksa, $polieksekutif);

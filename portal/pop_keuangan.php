...
?>
<div id="popup_keuangan" class="popup" style="width:500px;display:none;">
    ...
    <br>
        <fieldset>
            <legend style="font:bold 12px tahoma; color: #003366;">Login Modul Keuangan </legend>
           <form action="keuangan/user_login.php" method="post" id="frmLogin" name="login" onSubmit="return GoSubmit3();">
<table width="354" border="0" style="margin:20px; font:bold 12px tahoma; color:#000000;">
	<tr>
		<td width="115">Login</td>
		<td width="227"><input name="username" id="username_k" type="text" class="login_text" size="30"  />
<!-- onKeyUp="KeyEvent(event,this);"-->		</td>
	</tr>
	<tr>
		<td>Password</td>
		<td><input name="password" id="password_k" type="password" class="login_text" size="30" />
<!-- onKeyUp="KeyEvent(event,this);"-->		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
...
function GoSubmit3()
{
	if (document.getElementById("username_k").value==""){
		alert("Isikan Username Anda Terlebih Dahulu !");
		document.getElementById("username_k").focus();
		return false;
	}
	else if (document.getElementById("password_k").value==""){

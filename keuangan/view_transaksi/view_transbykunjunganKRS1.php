...
$userId=$_SESSION['id'];
$tipe = $_REQUEST['tipe'];
$pLegend = "View Transaksi -> Kunjungan Pasien -> Kunjungan Sudah Pulang (KRS)";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#808080" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="loadUlang();"><!-- onload="viewTime()"-->
                    ...
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="35" id="trKSO">
                                <td colspan="2" align="center">DATA TRANSAKSI KUNJUNGAN PASIEN (SUDAH PULANG / KRS)</td>
                            </tr>
                            <tr height="25" id="trKSO">
                                <td>Nama KSO</td>
                                <td>:&nbsp;
                                    <select id="cmbKso" name="cmbKso" onchange="filter()" class="txtinput"></select>
                                </td>
                            </tr>
							<tr>
                                <td>Periode</td>
                ...
                <tr id="trPen">
                    <td align="center" ><br>
                        ...
                        <fieldset style="width:980px">
                            <div id="gridbox" style="width:980px; height:330px; background-color:white; overflow:hidden;"></div>
        ...
        <div id="divPop" class="popup" style="width:910px;height:400px;display:none;">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <div id="gridbox_pop" style="width:900px; height:345px; background-color:white; "></div>
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            var url = "view_transbykunjunganKRS_utils.php?grid=1&ksoId="+kso+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            //alert(url);
			var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
			var timeFil = document.getElementById('cmbTime').value;
            var kso = document.getElementById('cmbKso').value;
            var url = "view_transbykunjunganKRS_utils.php?grid=1&ksoId="+kso+"&pil=1";
            //alert(url)
			var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function ambilData(){
			...
			var url;
			kunj_id = sisip[0];
			url = "view_transbykunjunganKRS_utils.php?grid=2&kunj_id="+sisip[0]+"&ksoId="+sisip[1];
			//alert(url);
            b.loadURL(url,'','GET');
        ...
        function count_tot_detail(key,val){
            if (val!=undefined){
                var tmp36 = val.split(String.fromCharCode(3));
				b.cellSubTotalSetValue(6,tmp36[0]);
				b.cellSubTotalSetValue(7,tmp36[1]);
				b.cellSubTotalSetValue(8,tmp36[2]);
				b.cellSubTotalSetValue(9,tmp36[3]);
				b.cellSubTotalSetValue(10,tmp36[4]);
            }
            else if(b.getRowId(b.getSelRow())==''){
				b.cellSubTotalSetValue(6,0);
		...
		a.setColHeader("NO,TANGGAL KUNJUNGAN,NO RM,NAMA,KSO,UNIT AWAL MASUK,TARIF PERDA,BIAYA PASIEN,TARIF KSO,IUR BAYAR,SELISIH");
		a.setSubTotal(",,,,,SubTotal :&nbsp;,0,0,0,0,0");
		a.setIDColHeader(",tgl,no_rm,nama,nmkso,unit_awal,,,,,");
		a.setColWidth("30,70,60,150,120,120,70,70,70,70,70");
		a.setCellAlign("center,center,center,left,center,center,right,right,right,right,right");
		a.setSubTotalAlign("center,center,center,left,center,right,right,right,right,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        a.setIDPaging("paging");
        a.attachEvent("onRowDblClick","ambilData");
        a.onLoaded(count_tot);
		a.baseURL("view_transbykunjunganKRS_utils.php?grid=1&ksoId="+ksoId);
        a.Init();

        var b=new DSGridObject("gridbox_pop");
        b.setHeader("DETAIL TRANSAKSI KUNJUNGAN PASIEN");
		b.setColHeader("NO,TGL TINDAKAN,TEMPAT LAYANAN,TINDAKAN / OBAT,PELAKSANA,TARIF PERDA,BIAYA PASIEN,TARIF KSO,IUR BAYAR,SELISIH");
		b.setSubTotal(",,,,SubTotal :&nbsp;,0,0,0,0,0");
		b.setIDColHeader(",tgl,unit,nmTind,dokter,,,,,");
		b.setColWidth("30,70,150,200,150,70,70,70,70,70");
		b.setCellAlign("center,center,left,left,left,right,right,right,right,right");
		b.setSubTotalAlign("center,center,center,left,right,right,right,right,right,right");
        b.setCellHeight(20);
        b.setImgPath("../icon");
        b.setIDPaging("paging_pop");
        b.onLoaded(count_tot_detail);
        b.baseURL("view_transbykunjunganKRS_utils.php?grid=2&kunj_id=0&ksoId=0");
        b.Init();

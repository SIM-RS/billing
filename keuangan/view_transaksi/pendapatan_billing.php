...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            var url = "pendapatan_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
            ...
            timeFil = document.getElementById('cmbTime').value;
            kso = document.getElementById('cmbKso').value;
            var url = "pendapatan_utils.php?grid="+par+"&tipePend=0&tipe=<?php echo $tipe;?>";
            if(par == 1){
                url += "&kso="+kso;
            }
            else{
        ...
        var first_time = true;
        function fill_unit(){
            isiCombo('cmbTmpLay',document.getElementById('cmbJnsLay').value,'','cmbTmpLay',first_time==true?viewTime:filter);
        ...
        if("<?php echo $tipe;?>" == "4"){
            ...
            a.setColWidth("30,70,70,60,150,120,120,70,70,70,70,70");
            ...
            a.setColWidth("30,70,70,60,150,150,70,70,70,70,70");
            a.setCellAlign("center,center,center,center,left,center,right,right,right,right,right");
		...
		a.baseURL("pendapatan_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
		//alert("pendapatan_utils.php?grid=1&tipe=<?php echo $tipe;?>&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
        a.Init();
        ...
        b.baseURL("pendapatan_utils.php?grid=2&tipe=<?php echo $tipe;?>&tipePend=0&kunjungan_id=0&waktu=");
        b.Init();

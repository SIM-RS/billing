...
<html xmlns="http://www.w3.org/1999/xhtml">
                    ...
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="30" id="trKSO">
                                <td>Suplplier Obat </td>
                                <td>:&nbsp;
                                    <select id="cmbSup" name="cmbSup" onchange="filter()" class="txtinputreg"></select>
                                </td>
                            </tr>
                            <tr>
                                <td>Waktu</td>
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            kso = document.getElementById('cmbSup').value;
            var url = "pembelian_obat_utils.php?tipe=<?php echo $_REQUEST['tipe'];?>";
            if(grd == 'gridbox'){
        ...
        var kso = document.getElementById('cmbSup').value;
        var a=new DSGridObject("gridbox");
        a.setHeader("PEMBELIAN OBAT FARMASI");
        a.setColHeader("NO,TANGGAL,PBF,NO PENRIMAAN,NO FAKTUR,SUB TOTAL,DISKON,PPN,TOTAL");
        a.setIDColHeader(",TANGGAL,NOTERIMA,PBF_NAAMA,nobukti,subtotal,total_diskon,ppn,total");
        a.setColWidth("30,100,200,170,170,80,80,80,80");
        a.setCellAlign("center,center,center,center,center,right,center,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        a.setIDPaging("paging");
        a.attachEvent("onRowDblClick","ambilData");
        a.onLoaded(count_tot);
        a.baseURL("pembelian_obat_utils.php?grid=1&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
        a.Init();
        ...
        b.baseURL("pembelian_obat_utils.php?grid=2&tipe=<?php echo $_REQUEST['tipe'];?>&kunjungan_id=0&waktu=");
        b.Init();

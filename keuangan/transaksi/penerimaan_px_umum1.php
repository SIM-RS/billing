...
<html xmlns="http://www.w3.org/1999/xhtml">
                    ...
                    <td valign="top" align="center">
                        <table width="550" border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="30" id="trKSO">
                                <td style="padding-left:120px;">Penerimaan</td>
                                <td>:&nbsp;<?php echo strtoupper($caption);?> - Pasien Umum</td>
                            </tr>
                            <tr style="display:none">
                                <td style="padding-left:120px">Waktu</td>
                                <td>:&nbsp;
                            ...
                            <tr id="trDay">
                                <td style="padding-left:120px;">Tanggal</td>
                                <td>:&nbsp;
                            ...
                            <tr id="trPer" style="display:none">
                                <td style="padding-left:120px">Periode</td>
                                <td>:&nbsp;
                        ...
                        <fieldset style="width:900px">
                            ...
                            <div align="left" style="padding-right:100px;">
                                <table>
                                    <tr>
                                        <td>
                                            Total Tarif Perda                                        </td>
                                        <td>
                                            : <span id="span_tot1" style="margin-left:20px;float:right;">&nbsp;</span>                                        </td>
                                        <td style="padding-left:20px;">
                                            Total Penerimaan Pasien                                        </td>
                                        <td>
                                            : <span id="span_tot2" style="margin-left:20px;float:right;">&nbsp;</span>                                        </td>
                                        <td style="padding-left:20px;"> Selisih Penerimaan </td>
                                        <td> : <span id="span_sel" style="margin-left:20px;float:right;">&nbsp;</span> </td>
                                    </tr>
                                </table>
                        <br />
                                <!--p align="center"><BUTTON type="button" onClick="ExportExcell();"><IMG SRC="../icon/addcommentButton.jpg" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Export ke File Excell</BUTTON></p-->
                            </div>
                            </fieldset>
                    </td>
                </tr>
    ...
    <script type="text/JavaScript" language="JavaScript">
		var kso = 1;
		var url="penerimaan_utils.php?grid=1&tipe=<?php echo $tipe;?>&kso=1&waktu=harian&txtTgl=0000-00-00&jenis_layanan=0&unit_id=0&inap=0";
        var a=new DSGridObject("gridbox");
        a.setHeader("PENERIMAAN <?php echo $caption;?> - PASIEN UMUM");
		a.setColHeader("NO,TANGGAL KUNJUNGAN,TANGGAL PULANG,NO RM,NAMA,TEMPAT LAYANAN,TARIF PERDA,PENERIMAAN PASIEN,SELISIH");
		a.setIDColHeader(",tgl,tgl_p,no_rm,pasien,unit,,,");
		a.setColWidth("30,80,80,70,200,270,70,70,70");
		a.setCellAlign("center,center,center,center,left,left,right,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        ...
        b.setHeader("PENERIMAAN <?php echo $caption;?> - PASIEN UMUM");
		b.setColHeader("NO,TGL TINDAKAN,TEMPAT LAYANAN,TINDAKAN,PELAKSANA,TARIF PERDA,PENERIMAAN PASIEN,SELISIH");
		b.setIDColHeader(",tgl,nama,,,,,,,,,,");
		b.setColWidth("30,80,150,200,150,70,70,70");
		b.setCellAlign("center,center,left,left,left,right,right,right");
        b.setCellHeight(20);
        b.setImgPath("../icon");
        b.setIDPaging("paging_pop");
        //b.onLoaded(konfirmasi);
        b.baseURL("penerimaan_utils.php?grid=2&tipe=<?php echo $tipe;?>&kunjungan_id=0&waktu=");
        b.Init();
		...
		function ExportExcell(){
			//alert('../laporan/rpt_pendapatan_excell.php?tgl_d='+document.getElementById('txtTgl').value+'&tipe=<?php echo $tipe; ?>&kso='+document.getElementById('cmbKso').value+'&kson='+document.getElementById('cmbKso').options[document.getElementById('cmbKso').options.selectedIndex].label+'&jenis_layanan='+document.getElementById('cmbJnsLay').value+'&unit_id='+document.getElementById('cmbTmpLay').value+'&inap='+document.getElementById('cmbTmpLay').options[document.getElementById('cmbTmpLay').options.selectedIndex].lang+'&unitN='+document.getElementById('cmbTmpLay').options[document.getElementById('cmbTmpLay').options.selectedIndex].label+'&jenis_layananN='+document.getElementById('cmbJnsLay').options[document.getElementById('cmbJnsLay').options.selectedIndex].label);
			OpenWnd('../laporan/rpt_pendapatan_excell.php?tgl_d='+document.getElementById('txtTgl').value+'&tipe=<?php echo $tipe; ?>&kso=1&kson=UMUM&jenis_layanan='+document.getElementById('cmbJnsLay').value+'&unit_id='+document.getElementById('cmbTmpLay').value+'&inap='+document.getElementById('cmbTmpLay').options[document.getElementById('cmbTmpLay').options.selectedIndex].lang+'&unitN='+document.getElementById('cmbTmpLay').options[document.getElementById('cmbTmpLay').options.selectedIndex].label+'&jenis_layananN='+document.getElementById('cmbJnsLay').options[document.getElementById('cmbJnsLay').options.selectedIndex].label,600,450,'childwnd',true);
		}
        ...
        function goFilterAndSort(grd){
            ...
            kso = 1;
            var url = "penerimaan_utils.php?grid=1&tipe=<?php echo $tipe;?>&kso="+kso+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
			...
			var url = "penerimaan_utils.php?grid="+par+"&tipe=<?php echo $tipe;?>";
            if(par == 1){
                url += "&kso="+kso;
            }
            else{
        ...
        function count_tot(key,val){
            ...
            if(a.getRowId(a.getSelRow())!=''){
                ...
                document.getElementById('span_sel').innerHTML = FormatNumberFloor(tot1*1-(tot2*1),'.');
            }
            else{
                document.getElementById('span_tot1').innerHTML = document.getElementById('span_tot2').innerHTML = document.getElementById('span_sel').innerHTML = 0;
            }
        }

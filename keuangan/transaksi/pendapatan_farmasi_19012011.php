...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        a.setColHeader("NO,UNIT,No KW,No RM,NAMA,TEMPAT LAYANAN,DOKTER,JUAL,RETURN,BAYAR");
        a.setIDColHeader(",unit_name,no_penjualan,no_pasien,nama_pasien,unit,dokter,,,");
        a.setColWidth("30,100,80,80,200,200,150,70,70,70");
        a.setCellAlign("center,left,center,center,left,left,left,right,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        ...
        b.setColHeader("NO,NAMA OBAT,QTY,NILAI,SUB TOTAL,BAYAR");
        b.setIDColHeader(",obat_nama,,,,");
        b.setColWidth("30,200,30,80,80,80");
        b.setCellAlign("center,LEFT,center,80,right,right");
        b.setCellHeight(20);
        b.setImgPath("../icon");

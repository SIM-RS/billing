...
if($statusProses=='Error') {
    ...
    if($grid == 1 || $tipe == 'lain2') {
        if($tipe == 'lain2') {
            ...
            while ($rows=mysql_fetch_array($rs)) {
			 ...
			 if($tipe != 4){
                ...
                $dt.=$rows["id"].'|'.$rows['pelayanan_id'].chr(3).number_format($i,0,",","").chr(3).$rows["tgl"].chr(3).$rows["no_rm"].chr(3).$rows["pasien"].chr(3).$tmpLay.chr(3).$rows["biayaRS"].chr(3).$rows["biaya_kso"].chr(3).$rows["biaya_pasien"].chr(3).($rows["biayaRS"]-($rows["biaya_kso"]+$rows["biaya_pasien"])).chr(3).$rows["bayar_kso"].chr(3).$rows["bayar_pasien"].chr(6);
                $tmpLay = '';
            }
        }
    }
        ...
        while ($rows=mysql_fetch_array($rs)) {
            $i++;
            $dt .= $rows["id"].chr(3).number_format($i,0,",","").chr(3).$rows["tgl"].chr(3).$rows["unit"].chr(3).$rows["tindakan"].chr(3).$rows["dokter"].chr(3).$rows["biayaRS"].chr(3).$rows["biaya_kso"].chr(3).$rows["biaya_pasien"].chr(3).($rows["biayaRS"]-($rows["biaya_kso"]+$rows["biaya_pasien"])).chr(3).$rows["bayar_kso"].chr(3).$rows["bayar_pasien"].chr(6);
        }
    }

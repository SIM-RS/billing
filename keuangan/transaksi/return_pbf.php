...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        a.setHeader("RETURN PBF");
        a.setColHeader("NO,PBF,NO BUKTI,NAMA OBAT,QTY,NILAI");
        a.setIDColHeader(",pbf,nobukti,nama,,");
        a.setColWidth("30,150,80,100,30,70");
        a.setCellAlign("center,left,center,left,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");

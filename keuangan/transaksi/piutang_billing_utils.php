						...
						$sqlPiutang="SELECT
										...
										SELECT DISTINCT *
										   FROM (SELECT
											   ...
											   p.unit_id,
											   t.kso_id,
											   IF(t.status_out=0,(IF(DATEDIFF(IFNULL(t.tgl_out,NOW()),t.tgl_in)=0,1,DATEDIFF(IFNULL(t.tgl_out,NOW()),t.tgl_in)))*t.beban_kso, (IF(DATEDIFF(IFNULL(t.tgl_out,NOW()),t.tgl_in)=0,0,DATEDIFF(IFNULL(t.tgl_out,NOW()),t.tgl_in)))*t.tarip)    biayaRS,

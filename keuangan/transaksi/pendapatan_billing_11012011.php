    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function count_tot(){
            if(a.getRowId(a.getSelRow())!=''){
                ...
                document.getElementById('span_tot1').innerHTML = document.getElementById('span_tot2').innerHTML = document.getElementById('span_tot3').innerHTML = 0;
            }
        }
        ...
        a.setColHeader("NO,TANGGAL KUNJUNGAN,NO RM,NAMA,TEMPAT LAYANAN,TARIF PERDA,BIAYA KSO,BIAYA PASIEN,PEMBAYARAN KSO,PEMBAYARAN PASIEN");
        a.setIDColHeader(",no_rm,tgl,pasien,unit,,,,,");
        a.setColWidth("30,80,70,200,270,70,70,70,70,70");
        a.setCellAlign("center,center,center,left,left,right,right,right,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        ...
        b.setColHeader("NO,TGL TINDAKAN,TEMPAT LAYANAN,TINDAKAN,PELAKSANA,TARIF PERDA,BIAYA KSO,BIAYA PASIEN,PEMBAYARAN KSO,PEMBAYARAN PASIEN");

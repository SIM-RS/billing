...
//===============================
	...
	*/
	...
	WHERE jenis_transaksi.JTRANS_KODE LIKE '$jtrans_kode%' AND ma_sak.MA_KODE NOT LIKE '1%'
	...
	while ($rows=mysql_fetch_array($rs)) {
		...
		$sisip = $id_ak_ms_unit;
		$i++;
		$nilai = "<input type='text' id='nilai_$id_ak_ms_unit' lang='$idparent_ak_ms_unit*$id_ak_ms_unit*$id_ma_sak' size='22' style='text-align:right' onkeyup='zxc(this);setSubTotal()' />";

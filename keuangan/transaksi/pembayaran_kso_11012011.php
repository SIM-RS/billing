...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            url += "&bln="+bln+"&thn="+thn;
            //url += "&waktu="+timeFil+"&bln="+bln+"&thn="+thn;
            //alert("pk_utils.php?filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage());
            a.loadURL(url,"","GET");
        }
        ...
        a.setHeader("PEMBAYARAN KSO <?php echo $caption;?>");
        a.setColHeader("NO,TANGGAL KUNJUNGAN,NAMA,TEMPAT LAYANAN,SUDAH BAYAR,TARIF PERDA,BIAYA KSO,BIAYA PASIEN,PEMBAYARAN KSO,PEMBAYARAN PASIEN");
        a.setIDColHeader(",tgl,pasien,nama,bayar,,,,,");
        a.setColWidth("30,80,200,270,50,70,70,70,70,70");
        a.setCellAlign("center,center,left,left,center,right,right,right,right,right");
		a.setCellType("txt,txt,txt,txt,txt,txt,txt,txt,txtbox,txt");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        ...
        b.setHeader("DETAIL PEMBAYARAN KSO <?php echo $caption;?>");

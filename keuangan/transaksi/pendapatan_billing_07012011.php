...
$userId=$_SESSION['id'];
$tipe = $_REQUEST['tipe'];
$caption = ($tipe==1)?'RAWAT JALAN':(($tipe==2)?'RAWAT INAP':'IGD')
        ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            var url = "pendapatan_utils.php?grid=1&tipe=<?php echo $_REQUEST['tipe'];?>&kso="+kso+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
            ...
            timeFil = document.getElementById('cmbTime').value;
            kso = document.getElementById('cmbKso').value;
            var url = "pendapatan_utils.php?grid="+par+"&tipe=<?php echo $_REQUEST['tipe'];?>";
            if(par == 1){
                url += "&kso="+kso;
            }
            else{
        ...
        a.setColHeader("NO,TANGGAL KUNJUNGAN,NAMA,TEMPAT LAYANAN,TARIF PERDA,BIAYA KSO,BIAYA PASIEN,PEMBAYARAN KSO,PEMBAYARAN PASIEN");
        a.setIDColHeader(",tgl,pasien,unit,,,,,");
        a.setColWidth("30,80,200,270,70,70,70,70,70");
        a.setCellAlign("center,center,left,left,right,right,right,right,right");
        a.setCellHeight(20);
        a.setImgPath("../icon");
        a.setIDPaging("paging");
        a.attachEvent("onRowDblClick","ambilData");
        //a.onLoaded(konfirmasi);
        a.baseURL("pendapatan_utils.php?grid=1&tipe=<?php echo $_REQUEST['tipe'];?>&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
        a.Init();


        var b=new DSGridObject("gridbox_pop");
        b.setHeader("PENDAPATAN <?php echo $caption;?>");
        b.setColHeader("NO,TGL TINDAKAN,TEMPAT LAYANAN,TINDAKAN,QTY,PELAKSANA,TARIF PERDA,BIAYA KSO,BIAYA PASIEN,PEMBAYARAN KSO,PEMBAYARAN PASIEN");
        ...
        b.baseURL("pendapatan_utils.php?grid=2&tipe=<?php echo $_REQUEST['tipe'];?>&kunjungan_id=0&waktu=");
        b.Init();

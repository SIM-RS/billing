...
<html>
    ...
    <body bgcolor="#808080" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#EAEFF3">
                ...
                <tr>
                    <td style="padding-left:20px;font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">
                        ...
                        <span style="padding-left:350px"><button id="btnBayarPajak" name="btnBayarPajak" type="button" class="tblBtn" onclick="bayarPajak()" disabled="disabled" style="display:none;">&nbsp;&nbsp;Bayar Pajak + Posting&nbsp;&nbsp;</button>&nbsp;&nbsp;<button id="btnBayar" name="btnBayar" type="button" disabled="disabled" class="tblBtn" onclick="bayar()">&nbsp;&nbsp;Bayar + Posting Akuntansi&nbsp;&nbsp;</button></span>
                    </td>
                </tr>
                <tr id="trGrid">
                    <td valign="top" align="center">
        ...
        <div id="divPop" class="popup" style="width:450px;height:190px;display:none;">
            <fieldset>
        ...
        function grid_act(){
		  ...
		  */
		  //no,tgl,nobukti,jenis trans,nilai,keterangan
			...
			document.getElementById('txtArea').value = grid.cellsGetValue(grid.getSelRow(),7);

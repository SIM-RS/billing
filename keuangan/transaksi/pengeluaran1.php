            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#EAEFF3">
                        ...
                        <table width="750" border="0" cellpadding="1" cellspacing="1" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold">
                            ...
                            <tr id='trForm1' height="40">
                                ...
                                <td>:&nbsp;
                                    ...
                                    <input type="text" id="nilai" name="nilai" size="14" onkeyup="zxc(this)" style="text-align:right;" class="txtinput"/> &nbsp;<img id="imgNilai" src="../icon/calculator_red.png" align="absmiddle" width="25" style="cursor:pointer;display:none;" onclick="popup1()" /></td>
                            </tr>
                            <tr id='trFak'>
                ...
                <tr>
                    <td style="padding-left:20px;font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">
                        ...
                        <span style="padding-left:450px"><button id="btnBayarPajak" name="btnBayarPajak" type="button" class="tblBtn" onclick="bayarPajak()" disabled="disabled" style="display:none;">&nbsp;&nbsp;Bayar Pajak + Posting&nbsp;&nbsp;</button>&nbsp;&nbsp;<button id="btnBayar" name="btnBayar" type="button" class="tblBtn" onclick="bayar()">&nbsp;&nbsp;Verifikasi&nbsp;&nbsp;</button></span>
                    </td>
                </tr>
                <tr id="trGrid">
                    <td valign="top" align="center">

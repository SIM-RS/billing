...
<html>
    ...
    <input type="hidden" id="id_ret" />
	<table width="1000" border="0" cellpadding="0" style="background:#EAEFF3;" cellspacing="0" align="center">
                <tr>
                	<td>&nbsp;</td>
                </tr>
                <tr>
                	<td align="center" colspan="2" style="font-size:16px"><b>Retur Pembayaran</b></td>
                </tr>
                <tr>
                	<td>&nbsp;</td>
                </tr>
                ...
                <tr>
					...
					<div id="gridReturn" style="width: 980px; height:430px; border:none; display:block"></div>
       ...
       <div id="form_return" style="display:block" align="center">     
            <table width="1000" border="0" cellspacing="0" cellpadding="0" class="txtinput1" bgcolor="#EAEFF3" align="center" height="450">
            	<tr>
                	<td>&nbsp;</td>
                </tr>
                <tr>
                	<td align="center" colspan="2" style="font-size:16px" id="jdlForm"><b>Input Retur Pelayanan</b></td>
                </tr>
                <tr>
                	<td align="right">&nbsp;</td>
                </tr>
                <tr>
                    <td valign="top" height="50" style="background-color:#EAEFF3; padding-left:20px; padding-right:20px;">
                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px; font-family:verdana;">
                            <tr>
                            <td>No RM</td><td> : </td><td colspan="3"><input type="text" tabindex="1" size="9" id="txtNoRm" name="txtNoRm" class="txtinput" onKeyUp="listPasien(event,'show',this.value)" value=""/></td>
                            ...
                            <!--td>&nbsp;</td><td>&nbsp;</td--><td><select id="cmbJnsRwt" name="cmbJnsRwt" disabled="disabled" onChange="setPasien(document.getElementById('txtVal').value);" class="txtinput" style="display:none;">
                                <option value="0">Semua</option>
                                <option value="1">Rawat Jalan</option>
                                <option value="3">Rawat Inap</option>
                                <option value="2">Darurat</option>
                            ...
                            <tr>
                            	<td rowspan="2" align="left">Tgl Kunjungan</td>
                ...
                <tr>
                    <td valign="top" style="padding-left:20px; padding-right:20px;">
                        <fieldset class="filed">
                        	<legend>Data Pembayaran
                            <input type="button" size="3" id="btnShowTinDown" value="&or;" style="display:none;cursor:pointer;" />
                            ...
                            <div id="divTableTindakan" align="center" style="overflow:auto;height:230px;">
                                <div id="gb" style="width: 900px; height:200px; border:none; display:block"></div>
                ...
                <tr>                              
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                    	<tr>
                            ...
                            <td>&nbsp;</td>
                            <td rowspan="2" align="right" style="padding-right:20px;"><!--button type="button" onClick="cetakReturn()" style="cursor:pointer"><img src="../icon/printer.png" width="20" align="absmiddle" title="Klik Untuk Cetak Kuitansi Retur">&nbsp;Cetak Retur</button-->&nbsp;
                   		...
                   		<tr>
                            ...
                            <td>: <input id="txtTglReturn" name="txtTglReturn" size="10" class="txtcenter" value="<?php echo $date_now;?>"/>
                                    <img alt="tanggal retur" id="tglR" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/simrs/billing/icon/archive1.gif" onClick="gfPop.fPopCalendar(document.getElementById('txtTglReturn'),depRange,zxc);" style="cursor: pointer"/></td>
                            <td>&nbsp;</td>                       
                        </tr>
                    </table>
                    </td>
            ...
            <script>
                ...
                function setPasien(val){
                   ...
                   // Request('koreksi_utils.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&tabel=pelayanan'+'&jnsRwt='+jnsRwt,'divPelayanan','','GET',afterPel,'ok');
					...
					//alert('r_pembayaran_util.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt);
					gg.loadURL('r_pembayaran_util.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt,'','GET');
					//alert('return_pembayaran_util.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt+'&tanggal='+document.getElementById('txtTglReturn').value);
					ggr.loadURL('return_pembayaran_util.php?idPasien='+dataPasien[0]+'&idKunj='+dataPasien[8]+'&jnsRwt='+jnsRwt+'&tanggal='+document.getElementById('txtTglReturn').value,'','GET');
...
function cekAll(){
	for(var i=1; i<=gg.getMaxRow(); i++ ){
		...
		if(document.getElementById('chk').checked)
			...
			document.getElementById('chk_'+id).checked = '';
	}
}
...
function cekAllr(){
	for(var i=1; i<=ggr.getMaxRow(); i++ ){
		...
		if(document.getElementById('chkr').checked)
			document.getElementById('chkr_'+id).checked = 'true';
		else
			document.getElementById('chkr_'+id).checked = '';
	}
}
...
gg.setHeader("DATA PEMBAYARAN",false);
gg.setColHeader("<input type='checkbox' id='chk' onchange='cekAll()' />,No Kwitansi,Tgl Bayar,Tgl Disetor,Nama Kasir,Nilai Pembayaran,Nilai Retur");
//g.setIDColHeader(",kode,nama,ket,");
gg.setColWidth("40,130,90,90,200,120,120");
gg.setCellAlign("center,center,center,center,left,right,center");
gg.setCellType("txt,txt,txt,txt,txt,txt,txt");
gg.setCellHeight(20);
gg.setImgPath("../icon");
gg.setIDPaging("pg");
gg.attachEvent("onRowClick","ambilTind");
gg.baseURL("r_pembayaran_util.php");
gg.Init();

var ggr = new DSGridObject("gbr");
ggr.setHeader("DATA PEMBAYARAN YANG DIRETUR",false);
ggr.setColHeader("<input type='checkbox' id='chkr' onchange='cekAllr()'/>,No Retur,Tgl Bayar,Tgl Retur,Nama Kasir,Petugas Retur,Nilai Retur,Cetak");
//g.setIDColHeader(",kode,nama,ket,");
ggr.setColWidth("40,130,90,90,160,160,100,50");
ggr.setCellAlign("center,center,center,center,left,left,right,center");
ggr.setCellType("txt,txt,txt,txt,txt,txt,txt,txt");
ggr.setCellHeight(20);
ggr.setImgPath("../icon");
ggr.setIDPaging("pgr");
ggr.attachEvent("onRowClick","ambilTind");
ggr.baseURL("return_pembayaran_util.php");
ggr.Init();
...
function editTindakan(){
	...
	alert('success');
	gg.loadURL('r_pembayaran_util.php?idPasien='+document.getElementById('txtIdPasien').value+'&idKunj='+document.getElementById('txtKunjId').value+'&jnsRwt='+document.getElementById('cmbJnsRwt').value,'','GET');
}
...
function prosesReturn(){
	var fdata = '';
	var proses = false;
	var temp,nreturBayar;
	for(var i=1;i<=gg.getMaxRow();i++){
		temp = gg.getRowId(i);
		//var idBayarTin = temp.split('|');
		if(document.getElementById('chk_'+temp)!=null){
			if(document.getElementById('chk_'+temp).checked){
				nreturBayar=document.getElementById('nilai_'+i).value;
				while (nreturBayar.indexOf('.')>0){
					nreturBayar=nreturBayar.replace('.','');
				}
				while (nreturBayar.indexOf(',')>0){
					nreturBayar=nreturBayar.replace(',','.');
				}
				
				fdata += temp+"*"+nreturBayar+"|";
				proses = true;
			}
		}
	}
	...
	if(proses==false){
		alert('Pilih Pembayaran Yang Ingin Diretur');
		return false;
	}
	var no_return = document.getElementById('no_return').value;
	var tgl_return = document.getElementById('txtTglReturn').value;
	//alert("proses_retur_pembayaran.php?retur=ya&no_return="+no_return+"&fdata="+fdata+"&tgl_return="+tgl_return+"&userId=<?php echo $userId; ?>");
	Request("proses_retur_pembayaran.php?retur=ya&no_return="+no_return+"&fdata="+fdata+"&tgl_return="+tgl_return+"&userId=<?php echo $userId; ?>",'divSelesai','','GET',habisReturn,'noLoad');
}
...
function prosesHapus(){
	...
	for(var i=1;i<=ggr.getMaxRow();i++){
		...
		//var idBayarTin = temp.split('|');
		if(document.getElementById('chkr_'+temp).checked){
			fdata += temp+"|";
			proses = true;
		}
	}
	if(proses==false){
		alert('Pilih Data Retur Yang Ingin Dibatalkan');
		return false;
	}
...
$(document).ready(function(){
	$("#btnShowTinDown").click(function(){
		 ...
		 $("#divTableTindakan").animate({height:230},"slow");
...
function goFilterAndSort(grd){		
	if(grd=="gridbox_tambah_resep"){			
		...
		rt.loadURL('list_return_util.php?bln='+document.getElementById('cmbBulan').value+'&thn='+document.getElementById('cmbTahun').value+'&filter='+rt.getFilter()+'&sorting='+rt.getSorting()+'&page='+rt.getPage(),'','GET');
	}
}
...
rt.setHeader("DATA RETUR PELAYANAN",false);
rt.setColHeader("No,Tgl Retur,No Retur,Tgl Kunjungan,Tgl Bayar,No Kwitansi,No RM,Nama Pasien,Nilai Retur,Cetak");
rt.setIDColHeader(",,r.no_return,,,b.no_kwitansi,p.no_rm,p.nama,,");
rt.setColWidth("25,60,100,60,60,90,60,150,80,40");
rt.setCellAlign("center,center,center,center,center,center,center,left,right,center");
rt.setCellType("txt,txt,txt,txt,txt,txt,txt,txt,txt,txt");
rt.setCellHeight(20);
rt.setImgPath("../icon");
...
var url;
	if(document.getElementById('id_ret').value=='' || document.getElementById('id_ret').value==null){
		alert('Pilih Data Yang Mau Dihapus Terlebih Dahulu');
		return false;
	}
	if(confirm('Yakin Ingin Menghapus Data Ini ???')){
		url='list_return_util.php?act=hapus&id_return='+document.getElementById('id_ret').value+'&bln='+document.getElementById('cmbBulan').value+'&thn='+document.getElementById('cmbTahun').value;
		//alert(url);
		rt.loadURL(url,'','GET');
	}
	//rt.loadURL('list_return_util.php?bln='+document.getElementById('cmbBulan').value+'&thn='+document.getElementById('cmbTahun').value,'','GET');
...
function setKosong(){
	...
	gg.loadURL('r_pembayaran_util.php?idPasien=0&idKunj=0&jnsRwt=0','','GET');
	ggr.loadURL('return_pembayaran_util.php?idPasien=0&idKunj=0&jnsRwt=0&tanggal='+document.getElementById('txtTglReturn').value,'','GET');
...
function cetakReturnById(id){
	//window.open('kwi_return_pembayaran.php?id='+id);
	window.open('../../billing/pembayaran/cetakPembayaran_inap_retur.php?id='+id+'&fromModul=1&idUser=<?php echo $userId; ?>');
}

function cetakReturn(){
	var cid=ggr.getRowId(ggr.getSelRow());
	//window.open('kwi_return_pembayaran.php?id='+cid+'&idKunj='+dataPasien[8]+'&jnsRwt='+document.getElementById('cmbJnsRwt').value+'&tanggal='+document.getElementById('txtTglReturn').value);
	window.open('../../billing/pembayaran/cetakPembayaran_inap_retur.php?id='+cid+'&fromModul=1&idUser=<?php echo $userId; ?>');
}

function ganti(){
	//alert("list_return_util.php?bln="+document.getElementById('cmbBulan').value+"&thn="+document.getElementById('cmbTahun').value);
	rt.loadURL("list_return_util.php?bln="+document.getElementById('cmbBulan').value+"&thn="+document.getElementById('cmbTahun').value,'','GET');
}

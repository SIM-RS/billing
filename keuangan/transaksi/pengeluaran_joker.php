            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#EAEFF3">
                ...
                <tr>
                    <td style="padding-left:20px;font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">
                        ...
                        <span style="padding-left:280px"><button id="btnBayarPajak" name="btnBayarPajak" type="button" class="tblBtn" onclick="bayarPajak()" disabled="disabled">&nbsp;&nbsp;Bayar Pajak + Posting&nbsp;&nbsp;</button>&nbsp;&nbsp;<button id="btnBayar" name="btnBayar" type="button" disabled="disabled" class="tblBtn" onclick="bayar()">&nbsp;&nbsp;Bayar + Posting Akuntansi&nbsp;&nbsp;</button></span>
                    </td>
                </tr>
                <tr id="trGrid">
                    <td valign="top" align="center">
    ...
    <script type="text/javascript" language="javascript">
		...
		var url;
            if(par == 'in'){
                ...
                url = 'supplier.php?type=11&txtTglAwal='+itxtTglAwal+'&txtTglAkhir='+itxtTglAkhir+'&jenis_supplier='+jenis_supplier+'&supplier='+supplier;
				//alert(url);
	   ...
	   function goFilterAndSort(grd){
			...
			if (grd=="divGrid"){
                ...
                var supplier = document.getElementById('cmbSup').value;
                var target = 'div_faktur';
				url = 'supplier.php?type=11&txtTglAwal='+itxtTglAwal+'&txtTglAkhir='+itxtTglAkhir+'&jenis_supplier='+jenis_supplier+'&supplier='+supplier+'&filter='+document.getElementById(grd).filter+'&sorting='+document.getElementById(grd).sorting;
				//alert(url);
                Request(url,target,'','GET');
			}
       }

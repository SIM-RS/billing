...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        if("<?php echo $tipe;?>" == "4"){
            a.setColHeader("NO,TANGGAL KUNJUNGAN,TANGGAL PULANG,NO RM,NAMA,TEMPAT LAYANAN,UNIT ASAL,TARIF PERDA,BIAYA PASIEN,TARIF KSO,IUR BAYAR,SELISIH");
            ...
            a.setColHeader("NO,TANGGAL KUNJUNGAN,TANGGAL PULANG,NO RM,NAMA,TEMPAT LAYANAN,TARIF PERDA,BIAYA PASIEN,TARIF KSO,IUR BAYAR,SELISIH");
            a.setSubTotal(",,,,,SubTotal :&nbsp;,0,0,0,0,0");

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/JavaScript" language="JavaScript">
		...
		function kirim(){
			...
			document.getElementById('btnVerifikasi').disabled=true;
			url="../transaksi/piutang_billing_utils.php?grid=1&txtTgl="+TglA+"&kso="+kso+"&posting="+cmbPost;
			//alert(url);
			a.loadURL(url,"","GET"); 
		}
		//=========================================
		...
		//var nilai='';
			...
			if (tmp!="")
			{
				...
				{
					url="../transaksi/piutang_billing_utils.php?grid=1&act=verifikasi&userId=<?php echo $userId; ?>&txtTgl="+txtTglA+"&kso="+kso+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp;
					//alert(url);
					a.loadURL(url,"","GET");
				}
			}

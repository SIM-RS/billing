...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>.: Pendapatan Lain-Lain :.</title>
        ...
        <div align="center">
            <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#EAEFF3">
                ...
                <tr>
                    <td valign="top" align="center">
                        <table width="750" border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="30">
                              <td height="30" colspan="2" align="center" style="font-size:16px">Pendapatan Lain-Lain</td>
                            </tr>
                            <tr height="30">
				...
				<input type="hidden" id="txtId" name="txtId" />				
									...
									FROM k_ms_transaksi WHERE tipe = 1 and isManual=1";
				    ...
				    <button id="btnMsTrans" name="btnMsTrans" class="txtinput">+</button>                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:&nbsp;
                                    ...
                                    <input type="button" name="btnTgl" value="&nbsp;V&nbsp;" class="txtcenter" onclick="gfPop.fPopCalendar(document.getElementById('txtTgl'),depRange);"/>                                </td>
                            </tr>
                            <tr>
                                <td style="padding-left:150px;">No Bukti</td>
                                <td>:&nbsp;
                                    <input id="txtNoBu" name="txtNoBu" size="30" class="txtinput" type="text" />                                </td>
                            </tr>                            

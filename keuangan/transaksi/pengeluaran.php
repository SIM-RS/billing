...
$ma_ppn_wapu_kredit=1243;
$ma_ppn_wapu_tdk_kredit=1244;
$ma_pph21=1233;
$ma_pph21_merit=1233;
$ma_pph21_tunjangan=1234;
$ma_pph21_insentif_lembur=1235;
$ma_pph21_bonus_jproduksi=1236;
$ma_pph21_lainnya=1237;
$ma_pph21_direksi_komisaris=1238;
$ma_pph21_tunj_direksi_komisaris=1239;
$ma_pbb=1241;
$ma_pph22=1246;
$ma_pph23=1240;
$ma_pph26=1246;
...
<html>
    ...
    <body bgcolor="#808080" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div align="center">
            <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#EAEFF3">
                <tr>
                    <td height="50">&nbsp;<span id="spnBacaDPA" style="display:none"></span></td>
                </tr>
                <tr>
                    <td valign="top" align="center">
                        <table width="750" border="0" cellpadding="1" cellspacing="1" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold">
                            <tr style="display:none">
                                <td width="50%" style="padding-left:150px;">Jenis Pengeluaran</td>
                                <td width="50%">:&nbsp;
                            ...
                            <tr id="trMA" style="display:none;">
                                <td width="50%" style="padding-left:150px;">Mata Anggaran</td>
                                <td width="50%">:&nbsp;
                            ...
                            <tr id="trBebanJenis" style="display:none;">
                                <td width="50%" style="padding-left:150px;">Beban Jenis</td>
                                <td width="50%">:&nbsp;
                                 <input type="hidden" id="txtidBJ" name="txtidBJ"  />
                                 <input type="text" id="txtBJ" name="txtBJ" class="txtinput" readonly="readonly" size="40" />&nbsp;&nbsp;<img src="../icon/view_tree.gif" align="absmiddle" style="cursor:pointer" onclick="OpenWnd('tree_beban_jenis.php?id='+document.getElementById('txtIdJnsPeng').value+'&par=txtidBJ*txtBJ',800,500,'Tree Unit',true)" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id='trForm'>
                                ...
                                <td>:&nbsp;
                                    <input type="text" id="nilaiSPK" name="nilaiSPK" readonly="readonly" size="14" style="text-align:right;" class="txtinput"/></td>
                            </tr>
                            <tr id='trForm1' height="40">
                                ...
                                <td>:&nbsp;
                                    ...
                                    <input type="text" id="nilai" name="nilai" size="14" readonly="readonly" onkeyup="zxc(this)" style="text-align:right;" class="txtinput"/> &nbsp;<img id="imgNilai" src="../icon/calculator_red.png" align="absmiddle" width="25" style="cursor:pointer;display:none;" onclick="popup1()" /></td>
                            </tr>
                            <tr id='trFak'>
                                ...
                                <td>:&nbsp;
                                	<input type="hidden" id="noTerima" name="noTerima" value="" />
                ...
                <tr>
                    <td align="center" height="50" valign="middle" style="padding-left:150px;">
                ...
                <tr>
                    <td style="padding-left:20px;font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">
                        <fieldset style="width: 170px;display:inline-table;">
                            <legend>
                        ...
                        </fieldset><span style="padding-left:290px;display:inline-table;"><button id="btnBayarPajak" name="btnBayarPajak" type="button" class="tblBtn" onclick="bayarPajak()" disabled="disabled" style="display:none;">&nbsp;&nbsp;Bayar Pajak + Posting&nbsp;&nbsp;</button>&nbsp;<BUTTON type="button" disabled="disabled" id="btnKwitansi" onClick="CetakKwitansi();" style="cursor:pointer;"><IMG SRC="../icon/contact-us.jpg" border="0" width="16" height="16" ALIGN="absmiddle">&nbsp;Kwitansi BKM/BBM</BUTTON>&nbsp;<button id="btnBayar" name="btnBayar" type="button" class="tblBtn" onclick="bayar()">&nbsp;&nbsp;Verifikasi&nbsp;&nbsp;</button></span>
                    </td>
                </tr>
                <tr id="trGrid">
                    <td valign="top" align="center">
        ...
        <div id="divPop" class="popup" style="width:480px;height:190px;display:none;">
            <fieldset>
                <legend style="float:right">
                    <div style="float:right; cursor:pointer" class="popup_closebox" onclick="Tutup_Pop_Bayar();">
                ...
                <table border="0">
                    <tr>
                        ...
                        <td>&nbsp;:&nbsp;</td>
                        <td><input id="txtNoBuktiBayar" name="txtNoBuktiBayar" class="txtinput" type="text" size="30" value="<?php echo $nobku; ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select id="caraBayar" name="caraBayar" class="txtinputreg">
                        		<?php 
								$sqlRek="SELECT * FROM $dbakuntansi.ak_ms_kas_bank WHERE (in_out=0 OR in_out=2) AND aktif=1 ORDER BY kode";
								$rsRek=mysql_query($sqlRek);
								while ($rwRek=mysql_fetch_array($rsRek)){
								?>
                                <option value="<?php echo $rwRek['ma_sak_id']; ?>"><?php echo $rwRek['nama']; ?></option>
                                <?php 
								}
								?>
                            </select></td>
                    ...
                    <tr style="visibility:collapse;">
                        ...
                        <fieldset>
                        	<table>
                            	<tr>
                                	<td>PPN</td>
                                    <td>:&nbsp;<input id="txtPPN" name="txtPPN" lang="<?php echo $ma_ppn; ?>" class="txtinput" type="text" value="" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>Pph 21</td>
                                    <td>:&nbsp;<input id="txtPph21" name="txtPph21" lang="<?php echo $ma_pph21; ?>" class="txtinput" type="text" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>Pph 22</td>
                                    <td>:&nbsp;<input id="txtPph22" name="txtPph22" lang="<?php echo $ma_pph22; ?>" class="txtinput" type="text" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>Pph 23</td>
                                    <td>:&nbsp;<input id="txtPph23" name="txtPph23" lang="<?php echo $ma_pph23; ?>" class="txtinput" type="text" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>Pph 26</td>
                                    <td>:&nbsp;<input id="txtPph26" name="txtPph26" lang="<?php echo $ma_pph26; ?>" class="txtinput" type="text" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>Pph 29</td>
                                    <td>:&nbsp;<input id="txtPph29" name="txtPph29" lang="<?php echo $ma_pph29; ?>" class="txtinput" type="text" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>P Daerah</td>
                                    <td>:&nbsp;<input id="txtpDaerah" name="txtpDaerah" lang="<?php echo $ma_pdaerah; ?>" class="txtinput" type="text" size="13" style="text-align:right" onkeyup="zxc(this)" />&nbsp;</td>
                                </tr>
                            	<tr>
                                	<td>&nbsp;</td>
                                    <td>&nbsp;</td>
                    ...
                    <tr>
                    	<td colspan="3" align="center" style="padding-left:30px"><button id="btnBayarPop" name="btnBayarPop" type="button" class="tblBtn" onclick="BayarPop()">&nbsp;&nbsp;Verifikasi&nbsp;&nbsp;</button></td>
                    </tr>
                </table>
            </fieldset>
        </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        var tmp = par.split('|');
			document.getElementById('noTerima').value = "";
		...
		var url;
            if(par == 'in'){
				...
				var ifilterKelompokSPK = document.getElementById('filterKelompokSPK').value;
                ...
                url = 'supplier.php?type=11&txtTglAwal='+itxtTglAwal+'&txtTglAkhir='+itxtTglAkhir+'&jenis_supplier='+jenis_supplier+'&supplier='+supplier+'&filterKelompokSPK='+ifilterKelompokSPK;
				//alert(url);
				...
				if (document.getElementById('stBayar').value=="1"){
					//alert('a');
					document.getElementById('btnKwitansi').disabled=false;
					document.getElementById('btnBayar').disabled=false;
					document.getElementById('btnBayar').innerHTML="&nbsp;&nbsp;UnVerifikasi&nbsp;&nbsp;";
				}else{
					//alert('b');
					document.getElementById('btnKwitansi').disabled=true;
					if (document.getElementById('stBayar').value=="0"){
						document.getElementById('btnBayar').disabled=false;
						document.getElementById('btnBayar').innerHTML="&nbsp;&nbsp;Verifikasi&nbsp;&nbsp;";
					}else{
        ...
        function view_tab()
        {
            ...
            switch(tipe){
                case '11'://supplier
					...
					if (document.getElementById('filterKelompokSPK')) ifilterKelompokSPK = document.getElementById('filterKelompokSPK').value;
					url += '&txtTglAwal='+itxtTglAwal+'&txtTglAkhir='+itxtTglAkhir+'&jenis_supplier='+jenis_supplier+'&supplier='+supplier+'&filterKelompokSPK='+ifilterKelompokSPK;
                    //target = 'div_faktur';
                    //+"&supplier="+supplier
                    break;
                case '8'://gaji pns
        ...
        function simpan(){
            ...
            if(melakukan == ''){
                melakukan = 'add';
            }else if (melakukan == 'edit'){
				if (verifId==1){
					alert("Data Yang Sudah Diverifikasi Tidak Boleh Diubah !");
					return false;
				}
			}
            ...
            if(document.getElementById('trSup2').style.display == 'table-row'){
				...
				var nterima = document.getElementById('noTerima').value;
				var tgl_filter1 = document.getElementById('txtTglAwal').value;
				var tgl_filter2 = document.getElementById('txtTglAkhir').value;
			 	/*var bln_in = document.getElementById('bln_in').value;
			 	var thn_in = document.getElementById('thn_in').value;*/
                url += "&jenis_supplier="+jenis_supplier+"&suplier_id="+suplier_id+"&nofaktur="+nofaktur+"&nterima="+nterima+"&bln_in="+bln_in+"&thn_in="+thn_in+"&tgl_filter1="+tgl_filter1+"&tgl_filter2="+tgl_filter2;
            }
	...
	function CetakKwitansi()
	{
		...
		// alert(sisip);
		var idPosting = sisip[18];
		var cmbPost = document.getElementById('stBayar').value;
		if(cmbPost=='0')
		{
		...
		else
		{
			...
			url='../../keuangan/laporan/jurnal/bukti_pengeluaran_kas_bank.php?id_posting='+idPosting;
			window.open(url);
			//clear();
		}
	}
		
		var bayar_pajak=false,verifId=0;
		function bayarPajak(){
			clearTimeout(var_refresh);
			bayar_pajak=true;
		...
		function bersihkan(){
			document.getElementById('txtNoBuktiBayar').value='<?php echo $nobku; ?>';
			...
			document.getElementById('txtpDaerah').value='';
		...
		function bayar(){
			...
			if (stBayar==0){
				...
				var noBukti = "";
				var TglBayar = "";
				var url="pengeluaran_utils.php?pilihan=pengeluaran&stBayar="+stBayar+"&ViewBayar="+ViewBayar+"&id="+id+"&bln="+bln+"&thn="+thn+"&noBukti="+noBukti+"&TglBayar="+TglBayar;
			
				for (var i=0;i<grid.getMaxRow();i++){
					if (grid.cellsGetChecked(i+1,7)){
				...
				if (tmp!=""){
					tmp=String.fromCharCode(5)+tmp.substr(0,(tmp.length-1));
					...
					alert("Pilih Data Yang Mau diUnVerifikasi");
				}
			}
		}
		
		function Tutup_Pop_Bayar(){
			var_refresh = setTimeout("AutoRefresh()", 300000);
		}
		...
		function BayarPop(){
			...
			if (noBukti==""){
				alert("Isikan No Bukti Pengeluaran !");
				return false;
			}
			...
			var url="pengeluaran_utils.php?pilihan=pengeluaran&stBayar="+stBayar+"&ViewBayar="+ViewBayar+"&id="+id+"&bln="+bln+"&thn="+thn+"&noBukti="+noBukti+"&TglBayar="+TglBayar+"&TglBayarPajak="+TglBayarPajak+"&tcaraBayar="+tcaraBayar+"&user_act="+user_act;
			...
			if (tmp!=""){
				...
				if (document.getElementById('txtPPN').value!=""){
					pajak +=document.getElementById('txtPPN').lang+"|"+document.getElementById('txtPPN').value.replace(/\./g,'')+String.fromCharCode(6);
					msgalert +="   - PPN = "+document.getElementById('txtPPN').value+" \r\n";
				}
				if (document.getElementById('txtPph21').value!=""){
					pajak +=document.getElementById('txtPph21').lang+"|"+document.getElementById('txtPph21').value.replace(/\./g,'')+String.fromCharCode(6);
					msgalert +="   - Pph21 = "+document.getElementById('txtPph21').value+" \r\n";
				}
				if (document.getElementById('txtPph22').value!=""){
					pajak +=document.getElementById('txtPph22').lang+"|"+document.getElementById('txtPph22').value.replace(/\./g,'')+String.fromCharCode(6);
					msgalert +="   - Pph22 = "+document.getElementById('txtPph22').value+" \r\n";
				}
				if (document.getElementById('txtPph23').value!=""){
					pajak +=document.getElementById('txtPph23').lang+"|"+document.getElementById('txtPph23').value.replace(/\./g,'')+String.fromCharCode(6);
					msgalert +="   - Pph23 = "+document.getElementById('txtPph23').value+" \r\n";
				}
				if (document.getElementById('txtPph26').value!=""){
					pajak +=document.getElementById('txtPph26').lang+"|"+document.getElementById('txtPph26').value.replace(/\./g,'')+String.fromCharCode(6);
					msgalert +="   - Pph26 = "+document.getElementById('txtPph26').value+" \r\n";
				}
				if (document.getElementById('txtPph29').value!=""){
					pajak +=document.getElementById('txtPph29').lang+"|"+document.getElementById('txtPph29').value.replace(/\./g,'')+String.fromCharCode(6);
					msgalert +="   - Pph29 = "+document.getElementById('txtPph29').value+" \r\n";
				}
				if (document.getElementById('txtpDaerah').value!=""){
					pajak +=document.getElementById('txtpDaerah').lang+"|"+document.getElementById('txtpDaerah').value.replace(/\./g,'')+String.fromCharCode(6);
				...
				if (tmp.length>1024){
					...
					//if(bayar_pajak==false){
						url+="&act=pengeluaranLain2&fdata="+tmp;
					/*}
					else{
						if(TglBayarPajak==''){
							alert('Tanggal Bayar Pajak tidak boleh kosong !.');
							return false;
						}
						url+="&act=pengeluaranLain2_bayarPajak&fdata="+tmp;
					}*/
        ...
        function grid_act(){
		  ...
		  sisip[6] = supplier_id
		  sisip[7] = nilai
		  sisip[8] = jenis_supplier
		  sisip[9] = verifikasiId
		  sisip[10] = nilai_sim
		  */
		  //no,tgl,nobukti,jenis trans,nilai,keterangan
			...
			document.getElementById('txtArea').value = grid.cellsGetValue(grid.getSelRow(),6);
		    ...
		    if (sisip[8] > 0){
				...
				document.getElementById('nilaiSPK').value = FormatNumberFloor(parseInt(sisip[10]),".");
				//alert(sisip[9]);
				if(sisip[8]==1){
			...
			document.getElementById('txtNoBuktiBayar').value=grid.cellsGetValue(grid.getSelRow(),3);
			document.getElementById('txtTglBayar').value=grid.cellsGetValue(grid.getSelRow(),2);
			//document.getElementById('txtTglBayarPajak').value;
			//document.getElementById('caraBayar').value;
			//document.getElementById('stBayar').value;
			
			//alert(sisip[17]);
			/*if(sisip[17]==1 && sisip[15]==1){
				document.getElementById('btnBayarPajak').disabled=false;
			}
			else{
				document.getElementById('btnBayarPajak').disabled=true;
			}*/
			
			var temp_pajak=sisip[12].split('#');
			var arPjk='';
			for(var i=1;i<temp_pajak.length;i++){
				arPjk=temp_pajak[i].split('*');
				
				if(arPjk[3]==394)
					document.getElementById('txtPPN').value=FormatNumberFloor(parseInt(arPjk[2]),".");
				if(arPjk[3]==388)
					document.getElementById('txtPph21').value=FormatNumberFloor(parseInt(arPjk[2]),".");
				if(arPjk[3]==389)
					document.getElementById('txtPph22').value=FormatNumberFloor(parseInt(arPjk[2]),".");
				if(arPjk[3]==390)
					document.getElementById('txtPph23').value=FormatNumberFloor(parseInt(arPjk[2]),".");
				if(arPjk[3]==391)
					document.getElementById('txtPph26').value=FormatNumberFloor(parseInt(arPjk[2]),".");
				if(arPjk[3]==392)
					document.getElementById('txtPph29').value=FormatNumberFloor(parseInt(arPjk[2]),".");
				if(arPjk[3]==858)
					document.getElementById('txtpDaerah').value=FormatNumberFloor(parseInt(arPjk[2]),".");
			}
        }
	   ...
	   function goFilterAndSort(grd){
			...
			if (grd=="divGrid"){
			...
			else if(grd=='div_faktur'){
				//alert(document.getElementById(grd).filter);
				//alert(document.getElementById(grd).sorting);
				var itxtTglAwal = document.getElementById('txtTglAwal').value;
                var itxtTglAkhir = document.getElementById('txtTglAkhir').value;
				var ifilterKelompokSPK = document.getElementById('filterKelompokSPK').value;
				var jenis_supplier = document.getElementById('cmbJenSup').value;
                var supplier = document.getElementById('cmbSup').value;
                var target = 'div_faktur';
				url = 'supplier.php?type=11&txtTglAwal='+itxtTglAwal+'&txtTglAkhir='+itxtTglAkhir+'&jenis_supplier='+jenis_supplier+'&supplier='+supplier+'&filterKelompokSPK='+ifilterKelompokSPK+'&filter='+document.getElementById(grd).filter+'&sorting='+document.getElementById(grd).sorting;
				//alert(url);
                Request(url,target,'','GET');
			}
       }
	...
	var cekbox=(p==true)?1:0;
        ...
        grid.setColHeader("NO,TGL TRANSAKSI,NO BUKTI,JENIS TRANSAKSI,NILAI,KETERANGAN,PILIH<BR><input type='checkbox' name='chkAll' id='chkAll' onClick='chkKlik(this.checked);'>&nbsp;&nbsp;&nbsp;&nbsp;");
        grid.setIDColHeader(",tgl,no_bukti,nama_trans,nilai,ket,");
        grid.setColWidth("30,70,120,180,80,250,60");
        grid.setCellAlign("center,center,center,center,right,left,center");
		grid.setCellType("txt,txt,txt,txt,txt,txt,chk");
...
<script>
	...
	function zxc(par){
		...
		//var nilai=FormatNumberFloat(parseInt(r),2,",",".",".");
		if(nilai=='NaN'){
			par.value = '';
		}
		else{
	...
	function ngeload_grid_detil(par){
		ftemp = '';
		ftot = '';
		//alert("ngutils.php?jtrans_kode="+par);
	...
	function BacaMA_DPA(a,b){
		Request('baca_ma_dpa.php?idtrans='+a+'&idma_sak='+b , 'spnBacaDPA', '', 'GET',fSetBacaMA_DPA,'noload');
	}
	
	function fSetBacaMA_DPA(){
	var cdata=document.getElementById('spnBacaDPA').innerHTML;
		cdata=cdata.split('|');
		document.getElementById('txtidMA').value=cdata[0];
		document.getElementById('txtMA').value=cdata[1];
	}
	
	function fchkTerimaPO_Click(){
	var tSubTot=0;
		if (document.forms[0].chkTerimaPO.length){
			for (var i=0;i<document.forms[0].chkTerimaPO.length;i++){
				//alert(document.forms[0].chkTerimaPO[i].checked);
				if (document.forms[0].chkTerimaPO[i].checked){
					tSubTot+=parseFloat(document.getElementById('tdNilaiTerima'+(i+1)).lang);
				}
				//tdNilaiTerima,tdSubTot
			}
			document.getElementById('tdSubTot').innerHTML=FormatNumberFloat(tSubTot,2,",",".",".")+'&nbsp;';
		}else{
			if (document.getElementById('chkTerimaPO').checked){
				document.getElementById('tdSubTot').innerHTML=FormatNumberFloat(document.getElementById('tdNilaiTerima1').lang,2,",",".",".")+'&nbsp;';
			}else{
				document.getElementById('tdSubTot').innerHTML='0,00&nbsp;';
			}
		}
	}
	
	function fchkTerimaPO_Pilih(){
	var tSubTot=0,tmp,nterima='',tmpnoterima;
		if (document.forms[0].chkTerimaPO.length){
			for (var i=0;i<document.forms[0].chkTerimaPO.length;i++){
				//alert(document.forms[0].chkTerimaPO[i].checked);
				if (document.forms[0].chkTerimaPO[i].checked){
					tSubTot+=parseFloat(document.getElementById('tdNilaiTerima'+(i+1)).lang);
					tmp=document.getElementById('lstDiag'+(i+1)).lang;
					tmpnoterima=tmp.split('|');
					nterima+=tmpnoterima[5]+'|';
					//alert(document.getElementById('lstDiag'+(i+1)).lang);
				}
			}
		}else{
			if (document.getElementById('chkTerimaPO').checked){
				tSubTot=parseFloat(document.getElementById('tdNilaiTerima1').lang);
				tmp=document.getElementById('lstDiag1').lang;
				tmpnoterima=tmp.split('|');
				nterima+=tmpnoterima[5]+'|';
			}
		}
		...
		document.getElementById('btnFak').value='show';*/
		if (tSubTot==0){
			alert("Pilih Data Penerimaan Yang Mau Dibayar Terlebih Dahulu !");
			return false;
		}
		//tmp=document.getElementById('tdSubTot').innerHTML;
		//tmp=tmp.substr(0,tmp.length-6);
		nterima=nterima.substr(0,nterima.length-1);
		document.getElementById('noTerima').value = nterima;
		tmp=tmp.split('|');
		document.getElementById('faktur').value = tmp[4];
		tmp=FormatNumberFloat(tSubTot,2,",",".",".");
		document.getElementById('nilai').value = tmp;
		document.getElementById('nilaiSPK').value = tmp;
		document.getElementById('div_faktur').style.display = 'none';
		document.getElementById('btnFak').value='show';
	}
</script>

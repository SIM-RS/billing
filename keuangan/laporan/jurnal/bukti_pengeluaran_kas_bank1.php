...
<body>
	...
	<div id="container">
		...
		<table id="detail" class="borderfull">
			...
			<tr>
				<td valign="top">2.</td>
				<td width="140" valign="top">Terbilang</td>
			  <td width="13" valign="top">:</td>
			  <td width="570" valign="top"><?php echo ucwords(terbilang($total['debit'])." Rupiah."); ?></td>
		  </tr>
			<tr>
				<td>3.</td>
				<td>Kepada</td>
		...
		<table id="paraf">
			<tr>
				...
				<td rowspan="6" align="center">
					...
					<?php echo $namaRS; ?>
					<br />
					<?php echo $pejabat_ttd_jkk; ?>
					<br />
					<br />
					<br />
					<br />
					<br />
					<?php echo $pejabat_ttd_nama_jkk; ?>
				</td>
			</tr>
			<tr>

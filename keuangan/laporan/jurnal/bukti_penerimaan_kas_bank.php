...
<body>
	...
	<div id="container">
		<?php
			...
			$kepada = "REBECCA AGUSTINA SIBUEA";
			$uraian = $nobukti = "";
			$total = array();
			$arrData = array();
		...
		<table id="detail" class="borderfull">
			...
			<tr>
				<td valign="top">2.</td>
				<td width="143" valign="top">Terbilang</td>
			  <td width="14" valign="top">:</td>
			  <td width="566" valign="top"><?php echo ucwords(terbilang($total['debit'])); ?></td>
		  </tr>
			<tr>
				<td>3.</td>
				<td>Dari</td>

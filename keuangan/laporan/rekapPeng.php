...
<?=$tlpRS;?>
    ...
    <tr>
        <td style="font-size:14px; height:70px; text-transform:uppercase; text-align:center; font-weight:bold;" valign="top">rekapitulasi PENGELUARAN<br><?php echo $Periode;?></td>
    </tr>
    <tr>
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
                <tr style="font-weight:bold">
					<td width="100">&nbsp;</td>
					<td colspan="2">PENGELUARAN/TANGGAL</td>
				</tr>
                <tr style="font-weight:bold">
					...
					<?php
					   ...
					   $sql = "SELECT tgl,date_format(tgl,'%d/%m') as f_tgl
							 ...
							 WHERE $waktu AND k_ms_transaksi.tipe = '2' group by tgl";
					   $rs = mysql_query($sql);
				...
				<?php
						$qPend = "SELECT k_ms_transaksi.id, k_ms_transaksi.nama
                                FROM k_transaksi INNER JOIN k_ms_transaksi ON k_transaksi.id_trans = k_ms_transaksi.id 
                                WHERE $waktu AND k_ms_transaksi.tipe = '2' GROUP BY k_ms_transaksi.id";
                ...
                <tr>
					...
					<?php
							...
							{ 
								...
								$qNilai= "SELECT if(nilai is null,0,nilai) nilai FROM k_transaksi WHERE id_trans=".$rwPend['id']." AND $waktu";

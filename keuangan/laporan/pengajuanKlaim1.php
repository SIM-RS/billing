		...
		<section id="detail">
			<?php
				switch($jReport){
					...
					case '1':
						//$klaim_id = "14";
						$kolom = array('No|20','Tanggal Kunjungan|60','Tanggal Pulang|60','No RM|60','Nama|120','KSO|100','Kunjungan Awal|100','Tarif Perda|60','Biaya Pasien|60','Biaya KSO<br/>(SIMRS)|60','Biaya KSO<br/>(Verif Klaim)|60');

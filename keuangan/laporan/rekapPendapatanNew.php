<?php
	...
	$ptitle="Rekap Pendapatan Billing + Farmasi";
	$lblTotalP="TOTAL PENDAPATAN BILLING + FARMASI";
	$fFarmasi="";
	
	if ($isFarmasi=="1"){
		$ptitle="Rekap Pendapatan Farmasi";
		$lblTotalP="TOTAL PENDAPATAN FARMASI";
		$fFarmasi=" AND t.isFarmasi=2";
	}elseif ($isFarmasi=="0"){
		$ptitle="Rekap Pendapatan Billing";
		$lblTotalP="TOTAL PENDAPATAN BILLING";
		$fFarmasi=" AND t.isFarmasi<>2";
	}
...
*/                    ?>
				<!--tr>
				    ...
				    <td width="100" style="border-right:1px solid #000000;">&nbsp;</td>
                        ...
                        $sql="SELECT * FROM $dbakuntansi.ak_ms_unit mu WHERE mu.tipe='2' AND mu.islast=1 AND mu.aktif=1 ORDER BY mu.nama";
						//echo $sql."<br>";

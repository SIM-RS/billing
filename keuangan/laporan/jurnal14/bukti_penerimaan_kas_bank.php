<?php
	...
	// if($_POST['export']=='excel'){
		...
		// header('Content-Disposition: attachment; filename="Bukti Penerimaan Kas - Bank.xls"');
	// }
...
<body>
	...
	<div id="container">
		...
		<header id="judul">
			...
			<div>
				<b style="font-size:20px;" >BUKTI PENERIMAAN KAS - BANK<br /></b>
			</div>
		...
		<table id="detail" class="borderfull">
			<tr>
				<td width="10">1.</td>
				<td colspan="3">Pemegang Kas Harap Menerima Uang Sebesar &nbsp; : &nbsp; <b>Rp <?php echo number_format($total['debit'],0,",","."); ?>,-</b></td>
			</tr>
			<tr>
				<td valign="top">2.</td>
				<td width="200" valign="top">Terbilang</td>
				<td valign="top">:</td>
				<td valign="top"><?php echo ucwords(terbilang($total['debit'])); ?></td>
			</tr>
			<tr>
				<td>3.</td>
				<td>Dari</td>
			...
			<tr>
				...
				<td>:</td>
				<td>Kwitansi & Rincian Pendapatan</td>
			</tr>
		</table>
		...
		<table id="dataNilai" class="borderfull">
			<tr style="background:#ECECEC;" class="borderbottom">
				<th>No</th>
				<th>Kode Rekening</th>
				<th colspan="2">Debit Buku Jurnal</th>
		...
		<table id="paraf">
			...
			<tr>
				...
				<td colspan="3"><?php echo $tgl_Post; ?></td>
			</tr>
		</table>
	</div>
	<?php 

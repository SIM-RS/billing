...
?>
<div id="popup_div1" class="popup" style="width:600px;display:none;">
    <div style="float:right; cursor:pointer" class="popup_closebox" onclick="resetF()">
        <img src="http://<?php echo $_SERVER['HTTP_HOST']?>/simrs-pelindo/keuangan/icon/cancel.gif" height="16" width="16" align="absmiddle"/>Tutup</div>
		<br>
				...
				<table width="550" align="center">
					...
					<tr id="trPeriode" style="visibility:collapse">
					  ...
					  <td align="left">
						...
						&nbsp;<input type="text" id="txtJam1" name="txtJam1" class="txtcenter" size="5"  style="display:none;" />
						s.d.
						...
						&nbsp;<input type="text" id="txtJam2" name="txtJam2" style="display:none;" class="txtcenter" size="5" />
					  </td>
					</tr>
					...
					<tr id="rwKasir" style="visibility:collapse">
						<td align="right">Kasir :&nbsp;</td>
						<td align="left"><select id="cmbKasir2" name="cmbKasir2" class="txtinput" onchange="isi_Combo('nmKsr',this.value,'','nmKsr','','<?php echo $fromHome; ?>');"></select>
					</tr>
					<tr id="rwNamaKasir" style="visibility:collapse">
						<td align="right">Pelaksana :&nbsp;</td>
						<td ><select id="nmKsr" name="nmKsr" class="txtinput" style="text-transform:uppercase"></select></td>
					</tr>
					<tr id="trJns">
						<td align="right">Jenis Layanan</td>
						<td >&nbsp;<select name="JnsLayanan" id="JnsLayanan" tabindex="26" class="txtinput" onchange="change(<?php echo $fromHome;?>)"></select></td>
					</tr>
					<tr id="trTmp">

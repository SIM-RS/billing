...
$pLegend = "Penerimaan -> Penerimaan Ambulan";
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <tr>
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr>
                                <td height="30" colspan="2" align="center" style="font-size:16px;">Penerimaan Ambulan</td>
                            </tr>
							<tr>
								<td style="padding-left:30px;">Layanan</td>
                                <td>:&nbsp;
									<select name="tipePeng" id="tipePeng" class="txtinput">
										<option value="0">RSPM</option>
										<option value="1">Pavilyun</option>
									</select>
	...
	function cetak(){
		...
		window.open("cetak_ambulan.php?bln="+bln+"&thn="+thn+"&filter="+a.getFilter()+"&sorting="+a.getSorting(), "", "scrollbars=yes, width=900, height=600, left=0");
	}
	...
	function simpanPen(){
		...
		if(ValidateForm('tipeKenda,jam,txtTgl,txtNoBu,nilai','ind')){
			...
			var tipePeng = document.getElementById("tipePeng").value;
			...
			+"&tipePeng="+encodeURIComponent(tipePeng)
	...
	function batalPen(){
	    var isian = "txtId*-**|*txtTgl*-*<?php echo $tgl;?>*|*txtTglSet*-*<?php echo $tgl;?>*|*txtNoBu*-**|*nilai*-**|*tipeKenda*-*0*|*tipePeng*-*0";
	    fSetValue(window,isian);	    
	...
	a.setColHeader("NO,TGL PELAYANAN, TGL SETOR, JAM SETOR, NO BUKTI, LAYANAN, JENIS AMBULAN, NILAI, KET, PETUGAS");
	a.setIDColHeader(",,,,no_bukti,tipePeng,nama,nilai,ket,username");
	a.setColWidth("40,80,80,50,100,100,250,80,250,100");
	a.setCellAlign("center,center,center,CENTER,CENTER,left,left,right,left,center,center");
	a.setCellHeight(20);
	a.setImgPath("../icon");

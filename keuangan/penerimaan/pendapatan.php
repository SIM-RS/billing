...
$pLegend = "Penerimaan -> Penerimaan Lainnya";
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <tr>
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr>
                                <td height="30" colspan="2" align="center" style="font-size:16px;">Penerimaan Lainnya</td>
                            </tr>
                            <tr height="30">
                                <td width="140" style="padding-left:30px;" height="30">Jenis Pendapatan</td>
                                <td>:&nbsp;
				<input type="hidden" id="txtId" name="txtId" />				
                                    <select id="cmbPend" name="cmbPend" onchange="changeType(this)" class="txtinput">
                                        <?php
                                        $qPend = "SELECT id, nama
									FROM k_ms_transaksi WHERE tipe = 1 AND isManual=1 AND aktif=1 ORDER BY nama";
                	...
                	<td align="center" >
                        <fieldset style="width:900px">
                            ...
                            <select id="blnPend" name="blnPend" onchange="goFilterAndSort('gridbox')" class="txtinputreg">
                                    ...
                                    <div id="gridbox" style="width:900px; height:230px; background-color:white; overflow:hidden;"></div>
	...
	function simpanPen(){
	    ...
	    if(cmbPend!="1"){
			if(ValidateForm('cmbPend,txtTgl,txtNoBu,nilai','ind')){
				...
				if(available){
					...
					a.loadURL("pendapatan_utils.php?act="+act+param+"&tipe=lain2&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage(),"","GET");
					batalPen();
				}
			}
	    }
	...
	var bln = document.getElementById('blnPend').value;
		...
		if(confirm("Anda yakin menghapus data Tanggal "+a.cellsGetValue(a.getSelRow(),2))){
			...
			a.loadURL("pendapatan_utils.php?bln="+bln+"&thn="+thn+"&act="+act+"&tipe=lain2&rowid="+rowid,"","GET");
			batalPen();
		}
	}
	...
	function goFilterAndSort(grd){
	     var bln = document.getElementById('blnPend').value;
            ...
            a.loadURL("pendapatan_utils.php?bln="+bln+"&thn="+thn+"&tipe=lain2&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage(),"","GET");
        }
	var bln = document.getElementById('blnPend').value;
        var thn = document.getElementById('thnPend').value;
	var a=new DSGridObject("gridbox");
        ...
        a.setColWidth("40,80,100,220,110,300");
		...
		//alert("pendapatan_utils.php?bln="+bln+"&thn="+thn+"&tipe=lain2");
        a.baseURL("pendapatan_utils.php?bln="+bln+"&thn="+thn+"&tipe=lain2");
        a.Init();

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function cetak(){
		...
		window.open("cetak_ambulan.php?bln="+bln+"&thn="+thn+"&filter="+a.getFilter()+"&sorting="+a.getSorting(), "", "width=900, height=600, left=0");
	}
	...
	a.setColHeader("NO,TGL PELAYANAN, TGL SETOR, JAM SETOR, NO BUKTI, JENIS AMBULAN, NILAI, KET, PETUGAS");

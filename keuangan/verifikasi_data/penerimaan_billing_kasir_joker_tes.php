...
<script>
	...
	aRkp.baseURL("penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasirRkp&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value);
	aRkp.Init();
	...
	//a1.baseURL("penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value);
	a1.baseURL("penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&Slip_ke=0&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value);
	a1.Init();
	...
	b.baseURL("penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasirDetail&bayar_id=0");
	b.Init();
    
	function ambilDataDetail(){
		var tmp = aRkp.getRowId(aRkp.getSelRow()).split('|');
		var url = "penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&Slip_ke="+tmp[3]+"&kasir="+tmp[2]+"&posting="+document.getElementById('cmbPost').value;
		alert(url)
		a1.loadURL(url,'','GET');
	...
	function ambilData(){
		...
		bayar_id = tmp[0];
		var url = "penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasirDetail&bayar_id="+bayar_id;
		//alert(url)
		b.loadURL(url,'','GET');
		new Popup('divPop',null,{modal:true,position:'center',duration:0.5})
		$('divPop').popup.show();
	...
	var url,tmp;
		...
		{		
			...
			url="penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasirRkp&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&filter="+aRkp.getFilter()+"&sorting="+aRkp.getSorting()+"&page="+aRkp.getPage();
			//alert(url);
...
//url="../transaksi/utils.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			url="penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasir&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&Slip_ke="+tmp[3]+"&kasir="+tmp[2]+"&posting="+document.getElementById('cmbPost').value+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
			//alert(url);
			a1.loadURL(url,"","GET");
		}
	...
	var url;
		...
		url="penerimaan_billing_kasir_utils_joker_tes.php?grd=loadkasir&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value;
		//alert(url);
	...
	function kirim(){
		var url;
		var cmbPost = document.getElementById('cmbPost').value;
		url="penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasirRkp&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+document.getElementById('tgl_slip').value+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+cmbPost;
		//alert(url);
		//a1.loadURL(url,"","GET");
		aRkp.loadURL(url,"","GET"); 
	}
	...
	function fJBayarChange(obj){
		...
		if (confirm("Yakin Ingin Mengubah Jenis Pembayaran ?")){
			//alert('ok');
			var url="penerimaan_billing_kasir_utils_joker_tes.php?act=ubah_jenis_bayar&cbyrId="+cbyrId+"&cjbyr="+cjbyr;
			Request( url , "spn_respon", "", "GET",function(p){
				var tmp_p=document.getElementById('spn_respon').innerHTML;
				//alert(tmp_p);
				var tmp=tmp_p.split("|");
				if (tmp[0]=="OK"){
	...
	function KoreksiDistribusi(){
		...
		if (a1.getMaxPage()>0){
			...
			if (tmp!="")
			{
				...
				{
					url="penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasir&act=koreksi_distribusi&idUser=<?php echo $userId; ?>&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+tglSlip+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp+"&filter="+a1.getFilter()+"&sorting="+a1.getSorting()+"&page="+a1.getPage();
					//alert(url);
					a1.loadURL(url,"","GET");
				}
			}
		...
		if (aRkp.getMaxPage()>0){
			...
			if (tmp!="")
			{
				...
				{*/
					...
					cancelP=0;
					fProgressExecute();
					//url="penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasir&act=verifikasi&idUser=<?php echo $userId; ?>&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+tglSlip+"&no_slip="+no_slip+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp;
					//alert(url);
					//a1.loadURL(url,"","GET");
				//}
			}
	...
	function fProgressExecute(){
		...
		url="penerimaan_billing_kasir_utils_joker_tes.php?grd=penerimaanBillingKasirRkp&act=verifikasi&idUser=<?php echo $userId; ?>&tanggal="+document.getElementById('tgl').value+"&tanggalSlip="+tglSlip+"&no_slip="+no_slip+"&kasir="+document.getElementById('cmbKasir').value+"&posting="+document.getElementById('cmbPost').value+"&fdata="+pdata[iter-1];
		alert(url);

	...
	var url,tmp;
		...
		//var url2;
			...
			if (tmp!="")
			{
				...
				{
					url="pasienKRS_utils.php?grid=1Rkp&act=verifikasi&userId=<?php echo $userId; ?>&txtTgl="+txtTglA+"&txtTgl2="+txtTglB+"&kso="+kso+"&posting="+document.getElementById('cmbPost').value+"&tglslip="+tglslip+"&fdata="+tmp+"&no_slip="+no_slip;
					...
					pdata=tmp.split(String.fromCharCode(5));
					iter=1;
					cancelP=0;
					fProgressExecute();
				//}
		...
		function fProgressExecute(){
			...
			url="pasienKRS_utils.php?grid=1Rkp&act=verifikasi&userId=<?php echo $userId; ?>&txtTgl="+txtTglA+"&txtTgl2="+txtTglB+"&kso="+kso+"&posting="+document.getElementById('cmbPost').value+"&tglslip="+tglslip+"&fdata="+pdata[iter-1]+"&no_slip="+no_slip+"&useProgress=1";
			//alert(url);

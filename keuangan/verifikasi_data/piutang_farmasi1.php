...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>.: Pendapatan - Piutang Farmasi :.</title>
                ...
                <tr>
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="30">
                                <td colspan="2" align="center" style="text-transform:uppercase">Pendapatan / Piutang Pelayanan Resep</td>
                            </tr>
                            <tr height="30" id="trKSO">
                                <td width="110" style="padding-left:150px;">Nama KSO</td>
                                <td>:&nbsp;
                                    <select id="cmbKso" name="cmbKso" onchange="kirim()" class="txtinputreg"></select>
                                </td>
                            </tr>
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            var url = "piutang_farmasi_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
            ...
            timeFil = document.getElementById('cmbTime').value;
            kso = document.getElementById('cmbKso').value;
            var url = "piutang_farmasi_utils.php?grid="+par;
            if(par == 1){
                url += "&kso="+kso;
            }
            else{
		...
		function kirim(){
			...
			document.getElementById('btnVerifikasi').disabled=true;
			url="piutang_farmasi_utils.php?grid=1&txtTgl="+TglA+"&kso="+kso+"&posting="+cmbPost;
			//alert(url);
			a.loadURL(url,"","GET"); 
		}
		//=========================================
		...
		//var nilai='';
			...
			if (tmp!="")
			{
				...
				{
					url="piutang_farmasi_utils.php?grid=1&act=verifikasi&userId=<?php echo $userId; ?>&txtTgl="+txtTglA+"&kso="+kso+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp;
					//alert(url);
					a.loadURL(url,"","GET");
				}
			}
        ...
        a.setHeader("PENDAPATAN / PIUTANG PELAYANAN RESEP");
		a.setColHeader("NO,TANGGAL KUNJUNGAN,TANGGAL PULANG,NO RM,NAMA,KSO,KUNJUNGAN AWAL,TARIF PERDA,BIAYA PASIEN,BIAYA KSO,BAYAR PASIEN,PIUTANG PASIEN,VERIFIKASI<BR><input type='checkbox' name='chkAll' id='chkAll' onClick='chkKlik(this.checked);'>&nbsp;&nbsp;&nbsp;&nbsp;");
		...
		a.setCellAlign("center,center,center,center,left,center,left,right,right,right,right,right,center");
		...
		a.baseURL("piutang_farmasi_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
		//alert("piutang_farmasi_utils.php?grid=1&tipe=<?php echo $tipe;?>&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
        a.Init();
        ...
        b.baseURL("piutang_farmasi_utils.php?grid=2&tipe=<?php echo $tipe;?>&tipePend=0&kunjungan_id=0&waktu=");
        b.Init();

...
$pLegend = "Verifikasi Data -> Selisih Tarip";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="content-type" content="text/html;charset=utf-8" />
        <title>.: Selisih Tarip Piutang :.</title>
                ...
                <tr>
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="30">
                              <td colspan="2" style="font-size:16px" align="center">Verifikasi Selisih Tarip Piutang</td>
                            </tr>
                            <tr height="30" id="trKSO">
                                <td width="110" style="padding-left:150px;">Nama KSO</td>
                                <td>:&nbsp;
                    ...
                    <td align="center" >
                        <table width="950px" border="0" cellpadding="0" cellspacing="0">
                        	<tr>
                                ...
                                <td align="right" style="padding-right:10px;"><button id="btnRincian" name="btnRincian" type="button" onclick="RincianTindakan();" style="visibility:hidden">Rincian Tindakan</button>&nbsp;&nbsp;<BUTTON type="button" id="btnVerifikasi" onClick="VerifikasiJurnal();"><IMG SRC="../icon/save.gif" border="0" width="16" height="16" ALIGN="absmiddle"><span id="spnBtnVer">&nbsp;Verifikasi</span></BUTTON></td>
                            </tr>
                        </table>
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            var url = "verifikasi_selisih_tarip_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
            ...
            timeFil = document.getElementById('cmbTime').value;
            kso = document.getElementById('cmbKso').value;
            var url = "verifikasi_selisih_tarip_utils.php?grid="+par;
            if(par == 1){
                url += "&kso="+kso;
            }
            else{
		...
		function kirim(){
			...
			document.getElementById('btnVerifikasi').disabled=true;
			url="verifikasi_selisih_tarip_utils.php?grid=1&txtTgl="+TglA+"&kso="+kso+"&posting="+cmbPost;
			//alert(url);
			a.loadURL(url,"","GET"); 
		}
		//=========================================
		...
		var nilai='';
			...
			if (tmp!="")
			{
				...
				{
					url="verifikasi_selisih_tarip_utils.php?grid=1&act=verifikasi&userId=<?php echo $userId; ?>&txtTgl="+txtTglA+"&kso="+kso+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp;
					//alert(url);
					a.loadURL(url,"","GET");
				}
			}
        ...
        a.setHeader("SELISIH TARIP PIUTANG");
		a.setColHeader("NO,TANGGAL KUNJUNGAN,TANGGAL PULANG,NO RM,NAMA,KSO,KUNJUNGAN AWAL,TARIF REGULER,BIAYA PASIEN,BIAYA KSO (SIMRS),BIAYA KSO (VERIF KLAIM),VERIFIKASI<BR><input type='checkbox' name='chkAll' id='chkAll' onClick='chkKlik(this.checked);'>&nbsp;&nbsp;&nbsp;&nbsp;");
		...
		a.setColWidth("30,70,70,60,170,100,140,70,70,70,80,50");
		...
		a.baseURL("verifikasi_selisih_tarip_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
		//alert("verifikasi_selisih_tarip_utils.php?grid=1&tipe=<?php echo $tipe;?>&kso="+kso+"&waktu="+timeFil+"&bln="+bln+"&thn="+thn);
        a.Init();
        ...
        b.baseURL("verifikasi_selisih_tarip_utils.php?grid=2&tipe=<?php echo $tipe;?>&tipePend=0&kunjungan_id=0&waktu=");
        b.Init();

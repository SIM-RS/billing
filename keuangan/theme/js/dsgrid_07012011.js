								...
								if (this.rows.length>0){
									...
									for (var i=1;i<cell.length;i++){
										if (typecell[i-1]=="txt"){
											...
											itemCol="<input type=\"checkbox\" value=\""+cell[i]+"\""+((parseInt(cell[i])==1)?" checked='checked'":"")+" />";
										}else if (typecell[i-1]=="txtbox"){
											itemCol="<input type=\"text\" class=\"txtinput\" id=\""+id+"item"+cell[0]+(i-1)+"\" style=\"text-align:"+alg[i-1]+"\" value=\""+cell[i]+"\" size=\"8\" />";
										}else{
											itemCol=cell[i];
										}
										dt+="<td width=\""+r[i-1]+"\" align=\""+alg[i-1]+"\">"+itemCol+"</td>";
									...
									for (var i=1;i<this.rows.length;i++){
										...
										for (var j=1;j<cell.length;j++){
											if (typecell[j-1]=="txt"){
												...
												itemCol="<input type=\"checkbox\" value=\""+cell[j]+"\""+((parseInt(cell[j])==1)?" checked='checked'":"")+" />";
											}else if (typecell[j-1]=="txtbox"){
												itemCol="<input type=\"text\" class=\"txtinput\" id=\""+id+"item"+cell[0]+(j-1)+"\" style=\"text-align:"+alg[j-1]+"\" value=\""+cell[j]+"\" size=\"8\" />";
											}else{
												itemCol=cell[j];
											}
											dt+="<td align=\""+alg[j-1]+"\">"+itemCol+"</td>";

...
function FormatNumberFloat(num,dec,dec_char,dec_char_asal,thousand_char){
var k=num.toString();
var g="";
var p=0;
var sisa=0;
...
var x="";
	...
	if (thousand_char=='' || thousand_char==undefined){
		if (x=="") k=k; else k=k+dec_char+x;
	}else{
		k=FormatNumberFloor(k,thousand_char)+dec_char+x;
	}
	//alert(k);
	return k;
}

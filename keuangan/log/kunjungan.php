...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <tr>
                    <td valign="top" align="center">
                        <table border="0" cellpadding="2" cellspacing="2" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold">
                            <tr height="30">
                              <td colspan="2" align="center">Log Hapus Kunjungan</td>
                            </tr>
    ...
    <script type="text/JavaScript" language="JavaScript">
        ...
        function goFilterAndSort(grd){
            ...
            var url = "kunjungan_utils.php?grid=1&tipe=<?php echo $tipe;?>&tipePend=0&kso="+kso+"&posting="+cmbPost+"&filter="+a.getFilter()+"&sorting="+a.getSorting()+"&page="+a.getPage();
            var tglA,tglZ;
            switch(timeFil){
                case 'harian':
        ...
        function filter(par){
            ...
            var url = "kunjungan_utils.php?grid="+par;
            if(par == 1){
                url += "&kso="+kso;
            }
            else{
		...
		var cekbox=(p==true)?1:0;
			...
			url="kunjungan_utils.php?grid=1&txtTgl="+TglA+"&txtTgl2="+TglB+"&kso="+kso+"&posting="+cmbPost+"&tipeData="+tipeData;
			//alert(url);
		...
		function kirim(){
			...
			url="kunjungan_utils.php?grid=1&kso="+kso+"&waktu="+tipeTime;
		...
		//var nilai='';
			...
			if (tmp!="")
			{
				...
				{
					url="kunjungan_utils.php?grid=1&act=verifikasi&userId=<?php echo $userId; ?>&txtTgl="+txtTglA+"&txtTgl2="+txtTglB+"&kso="+kso+"&posting="+document.getElementById('cmbPost').value+"&fdata="+tmp;
					//alert(url);
					a.loadURL(url,"","GET");
				}
			}
        ...
        a.setHeader("LOG HAPUS KUNJUNGAN");
		a.setColHeader("NO, TGL HAPUS, TGL KUNJUNGAN, NORM, NAMA, ALAMAT, PENJAMIN, KUNJUNGAN AWAL, BIAYA RS, BIAYA KSO, BIAYA Px");
		a.setCellType("txt,txt,txt,txt,txt,txt,txt,txt,txt,txt,txt");
		// a.setSubTotal(",,,,,,,SubTotal :&nbsp;,0,0,0,0,0,0");
		a.setIDColHeader(",,,no_rm,nama,,,,,,");
		a.setColWidth("30,70,70,70,180,180,150,150,80,80,80");
		a.setCellAlign("center,center,center,center,left,left,center,left,right,right,right");
		...
		a.baseURL("kunjungan_utils.php?grid=1&kso="+kso+"&waktu="+timeFil+"&txtTgl="+TglA);
        a.Init();

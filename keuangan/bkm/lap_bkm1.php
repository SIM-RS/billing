			...
			<tbody>
				<tr>
					<td colspan="6">
						<div class="left bold">
							<table>
								<tr><td>RSUD SIDOARJO</td></tr>
								<tr><td>KABUPATEN SIDOARJO</td></tr>
							</table>
						</div>
						<div class="right">
							<table>
				...
				<?php 
					$arrQ = array(
								"billing" 	=> "SELECT bd.bkm_id, bd.id, bd.id_trans, bd.kasir_id, bd.nilai, bd.no_bukti, u.nama ket
								...
								"farmasi" 	=> "SELECT bd.bkm_id, bd.id, bd.id_trans, bd.kasir_id, bd.nilai, bd.no_bukti, u.UNIT_NAME ket
												FROM k_bkm_detail bd
												INNER JOIN k_transaksi t
												   ON t.bkm_detail_id = bd.id

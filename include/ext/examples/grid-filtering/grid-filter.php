...
$username = 'root';
$password = '';
$database = 'db_penilaian'; // 'gridfiltersdemo' in sample sql
...
$total = mysql_num_rows(mysql_query($query));//echo $query;
...
while($obj=mysql_fetch_array($rs)){
    $arr[$i]=array('NIP'=>($no)."<input type='hidden' id=$i value='$obj[NIP]' />",'NAMA'=>$obj["NAMA"],"USER_NAMA"=>$obj[2],"PASSWORD"=>$obj[3],"ID_BAGIAN"=>$obj[4],"ID_KATEGORI"=>$obj[5]);
    $i++;
    $no++;
}
